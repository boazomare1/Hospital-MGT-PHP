...
{
	 $pono = $_REQUEST['pono'];
	 $newsupplieranum = $_REQUEST['newsupplieranum'];
	 $newsuppliercode = $_REQUEST['newsuppliercode'];
	 $newsuppliername = $_REQUEST['newsuppliername'];
	
	 $query88 = "update purchase_indent set supplieranum = '$newsupplieranum', suppliercode = '$newsuppliercode', suppliername = '$newsuppliername' where docno = '$pono' and pogeneration <> 'completed'"; 
...
$query55 = "select * from purchase_indent where docno='$pono'";
...
$(function() {
$('#newsuppliername').autocomplete({
	source:'ajaxsuppliernewserach.php', 
	select: function(event,ui){
			var code = ui.item.id;
			var anum = ui.item.anum;
			$('#newsuppliercode').val(code);
			$('#newsupplieranum').val(anum);
			},
	});
});
          ...
          <tbody>
            ...
            <tr>
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Ord.Qty</strong></div></td>
			...
			$sno = '';
			$postatus = '';
			$query34="select * from purchase_indent where docno='$pono' and approvalstatus <> 'reject'";
			$exec34=mysqli_query($GLOBALS["___mysqli_ston"], $query34) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			$totalpieces =0;
			$amount = $res34['amount'];
			$itemname=$res34['medicinename'];
			$itemcode=$res34['medicinecode'];
			$rate=$res34['rate'];
			$quantity=$res34['quantity'];
			$pogeneration = $res34['pogeneration'];
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="left">
			    ...
			    <div align="right"><?php echo $rate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left">
			    <div align="right"><?php echo $quantity; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left">
			    <div align="right"><?php echo $amount; ?></div></td>
			</tr>	
			<?php
			}
			?>
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ecf0f5"><a href="viewpurchaserequisition.php"><strong>Back</strong></a></td>
              </tr>
              <?php
			  if($postatus=='') { ?>
              <tr>
              <td colspan="5" class="bodytext31" valign="center"  align="left" 
                bgcolor="#fff"><strong>Supplier Update</strong></td>
              </tr>
              <td class="bodytext31" valign="center"  align="left">&nbsp;</td>
              <td colspan="4" class="bodytext31" valign="center"  align="left"><strong>Supplier </strong></td>
              </tr>
              <tr>
              <td class="bodytext31" valign="center"  align="left">&nbsp;</td>
              <td colspan="4" class="bodytext31" valign="center"  align="left"><strong></strong>
              <input type="text" name="newsuppliername" id="newsuppliername" size="45" autocomplete="off">
              <input type="hidden" name="newsuppliercode" id="newsuppliercode" value="">
              <input type="hidden" name="newsupplieranum" id="newsupplieranum" value="">
              </td>
              </tr>
              <tr>
              <td class="bodytext31" valign="center"  align="left">&nbsp;</td>

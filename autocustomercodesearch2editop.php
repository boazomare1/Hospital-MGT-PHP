...
// code ends here
   ...
   if($visitlimit<1){
	...
	$query52 = "select mcc from master_visitentry where patientcode = '$customercode' and recordstatus = '' order by auto_number desc limit 0,1";

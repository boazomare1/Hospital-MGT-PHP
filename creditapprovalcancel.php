...
else
{
	...
	$billnumbercode7 = $paynowbillprefix7 .$maxanum7;
		...
		$query67 = "delete from ip_creditapproval where patientcode='$patientcode' and visitcode='$visitcode'";
...
{
alert("Please Click on Cancel Request for Approval");
return false;
}
...
<body>
<form name="form1" id="form1" method="post" action="creditapprovalcancel.php" onSubmit="return validcheck()">	
  ...
  <tr>
	...
	$colorloopcount = $colorloopcount + 1;
      ...
      <tr>
       ...
       <tr>
        <td>&nbsp;</td>
		 <td width="3%">&nbsp;</td>
		  <td width="3%">&nbsp;</td>
		<td width="26%" align="right" valign="center" class="bodytext311">Cancel Request for Approval</td>
	  ...
	  <tr>
        ...
        <input type="submit" name="Submit" value="Cancel Request" style="border: 1px solid #001E6A" onClick="return funcvalidation()"/></td>

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="fulldebtoranalysissummary_subtype1.php" >
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
			...
			?>
			<tr bgcolor="#cbdbfa">
            <td colspan="9"  align="left" valign="center" bgcolor="#FFF" class="bodytext31" onClick="showsub(<?=$subtypeanum?>)"><strong><?php echo $subtype; ?> </strong></td>
            </tr> 
...
$grandtotalamount2401 += $totalamount2401;
			...
			$totalamount2401 = "0.00";
				?>
			  <?php
				$urlpath = "cbfrmflag1=cbfrmflag1&&ADate1=$ADate1&&ADate2=$ADate2&&searchsuppliername1=$searchsuppliername1&&type=$typeanum&&searchsubtypeanum1=$searchsubtypeanum1";
			?>
			 <td colspan="8"></td>
			 ...
			 <td colspan="8"></td>
		   	 <td class="bodytext31" valign="center"  align="right"><a href="print_fulldebtoranalysissummary_subtype1.php?<?php echo $urlpath; ?>"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a></td>
			</tr>
          </tbody>
        </table></td>
      </tr>
...
<?php echo  date('Y-m-d H:i:s'); include ("includes/footer1.php"); ?>
</body>
</html>

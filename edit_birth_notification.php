...
if (isset($_REQUEST["dnum"])) { $dnum = $_REQUEST["dnum"]; } else { $dnum = ""; }
...
$query = "select locationcode from login_locationdetails where username='$username' and docno='$docno' order by locationname";
 ...
 $query26="update birth_notification set patientname='$mname',patientcode='$regnumber',locationname='$locationname',locationcode='$locationcode',address='$maddress',doctor_name='$doctor',doctor_code='$doctorcode',record_date='$dateonly',record_time='$timeonly',edited_by='$username',gender='$gender',dateofbirth='$dateofbirth',accountname='$accountname',age='$age',child_name='$cname',father_name='$fname',father_nationality='$fnationality',mother_nationality='$mnationality',weight='$weight',baby_birth='$child_dob',child_gender='$sex',editdatetime='$updatedatetime' where docno = '$dnum'";
    $exec26=mysqli_query($GLOBALS["___mysqli_ston"], $query26) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	echo "<script>window.open('print_birthnotification.php?docno=$dnum','OriginalWindow','width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');window.location.href='medicalnotification.php';</script>";
...
<?php
	$query211 = "select * from birth_notification where docno = '$dnum'";
	 $exec211 = mysqli_query($GLOBALS["___mysqli_ston"], $query211) or die ("Error in Query211".mysqli_error($GLOBALS["___mysqli_ston"]));
	  ...
	  $patientcode = $res211['patientcode'];
	  $sex = $res211['child_gender'];
...
<form name="frmsales" id="frmsales" method="post" action="edit_birth_notification.php" onSubmit="return validCheck()" enctype="multipart/form-data">
      ...
      <tr>
		...
		<td width="14%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Sex</strong></td>
			  ...
			  <option value="FEMALE">FEMALE</option>
					 ...
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
 <input name="ADate1" id="ADate1" value="<?php echo $res211['baby_birth']; ?>"  size="20"  readonly="readonly" onKeyDown="return disableEnterKey()" />
			<img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate1','ddMMMyyyy','dropdown',true,'12',true,'past')" style="cursor:pointer"/>									
				 ...
				 <tr bgcolor="#011E6A">
					 ...
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
<input type="text"  name="cname" id="cname" value="<?php echo $res211['child_name']; ?>">									
		            </td>
			  			<td width="5%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Weight of the Child </strong></td>
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
					 	<input type="text" value="<?php echo $res211['weight']; ?>" name="weight" id="weight" size="15" autocomplete='off' >KGs
...
<input type="text" value="<?php echo $patientcode; ?>" name="rno" id="rno" readonly="<?php echo $patientcode; ?>" >									
					 ...
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
					 	<input type="text" value="<?php echo $res211['doctor_name']; ?>" name="doctor" id="doctor" size="30" autocomplete='off' onKeyUp="javascript:document.getElementById('doctorcode').value='';" >
					 	<input type="hidden" value="<?php echo $res211['doctor_code']; ?>" name="doctorcode" id="doctorcode" >
					</td>
					</tr>
										 <tr bgcolor="#011E6A">
					...
					<td width="5%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Medical Records Officer</strong></td>
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
					 		<input type="text"  name="maddress" id="maddress" size="30" value="<?php echo $res211['address']; ?>">
					</td>
                </tr>
				<tr>
				<td width="5%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Nationality </strong></td>
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
					 		<input type="text"  name="mnationality" id="mnationality" value="<?php echo $res211['mother_nationality']; ?>">
					</td>
	 <td width="5%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Mother NIN/AIN </strong></td>
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
					 		<input type="text"  name="mnin_ain" id="mnin_ain" value="<?php echo $res211['mnin_ain']; ?>">
					</td>
			    ...
			    <tr bgcolor="#011E6A">
					 ...
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
					 		<input type="text"  name="fname" id="fname" value="<?php echo $res211['father_name']; ?>">
					</td>						
<td width="5%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Nationality </strong></td>
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
					 		<input type="text"  name="fnationality" id="fnationality" value="<?php echo $res211['father_nationality']; ?>">
					</td>	
                </tr>
				<tr>
	 <td width="5%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Father NIN/AIN </strong></td>
					 <td width="46%" align="left" valign="middle"  bgcolor="#ecf0f5">
					 		<input type="text"  name="fnin_ain" id="fnin_ain" value="<?php echo $res211['fnin_ain']; ?>">
					</td>
        ...
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr>
			  ...
			  <br> <br>
			  <input type="hidden" value="<?=$dnum?>" name="dnum" id="dnum">

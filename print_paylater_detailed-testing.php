...
//		$cstnumber1 = $res2["cstnumber"];
	...
	echo $query2 = "select * from master_transactionpaylater as ms LEFT JOIN login_locationdetails as mel ON ms.username = mel.username where mel.locationcode='$locationcode' and ms.billnumber = '$billautonumber' group by ms.billnumber";
...
<tr>
	...
	<td align="left" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext31" ><?php echo $consultingdoctor; ?></td>
...
echo $query199 = "select * from master_consultationpharm where patientvisitcode='$res2visitcode' and patientcode='$res2patientcode' and medicinecode = '".$res19medicinecode."'";
...
<td  align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext31" width="120">	<?php echo number_format($res23amount1,2,'.',','); ?></td>

...

{
...

	{
		...
		$query1 = "UPDATE master_ward set locationname='$selectedlocation',locationcode='$selectedlocationcode', ward = '$ward', deposit_amount='$deposit', ipaddress = '$ipaddress', recorddate = '$updatedatetime' where auto_number = '$wardanum'";
                  ...
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Ward Master - Add New </strong></td>
                ...
                <select name="location" id="location" onChange="return funclocationChange1();"  style="border: 1px solid #001E6A;">
                  ...
                  <?php
                      ...
                      <tr>
                        ...
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Deposit Amount </div></td>

                        <td align="left" valign="top"  bgcolor="#FFFFFF">

						<input name="deposit" id="deposit" value="<?=$deposit_amount;?>" onKeyPress="return noDecimal(event)" style="border: 1px solid #001E6A; "  size="40" /></td>

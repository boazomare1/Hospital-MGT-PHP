        ...
        <td>
          ...
          <tbody>
			...
			<td colspan="12" align = "right" >
				<a href="excel_oprevenuereport_refund_radiology.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&locationcode=<?php echo $locationcode; ?>"><img  width="30" height="30" src="images/excel-xls-icon.png" style="cursor:pointer;"></a>
			</td>
			</tr>
            <tr>
			...
			$query1 = "select patientcode,patientname,radiologyitemrate,billdate,locationname,patientvisitcode,billnumber from refund_paylaterradiology where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			?>
				...
				$query1 = "select patientcode,patientname,radiologyitemrate,billdate,locationname,patientvisitcode,billnumber from refund_paynowradiology where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto'";
			...
			?>
				...
				$query1 = "select radiologyfxamount as radiologyitemrate, patientcode, patientname, entrydate, visitcode, locationname,billno from billing_patientweivers where locationcode='$locationcode' and entrydate between '$transactiondatefrom' and '$transactiondateto'";

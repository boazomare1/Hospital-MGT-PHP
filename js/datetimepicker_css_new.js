...

{
...

	{
...

		{
			...
			for (var i = 0; i <= disable_weekdays.length; i++) {

		

				if(n == disable_weekdays[i])
			...
			/*if(disable_weekdays.includes(n) )
...

			{
...

				{
...

					{
						...
						console.log(disable_weekdays.length);
					...
					for (var i = 0; i <= disable_weekdays.length; i++) {
						...
						var day = disable_weekdays[i];



					

						if((day == 1) && ((vDayCount + 6) % 7 === 0)) 

...
if (isset($_REQUEST["tmp"])) { $tmp_id = $_REQUEST["tmp"]; } else { $tmp_id = ""; }
...
$query_rt0 = "SELECT templatename,auto_number FROM pharma_rate_template WHERE auto_number='$tmp_id' and recordstatus <> 'deleted' ORDER BY auto_number DESC";
$exec_rt0 = mysqli_query($GLOBALS["___mysqli_ston"], $query_rt0) or die ("Error in Query_rt".mysqli_error($GLOBALS["___mysqli_ston"]));
$res6 = mysqli_fetch_array($exec_rt0);

$filename=$res6["templatename"]."-pharmacyrates-".$updatedatetime;
						...
						<tr>
							<td>
								...
								<tr >
									...
									<td width="4%"  class="bodytext3">
										<div align="center"><strong>S.no</strong></div>
									</td>
									<td width="9%"  class="bodytext3">
										<strong>Template ID</strong>
									</td>
									<td width="10%"  class="bodytext3">
										<strong>Item Code</strong>
									</td>									
									<td width="45%"  class="bodytext3">
									...
									<?php 
									  $query_rt = "SELECT templatename,markup FROM pharma_rate_template where auto_number='$tmp_id'  ORDER BY auto_number ASC";
									...
									if($_REQUEST["type"]==2){
									?>
									<td width="9%" align="center"  class="bodytext3">
										<strong>Markup</strong>
									</td>
									<?php } elseif($_REQUEST["type"]==1){ ?>
									<td  align="center" width="20%"  class="bodytext3">
							...
							<tr <?php echo $colorcode; ?>>
								...
								<td align="left" valign="middle"  class="bodytext3"><?php echo $tmp_id; ?> </td>
								...
								<!-- pharmacy template rate-->
									<?php
									    // Get all templates
									    $query_rt1 = "SELECT auto_number,markup FROM pharma_rate_template where auto_number='$tmp_id' ORDER BY auto_number ASC";

...
<?php include("a4pdfpayrollheader1.php"); ?>	
	...
	?>	
	<table width="470" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
	<tbody>
	<tr bgcolor="#FFFFFF">
...
<tr>
	<td width="80" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>PAYROLL NO</strong></td>
	<td width="100" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>LAST NAME</strong></td>
	<td width="100" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>FIRST NAME</strong></td>
...
require_once('html2pdf/html2pdf.class.php');
...

    {
        ...
        $html2pdf->Output('NHIFreport.pdf');

...
<?php  include("print_header1.php"); ?>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
             cellspacing="0" cellpadding="4" width="600"
            align="left" border="0">
		  ...
		  <tr>
              ...
              <td width="80" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"> <strong>Opg.Stock</strong> </td>
              <td width="80" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"> <strong>Receipts</strong> </td>
              <td  width="80" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"> <strong>Issues</strong> </td>
              <td width="80" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"> <strong>Returns</strong> </td>
              <td width="80" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"> <strong>Closing Stock</strong> </td>
				</tr>
				<?php
				if (isset($_REQUEST["frmflag1"])) { $frmflag1 = $_REQUEST["frmflag1"]; } else { $frmflag1 = ""; }
//$frmflag1 = $_REQUEST['frmflag1'];
...
<tr>
			<td class="bodytext31" valign="center"  align="left" 
              ...
              <td align="left" valign="center"  
                  class="bodytext31"> <strong>&nbsp;</strong> </td>
            		  <td align="left" valign="center"  
                  class="bodytext31"> <strong><?php echo $openingbalance; ?></strong> </td>
				  			  <td align="left" valign="center"  
                  class="bodytext31"><strong>  </strong></td>
				  <td align="left" valign="center"  
                  class="bodytext31"><strong>  </strong></td>
                  ...
                  class="bodytext31"><strong>  </strong></td>
       			 <td align="left" valign="center"  
                  class="bodytext31"><strong> <?php echo $balance; ?> </strong></td>
			...
			if($store == 'all')
			{
              ...
              <td align="left" valign="center"  
                ...
                <td align="left" valign="center"  
                 class="bodytext31"> <strong><?php echo $batch; ?></strong> </td>
					           <td align="left" valign="center"  
                 class="bodytext31"> <strong><?php echo $purchaseopeningstock; ?></strong> </td>
              <td align="left" valign="center"  
                 class="bodytext31"> <strong><?php echo intval($quantity); ?></strong> </td>
              <td align="left" valign="center"  
                class="bodytext31"> <strong><?php echo $purchaseissues; ?></strong> </td>
              <td align="left" valign="center"  
                class="bodytext31"> <strong><?php echo $purchasereturns; ?></strong> </td>
              <td align="left" valign="center"  
                class="bodytext31"> <strong><?php echo intval($purchasequantity); ?></strong> </td>
				</tr>
				<?php
				}
				?>

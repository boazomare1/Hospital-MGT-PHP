...
$query13l = "select * from master_subtype where auto_number = '$res111subtype' and recordstatus<>'deleted'  order by subtype";
...
$query1 = "select * from $tablenamel where status <> 'Deleted' AND  rateperunit <> 0  and itemcode not in (select itemcode from package_processing where visitcode='$visitcode' and add_pkg_trackid='' and package_item_type='LI') group by itemname order by itemcode";

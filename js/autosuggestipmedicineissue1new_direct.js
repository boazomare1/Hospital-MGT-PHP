...
AutoSuggestControlmed.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	var url = "";
	var url="ajaxmedicinebuildipmedicineissue_direct.php?searchmedicinename1="+searchmedicinename1+"&&searchlocation="+locationcode+"&&searchstore="+storecode+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*

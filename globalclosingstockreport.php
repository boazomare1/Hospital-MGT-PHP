...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
	...
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
      ...
      <tbody id="foo">
        <tr>
          <td colspan="5" bgcolor="#ecf0f5" class="bodytext31"><strong>Global Closing Stock - Report By Item</strong></td>
          </tr>
        <tr>
...
//echo $totalpurchase.'<br>'.$totalsalesquantity.'<br>'.$totalsalesreturn.'<br>'.$transferquantityfrom;
       ...
       <td align="right" colspan=""> <a target="_blank" href="stockreportglobal_xl.php?categoryname=<?= $categoryname; ?>&&store=<?= $store;?>&&location=<?= $reslocationanum;?>&&searchitemcode=<?= $searchcode;?>&&servicename=<?= $servicename;?>&ADate2=<?php echo $transactiondateto;?>"> <img src="images/excel-xls-icon.png" width="30" height="30"></a> </td>

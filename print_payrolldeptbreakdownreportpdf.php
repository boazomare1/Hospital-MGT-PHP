...
include("print_header.php");
	...
	<table width="600" border="0" align="center" cellpadding="0" cellspacing="2" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
		<thead>
			...
			<tr >
				<td colspan="2" align="center" class="bodytext3" ><strong>Departmental Breardown</strong></td>
			</tr>
			<tr >
				<td colspan="2" align="center" class="bodytext3" ><strong>&nbsp;</strong></td>
			</tr>
			...
			<tr >
				<td align="left" class="bodytext3" ><strong>PER :  <?php echo $assignmonth; ?></strong></td>
...
<?php
	...
	?>
		<tr>
			<td colspan="2" align = "left" class="bodytext3" bgcolor="#FFFFFF"><strong><?php echo $departmentname; ?></strong></td>
		</tr>
	<?php
	...
	?>
		...
		<tr>
			<td colspan="3" align = "left" class="bodytext27">&nbsp;</td>
		</tr>
		<tr>
...
//      $html2pdf->setModeDebug();
        ...
        $html2pdf->Output('payrolldeptbreakdownreport.pdf');
    }

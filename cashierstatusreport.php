...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><form name="cbform1" method="post" action="cashierstatusreport.php">
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
           ...
           <tr>
                ...
                bgcolor="#ffffff" class="bodytext31"><strong>Consultation Bill By </strong></td>
                           <td width="97"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><strong>Pharmacy Bill By </strong></td>
                           <td width="104"  align="left" valign="center" 
                bgcolor="#ffffff" class="style1">Lab Bill By </td>
                           <td width="101"  align="left" valign="center" 
                bgcolor="#ffffff" class="style1">Service Bill By </td>
                           <td width="110"  align="left" valign="center" 
                bgcolor="#ffffff" class="style1">Radiology Bill By </td>
           </tr>
			  <?php 
           $query1 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and (billtype = 'PAY NOW' or (billtype = 'PAY LATER' and (planfixedamount <> '0.00' or planpercentage <> '0.00'))) and consultationdate between '$fromdate' and '$todate' order by auto_number desc";
			...
			$query3 = "select * from billing_consultation where patientcode = '$res1patientcode' and patientvisitcode='$res1visitcode' and DATE(billdate) between '$fromdate' and '$todate' group by patientvisitcode  order by auto_number desc";
			$exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res3 = mysqli_fetch_array($exec3))
			{
			 $res3username  = $res3['username'];
			}
		    $query4 = "select * from billing_paynowpharmacy where patientcode = '$res1patientcode' and patientvisitcode='$res1visitcode' and billdate between '$fromdate' and '$todate' group by patientvisitcode  order by auto_number desc";
			$exec4 = mysqli_query($GLOBALS["___mysqli_ston"], $query4) or die ("Error in Query4".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res4 = mysqli_fetch_array($exec4))
			{
			$res4username  = $res4['username'];
			}
		   $query5 = "select * from billing_paynowlab where patientcode = '$res1patientcode' and patientvisitcode='$res1visitcode' and billdate between '$fromdate' and '$todate' group by patientvisitcode  order by auto_number desc";
			$exec5 = mysqli_query($GLOBALS["___mysqli_ston"], $query5) or die ("Error in Query5".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res5 = mysqli_fetch_array($exec5))
			{
			$res5username  = $res5['username'];
			}
			$query6 = "select * from billing_paynowservices where patientcode = '$res1patientcode' and patientvisitcode='$res1visitcode' and billdate between '$fromdate' and '$todate' group by patientvisitcode  order by auto_number desc";
		    ...
		    $query7 = "select * from billing_paynowradiology where patientcode = '$res1patientcode' and patientvisitcode='$res1visitcode' and billdate between '$fromdate' and '$todate' group by patientvisitcode  order by auto_number desc";

    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1134">
              ...
              <form name="cbform1" method="post" action="journaledit.php">
		<table width="594" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Journal Entry </strong></td>
           ...
           <td colspan="2" align="right" bgcolor="#ecf0f5" class="bodytext3" id="ajaxlocation"><strong> Location </strong>
			...
			<tr>
			  ...
			  <td width="10%" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Doc. Number</td>
              <td width="30%" align="left" valign="top"  bgcolor="#FFFFFF">
              	<span class="bodytext3">
                    <?php
						...
						?>
						<input type="hidden" id="location" name="location" value="<?php echo $locationcode; ?>">	
						<?php
						} 
					?>
          ...
          <tbody>
			...
			<tr>
			  <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><strong>Action</strong></td>
              <td class="bodytext31" valign="center"  align="left" 
			...
			$query2 = "select * from master_journalentries where locationcode='$location' AND docno like '$doc_no'  group by docno order by auto_number";
			...
			<tr bg-color="#eeeeee">
				<td class="bodytext31" valign="center"  align="left">
              	<a href="journalentriesedit.php?docno=<?php echo $res2billnumber;?>"><strong>Edit</strong></a>
              </td>
			</tr>
			<?php
			$query3 = "select * from master_journalentries where locationcode='$locationcode1' and docno = '$res2billnumber' order by selecttype desc";

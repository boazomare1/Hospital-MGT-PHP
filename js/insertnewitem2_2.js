...
//alert(document.getElementById("serial1").value);
	...
	var varlab2=varlabRate.replace(",","");
	var varlab3=parseInt(varlab2);
	...
	text8.type = "text";
	text8.size = "8";
	text8.value = formatMoney(varlab3);
	...
	text11.onclick = function() { return btnDeleteClick1(j,varlab3); }
	...
	totalamount1=parseFloat(totalamount1) + parseFloat(varlab3);
	document.getElementById("total1").value=formatMoney(totalamount1);
	document.getElementById("t2").value=totalamount1;

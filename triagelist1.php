...
var dataString = 'username='+username+'&&department='+ val;
$.ajax({
type: "get",
url: "ajaxdepartmentsearch.php",
data: dataString,
cache: true,

success: function(html){
$("#department_search").val(html);	
...
source:'ajaxdepartmentsearch.php?username='+username+'&&department='+val, 
...
$('#department_search').val(ui.item.scheme_name);
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="triagelist1.php">
                ...
                <table width="600" height="250" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
              ...
              <td colspan="2" align="right" bgcolor="#CCCCCC" class="bodytext3" id="ajaxlocation"><strong> Location </strong>
                  ...
                  <?php
                      if (isset($_REQUEST["department_search"])) {$department_search = $_REQUEST["department_search"]; } else { $department_search = ""; }
              ...
              <td  bgcolor="#FFFFFF" class="bodytext3"  colspan="3" ><select name="location" id="location" onChange="ajaxlocationfunction(this.value);" style="border: 1px solid #001E6A;">
                ...
                <input type="hidden" name="locationcodenew" value="<?php echo $res1locationanum; ?>">
                    ...
                    <tr>
					  ...
					  <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3" style="color:#F00"><strong>Department</strong></td>

					  <td width="82%" colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">

	<input name="department_search" type="text" id="department_search"  size="50" autocomplete="off" value="<?php echo $department_search; ?>" onKeyUp="get_department(this.value)"  placeholder="Search Department"  oninput="setCustomValidity('')"/>
          ...
          <td width="263" align="left" valign="center"  bgcolor="#ffffff"><span class="bodytext31">
			...
			<tr>
                ...
                <table >
                	<tr >
                		<td>&nbsp;&nbsp;&nbsp;</td> 
                		<td ><iframe id="publishedlistiframe" src="consultationwatinglist.php" width="670" height="250" frameborder="1">                  </iframe>                  
              </td>
                	</tr>
                </table>
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="1238" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="11" bgcolor="#cccccc" class="bodytext31"><script language="javascript">
			...
			<td width="15%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong> Consultant </strong></div></td>
			...
			{
			 $query1 = "select * from master_billing where patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and paymentstatus = 'completed' and triagestatus<>'completed' and consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode' and department='$department_search' order by auto_number asc";
			}
			else
			{
          ...
          // $query123 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and locationcode='$locationcode' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and locationcode='$locationcode' and  paymentstatus = '' and consultationdate between '$fromdate' and '$todate'  order by auto_number desc";
			...
			$query321 = "select departmentname,triagestatus,accountname,scheme_id,accountfullname from master_visitentry where patientcode = '$patientcode' and visitcode='$visitcode' and locationcode='$locationcode'";
	...
	$exec_sc = mysqli_query($GLOBALS["___mysqli_ston"], $query_sc) or die ("Error in query_sc".mysqli_error($GLOBALS["___mysqli_ston"]));
			//echo $nums1pay = mysqli_num_rows($exec_sc);
	$res_sc = mysqli_fetch_array($exec_sc);

	 $scheme_name = $res_sc['scheme_name'];

			//$consultingdoctor = $res321['consultingdoctor'];
			...
			$status = 'pending';
			 ...
			 $accountname=$res321['accountname'];	
			...
			$query1pay = "select gender from master_visitentry where overallpayment='completed' and patientcode like '%$patientcode%' and visitcode like '%$visitcode%' and billtype <> 'PAY NOW' and locationcode='$locationcode' order by auto_number desc";

			$exec1pay = mysqli_query($GLOBALS["___mysqli_ston"], $query1pay) or die ("Error in Query1pay".mysqli_error($GLOBALS["___mysqli_ston"]));

			$nums1pay = mysqli_num_rows($exec1pay);

			$res1pay = mysqli_fetch_array($exec1pay);
			...
			//$gender = $res32['gender'];
			$gender = $res1pay['gender'];

			

			$query751 = "select dateofbirth from master_customer where customercode = '$patientcode' and locationcode='$locationcode'";
			...
			$accountname=$res321['accountfullname'];	

			

			$query65="select visitcode from master_triage where patientcode = '$patientcode' and visitcode = '$visitcode' and triagestatus = 'completed' and closesvisits = ''";
			...
			$query5 = "select department from master_employeedepartment where department = '$department1111' and username='$username'";
            ...
            <tr <?php echo $colorcode; ?>>
             ...
             <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $scheme_name;?></div></td>
             <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $res1accountfullname;?></div></td>
			  ...
			  {?>
			    ...
			    <div align="left"><a href="addtriage2.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&menuid=<?php echo $menu_id; ?>"><strong>Triage</strong></a>&nbsp;&nbsp;
				...
				<a href="triagebilling.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&menuid=<?php echo $menu_id; ?>"><strong>    Billing</strong></a></div>
			 ...
			 if($department_search!='')
			{
			 ...
			 $query1 = "select * from master_visitentry where overallpayment <> 'completed'  and billtype <> 'PAY NOW' and 

			consultationfees <> '0' and patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and planfixedamount='0.00' and planpercentage='0.00' and triagestatus<>'completed' and consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode' and departmentname='$department_search' order by auto_number asc";
			}
			else
			{
			$query1 = "select * from master_visitentry where overallpayment <> 'completed'  and billtype <> 'PAY NOW' and 
			...
			$schemefromvisit = $res1['accountfullname'];
 $scheme_id = $res1['scheme_id'];
	...
	$res_sc = mysqli_fetch_array($exec_sc);
	 ...
	 $scheme_name = $res_sc['scheme_name'];
			...
			$query32="select doctorname from master_doctor where auto_number='$consultingdoctorname' and locationcode='$locationcode'";
			...
			$query65="select visitcode from master_triage where patientcode = '$patientcode' and visitcode = '$visitcode' and triagestatus = 'completed' and closesvisits = '' and locationcode='$locationcode'";
			...
			$query5 = "select department from master_employeedepartment where department = '$res1department' and username='$username' ";
			...
			<td class="bodytext31" valign="center"  align="left">
             ...
             <td class="bodytext31" valign="center"  align="left">
			  ...
			  {?>
				...
				<a href="mchtriagebilling.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&menuid=<?php echo $menu_id; ?>"><strong> Billing</strong></a></div>
        ...
        if($department_search!='')
			{
			 $query1 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and complaint <> '0' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and (consultationfees='0' or consultationfees='0.00') and triagestatus <> 'completed' and consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode'  and departmentname='$department_search' order by auto_number asc";
			}
			else
			{
			$query1 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and complaint <> '0' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and (consultationfees='0' or consultationfees='0.00') and triagestatus <> 'completed' and consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode' order by auto_number asc";
			}
 ...
 $scheme_id = $res1['scheme_id'];
	...
	$res_sc = mysqli_fetch_array($exec_sc);
	 ...
	 $scheme_name = $res_sc['scheme_name'];
			...
			$query33="select accountname from master_accountname where auto_number='$accountname' and locationcode='$locationcode'";
			...
			$query65="select visitcode from master_triage where patientcode = '$patientcode' and visitcode = '$visitcode' and triagestatus = 'completed' and closesvisits = '' and locationcode='$locationcode1'";
		...
		//	$query5 = "select * from master_employeedepartment AS me LEFT JOIN master_employeelocation AS ml ON me.employeecode = ml.employeecode  where me.department = '$res1department' and me.username='$username' and ml.locationcode = '".$locationcode."' ";
			...
			while($employeedep=mysqli_fetch_array($exec5))
			...
			$execml = mysqli_query($GLOBALS["___mysqli_ston"], $queryml) or die ("Error in Queryml".mysqli_error($GLOBALS["___mysqli_ston"]));

			$numml = mysqli_num_rows($execml);
			...
			<td class="bodytext31" valign="center"  align="left">
             ...
             <td class="bodytext31" valign="center"  align="left">
              ...
              <td class="bodytext31" valign="center"  align="left" hidden="true"><strong>
			  ...
			  {?>
				...
				<a href="mchtriagebilling.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&menuid=<?php echo $menu_id; ?>"></a></div>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#cccccc">&nbsp;</td> <td class="bodytext31" valign="center"  align="left" 

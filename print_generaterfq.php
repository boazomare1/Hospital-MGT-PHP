...
<tr bgcolor="#011E6A">
                        ...
                        <td width="9%" bgcolor="#ecf0f5" class="bodytext3"><strong>Code</strong></td>
                        <td width="11%" bgcolor="#ecf0f5" class="bodytext3"><strong>Description</strong></td>
                        <td width="8%" bgcolor="#ecf0f5" class="bodytext3"><strong>Strength</strong>                          </td>
                        <td width="10%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong>Note</strong></div></td>
						<td width="8%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong>Unit Packet </strong></div></td>
						<td width="10%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong>N. Unit Packets</strong></div></td>
						<td width="11%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong> Unit Price Kshs  </strong></div></td>
	  <td width="8%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong> Total Kshs  </strong></div></td>
	  <td width="10%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong> Country of Origin  </strong></div></td>
						<td width="9%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong> Expiry  Date  </strong></div></td>
                      </tr>
					   <?php

...
//get ends here
	...
	$ipduevalue=0;
	$Querylab=mysqli_query($GLOBALS["___mysqli_ston"], "select ipdue from master_customer where customercode='$patientcode'");
$execlab=mysqli_fetch_array($Querylab);
 $ipduevalue=$execlab['ipdue'];
 $ipduevalue=$ipduevalue+$totalamount;
 
 mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE  master_customer SET ipdue = '".$ipduevalue."' where customercode='$patientcode'");
 //exit();
...
foreach($_POST['description'] as $key=>$value)
		...
		if($descriptionname!="")
		{
			if($_REQUEST['cash'] > 0)
			 ...
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,cashamount,cashcode)values('$descriptionname','$descriptionrate','$descriptionquantity','$descriptionamount','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CASH','$descriptionamount','$cashcode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			 
			 }
			 else if($_REQUEST['cheque'] > 0)
			 {
			 $query55 = "select * from financialaccount where transactionmode = 'CHEQUE'";
			 $exec55 = mysqli_query($GLOBALS["___mysqli_ston"], $query55) or die ("Error in Query55".mysqli_error($GLOBALS["___mysqli_ston"]));
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,chequeamount,bankcode)values('$descriptionname','$descriptionrate','$descriptionquantity','$descriptionamount','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CHEQUE','$descriptionamount','$chequecode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			
			 }
			 else if($_REQUEST['online'] > 0)
			 {
			 $query55 = "select * from financialaccount where transactionmode = 'ONLINE'";
			 $exec55 = mysqli_query($GLOBALS["___mysqli_ston"], $query55) or die ("Error in Query55".mysqli_error($GLOBALS["___mysqli_ston"]));
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,onlineamount,bankcode)values('$descriptionname','$descriptionrate','$descriptionquantity','$descriptionamount','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','ONLINE','$descriptionamount','$chequecode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						
			 }
			 else if($_REQUEST['mpesa'] > 0)
			 {
			 $query55 = "select * from financialaccount where transactionmode = 'MPESA'";
			 $exec55 = mysqli_query($GLOBALS["___mysqli_ston"], $query55) or die ("Error in Query55".mysqli_error($GLOBALS["___mysqli_ston"]));
			 $res55 = mysqli_fetch_array($exec55);
			 $mpesacode = $res55['ledgercode'];
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,creditamount,mpesacode)values('$descriptionname','$descriptionrate','$descriptionquantity','$descriptionamount','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','MPESA','$descriptionamount','$mpesacode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
						
			 }
			 else if($_REQUEST['creditcard'] > 0)
			 {
			 ...
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,cardamount,bankcode)values('$descriptionname','$descriptionrate','$descriptionquantity','$descriptionamount','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CREDIT CARD','$descriptionamount','$chequecode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		{	
			if($_REQUEST['cash'] > 0)
			 ...
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,cashamount,cashcode)values('$descriptioncharge','$descriptionchargerate','$descriptionchargequantity','$descriptionchargeamount','$descriptionchargeward','$descriptionchargebed','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CASH','$descriptionchargeamount','$cashcode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,chequeamount,bankcode)values('$descriptioncharge','$descriptionchargerate','$descriptionchargequantity','$descriptionchargeamount','$descriptionchargeward','$descriptionchargebed','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CHEQUE','$descriptionchargeamount','$chequecode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,onlineamount,bankcode)values('$descriptioncharge','$descriptionchargerate','$descriptionchargequantity','$descriptionchargeamount','$descriptionchargeward','$descriptionchargebed','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','ONLINE','$descriptionchargeamount','$chequecode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $mpesacode = $res55['ledgercode'];
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,creditamount,mpesacode)values('$descriptioncharge','$descriptionchargerate','$descriptionchargequantity','$descriptionchargeamount','$descriptionchargeward','$descriptionchargebed','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','MPESA','$descriptionchargeamount','$mpesacode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			 ...
			 $query71 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,cardamount,bankcode)values('$descriptioncharge','$descriptionchargerate','$descriptionchargequantity','$descriptionchargeamount','$descriptionchargeward','$descriptionchargebed','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CREDIT CARD','$descriptionchargeamount','$chequecode')";
			 $exec71=mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die(mysqli_error($GLOBALS["___mysqli_ston"]));													 
			 }
		...
		{	
			if($_REQUEST['cash'] > 0)
			 ...
			 $query711 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,cashamount,cashcode)values('$descriptioncharge1','$descriptionchargerate1','$descriptionchargequantity1','$descriptionchargeamount1','$descriptionchargeward1','$descriptionchargebed1','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CASH','$descriptionchargeamount1','$cashcode')";
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query711 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,chequeamount,bankcode)values('$descriptioncharge1','$descriptionchargerate1','$descriptionchargequantity1','$descriptionchargeamount1','$descriptionchargeward1','$descriptionchargebed1','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CHEQUE','$descriptionchargeamount1','$chequecode')";
			 $exec711=mysqli_query($GLOBALS["___mysqli_ston"], $query711) or die(mysqli_error($GLOBALS["___mysqli_ston"]));			
			 }
			 else if($_REQUEST['online'] > 0)
			 {
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query711 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,onlineamount,bankcode)values('$descriptioncharge1','$descriptionchargerate1','$descriptionchargequantity1','$descriptionchargeamount1','$descriptionchargeward1','$descriptionchargebed1','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','ONLINE','$descriptionchargeamount1','$chequecode')";
			 $exec711=mysqli_query($GLOBALS["___mysqli_ston"], $query711) or die(mysqli_error($GLOBALS["___mysqli_ston"]));	
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $mpesacode = $res55['ledgercode'];
			 $query711 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,creditamount,mpesacode)values('$descriptioncharge1','$descriptionchargerate1','$descriptionchargequantity1','$descriptionchargeamount1','$descriptionchargeward1','$descriptionchargebed1','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','MPESA','$descriptionchargeamount1','$mpesacode')";
			 $exec711=mysqli_query($GLOBALS["___mysqli_ston"], $query711) or die(mysqli_error($GLOBALS["___mysqli_ston"]));	
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query711 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,cardamount,bankcode)values('$descriptioncharge1','$descriptionchargerate1','$descriptionchargequantity1','$descriptionchargeamount1','$descriptionchargeward1','$descriptionchargebed1','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CREDIT CARD','$descriptionchargeamount1','$chequecode')";
			 $exec711=mysqli_query($GLOBALS["___mysqli_ston"], $query711) or die(mysqli_error($GLOBALS["___mysqli_ston"]));	
			 }
		...
		{	
			if($_REQUEST['cash'] > 0)
			 ...
			 $query712 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,cashamount,cashcode)values('$descriptioncharge12','$descriptionchargerate12','$descriptionchargequantity12','$descriptionchargeamount12','$descriptionchargeward12','$descriptionchargebed12','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CASH','$descriptionchargeamount12','$cashcode')";
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query712 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,chequeamount,bankcode)values('$descriptioncharge12','$descriptionchargerate12','$descriptionchargequantity12','$descriptionchargeamount12','$descriptionchargeward12','$descriptionchargebed12','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CHEQUE','$descriptionchargeamount12','$chequecode')";
			 $exec712=mysqli_query($GLOBALS["___mysqli_ston"], $query712) or die(mysqli_error($GLOBALS["___mysqli_ston"]));		
			 }
			 else if($_REQUEST['online'] > 0)
			 {
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query712 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,onlineamount,bankcode)values('$descriptioncharge12','$descriptionchargerate12','$descriptionchargequantity12','$descriptionchargeamount12','$descriptionchargeward12','$descriptionchargebed12','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','ONLINE','$descriptionchargeamount12','$chequecode')";
			 $exec712=mysqli_query($GLOBALS["___mysqli_ston"], $query712) or die(mysqli_error($GLOBALS["___mysqli_ston"]));	
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $mpesacode = $res55['ledgercode'];
			 $query712 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,creditamount,mpesacode)values('$descriptioncharge12','$descriptionchargerate12','$descriptionchargequantity12','$descriptionchargeamount12','$descriptionchargeward12','$descriptionchargebed12','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','MPESA','$descriptionchargeamount12','$mpesacode')";
			 $exec712=mysqli_query($GLOBALS["___mysqli_ston"], $query712) or die(mysqli_error($GLOBALS["___mysqli_ston"]));	
			 ...
			 $res55 = mysqli_fetch_array($exec55);
			 $chequecode = $res55['ledgercode'];
			 $query712 = "insert into billing_ipbedcharges(description,rate,quantity,amount,ward,bed,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,transactionmode,cardamount,bankcode)values('$descriptioncharge12','$descriptionchargerate12','$descriptionchargequantity12','$descriptionchargeamount12','$descriptionchargeward12','$descriptionchargebed12','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$coa','".$locationnameget."','".$locationcodeget."','CREDIT CARD','$descriptionchargeamount12','$chequecode')";
			 $exec712=mysqli_query($GLOBALS["___mysqli_ston"], $query712) or die(mysqli_error($GLOBALS["___mysqli_ston"]));	
			 }
	...
	foreach($_POST['medicinename'] as $key=>$value)
		...
		$exec6412c = mysqli_query($GLOBALS["___mysqli_ston"], $query6412c) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
$execv32 = mysqli_query($GLOBALS["___mysqli_ston"], $queryv32) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
$execc32 = mysqli_query($GLOBALS["___mysqli_ston"], $queryc32) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
$execf32 = mysqli_query($GLOBALS["___mysqli_ston"], $queryf32) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
  ...
  <tr>
    ...
    <td colspan="5" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		$locationnameget = $res551['locationname'];
             ...
             <tr>
						  <td colspan="4" class="bodytext31" bgcolor="#ecf0f5"><strong>IP Final Invoice</strong></td>

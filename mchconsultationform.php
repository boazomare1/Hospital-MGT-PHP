	...
	if ($res2 == 0)
	{
		...
		{		
			...
			{			
				...
				$execanc2 = mysqli_query($GLOBALS["___mysqli_ston"], $queryanc2) or die ("Error in Queryanc2".mysqli_error($GLOBALS["___mysqli_ston"]));				
			}
		 ...
		 if ($cvs != "")
			{			
				...
				$execanc3 = mysqli_query($GLOBALS["___mysqli_ston"], $queryanc3) or die ("Error in Queryanc3".mysqli_error($GLOBALS["___mysqli_ston"]));				
			}
		...
		{		 
			...
			{			
				...
				$execanc4 = mysqli_query($GLOBALS["___mysqli_ston"], $queryanc4) or die ("Error in Queryanc4".mysqli_error($GLOBALS["___mysqli_ston"]));				
			}
		...
		{		   
			...
			{			
				...
				$execanc5 = mysqli_query($GLOBALS["___mysqli_ston"], $queryanc5) or die ("Error in Queryanc5".mysqli_error($GLOBALS["___mysqli_ston"]));				
			}
...
-->
				...
				<td colspan="6" align="left" valign="middle"  bgcolor="<?php if ($errmsg == '') { echo ''; } else { echo '#AAFF00'; } ?>" class="bodytext3"><?php echo $errmsg;?>&nbsp;</td>
				 ...
				 <tr>
				  ...
				  <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>ANC Consultation</strong> <span class="bodytext32"> <img src="images/plus1.gif" width="13" height="13"   onDblClick="return funcancHideView()" onClick="return funcancShowView()"> </span></td>
			      </tr>
				  <tr id="ancid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				   <table id="presid" width="831" border="0" cellspacing="1" cellpadding="1">
					 ...
					 $execanc5 = mysqli_query($GLOBALS["___mysqli_ston"], $queryanc5) or die ("Error in Queryanc5".mysqli_error($GLOBALS["___mysqli_ston"]));
					 while($resanc5 = mysqli_fetch_array($execanc5))
					 {
				   ...
				   <tr><td colspan="10" class="bodytext3"><strong>Physical Examination ( First Visit)</strong></td></tr>
				    <?php
					 ...
					 $execanc6 = mysqli_query($GLOBALS["___mysqli_ston"], $queryanc6) or die ("Error in Queryanc6".mysqli_error($GLOBALS["___mysqli_ston"]));
					 while($resanc6 = mysqli_fetch_array($execanc6))
					 {
					 $colorloopcount = $colorloopcount + 1;
					$showcolor = ($colorloopcount & 1); 
					if ($showcolor == 0)
				   ...
				   <table id="presid" width="900" border="0" cellspacing="1" cellpadding="1">
				    <tr><td colspan="14" class="bodytext3"><strong>Present Pregnancy</strong></td></tr>
					 ...
					 $execanc7 = mysqli_query($GLOBALS["___mysqli_ston"], $queryanc7) or die ("Error in Queryanc7".mysqli_error($GLOBALS["___mysqli_ston"]));
					 while($resanc7 = mysqli_fetch_array($execanc7))
					 {
					 $colorloopcount = $colorloopcount + 1;
					$showcolor = ($colorloopcount & 1); 
					if ($showcolor == 0)
				   ...
				   <table id="presid" width="831" border="0" cellspacing="1" cellpadding="1">
				    <tr><td colspan="5" class="bodytext3"><strong>Preventive Services</strong></td></tr>
					 ...
					 $execanc8 = mysqli_query($GLOBALS["___mysqli_ston"], $queryanc8) or die ("Error in Queryanc8".mysqli_error($GLOBALS["___mysqli_ston"]));
					 while($resanc8 = mysqli_fetch_array($execanc8))
					 {
					 $colorloopcount = $colorloopcount + 1;
					$showcolor = ($colorloopcount & 1); 
					if ($showcolor == 0)
					...
					else
					{
					 ...
					 <td width="132" class="bodytext3"><?php echo $resanc8['services']; ?></td>
                       ...
                       <td bgcolor="#ecf0f5" width="502" class="bodytext3"></td>
				   ...
				   <tr>
				   <td colspan="8" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">&nbsp;</span><span class="bodytext32">
				...
				?>
				 ...
				 <tr id="reffid">
					...
					<tr id="ancfree">
					<td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Free Gyne Consultation</strong> <input type="checkbox" name="ancfreerefer" id="ancfreerefer" onClick="return insertitemr();"></td>
					</tr>
                     <!--<tr>

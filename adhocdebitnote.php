...
//get ends here
	...
	$paynowbillprefix = 'DBN-';

$paynowbillprefix1=strlen($paynowbillprefix);

$query2 = "select * from adhoc_debitnote order by auto_number desc limit 0, 1";
...
$query91 = "INSERT into master_transactionpaylater (transactiondate, transactiontime, particulars,  
		...
		'', 'paylaterdebit', '$receivableamount', '', 
...
//////////////// INSERT OF DOC IN ////////////
		...
		echo "<script>window.open('print_adhoc_debitnote.php?billno=$billnumbercode&&visitcode=$visitcode&&patientcode=$patientcode', '', 'location=yes,height=520,width=620,scrollbars=yes,status=yes');</script>";
		echo "<script> window.location.href = 'debitnotelist.php';</script>";
		exit;
...
<form name="form1" id="frmsales" method="post" action="adhocdebitnote.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
		...
		<tr>
			   ...
			   <tr>
                ...
                <td align="left" valign="top" class="bodytext3">
                	...
                	<?php
                	 $sql12="SELECT accountname as accountname,accountcode, accountnameano from master_transactionpaylater where billnumber='$bill_num_get' and transactiontype='finalize'";
                	 // -- union all SELECT accountname  as accountname from billing_ipcreditapproved where billno='$bill_num_get'
						...
						if (mysqli_num_rows($querylab12) > 0) {
							while($execlab12=mysqli_fetch_array($querylab12)){
							 ...
							 ?>
                              <option value="<?php echo $pat_accountanum; ?>"><?php echo $patientaccount_final; ?></option>
							 <?php
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
				   ...
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>Debit Notes</strong> </span></td>

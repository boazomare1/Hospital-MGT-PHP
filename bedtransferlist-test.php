	...
	<table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr >
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>Bed Transfer List </strong></td>
...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	$searchpatient = $_POST['customercode'];
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
           ...
           <?php
		   echo $query63 = "select * from ip_bedallocation where locationcode='$searchlocationcode' and (patientname like '%$searchpatient%' or patientcode like '%$searchpatient%' or visitcode like '%$searchpatient%') and recordstatus <> 'discharged' and recordstatus!='request'";
           ...
           if($res63['recordstatus']=='transfered'){
		    echo $querynw1 = "select visitcode,patientcode,recorddate,ward,bed from ip_bedtransfer where locationcode='$searchlocationcode' and patientcode = '$patientcode' and visitcode = '$visitcode' and recordstatus='' order by auto_number limit 0,1";
		  ...
		  echo $query82 = "select * from master_ipvisitentry where patientcode='$patientcode' and locationcode='$searchlocationcode' and visitcode='$visitcode' and discharge not in ('completed')";

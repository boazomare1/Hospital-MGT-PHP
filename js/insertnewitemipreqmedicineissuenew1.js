...
//	var expirydate = document.getElementById("expirydate").value;
	...
	var varmedicine_rate =Number(document.getElementById("medicine_rate").value.replace(/[^0-9\.]+/g,""));
...
/*
	...
	*/
	cal_amt=varQuantity*varmedicine_rate;
	
	if(document.getElementById('total_amt').value=='0' || document.getElementById('total_amt').value=='')
	{
	totalamount2=0;
	}
	else
	...
	totalamount1=parseFloat(totalamount2) + parseFloat(cal_amt);
...
var td5 = document.createElement ('td');
	...
	text14.onclick = function() { return btnDeleteClick(i,cal_amt); }
...
//alert('working');
	...
	var toavlquantity123 = document.getElementById("toavlquantity").value = "";

    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="1300" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td colspan="7" bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>Radiology Item Master - Existing List - Latest 100 radiology Items </strong></span></td>
...

	  {
		...
		if(isset($_REQUEST["Submit3"]))	{
			...
			<tr bgcolor="#011E6A">
						...
						<td width="11%" bgcolor="#ecf0f5" class="bodytext3"><div><strong>IP Markup</strong></div></td>
	 ...
	 /*?>	
	   ...
	   $search1 = $_REQUEST["search1"];			  
	    ...
	    $query1 = "select * from $radtemplate where itemname like '%$search1%' or categoryname like '%$search1%' and status <> 'deleted' group by itemcode order by itemcode asc LIMIT $start , $limit";

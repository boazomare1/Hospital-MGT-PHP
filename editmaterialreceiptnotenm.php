...
echo $exec23 = mysqli_query($GLOBALS["___mysqli_ston"], $query23) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
echo $res23 = mysqli_fetch_array($exec23);
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td>&nbsp;
			...
			<tr>
              <td bgcolor="#ecf0f5" class="bodytext3" colspan="8"><strong>NM Edit Material Receipt Note</strong></td>
...
?>
  <tr>
	  ...
	  <table width="716">
     <tr>
	 <td width="20" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Total Purchase Cost</td><input type="hidden" name="totalpurchaseamount1" id="totalpurchaseamount1" size="10" readonly="readonly" value="<?php echo $grandtotalamount; ?>">
	   <td width="111" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><input type="text" name="totalpurchaseamount" id="totalpurchaseamount" size="10" readonly="readonly" value="<?php echo number_format($granditemtotalamount,2,'.',','); ?>"></td>

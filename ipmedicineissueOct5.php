		...
		<tr>
			...
			<?php echo $patientaccount1; ?>	</td>	
				...
				<?php if($packcharge == 1) { echo 'Yes'; } else { echo 'No'; } ?></td>
				 ...
				 <td width="59" align="left" valign="top" class="bodytext3"><b>To Store</b></td>
...
$query2 = "select * from master_store where locationcode = '$locationcode' and recordstatus='' ";
$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
...

{
	...
	<option value="<?php echo $storecode; ?>" <?php if($storecode==$ip_req_store) echo "selected"; ?>><?php echo $res2store; ?></option> 

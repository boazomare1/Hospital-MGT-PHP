    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="opradiologyresultsviewlist.php">
...
$querynw1 = "SELECT * from resultentry_radiology where patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and recorddate between '$fromdate' and '$todate' and docnumber like '%$docnumber%' and locationcode='$res1location'";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="10" bgcolor="#ecf0f5" class="bodytext31"><div align="left"><strong>Radiology Results View</strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
			 </tr>
            <tr>
		 ...
		 $query1 = "SELECT a.* from resultentry_radiology as a join consultation_radiology as b on a.patientvisitcode=b.patientvisitcode  where a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and a.patientname like '%$searchpatient%' and a.recorddate between '$fromdate' and '$todate' and a.docnumber like '%$docnumber%' and b.locationcode='$res1location' group by a.docnumber order by a.auto_number desc";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	$colorloopcount = $colorloopcount + 1;
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="left">
			    ...
			    <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $radiologyname; ?></div></td>
		   ...
		   ?>
           <tr>
              <td bgcolor="#CCC" colspan="10" align="left" class="bodytext31"><strong>&nbsp;</strong></td>
              </tr>

        ...
        <td>
          ...
          <tbody>
			...
			<td colspan="11" align = "right" >
				<a href="excel_oprevenuereport_credit_consultation.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&locationcode=<?php echo $locationcode; ?>"><img  width="30" height="30" src="images/excel-xls-icon.png" style="cursor:pointer;"></a>
			</td>
			</tr>			
            <tr>
			...
			//this query for consultation
			 ...
			 $query1 = "select patientcode,patientname,totalamount,billdate,locationname,visitcode,doctorname,consultation_percentage,sharingamount from billing_paylaterconsultation where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL' and visitcode in (select visitcode from master_visitentry where department like '$department')";

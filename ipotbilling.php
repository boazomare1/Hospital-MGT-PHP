...
else
{
	...
	$paymentmode = $_REQUEST['billtype'];
		...
		if($pairvar!="")
		{
		$referalquery1=mysqli_query($GLOBALS["___mysqli_ston"], "insert into ip_otbilling(docno,patientcode,patientname,patientvisitcode,surgeryname,rate,billtype,accountname,consultationdate,paymentstatus,consultationtime,username,ipaddress,locationcode)values('$billnumbercode','$patientcode','$patientfullname','$visitcode','$pairvar','$pairvar1','$billtype','$account','$dateonly','pending','$timeonly','$username','$ipaddress','$locationcode')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
				        ...
				        <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>IP Surgery </strong> </span></td>
		        </tr>
				<tr id="reffid">

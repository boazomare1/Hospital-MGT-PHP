    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="Visitbyreceptionistlist.php">
		...
		<table width="658" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Visit By Receptionist</strong></td>
...
<div class="bodytext31"><a href="Visitbyreceptionist.php?cbcustomername=<?= $cbcustomername; ?>&ADate1=<?= $ADate1; ?>&ADate2=<?= $ADate2; ?>&cbfrmflag2=cbfrmflag1&slocation=<?= $location ?>" target="_blank" > <?php echo $customername; ?>  </a></div></td>			

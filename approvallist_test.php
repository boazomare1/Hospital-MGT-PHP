	   ...
	   <table width="105%" border="0" cellspacing="0" cellpadding="0"><!--2ndtablestarthere  -->
		  ...
		  <tr><!--2ndtable-1strow start here  -->
				<td width="860"><!--2ndtable-1sttd start here  -->
					<form name="cbform1" method="post" action="approvallist_test.php">
...
?>
			<tr <?php echo $colorcode; ?>><!--4rth table 3rd tr  start here  -->
				...
				<td class="bodytext31" valign="center"  align="left"><div align="left"><a href="opamend.php?patientcode=<?php echo $res1['patientcode'] ;?>&&visitcode=<?php echo $res1['patientvisitcode'] ;?>">Approve</a></div></td>
			</tr>
			<?php
			$i++;
			}

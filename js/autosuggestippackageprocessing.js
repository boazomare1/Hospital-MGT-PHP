...
AutoSuggestControlmed.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	var subtype = $('#subtypeno').val();	
	var url = "";

	var url="ajaxmedicinebuildippkgprocess.php?subtype="+subtype+"&packageid="+packageid+"&&searchmedicinename1="+searchmedicinename1+"&&searchlocation="+locationcode+"&&searchstore="+storecode+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*

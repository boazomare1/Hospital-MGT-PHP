		...
		if($parentid != '')
		{
			...
			{  
				...
				$querycr1 = "SELECT SUM(`transactionamount`) as bankamount FROM `master_transactionpaylater` WHERE (`bankcode` = '$id') AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `docno` LIKE 'AR-%' AND `transactionstatus` = 'onaccount' AND `transactionmodule` = 'PAYMENT'
							 UNION ALL SELECT SUM(-1*`transactionamount`) as bankamount FROM `master_transactionpaylater` WHERE (`accountnameid` = '$id') AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `docno` LIKE 'AR-%' AND `transactionstatus` = 'onaccount' AND `transactionmodule` = 'PAYMENT'
							 UNION ALL SELECT SUM(-1*`transactionamount`) as bankamount FROM `master_transactionpharmacy` WHERE `bankcode` = '$id' AND `transactionmodule` = 'PAYMENT' AND `docno` LIKE 'SP-%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'

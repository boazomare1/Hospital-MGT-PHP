...
if ($frm1submit25 == 'frm1submit25')
{
	...
	header("location:budgetentryviewxl.php?docno=$docno");
}
...
<body>
<form name="budget" id="budget" method="post" action="budgetentryapproved.php">
    ...
    <td width="99%" valign="top"><table width="1214" border="0" cellspacing="0" cellpadding="0">
      <tr>
       <td width="96%"><table width="78%" border="0" align="left" cellpadding="4" cellspacing="4" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		  <tr bgcolor="#011E6A">
		  <td bgcolor="#ecf0f5" class="bodytext3" colspan="5" align="left"><strong>Budget Entries - Approved</strong></td>
		...
		<form name="form1" id="form1" method="post" action="budgetentryapproved.php">
		<tr>
        <td width="4%">&nbsp;</td><td width="96%"><table width="67%" border="1" align="left" cellpadding="4" cellspacing="4" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		  ...
		  <tr bgcolor="#0033FF">
			...
			<td width="146" align="center" class="bodytext3" style="color:#FFFFFF"><strong><?php echo $premonth; ?></strong></td>
			<td width="121" align="center" class="bodytext3" style="color:#FFFFFF"><strong><?php echo 'Markup %'; ?></strong></td>
			<td width="121" align="center" class="bodytext3" style="color:#FFFFFF"><strong><?php echo 'Markup Amt'; ?></strong></td>
			<td width="150" align="center" class="bodytext3" style="color:#FFFFFF"><strong><?php echo 'Projection for '.$desc.' '.$budgetyear; ?></strong>
		  ...
		  <?php
			...
			<td align="right" class="bodytext3" style="color:#FFFFFF"><strong><input type="text" name="<?php echo 'P|'.$snocount; ?>" id="<?php echo 'P|'.$snocount; ?>" size="10" value="<?php echo $markup; ?>" onKeyUp="return Calc(this.id)" readonly style="text-align:right;font-weight:bold;background-color:transparent; border:none;" autocomplete="off"></strong></td>
			<td align="right" class="bodytext3" style="color:#FFFFFF"><strong><input type="text" name="" size="10" value="<?php echo number_format($markupamount,2); ?>" readonly style="text-align:right;font-weight:bold;background-color:transparent; border:none;" autocomplete="off"></strong></td>
			...
			<input type="hidden" name="submit23" value="Update Budget" style="border:solid 1px #000066;">&nbsp;&nbsp;&nbsp;
			<input type="submit" name="excel" value="Export Excel" style="border:solid 1px #000066;" onClick="javascript: document.getElementById('xlexport').value='Excel';"></td>
			</tr>

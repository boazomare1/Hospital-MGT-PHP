...
function ajaxprocessACCS26()
{
	...
	var url = "";
	var url="autoradiologycodesearch2.php?RandomKey="+Math.random()+"&&radiologysearch="+radiologysearch+"&&patienttypesearch="+varpatienttype1+"&&varpaymenttype="+varpaymenttype+"&&locationcode="+locationcode;
    //alert(url);

...
?>
           <?php
 		$query1 = "select patientfullname, patientcode, accountname,billtype, gender, age, consultingdoctor, nhifid, subtype, type from master_ipvisitentry where patientcode='$patientcode' and visitcode='$visitcode'";
       ...
       $to_limit_date =date('Y-m-d');
		...
		<tr>
			<td width="169" align="left" valign="center" class="bodytext31"><strong>Category:</strong></td> 
			...
			if($packchargeapply == 1)
		{
			...
			?>
			  <tr>
			 <td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
			    <td width="74" class="bodytext31" valign="center"  align="left"><?php echo date("m/d/y", strtotime($consultationdate)); ?></td>
				<td width="80" class="bodytext31" valign="center"  align="left"><?php echo $viscode; ?></td>
			 <td width="242" class="bodytext31" valign="center"  align="left"><?php echo 'Admission Charge'; ?></td>
			     <td width="49" class="bodytext31" valign="center"  align="right"><?php echo '1'; ?></td>
                <td width="70" class="bodytext31" valign="center"  align="right"><?php echo number_format($consultationfee,2,'.',','); ?></td>
			...
			<?php
					  ...
					  $packageamount = 0;
			 $query731 = "select package,consultationdate,packagecharge,doctorType,age from master_ipvisitentry where visitcode='$visitcode' and patientcode='$patientcode'";
			...
			$query741 = "select packagename, days from master_ippackage where auto_number='$packageanum1'";
			...
			if($packageanum1 != 0)
	{
	 ...
	 $reqdate = date('Y-m-d',strtotime($packagedate1) + (24*3600*$reqquantity));
		...
		<tr>
			<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
			<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($packagedate1)); ?></td>
					...
					foreach($tmp as $rslt)
					{
					  ...
					  ?>
								<tr <?php echo $colorcode; ?>>
									...
									<td width="74" class="bodytext31" valign="center"  align="left"><div align="left"><?php echo date("m/d/y", strtotime($bedallocateddate)); ?></div></td>
					...
					while($res91 = mysqli_fetch_array($exec91))
					{
						...
						if($bedcharge=='0')
						{
						  ...
						  ?>
									<tr <?php echo $colorcode; ?>>
										<td width="49" class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $sno = $sno + 1; ?></div></td>
										<td width="74" class="bodytext31" valign="center"  align="left"><div align="left"><?php echo date("m/d/y", strtotime($date)); ?></div></td>
										<td width="80" class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $wdesc; ?></div></td>
										<td width="242" class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $charge1; ?>(<?php echo $bedname; ?>)</div></td>
										<td width="49" class="bodytext31" valign="center"  align="left"><div align="right"><?php echo $quantity; ?></div></td>
										<input type="hidden" name="descriptioncharge[]" id="descriptioncharge" value="<?php echo $charge; ?>">
...
while (strtotime($from_limit_date) <= strtotime($to_limit_date)) {
			...
			$query23 = "select entrydate, itemname, itemcode, rate, ipdocno, quantity, freestatus from pharmacysales_details where locationcode='$locationcode' and visitcode='$visitcode' and patientcode='$patientcode' and freestatus = 'No' and entrydate='$from_limit_date' GROUP BY ipdocno,itemcode";
		...
		<tr>
			<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
			  <td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date('m/d/y', strtotime($phadate)); ?></td>
			 ...
			 <td width="94" class="bodytext31" valign="center"  align="right"><?php echo $resamount; ?></td>
	...
	$fxrate = $original_fxrate;
		...
		<tr>
			<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
			<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($labdate)); ?></td>
		...
		<tr>
			<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
			<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($raddate)); ?></td>
			...
			<tr>
				<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
				<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($serdate)); ?></td>
		...
		<tr>
			<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
			<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($otbillingdate)); ?></td>
			...
			while($res621 = mysqli_fetch_array($exec621))
		   {
			...
			<tr>
				<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
				<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($privatedoctordate)); ?></td>
			...
			while($res63 = mysqli_fetch_array($exec63))
		   {
			...
			<tr>
				<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
				<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($ambulancedate)); ?></td>
			...
			while($res69 = mysqli_fetch_array($exec69))
		   {
			...
			<tr>
				<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
				<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($miscbillingdate)); ?></td>
			...
			<tr>
				<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
				<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($transactiondate)); ?></td>
			...
			?>
			  ...
			  ?>
						...
						<?php
			$totalnhifamount = 0;
			$query641 = "select consultationdate,docno,totaldays,nhifrebate,nhifclaim from ip_nhifprocessing where patientcode='$patientcode' and patientvisitcode='$visitcode'";
			...
			while($res641= mysqli_fetch_array($exec641))
		   {
			...
			<tr>
				<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
				<td class="bodytext31" valign="center"  align="left" width="74"><?php echo  date("m/d/y", strtotime($nhifdate)); ?></td>
				<td class="bodytext31" valign="center"  align="left" width="80"><?php echo $nhifrefno; ?></td>
				<td width="242" class="bodytext31" valign="center"  align="left"> <?php echo 'NHIF'; ?></td>
			...
			while($res64 = mysqli_fetch_array($exec64))
		   {
			...
			<tr>
				<td width="49" class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td>
				<td width="74" class="bodytext31" valign="center"  align="left"><?php echo  date("m/d/y", strtotime($discountdate)); ?></td>

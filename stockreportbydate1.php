      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  <tr>
              ...
              <th align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>Batch</strong></th>
              <th align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Opg.Stock</strong></div></th>
              <th align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Receipts</strong></div></th>
              <th align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Issues</strong></div></th>
              <th align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Returns</strong></div></th>
              <th align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Closing Stock</strong></div></th>
				</tr>
				<?php
				if (isset($_REQUEST["frmflag1"])) { $frmflag1 = $_REQUEST["frmflag1"]; } else { $frmflag1 = ""; }
//$frmflag1 = $_REQUEST['frmflag1'];
...
<tr>
			<td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5"><strong>Opening Balance</strong></td>
				
              <td align="left" valign="center"  
                bgcolor="#ecf0f5" class="bodytext31"><div align="left"><strong>&nbsp;</strong></div></td>
            		  <td align="left" valign="center"  
                bgcolor="#ecf0f5" class="bodytext31"><div align="left"><strong><?php echo $openingbalance; ?></strong></div></td>
				  			  <td align="left" valign="center"  
                ...
                bgcolor="#ecf0f5" class="bodytext31"><strong>  </strong></td>
       			 <td align="left" valign="center"  
                bgcolor="#ecf0f5" class="bodytext31"><strong> <?php echo $balance; ?> </strong></td>
			...
			if($store == 'all')
			{
              ...
              <a href="pdf_stockreportbydate1.php?frmflag1=frmflag1&&ADate1=<?= $AbDate1 ?>&&ADate2=<?= $AbDate2 ?>&&medicinecode=<?php echo $medicinecode; ?>&&searchitemcode=<?php echo $medicinecode; ?>&&itemname=<?php echo $searchmedicinename; ?>&&categoryname=<?php echo $categoryname; ?>&&store=<?php echo $store; ?>" target="_blank"><img src="images/pdfdownload.jpg" width="30" height="30"></a>

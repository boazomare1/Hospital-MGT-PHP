...
header('Content-Disposition: attachment;filename="oprevenuereport_refund_service.xls"');
      ...
      <tr>
        ...
        <td>
          ...
          <tbody>
			...
			$query1 = "select patientcode,patientname,servicesitemrate,billdate,locationname,patientvisitcode from refund_paylaterservices where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			?>
				...
				$query1 = "select patientcode,patientname,servicesitemrate,billdate,locationname,patientvisitcode from refund_paynowservices where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto'";

...
function insertitem3()
{
	...
	var varr1=varradRate.replace(",","");
	var varr2=parseInt(varr1);
	...
	text11.onclick = function() { return btnDeleteClick5(k,varr2); }
	...
	totalamount2=parseFloat(totalamount2) + parseFloat(varr2);
	document.getElementById("total2").value=formatMoney(totalamount2);
	document.getElementById("t3").value=totalamount2;

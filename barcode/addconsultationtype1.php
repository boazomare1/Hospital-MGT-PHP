...

{
...

	{
		...
		$query1s = "select auto_number from master_consultationtype where  department='$department' and doctorcode='$doctorcode' and consultationtype='$consultationtype' order by auto_number desc limit 1";
		...
		for($i=1; $i<=$loccountloop; $i++)
		{
		 ...
		 {
		//write here	
	$query155 = "insert into  locationwise_consultation_fees (consultation_id, department, doctorcode,doctorname, locationcode, consultationfees,review) values ('$consultation_id', '$department', '$doctorcode','$doctorname', '$loccodeget', '$locrateget','$default')";
...
<span >
 ...
 <?php $query1 = "select locationcode,locationname,prefix,suffix from master_location where status <> 'deleted' order by locationname";
	  ...
	  <span style="width:100px;float:left;line-height:20px"><?php echo $locationname;?></span>
	  </td>
        <td width="10px" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3" >
		
       &nbsp;<input type="text" name="locrate<?php echo $incr;?>" style="width:90px;"></td>
	  </tr> 

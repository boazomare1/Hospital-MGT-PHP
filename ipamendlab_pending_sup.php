  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
              ...
              <form name="cbform1" method="post" action="ipamendlab_pending_sup.php">
...

{
	...
	/*$searchpatientname = $_POST['patientname'];
	  ...
	  <tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
	        ...
	        $query1 = "select * from ipconsultation_lab where  locationcode='$searchlocationcode' and consultationdate between '$searchadate1'and '$searchadate2' $filter_qry group by patientvisitcode order by consultationdate desc"; 
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="ipamendlab_sup.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $locationcode; ?>&&menuid=<?php echo $menu_id; ?>"><strong>Amend</strong></a>			  </td>

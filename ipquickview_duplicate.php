...
<table  class="modal-content" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
	...
	$status='completed';
			...
			else
			{
			    ...
			    echo   $query2 = "select * from ipresultentry_radiology where patientvisitcode = '$visitcode' and itemcode='$pharmitemcode'  and docnumber='$labdocnumber'  group by itemname ";
				echo "</br>";
				  $exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
				  $num3233=mysqli_num_rows($exec2);
				  echo "row count".$num3233;

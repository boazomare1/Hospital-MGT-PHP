...

{
	...
	if(document.form1.amount4.value=="")

	{

		alert("Please enter amount");

		document.form1.amount4.focus();
	...
	var varSerialNumber41 = document.getElementById("serialnumberdoc").value;
	...
	var varamount = document.getElementById("amount4").value;
...
*/
	...
	var package_consulation_amt = $('#pkg_tot_cons_amt').val();
var total_added_amt = calculate_items_total_doctor();
var doctor_used_amt = $('#doctor_used_amt').val();
console.log('doc used'+doctor_used_amt)
var final_total_added_amt = parseFloat($('#amount4').val()) + parseFloat(total_added_amt);
var all_added_used_amt = parseFloat($('#amount4').val()) + parseFloat(total_added_amt) + parseFloat(doctor_used_amt);

if( parseFloat(final_total_added_amt) > parseFloat(package_consulation_amt) )
{
	alert('Consulation Amount exceeds Package Consultation Amount');
	return false;
}

if( parseFloat(all_added_used_amt) > parseFloat(package_consulation_amt) )
{
	alert('Consulation Amount exceeds Package Consultation Amount');
	return false;
}
	
$('#ct_items_subtotal').val(formatMoney(final_total_added_amt));
$('#ct_items_subtotal_val').val(final_total_added_amt);

calculate_items_grand_total();
calculate_package_variance();


    document.getElementById ('insertrow44').appendChild (tr);
	...
	document.getElementById("serialnumberdoc").value = parseInt(n) + 1;
	...
	//var vardocfee = document.getElementById("docfee").value = '';

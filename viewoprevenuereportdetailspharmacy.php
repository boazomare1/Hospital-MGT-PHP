...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="601" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Pharmacy</strong></td>
			...
			$query1 = "select * from billing_paynowpharmacy where billdate between '$ADate1' and '$ADate2' and accountname = 'CASH - HOSPITAL' ";
...
*/	
		   ...
		   ?>
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="right"><?php echo number_format($res1consultationamount,2,'.',','); ?></td>
			...
			$query1 = "select * from billing_externalpharmacy where billdate between '$ADate1' and '$ADate2'";
...
-->		
          ...
          <tr>
			...
			<a href="viewoprevenuereportdetailspharmacyxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>

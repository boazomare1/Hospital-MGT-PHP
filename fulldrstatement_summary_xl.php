...
<table width="700" border="0" cellspacing="0" cellpadding="2">
          <tbody>
          	...
          	<tr bgcolor="#ffffff">
            <td colspan="18"  align="center" valign="center"  ><strong>Doctor Wise Summary Statement</strong></td>
			 ...
			 <!-- <tr >
              ...
              <td  valign="center"  align="left"><?php  echo $snocount_invoice = $snocount_invoice+1; ?></td>
               ...
               <td  valign="center"  align="left" width="15%"><?php  echo $doctorname; ?></td>
                <td  valign="center"  align="left" width="15%"><?php  echo $patientname; ?></td>
              ...
              <td  valign="center"  align="left">
               ...
               <td  valign="center"  align="right">
                ...
                <div ><?php echo number_format($totalat1,2,'.',','); ?></div></td>

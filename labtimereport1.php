...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	//$transactiondateto = $_REQUEST['ADate2'];
		...
		$queryn21 = "select * from consultation_lab where publishstatus = 'completed' and locationcode='".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and resultdoc like '%$docnumber%' and consultationdate between '$fromdate' and '$todate'";
          ...
          <tbody>
            ...
            <tr>
              <td width="2%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Test</strong></div></td>
                <td width="19%"  align="left" valign="center" 
           ...
           <?php
		  $query23 = "select * from consultation_lab where publishstatus = 'completed' and locationcode='".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and resultdoc like '%$docnumber%' and consultationdate between '$fromdate' and '$todate'";

...
$updatedatetime = date('Y-m-d H:i:s');
	...
	if ($res2 == 0)
	{
		...
		values('$consultationid','$patientcode','$patientfullname','$visitcode','$pairvar113','$pairvar114','$accountname','$currentdate','$timestamp','$lname','$lcode')";
		...
		$query88 = "insert into master_consultation(consultation_id,patientcode,patientauto_number,patientname,patientvisitauto_number,patientvisitcode,recordstatus,recorddate,ipaddress,consultingdoctor,billtype,accountname,paymentstatus,sys,dia,pulse,temp,complaint,drugallergy,foodallergy,consultationtime,locationname,locationcode) 
				values('$consultationid','$patientcode','$patientauto_number','$patientfullname','$patientvisit','$visitcode','completed','$currentdate','$ipaddress','$consultingdoctor','$billingtype','$accountname','pending','$bpsystolic','$bpdiastolic','$pulse','$celsius','$complaint','$drugallergy','$foodallergy','$timestamp','$lname','$lcode')";
...
$maxanum = $labrefcode;
	...
	$categorylabquery1=mysqli_query($GLOBALS["___mysqli_ston"], "insert into consultation_lab(consultationid,patientcode,patientname,patientvisitcode,labitemname,labitemrate,billtype,accountname,consultationdate,paymentstatus,refno,labsamplecoll,resultentry,labrefund,locationname,locationcode)values('$consultationid','$patientcode','$patientfullname','$visitcode','$categorylabname','$categorylabrate','$billingtype','$accountname','$currentdate','$status','$labrefcode','pending','pending','norefund','$lname','$lcode')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		if($departmentreferal != '')
		{
		$newquery3=mysqli_query($GLOBALS["___mysqli_ston"], "update master_visitentry set referalconsultation='' where visitcode='$visitcode'");
		}
		else
		{
		$newquery3=mysqli_query($GLOBALS["___mysqli_ston"], "update master_visitentry set referalconsultation='completed' where visitcode='$visitcode'");
		}
		}
...
<script type="text/javascript" src="js/insertnewitem11_new.js"></script>
...
function btnDeleteClick(delID,pharmamount)
{
	...
	var curr=document.getElementById('total').value;
	var currenttotal4=Number(curr.replace(/[^0-9\.]+/g,""));
	//alert(currenttotal);
...
function btnDeleteClick1(delID1,vrate1)
{
	...
	var curr3=document.getElementById('total1').value;
	var currenttotal3=Number(curr3.replace(/[^0-9\.]+/g,""));
	//alert(currenttotal);
...
function btnDeleteClick5(delID5,radrate)
{
	...
	var curr2=document.getElementById('total2').value;
	var currenttotal2=Number(curr2.replace(/[^0-9\.]+/g,""));
	//alert(currenttotal);
...
var curr11=document.getElementById('total3').value;
var currenttotal11=Number(curr11.replace(/[^0-9\.]+/g,""));
	//alert(currenttotal);
	newtotal1= currenttotal11-vrate3;
...
function btnDeleteClick4(delID4,vrate4)
{
	...
	var currt=document.getElementById('total5').value;
	var currenttotal=Number(currt.replace(/[^0-9\.]+/g,""));
	//alert(currenttotal);
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="103%"><table   border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td colspan="6" bgcolor="#ecf0f5" class="style2">Consultation</td>
             ...
             <tr>
                <td colspan="6" align="left" valign="middle"  bgcolor="<?php if ($errmsg == '') { echo ''; } else { echo '#AAFF00'; } ?>" class="bodytext3"><strong><?php echo $patientfirstname.' '.$patientmiddlename.' '.$patientlastname; ?> , <?php echo $age; ?> , <?php echo $gender; ?></strong></td> <input type="hidden" name="locationcodeget" id="locationcode" value="<?php echo $locationcode;?>">
              ...
              <!--<tr>
				...
				<tr>
				  ...
				  <td colspan="2" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><lable><?php echo $address; ?></lable>                       </td>
                   ...
                   <input type="hidden" name="lcode1" id="lcode1" value="<?php echo $locationcode; ?>" readonly />
                     <input type="hidden" name="lname1" id="lname1" value="<?php echo $locationname; ?>" readonly />
				<tr>
...
-->
				...
				<td colspan="6" align="left" valign="middle"  bgcolor="<?php if ($errmsg == '') { echo ''; } else { echo '#AAFF00'; } ?>" class="bodytext3"><?php echo $errmsg;?>&nbsp;</td>
				 ...
				 <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="style2">
				   Consultation 
				 ...
				 <tr id="consltid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><textarea name="consultation"  id="consultation" cols="75"></textarea></td>
			      </tr>
				 ...
				 <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Prescription</strong> <span class="bodytext32"> <img src="images/plus1.gif" width="13" height="13"   onDblClick="return funcpresHideView()" onClick="return funcpresShowView()"> </span></td>
			      </tr>
				 <tr id="pressid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				...
				?>
				 ...
				 <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><span class="style2">Lab <img src="images/plus1.gif" width="13" height="13" onDblClick="return funcLabHideView()"  onClick="return funcLabShowView()"> </span></span></td>
			      </tr>
				 ...
				 <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><span class="style2">Radiology <img src="images/plus1.gif" width="13" height="13" onDblClick="return funcRadHideView()"  onClick="return funcRadShowView()"> </span></span></td>
		        </tr>
				 <tr id="radid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				    <table id="presid" width="621" border="0" cellspacing="1" cellpadding="1">
				 ...
				 <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><span class="style2">Services <img src="images/plus1.gif" width="13" height="13" onDblClick="return funcSerHideView()" onClick="return funcSerShowView()"> </span></span></td>
		        </tr>
				 <tr id="serid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				    <table id="presid" width="621" border="0" cellspacing="1" cellpadding="1">
				 ...
				 <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><span class="style2">Referral <img src="images/plus1.gif" width="13" height="13"  onDblClick="return  funcRefferalHideView()" onClick="return funcRefferalShowView()"> </span></span></td>
		        </tr>
				 <tr id="reffid">
				    <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				    <table id="presid" width="621" border="0" cellspacing="1" cellpadding="1">
		        ...
		        <tr>
				   <td colspan="8" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">Total</span><input type="text" id="totalr" readonly size="7"></td></tr>
				  	 		  ...
				  	 		  <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><span class="style2">Special Clinic <img src="images/plus1.gif" width="13" height="13"  onDblClick="return  funcExRefferalHideView()" onClick="return funcExRefferalShowView()"> </span></span></td>
		        </tr>
				<tr id="exreffid">
				 <td colspan="8" align="center" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><a target="_blank" href="appointmentscheduleentry.php?patientcode=<?php echo $patientcode; ?>">Special Clinic Appointment</a></td>
				</tr>
				 <tr id="exreffid1">
				    <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
                ...
                <td colspan="6" align="middle"  bgcolor="#ecf0f5"><div align="right" > <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <input name="Submit222" type="submit"  value="Save Consultation" onClick="return fortreatment()" class="button"/>

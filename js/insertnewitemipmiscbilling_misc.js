...
function insertitem5()
{
	...
	if(document.form1.accountsearch.value=="")
	{
		alert("Please select valid account");
		document.form1.accountsearch.value=="";
		document.form1.accountsearch.focus();
		return false;
	}
	...
	var varaccountname= document.getElementById("accountsearch").value;

...
$query27=mysqli_query($GLOBALS["___mysqli_ston"], "update consultation_lab set paymentstatus='completed' where patientvisitcode='$visitcode'");
...
?>
<?php
$querylab1=mysqli_query($GLOBALS["___mysqli_ston"], "select * from consultation_lab where patientcode='$patientcode'");
        ...
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
               ...
               <td bgcolor="#ecf0f5" class="bodytext3"><strong>   Lab Bill No. </strong></td>

...
?>
	...
	<thead>
		...
		<tr>
			...
			<td colspan="11" class="bodytext31"  valign="middle"  align="center" >&nbsp;</td>  

		</tr>

		<tr>

			<td colspan="11" class="bodytext31"  valign="middle"  align="center" ><strong>Supplier Statement </strong></td>  
		...
		<tr >
			...
			<td colspan="11"  align="left" valign="middle" bgcolor="#ffffff" class="bodytext31"><strong><?php echo $res21accountname;?> (Date From: <?php echo $ADate1; ?> Date To: <?php echo $ADate2;?>)</strong></td>
		...
		<tr>
              ...
              <td align="left" valign="middle"  bgcolor="#ffffff" class="bodytext31"><strong>GRN No.</strong></td>
              <td align="left" valign="middle"  bgcolor="#ffffff" class="bodytext31"><strong>PO No.</strong></td>
			...
			$query_acc = "select * from master_accountname where id = '$id'";
				...
				$querycr1op = "SELECT sum(-1*`transactionamount`) as payables, suppliercode as code, CONCAT('Payment - ',remarks) as name, docno as docno, transactiondate as date,chequenumber as chequenum FROM `master_transactionpharmacy` WHERE `suppliercode` = '$id' AND `transactionmodule` = 'PAYMENT' AND (`docno` LIKE 'SP%' or `docno` LIKE 'SPE%') AND `transactiondate` < '$ADate1'
						...
						/////////////// for wht //////////////
		  $wh_tax_value=0;
		   $query222 = "select sum(wh_tax_value) as wh_tax_value from purchase_details where suppliercode = '$id' and entrydate < '$ADate1' group by suppliercode";
...
$totalamount420 =$res451transactionamount-($totalpayment + $returnamount);
	...
	$totalat = $totalat + $res45transactionamount;
           ...
           <tr >
              ...
              <!-- <td class="bodytext31" valign="center"  align="left"><?php echo $ponumbers_unique  ?></td> -->
...

	{
	 ...
	 $totalat = $totalat - $total;
           ...
           <tr >
			  ...
			  <td class="bodytext31" valign="middle"  align="left"><?php echo $res85supplierbillnumber; ?></td>
	 ...
	 $totalat = $totalat - $total;
           ...
           <tr>
              ...
              <td  width="100" class="bodytext31" valign="middle"  align="right">   </td>
				...
				<td  width="40" class="bodytext31" valign="middle"  align="center"> <?php echo $days_between;?> </td>
		...
		<tr>
			...
			<td colspan="10" class="bodytext31" valign="middle"  align="left" bgcolor="#FFFFFF">&nbsp;

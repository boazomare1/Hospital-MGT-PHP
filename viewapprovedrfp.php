	...
	//echo "<br>".$itemcode;
	   ...
	   $acknow = $check;
		...
		{	
			...
			{
		     $query43="insert into purchase_rfqrequest(date,docno,medicinename,medicinecode,quantity,packagequantity,rate,amount,username,approvalstatus,grandapprovalstatus,status,companyanum,location)values
		                 ('$dateonly','$docno','$medicinename','$medicinecode','$reqqty','$pkgqty','$rate','$amount','$username','approved','approved','RFA','$companyanum','$location')";
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="1031" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td>&nbsp;
			...
			<tr>
              <td bgcolor="#ecf0f5" class="bodytext3" colspan="8"><strong>Approve RFQ</strong></td>
			  ...
			  <tr>
				...
				<input name="docno" id="docno" value="<?php echo $docno; ?>" style="border: 1px solid #001E6A;" size="10" autocomplete="off" readonly="readonly"/>                  </td>
...
?>
  <tr>
	  ...
	  <table width="716">
     <tr>
	 <td width="66" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
	   <td width="111" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
	    <td width="47" align="center" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Discard</td>
	   <td width="60" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"> <input type="checkbox" name="discard" value="<?php echo $docno; ?>"></td>
	   ...
	   <td width="120" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"> <input type="checkbox" id="selectall" onClick="selectAll(this)"></td>
		 ...
		 <tr>
				   <td colspan="3" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Add Medicine</strong></td>
			      </tr>	
				  <tr>
				   <td colspan="3" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
			      </tr>	
		<tr id="pressid">
				   <td colspan="13" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				   <table id="presid" width="621" border="0" cellspacing="1" cellpadding="1">
				    ...
				    <tr>
				   <td colspan="10" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">Total</span><input type="text" id="total" readonly size="7"></td>
			      </tr>				
		        
      <tr>
        
		 <td width="114" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Username</strong></td>
         <td width="62" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><?php echo $username; ?></td>
         <td width="540" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
         <td width="315" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><input type="hidden" name="frm1submit1" value="frm1submit1" />

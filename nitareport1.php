...
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   <td width="1%" align="left" valign="top">&nbsp;</td>
    <td  valign="top">
	<form name="form1" id="form1" method="post" action="nitareport1.php" onSubmit="return from1submit1()">
   ...
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tbody>
	<tr bgcolor="#FFFFFF">
	<td colspan="7" align="center" class="bodytext3"><strong>MONTHLY PAYROLL RETURN TO NITA</strong></td>
	</tr>
	<tr bgcolor="#ecf0f5">
	<td colspan="7" align="left" class="bodytext3"><strong>NITA Report</strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="7" align="left" class="bodytext3"><strong>EMPLOYER'S PIN : <?php echo $pinnumber; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<td width="276" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>NAME</strong></td>
	<td width="85" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>PIN NO</strong></td>
	...
	<td align="right" class="bodytext3" width="73">50</td>
	<?php $totalamount += 50;
	}
	}
	 ?>
	...
	<tr>
	<td colspan="5" align="left" class="bodytext3"><a href="print_nitareport1.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/pdfdownload.jpg" height="40" width="40"></a>
	&nbsp;&nbsp;&nbsp;<a href="print_nitareportxl.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/excel-xls-icon.png" height="40" width="40"></a>
	&nbsp;&nbsp;&nbsp;<a href="print_nitareportcsv1.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>">CSV Report</a></td>
	</tr>
	</tbody>
	</table> 
	<?php 

          ...
          <tbody>
            ...
            <tr>
              ...
              <td  align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
						...
						$query1 = "select * from master_employeelocation where   username='$username' group by locationname order by locationname";
						$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
						$loccode=array();
		 ...
		 <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="80%" align="left" border="0">
          <tbody>
			...
			<?php
				...
				{
			?>
				<td colspan="11" align="right" valign="right" ><a target="_blank" href="print_dispatch_reportby_subtype_detailed.php?cbfrmflag1=cbfrmflag1&ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>&&searchsuppliername=<?php echo $searchsuppliername; ?>&&location=<?php echo $location; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>

             </tr>
				<tr>
						  <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31" width=""><strong>Sno</strong></th>
						  <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Doc No</strong></th>
						  <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Bill No</strong></th>
						  <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Bill Date</strong></th>
						  <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Patient Name</strong></th>
						  <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Patient Code</strong></th>
						  <!--<th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width="10%"><strong>Visit Code</strong></th>-->
						  <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Provider</strong></th>
						  <!-- <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Account</strong></th>-->
						 <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Bill Amt.</strong></th>
						  <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Dispatched By</strong></th>
						  <th align="left" valign="center" bgcolor="#ffffff" class="bodytext31"  width=""><strong>Dispatched Date</strong></th>
				<tr>
				
			<?php
			$grandtot='0.00';
				if($searchsuppliername!='')
			    $query25 = "select auto_number,subtype from master_subtype where  subtype = '$searchsuppliername' and auto_number<>'1'";
				else
				$query25 = "select auto_number,subtype from master_subtype where auto_number<>'1'";	
			...
			?>
			<tr bgcolor="#cbdbfa" onClick="showsub(<?=$searchsubtypeanum1?>)">
			...
			<tbody id="<?=$searchsubtypeanum1?>" style="display:none">
			<?php
						$indtot='0.00';
					   ...
					   <tr >
						...
						<td colspan="2"  align="right" valign="center" bgcolor="" class="bodytext31">&nbsp;</td>
                       </tr>
			...
			<?php } ?>
						...
						<td colspan="2"  align="right" valign="center" class="bodytext31">&nbsp;</td>
                       </tr>

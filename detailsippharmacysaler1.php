  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Pharmacy Sales  Details</strong></td>
              <td width="10%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
              </tr>            
        ...
        <?php
		$totalpharmacysale = 0;
		$query66 = "SELECT patientcode,billdate,patientvisitcode, sum(amountuhx) as rateuhx FROM `billing_ippharmacy` WHERE billdate BETWEEN '$ADate1' AND '$ADate2' and patientvisitcode in(select visitcode from master_ipvisitentry where accountname ='$acc_id') group by patientvisitcode";
		...
		while($res66 = mysqli_fetch_array($exec66))
		{
			...
			$totalpharmacysaleamount = $res66['rateuhx'];
			 $sno=$sno+1;
...
-->		<!--<tr>
			...
			<a href="detailsippharmacysalerxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>
			</tr>-->
          </tbody>
        </table>

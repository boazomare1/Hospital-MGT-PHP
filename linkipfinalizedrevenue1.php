...
<script src="js/datetimepicker_css.js"></script>
	...
	$totalpharmacysaleamount = array_sum($crresultphar);
			  ...
			  $j = 0;
					...
					$j = 0;
						$crresultser = array();
						$querycr1ser = "SELECT SUM(`servicesitemrateuhx`) as income FROM `billing_ipservices` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'  and wellnessitem <> '1'";
		...
		$j = 0;
						...
						$crresultin = array();
								$querycr1bed = "SELECT SUM(`amountuhx`) as income FROM `billing_ipbedcharges` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2'";

...
function ajaxprocessACCS30()
{
	...
	//alert(referalsearch);
	var url = "";
	var url="autoreferalcodesearch2.php?RandomKey="+Math.random()+"&&referalsearch="+referalsearch+"&&locationcode="+locationcode+"&&subtype="+subtype;
    //alert(url);
...
{ 
	...
	//{
		...
		document.getElementById("rate4").value = formatMoney(varreferalRate);

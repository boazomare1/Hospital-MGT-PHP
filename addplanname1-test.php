      ...
      <tr>
        ...
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            ...
            <tr>
              ...
              <td><form name="form1" id="form1" method="post" action="addplanname1-test.php" onSubmit="return addplanname1process1()">
...
-->
                ...
                <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tr bgcolor="#011E6A">
                        ...
                        <td colspan="11" bgcolor="#ecf0f5" class="bodytext3"><strong><input type="text" id="plansearch" name="plansearch" value="" size="30" placeholder="Plan Search">
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Plan Name Master - Existing List </strong></td>

						<td width="22%" bgcolor="#ecf0f5" class="bodytext3"><strong>Sub Type</strong></td>

                        <td width="22%" bgcolor="#ecf0f5" class="bodytext3"><strong>Account</strong></td>

                        <td bgcolor="#ecf0f5" class="bodytext3"><strong>Fixed Amt </strong></td>

                        <td width="12%" bgcolor="#ecf0f5" class="bodytext3"><strong>Percentage</strong></td>

                        <td width="12%" bgcolor="#ecf0f5" class="bodytext3"><strong>Validity End </strong></td>
	    ...
	    $query1 = "select * from master_planname where recordstatus <> 'deleted' and auto_number='963' order by planname limit 50";
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<td width="34%" align="left" valign="top"  class="bodytext3"><?php echo $subtype; ?> </td>
                ...
                <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td bgcolor="#ecf0f5" class="bodytext3"><strong>Validity End </strong></td>
        ...
        <tr <?php echo $colorcode; ?>>
                        ...
                        <td width="29%" align="left" valign="top"  class="bodytext3"><?php echo $planname; ?></td>
						 ...
						 <td width="29%" align="left" valign="top"  class="bodytext3"><?php echo $subtype; ?></td>

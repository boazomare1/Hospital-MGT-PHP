...
if (isset($_REQUEST['update'])){
		...
		$itemcodes= $_REQUEST['newserselect'];
		 for($i=0;$i<$numrow;$i++){
		//echo $i."<br>";
		 $query1 = "select * from master_services where itemcode = '".$itemcodes[$i]."' order by auto_number ";
	...
	//	$auto_number = $res1["auto_number"];
		...
		$incrementalqty = $res1["incrementalquantity"];
		$rate2 = $res1['rate2'];
		$rate3 = $res1['rate3'];
		$pkg=$res1['pkg'];
$slab=$res1['slab'];
		...
		$query1 = "insert into $sertemplate (itemcode, itemname, categoryname,purchaseprice, rateperunit, rate2, expiryperiod, ipaddress, updatetime,locationcode,ipmarkup, pkg, incrementalrate,itemname_abbreviation,description,baseunit,incrementalquantity, rate3,slab,taxname,taxanum) 
			values ('$itemcode', '$itemname', '$categoryname','".$purchaseprice."', '".$rateperunit."','".$rate2."', '$expiryperiod', '$ipaddress', '$updatedatetime','".$location."','$ipmarkup','".$pkg."','$incrementalrate','$itemname_abbreviation','$description','".$baseunit."','".$incrementalqty."', '".$rate3."','".$slab."','$taxname','$taxanum')";
...
if ($st == 'del')
{
	...
	$query3 = "update $sertemplate set status = 'deleted',username = '$username',ipaddress = '$ipaddress',updatetime = '$updatedatetime' where auto_number = '$delanum'";
...
{
	$delanum = $_REQUEST["anum"];
	$query3 = "update $sertemplate set status = '',username = '$username',ipaddress = '$ipaddress',updatetime = '$updatedatetime' where auto_number = '$delanum'";
	$exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>
                ...
                <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="5" bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>services Item Master - Existing List - Latest 100 services Items </strong></span></td>
						...
						else
						{
							...
							*/
							...
							{	
								...
								//previous button
								if ($page > 1) 
									$pagination.= "<a href=\"$targetpage?sertemplate=$sertemplate&&1=$searchflag1&&search1=$search1&&page=$prev\" style='color:#3b3b3c;'>previous</a>";
								else
									$pagination.= "<span class=\"disabled\">previous</span>";	
						...
						?>
                         ...
                         <td align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31" ><a target="_blank" href="print_servicetemp.php?servicetemp=<?=$sertemplate?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>
                      </tr>
                      <tr bgcolor="#011E6A">
						...
						?>
                          ...
                          <input type="submit" name="Submit2" value="Search" style="border: 1px solid #001E6A" />
						    <input type="submit" name="Submit3" value="New Services" style="border: 1px solid #001E6A" /></td>
							
							 <td colspan="4" align="left" valign="center" bgcolor="#FFFFFF" class="bodytext31" >
				 	<a target="_blank" href="download_serviceitemtemp.php?servicetemp=<?=$sertemplate?>"> Download Temp	</a>&nbsp;
	  ...
	  if ($searchflag1 == 'searchflag1')
	  {
		...
		$search1 = $_REQUEST["search1"];
			...
			?>
			<tr bgcolor="#011E6A">
                        <td width="6%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong>Select</strong></div></td>
                        <td width="10%" bgcolor="#ecf0f5" class="bodytext3"><strong>ID / Code </strong></td>
                        <td width="10%" bgcolor="#ecf0f5" class="bodytext3"><strong>Category</strong></td>
                        <td width="28%" bgcolor="#ecf0f5" class="bodytext3"><strong>services Item</strong></td>
	    ...
	    $query1 = "select * from master_services where (itemname like '%$search1%' or categoryname like '%$search1%') and status <> 'deleted' and itemcode NOT IN (SELECT itemcode FROM $sertemplate) order by auto_number desc LIMIT $start , $limit";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
		$row= mysqli_num_rows($exec1);
	 ...
	 /*?>	
		...
		<tr bgcolor="#011E6A">
                        ...
                        <td width="28%" bgcolor="#ecf0f5" class="bodytext3"><strong>services Item</strong></td>
                        <td width="6%" bgcolor="#ecf0f5" class="bodytext3"><strong>Unit</strong></td>                       
                        <td width="9%" bgcolor="#ecf0f5" class="bodytext3"><div align="right"><strong>Charges</strong></div></td>
	 ...
	 /*?>	
        ...
        <tr <?php echo $colorcode; ?> id="<?php echo $sno;?>">
			...
			<input type="hidden" id="tablename_<?php echo $sno;?>" name="tablename_<?php echo $sno;?>" value="<?php echo $sertemplate;?>"/>
	...
	<tr bgcolor="#011E6A">
                        <td width="10%" bgcolor="#ecf0f5" class="bodytext3"><strong>ID / Code1 </strong></td>
                        <td width="10%" bgcolor="#ecf0f5" class="bodytext3"><strong>Category</strong></td>
                        <td width="28%" bgcolor="#ecf0f5" class="bodytext3"><strong>services Item</strong></td>
                        <td width="6%" bgcolor="#ecf0f5" class="bodytext3"><strong>Unit</strong></td>
                        <td width="9%" bgcolor="#ecf0f5" class="bodytext3"><div align="right"><strong>Charges</strong></div></td>
                        <td width="9%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong>Edit</strong></div></td>

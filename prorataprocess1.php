...
<script type="text/javascript" src="js/autoemployeecodesearchpro.js"></script>
<script type="text/javascript" src="js/autosuggestemployeepayrollprocess1.js"></script>
<script type="text/javascript" src="js/autocomplete_jobdescription2.js"></script>
<script type="text/javascript" src="js/autoemployeeprorata.js"></script>
<script type="text/javascript" src="js/autoemployeeloan1.js"></script>
<script type="text/javascript" src="js/autoemployeeprorataprocess1.js"></script>
...
{	
	...
	var varEmployeeWorkDays =  document.getElementById("workdays"+varActiveElementNumber).value;
	//alert (varCustomerNameCatch);
	...
	document.getElementById("searchworkdays").value = varEmployeeWorkDays;
...
<form name="form1" id="form1" method="post" action="prorataprocess1.php" onSubmit="return from1submit1()">
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tbody>
	<tr bgcolor="#FF9900">
	<td colspan="6" align="left" class="bodytext3"><strong>Prorata Payroll Process</strong></td>
	</tr>
	<tr>
	...
	<thead>
	<tr>
	<td colspan="2" class="bodytext3" align="left" bgcolor="#ecf0f5"><strong>Employee</strong>
    ...
    <td colspan="2" class="bodytext3" align="right" bgcolor="#ecf0f5"><strong>Work Days</strong>
	</tr>
	<tr>
	<td colspan="4" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
	<input name="searchsuppliername" id="searchsuppliername" accesskey="s" autocomplete="off" type="text" size="30" readonly="readonly" />
	...
	<thead>
	<tr>
	<td colspan="5" class="bodytext3" align="left" bgcolor="#ecf0f5"><strong>Payroll Components</strong>
    ...
    <input type="hidden" name="searchworkdays" id="searchworkdays" readonly="readonly"></td>
	</tr>
	<tr bgcolor="#ecf0f5">
	...
	<tr>
	<td colspan="2" align="left" class="bodytext3"><input type="button" value="Process Payroll" onClick="return PayrollProcess()"></td>
	<td colspan="4" align="left" class="bodytext3"><input type="hidden" value="Process All" onClick="return AllProcess()"></td>
	</tr>
	<tr>

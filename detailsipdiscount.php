    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Discount Details</strong></td>
        ...
        <?php
		 ...
		 $query9 = "SELECT * FROM ip_discount WHERE patientvisitcode IN (SELECT `visitcode` FROM `billing_ip` where billdate BETWEEN '$ADate1' and '$ADate2' union all SELECT `visitcode` FROM `billing_ipcreditapprovedtransaction` where billdate BETWEEN '$ADate1' and '$ADate2') and consultationdate between '$ADate1' and '$ADate2'";
		...
		$totaldiscount=$res9['rate'];

		

		$transfferdate=$res9['consultationdate'];

		//$dischargeddate=$res13['dischargeddate'];

		$docno=$res9['docno'];

		$visitcode=$res9['patientvisitcode'];
...
?>		
         ...
         <tr>
              ...
              <td colspan="4"  class="bodytext31" valign="center"  align="right" 
                ...
                bgcolor="#ecf0f5"><strong>Total Discount Amount</strong></td>

              <td align="right" valign="center" 

                bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo number_format($totaldiscountamount,2,'.',','); ?></strong></td>
...
-->		<tr>
			...
			<a href="detailsipdiscountxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>

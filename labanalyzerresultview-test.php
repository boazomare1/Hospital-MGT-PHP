    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="labanalyzerresultview-test.php">
...
?>
    	...
    	echo $query1 = "select * from resultentry_lab where patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and recorddate between '$fromdate' and '$todate' and docnumber like '%$docnumber%' and resultstatus='completed' and publishstatus = 'completed' group by docnumber order by patientvisitcode";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num1=mysqli_num_rows($exec1);
		if($num1>0)
		{
		...
		if($num1 !=0)
          ...
          <tr <?php echo $colorcode; ?>>
              <td height="45"  align="left" valign="center" class="bodytext31"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="center"><a href="print_master.php?patientcode=<?= $patientcode;?>&visitcode=<?= $visitcode;?>&fromdate=<?=$fromdate?>&todate=<?=$todate?>&docnumber=<?=$docnumber1;?>" target="_blank"><strong>Print</strong></a></td>
		...
		{
			?>
			<tr><td colspan="9" class="bodytext31" bgcolor=""><strong></strong> &nbsp;</td></tr>
		...
		if($num1 !=0)
          ...
          <tr <?php echo $colorcode; ?>>
              <td height="45"  align="left" valign="center" class="bodytext31"><div align="center"><?php echo $sno1 = $sno1 + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="center"><a href="print_master.php?patientcode=<?= $patientcode;?>&visitcode=<?= $visitcode;?>&fromdate=<?=$fromdate?>&todate=<?=$todate?>&&docnumber=<?=$docnumber;?>" target="_blank"><strong>Print</strong></a></td>
			  <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $consultationdate; ?></div></td>
				<td class="bodytext31" valign="center"  align="left">	
			    <div align="center"><?php echo $patientcode; ?></div></td>

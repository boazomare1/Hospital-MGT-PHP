...
$sno_det = 0;
   ...
   /* $searchsuppliername = $_REQUEST["suppliername"];
	...
	$qrypodetatils = "SELECT billdate,purchaseindentdocno,billnumber,suppliername,SUM(totalamount) AS totvalue,goodsstatus FROM purchaseorder_details WHERE suppliername LIKE '%$searchsuppliername%' AND billdate BETWEEN '$ADate1' AND '$ADate2' AND recordstatus<>'deleted' GROUP BY billnumber";
    ...
    <tr <?php echo $colorcode;?>>
        ...
        <td class="bodytext31" valign="middle"  align="right"><?php if($grnamount!=0){ ?><a target="_blank" ><?php echo  number_format($grnamount, 2, '.', ',');?></a><?php }  else { ?> <?php echo  number_format($grnamount, 2, '.', ',');?><?php } ?></td>

        <td class="bodytext31" valign="middle"  align="right"><?php if($grtamount!=0){ ?><a target="_blank" ><?php echo  number_format($grtamount, 2, '.', ',');?></a><?php } else { ?><?php echo  number_format($grtamount, 2, '.', ',');?> <?php } ?></td>
...

	{
		...
		<?php if($detailed_cnt == 1){ ?>
		 <tr bgcolor="#ffffff">
				...
				<td width=""  align="left" valign="middle" class="bodytext31">Rate</td>

                <td width=""  align="center" valign="middle" class="bodytext31">Ord.Qty</td>

                <td width=""  align="center" valign="middle" class="bodytext31">Free.Qty</td>

                <td width=""  align="center" valign="middle" class="bodytext31">Recd.Qty</td>

                 <td width=""  align="center" valign="middle" class="bodytext31">Recd.Free.Qty</td>

                 <td width=""  align="center" valign="middle" class="bodytext31">Bal.Qty</td>

              

                <td width=""  align="right" valign="middle" class="bodytext31">Amount</td>
...
$dompdf->stream("POAnalysisReport.pdf", array("Attachment" => 0)); 

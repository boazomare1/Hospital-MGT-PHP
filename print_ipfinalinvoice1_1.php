...
$totalbedtransferamount=0;
			...
			$ki=1;
			$querya01 = "select * from billing_ipbedcharges where locationcode='$locationcode' and visitcode='$visitcode' and patientcode='$patientcode' and docno='$billno'";
			...
			while($resca01=mysqli_fetch_array($execa01)){
				...
				$rate=$resca01['rateuhx'];
				$amount=$resca01['amountuhx'];

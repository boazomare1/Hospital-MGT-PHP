	...
	<table width="100%" border="0" align="center" cellpadding="2" cellspacing="4">
		...
		?>
		   <tr>
		     ...
		     <td width="311" align="left" valign="center" class="bodytext31">&nbsp;</td>
		   ...
		   <tr>
		     ...
		     <td width="311" align="left" valign="center" class="bodytext31"><?php echo $patientname; ?></td>
		     <td width="83" align="left" valign="center" class="bodytext31"><strong>Invoice No:</strong></td> 
		     <td width="121" align="left" valign="center" class="bodytext31"><?php echo $billno; ?></td>
          </tr>
		  
	       <tr>
             <td width="73" align="left" valign="center" class="bodytext31"><strong>Reg. No.:</strong></td>
	         <td width="311" align="left" valign="center" class="bodytext31"><?php echo $patientcode; ?></td>
	         <td width="83" align="left" valign="center" class="bodytext31"><strong>Bill Date:</strong></td> 
		     <td width="121" align="left" valign="center" class="bodytext31"><?php echo date("d/m/Y", strtotime($currentdate)); ?></td>
         </tr>
          <tr>
             <td width="73" align="left" valign="center" class="bodytext31"><strong>Bill Type:</strong></td>
	         <td width="311" align="left" valign="center" class="bodytext31"><?php echo $billtype; ?></td>
        ...
        <tr>
			...
			<td width="311" align="left" valign="center" class="bodytext31"><?php echo $accname; ?></td>
        ...
        <tr>
            <td width="73" align="left" valign="center" class="bodytext31"><strong>Category: </strong></td>
            <td width="311" align="left" valign="center" class="bodytext31"><?php echo $subtype; ?></td>
	...
	<table align="center" border="0" cellspacing="4" cellpadding="2">
		...
		<thead>
			<tr>
				...
				<td  align="left" valign="center" style="white-space:normal" width="250"
				bgcolor="#ffffff" class="bodytext31"><strong>Description</strong></td>
				<td  align="right" valign="center" width="7%"
				...
				<td  align="right" valign="center" width="16%"
					...
					while($res91 = mysqli_fetch_array($exec91))
					{
						...
						if($quantity>0 && $amount>0)
						{
							if($type=='hospital'||$charge!='Resident Doctor Charges')
							{
								...
								$totalbedallocationamount=$totalbedallocationamount+($amount)/$fxrate;
					  ...
					  ?>
								<tr>
									...
									<td class="bodytext31" valign="center"  align="left" width="250"><div align="left"><?php echo $charge; ?>(<?php echo $bedname; ?>)</div></td>
						...
						if($bedcharge=='0')
						{
							if($quantity>0 && $amount>0)
							{
								if($type=='hospital'||$charge!='Resident Doctor Charges')
								{
									...
									$totalbedtransferamount=$totalbedtransferamount+($amount)/$fxrate;
						  ?>
									<tr>
										<td class="bodytext31" valign="center"  align="left"><div align="left"><?php //echo $sno = $sno + 1; ?></div></td>
										<td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo date("d-m-Y", strtotime($date)); ?></div></td>
										<td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $refno; ?></div></td>
										<td class="bodytext31" valign="center"  align="left"><div align="left" width="250"><?php echo $charge; ?>(<?php echo $bedname; ?>)</div></td>
										<td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo $quantity; ?></div></td>
...
while (strtotime($from_limit_date) <= strtotime($to_limit_date)) {
		...
		<tr>
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left" width="250"><?php echo $sername; ?></td>
	   ...
	   <tr>
	     <td colspan="7" align="left" valign="center" bordercolor="#f3f3f3" class="bodytext31">&nbsp;</td>
		   ...
		   $exec41 = mysqli_query($GLOBALS["___mysqli_ston"], $query41) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			?>
			<tr>
				<td colspan="4" class="bodytext31" valign="center" bordercolor="#f3f3f3"  align="right"><strong><?php echo $postingaccount; ?></strong></td>

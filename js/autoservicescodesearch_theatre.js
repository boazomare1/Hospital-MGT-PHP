...
function ajaxprocessACCS27()
{
	...
	//var url = "";
	var url="autoservicescodesearch_theatre.php?RandomKey="+Math.random()+"&&servicessearch="+servicessearch+"&&patienttypesearch="+varpatienttype2+"&&varpaymenttype="+varpaymenttype+"&&locationcode="+locationcode+"&&subtype="+subtype+"&&patientcode="+patientcode;
    //alert(url);
    //console.log(url);
...
{ 
	...
	//{
		...
		document.getElementById("rate3").value = formatMoney(varservicesRate);
		...
		document.getElementById("baseunit").value = formatMoney(varservicesBase);
		
		var varservicesIncrQty = varNewLineValue[4];
		
		document.getElementById("incrqty").value = formatMoney(varservicesIncrQty);
		
		var varservicesIncrRate = varNewLineValue[5];
		
		document.getElementById("incrrate").value = formatMoney(varservicesIncrRate);

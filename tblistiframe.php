...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext31"><strong>TB List</strong> </td>
            ...
            <tr>
              ...
              <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31" colspan="3"><div align="left"><strong> Patient </strong></div></td>
             <!-- <td width="10%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Consulting Doctor </strong></div></td>-->
             
              <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31" colspan="3"><div align="left"><strong>Account</strong></div></td>
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><a href="tbconsultationform.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&frompage=iframetblist" target="_parent"><strong>Consult</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
		...
		if($num12 > 0)
		{
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left" colspan="3">
			  <div class="bodytext31"><?php echo $patientfirstname1.' '.$patientmiddlename1.' '.$patientlastname1.'('.$patientcode1.','.$visitcode1.')'; ?></div></td>
              <!--<td class="bodytext31" valign="center"  align="left">
			    <div align="left">
              ...
              <td class="bodytext31" valign="center"  align="left"><strong>Pending</strong></td>
              <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><a href="tbconsultationform.php?patientcode=<?php echo $patientcode1; ?>&&visitcode=<?php echo $visitcode1; ?>&&frompage=iframetblist" target="_parent"><strong>Consult</strong></a></div></td>
              </tr>
			<?php
			}    
			}

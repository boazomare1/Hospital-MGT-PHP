...
?>
		...
		function format_interval_dob(DateInterval $interval) {
 		...
 		$query1 = "select patientfullname, patientcode, accountname,billtype,consultationdate, gender,scheme_id, age, consultingdoctor, nhifid, subtype, type from master_ipvisitentry where patientcode='$patientcode' and visitcode='$visitcode'";

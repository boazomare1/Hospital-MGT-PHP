...
?>
<tr>
  <td align="center" valign="center" bgcolor="#ffffff" class="bodytext31" colspan="4"><strong>DAILY KPI SNAPSHOT</strong></td>
</tr>
<?php
//PREV MONTH
...
?>
<tr>
  <td width="25%" align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Details</strong></td>
  <td width="25%" align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Previous Month - <?php echo strtoupper(date('M', strtotime($ADate1.'-1 months')))." ".date('Y', strtotime($ADate1)); ?></strong></td>
  <td width="25%" align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>MTD - <?php echo strtoupper(date('M', strtotime($ADate1)))." ".date('Y', strtotime($ADate1)); ?></strong></td>
  <td width="25%" align="center" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Month Projection - <?php echo strtoupper(date('M', strtotime($ADate1)))." ".date('Y', strtotime($ADate1)); ?></strong></td>
</tr>
<tr>
  <td align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31" colspan="4"><strong>KPI's</strong></td>
</tr>
<?php
  $snocount = $snocount + 1;
...
<tr>
  <td align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31"><strong>Income Statement</strong></td>
  <td align="right" valign="center" bgcolor="#ecf0f5" class="bodytext31"><strong>000'</strong></td>
  <td align="right" valign="center" bgcolor="#ecf0f5" class="bodytext31"><strong>000'</strong></td>
  <td align="right" valign="center" bgcolor="#ecf0f5" class="bodytext31"><strong>000'</strong></td>
</tr>
<?php
...
<br/>
<?php
$kpicontent = ob_get_clean();
/*$content = ob_get_clean();
$dtime=date('Y-m-d H-i-s',strtotime("-1 day"));
$filename ='kpi-'.$dtime.'.xls';
$path=$mis_path;
if ( !file_exists($path) ) {
	 mkdir ($path, 0755);
 }

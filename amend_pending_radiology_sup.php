...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
		  <form name="cbform1" method="post" action="amend_pending_radiology_sup.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Amend Pending Radiology</strong></td>
			</tr>
			<tr>
	     ...
	     <td>	
          ...
          <tbody>
			...
			$sno = '';
			 ...
			 $query11 = "select a.patientcode as patientcode, a.patientvisitcode as patientvisitcode, a.patientname as patientname, a.accountname as accountname, a.consultationdate as consultationdate, a.paymentstatus as paymentstatus from consultation_radiology AS a where a.patientcode like '%$patientcode1' and a.patientvisitcode like '%$visitcode1%' and a.patientname like '%$patientname1%'  and a.consultationdate between '$ADate1' and '$ADate2' and a.billtype = 'PAY LATER'  group by a.patientvisitcode order by a.consultationdate DESC";
		   ...
		   $patientaccountname=$res11['accountname'];
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="amendradiology_sup.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&menuid=<?php echo $menu_id; ?>"><strong>Amend</strong></a>			  </td>
              </tr>
			<?php
			}    
			}

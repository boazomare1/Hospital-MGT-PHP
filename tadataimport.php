...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($fileformat == 'csv') // || $fileformat == 'peg') // || $fileformat == 'gif')
	{
		...
		{
			header ("location:tadataimport1.php?upload=success");
		}
		else
		{
			header ("location:tadataimport.php?upload=failed");
		}
...
if ($upload == 'failed')
{
	$errmsg = "File Upload Failed. Make Sure You Are Uploading CSV File.";
	$bgcolorcode = 'failed';
}
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form action="tadataimport.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return dataimport1verify()">
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>TA Data Import From CSV File </strong></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">&nbsp;</td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3"><strong>Only CSV Files Are Accepted. </strong></span></td>
                      </tr>
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">&nbsp;</td>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">&nbsp;</td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3"><strong>Open Sample File, Populate Date, Save as CSV File. Import Here. </strong></span></td>
                      </tr>
                      <tr>

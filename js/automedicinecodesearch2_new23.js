...
function ajaxprocessACCS24()
{
	...
	var url = "";
	var url="automedicinecodesearch2_new.php?RandomKey="+Math.random()+"&&medicinesearch="+medicinesearch+"&&accountname="+accountname;
    //alert(url);
...
{ 
	...
	//{
		...
		var paymenttypenew = document.getElementById("paymenttypenew").value;
		...
		if(paymenttypenew ==5)
		{
		var varMedicineRate = varNewLineValue[7];

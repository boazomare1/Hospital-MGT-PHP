...
$itemcode=isset($_REQUEST['itemcode'])?$_REQUEST['itemcode']:'';
 ...
 $accountquery="select accountname from master_accountname where auto_number in (select accountname from master_ipvisitentry where patientcode='$patientcode' and visitcode='$visitcode' group by visitcode)";
$exeaccount=mysqli_query($GLOBALS["___mysqli_ston"], $accountquery);
$resaccount=mysqli_fetch_array($exeaccount);
 $account=$resaccount['accountname'];

  $query612 = "select * from ipconsultation_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and resultentry = 'completed' and labitemcode='$itemcode'  order by auto_number";
...
$billdatetime1 = $res612['consultationdate'];
$billdatetime2 = $res612['consultationtime'];
$billdatetime = $billdatetime1.' '.$billdatetime2;
$sampleid = $res612['sampleid'];
$res38publisheddatetime = $res612['consultationdate'];
...
$query613 = "select * from ipresultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and docnumber like '%$docnumber%' order by auto_number desc";
...
$resultdate=$res613['recorddate'];

$query123 = "select * from ipsamplecollection_lab where patientcode = '$patientcode' and sampleid = '$sampleid' order by auto_number desc";
...
{
$query77 = "select * from ipconsultation_lab where resultdoc = '$docnumber'";
...
$billnumber=$res77['billnumber'];
  $locationcode=$res77['locationcode'];
...
<?php //include('a4pdfheader.php'); ?>
  <table width="520" cellspacing="0" cellpadding="1" border="0">
	...
	<table width="551" border="0" cellspacing="0" cellpadding="1" style="border-top:solid 1px #000000;border-bottom:solid 1px #000000;">
	       
        <tr>
			<input name="billnumberprefix" id="billnumberprefix" value="<?php echo $billnumberprefix; ?>" type="hidden" style="border: 1px solid #001E6A"  size="5" /> 
			<input type="hidden" name="patientcode" value="<?php echo $patientcode; ?>">
			<td width="49" class="bodytext27"><strong>Patient</strong></td>
		  <td width="111" align="left" valign="middle"  class="bodytext27"><?php echo $Patientname; ?>
		 &nbsp; <?php if($patientcode !='') { echo '('.$patientcode.')' ; } ?>
		  ...
		  <td width="39" align="left" valign="middle" nowrap="nowrap" class="bodytext27"><strong>Lab No</strong> </td>
		  <td width="42" align="left" valign="middle" nowrap="nowrap" class="bodytext27"><?php echo $docno; ?></td>
		  <td width="55" align="left" valign="middle" nowrap="nowrap" class="bodytext27"><strong>Visit Date</strong></td>
		  <td width="86" align="left" valign="middle" nowrap="nowrap" class="bodytext27" ><?php echo date('Y-M-d g:i:A',strtotime($billdatetime)); ?></td>
           <td width="63" class="bodytext27"><strong>Collected On </strong></td>
		  <td width="90" class="bodytext27" align="left"><?php echo date('Y-M-d',strtotime($collectedon)).' '.date('g:i:A',strtotime($collectedtime)); ?></td>
		</tr>
		...
		<tr>
		  ...
		  <td align="left" valign="top" class="bodytext27"><?php echo substr($patientgender, 0, 1);?></td>
             <td width="63" align="left" valign="top" class="bodytext27"><strong>Requested On</strong></td>
	<td width="90" align="left" valign="top" class="bodytext27"><?php if($samplecollectedon !=''){ echo date('Y-M-d g:i:A',strtotime($samplecollectedon)); }?></td>
	   ...
	   <tr>
		  ...
		  <td class="bodytext27"><?php if($res123recorddate !=''){ echo date('Y-M-d',strtotime($res123recorddate)).' '.date('g:i:A',strtotime($res123recordtime)); } ?></td>	
	  ...
	  <?php } ?>	  
        <input name="account" type="hidden" id="account" value="<?php echo $accountname; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly="readonly"/>
		  <td align="left" valign="top" class="bodytext27"><strong>&nbsp;</strong></td><td align="left" valign="top" class="bodytext27"><strong>&nbsp;</strong></td>
         <td align="left" valign="top" class="bodytext27"><strong>&nbsp;</strong></td><td align="left" valign="top" class="bodytext27"><strong>&nbsp;</strong></td>
           <td class="bodytext27"><strong>Reported On</strong></td>
		   <td class="bodytext27"><?php echo date('Y-M-d g:i:A',strtotime($resultdate)); ?></td>	
    ...
    <table width="519" border="0" cellpadding="1" cellspacing="2">
	  ...
	  <?php
	  $pendingtest = '';
	  echo $query68 = "select * from ipconsultation_lab where labitemcode not in (select itemcode from ipresultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode') and patientcode = '$patientcode' and patientcode <> 'walkin' and patientvisitcode = '$visitcode' and resultentry <> 'completed'";
	  ...
	  $referencenumbers=0;
	    ...
	    $query616 = "select * from ipresultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and docnumber = '$docnumber' and itemcode='$itemcode' order by auto_number desc";
	...
	$query32="select * from ipresultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and referencename = '$referencename1' and docnumber = '$docnumber' order by auto_number ";

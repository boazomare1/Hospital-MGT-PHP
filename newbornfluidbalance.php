...
else
{
	...
	$openingbalance = '0.00';
		...
		$referalquery1=mysqli_query($GLOBALS["___mysqli_ston"], "insert into fluidbalance(docno,patientcode,patientname,visitcode,billtype,accountname,recorddate,recordtime,username,ipaddress,iv,ivdescription,alimentary,alimentarydesc,intravenoustype,alimentarytype,bottle,amount,infused,vomitus,stool,ngast,others,urine,locationname,locationcode)values('$billnumbercode','$patientcode','$patientfullname','$visitcode','$billtype','$account','$dateonly','$timeonly','$username','$ipaddress','$iv','$ivdescription','$alimentary','$alimentarydesc','$intravenoustype','$alimentarytype','$bottle','$amount','$infused','$vomitus','$stool','$ngast','$others','$urine','$locationname','$locationcode')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));

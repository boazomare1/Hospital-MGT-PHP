...
if (isset($_REQUEST["hideicd"])) { $hideicd = $_REQUEST["hideicd"]; } else { $hideicd = 0; }
...
<td width="110" align="left" valign="center" class="bodytext31"><strong>A/c No:</strong></td>
  ...
  <tr>
    <td width="110" align="left" valign="center" class="bodytext31"><strong>Claim Number :</strong></td>
...
<tr>
 ...
 <?php
 $queryicd = "select * from consultation_icd where patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode' group by secicdcode order by auto_number DESC";
...
$query1 = "select * from master_consultationpharm where patientvisitcode='$res2visitcode' and patientcode='$res2patientcode' and medicinecode = '".$res19medicinecode."' and cash_copay!=0";
$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
$count1 = mysqli_num_rows($exec1);
$res1= mysqli_fetch_array($exec1);
if($count1>0){
$copaypharm =$cash_copay= $res1['cash_copay'];		
}
...
<?php if($planforall=='yes' || $cash_copay>0){

	$totalcopaypharm=$totalcopaypharm+$copaypharm;
...
$res11billingdatetime=$res2transactiondate;
$res11visitcode=$res2visitcode;
$res11locationcode=$locationcode;
$res11subtotalamount=$totalpayable;
$res11subtotalamount = str_replace(',', '', $res11subtotalamount);
$source_from='paylater_detailed';
...
<tr>
    <br/><br/><br/>
<td  align="left" valign="left" 
	 bgcolor="#ffffff" class="bodytext31">    <?php echo date("d/m/Y", strtotime($res2transactiondate)).' '.$res2transactiontime[0].':'.$res2transactiontime[1]; ?></td>
<td  align="left" valign="left" 
	 bgcolor="#ffffff" class="bodytext31">    <?php //echo $patientcode; ?></td>
<td  align="left" valign="left" 
	 bgcolor="#ffffff" class="bodytext31">    <?php //echo 'Copay Amount'; ?></td>

...
{ 
	...
	for (m=0;m<=varNewLineLength;m++)
	{
		...
		if(VarRes4Age =="" || varRes4AccountName =="")
		{
			//var link1=<a href="editpatient.php?patientcode=varCustomercode1" >  </a>;
	document.getElementById("edit").innerHTML="<a href='editpatient_new.php?patientcode="+varCustomercode1+"'><input type='button' value='Edit Details'/></a>";
		}
		else
		{

        ...
        <td>
          ...
          <tbody>
			...
			<td colspan="12" align = "right" >
				<a href="excel_oprevenuereport_refund_pharmacy.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&locationcode=<?php echo $locationcode; ?>"><img  width="30" height="30" src="images/excel-xls-icon.png" style="cursor:pointer;"></a>
			</td>
			</tr>
            <tr>
             ...
             <td colspan="11" bgcolor="#ecf0f5" class="bodytext3"><strong>OP Revenue &nbsp; From &nbsp;<?php echo $transactiondatefrom; ?> To <?php echo $transactiondateto; ?></strong></td>
              ...
              <tr>
				  ...
				  <td width="16%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Bill Number</strong></td>
			...
			$query1 = "select patientcode,patientname,amount,billdate,locationname,patientvisitcode,billnumber from refund_paylaterpharmacy where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			?>
				...
				$query1 = "select patientcode,patientname,amount,billdate,locationname,patientvisitcode,billnumber from refund_paynowpharmacy where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto'";
			...
			?>
			    ...
			    <?php
				 ...
				 $query1 = "SELECT `amount` as amount, patientcode, patientname, patientvisitcode, locationname, billdate,billnumber FROM `paylaterpharmareturns` WHERE locationcode='$locationcode' and billdate between  '$transactiondatefrom' and '$transactiondateto' AND ledgercode <> '' AND `billnumber` IN (SELECT b.`docno` FROM `master_transactionpaylater` as a JOIN `master_transactionpaylater` as b ON (a.`visitcode` = b.`visitcode`) WHERE a.`transactiontype` = 'finalize' and b.`transactiontype` = 'pharmacycredit' and b.`auto_number` > a.`auto_number`)";
			...
			$query1 = "select pharmacyfxamount as pharmacyfxamount, patientcode, patientname, entrydate, visitcode, locationname,billno from billing_patientweivers where locationcode='$locationcode' and entrydate between '$transactiondatefrom' and '$transactiondateto'";

...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
             ...
             <tr>
                ...
                bgcolor="#FFFFFF" class="bodytext31"> As at Date </td>
                      <td width="54%" align="left" valign="center"  bgcolor="#FFFFFF"><span class="bodytext31">
					    <input type="hidden" name="ADate1" id="ADate1" style="border: 1px solid #001E6A" value="<?php echo $ADate1; ?>"  size="10"  onKeyDown="return disableEnterKey()" />
                        <input name="ADate2" id="ADate2" style="border: 1px solid #001E6A" value="<?php echo $ADate2; ?>"  size="10" readonly onKeyDown="return disableEnterKey()" />
 ...
 <td width="54%" valign="top"><table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			<input type="text" id="credit" value="<?php echo number_format($groupright12+$netpandl,2,'.',''); ?>" readonly style="text-align:right;border:none;background:transparent; font-weight:bold;"></td>
			</tr>
			<?php
			if (isset($_REQUEST["cbfrmflag1"])) { $cbfrmflag1 = $_REQUEST["cbfrmflag1"]; } else { $cbfrmflag1 = ""; }
			//$cbfrmflag1 = $_REQUEST['cbfrmflag1'];
			...
			?>
            <tr>
			<td colspan="2" align="right"><a href="balancesheetxl.php?ADate1=<?php echo '2014-01-01'; ?>&&ADate2=<?php echo $ADate2; ?>" target="_blank"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a></td>
			</tr>
			<script type="text/javascript">
			totalsum();
			</script>
...
function ledgervalue($parentid,$ADate1,$ADate2,$tbinclude,$tbclosing)
{
	...
	if($parentid != '' && $tbinclude != '')
	{
		...
		//if($tbinclude == 'tb_accountap.php' || $tbinclude == 'tb_accountinv.php' || $tbinclude == 'tb_accountexpense.php' || $tbinclude == 'tb_accountassets.php')
		//if($tbinclude == 'tb_accountbank.php' || $tbinclude == 'tb_accountar.php' || $tbinclude == 'tb_accountincomeother.php' || $tbinclude == 'tb_accountincomerad.php' || $tbinclude == 'tb_accountincomeser.php' || $tbinclude == 'tb_accountincomephar.php' || $tbinclude == 'tb_accountincomelab.php'

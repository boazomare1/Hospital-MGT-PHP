...
//			$resamount=$resquantity*($pharate/$fxrate);
		   ...
		   $totalpharmuhx = $totalpharmuhx + $resamountuhx;
			...
			{
			$queryl51 = "select rateperunit from `master_lab` where itemcode='$labcode'";
		   ...
		   $totallabuhx = $totallabuhx + $labrateuhx;
			...
			{
			$queryr51 = "select rateperunit from `master_radiology` where itemcode='$radiologyitemcode'";
		   ...
		   $totalraduhx = $totalraduhx + $radrateuhx;
			...
			$querys51 = "select rateperunit from `master_services` where itemcode='$sercode'";
		  ...
		  //  $totaldepositamountuhx = $totaldepositamountuhx + $advancedepositamountuhx;
		   ?>
			...
			$totaldepositrefundamount = $totaldepositrefundamount + $depositrefundamount;
			 ...
			 echo $overalltotal=($totalop+$totalbedtransferamount+$totalbedallocationamount+$totallab+$totalpharm+$totalrad+$totalser+$packageamount+$totalotbillingamount+$totalprivatedoctoramount+$totalambulanceamount+$totaldiscountamount+$totalmiscbillingamount-$totaldepositamount-$totalnhifamount+$totaldepositrefundamount);

...
$accountname = $execlab['accountname'];
  ...
  <tr>
		...
		<td width="" align="left" valign="middle"    bgcolor="#FFFFFF" class="bodytext32"><strong>Patient Name</strong></td>
        
		<td width="" align="left" valign="middle"    bgcolor="#FFFFFF" class="bodytext32"><strong>Visitcode</strong></td>

		<td width="" align="left" valign="middle"    bgcolor="#FFFFFF" class="bodytext32"><strong>Patientcode</strong></td>

		<td width="" align="left" valign="middle"    bgcolor="#FFFFFF" class="bodytext32"><strong>Bed No. </strong></td>

		<td width="" align="left" valign="middle"   bgcolor="#FFFFFF" class="bodytext32"><strong>Account</strong></td>
...
<table cellspacing="3" cellpadding="0" width="750" align="left" border="0"> 
  ...
  <!-- <tr>
		...
		<td colspan="9" align="center" class="bodytext31"><strong>Visit Summary </strong></td>
...
<?php }if($weight!=''){  ?>
   ...
   <td colspan="2" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext32"><strong>BMI:</strong></td>
		...
		<td colspan="1" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext32"><strong>Discharge Date: </strong> </td>
...
<table  cellspacing="3" cellpadding="0" width="50%" align="left" border="0">
 ...
 <td colspan="3"></td>
  ...
  <tr>
	  ...
	  <td width="100" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext32"><strong>Quantity</strong></td> 
	  <td width="100" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext32"><strong>Requested Date</strong></td> 
	  <td width="100" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext32"><strong>Issued Qty</strong></td> 
	  <td width="100" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext32"><strong>Issued Date</strong></td> 
		   ...
		   $itemnameph = $res11221['itemname'];
				  ...
				  ?> 
                    ...
                    <td width="100" bgcolor="#ffffff" class="bodytext3" align="left"><?php echo $quantity; ?>&nbsp;</td>
                    <td width="100" bgcolor="#ffffff" class="bodytext3" align="left"><?php echo $res34date; ?>&nbsp;</td>


                    <td width="100" bgcolor="#ffffff" class="bodytext3"  align="left"><?php echo $issuedqty; ?>&nbsp;</td>
                    <td width="100" bgcolor="#ffffff" class="bodytext3"  align="left"><?php echo $issueddate; ?>&nbsp;</td>
...
$nsno=$nsno+1;
      ...
      <tr >
       <td class="bodytext3" valign="center"  align="left"><?php echo $nsno; ?></td>
        ...
        <td width="500"  align="left" valign="center"  class="bodytext3"  ><?php echo $notes; ?></td>
...
$nsno=$nsno+1;
	  ...
	  ?>	   
         ...
         <td width="500"  class="bodytext3" valign="center"  align="left" ><?php echo $ipdoctornotes; ?></td>

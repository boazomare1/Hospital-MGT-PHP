...
foreach($_POST['description'] as $key=>$value)
	...
	foreach($_POST['medicinecodepkg'] as $key=>$value)
		...
		if($servicesname!="")
		{
		$servicesquery1=mysqli_query($GLOBALS["___mysqli_ston"], "insert into billing_ipservices(patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,accountname,billdate,billnumber,servicecoa,locationname,locationcode,servicesitemrateuhx,curtype,fxrate,incomeledgercode,incomeledgername,doctorcode,doctorname,wellnesspkg)values('$patientcode','$patientname','$visitcode','$servicescode','$servicesname','$servicesrate','$accountname','$currentdate','$billno','$servicecoa','".$locationnameget."','".$locationcodeget."','".$servicesrateuhx."','".$curtype."','".$fxrate."','$serviceledgcode','$serviceledgname','$servicedoctorcode','$servicedoctorname','0')") or die("Error in ServiceQuery1".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);
		...
		if($privatedoctor!="")
		{
		$query52 = "insert into billing_ipprivatedoctor(description,rate,quantity,amount,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,doccoa,billstatus,doctorstatus,billtype,rateuhx,amountuhx,curtype,fxrate,pvtdr_percentage,sharingamount,transactionamount)values('$privatedoctor','$privatedoctorrate','$privatedoctorquantity','$privatedoctoramount','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','','".$locationnameget."','".$locationcodeget."','$doccoa','paid','unpaid','PAY LATER','".$privatedoctorrateuhx."','".$privatedoctoramountuhx."','".$curtype."','".$fxrate."','$pvtdrperc', '$pvtdrsharingamount','$privatedoctoramount')";
		...
		foreach($_POST['privatedoctorpkg'] as $key=>$value)
		 {
			...
			if($privatedoctor!="")
			{
			$query52 = "insert into billing_ipprivatedoctor(description,rate,quantity,amount,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,doccoa,rateuhx,amountuhx,curtype,fxrate,pkg_id,pkg_status,package_process_id,transactionamount)values('$privatedoctor','$privatedoctorrate','$privatedoctorquantity','$privatedoctoramount','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','','".$locationnameget."','".$locationcodeget."','$doccoa','".$privatedoctorrateuhx."','".$privatedoctoramountuhx."','".$curtype."','".$fxrate."','$packageid','$pkg_status','$pkg_process_row_id','".$privatedoctoramount."')";
		...
		if($miscbilling!="")
		{
		$query55 = "insert into billing_ipmiscbilling(description,rate,quantity,amount,docno,patientname,patientcode,visitcode,accountname,recordtime,recorddate,ipaddress,username,coa,locationname,locationcode,rateuhx,amountuhx,curtype,fxrate)values('$miscbilling','$miscbillingrate','miscbillingquantity','$miscbillingamount','$billno','$patientname','$patientcode','$visitcode','$accountname','$updatetime','$updatedate','$ipaddress','$username','$miscbillingcoa','".$locationnameget."','".$locationcodeget."','".$miscbillingrateuhx."','".$miscbillingamountuhx."','".$curtype."','".$fxrate."')";
		...
		mysqli_query($GLOBALS["___mysqli_ston"], "insert into billing_ipcreditapproved(billno,patientname,patientcode,visitcode,totalamount,billdate,accountname,subtype,totalrevenue,discount,deposit,nhif,depositcoa,locationname,locationcode,fxamount,curtype,fxrate,accountnameid,accountnameano)values('$billno','$patientname','$patientcode','$visitcode','$totalamount','$currentdate','$accountname','$subtype','$totalrevenue','$discount','$deposit','$nhif','$ipdepositscoa','".$locationnameget."','".$locationcodeget."','".$totalamountuhx."','".$curtype."','".$fxrate."','$accountcode','$accountanum')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		$query432="insert into master_transactionpaylater(patientname,patientcode,visitcode,transactiondate,accountname,billnumber,ipaddress,companyanum,companyname,transactiontype,paymenttype,subtype,transactionamount,username,transactiontime,locationname,locationcode,fxamount,currency,fxrate,accountcode,accountnameid,accountnameano,billbalanceamount)values('$patientname','$patientcode','$visitcode','$currentdate','$account1name','$billno','$ipaddress','$companyanum','$companyname','finalize','$paymenttype','$subtype','$account1amount','$username','$updatetime','".$locationnameget."','".$locationcodeget."','".$account1fxamount."','".$curtype."','".$fxrate."','$account1nameid','$account1nameid','$account1nameano','$account1fxamount')";
	    $exec432=mysqli_query($GLOBALS["___mysqli_ston"], $query432) or die("error in query432".mysqli_error($GLOBALS["___mysqli_ston"]));		  
		
		mysqli_query($GLOBALS["___mysqli_ston"], "insert into billing_ipcreditapprovedtransaction(billno,patientname,patientcode,visitcode,totalamount,billdate,accountname,subtype,locationname,locationcode,fxamount,currency,fxrate,accountcode,accountnameid,accountnameano)values('$billno','$patientname','$patientcode','$visitcode','$account1amount','$currentdate','$account1name','$subtype','".$locationnameget."','".$locationcodeget."','".$account1fxamount."','".$curtype."','".$fxrate."','$account1nameid','$account1nameid','$account1nameano')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		$query4312="insert into master_transactionpaylater(patientname,patientcode,visitcode,transactiondate,accountname,billnumber,ipaddress,companyanum,companyname,transactiontype,paymenttype,subtype,transactionamount,username,transactiontime,locationname,locationcode,fxamount,currency,fxrate,accountcode,accountnameid,accountnameano,billbalanceamount)values('$patientname','$patientcode','$visitcode','$currentdate','$account2name','$billno','$ipaddress','$companyanum','$companyname','finalize','$paymenttype','$subtype','$account2amount','$username','$updatetime','".$locationnameget."','".$locationcodeget."','".$account2fxamount."','".$curtype."','".$fxrate."','$account2nameid','$account2nameid','$account2nameano','$account2fxamount')";
	    $exec4312=mysqli_query($GLOBALS["___mysqli_ston"], $query4312) or die("error in query4312".mysqli_error($GLOBALS["___mysqli_ston"]));		  
		
		mysqli_query($GLOBALS["___mysqli_ston"], "insert into billing_ipcreditapprovedtransaction(billno,patientname,patientcode,visitcode,totalamount,billdate,accountname,subtype,locationname,locationcode,fxamount,currency,fxrate,accountcode,accountnameid,accountnameano)values('$billno','$patientname','$patientcode','$visitcode','$account2amount','$currentdate','$account2name','$subtype','".$locationnameget."','".$locationcodeget."','".$account2fxamount."','".$curtype."','".$fxrate."','$account2nameid','$account2nameid','$account2nameano')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		$query4321="insert into master_transactionpaylater(patientname,patientcode,visitcode,transactiondate,accountname,billnumber,ipaddress,companyanum,companyname,transactiontype,paymenttype,subtype,transactionamount,username,transactiontime,locationname,locationcode,fxamount,currency,fxrate,accountcode,accountnameid,accountnameano,billbalanceamount)values('$patientname','$patientcode','$visitcode','$currentdate','$account3name','$billno','$ipaddress','$companyanum','$companyname','finalize','$paymenttype','$subtype','$account3amount','$username','$updatetime','".$locationnameget."','".$locationcodeget."','".$account3fxamount."','".$curtype."','".$fxrate."','$account3nameid','$account3nameid','$account3nameano','$account3fxamount')";
	    $exec4321=mysqli_query($GLOBALS["___mysqli_ston"], $query4321) or die("error in query4321".mysqli_error($GLOBALS["___mysqli_ston"]));	
		
		mysqli_query($GLOBALS["___mysqli_ston"], "insert into billing_ipcreditapprovedtransaction(billno,patientname,patientcode,visitcode,totalamount,billdate,accountname,subtype,locationname,locationcode,fxamount,currency,fxrate,accountcode,accountnameid,accountnameano)values('$billno','$patientname','$patientcode','$visitcode','$account3amount','$currentdate','$account3name','$subtype','".$locationnameget."','".$locationcodeget."','".$account3fxamount."','".$curtype."','".$fxrate."','$account3nameid','$account3nameid','$account3nameano')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
<form name="form1" id="form1" method="post" action="ipcredittest.php" onSubmit="return validcheck()">	
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td colspan="8" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
		...
		$querymenu = "select subtype from master_ipvisitentry where patientcode='$patientcode' and visitcode='$visitcode'";
			...
			if($packageanum1 != 0)
	{
	 ...
	 $reqdate = date('Y-m-d',strtotime($packagedate1) + (24*3600*$reqquantity));
		   ...
		   $totalpharmuhx = $totalpharmuhx + $resamountuhx;
			...
			$querypkg = "select package,package_process from master_ipvisitentry where visitcode='$visitcode' and patientcode='$patientcode'";
  ...
  <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format(($otbillingrate/$fxrate),2,'.',','); ?></div></td>
			...
			while($res62 = mysqli_fetch_array($exec62))
		   {
			...
			$query20 = "select pvtdr_percentage from master_doctor where doctorcode = '$doccoa'";		

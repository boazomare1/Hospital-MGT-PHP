...
$consult_autonumber = $_REQUEST["consult_autonumber"];
...
if($radiologyname != "")

   {
	...
	$query76 = "update consultation_radiology set docnumber='$docnumber' where patientcode = '$patientcode' and patientvisitcode = '$visitcode'  and radiologyitemcode='$itemcode' and auto_number='$consult_autonumber' ";
...
echo '<script type="text/javascript"> window.opener.acknowledgevalid('.$print.'); window.close(); </script>';
...
<form name="frmsales" id="frmsales" method="post" FORM ENCTYPE="multipart/form-data" action="appendto.php" onKeyDown="return disableEnterKey(event)" onSubmit="return toredirect();">
		...
		<table width="1150" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					 ...
					 <input type="hidden" name="visitcode" value="<?php echo $visitcode; ?>">
					  ...
					  <input type="hidden" name="templatecode" value="<?php echo $templatecode; ?>">
					   ...
					   <input type="hidden" name="itemcode" value="<?php echo $itemcode; ?>">
					    ...
					    <input type="hidden" name="consult_autonumber" value="<?php echo $consult_autonumber; ?>">
					...
					<?php echo "Title: ".strtoupper($job_title); ?></textarea>		
	...
	config.removeButtons = 'Save,NewPage,Preview,Print,Form,Checkbox,Radio,About,Link,Unlink,Anchor,TextField,Textarea,Select,Button,ImageButton,HiddenField,Templates,Source';

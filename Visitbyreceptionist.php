          ...
          <?php
		   ...
		   $cbcustomername=$_REQUEST['cbcustomername'];
			...
			//echo 'Received';
			 ...
			 $query1 = "select username from master_visitentry where consultationdate between '$ADate1' and '$ADate2' and $pass_location group by username order by username";
			 ...
			 $cbcustomername = $res1['username'];
			 	  ...
			 	  $query7 = "select username from master_visitentry where username like '$cbcustomername' and consultationdate between '$ADate1' and '$ADate2' and $pass_location

				  UNION ALL select username from master_ipvisitentry where username like '$cbcustomername' and consultationdate between '$ADate1' and '$ADate2' and $pass_location"; 
		...
		<tr>   <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan='10' bgcolor="#ecf0f5" class="bodytext31"><?php echo 'Total No of Visits by '.$cbcustomername?>(<?php echo $numcount;?>)</td>
            ...
            <tr>
              ...
              <td width="14%"  align="left" valign="center"  
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Date of Birth</strong></div></td>
			...
			<?php
		  		  ...
		  		  $query4 = "select patientfullname,patientcode,visitcode,username,consultationdate,accountfullname from master_visitentry where username like '$cbcustomername' and consultationdate between '$ADate1' and '$ADate2' and $pass_location

				  UNION ALL select patientfullname,patientcode,visitcode,username,consultationdate,accountfullname from master_ipvisitentry where username like '$cbcustomername' and consultationdate between '$ADate1' and '$ADate2' and $pass_location"; 
		  ...
		  while($res4 = mysqli_fetch_array($exec4))

			{
				...
				$accountname = $res4['accountfullname'];

				

				$query7 = "select age,gender,dateofbirth,ageduration from master_customer where customercode ='$patientcode'"; 

				$exec41 = mysqli_query($GLOBALS["___mysqli_ston"], $query7) or die ("Error in Query41".mysqli_error($GLOBALS["___mysqli_ston"]));

		  $res41 = mysqli_fetch_array($exec41);

		  $age= $res41['age'];

		  $ageduration= $res41['ageduration'];

		  $gender= $res41['gender'];

	      $dateofbirth= $res41['dateofbirth'];
...
*/			
				...
				<div class="bodytext31"><?php echo calculate_age($dateofbirth);  ?></div></td>

...
<table width="100%" border="" align="center" class="page">
   ...
   <tr>
      <td colspan="7" align="left" class="fontsize"><strong>Delivered Invoices</strong></td>
    </tr>
	<?php
   ...
   ?>
	<tr class="delivery">
      <td colspan="7" align="left"><strong><?php echo $locationnamecheck;?></strong></td>
    </tr>
    <?php
	$totalamount = '0.00';
    ...
    <tr <?php echo $colorcode; ?> class="page">
      ...
      <td align="left" class="bodytext3"><?php echo $accountname; ?></td>

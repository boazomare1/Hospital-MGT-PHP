  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Radiology Charge Details</strong></td>
              <td width="10%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
              </tr>            
		...
		$query66 = "SELECT * FROM `billing_ipradiology` WHERE billdate BETWEEN '$ADate1' AND '$ADate2' and patientvisitcode in(select visitcode from master_ipvisitentry where accountname ='$acc_id')";
		...
		while($res66 = mysqli_fetch_array($exec66))
		{
		   ...
		   $sno=$sno+1;
				...
				$totalradiologyitemrate =$res66['radiologyitemrateuhx'];
		   ...
		   $totalradiologycharges=$totalradiologycharges+$totalradiologyitemrate;
           ...
           <tr <?php echo $colorcode; ?>>
            ...
            <td align="right" valign="center"  class="bodytext31"><div class="bodytext31"><?php echo number_format($totalradiologyitemrate,2,'.',','); ?></div></td>
           </tr>
	<?php
		}
?>		
...
-->		
			...
			<a href="detailipradiologyxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>
			</tr>-->
          </tbody>
        </table>

...
foreach($_POST['lab'] as $key => $value)
		...
		$labitemanum = $_POST['labitemanum'][$key];
		
		if($resultvalue != '')
		{
   
    $query26 ="update pending_test_orders set result='$resultvalue',edited_by = '$username',editdatetime='$updatedatetime' where patientcode='$patientcode' and visitcode='$visitcode' and testcode='$itemcode' and parametername='$refname' and sample_id ='$docnumber' and auto_number = '$labitemanum'";
...
<?php
$query65= "select * from pending_test_orders where patientcode='$patientcode' and sample_id = '$docnumber'";
...
$Patientname=$res65['patientname'];
$sampleidfull = $res65['full_sample_id'];
$testcode= $res65['testcode'];
...
$opip = substr($visitcode,-3);
if($opip == 'IPV'){
	 
	$query7 = "select * from ipconsultation_lab where patientcode='$patientcode' and patientvisitcode='$visitcode' and labitemcode='$testcode'";
	...
	$query23 = "select * from consultation_lab where patientcode='$patientcode' and patientvisitcode='$visitcode' and labitemcode='$testcode'";
	$exec23 = mysqli_query($GLOBALS["___mysqli_ston"], $query23) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	$res23 = mysqli_fetch_array($exec23);
...
<body>
<form name="frm" id="frmsales" method="post" action="editanalyserlabresult.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck1()">
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="middle"  bgcolor="<?php if ($errmsg == '') { echo '#ecf0f5'; } else { echo 'red'; } ?>" class="bodytext3"><strong><?php echo $errmsg;?>&nbsp;</strong></td></tr>
	  ...
	  <td width="22%" align="left" valign="middle" class="bodytext3" bgcolor="#ecf0f5">
			...
			<input name="visitcode" id="visitcode" type="hidden" value="<?php echo $visitcode; ?>" style="border: 1px solid #001E6A" size="18" rsize="20" readonly/><?php echo $visitcode; ?>                  </td>
			  ...
			  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style4"></span><strong>Age &amp; Gender </strong></td>
				...
				<td colspan="1" align="left" valign="top" class="bodytext3"><?php echo $sampleidfull; ?></td>
				  </tr>
				  <tr>
     ...
     <tr>
	  ...
	  $query31="select * from pending_test_orders where patientcode = '$patientcode' and visitcode = '$visitcode' and  sample_id='$docnumber' group by testname";
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            align="left" border="0">
              <tbody>
			   ...
			   $sn = 0;
			   $query52="select * from pending_test_orders where patientcode = '$patientcode' and visitcode = '$visitcode' and  sample_id='$docnumber' and testcode = '$labitemcode'";
			   $exec52=mysqli_query($GLOBALS["___mysqli_ston"], $query52);
			   $num=mysqli_num_rows($exec52);
			   while($res52=mysqli_fetch_array($exec52))
			   {
			   $labname2=$res52['testname'];
			 $itemcode2=$res52['testcode'];
				  $labunit1=$res52['parametercode'];
				   $labreferenceunit = $res52['result_unit'];
					$labreferencename = $res52['parametername'];
					$labitemanum = $res52['auto_number'];
				   //echo $labreferencerange1[0]; 
				  $labreferencevalue1='';
				  
				  $query43 = "select * from pending_test_orders where visitcode='$visitcode' and testcode = '$itemcode2' and parametername = '$labreferencename' and sample_id='$docnumber'";
				  ...
				  $res64 = mysqli_fetch_array($exec64);
				  $labreferencerange = $res64['referencerange'];
				...
				$labreferencerange1[1] = 1000000;
				 ...
				 $query49 = "select * from pending_test_orders where visitcode='$visitcode' and testcode = '$itemcode2' and parametername = '$labreferencename' order by auto_number desc limit 0,1";
				 ...
				 $pastresult = $res49['result'];
                  ...
                  <td width="434" align="center" valign="center" bordercolor="#f3f3f3" class="bodytext311"><div align="center">
                   ...
                   <input type="hidden" name="labitemanum[]" id="labitemanum<?php echo $sn; ?>" value="<?php echo $labitemanum; ?>">

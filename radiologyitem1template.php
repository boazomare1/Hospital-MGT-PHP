                    ...
                    <tbody>
                      <tr bgcolor="#011E6A">
						...
						if($searchflag1 != 'searchflag1'){
							...
							*/
							$query111 = "select * from $radtemplate where status <> 'deleted' group by itemcode order by auto_number desc ";
						...
						else
						{
							...
							/* 
							   ...
							   If you have a WHERE clause in your query, make sure you mirror it here.
							*/
							$query111 = "select * from $radtemplate where itemname like '%$search1%' or categoryname like '%$search1%' and  status <> 'deleted' group by itemcode order by auto_number desc ";
							$exec111 = mysqli_query($GLOBALS["___mysqli_ston"], $query111) or die ("Error in Query111".mysqli_error($GLOBALS["___mysqli_ston"]));
							$res111 = mysqli_fetch_array($exec111);
							$total_pages = mysqli_num_rows($exec111);
	 ...
	 /*?>	
        ...
        <tr <?php echo $colorcode; ?>>
                        ...
                        <td align="center" valign="top"  class="bodytext3"><?php echo $ipmarkup; ?></td>
						  ...
						  <div align="center">
						  <a href="edititem1radiologymaster.php?sanum=<?php echo $auto_number; ?>&&itemcode=<?php echo $itemcode; ?>&&radtemplate=<?php echo $radtemplate; ?>" class="bodytext3">Edit</a></div></td>
                      </tr>
                      <?php
		}
	}

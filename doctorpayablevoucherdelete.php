...
if($action == 'deletedoctorpaymentamount')
{
		...
		$query1222 = "update master_transactiondoctor set transactionamount = '0',$modetype ='0',taxamount='0',balanceamount='0',netpayable='0',wht_perc='0',amend_username='$user',amend_date='$updatetime' WHERE docno = '$docno'";

...
<body>
<form name="budget" id="budget" method="post" action="budgetentryfinallist.php">
    ...
    <td width="99%" valign="top"><table width="1214" border="0" cellspacing="0" cellpadding="0">
      <tr>
       <td width="6%">&nbsp;</td><td width="94%"><table width="70%" border="0" align="left" cellpadding="4" cellspacing="4" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		  <tr bgcolor="#011E6A">
		  <td bgcolor="#ecf0f5" class="bodytext3" colspan="5"><strong>Budget Entries - Finalized</strong></td>
		  ...
		  <td align="left" class="bodytext3"><a href="budgetentryfinalview.php?st=view&&docno=<?php echo $budgetno; ?>"><strong><?php echo 'View'; ?></strong></a></td>
		  </tr>
		  <?php
		  }
		  ?>

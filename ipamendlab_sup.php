...
$data=mysqli_query($GLOBALS["___mysqli_ston"], "select auto_number,patientcode,patientvisitcode,patientname,refno,labitemcode,labitemname,labitemrate from ipconsultation_lab where auto_number='$labname'");
...
mysqli_query($GLOBALS["___mysqli_ston"], "delete from ipconsultation_lab where auto_number='$labname' and patientvisitcode='$viscode'");

header('location:ipamendlab_sup.php?patientcode='.$patientcode.'&visitcode='.$visitcode.'&locationcode='.$locationcode);
...
$querylab1=mysqli_query($GLOBALS["___mysqli_ston"], "select * from ipconsultation_lab where patientcode='$patientcode'");
...
window.location='ipamendlab_sup.php?delete='+id+'&patientcode='+patient+'&&visitcode='+visit+'&locationcode='+locationcode+'&remarks-'+id+'='+msg;
}
...
<form name="form1" id="frmsales" method="post" action="ipamendlab_sup.php" onKeyDown="return disableEnterKey(event)">

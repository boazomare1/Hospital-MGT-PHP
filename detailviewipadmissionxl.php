...
header('Content-Disposition: attachment;filename="IPadmission.xls"');
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#fff" class="bodytext31"><strong>Admission Charge Details</strong></td>
              <td width="10%" bgcolor="#fff" class="bodytext31">&nbsp;</td>
              </tr>            
...
?>		
         <tr>
              <td colspan="4"  class="bodytext31" valign="center"  align="right" 
                bgcolor="#fff"><strong>Total Charges:</strong></td>

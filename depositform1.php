...
<form name="form1" id="form1" method="post" action="depositform.php?menuid=<?php echo $menuid; ?>" onSubmit="return checkvalid();">	
<table width="101%" border="0" cellspacing="0" cellpadding="2">
                ...
                <td align="left" valign="center"  
                 class="bodytext31">&nbsp;</td>
                  ...
                  <tr>
                  	...
                  	<td align="left" valign="center" class="bodytext31" bgcolor="#FFFFFF" colspan="8"> <span class="bodytext31" id="amount_in_words" style="border:none;background:none;color:#000;font:bold 15px/15px Arial, Helvetica, sans-serif"></span></td>
                  </tr> 
                 <!-- <tr>
 ...
 class="bodytext31" colspan="1" bgcolor="#FFF"><div align="right"><strong> Transaction No </strong></div></td>
                <td align="left" valign="center"  
 class="bodytext31" colspan="1" bgcolor="#FFF"><input name="cardnumber" id="cardnumber" value="" style="border: 1px solid #001E6A; text-align:left; text-transform:uppercase" size="8"  <?php if($barclayscard_integration == 1){ echo "readonly"; } ?>/><!-- iPayments HTML/PHP Code Start -->
	            <?php

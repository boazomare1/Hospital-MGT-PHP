...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="585" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Consultation</strong></td>
			...
			$query1 = "SELECT * FROM `billing_consultation` WHERE `billdate` BETWEEN '$ADate1' AND '$ADate2' and accountname = 'CASH - HOSPITAL'";
...
*/	
         ...
         <tr>
			...
			<a href="viewoprevenuereportdetailsconsultationxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>

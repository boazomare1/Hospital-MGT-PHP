...
$location = $_REQUEST['location'];
   ...
   $accountname = $_REQUEST["accountname"];
	...
	if($billtype == 'PAY NOW')
	{
		...
		if ($rowcount3 != 0)
		{
			header ("location:visitentry_op_new1.php?errorcode=errorcode1failed");
			exit();
		}	
	}
	else
	...
	$query224 = "select * from billing_paynow where visitcode='$oldvisitcode'";
	$exec224 = mysqli_query($GLOBALS["___mysqli_ston"], $query224) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	$res224 = mysqli_num_rows($exec224);
	$payrows1 = $res22 + $res224;							
	if ($payrows1 == 0)
	{
		header ("location:visitentry_op_new1.php?errorcode=errorcode1failed");
			exit();
	...
	{
	$query211 = "select * from master_visitentry where patientcode = '$patientcode' order by auto_number desc limit 0,1";
	...
	echo $payrows = $res221 + $res2214 + $res2215; exit;
...
else
{
	...
	if ($res2 == 0)
	{
		...
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,complaint,consultationrefund,locationname1,locationcode,admitid,smartbenefitno,hospitalfees,doctorfees)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$consultingdoctorcode','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$availablelimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','completed','','$age','$gender','$accname','$departmentname','$username','$triag','torefund','$locationname','$location','$admitid','$smartbenefitno','$hospitalfees','$doctorfees')"; 
		$exec56=mysqli_query($GLOBALS["___mysqli_ston"], $query56) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		
		header("location:visitentry_op_new1.php");
		exit();
}
	...
	{
	$query56="insert into master_visitentry(patientcode, visitcode, patientfirstname,patientmiddlename, patientlastname,consultationtype,consultingdoctor,consultingdoctorcode,accountname,accountexpirydate,paymenttype,subtype,planname,planexpirydate,visitlimit,overalllimit,availablelimit,billtype,
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,complaint,consultationrefund,locationname,locationcode,admitid,smartbenefitno,hospitalfees,doctorfees)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$consultingdoctorcode','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$availablelimit','$billtype','$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','completed','pendng','$age','$gender','$accname','$departmentname','$username','$triag','torefund','$locationname1','$location','$admitid','$smartbenefitno','$hospitalfees','$doctorfees')";
		$exec56=mysqli_query($GLOBALS["___mysqli_ston"], $query56) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		header("location:visitentry_op_new1.php");
	exit();
	}
	...
	$query56="insert into master_visitentry(patientcode, visitcode, patientfirstname,patientmiddlename, patientlastname,consultationtype,consultingdoctor,consultingdoctorcode,accountname,accountexpirydate,paymenttype,subtype,planname,planexpirydate,visitlimit,overalllimit,availablelimit,billtype,
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,complaint,consultationrefund,locationname,locationcode,admitid,smartbenefitno,hospitalfees,doctorfees)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$consultingdoctorcode','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$availablelimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','completed','pending','$age','$gender','$accname','$departmentname','$username','$triag','torefund','$locationname1','$location','$admitid','$smartbenefitno','$hospitalfees','$doctorfees')";
		$exec56=mysqli_query($GLOBALS["___mysqli_ston"], $query56) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		header("location:visitentry_op_new1.php");
	exit();
	}
	...
	{
		$query56="insert into master_visitentry(patientcode, visitcode, patientfirstname,patientmiddlename, patientlastname,consultationtype,consultingdoctor,consultingdoctorcode,accountname,accountexpirydate,paymenttype,subtype,planname,planexpirydate,visitlimit,overalllimit,availablelimit,billtype,
		visitcount,department,consultationdate,consultationtime,consultationfees,patientspent,planfixedamount,planpercentage,patientfullname,paymentstatus,triagestatus,age,gender,accountfullname,departmentname,username,consultationrefund,complaint,locationname,locationcode,admitid,smartbenefitno,hospitalfees,doctorfees)values('$patientcode','$visitcode','$patientfirstname','$patientmiddlename','$patientlastname','$consultationtype','$consultingdoctor','$consultingdoctorcode','$accountname','$accountexpirydate','$paymenttype','$subtype','$planname','$planexpirydate','$visitlimit','$overalllimit','$availablelimit','$billtype',
		'$visitcount','$department','$consultationdate','$consultationtime','$consultationfees','$patientspent','$planfixedamount','$planpercentageamount','$patientfullname','','','$age','$gender','$accname','$departmentname','$username','torefund','$triag','$locationname1','$location','$admitid','$smartbenefitno','$hospitalfees','$doctorfees')";
		$exec56=mysqli_query($GLOBALS["___mysqli_ston"], $query56) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	if ($res2 == 0)
	{
		...
		department,paymenttype,subtype,billtype,accountname,accountexpirydate,planname,planexpirydate,consultationdate,consultationtime,consultationtype,consultationfees,referredby,consultationremarks,complaint,registrationdate,visittype,visitlimit,overalllimit,availablelimit,visitcount,patientspent,planpercentage,planfixedamount,age,gender,accountfullname,itemrefund,departmentname,username,consultationrefund,locationname,locationcode,admitid,smartbenefitno,hospitalfees,doctorfees) 
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" action="visitentry_op_new1.php" onKeyDown="return disableEnterKey(event)" onSubmit="return process1()">
             ...
             <tr>
              ...
              <select name="location" id="location" onChange="locationform(form1,this.value); ajaxlocationfunction(this.value);"  style="border: 1px solid #001E6A;">
                ...
                <input type="hidden" name="locationcodenew" value="<?php echo $res1locationanum; ?>">
				  ...
				  <td width="14%" align="left" valign="middle"  bgcolor="#ecf0f5">&nbsp;</td>
				...
				<tr>
				 ...
				 <input type="text" name="planpercentageamount" id="planpercentageamount"  value="<?php echo $planpercentageamount;?>"   readonly="readonly" ></label> </td>
				  ...
				  <td align="left" valign="middle"  bgcolor="#ecf0f5"><input type="text" name="availablelimit" id="availablelimit"  value="<?php echo $availablelimit;?>"   ></td>
				...
				<tr>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32">Department</span></td>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5"><strong><!--				   
...
-->
			...
			<input name="consultingdoctorsearch" id="consultingdoctorsearch" value="" type="hidden" />
				  ...
				  <td align="left" valign="middle"  bgcolor="#ecf0f5"><span class="bodytext32"> Fee Type</span></td>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5"><strong>
               ...
               /* $query53="select * from master_consultationtype where locationcode = '$resultlocationanum' and department = '1' and recordstatus = '' order by consultationtype";
                ...
                <td align="left" valign="middle"  bgcolor="#ecf0f5">&nbsp;</td>
				 ...
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="memberno" id="memberno" onBlur="membernovalidation1();" value="" size="20" /></td>
			 ...
			 <tr id="enabtriag">
				 ...
				 <td colspan=""><div align="left"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                 </font></font></font></font></font></div></td>
                <td colspan="2" align="middle"  bgcolor="#ecf0f5"><div align="left"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  <input type="hidden" name="frmflag1" value="frmflag1" />
                  <input type="hidden" name="loopcount" value="<?php echo $i - 1; ?>" />
                  <input name="Submit222" type="submit"  value="Save Visit Entry (Alt+S)" accesskey="s" class="button" id="submit" onClick="return expirydatewarning()"/>  <span align="middle" id="edit"> </span>

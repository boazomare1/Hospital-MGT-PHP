...
<head>
    ...
    <title>Inpatient Discharge List - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/ipdischargelist-modern.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <nav class="nav-breadcrumb">
        ...
        <span>→</span>
        <span>Inpatient Discharge List</span>
    </nav>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2>Inpatient Discharge List</h2>
            ...
            <div class="search-form-section">
                <div class="search-form-header">
                    ...
                    <h3 class="search-form-title">Search Discharge List</h3>
                </div>
                
                <form id="searchForm" name="cbform1" method="post" action="ipdischargelist.php" class="search-form">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="ward" id="ward" class="form-input">
                                ...
                                while($res78 = mysqli_fetch_array($exec78)) {
                                    ...
                                    $wardname = $res78['ward'];
                                    ?>
                                    <option value="<?php echo $wardanum; ?>" <?php if($wardanum == $ward12) { echo "selected"; } ?>><?php echo htmlspecialchars($wardname); ?></option>
                                    <?php
                                }
                                ?>
                            </select>
            ...
            <div class="results-section">
                ...
                if ($cbfrmflag1 == 'cbfrmflag1') {
                    ...
                    <div class="results-header">
                        ...
                        <h3 class="results-title">Discharge List - <?php echo htmlspecialchars($wardname); ?></h3>
                    </div>
                                                ...
                                                <tr class="<?php echo $rowClass; ?>">
                                                    ...
                                                    <td>
                                                        <div class="action-buttons">
                                                            <a href="ipdischarge.php?patientcode=<?php echo $patientcode; ?>&visitcode=<?php echo $visitcode; ?>&patientlocation=<?php echo $location; ?>" 
                                                               class="action-btn discharge" title="Discharge">
                                                                <i class="fas fa-user-times"></i>
                                                                Discharge
                                                            </a>
                                                            <a href="ipdischargereverse.php?patientcode=<?php echo $patientcode; ?>&visitcode=<?php echo $visitcode; ?>&patientlocation=<?php echo $location; ?>" 
                                                    ...
                                                    <td>
                                                        <span class="package-badge"><?php echo htmlspecialchars($packagename1); ?></span>
                                                    </td>
                                                    <td>
    ...
    <!-- Modern JavaScript -->
    <script src="js/ipdischargelist-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>
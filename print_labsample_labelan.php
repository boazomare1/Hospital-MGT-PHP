...
if (isset($_REQUEST["lanum"])) {$lanum = $_REQUEST["lanum"]; } else { $lanum = ""; }
...
$query61 = "select sampleid,recorddate,recordtime from opipsampleid_lab where  patientvisitcode = '$visitno' and docnumber = '$docnumber' order by sampleid ASC ";
...
$query6 = "select patientname,sampleid,itemname,patientcode,patientvisitcode from opipsampleid_lab where auto_number = '$lanum'";
$exec6 = mysqli_query($GLOBALS["___mysqli_ston"], $query6) or die ("Error in Query6".mysqli_error($GLOBALS["___mysqli_ston"]));
$res6 = mysqli_fetch_array($exec6);

$patientname = $res6['patientname'];
$sampleid = $res6['sampleid'];
$itemname = $res6['itemname'];
$patientcode=$res6['patientcode'];
$visitcode=$res6['patientvisitcode'];

...
<table width="1900" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="revenuerecon.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Revenue Reconciliation Report </strong></td>
	...
	$querycr1 = "SELECT SUM(`consultation`) as income FROM `billing_consultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
				...
				UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_paynowpharmacy` WHERE ledgercode <> '' AND billdate BETWEEN '$ADate1' AND '$ADate2'
	...
	$totalopcash = array_sum($crresult) - array_sum($drresult);
	 ...
	 $querycr11 = "SELECT SUM(`fxamount`) as income FROM `billing_paylaterconsultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
				...
				UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_paylaterpharmacy` WHERE ledgercode <> '' AND billdate BETWEEN '$ADate1' AND '$ADate2'
				UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_paylaterradiology` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
				UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_paylaterservices` WHERE billdate BETWEEN '$ADate1' AND '$ADate2' and wellnessitem <> '1'
...
$ipfinalizedamount='';
						...
						$j = 0;
	$crresultcash = array();
	$querycr1cash = "SELECT SUM(a.`amountuhx`) as income FROM `billing_ippharmacy` AS a WHERE ledgercode <> '' AND  a.billdate BETWEEN '$ADate1' AND '$ADate2' AND billnumber in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`rateuhx`) as income FROM `billing_iplab` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'  AND billnumber in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`radiologyitemrateuhx`) as income FROM `billing_ipradiology` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'  AND billnumber in (select billno from billing_ip where accountnameano = '1107')
					UNION ALL SELECT SUM(`servicesitemrateuhx`) as income FROM `billing_ipservices` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'  AND billnumber in (select billno from billing_ip where accountnameano = '1107') and wellnesspkg = '1' 
					UNION ALL SELECT SUM(`amountuhx`) as income FROM `billing_ipadmissioncharge` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2'  AND docno in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`amountuhx`) as income FROM `billing_ipambulance` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' AND docno in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`amountuhx`) as income FROM `billing_ipbedcharges` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' AND docno in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`amount`) as income FROM `billing_iphomecare` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' AND docno in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`amountuhx`) as income FROM `billing_ipmiscbilling` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' AND docno in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`fxamount`) as income FROM `master_transactionpaylater` WHERE transactiondate BETWEEN '$ADate1' AND '$ADate2' and accountnameano = '1107' and billnumber = patientcode and billnumber like 'ipdr%'
					UNION ALL SELECT SUM(-1*`fxamount`) as income FROM `master_transactionpaylater` WHERE transactiondate BETWEEN '$ADate1' AND '$ADate2' and accountnameano = '1107' and billnumber = patientcode and billnumber like 'ipcr%'
					...
					UNION ALL SELECT SUM(-1*`rate`) as income FROM `ip_discount` WHERE patientvisitcode IN (select visitcode FROM `master_transactionip` WHERE accountnameano = '1107' and transactiondate BETWEEN '$ADate1' AND '$ADate2' group by billnumber)
						UNION ALL SELECT SUM(-1*`rate`) as income FROM `ip_discount` WHERE patientvisitcode IN (select visitcode FROM `billing_ipcreditapprovedtransaction` WHERE accountnameano = '1107' and billdate BETWEEN '$ADate1' AND '$ADate2' group by billno)";
	...
	$querycr1credit = "SELECT SUM(a.`amountuhx`) as income FROM `billing_ippharmacy` AS a WHERE ledgercode <> '' AND  a.billdate BETWEEN '$ADate1' AND '$ADate2' AND billnumber not in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`rateuhx`) as income FROM `billing_iplab` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'  AND billnumber not in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`radiologyitemrateuhx`) as income FROM `billing_ipradiology` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'  AND billnumber not in (select billno from billing_ip where accountnameano = '1107')
					UNION ALL SELECT SUM(`servicesitemrateuhx`) as income FROM `billing_ipservices` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'  AND billnumber not in (select billno from billing_ip where accountnameano = '1107') and wellnesspkg = '1'
					UNION ALL SELECT SUM(`amountuhx`) as income FROM `billing_ipadmissioncharge` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2'  AND docno not in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`amountuhx`) as income FROM `billing_ipambulance` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' AND docno not in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`amountuhx`) as income FROM `billing_ipbedcharges` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' AND docno not in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`amount`) as income FROM `billing_iphomecare` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' AND docno not in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`amountuhx`) as income FROM `billing_ipmiscbilling` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' AND docno not in (select billno from billing_ip where accountnameano = '1107') 
					UNION ALL SELECT SUM(`fxamount`) as income FROM `master_transactionpaylater` WHERE transactiondate BETWEEN '$ADate1' AND '$ADate2' and accountnameano <> '1107' and billnumber = patientcode and billnumber like 'ipdr%'
					UNION ALL SELECT SUM(-1*`fxamount`) as income FROM `master_transactionpaylater` WHERE transactiondate BETWEEN '$ADate1' AND '$ADate2' and accountnameano <> '1107' and billnumber = patientcode and billnumber like 'ipcr%'
...
$totalamount7 = '0.00';
	...
	$ledgerid='08-9301-NHL';
				...
				$i=0;
				$drresultdp = array();
						$querydr1dp = "SELECT SUM(`transactionamount`) as depositref FROM `master_transactionipdeposit` WHERE visitcode IN (select visitcode FROM `master_transactionip` WHERE accountnameano <> '1107' and transactiondate BETWEEN '$ADate1' AND '$ADate2' group by billnumber)
										UNION ALL SELECT SUM(`transactionamount`) as depositref FROM `master_transactionadvancedeposit` WHERE visitcode IN (select visitcode FROM `master_transactionip` WHERE accountnameano <> '1107' and transactiondate BETWEEN '$ADate1' AND '$ADate2' group by billnumber)
										";
						...
						$j = 0;
						$crresultdp = array();
						$querycr1dp = "SELECT SUM(amount) as deposit FROM `deposit_refund` WHERE visitcode IN (select visitcode FROM `master_transactionip` WHERE accountnameano <> '1107' and transactiondate BETWEEN '$ADate1' AND '$ADate2')
									 ";
...
$query11 = "select sum(cashamount) as cashamount1, sum(cardamount) as cardamount1, sum(onlineamount) as onlineamount1, sum(creditamount) as creditamount1, sum(chequeamount) as chequeamount1 from master_transactionpaylater where docno like 'AR-%' and transactionstatus like 'onaccount' and transactiondate between '$transactiondatefrom' and '$transactiondateto'"; 
		  ...
		  $total = $cashamount1 + $onlineamount1 + $chequeamount1 + $cardamount1 + $creditamount1 + $sumtransaction1 +$cashamount5;
		  ...
		  $showcolor = ($colorloopcount & 1); 
			...
			<tr>
			<td bgcolor="#ecf0f5" colspan="7" align="left" class="bodytext31"><strong>Revenue Summary</strong></td>
			</tr>
			 <tr>
              ...
              <td width="21%" align="left" valign="left"  
				...
				<td width="17%" align="left" valign="left"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Debtors</strong></div></td>
           ...
           <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="right">
				...
				<td class="bodytext31" valign="center"  align="right">
			    <div align="right"><?php echo number_format($sumtransaction1 +$cashamount5,2,'.',','); ?></div></td>
				<td class="bodytext31" valign="center"  align="right">
		   ...
		   ?>
			<tr>
			<td bgcolor="#ecf0f5" colspan="7" align="left">&nbsp;</td>
			</tr>

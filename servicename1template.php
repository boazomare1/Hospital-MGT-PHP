    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>
                ...
                <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="6" bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>services Item Master - Existing List - Latest 100 services Items </strong></span></td>
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        ></tr>
                      <tr bgcolor="#011E6A">
                        <td width="6%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong>Delete</strong></div></td>
                        ...
                        <td width="28%" bgcolor="#ecf0f5" class="bodytext3"><strong>services Item</strong></td>
						  <td width="9%" bgcolor="#ecf0f5" class="bodytext3"><div><strong>IP Markup</strong></div></td>
	 ...
	 /*?>	
        ...
        <tr <?php echo $colorcode; ?>>
                        <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="center"><a href="servicename1.php?st=del&&anum=<?php echo $auto_number; ?>&&sertemplate=<?php echo $sertemplate; ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
                  ...
                  <td align="left" valign="top"  class="bodytext3"><?php echo $incrementalrate; ?></td>
                        <td align="left" valign="top"  class="bodytext3">
						  <div align="center">
						  <a href="edititem1servicesmaster.php?sanum=<?php echo $auto_number; ?>&&itemcode=<?php echo $itemcode; ?>&&sertemplate=<?php echo $sertemplate; ?>" class="bodytext3">Edit</a></div></td>
                      </tr>
                      <?php
		}
	}
	...
	$query1 = "select * from $sertemplate where status <> 'deleted' order by auto_number desc LIMIT $start , $limit";
	  ...
	  if ($searchflag2 == 'searchflag2')
	  {
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="servicename1.php?st=activate&&anum=<?php echo $auto_number; ?>&&sertemplate=<?php echo $sertemplate; ?>" class="bodytext3">

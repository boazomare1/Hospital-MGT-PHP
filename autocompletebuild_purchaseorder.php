...
$stringbuild1 = "";
 $todate=date('Y-m-d', mktime(0, 0, 0, date('m'), date('d') -180, date('Y')));
 $query1 = "select * from purchaseorder_details where goodsstatus='' and recordstatus<>'deleted' and billdate <= '".date('Y-m-d')."' AND billdate >= '".$todate."' group by billnumber";

...
$sno=0;
	$totalpharmacysalesreturn=0;
	  $overaltotalrefund=0;    
		  $query2 = "select planname,patientcode,visitcode,subtype,planpercentage from master_visitentry where billtype='PAY LATER' and overallpayment='' and consultationdate between '$ADate1' and '$ADate2' AND visitcode NOT IN (SELECT visitcode FROM billing_paylater) order by accountfullname desc ";

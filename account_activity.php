...
$(document).ready(function(e) {
	...
	source:"ajaxsupplierdoctoraccount_nm.php",
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="POST" action="account_activity.php" onSubmit="return validate();">
		...
		<!-- <form name="cbform2" method="post" action="paymentapproval.php" onSubmit="return paymententry1process2()"> -->
            ...
            <tr>
              ...
              <td width="5%" align="left" valign="center" bordercolor="#f3f3f3" 
                ...
                bgcolor="#ffffff" class="bodytext311"><strong>Bill Date</strong></td>

              <!-- <td width="9%" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext311"><strong> Supplier Inv No</strong></td> -->

              <td class="bodytext311" width="5%" valign="center" bordercolor="#f3f3f3" align="left"  bgcolor="#ffffff"><div align="left"><strong>Doc No </strong></div></td>

              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" width="8%" bgcolor="#ffffff"><div align="center"><strong>Ref No. </strong></div></td>

              <td class="bodytext311" width="15%" valign="center" bordercolor="#f3f3f3" align="left"   bgcolor="#ffffff"><div align="right"><strong>Bill Amt </strong></div></td>
              ...
              <td width="8%" align="left" valign="center" bordercolor="#f3f3f3"  bgcolor="#ffffff" class="bodytext311"><div align="right"><strong>Dr Pending</strong></div></td>
              <td width="8%" align="left" valign="center" bordercolor="#f3f3f3"  bgcolor="#ffffff" class="bodytext311"><div align="right"><strong>Action</strong></div></td>
		  ...
		  $total_debit = $res5transactionamount + $total_debit;
			...
			if($type=="doctor")
			{
				$query3 = "SELECT transactionamount from master_transactiondoctor where  debit_reference_no = '$res5docnumber' and doctorcode = '$arraysuppliercode'";
			}
			else
			{
           ...
           <tr <?php  echo $colorcode; ?>>
              ...
              <?php if($type=="doctor"){ ?>
              	<td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="right"><a href="doctor_debitnotes_view.php?document=<?=$res5docnumber;?>&&suppliercode=<?=$suppliercode;?>">View</a> </td>
              <?php }
              else{ ?>
              	 <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="right"><a href="account_activity_view.php?document=<?=$res5docnumber;?>&&suppliercode=<?=$suppliercode;?>">View</a> </td>
              <?php }
               ?>
              
               <!-- &&suppliername=<?=$suppliername;?>&&pending=<?=$pending;?>&&ald=<?=$billdate;?>&&billamount_url=<?=$res5transactionamount;?> -->

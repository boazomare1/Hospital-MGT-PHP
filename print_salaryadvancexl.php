...
header('Content-Disposition: attachment;filename="ComponentReport.xls"');
...
<?php //include("a4pdfheader1.php"); ?>	
	...
	<td width="90" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>PAYROLL NO</strong></td>
	<td width="220" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>EMPLOYEE'S NAME</strong></td>

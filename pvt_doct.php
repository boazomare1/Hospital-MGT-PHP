...
if($searchsuppliername=='' && $searchsuppliercode==''){
$query1 = "select * from master_employee where employeename = '$username'";
$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
$res1 = mysqli_fetch_array($exec1);
$res1employeecode = $res1['employeecode'];

$query11 = "select * from doctor_mapping where employeecode = '$res1employeecode'";
$exec11 = mysqli_query($GLOBALS["___mysqli_ston"], $query11) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
$res11 = mysqli_fetch_array($exec11);
$searchsuppliername = $res11['doctorname'];
$searchsuppliercode = $res11['doctorcode'];
}
    ...
    <td width="97%" valign="top"><table width="auto" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="pvt_doct.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
           ...
           <tr>
              ...
              <input name="searchsuppliername" type="text" id="searchsuppliername" value="<?php echo $searchsuppliername; ?>" size="50" autocomplete="off" readonly>
              </span>
      ...
      <tr>
       ...
       <tr>
        <td>
            ...
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="149%" 
            align="left" border="0">
          <tbody>
            ...
            <tr>
              ...
              <th width="" align="left" valign="right"  

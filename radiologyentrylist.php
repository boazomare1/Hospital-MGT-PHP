        ...
        <td width="860">
              <form name="cbform1" method="post" action="radiologyentrylist.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                  <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Search Radiology result reporting</strong></td>
...
?>
	<tr>
			...
			$query1 = "select a.* from consultation_radiology as a JOIN master_radiology as b ON a.radiologyitemcode=b.itemcode and b.categoryname='$categoryname' where a.patientname like '%$searchpatient%' and a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and a.prepstatus='completed' and a.imgaquistatus='completed' and a.billtype='PAY NOW' and a.resultentry='$searchstatus' and (a.paymentstatus='completed' OR a.paymentstatus='paid') and  a.consultationdate between '$fromdate' and '$todate'  and a.locationcode='".$locationcode."' group by a.patientvisitcode,a.radiologyitemcode,a.refno order by a.consultationdate ";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			if($patienttype!='IP')
			{			
...
$data_count++;
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="radiologyentry.php?patientcode=<?php echo $res1patientcode; ?>&&visitcode=<?php echo $res1visitcode; ?>&&q_itemcode=<?= $radiologyitemcode ?>&&q_refno=<?= $refno ?>"><strong>Process</strong></a></div></td>
				<td align="left" valign="center"  
			...
			$query2 = "select a.* from consultation_radiology as a JOIN master_radiology as b ON a.radiologyitemcode=b.itemcode and b.categoryname='$categoryname' where a.patientname like '%$searchpatient%' and a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and a.prepstatus='completed' and a.imgaquistatus='completed' and billtype='PAY LATER' and a.paymentstatus='completed' and a.resultentry='$searchstatus' and   a.consultationdate between '$fromdate' and '$todate'  and a.locationcode='".$locationcode."' and (a.approvalstatus='1' or a.approvalstatus='2') group by a.patientvisitcode,a.radiologyitemcode,a.refno order by a.consultationdate ";
 ...
 $patientdob=$res69['dateofbirth'];
            ...
            <tr <?php echo $colorcode; ?>>
             ...
             <td class="bodytext31" valign="center"  align="left">
              ...
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="radiologyentry.php?patientcode=<?php echo $res2patientcode; ?>&&visitcode=<?php echo $res2visitcode; ?>&&q_itemcode=<?= $radiologyitemcode ?>&&q_refno=<?= $refno ?>"><strong>Process</strong></a></div></td>
				<td align="left" valign="center"  
                class="bodytext31" <?php if($waitingtime1 > 15 || $days > 1){ ?> bgcolor=" #FF0040" <?php } ?>><div align="center"><strong>
			...
			$query2 = "select a.* from consultation_radiology as a JOIN master_radiology as b ON a.radiologyitemcode=b.itemcode and b.categoryname='$categoryname' where a.locationcode = '".$locationcode."' and a.patientname like '%$searchpatient%' and a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and a.paymentstatus='pending' and a.prepstatus='completed' and a.imgaquistatus='completed' and a.billtype='PAY LATER' and (a.approvalstatus='1' or a.approvalstatus='2') and a.resultentry='$searchstatus' and a.consultationdate between '$fromdate' and '$todate'  group by a.patientvisitcode,a.radiologyitemcode,a.refno order by a.consultationdate";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res2 = mysqli_fetch_array($exec2))
			{
			$res2patientcode = $res2['patientcode'];
...
$res69=mysqli_fetch_array($exec69);
 $patientdob=$res69['dateofbirth'];
			...
			$query1 = "select a.* from ipconsultation_radiology as a JOIN master_radiology as b ON a.radiologyitemcode=b.itemcode and b.categoryname='$categoryname' where a.patientname like '%$searchpatient%' and a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and a.prepstatus='completed' and a.imgaquistatus='completed' and a.billtype='PAY NOW' and a.resultentry='$searchstatus' and a.consultationdate between '$fromdate' and '$todate'  and a.locationcode='".$locationcode."' group by a.patientvisitcode,a.radiologyitemcode,a.refno order by a.consultationdate ";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res1 = mysqli_fetch_array($exec1))
			{
			$res1patientcode = $res1['patientcode'];
 ...
 $patientdob=$res69['dateofbirth'];
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><?php echo $res1account; ?></td>
			   ...
			   <td class="bodytext31" valign="center"  align="left"><?php echo $res1112department; ?></td>
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="ipradiologyentry.php?patientcode=<?php echo $res1patientcode; ?>&&visitcode=<?php echo $res1visitcode; ?>&&q_itemcode=<?= $radiologyitemcode ?>&&q_refno=<?= $refno ?>"><strong>Process</strong></a></div></td>
				<td align="left" valign="center"  
                class="bodytext31" <?php if($waitingtime1 > 15 || $days > 1){ ?> bgcolor=" #FF0040" <?php } ?>><div align="center"><strong>
				<?php $datetime1=$res1['aquisition_datetime']; get_time($datetime1); ?></strong></div></td>
              </tr>
			...
			$query2 = "select a.* from ipconsultation_radiology as a JOIN master_radiology as b ON a.radiologyitemcode=b.itemcode and b.categoryname='$categoryname' where a.patientname like '%$searchpatient%' and a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and a.prepstatus='completed' and a.imgaquistatus='completed' and a.billtype='PAY LATER' and a.resultentry='$searchstatus' and  a.consultationdate between '$fromdate' and '$todate' and a.locationcode='".$locationcode."' group by a.patientvisitcode,a.radiologyitemcode,a.refno order by a.consultationdate ";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res2 = mysqli_fetch_array($exec2))
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><?php echo $res2account; ?></td>
			   ...
			   <td class="bodytext31" valign="center"  align="left"><?php echo $res1112department; ?></td>
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="ipradiologyentry.php?patientcode=<?php echo $res2patientcode; ?>&&visitcode=<?php echo $res2visitcode; ?>&&q_itemcode=<?= $radiologyitemcode ?>&&q_refno=<?= $refno ?>"><strong>Process</strong></a></div></td>
				<td align="left" valign="center"  
                class="bodytext31" <?php if($waitingtime1 > 15 || $days > 1){ ?> bgcolor=" #FF0040" <?php } ?>><div align="center"><strong>
				<?php $datetime1=$res2['aquisition_datetime']; get_time($datetime1); ?></strong></div></td>
              </tr>

...
$fromstorecode=$storecode=isset($_REQUEST['storecode'])?$_REQUEST['storecode']:'';

 $query222 = "select * from master_medicine where itemname like '%$searchmedicinename1%' ".$strtype." and status <> 'Deleted' limit 0,1000";

...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
	...
	<tr>
				  ...
				  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style1">*النوع </span></td>
				...
				?>
				  ...
				  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="style2">*التأمين</td>
...
-->				  
				  ...
				  <td width="7%" align="left" valign="middle"  bgcolor="#ecf0f5" class="style2">*الشركة</td>
...
-->				
					...
					<td width="7%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32">الصلاحية </span></td>
				...
				<td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">*الخطة </span></td>
				  ...
				  <input type="hidden" name="planvaliditystart" id="planvaliditystart" value="<?php echo $registrationdate; ?>" readonly  >
					  ...
					  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">كوباي </td>
				  ...
				  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32">نوع الفاتورة </span></td>
...
-->
				  ...
				  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">الحد </td>
				...
				<td align="left" valign="middle"  bgcolor="#ecf0f5" class="style2">*Salutation</td>
...
-->                  </td>
				...
				<input name="customermiddlename" id="customermiddlename" value="<?php echo $pmname; ?>" style=" text-transform:uppercase;" size="20" onKeyPress="return namevalid(event);" onChange="concatmiddledob();" tabindex="9"></td>

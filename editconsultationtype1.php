...

{
...

	{
		...
		$query612 = "delete from locationwise_consultation_fees where maintype='$paymenttype' and subtype='$subtype'";
		$exec612 = mysqli_query($GLOBALS["___mysqli_ston"], $query612) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		
		//$query613 = "delete from master_consultationtype where paymenttype='$paymenttype' and subtype='$subtype'";
...
<input type="text" name="search_subtype" id="search_subtype" value="<?php echo $res51subtype;?>" style="border: 1px solid #001E6A;" size="40" readonly />
</td>
                   <td width="10px" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3" >&nbsp;</td>
                            <td width="10px" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3" >&nbsp;</td>
                             <td width="10px" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3" >&nbsp;</td>
...
else
{
   ...
   $query_sub12 = "select consultationtype from master_consultationtype where auto_number='$consultation_id_get' ";
...
source:'get_subtypes.php?res12paymenttypeanum='+res12paymenttypeanum,
minLength:0,
html: true, 
select: function(event,ui){

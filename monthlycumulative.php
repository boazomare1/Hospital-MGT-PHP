    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="monthlycumulative.php">
		<table width="634" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td bgcolor="#ecf0f5" colspan="4" class="bodytext3"><strong>MONTHLY CUMULATIVE</strong></td>
             </tr>
             <tr>
            ...
            <tr>
              <td class="bodytext31" valign="center" align="left" bgcolor="#FFFFFF">Select Year </td>
              ...
              <td class="bodytext31" valign="center"  align="left" bgcolor="#FFFFFF">Select Month </td>
              <td width="30%" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31">
        ...
        <td>
            ...
            <tr>
              <td class="bodytext31" valign="center"  align="left"> 
               <a target="_blank" href="xl_monthlycumulative.php?locationcode=<?php echo $locationcode; ?>&year=<?php echo $from_year; ?>&month=<?php echo $from_month; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a>
              </td>
            </tr>

...
<table width="1000" border="0" cellpadding="0" cellspacing="0" style="margin: 0px 30px 0px 60px;">

  <tr>

    <td width="370" rowspan="7"  align="left" valign="center" 
	 ...
	 bgcolor="#ffffff" class="bodytext31"><?php
      ...
      <img src="logofiles/1.png" width="200" height="100" />

...

{
	...
	$query10 ="select auto_number,consultationtype,condefault,consultationfees from master_consultationtype where department = '$department'  and subtype = '$subtype'  and recordstatus <>'deleted' and condefault <>'on' order by auto_number desc";
...
$query1 = "select consultationfees from locationwise_consultation_fees where consultation_id='$res10consultationtypeanum' and locationcode = '$locationcode' and department='$department' ";

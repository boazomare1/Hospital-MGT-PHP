...

{
	...
	window.open("popup_itemmapmultiple.php?callfrom="+varCallFrom+'&item='+item,"Window2",'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=750,height=350,left=100,top=100');
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="850" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
						...
						<form name="form1" id="form1" action="itemmapmultiple.php" method="post" onSubmit="return form1valid();">
...

	  {
		...
		$query1 = "select itemcode,itemname,categoryname,auto_number,unitname_abbreviation from master_medicine  where itemname like '%$search1%' and status <> 'deleted'  order by itemname";
		...
		$supplierq = "select suppliercode from master_itemmapsupplier where itemcode = '$itemcode'";
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<td align="left" valign="top"  class="bodytext3"><a href='javascript:return false;' onClick="javascript:coasearch('7','<?php echo $itemcode;?>');" value="Map" accesskey="m">Map</a></td>

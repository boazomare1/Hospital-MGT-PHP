...
if($num232>0){
	...
	if($num919>0){
		while($res919 = mysqli_fetch_array($exec919))
		{
			...
			{
			$copay_type='NHIF';
			$total_amount=$total_amount+$fxamount;
			}
			
			
			if($fxamount>0)
			{
			$copay_arr[1]["copay_type"]=$copay_type;
			$copay_arr[1]["copay_amount"]=$total_amount;
   ...
   /////////////////////// start adv deposit  /////////////////////////////////////
    ...
    if($deposits>0){
	  $copay_arr["copay_type"]="SELF_PAY";
	  $copay_arr["copay_amount"]=$deposits;
	  array_push($copays,$copay_arr);
	}

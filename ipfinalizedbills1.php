...
// Check if table exists and get finalized bills data
$tableExists = false;
$exec2 = null;
$sno = 0;
$totalBills = 0;
...
$checkTable = "SHOW TABLES LIKE 'master_billing'";
$checkResult = mysqli_query($GLOBALS["___mysqli_ston"], $checkTable);
if(mysqli_num_rows($checkResult) > 0) {
    $tableExists = true;
    $query2 = "select * from master_billing where date(updatedatetime) between '$transactiondatefrom' and '$transactiondateto' order by updatedatetime desc";
...
<head>
    ...
    <title>Finalized Bills - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/ipfinalizedbills1-modern.css?v=<?php echo time(); ?>">
...
<body>
        ...
        <aside id="leftSidebar" class="left-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="ipradiologyresults.php" class="nav-link">
                            <i class="fas fa-x-ray"></i>
                            <span>Radiology Results</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="ipfinalizedbills1.php" class="nav-link active">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2><i class="fas fa-file-invoice"></i> Finalized Bills</h2>
                    <p>View and manage finalized inpatient bills</p>
                </div>
                ...
                <form method="post" class="search-form">
                    <div class="search-row">
                        <div class="search-group">
                            ...
                            <input type="text" id="searchInput" class="search-input" placeholder="Search by patient name, bill number, or ID...">
                        </div>
                        ...
                        <div class="search-group">
                            ...
                            <select id="billStatus" class="search-input">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 3rem;">
                                <div style="color: #64748b; font-size: 1.1rem;">
                                    ...
                                    <p>The 'master_billing' table does not exist in the database.</p>
                        ...
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 3rem;">
                                <div style="color: #64748b; font-size: 1.1rem;">
                                    ...
                                    <p>No finalized bills found for the selected date range.</p>
                                </div>
                            </td>
                        </tr>
                        <?php } else if ($exec2) { 
                            ...
                            while ($res2 = mysqli_fetch_array($exec2)) {
                                ...
                                $paidamount = $res2["paidamount"];
                                $balance = $totalamount - $paidamount;
                                $billdate = $res2["updatedatetime"];
                                $status = $res2["status"];
                        ...
                        <tr>
                            ...
                            <td><?php echo date('d-m-Y H:i', strtotime($billdate)); ?></td>
                            <td>
                            ...
                            <td>
                                ...
                                <button class="btn btn-outline" onclick="printBill('<?php echo $auto_number; ?>')">
            ...
            <div class="form-container">
                ...
                <div class="summary-grid">
                    <div class="summary-item">
                        <h4>Total Bills</h4>
                        <div class="value"><?php echo $totalBills; ?></div>
                    </div>
                    <div class="summary-item">
                        <h4>Total Amount</h4>
                    ...
                    <div class="summary-item">
                        <h4>Outstanding</h4>
                        <div class="value">₹<?php echo number_format($totalAmount - $totalPaid, 2); ?></div>
                    </div>
                </div>
            </div>
    ...
    <!-- Modern JavaScript -->
    <script src="js/ipfinalizedbills1-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

...
header('Content-Disposition: attachment;filename="moh705a_xl.xls"');
header('Cache-Control: max-age=80');


$location =isset( $_REQUEST['locationcode'])?$_REQUEST['locationcode']:'';
$selectedmonth=isset($_REQUEST['month'])?$_REQUEST['month']:'';
$selectedyear=isset($_REQUEST['year'])?$_REQUEST['year']:'';
...
-->
		...
		?>
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse; margin-top:50px;" bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" align="left" border="1">
          <tbody>		 
                <tr>
				...
				?>	
                 <tr >
                    ...
                    <td width="80%" colspan="" valign="center"  align="left"  class="bodytext31"><?php echo $rptname; ?></td>            

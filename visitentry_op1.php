...
function funcDepartmentChange()
{
	...
	$query41 = "select * from master_subtype where recordstatus = ''";
	...
	//alert(document.getElementById("subtype").value);
		...
		{
		//alert(document.getElementById("subtype").value+' vasu');
		...
		<?php
		$query10 = "select * from master_consultationtype where department = '$res11departmentanum' and subtype = '44' and locationcode = '$res4loccode' order by consultationtype";
...
-->
				...
				?>
				  ...
				  <td align="left" valign="middle"  bgcolor="#ecf0f5"><strong>
			<input name="consultingdoctor" id="consultingdoctor" value="M.O. Consultation" autocomplete="off" />
			...
			<input name="consultingdoctorsearch" id="consultingdoctorsearch" value="" type="hidden" />
			 ...
			 <tr id="enabtriag">
                ...
                <td colspan="4" align="middle"  bgcolor="#ecf0f5"><div align="left"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">

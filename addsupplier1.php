      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="860"><table width="800" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#ecf0f5" class="bodytext3" colspan="2"><strong>Supplier - New </strong></td>
             ...
             <tr>
              ...
              <!--<tr>
				...
				<tr>
                <td width="19%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32">Supplier Name   *</span></td>
                <td width="38%" align="left" valign="middle"  bgcolor="#ecf0f5"><input name="suppliername" id="suppliername" value="<?php echo $companyname; ?>" style="border: 1px solid #001E6A;" size="40"></td>
                <td width="21%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Supplier Code   *</td>
                <td width="22%" align="left" valign="middle"  bgcolor="#ecf0f5"><input name="suppliercode" id="suppliercode" value="<?php echo $suppliercode; ?>" readonly="readonly" style="border: 1px solid #001E6A;text-transform: uppercase; background-color:#ecf0f5" size="20"></td>
				</tr>
			  <tr>
			    <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Address 1 </td>
			    <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="address1" id="address1" value="<?php echo $address1; ?>" style="border: 1px solid #001E6A;"  size="20" /></td>
                <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Address 2 </td>
                <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="address2" id="address2" value="<?php echo $address2; ?>" style="border: 1px solid #001E6A;"  size="20" /></td>
			  </tr>
				 <tr>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">State </td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><font size="2">
...
-->				   </td>
				 ...
				 <tr>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Area</td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="area" id="area" value="<?php echo $location; ?>" style="border: 1px solid #001E6A;"  size="20" /></td>
...
-->				   </td>
				 ...
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="tinnumber" id="tinnumber" value="<?php echo $tinnumber; ?>" style="border: 1px solid #001E6A"  size="20" /></td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">CST Number </td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="cstnumber" id="cstnumber" value="<?php echo $cstnumber; ?>" style="border: 1px solid #001E6A"  size="20" /></td>
			      </tr>
				 <tr>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Remarks</td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="remarks" id="remarks" value="<?php echo $remarks; ?>" style="border: 1px solid #001E6A;"  size="20" /></td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Opening Balance</td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5">

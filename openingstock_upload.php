...
$query3 = "select * from master_company where companystatus = 'Active'";
...

	{
		...
		try {
			...
			*/
			$excel_date=explode('/',$expiry_date1);
			$month=$excel_date[0];
			$year=$excel_date[1];
			$expiry_date2=$year.'-'.$month.'-01';
		$expiry_date = date("Y-m-d", strtotime($expiry_date2));
...
$exec12=mysqli_query($GLOBALS["___mysqli_ston"], $query12) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
            ...
            $errmsg = "Success. Opening Stock  Uploaded.";
          ...
          <tbody bgcolor="#CBDBFA">
			...
			<strong>Upload XLSX File </strong>			</td>
             ...
             <tr>
                        ...
                        <td colspan="3" align="left" valign="middle"   bgcolor="<?php if ($bgcolorcode == '') { echo '#CBDBFA'; } else if ($bgcolorcode == 'success') { echo '#ECF0F5'; } else if ($bgcolorcode == 'failed') { echo '#AAFF00'; } ?>" class="bodytext3"><div align="left"><?php echo $errmsg; ?></div></td>

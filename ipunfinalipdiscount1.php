           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $sno ?></td>
               <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $discountrefno;?></div> </td>
...
?>		
         <tr>
              <td colspan="4"  class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong>Total IP Discount Amount</strong></td>
              <td align="right" valign="center" 
                bgcolor="#ecf0f5" class="bodytext31"><strong>-<?php echo number_format($totaldiscountrate,2,'.',','); ?></strong></td>
				</tr>
		<!--<tr>
				<td colspan="7" align="left">
			<a href="ipunfinalipdiscountxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>
			</tr>-->
          </tbody>
        </table>

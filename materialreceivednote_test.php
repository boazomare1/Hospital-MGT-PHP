...
-->
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
		 <form name="cbform1" id="cbform1" method="post" action=""> 
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
         ...
         <input type="hidden" name="purchasetype" id="purchasetype" value="<?php echo $purchasetype; ?>">
			...
			{
			echo '----'.$query767 = "select * from purchaseorder_details where billnumber='$po_number' and itemcode = '$itemcode' $condn and (recordstatus='autogenerated' || recordstatus='generated') and goodsstatus='' and itemstatus <> 'deleted' and auto_number = '$itemanum'";

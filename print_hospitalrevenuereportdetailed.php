...
$serial=0;
		...
		if ($cbfrmflag1 == 'cbfrmflag1')
			...
			//**CONSULTATION**//
			//CASH
			$query_op = "SELECT patientcode, patientvisitcode as  visitcode, patientname, billnumber as billno, billdate as billdate  from billing_consultation where  $pass_location  and billdate between '$transactiondatefrom' and '$transactiondateto' and $pass_location group by billno
			union all SELECT patientcode,visitcode, patientname, billno as billno, billdate as billdate   from billing_paynow where  $pass_location  and  billdate between '$transactiondatefrom' and '$transactiondateto' and $pass_location group by billno
			UNION ALL select patientcode,visitcode, patientname, billno as billno, billdate as billdate    from billing_paylater where $pass_location  and  billdate between '$transactiondatefrom' and '$transactiondateto' and $pass_location
			union all SELECT patientcode,visitcode, patientname, docno as billno, recorddate as billdate   from billing_opambulance where  $pass_location  and  recorddate between '$transactiondatefrom' and '$transactiondateto' and $pass_location group by billno
			union all SELECT patientcode,visitcode, patientname, docno as billno, recorddate as billdate  from billing_homecare where  $pass_location  and  recorddate between '$transactiondatefrom' and '$transactiondateto' and $pass_location group by billno
			";
...
$subtotal_2-=$subtotal_ref;
           ...
           ?>
            <tr <?php //  echo $colorcode1; ?>>
                  ...
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">-<?php echo number_format(0,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">-<?php echo number_format(0,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php echo number_format((-1)*$subtotal_refp,2,'.',','); ?></strong></div></td>
               </tr>

...
$external_services_add=0;
				...
				$exec267 = mysqli_query($GLOBALS["___mysqli_ston"], $query267) or die ("Error in Query267".__LINE__.mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	$i = 0;
		...
		$execdr1 = mysqli_query($GLOBALS["___mysqli_ston"], $querydr1in) or die ("Error in querydr1in".__LINE__.mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	*/
	...
	$i = 0;
		...
		$execcr1 = mysql_query($querycr1in) or die ("Error in querycr1in".__LINE__.mysql_error());

...
<td   class="bodytext31" valign="center"  align="right"><a href="xl_view_deptstats.php?ADate1=<?php echo $transactiondatefrom;?>&&ADate2=<?php echo $transactiondateto; ?>&&location=<?php echo $location; ?>&&department_search=<?php echo $department_search; ?>&&cbfrmflag1=cbfrmflag1"><img  width="30" height="30" src="images/excel-xls-icon.png" style="cursor:pointer;"></a> </td>

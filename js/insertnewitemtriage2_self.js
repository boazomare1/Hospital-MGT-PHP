...
function insertitem2()
{
	...
	text111.id = "labcode5"+j+"";
	text111.name = "labcode5[]"+j+"";
	text111.type = "hidden";
	text111.align = "left";
	text111.size = "50";
	text111.value = varLabcode;
	...
	totalamount1=parseInt(totalamount1) + parseInt(varlabRate.replace(/[^0-9\.]+/g,""));
	...
	var varLab = document.getElementById("labcode").value = "";

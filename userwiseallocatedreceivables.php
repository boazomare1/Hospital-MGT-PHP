    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Userwise Allocated Receivables</strong></td>
              </tr>
            <!--<tr>
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
		  ...
		  $exec414 = mysqli_query($GLOBALS["___mysqli_ston"], $query414) or die ("Error in query3".mysqli_error($GLOBALS["___mysqli_ston"]));
		  $num414 = mysqli_num_rows($exec414);
		  ...
		  $exec4 = mysqli_query($GLOBALS["___mysqli_ston"], $query4) or die ("Error in query3".mysqli_error($GLOBALS["___mysqli_ston"]));
		  ...
		  $exec41 = mysqli_query($GLOBALS["___mysqli_ston"], $query41) or die ("Error in query3".mysqli_error($GLOBALS["___mysqli_ston"]));
 ...
 <td class="bodytext31" valign="center"  align="left">
           ...
           <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo number_format($totalreceivedamount,2,'.',','); ?></strong></div></td>
				 <td class="bodytext31" valign="center"  align="left" 

...
$query2 = "select auto_number,id,accountname,accountssub from master_accountname where accountsmain  in ('4') and accountname like '%$term%' and recordstatus <> 'deleted'";

...
$query2 = "select consultationid as billnumber from consultation_services where consultationid like 'EB-%' order by auto_number desc";
...
$wellnesspkg='0';
		...
		//$servicescode==$execlab['itemcode'];
		$wellnesspkg='0';
$serrefcode=$labrefcode;
...
/*		 $query1222 = "select bankrefno from bank_refrencenumber  where visitcode='$visitcode' and patientcode='$patientcode' and patientname='$patientfullname' and billnumber='' ";
		...
		/*	if(is_connected()){
				...
				$apibill_name = 'EXTERNAL SERVICES';
				$apibill_date = $opdate;
...
?>
<?php
include ("autocompletebuild_services1_serv.php");
...
<script type="text/javascript" src="js/autoservicescodesearchexternal_live.js"></script>
	...
	//alert('amounttot['+varDeleteID+']');
	   ...
	   // document.getElementById("cashamount").value=document.getElementById("cashgivenbycustomer").value;
		...
		if (document.getElementById("billtype").value == "CASH")
		{
			...
			{
				document.getElementById("cashgiventocustomer").value=parseFloat(document.getElementById("cashgivenbycustomer").value)-parseFloat(totalamt).toFixed(2);
			}
			...
			{
				document.getElementById("balanceamt").value=balanceinfo.toFixed(2);
				document.getElementById("tdShowTotal").innerHTML =balanceinfo.toFixed(2);
			}
			else
			{
				document.getElementById("balanceamt").value=0.00;
		...
		if (document.getElementById("billtype").value == "SPLIT")
		{
			...
			if(parseFloat(totalamt)<=parseFloat(allcash))
			{
				...
				document.getElementById("cashgiventocustomer").value=parseFloat(cashgtocst).toFixed(2);
...
<form name="form1" id="frmsales" method="post" action="services_externalbilling_request.php" onSubmit="return validcheck()"   onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
         		<tr > 
				 <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>Services <img src="images/plus1.gif" width="13" height="13"> </strong></span></td>
		   </tr>
				<tr id="serid">
				   ...
				   <td width="30"><input name="servicesa1" type="text" id="services" onChange="return cleardatas('serv')" size="69">
				   <input name="hiddenservices" type="hidden" id="hiddenservices" size="69">
				   </td>
				    <td width="30"><input name="rate31" type="text" id="rate3" readonly size="8"></td>
					<td widthd="30"><input name="serviceqty" type="text" id="serviceqty" size="8" autocomplete="off" onKeyPress="return isNumber(event)" onKeyUp="return sertotal()"></td>
			   ...
			   <tr>
				   <td colspan="8" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Total</strong>

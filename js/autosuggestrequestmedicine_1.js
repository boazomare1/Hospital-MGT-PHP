...
AutoSuggestControlmed.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	//alert(storecode);
	var url = "";
	var url="ajaxrequestmedicinebuild.php?locationcode="+locationcode+"&&storecode="+storecode+"&&searchmedicinename1="+searchmedicinename1+"&&typetransfer="+typetransfer+"&&tolocation="+tolocation+"&&RandomKey="+Math.random()+"";
    //alert(url);
	///*
...
AutoSuggestControlmed.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var availablestock = arrSupplierName[2];						var fromstorename = arrSupplierName[3];						var fromstorecode = arrSupplierName[4];					var tostore = arrSupplierName[5];						var tostorecode = arrSupplierName[6];
			...
			document.getElementById("avlquantity").value = availablestock;						document.getElementById("fromstorename").value = fromstorename;						document.getElementById("fromstorecode").value = fromstorecode;						document.getElementById("fromstore").value = fromstorecode;						document.getElementById("tostore").value = tostore;						document.getElementById("tostorecode").value = tostorecode;			
			funcmedicinesearch4();
			//funcBatchbuild();

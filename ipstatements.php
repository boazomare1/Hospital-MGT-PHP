...
?>
		...
		$query1 = "select * from master_ipvisitentry where patientcode = '$searchpatientcode' and visitcode = '$searchvisitcode' ";
...
?>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
		      <tr>
			     <td colspan="8" align="left" bgcolor="" class="bodytext31"><strong>Bed Details</strong></td>
			  </tr>
               <tr>
			     <td colspan="8" align="center" bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo $patientname;  ?>/<?php echo $patientcode; ?>/<?php echo $res39visitcode; ?></strong></td>
			  </tr>
            <tr>
			  ...
			  <td width="4%" class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="center"><strong>Action</strong></div></td>
			<td width="4%" class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="center"><strong>Remarks</strong></div></td>

			  <td width="4%" class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="center"><strong>Action Date</strong></div></td>
			  <td width="4%" class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="center"><strong>Action By</strong></div></td>
			  <td width="4%" class="bodytext31" valign="center"  align="left" 
...
$query351 = "select * from master_store where storecode = '$store' ";
          ...
          <tr <?php echo $colorcode; ?>>
			...
			<tr>
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left" 
                colspan="13"><strong>Direct Issue</strong></td>
	  ...
	  $sno=0;
	   ...
	   $query39 = "select * from ipconsultation_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' ";
	   $exec39 = mysqli_query($GLOBALS["___mysqli_ston"], $query39) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	   $res39 = mysqli_fetch_array($exec39);
	   $res39visitcode = $res39['patientvisitcode'];
	   $res39patientname = $res39['patientname'];
		?>

		      <tr>
			     <td colspan="13" align="left" bgcolor="" class="bodytext31"><strong>Lab Details</strong></td>
			  </tr>
               <tr>
			     <td colspan="8" align="center" bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo $patientname;  ?>/<?php echo $patientcode; ?>/<?php echo $res39visitcode; ?></strong></td>
			  </tr>
<tr>
<td width="4%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><div align="center"><strong>S.No.</strong></div></td>
<td width="8%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><div align="center"><strong>Ref No</strong></div></td>
<td width="16%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff" colspan="3"><div align="center"><strong>Item Name</strong></div></td>
<td width="8%"  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Rate</strong></div></td>
<td width="8%"  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Amount </strong></div></td>
<td width="9%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><div align="center"><strong>Requested Date</strong></div></td>
<td width="9%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff" colspan="2"><div align="center"><strong>Action By</strong></div></td>
           ...
           $query34 = "select * from ipconsultation_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
		   $exec34 = mysqli_query($GLOBALS["___mysqli_ston"], $query34) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		   while($res34 = mysqli_fetch_array($exec34))
		   {
		   $patientname = $res34['patientname'];
		   $patientcode = $res34['patientcode'];
		   $visitcode = $res34['patientvisitcode'];
		   $itemname = $res34['labitemname'];
		   $itemcode = $res34['labitemcode'];
		   $docno = $res34['docnumber'];
		   $quantity = '1';
		   $res34date = $res34['consultationdate'];
		   $rateperunit = $res34['labitemrate'];
		   $totalrate = $res34['labitemrate'];
		   $freestatus = $res34['freestatus'];
		   $username = $res34['username'];
		   $ipaddress = '';
		   $issuedocno = '';
		   ...
		   $issueduser = $res34['username'];
		   $issuedipaddress = '';
		   $issueddate = $res34['consultationdate'];
        ...
        <td class="bodytext31" valign="center"  align="left"  colspan="3"><div align="center"><?php echo $itemname; ?></div></td>
        <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format($rateperunit,2,'.',','); ?></div></td>
        <td  align="left" valign="center" class="bodytext31"><div align="right"><?php echo number_format($totalrate,2,'.',','); ?></div></td>
        <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo  date("d/m/Y", strtotime($res34date)); ?></div></td>   		<td class="bodytext31" valign="center" align="left" colspan="2"><div align="center"><?php echo $issueduser;?></div></td>
	  ...
	  $sno=0;
	   ...
	   $query39 = "select * from ipconsultation_radiology where patientcode = '$patientcode' and patientvisitcode = '$visitcode' ";
	   $exec39 = mysqli_query($GLOBALS["___mysqli_ston"], $query39) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	   $res39 = mysqli_fetch_array($exec39);
	   $res39visitcode = $res39['patientvisitcode'];
	   $res39patientname = $res39['patientname'];
		?>
		      ...
		      <tr>
			     <td colspan="13" align="left" bgcolor="" class="bodytext31"><strong>Radiology Details</strong></td>
			  </tr>
               <tr>
			     <td colspan="8" align="center" bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo $patientname;  ?>/<?php echo $patientcode; ?>/<?php echo $res39visitcode; ?></strong></td>
			  </tr>
...
<td width="9%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff" colspan="2"><div align="center"><strong>Action By</strong></div></td>
           ...
           $query34 = "select * from ipconsultation_radiology where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
		   $exec34 = mysqli_query($GLOBALS["___mysqli_ston"], $query34) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		   while($res34 = mysqli_fetch_array($exec34))
		   {
		   $patientname = $res34['patientname'];
		   $patientcode = $res34['patientcode'];
		   $visitcode = $res34['patientvisitcode'];
		   $itemname = $res34['radiologyitemname'];
		   $itemcode = $res34['radiologyitemcode'];
		   $docno = $res34['docnumber'];
		   $quantity = '1';
		   $res34date = $res34['consultationdate'];
		   $rateperunit = $res34['radiologyitemrate'];
		   $totalrate = $res34['radiologyitemrate'];
		   $freestatus = $res34['freestatus'];
		   $username = $res34['username'];
		   $ipaddress = '';
		   $issuedocno = '';
	  ...
	  $sno=0;
	   ...
	   $query39 = "select * from ipconsultation_services where patientcode = '$patientcode' and patientvisitcode = '$visitcode' ";
	   $exec39 = mysqli_query($GLOBALS["___mysqli_ston"], $query39) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	   $res39 = mysqli_fetch_array($exec39);
	   $res39visitcode = $res39['patientvisitcode'];
	   $res39patientname = $res39['patientname'];
		?>
		      ...
		      <tr>
			     <td colspan="13" align="left" bgcolor="" class="bodytext31"><strong>Services Details</strong></td>
			  </tr>
               <tr>
			     <td colspan="8" align="center" bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo $patientname;  ?>/<?php echo $patientcode; ?>/<?php echo $res39visitcode; ?></strong></td>
			  </tr>
...
<td width="4%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><div align="center"><strong>S.No.</strong></div></td>
<td width="8%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><div align="center"><strong>Ref No</strong></div></td>
<td width="16%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff" colspan="2"><div align="center"><strong>Item Name</strong></div></td>
<td width="8%"  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Quantity</strong></div></td>
<td width="8%"  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Rate</strong></div></td>
<td width="8%"  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Amount </strong></div></td>
<td width="9%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><div align="center"><strong>Requested Date</strong></div></td>
<td width="9%" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff" colspan="2"><div align="center"><strong>Action By</strong></div></td>
           ...
           $query34 = "select * from ipconsultation_services where patientcode = '$patientcode' and patientvisitcode = '$visitcode'";
		   $exec34 = mysqli_query($GLOBALS["___mysqli_ston"], $query34) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		   while($res34 = mysqli_fetch_array($exec34))
		   {
		   $patientname = $res34['patientname'];
		   $patientcode = $res34['patientcode'];
		   $visitcode = $res34['patientvisitcode'];
		   $itemname = $res34['servicesitemname'];
		   $itemcode = $res34['servicesitemcode'];
		   $docno = $res34['docnumber'];
		   $quantity = $res34['serviceqty'];
		   $res34date = $res34['consultationdate'];
		   $rateperunit = $res34['servicesitemrate'];
		   $totalrate = $res34['amount'];
		   $freestatus = $res34['freestatus'];
		   $username = $res34['username'];
		   $ipaddress = '';
		   $issuedocno = '';
        ...
        <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
        <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $docno; ?></div></td>
        <td class="bodytext31" valign="center"  align="left"  colspan="2"><div align="center"><?php echo $itemname; ?></div></td>

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>   
		<td width="860">
              ...
              <form name="cbform1" method="post" action="packageissue.php">
...
?>
            ...
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Package Inpatient List </strong></td>
	  ...
	  <form name="form1" id="form1" method="post" action="packageissue.php">	
	  <tr>
        <td>
...
?>
		...
		*/
		...
		$visitcode = $res592['visitcode'];
		 ...
		 $query49 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$searchlocation' and visitcode='$visitcode' and package<>'0' and discharge not in ('discharged','completed') order by auto_number desc limit 0, 1" ;
			...
			if($num69 > 0)
		{
		   ...
		   $query82 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$searchlocation' and visitcode='$visitcode' and package<>'0' and discharge not in ('discharged','completed')";
		   ...
		   if($num82 > 0)
		   {
			...
			$query822 = "select * from transaction_stock where patientcode='$patientcode'  and locationcode='$searchlocation' and patientvisitcode='$visitcode' and description='Package' ";
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="left">
				...
				<td class="bodytext31" valign="center"  align="left"><a href="processpackage.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>" style="text-decoration: none;">Process</a>			</td>
              </tr>
		   <?php 
		   }
		   }

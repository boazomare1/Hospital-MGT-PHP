...
header('Content-Disposition: attachment;filename="morbidity-op_xl.xls"');
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
                ...
                <td colspan="4" valign="center"  align="center" bgcolor="#ffffff"><strong><?= strtoupper($res1location); ?></strong></td>
                 ...
                 <tr>
                <td colspan="2" valign="center"  align="left" bgcolor="#ffffff" class="bodytext31">Diagnosis [Morbidity]:OP</td>
                <td colspan="2" valign="center"  align="left" bgcolor="#ffffff" class="bodytext31">Printed On : <?php echo date('d-m-Y'); ?></td>
				</tr>
                 <tr>
				...
				<td align="center" valign="center" bgcolor="#ffffff" class="bodytext31" width="79%"><strong>DISEASE</strong></td>
				<td align="center" valign="center" bgcolor="#ffffff" class="bodytext31" width="8%"><strong>NO OF CASES</strong></td>

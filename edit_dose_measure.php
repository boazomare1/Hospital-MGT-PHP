...

{
  ...
  $query2 = "select id from dose_measure where name = '$producttype' and  id <> '$prodcuttypeanum'";
...

  {
    ...
    //echo 'yes';
      ...
      $query1 = "update dose_measure set name = '$producttype', updated_on = '$updatedatetime' where id = '$prodcuttypeanum'";

    $exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));

    $errmsg = "Success. Dose Measure Type Updated.";

    //$bgcolorcode = 'success';

    header ("location:edit_dose_measure.php?bgcolorcode=success&&st=edit&&anum=$prodcuttypeanum");
...

  {
    ...
    header ("location:edit_dose_measure.php?bgcolorcode=failed&&st=edit&&anum=$prodcuttypeanum");
...

{
    ...
    $query1 = "select id,name from dose_measure where id = '$anum'";
...

{
    ...
    $errmsg = "Success. Dose Measure Updated.";

    header("Refresh: 5; url=dose_measure.php");
      ...
      <tr>
        ...
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            ...
            <tr>
              ...
              <td><form name="form1" id="form1" method="post" action="edit_dose_measure.php" onSubmit="return addproducttype1process1()">
                  ...
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Dose Measure Master - Edit </strong></td>
            ...
            bgcolor="<?php if ($bgcolorcode == '') { echo '#FFFFFF'; } else if ($bgcolorcode == 'success') { echo '#FFBF00'; } else if ($bgcolorcode == 'failed') { echo '#AAFF00'; } ?>" class="bodytext3"><div align="left"><?php echo $errmsg; ?></div></td>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Edit Dose Measure</div></td>

...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="birthnotificationlist.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Birth Notification </strong></td>
              </tr>
	...
	<form name="form1" id="form1" method="post" action="birthnotificationlist.php">	
	  <tr>
        <td>
            ...
            $query2 = "select * from master_customer where customercode like '$patientcode'";
			 ...
			 // echo $num2;
              ...
              <tr <?php echo $colorcode; ?>>
				...
				?>
					<a target="_blank" href="edit_birth_notification.php?dnum=<?=  $dnumber ?>"> Edit </a>
				<?php
				}
				?>
					</td>

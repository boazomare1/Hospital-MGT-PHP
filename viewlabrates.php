...
//if (isset($_REQUEST["searchflag12"])) { $searchflag12  = $_REQUEST["searchflag12"]; } else { $searchflag12  = ""; }
...

	{
        ...
        <tr <?php echo $colorcode; ?>>
                        ...
                        <td width="7%" align="left" valign="top"  class="bodytext3"><?php echo $itemcode; ?> </td>

                        <td width="14%" align="left" valign="top"  class="bodytext3"><?php echo $categoryname; ?> </td>

                        <td width="27%" align="left" valign="top"  class="bodytext3"><?php echo $itemname; ?> </td>
					   ...
					   <td width="9%" align="left" valign="top"  class="bodytext3"><?php echo $ipmarkup; ?> </td>
                        ...
                        <td width="10%" align="left" valign="top"  class="bodytext3"><div align="right"><?php echo $rateperunit; ?></div></td>

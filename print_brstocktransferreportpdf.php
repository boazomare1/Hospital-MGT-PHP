...
<?php  include("print_header1.php"); ?>
            ...
            <tbody>
              <tr>
                <td colspan="14" bgcolor="#FFF" class="bodytext31">
				<strong>Branch Stock Transfer Report</strong></td>
                </tr>
              ...
              <tr>
                ...
                bgcolor="#ffffff"> <strong>From Location</strong> </td>
                <td  width="20"class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"> <strong> From Store </strong> </td>
				 <td  width="20"class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"> <strong>To Location</strong> </td>
                <td  width="20"class="bodytext31" valign="center"  align="left" 
			...
			if($typetransfer=="Consumable" || $tostore1==''){						
			  ...
			  $res66tolocationcode = $res66['tolocationcode'];
			  ...
			  $query32 = "select locationname from master_location where locationcode = '$res66tolocationcode'";
			  ...
			  $res3tolocationname = $res32['locationname'];
              ...
              <tr>
                ...
                <td class="bodytext31"  valign="center"  align="left"> <?php echo $fromstore1; ?> </td>
				 <td width="80"  class="bodytext31"  valign="center"  align="left">  <?php echo $res3tolocationname; ?> </td>
                <td class="bodytext31"  valign="center"  align="left"><?php echo $tostore1; ?> </td>
                <td class="bodytext31" valign="center"  align="left"> <?php echo $entrydate; ?> </td>
                <td  width="130" class="bodytext31" valign="center"  align="left"><?php echo $itemname; ?> </td>
                <td class="bodytext31" valign="center"  align="left"><?php echo $batch; ?> </td>
                <td class="bodytext31" valign="center"  align="left"> <?php echo $expirydate; ?> </td>
                  <td class="bodytext31" valign="center"  align="left"> <?php echo $transaction_quantity; ?> </td>
                <td class="bodytext31" valign="center"  align="left"><?php echo number_format($rate,2); ?> </td>
				<td width="60"  class="bodytext31" valign="center"  align="right"> <?php echo number_format($amount,2); ?> </td>
              </tr>
			  <?php
			  //}
			  }

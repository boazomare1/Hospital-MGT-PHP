    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="791" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Sample Collection Attached </strong></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td width="12%" align="left" valign="center"  
				...
				<td width="5%"  align="left" valign="center" bgcolor="#ecf0f5">&nbsp;</td>
				<td width="16%"  align="left" valign="center" bgcolor="#ecf0f5">&nbsp;</td>
			...
			<?php
			 ...
			 if (isset($_REQUEST["cbfrmflag1"])) { $cbfrmflag1 = $_REQUEST["cbfrmflag1"]; } else { $cbfrmflag1 = ""; }
			   ...
			   $exeemp=mysqli_query($GLOBALS["___mysqli_ston"], $queryemp);
			   while($result=mysqli_fetch_array($exeemp))
			   {
				   $empusername=$result['username'];
				?>
				<tr> <td colspan="5" bgcolor="#ecf0f5" class="bodytext31"><?php echo $empusername;?></td></tr>
				<?php

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="package_linking.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		   <tr>
              <td colspan="5" bgcolor="#ecf0f5" class="bodytext3"><strong> Package Linking </strong></td>
            ...
            <tr>
              <td colspan="8" class="bodytext3"><strong> Select Package </strong>
	  ...
	  <tr id="pressid">
            ...
            <?php $skey=isset($_REQUEST['skey'])?$_REQUEST['skey']:''; if($skey==1){?>
             <tr>
                        <td colspan="2" class="bodytext3" style="color:#F00" align="center"><strong>Package Linking Edited Successfully </strong></td>
                      </tr>
                      <?php }?>
			 <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Package Linking - Existing List </strong></td>
                      </tr>
                      <tr>
                      ...
                      <?php
					  $colorloopcount = '';
	    $query1 = "select * from master_packageslinking where recordstatus <> 'deleted' group by packagecode";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
		while ($res1 = mysqli_fetch_array($exec1))
		{
		$packagecode = $res1['packagecode'];
		...
		?>
                      <tr <?php echo $colorcode; ?>>
						...
						<a href="editpackageslinking.php?st=edit&&code=<?php echo $packagecode; ?>" style="text-decoration:none">Edit</a>						</td>
                      </tr>
                      <?php
		}
		?>

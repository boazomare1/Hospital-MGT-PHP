...
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   <td width="1%" align="left" valign="top">&nbsp;</td>
    <td  valign="top">
	<form name="form1" id="form1" method="post" action="leaveentitlementandusagereport.php">
	...
	<tbody>
	<tr bgcolor="#999999">
	<td colspan="30" align="left" class="bodytext3"><strong>Search  Employees Leave Entitlement and Usage Report</strong></td>
	</tr>
	<tr>
   ...
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tbody>
	<tr bgcolor="#999999">
	<td colspan="58" align="left" class="bodytext3"><strong>Employees Leave Entitlement and Usage Report.</strong></td>
	</tr>
	<tr>
	...
	<td width="67" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Allowed Leave days</strong></td>
	<td width="67" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Usage</strong></td>
	<td width="67" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Balance</strong></td>
	...
	$deptunit = $res45['departmentunit'];
	 ...
	 $retirement_date=$res45['retirement_date']; 
	    ...
	    $query51 = "select sum(total_days) as total_days from leave_request where employeecode='$res2employeecode' and approvalstatus = 'approved' group by employeecode ";
	...
	<td  align="left"  class="bodytext3"><strong><?php echo $allowed_leave_days; ?></strong></td>
	<td  align="left"  class="bodytext3"><strong><?php echo $total_days; ?></strong></td>
	<td  align="left"  class="bodytext3"><strong><?php echo ($allowed_leave_days-$total_days); ?></strong></td>

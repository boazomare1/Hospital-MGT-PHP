...
//			  }
			...
			$fxrate = $original_fxrate;
			  ...
			  $query19 = "select * from ipconsultation_lab where patientvisitcode='$visitcode' and patientcode='$patientcode' and labitemname <> '' and labrefund <> 'refund' and freestatus='No' order by consultationdate";
...
<br />
		...
		<thead>
			...
			<tr>
				...
				<td  align="left" valign="center" style="white-space:normal" width="175"
	...
	?>
            ...
            <td colspan="6"><strong>ADMISSION FEE</strong></td></tr>
			 ...
			 <td class="bodytext31" valign="center"  align="left" width="175"><?php echo 'Admission Charge'; ?></td>
...

	{
	 ...
	 $reqdate = date('Y-m-d',strtotime($packagedate1) + (24*3600*$reqquantity));
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="left" width="175"><?php echo $packagename; ?></td>
...
$totalbedtransferamount=0;
			...
			while($resca01=mysqli_fetch_array($execa01)){
                ...
                <tr>
                    ...
                    <td class="bodytext31" valign="center"  align="left" width="85"><div align="left"><?php echo trim($wardname); ?></div></td>

                    <td class="bodytext31" valign="center"  align="left" width="175"><div align="left" ><?php echo trim($charge1).' ('.$bedname.')'; ?></div></td>
...
//while (strtotime($from_limit_date) <= strtotime($to_limit_date)) {
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td> 
			 ...
			 <td class="bodytext31" valign="center"  align="left"  width="175"nowrap="nowrap"><?php echo $phaname; ?></td>
			...
			<!-- <input name="medicinename[]" type="hidden" id="medicinename" size="25" value="<?php echo $phaname; ?>">
			 ...
			 <td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($resamount,2,'.',',');; ?></td>
			  ...
			  <?php 
				  ...
				  $query19 = "select * from ipconsultation_lab where locationcode='$locationcode' and patientvisitcode='$visitcode' and patientcode='$patientcode' and labitemname <> '' and labrefund <> 'refund' and freestatus='No' order by consultationdate";
		...
		<!--	<input name="lab[]" id="lab" size="69" type="hidden" value="<?php echo $labname; ?>">
			...
			<td class="bodytext31" valign="center"  align="left" width="175"><?php echo $labname; ?></td>
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="left" width="175"><?php echo $radname; ?></td>
		...
		<!--	<input name="radiology[]" id="radiology" type="hidden" size="69" autocomplete="off" value="<?php echo $radname; ?>">
		    ...
		    $query21 = "select * from ipconsultation_services where locationcode='$locationcode' and patientvisitcode='$visitcode' and patientcode='$patientcode' and servicesitemname <> '' and servicerefund <> 'refund' and wellnessitem <> '1' and freestatus = 'No'  group by servicesitemname,iptestdocno order by consultationdate";
...
/*			$querys51 = "select sum(servicesitemrate) as rateperunit from `billing_ipservices` where patientvisitcode='$visitcode' and patientcode='$patientcode' and servicesitemcode='$sercode' and wellnessitem <> '1'";
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left"width="175"><?php echo $sername." - ".$servicesdoctorname; ?></td>
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="left"width="175"><?php echo $otbillingname; ?></td>
		...
		<!--	<input name="surgeryname[]" type="hidden" id="surgeryname" size="69" value="<?php echo $otbillingname; ?>">
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left"width="175"><?php echo $privatedoctor.' '.$description; ?></td>
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left"width="175"><?php echo $ambulance; ?></td>
			...
			$query69 = "select * from ipmisc_billing where locationcode='$locationcode' and patientcode='$patientcode' and patientvisitcode='$visitcode' order by consultationdate";
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left"width="175"><?php echo $miscbilling; ?></td>
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left" width="175"><?php echo 'Deposit'; ?>&nbsp;&nbsp;<?php echo $transactionmode; ?>
			...
			?>
			  ...
			  <tr>
				...
				<td class="bodytext31" valign="center"  align="left"><?php echo $sno = $sno + 1; ?></td> 
				 ...
				 <td class="bodytext31" valign="center"  align="left"width="175"><?php echo 'Deposit Refund'; ?></td>
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left"width="175"> <?php echo 'NHIF'; ?></td>
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left"width="175">Discount On <?php echo $discount; ?> by <?php echo $authorizedby; ?></td>

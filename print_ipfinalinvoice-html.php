...
<page pagegroup="new" backtop="12mm" backbottom="20mm" backleft="2mm" backright="3mm">
	...
	<table width="600" align="center" border="0" cellspacing="4" cellpadding="0">
...
//while (strtotime($from_limit_date) <= strtotime($to_limit_date)) {
			...
			$query23 = "select * from pharmacysales_details where  visitcode='$visitcode' and patientcode='$patientcode' and freestatus = 'No' and from_module<>'fromtheaterbilling' and store='".$resStore['storecode']."'  GROUP BY ipdocno,itemcode order by entrydate";
			$exec23 = mysqli_query($GLOBALS["___mysqli_ston"], $query23) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			$num_pharmacy = mysqli_num_rows($exec23);
			if($num_pharmacy>0){

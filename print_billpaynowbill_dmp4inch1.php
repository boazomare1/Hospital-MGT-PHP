...
/*	$query2 = "select * from master_company where locationcode='$locationcode' and auto_number = '$companyanum'";
	...
	$res11creditcardnumber = $res11['creditcardnumber'];

	$res11onlineamount= $res11['onlineamount'];
	
	$res11onlinenumber= $res11['onlinenumber'];
...
<tr><td class="" colspan="4" width="375">&nbsp;</td></tr>
  ...
  <tr>
	 ...
	 <td align="center" class="bodytext32 border" width="20">S.No</td>
	  ...
	  <td align="center" class="bodytext32 border" width="250"><strong>Description</strong></td>

	  <td align="center" class="bodytext32 border" width="20"><strong>Qty</strong></td>

	  <td align="right" class="bodytext32 border" width="30"><strong>Rate</strong></td>

    <td align="right" class="bodytext32 border" width="50"><strong>Amount</strong></td>
   ...
   $query14 = "select planpercentage,planname from master_visitentry where locationcode='$locationcode' and visitcode = '$res11visitcode' and patientcode = '$res11patientcode'  ";
			...
			?>
			  ...
			  <tr <?php //echo $colorcode; ?>>
			   ...
			   <td class="bodytext34 border" valign="center"  align="left"  width="245">
			   ...
			   <?php echo 1; ?></td>
				...
				<td class="bodytext34 border" valign="center"  align="right"  width="55">
			...
			<tr <?php //echo $colorcode; ?>>
				<td class="bodytext34 border" valign="center"  align="center" ><?php echo $sno; ?></td>
				<td class="bodytext34 border" valign="center"  align="left"  width="245"><?php echo nl2br($res3referalname.$res51referalremark); ?></td>
				<td class="bodytext34 border" valign="center"  align="center" ><?php echo 1; ?></td>
				<td class="bodytext34 border" valign="center"  align="right" ><?php echo number_format($res3referalrate,2,'.',','); ?></td>
				<td class="bodytext34 border" valign="center"  align="right" ><?php echo number_format($res3referalrate,2,'.',','); ?></td>
			</tr>
			...
			?>
              ...
              <td class="bodytext34 border" valign="center"  align="center">
			   ...
			   <?php echo $sno; ?></td>
			    ...
			    <td class="bodytext34 border" valign="center"  align="left" width="235"><?php echo nl2br($res4medicinename); ?></td>

			    <td class="bodytext34 border" valign="center"  align="center" ><?php echo $res4quantity; ?></td>

			    <td class="bodytext34 border" valign="center"  align="right"><?php echo number_format($res4rate,2,'.',','); ?></td>

			    <td class="bodytext34 border" valign="center"  align="right" ><?php echo number_format($res4amount,2,'.',','); ?></td>
    ...
    <tr>
		...
		<td align="right " colspan="4" class="bodytext32">Bill Amounts:</td>
...
<table width="100%"  align="center" cellpadding="0" cellspacing="0">
 ...
 <?php if($res11cashgivenbycustomer != 0.00) { ?> 
	...
	<tr>
		...
		<td class="bodytext32"><strong>Cheque Amount - <?php echo $res11chequenumber;?></strong></td>
	...
	<tr>
		...
		<td class="bodytext32"><strong>Online Amount - <?php echo $res11onlinenumber;?></strong></td>
	...
	<tr>
		...
		<td class="bodytext32"><strong>Card Amount - <?php echo $res11creditcardnumber;?></strong></td>
	...
	<tr>
		...
		<td class="bodytext32"><strong>MPESA - <?php echo $mpesanumber;?></strong><span align="right"></span></td>
	...
	<tr>
		...
		<td class="bodytext32"><strong>Deposit Adjusted</strong></td>

		<td align="right" class="bodytext34" valign="middle"><?php echo number_format($res11adjustamount,2,'.',','); ?></td>
	...
	<tr>
		...
		<td colspan="5" class="bodytext32" width="375"><strong>Kenya Shillings </strong><?php echo str_replace('Kenya Shillings','',$convertedwords); ?></td>
	...
	<tr>
     ...
     <?php
	 $res11subtotalamount=$res11transactionamount;
	  $source_from='';
  ...
  ?>
	...
	<tr>
		...
		<td  class="bodytext32">Served By: <?php echo strtoupper($res11username); ?> </td>
        <td class="bodytext31"><?php echo date("d/m/Y", strtotime($res11billingdatetime))."&nbsp;".date("g.i A",strtotime($res11updatetime)); ?> </td>

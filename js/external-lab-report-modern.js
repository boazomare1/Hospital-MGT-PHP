/**
 * External Lab PO Report Modern JavaScript
 * Handles interactive elements for the external lab PO report system
 */
...
function initializeApp() {
    console.log('External Lab PO Report Modern JS initialized');
...
function initializeTableSorting() {
    $('.data-table th').each(function() {
        ...
        if (text === 'Date' || text === 'Patient Name' || text === 'Test Name' || text === 'Amount' || text === 'Rate') {
...
function exportReport() {
    ...
    a.href = url;
    a.download = `external_lab_po_report_${fromdate}_to_${todate}.csv`;

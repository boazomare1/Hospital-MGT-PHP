...
function employeesearch5()
{
	...
	if(document.getElementById("employeesearch").value!="")
	{
		...
		document.getElementById("employeesearch").value = varEmployeesearch;
...
function ajaxprocessACCS2()
{
	...
	var url = "";
	var url="autoemployeecodesearch5.php?RandomKey="+Math.random()+"&&employeesearch="+varEmployeesearch;
   	//alert(url);

  ...
  <tr>
	...
	<td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
              ...
              <form name="cbform1" method="post" action="ipamendrad_pending_sup.php">
              ...
              <td colspan="3" bgcolor="#ecf0f5" align="left"  class="bodytext31">
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="6" bgcolor="#ecf0f5" class="bodytext31"><script language="javascript">
			...
			$query1 = "select * from ipconsultation_radiology where  locationcode='$searchlocationcode' and consultationdate between '$searchadate1'and '$searchadate2' $filter_qry group by patientvisitcode order by consultationdate DESC";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="ipamendradiology_sup.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&locationcode=<?php echo $locationcode; ?>&&menuid=<?php echo $menu_id; ?>"><strong>Amend</strong></a>			  </td>

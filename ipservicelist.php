...
// Check if table exists and get service list data
$tableExists = false;
$exec2 = null;
$sno = 0;

// Check if table exists
$checkTable = "SHOW TABLES LIKE 'billing_ipservices'";
$checkResult = mysqli_query($GLOBALS["___mysqli_ston"], $checkTable);
if(mysqli_num_rows($checkResult) > 0) {
    $tableExists = true;
    $query2 = "select * from billing_ipservices where date(updatedatetime) between '$fromdate' and '$todate' order by updatedatetime desc";
    if($location != '') {
        $query2 = "select * from billing_ipservices where locationcode='$location' and date(updatedatetime) between '$fromdate' and '$todate' order by updatedatetime desc";
    }
...
<head>
    ...
    <title>Service List - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/ipservicelist-modern.css?v=<?php echo time(); ?>">
        ...
        <aside id="leftSidebar" class="left-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="ipservicelist.php" class="nav-link active">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2><i class="fas fa-stethoscope"></i> Service List</h2>
                    <p>View and manage inpatient services</p>
                </div>
                ...
                <form method="post" class="search-form">
                    <div class="search-row">
                        <div class="search-group">
                            ...
                            <input type="text" id="searchInput" class="search-input" placeholder="Search by patient name, service, or ID...">
                        </div>
...
<?php
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 3rem;">
                                <div style="color: #64748b; font-size: 1.1rem;">
                                    ...
                                    <p>The 'billing_ipservices' table does not exist in the database.</p>
                        ...
                        <tr>
                            <td colspan="9" style="text-align: center; padding: 3rem;">
                                <div style="color: #64748b; font-size: 1.1rem;">
                                    ...
                                    <p>No service records found for the selected date range.</p>
                                </div>
                            </td>
                        </tr>
                        <?php } else if ($exec2) { 
                            ...
                            while ($res2 = mysqli_fetch_array($exec2)) {
                                ...
                                $amount = $res2["amount"];
                                $servicedate = $res2["updatedatetime"];
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($servicetype); ?></td>
                            <td>₹<?php echo number_format($amount, 2); ?></td>
                            <td><?php echo date('d-m-Y H:i', strtotime($servicedate)); ?></td>
    ...
    <!-- Modern JavaScript -->
    <script src="js/ipservicelist-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

...
$ipaddress = $_SERVER["REMOTE_ADDR"];
	...
	if($selValue==1)
	{
 	...
 	$query31 = "update  pcrequest set amount='$ramount',approved_amt='$aamount',approved_status='$selValue',first_approvel_user='$user',first_approval_date='$updatedate',ipaddress='$ipaddress' WHERE doc_no = '$doc'";
...
//	if($selValue==2)
 	...
 	$query31 = "update  pcrequest set final_status='pending',amount='$ramount',approved_amt='$aamount',approved_status='$selValue',first_rejected_user='$user',first_rejected_date='$updatedate',ipaddress='$ipaddress' WHERE doc_no = '$doc'";
	$exec31 = mysqli_query($GLOBALS["___mysqli_ston"], $query31) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
	if($exec31){
		echo 'success';
	}else{

...
<TABLE cellpadding=0 cellspacing=0   style=" margin: 20px 30px 0px 60px;">
	<tr>
      ...
      <img src="logofiles/1.png" width="150" height="80" />
...
<TR>
	...
	<TD colspan=2 class="tr2 td2"><P class="p1 ft2">Admitted On : <?php echo  date("d/m/Y", strtotime($admissiondate))." ".$admissiontime; ?></P></TD>
</TR>
<TR>
	 	<TD class="tr2 td1"><P class="p0 ft0">&nbsp;</P></TD>
...
<TABLE cellpadding=0 cellspacing=0 class="t1" style=" margin: 10px 30px 0px 60px;">
	<TR>
...
<div style=" margin: 10px 30px 0px 60px;">
	<hr>

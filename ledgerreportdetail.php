    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong> Ledger Report</strong></td>
              </tr>
            <!--<tr>
       ...
       <tr>
        <td><table width="80%" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			<?php }//} ?>	
				...
				$ledgertotal = 0;
				if($group == '18' || $group == '19' || $group == '20' || $group == '21' || $group == '22' || $group == '23' || $group == '24' || $group == '25' || $group == '26' || $group == '27' || $group == '28' || $group == '30' || $group == '31' || $group == '32' || $group == '33' || $group == '34' || $group == '35' || $group == '36' || $group == '37' || $group == '42')
				{
				?>
				<tr bgcolor="#CCC">
				<td width="92" align="left" class="bodytext3"><strong><?php echo 'S.No'; ?></strong></td>
...
$searchsuppliername='';
	...
	*/
	...
	$i = 0;
		$crresult1 = array();
		$querycr1in = "SELECT (`consultation`) as income, patientcode as code, patientname as name, billnumber as docno, billdate as date FROM `billing_consultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'						
		...
		$j = 0;
		$drresult1 = array();
		$querydr1in = "SELECT (`consultation`) as income, patientcode as code, patientname as name, billnumber as docno, billdate as date FROM `refund_consultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
		UNION ALL SELECT (`consultation`) as income, patientcode as code, patientname as name, billnumber as docno, billdate as date FROM `refund_paylaterconsultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'";
	...
	if($id == '01-1002')
	{
		...
		$balance = $balance + array_sum($crresult) - array_sum($drresult);
				...
				else if($group == '38' || $group == '43' || $group == '44')
				{
					$totalamount=0;
					$openingbalance1=0;
					?>
				...
				else if($group == '39' || $group == '40' || $group == '41')
				{
				?>
				<tr bgcolor="#CCC">
				<td width="92" align="left" class="bodytext3"><strong><?php echo 'S.No'; ?></strong></td>
	...
	$i = $i+1;
				...
				//ACCOUNTS PAYABLE-19
				else if($group == '29' || $group == '45' || $group == '48' || $group == '49' || $group == '50' || $group == '51' || $group == '52' || $group == '53' || $group == '46' || $group == '47')
				{
					$totalamount=0;
					$openingbalance1=0;?>
                     <tr bgcolor="#CCC">

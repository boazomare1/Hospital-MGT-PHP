...
if (isset($_REQUEST["locationcode1"])) {  $locationcode = $_REQUEST["locationcode1"]; } else { $locationcode = ""; }
...
?>
		...
		<table width="800" border="0" align="left" cellpadding="1" cellspacing="0" >
      ...
      <tr>
       ...
       <tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            bordercolor="#666666" cellspacing="0" cellpadding="1" width="1200" 
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ffffff" width="30"><strong>No.</strong></td>
			...
			<td width="50" align="left" valign="center"  
              ...
              <td width="100" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Credit</strong></div></td>
              <td width="50" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Outstanding</strong></div></td>
...
/* 				$query81 = "select patientvisitcode,billnumber,referalrate from billing_paynowreferal  where referalname='$searchsuppliername' and  billdate < '$ADate1'";
		  ...
		  ?>
			...
			<td class="bodytext31" valign="center"  align="left" 
			 ...
			 <td  align="left" valign="center"   bgcolor="#ecf0f5" class="bodytext31"><div align="right"><strong>&nbsp;</strong></div></td>	
			 <td  align="left" valign="center"   bgcolor="#ecf0f5" class="bodytext31"><div align="right"><strong>&nbsp;</strong></div></td>	
			...
			?>
				...
				<tr bgcolor="#ffffff">
					...
					<td colspan="12"  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong><?php echo $res21accountname;?> (Date From: <?php echo $ADate1; ?> Date To: <?php echo $ADate2; ?>)</strong></td>
			...
			//--UNION ALL SELECT '' AS doctorname,patientname,patientcode,patientvisitcode as visitcode, accountname,docno as billnumber, consultationdate as recorddate, 0 as original_amt,amount, sum(amount) as transactionamount, billtype, locationcode, 0 as transactionamount1, billingaccountcode as doccoa, '' as visittype from adhoc_debitnote where billingaccountcode = '$searchsuppliercode' and consultationdate between '$ADate1' and '$ADate2'  group by visitcode
			 ...
			 // sum(transactionamount) as transactionamount, billtype, locationcode, 0 as transactionamount1, doccoa as doccoa, visittype as visittype from billing_ipprivatedoctor_refund where doccoa = '$searchsuppliercode' and recorddate between '$ADate1' and '$ADate2' group by visitcode ) as a group by visitcode,billnumber 
...
*/
			...
			//$query3 = "select * from master_transactiondoctor where billnumber = '$billnumber'  and recordstatus = '' and billautonumber='$billautonumber' and acc_status <> 'deallocated' order by auto_number desc";

			$query3 = "select * from master_transactiondoctor where billnumber = '$billnumber'  and recordstatus = ''  and acc_status <> 'deallocated' and doctorcode = '$searchsuppliercode' order by auto_number desc";
		...
		else
		{
			...
			else
			{
				...
				else
				{
				  ...
				  <td class="bodytext31" valign="center"  align="right">
					<?php echo number_format($balanceamount1,2,'.',','); ?>
					<!-- <div align="right"><?php // if ($balanceamount != '0.00') echo number_format($balanceamount,2,'.',','); ?> -->
					</td>
					<?php $outstanding_new=$balanceamount1-$res45transactionamount;
					 ?>

					<td class="bodytext31" valign="center" align="right"><?php echo number_format(($balanceamount1-$res45transactionamount),2,'.',','); ?> </td>

					<td class="bodytext31" valign="center"  align="left"> <div align="center"><?php echo $daysafterbilldate; ?></div></td>
...
<tr>
      <td>
			...
			<tr>
              ...
              <td width="100" class="bodytext31" valign="center"  align="left" 
           ...
           <td class="bodytext31" valign="center"  align="right" 
			...
			<tr>
               ...
               <td class="bodytext31" valign="center"  align="right" ><?php echo number_format(($totalamount30+$totalamount30_n),2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right" ><?php echo number_format(($totalamount60+$totalamount60_n),2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right" ><?php echo number_format(($totalamount90+$totalamount90_n),2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right" ><?php echo number_format(($totalamount120+$totalamount120_n),2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right" ><?php echo number_format(($totalamount180+$totalamount180_n),2,'.',','); ?></td>

            <td class="bodytext31" valign="center"  align="right" ><?php echo number_format(($totalamountgreater+$totalamountgreater_n),2,'.',','); ?></td>

             	 <td class="bodytext31" valign="center"  align="right" ><?php echo number_format(($totalat+$grandtotal_n),2,'.',','); ?></td>
...
//      $html2pdf->setModeDebug();
        ...
        $html2pdf->Output('print_doctoroutstanding_detailed.pdf');

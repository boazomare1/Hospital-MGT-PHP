...
text-align:right;
		...
		<table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            align="left" border="1">
            <tr>
            <td align="left" colspan="2" class="bodytext3"><strong>Income Statement</strong></td>
            </tr>
            <tr>
            <td align="left" colspan="2" class="bodytext3"><strong>From <?= $ADate1.' To '.$ADate2; ?></strong></td>
            </tr>
			<?php
			...
			{	
				...
				?>
				<tr bgcolor="#FFF">
				<td width="695" align="left" class="bodytext3" ><strong>Total :</strong></td>
				<td width="100" align="right" class="bodytext3" ><strong><?php echo number_format($ledgeramountsum,2,'.',','); $GLOBALS['$ledgeramountsumtotal'] = $ledgeramountsum; + $GLOBALS['$ledgeramountsumtotal'];?></strong></td>
				</tr>
				<?php
			...
			?>
			<tr >
			<td width="695" align="left" class="bodytext3" ><strong><?php echo $accountsmain; ?></strong></td>
			<td width="100" align="right" class="bodytext3" ><strong><?php //echo number_format($totalamount12,2,'.',','); ?></strong>&nbsp;&nbsp;</td>
			</tr>
			<?php		
			$querygroup2 = "select accountsmain from master_accountssub where accountsmain = '$parentid' and parentid = '0' and recordstatus <> 'deleted'";
			...
			<!--<tr bgcolor="#ecf0f5">
			<td width="695" align="left" class="bodytext3" ><strong>Total :</strong></td>
			<td width="100" align="right" class="bodytext3" ><strong><?php echo number_format($ttlamt,2,'.',','); ?></strong>&nbsp;&nbsp;</td>
			</tr>-->
			<?php
			}
			...
			<tr>
			<td width="695" align="left" class="bodytext3" ><strong>Total :</strong></td>
			<td width="100" align="right" class="bodytext3" ><strong><?php $groupleft12 = groupleft('0'); echo number_format($groupleft12,2,'.',','); ?></strong></td>
			</tr>
			<tr>
			<td colspan="2" width="695" align="left" class="bodytext3"><strong>&nbsp;</strong></td>
			</tr>
            <?php
			...
			{	
				...
				<tr >
				<td width="695" align="left" class="bodytext3" ><strong>Total :</strong></td>
				<td width="100" align="right" class="bodytext3" ><strong><?php echo number_format($ledgeramountsum,2,'.',','); ?></strong></td>
				</tr>
				<?php
			...
			<tr>
			<td width="695" align="left" class="bodytext3" ><strong>Total :</strong></td>
			<td width="100" align="right" class="bodytext3" ><strong><?php $groupright12 = groupright(0); echo number_format($groupright12,2,'.',','); ?></strong></td>
			</tr>
			<tr >
			<td width="695" align="left" class="bodytext3" ><strong>Net Profit / Loss :</strong></td>
			<td width="100" align="right" class="bodytext3" ><strong><?php $netpandl = $groupleft12 - $groupright12; echo number_format($netpandl,2,'.',','); ?></strong></td>
			</tr>
...
function ledgervalue($parentid,$ADate1,$ADate2,$tbinclude,$tbclosing)
{
	...
	if($parentid != '' && $tbinclude != '' && $tbclosing == '')
	{
		include($tbinclude);
		return $sumbalance;
	}
	else if($parentid != '' && $tbinclude != '' && $tbclosing != '')
	{
		include($tbinclude);
		//include($tbclosing);
		//$sumbalance = $sumbalance + $sumbalance1;
		$sumbalance = $sumbalance + 0;
		return $sumbalance;
	}
	else
	{

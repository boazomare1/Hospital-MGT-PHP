...
<td style="border-bottom:solid 1px #000000;">&nbsp;</td>
  ...
  <tr>
	  <td width="52" align="center" class="bodytext32" style="border:solid 1px #000000;  border-right:none;"><strong>NAME OF THE CHILD </strong></td>
	  <td width="27" align="center" class="bodytext32" style="border:solid 1px #000000; "><strong>WEIGHT</strong></td>
   ...
   <tr <?php //echo $colorcode; ?>>
				...
				<td height="27" class="bodytext32" valign="center"  align="center" style="border:solid 1px #000000;  border-right:none;">
			   <?php echo strtoupper($resdoc['child_name']);?></td>
				<td  height="27" class="bodytext32" valign="center"  align="center" style="border:solid 1px #000000; ">
...
<table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	  <td width="52" align="center" class="bodytext32" style="border:solid 1px #000000;  border-right:none;"><strong>DATE OF BIRTH OF CHILD</strong></td>
	  <td width="27" align="center" class="bodytext32" style="border:solid 1px #000000; border-right:none;"><strong>SEX</strong></td>
	  <td width="67" align="center" class="bodytext32" style="border:solid 1px #000000; border-right:none;"><strong>DISTRICT</strong></td>
    <td width="68" align="center" class="bodytext32" style="border:solid 1px #000000; border-right:none;"><strong>SUB-COUNTY</strong></td>
	 <td width="53" align="center" class="bodytext32" style="border:solid 1px #000000; border-right:none;"><strong>PARISH</strong></td>
	  <td width="63" align="center" class="bodytext32" style="border:solid 1px #000000; "><strong>VILLAGE</strong></td>
   ...
   <tr <?php //echo $colorcode; ?>>
			 ...
			 <?php echo $resdoc['child_gender']; ?></td>
				<td height="27" align="center" valign="center" class="bodytext32" style="border:solid 1px #000000;  border-right:none;">
			   <?php echo "KAMPALA"; ?></td>
			   <td height="27" align="center" valign="center" class="bodytext32" style="border:solid 1px #000000;  border-right:none;">
			   <?php  echo "CENTRAL - DIVISION"; ?></td>
			   <td height="27" align="center" valign="center" class="bodytext32" style="border:solid 1px #000000;  border-right:none;">
			   <?php echo "NAKASERO"; ?></td>
			    <td  height="27" align="center" valign="center" class="bodytext32" style="border:solid 1px #000000; ">
...
<tr>
  ...
  <tr>
	  <td width="52" align="center" class="bodytext32" style="border:solid 1px #000000;  border-right:none;"><strong>NAME OF FATHER</strong></td>
	  <td width="27" align="center" class="bodytext32" style="border:solid 1px #000000; border-right:none;"><strong>NATIONALITY OF FATHER</strong></td>
	  <td width="67" align="center" class="bodytext32" style="border:solid 1px #000000; border-right:none;"><strong>NIN/AIN</strong></td>
    <td width="68" align="center" class="bodytext32" style="border:solid 1px #000000; border-right:none;"><strong>NAME OF MOTHER</strong></td>
	 <td width="53" align="center" class="bodytext32" style="border:solid 1px #000000; border-right:none;"><strong>NATIONALITY OF MOTHER</strong></td>
	  <td width="63" align="center" class="bodytext32" style="border:solid 1px #000000; "><strong>NIN/AIN</strong></td>
   ...
   <tr <?php //echo $colorcode; ?>>
			 ...
			 <?php echo strtoupper($resdoc['father_nationality']); ?></td>
			   ...
			   <td align="center" valign="center" class="bodytext32" style="border:solid 1px #000000;  border-right:none;">

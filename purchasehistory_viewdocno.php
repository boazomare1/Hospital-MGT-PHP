...
<table border=""  align="center" cellpadding="5" cellspacing="">
	...
	<tr>
       ...
       <td  align="center"   class="bodytext4 border">Rate</td>

      	<td  align="center" class="bodytext4 border">Discount %</td>

        <td  align="center" class="bodytext4 border">VAT %</td>

       <td  align="center" class="bodytext4 border">Amount </td>
    ...
    <tr>
    	...
    	<td align="right" class="bodytext4" colspan="10">VAT Amount:</td>
    ...
    <tr>
    	<td class="bodytext3" colspan="1"><strong>Prepared By&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong>&nbsp;<?php echo $username; ?></td>

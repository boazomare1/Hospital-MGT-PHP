		...
		<tr>
			...
			<td width="97%" valign="top">
				<table width="116%" border="0" cellspacing="0" cellpadding="0">
						...
						<td width="860">
							...
							<form name="cbform1" method="post" action="inpatientactivity.php">
								<table width="604" border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
									<tbody>
										<tr bgcolor="#011E6A">
											<td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Inpatient Activity</strong></td>
											...
											<!--<td colspan="5" bgcolor="#ecf0f5" class="bodytext3"><strong>Location</strong></td>-->
					...
					<tr>
						...
						<td width="30%" align="left" valign="top" bgcolor="#FFFFFF"><span class="bodytext3">
								...
								<select name="location" id="location" onChange=" funcSubTypeChange1(); ajaxlocationfunction(this.value);">
									...
									?>
										<option value="<?php echo $locationcode; ?>" <?php if ($location != '') {
						...
						<td width="30%" align="left" valign="top" bgcolor="#FFFFFF"><span class="bodytext3">
								<select name="ward" id="ward" onChange="return funcwardChange1()">
									...
									while ($res78 = mysqli_fetch_array($exec78)) {
										...
										$wardname = $res78['ward'];
									?>
										<option value="<?php echo $wardanum; ?>" <?php if ($wardanum == $ward12) {
																						echo "selected";
																					} ?>><?php echo $wardname; ?></option>
									<?php
									}
					...
					<tr>
						<td colspan="4" width="10%" align="center" bgcolor="#ecf0f5" class="bodytext3"><strong><input type="hidden" name="cbfrmflag1" value="cbfrmflag1">
		...
		<form name="form1" id="form1" method="post" action="inpatientactivity.php">
			<tr>
				<td>
					...
					?>
						<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="1199" align="left" border="0">
							<tbody>

								<tr>
									<td width="4%" class="bodytext31" valign="center" align="left" bgcolor="#ffffff">
										<div align="center"><strong>No.</strong></div>
									</td>
									<td width="22%" class="bodytext31" valign="center" align="left" bgcolor="#ffffff">
										<div align="center"><strong>Patient Name</strong></div>
									</td>
									<td width="12%" class="bodytext31" valign="center" align="left" bgcolor="#ffffff">
										<div align="center"><strong>Kin Name</strong></div>
									</td>
									<td width="9%" class="bodytext31" valign="center" align="left" bgcolor="#ffffff">
										<div align="center"><strong>Kin Number</strong></div>
									</td>
									<td width="7%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31">
										<div align="center"><strong>Age</strong></div>
									</td>
									<td width="6%" align="left" valign="center" bgcolor="#ffffff" class="style1">
										<div align="center">Gender</div>
									</td>
									<td width="6%" class="bodytext31" valign="center" align="left" bgcolor="#ffffff">
										<div align="center"><strong>Reg No</strong></div>
									</td>
									<td width="7%" class="bodytext31" valign="center" align="left" bgcolor="#ffffff">
										<div align="center"><strong>DOA</strong></div>
									</td>
									<td width="7%" class="bodytext31" valign="center" align="left" bgcolor="#ffffff">
										<div align="center"><strong>IP Visit</strong></div>
									</td>
									<td width="15%" class="bodytext31" valign="center" align="left" bgcolor="#ffffff">
										<div align="center"><strong>Ward</strong></div>
									</td>
									<td width="7%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31">
										<div align="center"><strong>Bed No </strong></div>
									</td>
									<td width="20%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31">
										<div align="center"><strong>Account</strong></div>
									</td>

									<td width="12%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31">
										<div align="center"><strong>IP Activity</strong></div>
									</td>
								</tr>
								<?php
								$query34 = "select * from master_ward where ward = '$wardname' and locationcode='$location'";
								...
								?>
									<tr>
										<td colspan="13" align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31">
											<div align="left"><strong><?php echo $wardname5; ?></strong></div>
										</td>
									</tr>
									<?php
									...
									while ($res50 = mysqli_fetch_array($exec50)) {
										...
										if ($num69 > 0) {
											...
											if ($num82 > 0) {
												...
												$execage = mysqli_query($GLOBALS["___mysqli_ston"], $queryage) or die("Error in queryage" . mysqli_error($GLOBALS["___mysqli_ston"]));
												if ($resage = mysqli_fetch_array($execage)) {
													$res10age = calculate_age($resage['dateofbirth']);
												}

												$querykin = "select kinname,kincontactnumber from master_customer where customercode='$patientcode' ";
												$execkin = mysqli_query($GLOBALS["___mysqli_ston"], $querykin) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
												$reskin = mysqli_fetch_array($execkin);
												$kinname = $reskin['kinname'];
												$kinno = $reskin['kincontactnumber'];
									...
									?>
												...
												<tr <?php echo $colorcode; ?>>
													...
													<td class="bodytext31" valign="center" align="left">
														<div align="center"><?php echo $kinname; ?></div>
													</td>
													<td class="bodytext31" valign="center" align="left">
														<div align="center"><?php echo $kinno; ?></div>
													</td>

													<td class="bodytext31" valign="center" align="left">
														<div align="center"><?php echo $res10age; ?></div>
													</td>
													<td class="bodytext31" valign="center" align="left">
														<div align="center"><?php echo $res10gender; ?></div>
													</td>
													<td class="bodytext31" valign="center" align="left">
													...
													<td class="bodytext31" valign="center" align="left">
														<div align="center"><a href="ipquickview.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>" target="_blank"><strong><?php echo $visitcode; ?></strong></a></div>
													</td>
													<td class="bodytext31" valign="center" align="left">
														<div align="center"><?php echo $wardname1; ?></div>
													</td>
													<td class="bodytext31" valign="center" align="left">
														<div align="center"><?php echo $bedname; ?></div>
													</td>
													<td class="bodytext31" valign="center" align="left">
														<div align="center"><?php echo $subtypename; ?></div>
													</td>
													<td class="bodytext31" valign="center" align="left">

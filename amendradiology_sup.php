...
if ($frm1submit1 == 'frm1submit1')
{
	...
	$rad= $_POST['radiology'];
		...
		if(($pairvar!="")&&($pairvar1!=""))
		{
		$radiologyquery1="insert into consultation_radiology(consultationid,patientcode,patientname,patientvisitcode,radiologyitemcode,radiologyitemname,radiologyitemrate,billtype,accountname,consultationdate,paymentstatus,refno,resultentry)values('$consultationid','$patientcode','$patientname','$visitcode','$radiologycode','$pairvar','$pairvar1','$patientpaymentmode','$accountname','$consultationdate','$status','$radrefnonumber','pending')";
...
$data=mysqli_query($GLOBALS["___mysqli_ston"], "select auto_number,patientcode,patientvisitcode,patientname,refno,radiologyitemcode,radiologyitemname,radiologyitemrate from consultation_radiology where auto_number='$radiologyname'");
...
if($medicinecode<>'')
{
 $query="insert into amendment_details (patientcode,visitcode,patientname,refno,itemcode,itemname,rate,amenddate,amendtime,amendfrom,amendby,ipaddress,remarks,qty,amount) values ('$patientcode','$visitcode','$patientname','$refno','$medicinecode','$medicinename','$rate','$date','$time','radiology','$username','$ipaddress','$remarks','1','$rate')";
mysqli_query($GLOBALS["___mysqli_ston"], $query)or die("Error in query".mysqli_error($GLOBALS["___mysqli_ston"]));
}
mysqli_query($GLOBALS["___mysqli_ston"], "delete from consultation_radiology where auto_number='$radiologyname' and patientvisitcode='$visit'");
header('location:amendradiology_sup.php?patientcode='.$patientcode.'&visitcode='.$visitcode);
}
...
$patientaccount=$res78['accountname'];
...
window.location='amendradiology_sup.php?delete='+id+'&patientcode='+patient+'&&visitcode='+visit+'&remarks-'+id+'='+msg;
}
}
...
<form name="form1" id="frmsales" method="post" action="amendradiology_sup.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			{
				$status='pending';
				$query17 = "select * from consultation_radiology where patientvisitcode='$visitcode' and patientcode='$patientcode' and paymentstatus='$status' ";
			}
			else
			{
				$query173 = "select planpercentage from master_visitentry where visitcode='$visitcode' and patientcode='$patientcode'";
				...
				{
					$status='completed';
					$query17 = "select * from consultation_radiology where patientvisitcode='$visitcode' and patientcode='$patientcode'  ";
				}
				else
				{
					$status='pending';
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				  <td class="bodytext31" valign="center"  align="left"><div align="center"><input type = "text" name ="remarks-<?php echo $radanum; ?>" id ="remarks-<?php echo $radanum; ?>"></div></td>
				  <td class="bodytext31" valign="center"  align="left"><div align="center"><a  onClick="return deletevalid('<?php echo $radanum; ?>','<?php echo $patientcode; ?>','<?php echo $visitcode; ?>')" href='javascript:return false;'>Delete</a></div></td>

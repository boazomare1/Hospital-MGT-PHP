...
<table width="1901" border="0" cellspacing="0" cellpadding="2">
  ...
  <td width="1%">&nbsp;</td>
    <td colspan="8">
    <form name="cbform1" method="post" id="form1" action="morbidity-op.php">
    <table width="604" border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>MORBIDITY -OP </strong></td>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>		 
                ...
                <td colspan="4" valign="center"  align="center" bgcolor="#ffffff"><strong><?= strtoupper($res1location); ?></strong></td>
                 ...
                 <tr>
                <td colspan="2" valign="center"  align="left" bgcolor="#ecf0f5" class="bodytext31">Diagnosis [Morbidity]:OP</td>
...
//				}
         ...
         <td align="left" valign="top"><a target="_blank" href="print_morbidity-op.php?cbfrmflag1=cbfrmflag1&&locationcode=<?php echo $location; ?>&&ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>"><img src="images/pdfdownload.jpg" width="30" height="30"></a>
            <a href="morbidity-op_xl.php?cbfrmflag1=cbfrmflag1&&locationcode=<?php echo $location; ?>&&ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>
      </tr>
       <?php 
				}
		?>

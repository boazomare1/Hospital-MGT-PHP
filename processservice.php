...
$Querylab=mysqli_query($GLOBALS["___mysqli_ston"], "select subtype from master_visitentry where patientcode='$patientcode' and visitcode='$visitcode'");
...
$query01="";
...

				{
  					 ...
  					 $query29=mysqli_query($GLOBALS["___mysqli_ston"], "update consultation_services set servicerefund='$refund',refundquantity='$newretqty',remarks='$remarks',process='$process',processedby = '$username' where patientvisitcode='$visitcode' and patientcode='$patientcode' and servicesitemcode = '$servicesitemcode' and auto_number='$autonumber'")or die("Error in Query29".mysqli_error($GLOBALS["___mysqli_ston"]));
			 ...
			 $querycumstock2 = "select cum_quantity from transaction_stock where cum_stockstatus='1' and itemcode='$itemcode' and locationcode='$locationcodeget'";
...

				{
...

					{
					 ...
					 $queryupdate=mysql_query("update consultation_services set process='completed',remarks='$remarks',processedby = '$username' where patientvisitcode='$visitcode' and patientcode='$patientcode' and servicesitemcode = '$servicesitemcode' and auto_number='$refno'")or die("Error in queryupdate".mysql_error());
...
<form name="frmsales" id="frmsales" method="post" action="processservice.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">

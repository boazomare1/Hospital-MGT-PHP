...
/*$query2 = "select * from master_icd where (disease like '%$searchdisease1' OR description like '%$searchdisease1' OR icdcode like '%$searchdisease1')OR(disease like '%$searchdisease1%' OR description like '%$searchdisease1%' OR icdcode like '%$searchdisease1%') and recordstatus = 'active' order by description LIMIT 10";*/// order by subtype limit 0, 15";

...
//alert('h');
	...
	var varr2=varpharmRate.replace(",","");
	var varr3=varr2.replace(",","");
	var varr4=varr3.replace(",","");
	var varp2=parseInt(varr4);
	//alert(var2);
	var varpharmAmount = document.getElementById("amount").value;
	var varexclude = document.getElementById("exclude").value;
var var2=varpharmAmount.replace(",","");
var var3=var2.replace(",","");
//var var4=var3.replace(",","");
var varam2=parseInt(var3);
//alert(varpharmAmount);
...
/*
	...
	*/
	...
	text81.type = "text";
	text81.size = "8";
	text81.value = formatMoney(varam2);
	...
	text11.onclick = function() { return btnDeleteClick(i,varam2); }
	...
	totalamount=parseFloat(totalamount) + parseFloat(varam2);
	
	document.getElementById("total").value=formatMoney(totalamount);
	document.getElementById("t1").value=totalamount;
	...
	{
	totalamount4=document.getElementById('t6').value;
	}
	...
	{
	totalamountr=document.getElementById('tr').value;
	}

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="658" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Lab Result Entry By User</strong></td>
              </tr>
      ...
      <tr>
	   ...
	   <?php if($cbfrmflag2 == 'cbfrmflag1'){?>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  ?>
            <tr>
              <td colspan='12' bgcolor="#ecf0f5" class="bodytext31"><?php echo 'Total Result Entry by  '.$cbcustomername?>(<?php echo $numcount;?>)</td>
            </tr>
            <tr>
...
*/			
		  ...
		  $numcount1=mysqli_num_rows($exec41);

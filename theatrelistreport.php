...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
 ...
 <form name="cbform1" method="post">
          ...
          <td width="131" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><input name="ADate1" id="ADate1" value="<?php echo $fromdate; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
...
<table width="116%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td><a href="theatrelistexcel.php?ADate1=<?php echo $fromdate; ?>&&ADate2=<?php echo $todate; ?>" target="_blank" style="background-color: green;border: none;color: white;padding: 5px 8px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;">EXPORT EXCEL</a></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
	    ...
	    ?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="80%" 
            align="left" border="0">
          <tbody>
          	<tr>
...
//and  approvalstatus = 'Pending'
			$query2 = "select a.* from master_theatre_booking as a left join ip_discharge as b on a.patientvisitcode=b.visitcode  where a.theatrecode = '$theatre_anum' and a.locationcode='$patientlocationcode' and a.date between '$from_date_new' and '$to_date_new' and a.theater_approvalstatus='Approve' and (b.req_status is null or b.req_status='request') order by a.auto_number desc";
			...
			$ward ='';
			$bed='';
			$query592 = "select ward,bed from ip_bedtransfer where patientcode = '$patientcode' and visitcode = '$visitcode' and recordstatus NOT IN ('discharged','transfered') order by auto_number desc limit 0, 1";
			...
			if($num592 > 0)
			{
                ...
                $query592 = "select ward,bed from ip_bedallocation where patientcode = '$patientcode' and visitcode = '$visitcode' and recordstatus NOT IN ('discharged','transfered') order by auto_number desc limit 0, 1";
				$exec592 = mysqli_query($GLOBALS["___mysqli_ston"], $query592) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
				$res592 = mysqli_fetch_array($exec592);
				$ward = $res592['ward'];
				$bed = $res592['bed'];
          ...
          <tr <?php echo $colorcode; ?>>
				...
				<td  align="center" valign="center" class="bodytext31">
					...
					$query3_01221 = "select * from master_bed where auto_number = '$bed'";
						    $exec3_01221 = mysqli_query($GLOBALS["___mysqli_ston"], $query3_01221) or die ("Error in Query3_01221".mysqli_error($GLOBALS["___mysqli_ston"]));
							$res3_01221 = mysqli_fetch_array($exec3_01221);

					echo $ward_name."(".$res3_01221['bed'].")";
					}
					?>
				</td>
				<td  align="center" valign="center" class="bodytext31">
				...
				<td  align="center" valign="center" class="bodytext31"><a  target="_blank" href="theaterbillingmodule.php?id=<?php echo $bookingid;?>&&cbfrmflag1=<?php echo 'cbfrmflag1';?>">Theater Billing</a></td>
			   </tr>
		   <?php 
		   } 
		   ?>
...
<tr>
<td colspan="11" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ecf0f5" class="bodytext311">&nbsp;</td>
</tr>
             	<tr>
             		<td>&nbsp;</td>
             	</tr>

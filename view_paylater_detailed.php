...
$querycopay = "select cash_copay from consultation_lab where patientvisitcode = '$res2visitcode' and labitemcode = '$res8labitemcode' and `op_package_id` IS NULL";
...
<table width="1901" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td  class="bodytext33" bgcolor="#FFFFFF" ><?php echo $res44customerfullname; ?></td>
	
	<td  class="bodytext33"  bgcolor="#FFFFFF">Invoice No: </td>

        <td valign="top"  colspan="2" class="bodytext33"  bgcolor="#FFFFFF"><?php echo $billautonumber; ?></td>
	...
	<tr>
        ...
        <td  align="left" class="bodytext33" bgcolor="#FFFFFF" ><?php echo $res2patientcode; ?></td>
		
		 <td class="bodytext33" bgcolor="#FFFFFF">Invoice Date: </td>

		<td class="bodytext33" colspan="2" bgcolor="#FFFFFF"><?php echo date("d/m/Y", strtotime($res2transactiondate)); ?></td>
		<td  align="left" bgcolor="#FFFFFF"></td>
	...
	<tr>
		<td align="left" class="bodytext33" bgcolor="#FFFFFF">OP Visit Date. </td>
		
        <td  align="left" class="bodytext33" bgcolor="#FFFFFF"><?php echo $visitentrydate.' '.$visitentrytime;  ?></td>

	     <td class="bodytext33" bgcolor="#FFFFFF">Consultation Amount:</td>

		<td class="bodytext33" colspan="2" bgcolor="#FFFFFF"><?php echo number_format($res4totalamount,2,'.',',');  ?></td>
		<td  align="left" bgcolor="#FFFFFF"></td>
		...
		<tr>
		<td align="left" class="bodytext33" bgcolor="#FFFFFF">OP Visit No. </td>
		
        <td  align="left" class="bodytext33" bgcolor="#FFFFFF"><?php echo $res2visitcode;  ?></td>

	     <td class="bodytext33" bgcolor="#FFFFFF">Pharmacy Amount:</td>

		<td class="bodytext33" colspan="2" bgcolor="#FFFFFF"><?php echo number_format($res5amount,2,'.',','); ?></td>
		<td  align="left" bgcolor="#FFFFFF"></td>
		 
		</tr>
		
		<tr>
		<td align="left" class="bodytext33" bgcolor="#FFFFFF">Account: </td>
		
        <td  align="left" class="bodytext33" bgcolor="#FFFFFF"><?php echo nl2br($res15accountname);   ?></td>

	     <td class="bodytext33" bgcolor="#FFFFFF">Lab Amount:</td>

		<td class="bodytext33" colspan="2" bgcolor="#FFFFFF"><?php echo number_format($res8labitemrate,2,'.',','); ?></td>
		<td  align="left" bgcolor="#FFFFFF"></td>
		...
		<tr>
		<td align="left" class="bodytext33" bgcolor="#FFFFFF">A/c No: </td>
		
        <td  align="left" class="bodytext33" bgcolor="#FFFFFF"><?php  echo "$res15accountno";?>  </td>

	     <td class="bodytext33" bgcolor="#FFFFFF">Radiology Amount:</td>

		<td class="bodytext33" colspan="2" bgcolor="#FFFFFF"><?php echo number_format($res9radiologyitemrate,2,'.',','); ?></td>
		<td  align="left" bgcolor="#FFFFFF"></td>
	...
	<tr>
		<td align="left" class="bodytext33" bgcolor="#FFFFFF">Insurance Co: </td>
		
        <td  align="left" class="bodytext33" bgcolor="#FFFFFF"><?php  echo nl2br($res2subtype); ?>  </td>

	     <td class="bodytext33" bgcolor="#FFFFFF">Referral Amount:</td>

		<td class="bodytext33" colspan="2" bgcolor="#FFFFFF"><?php echo number_format($res10referalrate,2,'.',','); ?></td>
		<td  align="left" bgcolor="#FFFFFF"></td>
...
<tr>
		<td align="left" class="bodytext33" bgcolor="#FFFFFF">Membership No: </td>
		
        <td  align="left" class="bodytext33" bgcolor="#FFFFFF"><?php  echo $resmemberno; ?>  </td>

	     <td class="bodytext33" bgcolor="#FFFFFF">Service Amount:</td>

		<td class="bodytext33" colspan="3" bgcolor="#FFFFFF"><?php echo number_format($res11servicesitemrate,2,'.',','); ?></td>
		
		 
		</tr>

<tr>
		<td align="left" class="bodytext33" bgcolor="#FFFFFF">Doctor : </td>
		
        <td  align="left" class="bodytext33" bgcolor="#FFFFFF"><?php  echo $res_doctor_fullname; ?>  </td>

	     <td class="bodytext33" bgcolor="#FFFFFF"></td>

		<td class="bodytext33" colspan="3" bgcolor="#FFFFFF"></td>
...
<tr>
    ...
    <td colspan="6" align="center" bgcolor="#FFFFFF"><strong><?php echo 'Diagnosis'; ?></strong></td>

  </tr>

<tr>
		<td align="left" class="bodytext33" bgcolor="#FFFFFF">ICD Code </td>
		
        <td  align="left" class="bodytext33" bgcolor="#FFFFFF">ICD Name  </td>
...
<tr>
    ...
    <td colspan="6" align="left" bgcolor="#FFFFFF"><strong><?php echo 'Impression'; ?></strong></td>
...
?>
 ...
 <tr>
   ...
   <td align="left" bgcolor="#FFFFFF"><?= $primarycode; ?></td>

   <td  align="left" bgcolor="#FFFFFF"><?= $primary; ?></td>
...
<tr>
    ...
    <td colspan="6" align="left" bgcolor="#FFFFFF"><strong><?php echo 'Final Diagnosis'; ?></strong></td>
...
<tr>
    ...
    <td   colspan="6" align="center" bgcolor="#FFFFFF"><strong><?php echo 'DETAILED INVOICE'; ?></strong></td>
...
<tbody>
 ...
 <tr>
	...
	bgcolor="#ffffff" class="bodytext32 " width="25%" ><strong>REF No.</strong></td>
...
?>
	...
	<tr>
		...
		<td colspan="6" class="bodytext32" valign="center" bgcolor="#ffffff" align="left">
...
<tr>
	...
	<td align="left" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" ><?php echo $res17viscode; ?></td>

	<td align="left" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" ><?php echo $consultingdoctor; ?></td>

	<td align="center" valign="center" 

	 bgcolor="#ffffff" class="bodytext32"><?php echo $res17quantity; ?></td>

    <td align="right" valign="right" 

	 bgcolor="#ffffff" class="bodytext32"><?php echo number_format($res17consultationfee,2,'.',','); ?></td>

	<td align="right" valign="right" 

	 bgcolor="#ffffff" class="bodytext32"><?php echo number_format($res17total,2,'.',','); ?></td>
...
<tr>
	...
	<td colspan="6" bgcolor="#ffffff" class="bodytext32 ">
...
<tr>
	...
	<td align="left" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="90">

	  <?php echo $visitentrydate; ?></td>

	<td align="left" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="50">

	 <?php echo $res19medicinecode; ?></td>

	<td align="left" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="280" id="test">

	<?php echo $res19medicinename; ?></td>

	<td align="center" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="30">
	...
	<td align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="120">
...
<tr>
	...
	<td bgcolor="#ffffff" class="bodytext32" colspan="6">
...
<tr>
	...
	<td align="left" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="55">

	<?php echo $visitentrydate; ?></td>

	<td align="left" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="80">
...
<?php echo $res20labitemname; ?></td>
	...
	<td align="center" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="30"><?php echo $res20quantity; ?></td>
...
<td align="left" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="90"><?php echo $visitentrydate; ?></td>

<td align="left" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="50"><?php echo $res21radiologyitemcode; ?></td>

<td align="left" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="280" id="test"><?php echo $res21radiologyitemname; ?></td>

<td align="center" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="30"><?php echo $res21quantity; ?></td>

<td align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="90"><?php echo number_format($res21amount,2,'.',','); ?></td>

<td align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="120"><?php echo number_format($res211referalrate,2,'.',','); ?></td>
...
<td align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32"><strong><?php echo 'Sub Total:'; ?></strong></td>

<td align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32"><?php echo number_format($res21amount1-$pw_radiology-$totalradcash_copay-$totalraddisc_amount,2,'.',','); ?></td>
...
<td  align="left" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="50">	<?php echo $res2visitcode; ?></td>

<td  align="left" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="280" id="test">	<?php echo $res22referalname; ?></td>

<td  align="center" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="30">	<?php echo $res22quantity; ?></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="90">	<?php echo number_format($res22referalrateamt,2,'.',','); ?></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="120">	<?php echo number_format($res22amount,2,'.',','); ?></td>
...
<td  align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32"><?php echo number_format($res22amount1=$res22amount1-$copayreftotal,2,'.',','); ?></td>
...
<td  align="left" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="280" id="test">	<?php echo $res2227referalname; ?></td>

<td  align="center" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="30">	<?php echo $res2227quantity; ?></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="90">	<?php echo number_format($res2227referalrate,2,'.',','); ?></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="120">	<?php echo number_format($res2227amount,2,'.',','); ?></td>
...
<td  align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32"><?php echo number_format($res222amount1=$res222amount1-$copayambtotal,2,'.',','); ?></td>
...
<td  align="left" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="280" id="test"><?php echo $res2222referalname; ?></td>

<td  align="center" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="30">	<?php echo $res2222quantity; ?></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="90">	<?php echo number_format($res2222referalrate,2,'.',','); ?></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="120">	<?php echo number_format($res2222amount,2,'.',','); ?></td>
...
<td  align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32"><?php echo number_format($res2222amount1=$res2222amount1-$copayhomtotal,2,'.',','); ?></td>
...
<td  align="left" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="50">	<?php echo $res23servicesitemcode; ?></td>

<td  align="left" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="280" id="test">	<?php echo $res23servicesitemname; ?></td>

<td  align="center" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="30">	<?php echo $serqty; ?></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="90">	<?php echo number_format($res23servicesitemrate,2,'.',','); ?></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32" width="120">	<?php echo number_format($res23amount,2,'.',','); ?></td>
...
<td  align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32">	<?php echo number_format($res23amount1-$pw_services-$totalsercash_copay,2,'.',','); ?></td>
...
<td  colspan="6" align="left"  valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32"><span style="font-weight: bold"><?php echo strtoupper($res2currency); ?> </span> </td>
...
<td  align="left" colspan="6" valign="left" 
	 ...
	 bgcolor="#ffffff" class="bodytext32" width="100%" id="test">
...
<td  align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" colspan="5" class="bodytext32"><strong>Total Amount:</strong></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32"><?php echo $grandtotal; ?></td>
...
<td  align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" colspan="5" class="bodytext32"><strong>Total Copay:</strong></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32"><?php echo number_format($totalcopaytot,2,'.',','); ?></td>
...
<td  align="right" valign="left" 
	 ...
	 bgcolor="#ffffff" colspan="5" class="bodytext32"><strong>Amount Payable:</strong></td>

<td  align="right" valign="left" 

	 bgcolor="#ffffff" class="bodytext32"><?php echo $totalpayable; ?></td>
...
?>
<tr>
	<td colspan="6" bgcolor="#ffffff" class="bodytext32"><strong>Receivable Accounts : </strong></td>
</tr>
<?php
while($resa = mysqli_fetch_array($execa)){
?>
<tr>
<td colspan="3" bgcolor="#ffffff" class="bodytext32"><?= $resa['accountname'] ?></td>
<td align="right" bgcolor="#ffffff" class="bodytext32"><?= number_format($resa['transactionamount'],2) ?></td>
<td colspan="2" bgcolor="#ffffff" class="bodytext32"></td>
</tr>
<?php
}
}
...
<td  align="left" valign="middle" 
	 ...
	 bgcolor="#ffffff" class="bodytext32"><strong>Served By: </strong></td>

<td  align="left" valign="middle"  colspan='5'

	 bgcolor="#ffffff" class="bodytext32"><?php echo strtoupper($res2username); ?> &nbsp; &nbsp; &nbsp; &nbsp;<strong>Patient's Signature: </strong>...................</td>

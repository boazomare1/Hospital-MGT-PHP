...
/*	$query29=mysql_query("update ipconsultation_services set servicerefund='refund',refundquantity='$refundquantity',process='$process' where patientcode='$patientcode' and patientvisitcode='$visitcode' and servicesitemcode = '$servicesitemcode' and auto_number='$autonumber'")or die("Error in Query29".mysql_error());
 */
			...
			$querycumstock2 = "select cum_quantity from transaction_stock where cum_stockstatus='1' and itemcode='$itemcode' and locationcode='$locationcodeget'";
				...
				if($pharmacyquantityenter>0)
				{
					...
					if($bat_quantity>='0')
					{
						...
						echo "<br>".$stockquery2="insert into transaction_stock (fifo_code,tablename,itemcode, itemname, transaction_date,transactionfunction,description,
				   ...
				   $exec86 = mysql_query($query86) or die(mysql_error());
					...
					$queryupdate=mysql_query("update ipconsultation_services set process='completed' where servicesitemname='$servicename' and patientvisitcode='$visitcode' and patientcode='$patientcode' and servicesitemcode = '$servicesitemcode' and auto_number='$autonumber'")or die("Error in queryupdate".mysql_error());
					*/
					}
					else
					{
...
<form name="frmsales" id="frmsales" method="post" action="processserviceip_test1.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">

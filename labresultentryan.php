...
$query7 = "select * from samplecollection_lab where sampleid = '$sampleid'";
...
$query31="INSERT INTO `samplecollection_laban`(`patientname`, `patientcode`, `patientvisitcode`, `recorddate`, `recordtime`, `itemcode`, `itemname`, `sampleid`, `sample`, `acknowledge`, `refund`, `status`, `remarks`, `resultentry`, `billnumber`, `docnumber`, `externallab`, `transferlabcode`, `transferlabname`, `username`, `entrywork`, `entryworkby`, `locationcode`, `locationname`) 
SELECT `patientname`, `patientcode`, `patientvisitcode`, `recorddate`, `recordtime`, `itemcode`, `itemname`, `sampleid`, `sample`, `acknowledge`, `refund`, `status`, `remarks`, `resultentry`, `billnumber`, `docnumber`, `externallab`, `transferlabcode`, `transferlabname`, `username`, `entrywork`, `entryworkby`, `locationcode`, `locationname` FROM `samplecollection_lab` WHERE patientcode = '$patientcode' and patientvisitcode = '$visitcode' and sampleid = '$sampleid' and acknowledge = 'completed' and docnumber='$docnumber'";
...
$query76 = "update samplecollection_lab set resultentry='completed' where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and sampleid = '$sampleid' and acknowledge = 'completed' and docnumber='$docnumber'";
 $exec76 = mysqli_query($GLOBALS["___mysqli_ston"], $query76) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
 
 $query29="update consultation_lab set resultentry='completed',resultdoc='$docnumber', publishdatetime='$updatedatetime',publishstatus = 'completed' where labitemcode='$itemcode' and patientvisitcode='$visitcode' and docnumber='$docnumber'";

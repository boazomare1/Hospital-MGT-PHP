  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		$query66 = "select * from billing_ipservices where billdate between '$ADate1' and '$ADate2' and patientvisitcode in(select visitcode from master_ipvisitentry where accountname ='$acc_id') and wellnessitem <> '1'";

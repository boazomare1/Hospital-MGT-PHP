...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
        <td width="860">
              <form name="cbform1" method="post" action="leavehodapprovallist.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                   <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>HOD Leave Approval</strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tr>
			...
			$colorloopcount = '';
			$sno = '';
			$query1 = "select * from leave_request where approvalstatus=''  and entrydate between '$fromdate' and '$todate' and docno like '%$docno%' order by entrydate";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    ...
			    <div align="center"><?php echo $total_days; ?></div></td>
                 <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="leavehodapproval.php?docno=<?php echo $docno1; ?>"><strong> <?php if($approvalstatus=='')
				{
                 echo 'VIEW';
				}
				else
            ...
            $colorloopcount = '';
			$sno = '';
			$query1 = "select * from leave_request where approvalstatus='rejected'  and entrydate between '$fromdate' and '$todate' and docno like '%$docno%' order by entrydate";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res1 = mysqli_fetch_array($exec1))
			{
			$date = $res1['entrydate'];

...
<body>
<?php
if(isset($_REQUEST['searchstatus'])){$searchstatus = $_REQUEST['searchstatus'];}else{$searchstatus='Leave Request';}
...
if(isset($_POST['docno'])){$docno = $_POST['docno'];}else{$docno='';}
	...
	$query1 = "select * from leave_request where approvalstatus='' and entrydate between '$fromdate' and '$todate' and docno like '%$docno%' group by docno";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
	$resnw3 = mysqli_num_rows($exec1);
	
	$query1 = "select * from leave_request where approvalstatus='rejected' and entrydate between '$fromdate' and '$todate' and docno like '%$docno%' group by docno";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
        <td width="860">
              <form name="cbform1" method="post" action="leavehrapprovallist.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                   <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>HR Leave Approval</strong></td>
              ...
              <td colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
                <input name="docno" type="text" id="docno" value="<?php echo $docno; ?>" autocomplete="off">
              </span></td>
              </tr>
			  <tr>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tr>
              ...
              <?php
			   if($searchstatus=='Leave Request'||$searchstatus=='All'){?>
            <tr>
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext31">
                <!--<input onClick="javascript:printbillreport1()" name="resetbutton2" type="submit" id="resetbutton2"  style="border: 1px solid #001E6A" value="Print Report" />-->
                <div align="left" style="width:70%; float:left"><strong>Leave Approval</strong></div><div align="right" style="width:20%; float:left;"><strong><<<?php echo $resnw3;?>>></strong>
                </div></td>
              </tr>
			...
			$colorloopcount = '';
			$sno = '';
			$query1 = "select * from leave_request where approvalstatus <> '' and hodusername <> '' and hrusername = '' and entrydate between '$fromdate' and '$todate' and docno like '%$docno%' order by entrydate";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $from_date; ?></div></td>
                <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $to_date; ?></div></td>
                <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $total_days; ?></div></td>
                 <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="leavehrapproval.php?docno=<?php echo $docno1; ?>"><strong> <?php if($approvalstatus<>'')
				{
                 echo 'VIEW';
				}
				else
			...
			if($searchstatus=='Rejected' || $searchstatus=='All'){?>
            ...
            <tr>
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext31">
                <!--<input onClick="javascript:printbillreport1()" name="resetbutton2" type="submit" id="resetbutton2"  style="border: 1px solid #001E6A" value="Print Report" />-->
                <div align="left" style="width:70%; float:left"><strong>Rejected Requests</strong></div><div align="right" style="width:20%; float:left;"><strong><<<?php echo $resnw2;?>>></strong>
                </div></td>
              </tr>
              <tr>
              <td width="4%" align="left" valign="center" 
            ...
            $colorloopcount = '';
			$sno = '';
			$query1 = "select * from leave_request where approvalstatus='rejected' and hodusername <> '' and entrydate between '$fromdate' and '$todate' and docno like '%$docno%' order by entrydate";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res1 = mysqli_fetch_array($exec1))
			{
			$date = $res1['entrydate'];
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    ...
			    <div align="center"><?php echo $total_days; ?></div></td>
                 <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="leavehrapproval.php?docno=<?php echo $docno1; ?>"><strong> <?php echo 'VIEW Rejected';?></strong></a></div></td>
              </tr>
			<?php
			}
	}

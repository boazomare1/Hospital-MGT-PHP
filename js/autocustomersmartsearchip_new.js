...
function funcCustomerSmartSearch_new()
{
	...
	if(document.getElementById("patientcode").value!="")
	{
		...
		if (varCustomerSearchLen > 1)
		{
			...
			var url="autocustomersmartsearch_admitip.php?InOut_Type=2&&RandomKey="+Math.random()+"&&customersearch="+customersearch+"&&registrationdate="+registrationdate+"&visitcode="+visitcode;
		   //alert(url);
...
function ajaxprocessACCS20()
{
	...
	var url="autocustomersmartsearch.php?InOut_Type=2&&RandomKey="+Math.random()+"&&customersearch="+customersearch+"&&registrationdate="+registrationdate;
   //alert(url);

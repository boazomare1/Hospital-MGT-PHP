    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Published Lab Results </strong></td>
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="12" bgcolor="#ecf0f5" class="bodytext31" nowrap="nowrap"><div align="left"><strong>Published Lab Results </strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
			 </tr>
            <tr>
           ...
           <?php
		 $query1 = "select * from resultentry_lab where locationcode='".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and patientcode <> 'walkin' and recorddate between '$fromdate' and '$todate' and docnumber like '%$searchdocnumber%' and resultstatus='completed' and publishstatus = 'completed' group by docnumber order by auto_number desc";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
	   ...
	   $query11="select * from resultentry_lab where locationcode='".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and recorddate between '$fromdate' and '$todate' and docnumber like '%$docnumber%' and resultstatus='completed' and publishstatus = 'completed' group by itemcode ";
	    ...
	    while($res11=mysqli_fetch_array($exec11))
          ...
          <tr <?php echo $colorcode; ?>>
              <td height="45"  align="left" valign="center" class="bodytext31"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="center"><a target="_blank" href="print_master.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&billnumber=<?php echo $docnumber; ?>&&fromdate=<?php echo $fromdate; ?>&&todate=<?php echo $todate; ?>&&docnumber=<?= $docnumber?>"><strong>Print</strong></a></td>
             ...
             <td class="bodytext31" valign="center"  align="left">
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="print_master.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $docnumber; ?>&&fromdate=<?php echo $fromdate; ?>&&todate=<?php echo $todate; ?>"><strong>View</strong></a></td>
		...
		$query1 = "select * from ipresultentry_lab where locationcode='".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and patientcode <> 'walkin' and recorddate between '$fromdate' and '$todate' and docnumber like '%$searchdocnumber%' and resultstatus='completed' group by docnumber order by auto_number desc";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1-580".mysqli_error($GLOBALS["___mysqli_ston"]));
		echo $num1=mysqli_num_rows($exec1);
	   ...
	   $query11="select * from ipresultentry_lab where locationcode='".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and recorddate between '$fromdate' and '$todate' and docnumber like '%$docnumber%' and resultstatus='completed' group by itemcode ";
		$exec11=mysqli_query($GLOBALS["___mysqli_ston"], $query11) or die("error in query11-593".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num11=mysqli_num_rows($exec11);
	    ...
	    while($res11=mysqli_fetch_array($exec11))
				...
				$exec23 = mysqli_query($GLOBALS["___mysqli_ston"], $query23) or die("error in query23-610".mysqli_error($GLOBALS["___mysqli_ston"]));
				$res23 = mysqli_fetch_array($exec23);
				$requestedby = $res23['username'];
				$docno2 = $res23['docnumber'];
				$query27 = "select auto_number from opipsampleid_lab where docnumber = '$docno2' order by auto_number ASC limit 1";
				$exec27 = mysqli_query($GLOBALS["___mysqli_ston"], $query27) or die("error in query27-610".mysqli_error($GLOBALS["___mysqli_ston"]));
				$res27 = mysqli_fetch_array($exec27);
				$docanum = $res27['auto_number'];
				$query26 = "select sampledate,publishdatetime from pending_test_orders where sample_id in($docanum)";
				$exec26 = mysqli_query($GLOBALS["___mysqli_ston"], $query26) or die("error in query26-610".mysqli_error($GLOBALS["___mysqli_ston"]));
				$res26 = mysqli_fetch_array($exec26);
				$sampledatetime = $res26['sampledate'];
				$publishdatetime = $res26['publishdatetime'];
				
				$query24 = "select * from master_employee where username = '$requestedby'";
				$exec24 = mysqli_query($GLOBALS["___mysqli_ston"], $query24) or die("error in query24-617".mysqli_error($GLOBALS["___mysqli_ston"]));
				$res24 = mysqli_fetch_array($exec24);
				$requestedbyname = $res24['employeename'];
          ...
          <tr <?php echo $colorcode; ?>>
		   ...
		   <?php
		$query21 = "select * from resultentry_lab where locationcode='".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and  patientname like '%$searchpatient%' and patientcode = 'walkin' and patientvisitcode = 'walkinvis' and recorddate between '$fromdate' and '$todate' and resultstatus='completed' and publishstatus = '' group by docnumber order by auto_number desc";
	   ...
	   $query22="select * from resultentry_lab where locationcode='".$locationcode."' and patientcode like '%walkin%' and patientvisitcode like '%walkinvis%' and  patientname like '%$searchpatient%' and recorddate between '$fromdate' and '$todate' and docnumber = '$res21docnumber' and resultstatus='completed' and publishstatus = '' group by itemcode ";
           ...
           <tr <?php echo $colorcode; ?>>
              <td height="45"  align="left" valign="center" class="bodytext31"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="center"><a target="_blank" href="print_master.php?patientcode=walkin&&visitcode=walkinvis&&docnumber=<?php echo $res21docnumber; ?>&&fromdate=<?php echo $fromdate; ?>&&todate=<?php echo $todate; ?>"><strong>Print</strong></a></td>

	...
	<div class="row">
		...
		<div class="col-6">
			...
			<?php
				...
				$query = "select auto_number as uid,id as code,accountsmain as name,section from master_accountsmain where tb_group = 'B'   order by section";
						...
						$section = $res['section'];
							...
							$endyear =  date('Y',strtotime($to_date));
								...
								if($section == 'L'){
									 ...
									 $opening_dr_cr = $opening_dr_cr + $GLOBALS['eal'] ;
								}
				...
				//	echo "<tr style='font-weight:bold;'> <td colspan='4' align='right'>Total : </td> <td  colspan='2' align='right'>".showAmount(net_profit1($from_date,$to_date),1)." </td> </tr>";
					echo "<tr style='font-weight:bold;'> <td colspan='5' align='right'>Total : </td> <td  colspan='2' align='right'>".showAmount($balance_sheet,1)." </td> </tr>";

...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext31"><strong>Surgeon List</strong> </td>
			...
			$query1 = "select * from master_visitentry where department='5' and doctorconsultation <> 'completed' and paymentstatus = 'completed' order by auto_number desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			...
			{
			$query12 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode1' and referalcode = '5'";

        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td width="12%" align="left" valign="center"  
                ...
                bgcolor="#ffffff" class="bodytext31"><strong>Sup Inv.</strong></td>

              <td width="11%" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><strong>GRN No.</strong></td>
              <td width="11%" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><strong>PO No.</strong></td>
              ...
              <td width="9%" align="left" valign="center"  
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Cur Bal</strong></div></td>
		  ...
		  ?>
			...
			<td class="bodytext31" valign="center"  align="left" 
              ...
              <td width="10%" colspan="2" align="left" valign="center"  
...
$res85supplierbillnumber='';
		 ...
		 $query45 = "SELECT transactiondate as groupdate,suppliername,suppliercode,sum(transactionamount) as totalfxamount,billnumber, auto_number from master_transactionpharmacy where suppliercode = '$arraysuppliercode' and transactiondate between '$ADate1' and '$ADate2' and transactiontype = 'PURCHASE' and billnumber NOT LIKE 'PV%' group by billnumber ";
...
$totalamount420 =$res451transactionamount-($totalpayment + $returnamount);
	...
	$totalat = $totalat + $res45transactionamount;
           ...
           <tr <?php  echo $colorcode; ?>>
              ...
              //echo $ponumbers_unique;  
              $ponum = explode(",", $ponumbers_unique); 
              // splitting the string by commas
				...
				foreach($ponum as $ponums) {
				 $ponums = trim($ponums);
					 ...
					 ?></td>
              <!-- ."  ".$mrnnumbers_unique; -->
              <!-- <td class="bodytext31" valign="center"  align="left"><?php echo json_encode($res85supplierponumber); unset($res85supplierponumber); ?></td> -->
...
$reswh_tax_value='0';
		  	$query3 = "select * from purchase_details WHERE billnumber = '$res5billnumber' "; 

			$exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
			
			$res3= mysqli_fetch_array($exec3);
			
			$reswh_tax_value = $res3['wh_tax_value'];
			if($reswh_tax_value>0){
			$res5transactionamount=$res5transactionamount+$reswh_tax_value;
			}
...
// 		  $res5transactiondate = $res45['groupdate'];
		  ...
		  $supplier_id_debitnotes = $res5['supplier_id'];
...

	{
	 ...
	 $totalat = $totalat - $total;
		...
		//echo $cashamount;
			...
			$query3 = "SELECT * from master_transactionpharmacy where  docno = '$res5docnumber' and recordstatus = 'allocated' order by auto_number desc";
				$exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
				$num_debit=mysqli_num_rows($exec3);
					

			?>

			<!-- <tr bgcolor="#ecf0f5"><td colspan="11"><b>Debit Note</b></td></tr> -->
           ...
           <tr <?php  echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
                ...
                <div class="bodytext31"><?php echo 'Towards Debit ' ?></div></td>

              <td class="bodytext31" valign="center"  align="left"><?php //; ?></td>

			  <td class="bodytext31" valign="center"  align="left">&nbsp;</td>

              <td class="bodytext31" valign="center"  align="left"><a style="color: blue; text-decoration: underline;cursor: pointer;" onclick="window.open('supplier_drlist_allocated.php?document=<?=$res5docnumber;?>&&suppliercode=<?=$supplier_id_debitnotes;?>', '_blank', 'location=yes,height=570,width=700,scrollbars=yes,status=yes');"><?php echo $res5docnumber;?></a> 
              	<!--  <?php //if($num_debit>0){ ?>
              		<a style="color: blue; text-decoration: underline;cursor: pointer;" onclick="window.open('supplier_drlist_allocated.php?document=<?=$res5docnumber;?>&&suppliercode=<?=$supplier_id_debitnotes;?>', '_blank', 'location=yes,height=570,width=700,scrollbars=yes,status=yes');">Invoices</a> 
              	<?php //} ?> -->
              </td>
              <td class="bodytext31" valign="center"  align="left">&nbsp;</td>
	...
	background:indigo;
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left"  bgcolor="#ecf0f5">&nbsp;</td>
				 ...
				 <td class="bodytext31" valign="center"  align="left"  bgcolor="#ecf0f5">&nbsp;</td>
				 <td class="bodytext31" valign="center"  align="left"  bgcolor="#ecf0f5">&nbsp;</td>
				 <td class="bodytext31" colspan="4" valign="center"  align="right"  bgcolor="#ecf0f5">&nbsp;

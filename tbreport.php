...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
 ...
 <form name="cbform1" method="post" action="tbreport.php">
          ...
          <tbody>
           ...
           <?php
                ...
                $credit_amt = 0;
				    ...
				    $query3 = "SELECT doc_number,transaction_type,sum(transaction_amount) as amount FROM `tb` WHERE doc_number= '$doc_number' group by transaction_type";

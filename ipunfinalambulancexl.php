        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="7" align="center" bgcolor="#FFFFFF" class="bodytext31"><strong>Ambulance Details</strong></td>
...

		{
           ...
           <tr <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><?php echo $customerfullname; ?></td>
               ...
               <td class="bodytext31" valign="center" align="right"><?php echo $ambulancerefno;?></td>
...
?>		
         	...
         	<tr>
              ...
              <td colspan="6"  class="bodytext31" valign="center"  align="right" bgcolor="#fff"><strong>Total Ambulance Amount</strong></td>

              <td align="right" valign="center" bgcolor="#fff" class="bodytext31"><strong><?php echo number_format($totalambulanceamount,2,'.',','); ?></strong></td>
			</tr>

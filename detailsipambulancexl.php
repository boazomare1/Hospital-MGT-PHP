...
header('Content-Disposition: attachment;filename="IPambulance.xls"');
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#FFFFFF" class="bodytext31"><strong>Ambulance Details</strong></td>
              <td width="10%" bgcolor="#FFFFFF" class="bodytext31">&nbsp;</td>
              </tr>            
...
?>		
         <tr>
              <td colspan="4"  class="bodytext31" valign="center"  align="right" 
                bgcolor="#FFFFFF"><strong>Total Ambulance Amount</strong></td>
              <td align="right" valign="center" 
                bgcolor="#FFFFFF" class="bodytext31"><strong><?php echo number_format($totalambulance,2,'.',','); ?></strong></td>

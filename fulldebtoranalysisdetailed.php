		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            ...
            <!--<tr>
			  ...
			  <?php
			  $query51 = "select auto_number, paymenttype from master_paymenttype where recordstatus <> 'deleted'";
            ...
            <tr>
			  ...
			  <input name="searchaccountnameanum1" id="searchaccountnameanum1" value="<?php echo $searchaccountnameanum1; ?>" type="hidden">
...
$numquery=mysqli_num_rows($exequery);
		...
		$totalamount301=$totalamount301 + $openingbalance;
            ...
            <tr>
                ...
                <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong><?php echo number_format($closetotalamount1,2,'.',','); ?></strong></td>
                <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong><?php echo number_format($closetotalamount301,2,'.',','); ?></strong></td>
                 <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong><?php echo number_format($closetotalamount601,2,'.',','); ?></strong></td>
                <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong><?php echo number_format($closetotalamount901,2,'.',','); ?></strong></td>
                <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong><?php echo number_format($closetotalamount1201,2,'.',','); ?></strong></td>
                <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong><?php echo number_format($closetotalamount1801,2,'.',','); ?></strong></td>
                <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong><?php echo number_format($closetotalamount2101,2,'.',','); ?></strong></td>
                <td class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong><?php echo number_format($closetotalamount2401,2,'.',','); ?></strong></td>        
            </tr>
            <?php
			$closetotalamount1 = '0';
			$closetotalamount301 = '0';
			...
			<tr>
			<?php			
				$urlpath = "cbfrmflag1=cbfrmflag1&&ADate1=$ADate1&&ADate2=$ADate2&&searchsuppliername=$searchsuppliername&&searchsuppliername1=$searchsuppliername1&&type=$type&&searchaccountnameanum1=$searchaccountnameanum1&&searchsuppliercode=$searchsuppliercode&&searchsubtypeanum1=$searchsubtypeanum1";			
			?>
			 <td colspan="12"></td>

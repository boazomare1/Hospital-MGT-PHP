...
function insertitem4()
{
	...
	var sera = varserviceamount;
	
	var seraa=sera.replace(",","");
	var sera2 =seraa.replace(",","");
	var sera3=parseInt(sera2);
	...
	text13.type = "text";
	text13.size = "8";
	text13.value = formatMoney(sera3);
	...
	text11.onclick = function() { return btnDeleteClick3(m,sera3); }
	...
	totalamount3=parseFloat(totalamount3) + parseFloat(sera3);
	//alert(totalamount3);
	document.getElementById("total3").value=formatMoney(totalamount3);
		document.getElementById("t4").value=totalamount3;

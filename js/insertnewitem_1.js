...
//alert('h');
	...
	var varr=Number(varpharmRate.replace(/[^0-9\.]+/g,""));
	
	var varpharmAmount = document.getElementById("amount").value;
	
	var varp=Number(varpharmAmount.replace(/[^0-9\.]+/g,""));
...
/*
	...
	*/
	...
	text11.onclick = function() { return btnDeleteClick(i,varp); }
	...
	totalamount=parseFloat(total) + parseFloat(varp);

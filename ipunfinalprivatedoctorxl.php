...
header('Content-Disposition: attachment;filename="IPUnfinal_Pvtdoctor.xls"');
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             ...
             <tr>
              ...
              <td colspan="8" bgcolor="#ecf0f5" align="center" class="bodytext31"><strong>Private Doctor Charge Details</strong></td>
              <!-- <td width="10%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td> -->
              </tr>           
...
?>		
         ...
         <tr>
              ...
              <td colspan="7"  class="bodytext31" valign="center"  align="right" bgcolor="#FFFFFF"><strong>Total Private Doctor Charges:</strong></td>

              <td align="right" valign="center" bgcolor="#FFFFFF" class="bodytext31"><strong><?php echo number_format($totalprivatedoctorcharges,2,'.',','); ?></strong></td>

...
<div style="margin: 0px 30px 0px 60px;"> 
  ...
  <td colspan="10">&nbsp;</td></tr>
		   ...
		   <tr>
             <td width="150" align="left" valign="center" class="bodytext31"><strong>Name Of Patient:</strong></td> 
	         ...
	         <td width="180" align="left" valign="center" class="bodytext31"><?php echo $patientcode; ?></td>
          </tr>
           <tr>
             <td width="150" align="left" valign="center" class="bodytext31"><strong>Ward Name:</strong></td> 
		     <td width="250" align="left" valign="center" class="bodytext31"><?php echo $wardname; ?></td>
		     <td width="110" align="left" valign="center" class="bodytext31"><strong>Admission. No.:</strong></td>
	         <td width="150" align="left" valign="center" class="bodytext31"><?php echo $visitcode; ?></td>
          </tr>
           <tr>
             <td width="150" align="left" valign="center" class="bodytext31"><strong>Payer:</strong></td> 
		     <td  align="left" colspan="1" valign="center" class="bodytext31"><?php echo $subtype; ?></td>
		      <td width="120" align="left" valign="center" class="bodytext31"><strong>BillNumber:</strong></td>
	         <td width="160" align="left" valign="center" class="bodytext31"><?php echo $billnumber;?></td>
          </tr>
          <tr>
             
		     <td width="150" align="left" valign="center" class="bodytext31"><strong>Scheme:</strong></td>
	         <td colspan="3" align="left" valign="center" class="bodytext31"><?php echo $accname ; ?></td>
   ...
   <h5 align="center">CLEARANCE FROM WARD</h5>
   <div style="margin: 0px 30px 80px 80px;"> 
		<p style="text-align: justify; width: 80%; line-height: 1.6;">The above named Patient has Completed the necessary formalities with the Ward Officer and thus can be
released.</p>
		 
	<P  class="p12 ft0">Name Of Nurse :________________&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   signature________________________</P>	 
</div>

	<br>
	<div style="margin: 5px 30px 80px 80px;"> 
		<p style="text-align: justify; width: 80%; line-height: 1.6;">The above named Patient has Completed the necessary formalities with the Finance Officer and thus can be
released.</p>
...
<div style=" margin: 10px 30px 10px 80px;  ">
	<P  class="p12 ft0">Printed By :<?=ucwords($username);?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  signature________________________</P>
	<br>
	
	<P  class="p12 ft0">Name Of Security :________________&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   signature________________________</P>	 
	<br>
	
	<P class="p12 ft0">Date: <?=$currentdate; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    Time : <?=$currtime; ?> </P>
</div>
...
//      $html2pdf->setModeDebug();
        ...
        $filename="Clearance-".$visitcode.".pdf";

  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
       ...
       <td width="860">
		...
		<form name="cbform1" method="post" action="opiprevenuereport-old.php">
...
*/
		  ...
		  //CASH
		  	...
		  	select sum(amount) as amount1 from billing_paylaterpharmacy where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto' and accountname = 'CASH - HOSPITAL'
...
$totrebate                = 0;
    ...
    //                $query112 = "select sum(amountuhx) as amountuhx from billing_ipbedcharges where locationcode='$locationcode1' and  description NOT IN  ('Bed Charges','Nursing Charges','Resident Doctor Charges') and  visitcode='$visitcode'  and recorddate between '$fromdate' and '$todate'
		...
		//TO GET TOTAL LAB AMOUNT
		  ...
		  $query3 = "select sum(rateuhx) from billing_iplab where pkg_status='No' and locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'  ";
		...
		//TO GET TOTAL RADIOLOGY CHARGES AMOUNT
		  ...
		  $query4 = "select sum(radiologyitemrateuhx) from billing_ipradiology where pkg_status='No' and locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'  ";
		...
		$radiologyamount=$res4['sum(radiologyitemrateuhx)'];
		 ...
		 $query5 = "select sum(amountuhx) from billing_ippharmacy where pkg_status='No' and locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'  ";
	    ...
	    $query6 = "select sum(servicesitemrateuhx),sum(sharingamount) from billing_ipservices where pkg_status='No' and locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'";
		...
		$query8              = "select (transactionamount) as transactionamount, (original_amt) as original_amt, visittype, coa from billing_ipprivatedoctor where pkg_status='No' and patientcode = '$patientcode' and visitcode='$visitcode' and billtype <>'' and recorddate between '$fromdate' and '$todate'  ";
                $exec8 = mysqli_query($GLOBALS["___mysqli_ston"], $query8) or die("Error in Query8" . mysqli_error($GLOBALS["___mysqli_ston"]));
                $num8                     = mysqli_num_rows($exec8);
                while($res8 = mysqli_fetch_array($exec8))
				{
...

		{
		   ...
		   <?php 
			...
			$rowtot1 = $totaladmissionamount+$totalpackagecharge+$totalipbedcharges+$totalipnursingcharges+$totaliprmocharges+ $totaliprmocharges1+$totallabamount+$totalradiologyamount+$totalpharmacyamount+$totalservicesamount+$totalambulanceamount+$totalhomecareamount+$totalprivatedoctoramount+$totalipmiscamount+$totalipdiscamount;
	 ...
	 UNION ALL SELECT auto_number,patientname,patientcode,visitcode,'creditapproved' as type from billing_ipcreditapproved where billdate between '$fromdate' and '$todate' and  locationcode='$locationcode1'  and accountnameano != '603'  group by visitcode  order by auto_number DESC ";
		...
		//TO GET TOTAL LAB AMOUNT
		 ...
		 // $query3 = "select sum(labitemrate) as labitemrate1 from billing_iplab where locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'";
		  ...
		  $query3 = "SELECT SUM(rateuhx) as amountuhx FROM `billing_iplab` WHERE pkg_status='No' and billdate BETWEEN '$fromdate' AND '$todate' and locationcode='$locationcode1' and  patientvisitcode ='$visitcode'
		...
		//TO GET TOTAL RADIOLOGY CHARGES AMOUNT
		 ...
		 /* $query4 = "select sum(radiologyitemrateuhx) from billing_ipradiology where locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'		 ";*/
		  ...
		  $query4 = "SELECT sum(radiologyitemrateuhx) as amountuhx FROM `billing_ipradiology` WHERE pkg_status='No' and billdate BETWEEN '$fromdate' AND '$todate' and patientvisitcode ='$visitcode'
	   ...
	   $totalradiologyamount=$totalradiologyamount + $radiologyamount;
		 ...
		 $query5 = "select sum(amount) from billing_ippharmacy where pkg_status='No' and locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'  ";
		...
		$query6 = "SELECT SUM(servicesitemrateuhx) as amountuhx,sum(sharingamount) as sharingamount  FROM `billing_ipservices` WHERE pkg_status='No' and locationcode='$locationcode1' AND billdate BETWEEN '$fromdate' AND '$todate' and patientvisitcode ='$visitcode'
		...
		$query8 = "select (transactionamount) as transactionamount, (original_amt) as original_amt, visittype, coa from billing_ipprivatedoctor where pkg_status='No' and locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and recorddate between '$fromdate' and '$todate'  ";

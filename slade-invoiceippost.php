<?php
include_once("slade-invoiceip.php");
...
/*	echo 'billno-->'.$billno;
	...
	exit; */
header("location:slade-invoicepostippdf.php?billautonumber=$billno&&visitcode=$visitcode&claim=$id&auth=$authorization&invoice_url=$invoice_attach_url&patientcode=$patientcode");
exit;

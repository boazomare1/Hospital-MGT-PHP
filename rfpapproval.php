  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td>&nbsp;
			...
			<tr>
              <td bgcolor="#ecf0f5" class="bodytext3" colspan="8"><strong>Review RFQ</strong></td>
  ...
  <tr>
		...
		?>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ecf0f5"><input type="text" name="totalamount" id="totalamount" value="<?php echo number_format($totalamount,'2','.',','); ?>" size="12" class="bal" readonly></td>
				 <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5">&nbsp;</td>
               </tr>
          </tbody>

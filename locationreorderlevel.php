    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
             <td colspan="11" bgcolor="#ecf0f5" class="bodytext31"><strong>Location Reorder Level</strong></td>
             </tr>
               
			  <form method="post" name="form2" id="form2" action="locationreorderlevel.php" onSubmit="return Valid1();">
			   <tr>
		  ...
		  <td colspan="2" align="left" bgcolor="#FFFFFF">&nbsp;</td>
		   ...
		   <input type="submit" value="Search" name="submit56">
			...
			{ 
				...
				?>
			<tr>
	   <td align="left" colspan="7"> <a target="_blank" href="print_locreorderlevelxl.php?location=<?= $location;?>&&statustype=<?=$statustype?>&categoryid=<?=$categoryid?>"> <img src="images/excel-xls-icon.png" width="30" height="30"></a> </td>
	  </tr>

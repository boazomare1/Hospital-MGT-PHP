		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Casuality List</strong></td>

            </tr>mysqli_error($GLOBALS["___mysqli_ston"])
      ...
      <tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$exec11 = mysqli_query($GLOBALS["___mysqli_ston"], $query11) or die(mysql_query());

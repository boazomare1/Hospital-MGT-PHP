    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="1134">
              ...
              <form name="cbform1" method="post" action="daybookreport-test.php">
		...
		<table width="791" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Day Book Report </strong></td>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
			 ...
			 $query31 = "select * from master_employee as me LEFT JOIN master_employeelocation as mel ON me.employeecode = mel.employeecode where mel.locationcode='$locationcode1' and me.shift = 'YES' and me.username like '%$cbcustomername%'  GROUP BY me.employeecode";
...
$totalcashamount41='0.00';
			...
			UNION
			SELECT billnumber AS billnumber,updatetime AS transactiondate,username AS username  FROM master_billing WHERE username = '$res21username' AND date(updatetime) between '$transactiondatefrom' AND '$transactiondateto' 
			UNION
			...
			$query2 = "select * from master_transactionpaynow where billnumber = '$unionbillnumber' AND  locationcode='$locationcode1' and username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
		   ...
		   $cardtxtno=$res3['creditcardnumber'];
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res2billnumber."master_transactionpaynow"; ?></div></td>
			...
			$query23 = "select * from master_billing where billnumber = '$unionbillnumber' AND locationcode='$locationcode1' and username = '$res21username' and date(updatetime) between '$transactiondatefrom' and '$transactiondateto' order by username desc";
			...
			$res23billingdatetime = $res23['updatetime'];
...

		{
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res23billnumber."master_billing"; ?></div></td>
			...
			$query24 = "select * from master_transactionexternal where  billnumber = '$unionbillnumber' AND locationcode='$locationcode1' and username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
...

		{
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res24billnumber."master_transactionexternal"; ?></div></td>
			...
			$query25 = "select * from refund_paynow where billnumber = '$unionbillnumber' AND  locationcode='$locationcode1' and username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
...

		{
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res25billnumber.'refund_paynow'; ?></div></td>
			...
			$query26 = "select * from master_transactionadvancedeposit where  docno = '$unionbillnumber' AND locationcode='$locationcode1' and username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
...

		{
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res26billnumber.'master_transactionadvancedeposit'; ?></div></td>
			...
			$query27 = "select * from master_transactionipdeposit where  docno = '$unionbillnumber' AND locationcode='$locationcode1' and username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
...

		{
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res27billnumber.'master_transactionipdeposit'; ?></div></td>
		...
		/*	//$dotarray = explode("-", $transactiondateto);
			...
			$query28 = "select * from master_transactionip where  billnumber = '$unionbillnumber' AND locationcode='$locationcode1' and username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
...

		{
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res28billnumber.'master_transactionip'; ?></div></td>
		...
		/*	//$dotarray = explode("-", $transactiondateto);
			...
			$query29 = "select * from master_transactionipcreditapproved where billnumber = '$unionbillnumber' AND locationcode='$locationcode1' and username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
		   ...
		   $txtno=$res39['mpesanumber'];
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res29billnumber.'master_transactionipcreditapproved'; ?></div></td>
			...
			$query40 = "select * from receiptsub_details where docnumber = '$unionbillnumber' AND locationcode='$locationcode1' and username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto'";
...

		{
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res40billnumber.'receiptsub_details'; ?></div></td>
			...
			$query40 = "select * from master_transactionpaylater where docno = '$unionbillnumber' AND locationcode='$locationcode1' and username = '$res21username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' and docno like 'AR-%' and transactionstatus='onaccount' ";
           ...
           $txtno=$res40['mpesanumber'];
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res40billnumber.'master_transactionpaylater'; ?></div></td>
...

		{
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right">
                ...
                <div class="bodytext31"><?php echo $res25billnumber1.'deposit_refund'; ?></div></td>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="right" 
				...
				<td  align="right" valign="center" bgcolor="#ecf0f5" class="bodytext31"><a target="_blank" href="daybookreport_total_print_pdf.php?cbfrmflag1=cbfrmflag1&&location=<?php echo $locationcode1; ?>&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&cbcustomername=<?php echo $cbcustomername; ?>"><img src="images/pdfdownload.jpg" width="30" height="30"></a></td>

		<td><a href="daybookreport_total_print.php?cbfrmflag1=cbfrmflag1&&location=<?php echo $locationcode1; ?>&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&cbcustomername=<?php echo $cbcustomername; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>

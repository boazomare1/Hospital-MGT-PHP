...
//alert('h');
	...
	if(availablelimit100!='external'){
			...
			if(document.getElementById("visitlimit").value>=0 && availablelimit100==0){
				...
				var varp = document.getElementById("amount").value;
				...
				var varMedicineCode = document.getElementById("searchmedicineanum1").value = "";
    ...
    */
	...
	var varMedicineName = document.getElementById("hiddenmedicinename").value;
...
//alert(varMedicineCode);
	...
	var varpr = document.getElementById("rates").value;

	var varpharmRate=Number(varpr.replace(/[^0-9\.]+/g,""));
...
/*
	...
	*/
	...
	for(i =1;i< varSerialNumber;i++){
	var initial=$("#medicinecode"+i).val();
	if(initial==varMedicineCode){
	...
	tda12.id = "dosemeasure"+i+"";

	tda12.align = "left";

	tda12.valign = "top";

	tda12.style.backgroundColor = "#FFFFFF";

	tda12.style.border = "0px solid #001E6A";

	//var text2 = document.createElement ('<input name="itemcode'+i+'" value="'+varItemCode+'" id="itemcode'+i+'" style="border: 0px solid #001E6A; text-align:left" size="10" readonly="readonly" />');

	var texta12 = document.createElement ('input');

	texta12.id = "dosemeasure"+i+"";

	texta12.name = "dosemeasure"+i+"";

	texta12.type = "text";

	texta12.size = "8";

	texta12.value = vardosemeasure;

	texta12.readOnly = "readonly";

	texta12.style.backgroundColor = "#FFFFFF";

	texta12.style.border = "0px solid #001E6A";

	texta12.style.textAlign = "left";

	tda12.appendChild (texta12);

	tr.appendChild (tda12);
	...
	text8.value = formatMoney(varpharmRate);
	...
	text81.value = formatMoney(varpharmAmount);
	...
	document.getElementById("total").value=formatMoney(totalamount);

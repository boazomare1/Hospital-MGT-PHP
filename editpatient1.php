...
if ($frmflag1 == 'frmflag1')
{
   $customercode = $_REQUEST['customercode'];
	...
	$customermiddlename = addslashes($customermiddlename);
	 ...
	 $inactivestatus = isset($_REQUEST['inactivestatus'])?$_REQUEST['inactivestatus']:''; 
	...
	if ($_FILES['uploadedfile']['name'] != '')
		{
			if(move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path)) 
			{
				...
				maintype='$maintype',billtype='$billtype',accountexpirydate='$accountexpirydate',planexpirydate='$planexpirydate',overalllimit='$overalllimit',planfixedamount='$planfixedamount',planpercentage='$planpercentage',locationcode='$locationcode',locationname='$locationname',inactivestatus = '".$inactivestatus."' where customercode='$customercode'"; 
		...
		header("location:medicalnotification.php?patientcode=$customercode");
...
function funcAccountNameChange1()
{
	...
	?>
		...
		<?php
		$query10 = "select * from master_planname where accountname = '$res11accountnameanum' and planexpirydate > NOW() order by planname";
		$exec10 = mysqli_query($GLOBALS["___mysqli_ston"], $query10) or die ("error in query10".mysqli_error($GLOBALS["___mysqli_ston"]));
		while ($res10 = mysqli_fetch_array($exec10))
		{
		$loopcount = $loopcount+1;
	...
	?>
	if(document.getElementById("accountname").value== 7)
	{
	document.getElementById("visitlimit").value = "";
	document.getElementById("overalllimit").value = "";
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="1311"><table width="1300" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#ecf0f5" class="bodytext3" colspan="2"><strong> Edit Patient Registration </strong></td>
                <!--<td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><?php echo $errmgs; ?>&nbsp;</td>-->
                <td bgcolor="#ecf0f5" class="bodytext3" colspan="8">&nbsp;</td>
              </tr>
              <tr>
...
-->				  
				  ...
				  <td width="7%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32">Account </span></td>
...
-->				
					...
					<td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"> Validity</span></td>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5"><input type="text" name="accountexpirydate" id="accountexpirydate" value="<?php echo $res2accountexpirydate; ?>" readonly ></td>
				</tr>
				<tr>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32">Plan</span></td>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5">
				  <input type="hidden" name="planvaliditystart" id="planvaliditystart" value="<?php echo $registrationdate; ?>" readonly>
				      ...
				      <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><input type="text" name="planfixedamount" id="planfixedamount" readonly value="<?php echo $res2planfixedamount; ?>" ></td>
...
-->
				  ...
				  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><input type="text" name="overalllimit" id="overalllimit" readonly value="<?php echo $res2overalllimit; ?>">                  </td>
				  </tr>
				<tr>				</tr>
				<tr>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Salutation</td>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5"><strong>
...
-->					</td>
<td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">DOB </td>
			      <td align="left" valign="middle"  bgcolor="#ecf0f5">
				  <input type="text" name="dateofbirth" id="dateofbirth" value="<?php echo $res2dob; ?>" onChange="return GetDifference1()" style=" background-color:#ecf0f5;">
			      ...
			      <td align="left" valign="middle" bgcolor="#ecf0f5"><input name="age" type="text" id="age" value="<?php echo $res2age; ?>" size="5" onKeyUp="return dobcalc();" style="background-color:#ecf0f5;" onChange="concatmiddledob();">
                      <!--				  
				  <select name="age">
...
-->
                      <input name="ageduration" id="ageduration" value="YEARS" size="5" readonly style="background-color:#ecf0f5;">
...
-->                  </td>
				...
				<tr>
				<td width="5%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"> First Name   </span></td>
                <td align="left" valign="middle"  bgcolor="#ecf0f5">
				...
				<td width="6%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"> Middle Name   </span></td>
				<td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				<input name="customermiddlename" id="customermiddlename" value="<?php echo $res2customermiddlename; ?>" style="text-transform:uppercase;" onChange="concatmiddledob();"></td>
				<td width="6%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"> Last Name   </span></td>
				<td align="left" valign="middle"  bgcolor="#ecf0f5">
				<input name="customerlastname" id="customerlastname" value="<?php echo $res2customerlastname; ?>" style="text-transform:uppercase;" ></td>
				<td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">National ID</td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5">
				 ...
				 <tr>
                	 <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Inactive Status</td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5">
                          <select name="inactivestatus" style="width: 174px;">
                           <option value="" >-Select-</option>
                          <option value="Alive" <?php if($inactivestatus == 'Alive'){echo "selected";}?>>Alive</option>
                          <option value="Dead"  <?php if($inactivestatus == 'Dead'){echo "selected";}?>>Dead</option>
                          </select>
				  </td> 
                </tr>
				<tr>
				  <td colspan="15" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong> Personal Details </strong></td>
				  </tr>
			    <tr>
			      <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32">Guardian</span></td>
			    ...
			    <td width="30%" align="left" valign="middle"  bgcolor="#ecf0f5"><input name="address1" id="address1" value="<?php echo $res2address1; ?>" size="20" /></td>
	    	      </tr>
			    
			    <tr>
				 <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Occupation</td>
			      <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="occupation" id="occupation" value="<?php echo $res2occupation; ?>" size="20" /></td>
...
-->				   </td>
          ...
          <?php
                ...
                <td width="30%" align="left" valign="middle"  bgcolor="#ecf0f5"><input name="address2" id="address2" value="<?php echo $res2address2; ?>" size="20" /></td>
		          </tr>
				 ...
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="pincode" id="pincode" value="<?php echo $res2pincode; ?>" size="20" /></td>
          ...
          <?php
				 ...
				 <tr>
				   <td colspan="10" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong> Contact Details </strong></td>
			      </tr>
				 <tr>
				 <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">MRD No. </td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="mrdno" id="mrdno" value="<?php echo $res2mrdno; ?>" size="20">			        </td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32">Mobile No </span></td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5">
				   ...
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="emailid1" id="emailid1" value="<?php echo $res2emailid1; ?>" size="20">
			        <input type="hidden" name="tinnumber" id="tinnumber" value="<?php echo $tinnumber; ?>" style="text-transform: uppercase;"  size="20" /></td>
					<td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Next Kin Name </td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="kinname" id="kinname" value="<?php echo $res2kinname; ?>" size="20" /></td>
			      </tr>
				 <tr>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Promotion </td>
			      <td align="left" valign="middle"  bgcolor="#ecf0f5"><select name="promotion" style="width: 150px;">
				   ...
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="emailid2" id="emailid2" value="<?php echo $res2emailid2; ?>" size="20">
			        <input type="hidden" name="cstnumber" id="cstnumber" value="<?php echo $cstnumber; ?>" style="text-transform: uppercase;"  size="20" /></td>
			      <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Kin Contact Nor </td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input name="kincontactnumber" id="kincontactnumber" value="<?php echo $res2kincontact; ?>" size="20" /></td>
				  </tr>
				
				 <tr>
				   <td colspan="10" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>Misc  Details </strong></span></td>
			      </tr>
				 <tr>
				 <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Reg Code </td>
				  <td align="left" valign="middle"  bgcolor="#ecf0f5"><strong><span class="bodytext312">
                    <!--<img src="images2/cal.gif" onClick="javascript:NewCssCal('insurancevalidityend')" style="cursor:pointer"/>-->
                    <input  name="customercode" id="customercode" value="<?php echo $patientcode; ?>" readonly style="border: 1px solid #001E6A; background-color:#ecf0f5;" size="20">
                  </span></strong></td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Reg Date </td>
				   <td align="left" valign="middle"  bgcolor="#ecf0f5"><input type="text" name="registrationdate" id="registrationdate" value="<?php echo $res2registrationdate; ?>" readonly style="background-color:#ecf0f5;">
				 ...
				 <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Photo </td>
				   <td colspan="3" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">

...
?>
            ...
            <td colspan="3" align="left" valign="center" bgcolor="#CCC" class="bodytext31" ><strong><?php
        echo $type;
?> </strong></td>
        ...
        while ($res2212 = mysqli_fetch_array($exec2212)) {
            ...
            // $accountname_ac = $res2212['accountname'];
            $sno         = 1;
...
?>
            ...
            <td colspan="3"  align="left" valign="center" bgcolor="#FFF" class="bodytext31" onClick="showsub(<?= $subtypeanum ?>)"><strong><?php
            echo $subtype;
?> </strong></td>
            ...
            while ($res221 = mysqli_fetch_array($exec221)) {
                ...
                $accountname_ac    = $res221['accountname'];
...
// $query = "select visitcode from master_visitentry where accountname='$res21accountnameano' and consultationdate between '$ADate1' and '$ADate2' group by visitcode ";
$query = "SELECT visitcode from billing_paylater where accountnameano='$res21accountnameano' and accountnameid='$res21accountid' and billdate between '$ADate1' and '$ADate2' group by visitcode 
	  
";

 // accountname='$accountname_ac' and
// billing_paylater where billdate between '$ADate1' and '$ADate2' group by visitcode  
$exec = mysqli_query($GLOBALS["___mysqli_ston"], $query) or die("Error in query1" . mysqli_error($GLOBALS["___mysqli_ston"]));
while ($res1v = mysqli_fetch_array($exec)) {
	$visitcode=$res1v['visitcode'];

$res2consultationamount=0;
$res8pharmacyitemrate=0;
	$query1 = "select SUM(totalamount) AS billamount1 from billing_paylaterconsultation where accountname != 'CASH - HOSPITAL' and visitcode='$visitcode' and billdate between '$ADate1' and '$ADate2' ";
	...
	$query8 = "select SUM(fxamount) AS  amount1 from billing_paylaterpharmacy where accountname != 'CASH - HOSPITAL' and patientvisitcode='$visitcode' and billdate between '$ADate1' and '$ADate2' 
	                ";
			$exec8 = mysqli_query($GLOBALS["___mysqli_ston"], $query8) or die("Error in query8" . mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	$query2 = "select sum(labitemrate1) as labitemrate1 from (select sum(labitemrate) as labitemrate1 from billing_paylaterlab where  accountname != 'CASH - HOSPITAL' and patientvisitcode='$visitcode' and billdate between '$ADate1' and '$ADate2') as amount1";
		$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die("Error in query2" . mysqli_error($GLOBALS["___mysqli_ston"]));
		$res2            = mysqli_fetch_array($exec2);
		$res2labitemrate = $res2['labitemrate1'];

	$query4          = "select sum(radiologyitemrate) as radiologyitemrate1 from billing_paylaterradiology where accountname != 'CASH - HOSPITAL' and patientvisitcode='$visitcode' and billdate between '$ADate1' and '$ADate2'";
		$exec4 = mysqli_query($GLOBALS["___mysqli_ston"], $query4) or die("Error in query4" . mysqli_error($GLOBALS["___mysqli_ston"]));
		$res4                  = mysqli_fetch_array($exec4);
		$res4radiologyitemrate = $res4['radiologyitemrate1'];


	$query6                = "select sum(fxamount) as servicesitemrate1 from billing_paylaterservices where patientvisitcode='$visitcode' and billdate between '$ADate1' and '$ADate2'";
			$exec6 = mysqli_query($GLOBALS["___mysqli_ston"], $query6) or die("Error in query6" . mysqli_error($GLOBALS["___mysqli_ston"]));
			$res6                 = mysqli_fetch_array($exec6);
			$res6servicesitemrate = $res6['servicesitemrate1'];


	$query10              = "select sum(referalrate) as referalrate1 from billing_paylaterreferal where patientvisitcode='$visitcode' and billdate between '$ADate1' and '$ADate2'";
	$exec10 = mysqli_query($GLOBALS["___mysqli_ston"], $query10) or die("Error in query10" . mysqli_error($GLOBALS["___mysqli_ston"]));
			$res10                = mysqli_fetch_array($exec10);
			$res10referalitemrate = $res10['referalrate1'];


	$query31              = "select sum(amount) as amount1 from billing_opambulancepaylater where  visitcode='$visitcode' and recorddate between '$ADate1' and '$ADate2'";
			$exec31 = mysqli_query($GLOBALS["___mysqli_ston"], $query31) or die("Error in Query31" . mysqli_error($GLOBALS["___mysqli_ston"]));
			$res31       = mysqli_fetch_array($exec31);
			$res31rescue = $res31['amount1'];


	$query29     = "select sum(amount) as amount1 from billing_homecarepaylater where visitcode='$visitcode' and recorddate between '$ADate1' and '$ADate2'";
	...
	$closetotalamount301 = $closetotalamount301 + $credittotal;
		  	$totalamount301 = $totalamount301+$credittotal;
...
$query_pd="SELECT sum(fxamount) as amount1 from billing_paynowpharmacy  where  billdate between '$ADate1' and '$ADate2' and patientvisitcode in (select visitcode from billing_paylater where accountname='$res21accountnameano' ) and accountname != 'CASH - HOSPITAL'
...
?>>
           ...
           <td class="bodytext31" valign="center"  align="left"><?= $sno++; ?></td>
                ...
                ><a href="revenuedetailed_account.php?accid=<?= $res21accountid ?>&&fromdate=<?= $ADate1 ?>&&todate=<?= $ADate2 ?>" target="_blank"><?php
...
?></strong></td> -->
            ...
            <a href="print_revenuereport_summary.php?<?php
    echo $urlpath;
?>"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a>

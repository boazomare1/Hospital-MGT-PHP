...
?>
		...
		<tr>
		 ...
		 <tr>
			...
			?>
			  <tr > <td colspan="8"  align="center" valign="center" bgcolor="#ecf0f5"   class="bodytext31"><strong><?php echo strtoupper ($res3username);?></strong></td>

              </tr>
			<tr>

              <td  align="center" valign="center"  class="bodytext31"><strong>No.</strong></td>

				<td   align="center" valign="center" class="bodytext31"><strong>Bill Date </strong></td>

				<td   align="center" valign="center" class="bodytext31"><strong>Bill No </strong></td>

              <td   align="right" valign="center" class="bodytext31"><strong>Cash </strong></td>

              <td  align="right" valign="center"  class="bodytext31"><strong> Card </strong></td>

              <td  align="right" valign="center"  class="bodytext31"><strong> Cheque </strong></td>

				<td  align="right" valign="center"  class="bodytext31" ><strong>Online</strong></td>

                <td  align="right" valign="center"  class="bodytext31"><strong>Mobile Money</strong></td>
...
$totalcashamount41='0.00';		
			...
			$query2 = "select * from master_transactionpaynow where billnumber = '$unionbillnumber' AND  $pass_location and username = '$res3username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
            ...
            <tr >
			  ...
			  <td class="bodytext31" valign="center"  align="right"><?php echo $res2billnumber; ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res3cashamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res3cardamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res3chequeamount1,2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right"><?php echo number_format($res3onlineamount1,2,'.',','); ?></td>

                <td  align="right" valign="center" class="bodytext31"><?php echo number_format($res3creditamount1,2,'.',','); ?></td>
			...
			$query23 = "select * from master_billing where billnumber = '$unionbillnumber' AND $pass_location and username = '$res3username' and billingdatetime between '$transactiondatefrom' and '$transactiondateto' order by username desc";
            ...
            <tr >
              ...
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res33cashamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res33cardamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res33chequeamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res33onlineamount1,2,'.',','); ?></td>

                <td  align="right" valign="center" class="bodytext31"><?php echo number_format($res33creditamount1,2,'.',','); ?></td>
			...
			$query24 = "select * from master_transactionexternal where billnumber = '$unionbillnumber' AND $pass_location and username = '$res3username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
            ...
            <tr >
              ...
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res34cashamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res34cardamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res34chequeamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res34onlineamount1,2,'.',','); ?></td>

                <td  align="right" valign="center" class="bodytext31"><?php echo number_format($res34creditamount1,2,'.',','); ?></td>
			...
			$query25 = "select * from refund_paynow where billnumber = '$unionbillnumber' AND $pass_location and username = '$res3username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
            ...
            <tr >
              ...
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format(- $res35cashamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format(- $res35cardamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format(- $res35chequeamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format(- $res35onlineamount1,2,'.',','); ?></td>

                <td  align="right" valign="center" class="bodytext31"><?php echo number_format(- $res35creditamount1,2,'.',','); ?></td>
			...
			$query26 = "select * from master_transactionadvancedeposit where docno = '$unionbillnumber' AND $pass_location and username = '$res3username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
...

		{
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res36cashamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res36cardamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res36chequeamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res36onlineamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res36creditamount1,2,'.',','); ?></td>
			...
			$query27 = "select * from master_transactionipdeposit where docno = '$unionbillnumber' AND $pass_location and username = '$res3username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
...

		{
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res37cashamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res37cardamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res37chequeamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res37onlineamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res37creditamount1,2,'.',','); ?></td>
			...
			$query28 = "select * from master_transactionip where billnumber = '$unionbillnumber' AND $pass_location and username = '$res3username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
...

		{
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res38cashamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res38cardamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res38chequeamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res38onlineamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res38creditamount1,2,'.',','); ?></td>
			...
			$query29 = "select * from master_transactionipcreditapproved where billnumber = '$unionbillnumber' AND $pass_location and username = '$res3username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
...

		{
            ...
            <tr >
              ...
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res39cashamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res39cardamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res39chequeamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res39onlineamount1,2,'.',','); ?></td>

                <td  align="right" valign="center" class="bodytext31"><?php echo number_format($res39creditamount1,2,'.',','); ?></td>
			...
			$query45 = "select * from receiptsub_details where docnumber = '$unionbillnumber' AND $pass_location and username = '$res3username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' order by username desc";
			...
			$res45transactiondate = $res45['transactiondate'].' '.$res45['transactiontime'];
			...
			//$query1 = "select billnumber from master_billing, master_transactionpaynow, master_transactionexternal where master_billing.";
			if(($res45cashamount1 != '0.00')||($res45cardamount1 != '0.00')||($res45creditamount1 != '0.00')||($res45chequeamount1 != '0.00'))
            ...
            <tr >
              ...
              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res45cashamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res45cardamount1,2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right"><?php echo number_format($res45chequeamount1,2,'.',','); ?></td>

				<td  align="right" valign="center" class="bodytext31"><?php echo number_format($res45onlineamount1,2,'.',','); ?></td>

                <td  align="right" valign="center" class="bodytext31"><?php echo number_format($res45creditamount1,2,'.',','); ?></td>
			...
			$query40 = "select * from master_transactionpaylater where  docno = '$unionbillnumber' AND  $pass_location and username = '$res3username' and transactiondate between '$transactiondatefrom' and '$transactiondateto' and docno like 'AR-%' and transactionstatus='onaccount' ";
...
<?php 
...

		{
			...
			$totalcashamount = $totalcashamount1 + $totalcashamount2 + $totalcashamount3 - $totalcashamount4 + $totalcashamount5 + $totalcashamount6 + $totalcashamount7 + $totalcashamount8 + $totalcashamount10 -$totalcashamount41;

			$totalcardamount = $totalcardamount1 + $totalcardamount2 + $totalcardamount3 - $totalcardamount4 - $totalcardamount41 + $totalcardamount5 + $totalcardamount6 + $totalcardamount7 + $totalcardamount8 + $totalcardamount10;

			$totalchequeamount = $totalchequeamount1 + $totalchequeamount2 + $totalchequeamount3 - $totalchequeamount4 - $totalchequeamount41 + $totalchequeamount5 + $totalchequeamount6 + $totalchequeamount7 + $totalchequeamount8 + $totalchequeamount10;

			$totalonlineamount = $totalonlineamount1 + $totalonlineamount2 +$totalonlineamount3 - $totalonlineamount4 - $totalonlineamount41 + $totalonlineamount5 + $totalonlineamount6 + $totalonlineamount7 + $totalonlineamount8 + $totalonlineamount10;

			$totalcreditamount = $totalcreditamount1 + $totalcreditamount2 +$totalcreditamount3 - $totalcreditamount4  - $totalcreditamount41 +  $totalcreditamount5 + $totalcreditamount6 + $totalcreditamount7 + $totalcreditamount8 + $totalcreditamount10;
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="right" 
                ...
                bgcolor="#FFFFFF" class="bodytext31"><?php echo number_format($totalcreditamount,2,'.',',');?></td>
		...
		<!-- <td colspan="1" class="bodytext31" valign="center"  align="right">&nbsp;</td> -->

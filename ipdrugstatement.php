    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="5" bgcolor="#ecf0f5" class="bodytext3"><strong>IP Drug Statement </strong></td>
              </tr>
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
               <tr>
			 <td colspan="7" align="center" "bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo $_REQUEST['customer'];  ?>-<?php echo $searchpatientcode; ?>-<?php echo $res39visitcode; ?></strong></td>
			 </tr>
            <tr>

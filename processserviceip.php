...

{
	...
	$query29=mysqli_query($GLOBALS["___mysqli_ston"], "update ipconsultation_services set servicerefund='refund',refundquantity='$refundquantity',process='$process',processedby = '$username' where patientcode='$patientcode' and patientvisitcode='$visitcode' and servicesitemcode = '$servicesitemcode' and auto_number='$autonumber'")or die("Error in Query29".mysqli_error($GLOBALS["___mysqli_ston"]));

...
else
{
	...
	$billnumbercode7 = $paynowbillprefix7 .$maxanum7;
		...
		$notes=mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $notes);
...
var tt = confirm("Do you want save?");
if(tt == true)
{ return true;	}
else
	return false;
	...
	$colorloopcount = $colorloopcount + 1;
      ...
      <tr>
       ...
       <tr>
		...
		<td width="23%" align="left" valign="center" class="bodytext311"><textarea name="notes" id="notes" rows="10" cols="60"></textarea></td>
	  ...
	  <tr>
		...
		<table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>Previous Notes</strong></td>
	  ...
	  <tr>
		...
		<td width="10%" align="center" valign="center" class="bodytext311">        </td>

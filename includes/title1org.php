...
<b><?php echo $locationshortname; ?></b>
</div>
...
$res_main = mysqli_fetch_array($exec_main);
 ...
 if($submenuid_1!=""){
?>
<div style="float:left; margin-bottom:3;margin-left:45;font-size:15px">

        <a href="<?php echo $mainmenulink; ?>"><span style="color:blue"><b><?php echo $mainmenutext; ?></b></span></a>  &nbsp;>&nbsp;<span style="color:green">
		<?php echo $submenutext; ?></span>
 
 </div>
 <?php } ?>
 <div style="float:left; margin-bottom:3;margin-left:85;font-size:21px">
...
<a href="mainmenu1.php?mainmenuid=MM000">
	...
	<!--<img src="images/presto.png" />	</span>-->
	</a>
	</td>

    <!--<td width="3%" bgcolor="#FFFFFF"><img src="images/user1.png" width="30" height="20"/></td>-->

    <td width="26%" bgcolor="#3c8dbc" class="style4TM1" align="left" valign="">
    ...
    <script type="text/javascript">date_time('date_time');</script><a href="login1.php"><img src="images/logout.png"  align="center"width="40" height="30"/ title='Logout'></a>
...
<input type="hidden" name="username" id="username" value="<?php echo $username; ?>">
   ...
   ?>
	...
	$name=$user_name;
	$pass=$password;
	$url='http://localhost/evofin/login?username='.$name.'&&password='.$pass.'&&location_code='.$reslocationanum.'&&store_code='.$store_code.'';

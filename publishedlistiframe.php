  ...
  <tr>
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		$query1 = "select a.* from master_consultation as a left join master_visitentry as b on a.patientvisitcode=b.visitcode where a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and a.patientname like '%$searchpatient%' and a.username like '%$searchdoctor%' and  a.results='completed' and a.closevisit = '' and a.recorddate = '$res11recorddate' and b.department in (SELECT departmentanum FROM `master_employeedepartment` where username like '$username') and a.locationcode='$locationcode'  group by a.patientvisitcode,a.recorddate  order by a.auto_number desc";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		$query431 = "select username from master_consultationlist where visitcode='$visitcode' and locationcode='$locationcode'";
		...
		$requestedbyname = $res431['username'];

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="slade_visit_status.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>Visit Status </strong></td>
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="9" bgcolor="#ecf0f5" class="bodytext31"><div align="left"><strong>Visit Status</strong><label class="number"></label></div></td>
			 </tr>
            <tr>
			  ...
			  <td width="50%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31" colspan="2"><strong>Status</strong></td>
		...
		$eclaim_val='';
		 ...
		 master_visitentry as b on (a.visitcode=b.visitcode)
		  where (b.eclaim_id='2' or b.eclaim_id='3' or b.offpatient='1')  and a.patientcode like '%$searchpatientcode%' and a.visitcode like '%$searchvisitcode%' and a.patientname like '%$searchpatient%'  and a.billno like '%$billnumber2%'";
		...
		$invoice_attach_url=$res1701['invoice_url'];
          ...
          <tr <?php echo $colorcode; ?> id="row-<?php echo $sno ; ?>">
			  ...
			  <td class="bodytext31" valign="center"  align="left">
                ...
                <?php
			  if(($num232<=0 && $eclaim_id=='2') || ($num232<=0 && $eclaim_id=='3'))
			  {?>
                           
               <td class="bodytext31" valign="center"  align="left" colspan="2"><strong>Not Posted</strong></td>  


              <?php } else if ($claim_payload=='') { ?>
            <td class="bodytext31" valign="center"  align="left" colspan="2"><strong>Claim Not Posted</strong></td> 
              
              <?php } else if ($invoice_payload=='') {?>
              
                <td class="bodytext31" valign="center"  align="left" colspan="2"><strong>Invoice Line Items Not Posted</strong></td> 

              
              <?php } else if ($invoice_upload_payload=='') {?>
               <td class="bodytext31" valign="center"  align="left" colspan="2"><strong>Invoice Not Uploaded</strong></td> 

			<?php } else {?>
             <td class="bodytext31" valign="center"  align="left" colspan="2"><strong>Successfully Posted</strong></td>  
             <?php } ?>
                 <td class="bodytext31" valign="center"  align="left">
		...
		$invoice_attach_url=$res1701['invoice_url'];
          ...
          <tr <?php echo $colorcode; ?> id="row-<?php echo $sno ; ?>">
			  ...
			  <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $billnumber; ?></div></td>
             <?php
			  if(($num232<=0 && $eclaim_id=='') || ($num232<=0 && $eclaim_id=='3'))
			  {?>
...
<?php } else {?>
		...
		$invoice_attach_url=$res1701['invoice_url'];
          ...
          <tr <?php echo $colorcode; ?> id="row-<?php echo $sno ; ?>">
              ...
              <?php } else if ($num232<=0 && $eclaim_id=='2' && $offpatient=='1' || $num232<=0 && $eclaim_id=='0' && $offpatient=='1' || $num232<=0 && $eclaim_id=='3' || $claim_payload=='') { ?>
             <td class="bodytext31" valign="center"  align="left" colspan="2"><strong>Claim Not Posted</strong></td>  

  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="1145"><form name="cbform1" method="post" action="publishedlistiframe_intriagelist.php">
		  ...
		  <td   align="left" valign="top"  bgcolor="#FFFFFF"><input type="hidden" name="cbfrmflag1" value="cbfrmflag1">
                        ...
                        <td  width="136"  align="left" valign="top"  bgcolor="#FFFFFF" onclick="window.open('publishedlistiframe_intriagelist_popup.php?ss=1&&fromdate=<?=$fromdate;?>&&todate=<?=$todate;?>','_blank');"><button>Full Screen</button> </td>
                        <!-- <td  width="136"  align="left" valign="top"  bgcolor="#FFFFFF" onclick="window.open('publishedlistiframe_intriagelist_popup.php?ss=1&&fromdate=<?=$fromdate;?>&&todate=<?=$todate;?>','win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=1400,height=980,directories=no,location=no','_blank');"><button>Full Screen</button> </td> -->
                    <?php } ?>
...
<style type="text/css">
	.hidethe{
		...
		$gender = $res43['gender'];
            ...
            <tr onclick="HideFunction(<?=$sno;?>)" style="cursor: pointer;" <?php echo $colorcode; ?>>

              <td class="bodytext31" valign="center"  align="left"><div align="left"> <strong><?php echo $res1patientname; ?> (<?php echo $patientcode; ?>,<?php echo $visitcode; ?>),<?php echo $gender; ?>,<?php echo $age; ?></strong> </div></td>
            ...
            <tr id="res<?=$sno;?>" class="hidethe">
            	<td></td>
            	 <td  class="bodytext31" valign="center"  align="center"><iframe id="preconsultation" src="preconsultationresultsview_iframe.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&date=<?php echo $consultationdatetime; ?>&&name=<?php echo $res1patientname;?>" width="450" height="140" scrolling="" frameborder="0"> </iframe></td>
            	 <td></td>
            </tr>

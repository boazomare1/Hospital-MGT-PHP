<?php
				...
				{  
					...
					if($id == '04-6001')
					{
						$i = 0;
						$drresult = array();
						$querydr1in = "SELECT SUM(`serviceamount`) as incomedebit FROM `refund_paynowservices` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
						...
						$j = 0;
						$crresult = array();
						$querycr1in = "SELECT SUM(`fxamount`) as income FROM `billing_paynowservices` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'

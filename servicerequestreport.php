    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="servicerequestreport.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Service Request Report</strong></td>
	  ...
	  <tr>
        <td>
	<form name="form1" id="form1" method="post" action="servicerequestreport.php">	
...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	?>
          ...
          <tbody>
            ...
            <tr>
             ...
             <td width=""  align="left" valign="center" 
                ...
                <td width=""  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Service Item code</strong></div></td>
                
                <td width=""  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Service Item Rate</strong></div></td>
                
                <td width=""  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Service Item Name</strong></div></td>
				<td width=""  align="left" valign="center" 
		   ...
		   select servicesitemname as labitemname,servicesitemcode as labitemcode,patientvisitcode as visitcode from consultation_services where locationcode='".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and consultationdate between '$fromdate' and '$todate' 
		   UNION ALL
		   select itemname as labitemname,itemcode as labitemcode,visitcode as visitcode from amendment_details where visitcode like '%-$loctid' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and amenddate between '$fromdate' and '$todate' and amendfrom='services' and visitcode like 'OPV-%') as a group by labitemcode";
           ...
           <tr>
			  ...
			  <div class="bodytext31" align="left"><strong>Service Item Name:<?= $itemname; ?></strong></div></td>
               <td class="bodytext31" valign="center" colspan="10"  align="left" bgcolor="#ffffff">
			...
			$query23 = "select username,patientcode,patientvisitcode,patientname,servicesitemcode as labitemcode,servicesitemrate as labitemrate,consultationdate,process as resultentry,'' as amend,exclude,externalack from consultation_services where locationcode='".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and consultationdate between '$fromdate' and '$todate' and servicesitemcode='".$itemcode21."'
			UNION ALL
			select amendby as username,patientcode,visitcode as patientvisitcode,patientname,itemcode as labitemcode,rate as labitemrate,amenddate as consultationdate,'' as resultentry,'Yes' as amend,'' as exclude,'' as externalack from amendment_details where visitcode like '%-$loctid' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and amenddate between '$fromdate' and '$todate' and amendfrom='services' and visitcode like 'OPV-%'  and itemcode='".$itemcode21."'
			";
		...
		$extcount+=1;
			$extlab=1;
		$supplierq = "select suppliercode,rate from serv_supplierlink where itemcode = '$itemcode' and fav_supplier='1'";
		 ...
		 $colorloopcount = $colorloopcount + 1;
           ...
           <tr>
			...
			<tr>
             ...
             <td height="45"  align="left" valign="center" class="bodytext31" colspan="2"><div align="right"><strong>Service Request Count</strong></div></td>
			  ...
			  <td height="45"  align="left" valign="center" class="bodytext31" colspan="2"><div align="right"><strong>Service Pending Count</strong></div></td>
			   <td class="bodytext31" valign="center"  align="left">
            ...
            <tr>
             ...
             <td height="45"  align="left" valign="center" class="bodytext31" colspan="2"><div align="right"><strong>External Lab Count</strong></div></td>
			   <td class="bodytext31" valign="center"  align="left" colspan="2">
			  <div class="bodytext31" align="center"><strong><?= $extcount; ?></strong></div></td>
			  
			  <td height="45"  align="left" valign="center" class="bodytext31" colspan="2"><div align="right"><strong>External Lab Amount</strong></div></td>
			   <td class="bodytext31" valign="center"  align="left">

...
if($frmflag1 == 'frmflag1')
{
	...
	$query7 = "update openingbalanceaccount set entrydate = '$expenseentrydate', openbalanceamount = '$expenseamount', amount = '$expenseamount', username = '$username' where auto_number = '$editanum'";
...
$query6 = "select * from openingbalanceaccount where auto_number = '$anum'";
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td >
				...
				<form name="form1" id="form1" method="post" action="editopeningbalanceaccount.php">
			  <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                <tbody>
                  <tr bgcolor="#011E6A">
                    <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Edit Opening Balance Account  </strong></td>

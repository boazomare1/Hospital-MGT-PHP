...
?>
		...
		$sno = 0;	
		$colorloopcount=0;
		$query2 = "select patientvisitcode,consultationdate,labitemname,iptestdocno,labitemrate,username from ipconsultation_lab where locationcode='$locationcode1' and consultationdate between '$fromdate' and '$todate' and  freestatus='$status1' and patientvisitcode in (select visitcode from master_ipvisitentry where locationcode='$locationcode1' and consultationdate between '$fromdate' and '$todate' and  package='$packagecode' and finalbillno <> '') order by consultationdate ASC";
		...
		$itemname= $res2['labitemname'];
		$docno= $res2['iptestdocno'];
		$rate= $res2['labitemrate'];

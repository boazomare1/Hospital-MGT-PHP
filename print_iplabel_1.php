...
<td>
 ...
 <tr>
  ...
  <tr>
    <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31" style="border-bottom: solid 2px #000000;"><strong><?php echo ucwords(strtoupper($res7patientfullname)); ?></strong></td>
  </tr>
  <tr>
    <td   class="bodytext41" valign="center"  
                bgcolor="#ffffff"><strong>Registration : <?php echo $patientcode; ?>&nbsp;&nbsp; Visit :<?php echo $visitcode; ?></strong></td>
    </tr>
    ...
    <tr>
    <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext41"><strong>Age : <?php echo $patientage1; ?>&nbsp; Gender : <?php echo $patientgender;?></strong> </td>
    </tr>
	
   <tr>
    <td   class="bodytext41" valign="center"  
                bgcolor="#ffffff"><strong>DOA  : <?php echo $recorddate; ?></strong></td>
    </tr>

	<tr>
    <td   class="bodytext41" valign="center"  
                bgcolor="#ffffff"><strong>Ward : <?php echo $wardname; ?></strong></td>
    </tr>
	<tr>
    <td   class="bodytext41" valign="center"  
                bgcolor="#ffffff"><strong>Bed  : <?php echo $bedname; ?></strong></td>
    </tr>
	<tr>
    <td   class="bodytext41" valign="center"  
                bgcolor="#ffffff"><strong>Doctor : <?php echo $consultingdoctorName; ?></strong></td>
    </tr>

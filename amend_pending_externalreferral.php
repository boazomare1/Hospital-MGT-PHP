  ...
  <tr>
	...
	<tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Amend Special Clinic</strong></td>
			</tr>
			<tr>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$colorloopcount = '';
			$sno = '';
			$query1 = "select * from consultation_referal where patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and consultationdate between '$ADate1' and '$ADate2' and paymentstatus = 'pending' and billtype = 'PAY NOW' group by patientvisitcode order by consultationdate DESC";
			...
			?>
			 ...
			 <?php
			 $query11 = "select * from consultation_referal where patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and consultationdate between '$ADate1' and '$ADate2' and billtype = 'PAY LATER' group by patientvisitcode order by consultationdate DESC";

...
<?php include("print_header.php");
	...
	<tr >
		<td colspan="7" align="left" class="bodytext31"><strong>EMPLOYER'S NAME : </strong><?php eval(base64_decode('IGVjaG8gJGNvbXBhbnluYW1lOyA=')); ?></td>
		<td colspan="7" align="right" class="bodytext31"><strong>EMPLOYER'S NAME : </strong><?php eval(base64_decode('IGVjaG8gJHNlYXJjaGVtcGxveWVlOyA=')); ?></td>
	</tr>
...
//      $html2pdf->setModeDebug();
	//$html2pdf->setDefaultFont('Arial');
	$html2pdf->writeHTML($content, isset($_GET['vuehtml']));
	$html2pdf->Output('print_bankreportpdf.pdf');
}
catch(HTML2PDF_exception $e) {
	echo $e;
	exit;

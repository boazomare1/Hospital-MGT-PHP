...
if (isset($_REQUEST["delay_reason"])) { $delay_reason = $_REQUEST["delay_reason"]; } else { $delay_reason = ""; }
      ...
      <tr>
        <td>
          ...
          <tbody>
			...
			$colorloopcount = '';
			$snocount=0;
			  $querycr1in = " SELECT b.selectreason,a.auto_number,b.booking_id,b.late_reason FROM `master_theatre_booking` as a join `theatre_panel_late reason` as b on b.booking_id=a.auto_number  WHERE date(a.surgerydatetime) BETWEEN '$ADate1' AND '$ADate2'  and b.selectreason like '%$delay_reason%' order by b.selectreason";	
			 ...
			 $selectreason=$res['selectreason'];
			 $late_reason=$res['late_reason'];
			 $booking_id=$res['booking_id'];
			 $count=0;
			 
			  $querycr1in1 = " SELECT * FROM `master_theatre_booking`   WHERE  auto_number ='$bookingid' ";	
			 ...
			 $cancel_reason=$res1['cancel_reason'];
			  $anesthesia = $res1['anesthesia'];
			  $ward = $res1['ward'];
			 ...
			 $ward_name = $res3_0121['ward'];
			  ...
			  $stringbigname1='';
				 $query_surg_doc = "select * from theatre_booking_surgeons WHERE booking_id  = '$auto_number'";
			...
			?>
			 ...
			 <tr  <?php echo $colorcode; ?>>
			  ...
			  <td width="" align="left" valign="center"   class="bodytext31"><?php echo $late_reason ?></td>

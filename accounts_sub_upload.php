...
{	
		...
		try {
			...
			if($rowData[$key] == 'Main Account Id')
			 $maintype1 = $key;

			if($rowData[$key] == 'Sub Id')
			 $sub_id1 = $key;

			if($rowData[$key] == 'Sub Name')
			 $sub_name1 = $key;
    		...
    		$rowData = $sheet->rangeToArray('A' . $row . ':' . $highestColumn . $row,
    				...
    				$sub_id = $rowData[$sub_id1];
					$sub_name = $rowData[$sub_name1];
			...
			if($sub_id!="")
				{
									...
									$sub_name = preg_replace('/[^a-zA-Z0-9_ %\[\]\.\(\)%&-]/s', '', $sub_name);

									$sub_name=ucwords(strtolower($sub_name));
 
									$query1 = "INSERT into master_accountssub (accountsmain, accountssub, ipaddress, recorddate, username, id, shortname) 
									values ('$maintype', '$sub_name', '$ipaddress', '$updatedatetime', '$username', '$sub_id', '')";
					...
					echo "<script>window.location.href = 'accounts_sub_upload.php'</script>";
					// accounts_sub_upload
                  ...
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Accounts Sub Upload :  </strong></td>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
                          <a href="sample_excels/master_accountssub_sample.xls" class="bodytext3"><span class="bodytext3" style="color: red; text-decoration: underline;"><strong>Click Here for Sample Excel File...</strong></span></a></td>
                      </tr>
                      <tr>

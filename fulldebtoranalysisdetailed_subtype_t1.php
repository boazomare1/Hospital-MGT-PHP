    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="fulldebtoranalysisdetailed_subtype_t1.php" >
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
			...
			?>
			<tr bgcolor="#cbdbfa">
            <td colspan="13"  align="left" valign="center" bgcolor="#FFF" class="bodytext31" onClick="showsub(<?=$subtypeanum?>)"><strong><?php echo $subtype; ?> </strong></td>
            </tr> 
...
$resamount=0;
		  ...
		  UNION ALL SELECT `docno` as docno, sum(debitamount-creditamount) as fxamount, `entrydate` as transactiondate ,ledgerid as patientcode, ledgername as patientname,'' as visitcode,narration as particulars   FROM `master_journalentries` WHERE `ledgerid` = '$res21accountid' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' group by docno) as t order by t.transactiondate DESC";
		   ...
		   <td class="bodytext31" valign="center"  align="left"><?=$sno++;?></td>
                <td class="bodytext31" valign="center" colspan="12" align="left"><?php echo $res22accountname; ?></td>
		  ...
		  while($res42 = mysqli_fetch_array($exec42))
		  {
				...
				$totalpayment = 0;
				$query98 = "select sum(fxamount) as transactionamount1 from master_transactionpaylater where transactiontype = 'PAYMENT' and billnumber='$res2billnumber' and recordstatus = 'allocated'";
				...
				$totalonaccountpayment = 0;
			 	$query67 = "select sum(fxamount) as transactionamount1 from master_transactionpaylater where docno='$res2billnumber' and transactionstatus <> 'onaccount' and recordstatus = 'allocated'";
				...
				$resamount = $res2transactionamount - $totalpayment + $totalonaccountpayment;
			...
			#cbdbfa
			?>
			<tr <?php echo $colorcode2; ?> class="acc<?=$res21accountnameano?>" style="display:none">
...
$grandtotalamount2401 += $totalamount2401;
			...
			$totalamount2101 = "0.00";
			$totalamount2401 = "0.00";
				$urlpath = "cbfrmflag1=cbfrmflag1&&ADate1=$ADate1&&ADate2=$ADate2&&searchsuppliername=$searchsuppliername&&searchsuppliername1=$searchsuppliername1&&type=$typeanum&&searchsubtypeanum1=$searchsubtypeanum1";	
			...
			?>
			 <td colspan="8"></td>
              ...
              <td class="bodytext31" valign="center"  align="right" 
				...
				<td class="bodytext31" valign="center"  align="right"><a href="print_fulldebtoranalysisdetailed_subtype.php?<?php echo $urlpath; ?>"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a>
                <a href="print_fulldebtoranalysisdetailed_subtypepdf.php?<?php echo $urlpath; ?>"><img src="images/pdfdownload.jpg" width="40" height="40"></a></td>       
            </tr>
          </tbody>
        </table></td>
      </tr>

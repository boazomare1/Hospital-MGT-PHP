...
header('Content-Disposition: attachment;filename="labrevenuereport.xls"');
...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		 ...
		 <tr> <td colspan="10" align="center"><strong><u><h3>LAB REVENUE REPORT</h3></u></strong></td></tr>

         

         <tr>  <td colspan="10" align="center">

         <strong> Type : <?php if($type=='') { echo "ALL"; } else echo $type; ?> </strong></td> </tr>

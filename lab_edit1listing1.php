...
$referencecomments = $res23['referencecomments'];
$referenceanum = $res23['auto_number'];
$generic_search = $res23['generic_search'];
?>
<TR id="idTR<?php echo $itemcount; ?>" bgcolor="#ecf0f5">
<td id="idTD1<?php echo $itemcount; ?>" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
...
<td id="idTD2<?php echo $itemcount; ?>" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
...
<textarea name="refcomments[]" id="refcomments<?php echo $itemcount; ?>" rows="2" cols="15" style="display:none;"><?php echo $referencecomments; ?></textarea>

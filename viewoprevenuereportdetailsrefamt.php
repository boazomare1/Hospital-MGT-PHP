...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Refund Amount</strong></td>
			...
			$query1 = "SELECT billdate, billnumber, patientvisitcode, patientname, consultation as consultation from refund_consultation where billdate between '$ADate1' and '$ADate2'
			union all select billdate, billnumber, patientvisitcode, patientname, fxamount as consultation from refund_paylaterconsultation where billdate between '$ADate1' and '$ADate2'
			union all select entrydate as billdate, billno as billnumber, visitcode as patientvisitcode, patientname, consultationfxamount as consultation from billing_patientweivers where entrydate between '$ADate1' and '$ADate2'
			";
			...
			$res1consultationamount = $res1['consultation'];
...
*/	
		   ...
		   ?>
            ...
            <tr <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5" align="right"><?php echo number_format((-1)*$res1consultationamount,2,'.',','); ?></td>
         ...
         <tr>
              ...
              <td align="right" valign="center" 
                ...
                bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo number_format((-1)*$total6,2,'.',','); ?></strong></td></tr>
...
-->		
          ...
          <tr>
			...
			<a href="viewoprevenuereportdetailsrefamtxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>

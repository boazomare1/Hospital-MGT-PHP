    ...
    <td width="99%" valign="top">
      ...
      <tr>
        <td>
          ...
          <tbody>
            <td colspan="12" bgcolor="#ecf0f5" class="bodytext3"><strong>OP Revenue Cash &nbsp; From &nbsp;<?php echo $transactiondatefrom; ?> To <?php echo $transactiondateto; ?></strong></td>
			...
			<tr>
				  ...
				  <td width="8%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Bill Date</strong></td>
                  ...
                  <td width="12%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Doctor</strong></td>
			...
			$query1 = "select patientcode,patientname,consultation,billdate,locationname,patientvisitcode,doctorname,consultation_percentage,sharingamount,billnumber as billnumber from billing_consultation where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname = 'CASH - HOSPITAL' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')

				UNION ALL

				select patientcode,patientname,fxamount as consultation,billdate,locationname,visitcode as patientvisitcode,doctorname,consultation_percentage,sharingamount,billno as billnumber from billing_paylaterconsultation where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname = 'CASH - HOSPITAL' and visitcode in (select visitcode from master_visitentry where department like '$department')
				order by billdate";
			...
			$query1 = "select patientcode,patientname,fxamount,billdate,locationname,patientvisitcode,billnumber from billing_paynowpharmacy where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname = 'CASH - HOSPITAL'  and patientvisitcode in (select visitcode from master_visitentry where department like '$department')

				UNION ALL

				select patientcode,patientname,fxamount,billdate,locationname,patientvisitcode,billnumber from billing_paylaterpharmacy where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname = 'CASH - HOSPITAL' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			$query1 = "select patientcode,patientname,fxamount,billdate,locationname,patientvisitcode,billnumber from billing_paynowlab where locationcode='$locationcode' and billdate between '$transactiondatefrom' and '$transactiondateto'";
			...
			?>
                ...
                <tr <?php echo $colorcode; ?>>
				  ...
				  <td class="bodytext31" valign="center"  align="left"><div class="bodytext31"></td>

                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php echo number_format($amount,2,'.',','); ?></div></td>
				  
				  <td class="bodytext31" valign="center"  colspan="3" align="left"><div class="bodytext31"></td>
			...
			$query1 = "select patientcode,patientname,fxamount,billdate,locationname,patientvisitcode,billnumber from billing_paynowradiology where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			$query1 = "select patientcode,patientname,amount,recorddate,locationname,visitcode,docno from billing_opambulance where  locationcode='$locationcode' and  recorddate between '$transactiondatefrom' and '$transactiondateto' and visitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			$query1 = "select patientcode,patientname,amount,recorddate,locationname,visitcode,docno from billing_homecare where  locationcode='$locationcode' and  recorddate between '$transactiondatefrom' and '$transactiondateto' and visitcode in (select visitcode from master_visitentry where department like '$department')";

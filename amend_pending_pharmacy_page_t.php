	   ...
	   <tr>
	     <td>	
          ...
          <!--  <tr>
			...
			$sno = '';
			//echo $selectpending;
			$query1 = "select * from master_consultationpharm where medicineissue='pending' and patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and recorddate between '$ADate1' and '$ADate2' and  billing = '' ";
			...
			$query1 .= " group by patientvisitcode order by auto_number desc";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="amendpharmacy_page.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&selectpending=<?php echo $selectpending; ?>"><strong>Amend</strong></a>			  </td>
                
              <td class="bodytext31" valign="center"  align="left"><a href="print_amendpharmacy_page.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode ?>" target="new" ><strong>Print</strong></a>			  </td>
              </tr>
			<?php
			  }
			  }    

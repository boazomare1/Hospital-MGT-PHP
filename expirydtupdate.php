...
//and pd.categoryname like '%".$categoryname."%'  and pd.companyanum = '$companyanum'
			...
			//echo $res59batchnumber.$res99itemcode.$loc.$store.$updatedate;
		...
		$batch_quantity= $currentstock1-$currentstock2;
            ...
            <tr <?php echo $colorcode; ?> id="<?php echo $sno;  ?>">
              ...
              <td align="left" valign="center"  
                  class="batchupdatestatic" >
                <div align="left" class="updatebatch bodytext31" id="uibatch_<?php echo $sno;?>"><?php echo $res59batchnumber; ?></div>
              </div></td>

              <td style="display:none;" class="batchupdatetd" width="123" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"  

                 ><div class="bodytext31">

                <div align="left"><input  id="batchupdate_<?php  echo $sno;?>" name="batchupdate[]" style="border: 1px solid #001E6A" value=""  size="10"  value='<?php echo $res59batchnumber;?>' />
</div>

...
if ($frmflag1 == 'frmflag1')
{
	...
	$equipment_name = $_REQUEST["equipment"];
	//$store = strtoupper($store);
	$templatename = trim($equipment_name);
	...
	if ($length<=100)
	{
	$query2 = "select * from master_equipments where equipment_name = '$equipment_name' and location_code = '$locationcode'";

	$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
	$res2 = mysqli_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "INSERT INTO `master_equipments`(`equipment_name`, `created_at`, `updated_at`, `record_status`, `user_id`, `ip_address`, `location_code`) VALUES ('$equipment_name','$updatedatetime','$updatedatetime','','$username','$ipaddress','locationcode')";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
		$errmsg = "Success. New Theatre Equipment Saved.";
		$bgcolorcode = 'success';
	...
	{
		$errmsg = "Failed. Theatre Equipment Already Exists.";
		$bgcolorcode = 'failed';
	}
	}
	else
...
if ($st == 'del')
{
	...
	$query3 = "update master_equipments set record_status = 'deleted' where auto_number = '$delanum'";
	$exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
}
if ($st == 'activate')
{
	$delanum = $_REQUEST["anum"];
	$query3 = "update master_equipments set record_status = '' where auto_number = '$delanum'";
	$exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
}
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="theatre_equipments.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="" bgcolor="#ecf0f5" class="bodytext3"><strong>Theatre Equipments - Add New </strong></td>
                  ...
                  <?php
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="equipment" id="equipment" style="border: 1px solid #001E6A;" size="40" /></td>
                      </tr>
					   <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="6" bgcolor="#ecf0f5" class="bodytext3"><strong>Theatre Equipments  - Existing List </strong></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top" bgcolor="#ecf0f5"  class="bodytext3">&nbsp;</td>
                        <td align="left" valign="top" bgcolor="#ecf0f5"  class="bodytext3">No.</td>
                        <td width="48%" align="left" valign="top" bgcolor="#ecf0f5"  class="bodytext3"><strong>Equipment Name</strong></td>
                        <td width="9%" align="left" valign="top" bgcolor="#ecf0f5"  class="bodytext3"><strong><!--Edit--></strong></td>
                      </tr>
                      <?php
					    $query1 = "SELECT * FROM `master_equipments` WHERE record_status <> 'deleted' order by auto_number";
						$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
						$sid= 0;
						...
						$equipmentname = $res1["equipment_name"];
                      ...
                      <tr <?php echo $colorcode; ?>>
					    ...
					    <a href="theatre_equipments.php?st=del&&anum=<?php echo $auto_number; ?>" onClick="return funcDeletestore('<?php echo $store;?>')">
						<img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
						<td align="left" valign="top"  class="bodytext3"><?php echo $sid; ?> </td>
                        <td width="60%" align="left" valign="top"  class="bodytext3"><?php echo $equipmentname; ?> </td>
                        <!--<td width="37%" align="left" valign="top"  class="bodytext3"><?php echo $location; ?> </td>-->
                        <td align="left" valign="top"  class="bodytext3">
						<!--<a href="edittheatre_equipment.php?st=edit&&anum=<?php echo $auto_number; ?>" style="text-decoration:none">Edit</a>-->
						</td>
                      </tr>
                      <?php
		}
                    ...
                    <tbody>
                      ...
                      <?php
				        ...
				        <tr <?php echo $colorcode; ?>>
							...
							<a href="theatre_equipments.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext3">
	                          <div align="center" class="bodytext3">Activate</div>
	                        </a></td>
	                        <td width="52%" align="left" valign="top"  class="bodytext3"><?php echo $sid; ?></td>
	                        <td width="37%" align="left" valign="top"  class="bodytext3"><?php echo $equipmentname; ?></td>
				        </tr>
				        <?php
						}
						?>

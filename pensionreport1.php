...
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   ...
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tbody>
	<tr bgcolor="#FFFFFF">
	<td colspan="30" align="center" class="bodytext3"><strong>PENSION CONTRIBUTION</strong></td>
	</tr>
	<tr bgcolor="#ecf0f5">
	...
	<tr>
	<td colspan="10" align="left" class="bodytext3"><a href="print_pensionreport1.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/pdfdownload.jpg" height="40" width="40"></a>

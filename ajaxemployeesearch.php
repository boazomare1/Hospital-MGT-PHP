...
$a_json = array();
$a_json_row = array();
$query1 = "select * from master_employee where employeename like '%$customer%' and is_user like 'yes'  order by auto_number limit 20";
...
while ($res1 = mysqli_fetch_array($exec1))
{
	...
	$a_json_row["employeecode"] = $res1employeecode;
	$a_json_row["docusername"] = $res1username;

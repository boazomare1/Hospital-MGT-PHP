...
if($radiologyname != "")
 ...
 //  mysql_query("update consultation_radiology set resultentry='$status',radiologyrefund='$status1',docnumber = '$billnumbercode',urgent='$u1',comments='$comments' where billnumber='$billnumber' and radiologyitemname='$radiologyname' and auto_number='$radno'");
...
//  $query123="update consultation_radiology set prepstatus='$status1', resultentry='$status1',radiologyrefund='$status1',docnumber='$docnumber',urgent='$u1',resulttime='".date('Y-m-d h:i:s')."' , comments='$comments',urgentstatus='0' where patientvisitcode='$visitcode' and radiologyitemname='$radiologyname' and refno='$refno' "; 
//
//mysql_query($query123) or die(mysql_error());
 
   mysqli_query($GLOBALS["___mysqli_ston"], "update consultation_radiology set  prepstatus='$status1', resultentry='$status1',radiologyrefund='$status1',docnumber = '$billnumbercode',urgent='$u1',comments='$comments' where billnumber='$billnumber' and radiologyitemname='$radiologyname' and auto_number='$radno'");
...
/* $query76 = "update master_consultation set results='completed',username='$orderedbyname',closevisit='' where patientvisitcode='$visitcode'";
   ...
   //echo "update consultation_radiology set resultentry='$status',radiologyrefund='$status1',docnumber='$docnumber',urgent='$u1',resulttime='".date('Y-m-d h:i:s')."' , comments='$comments',urgentstatus='0' where patientvisitcode='$visitcode' and radiologyitemname='$radiologyname' and refno='$refno";
  /*$query123="update consultation_radiology set prepstatus='$status', radiologyrefund='$status1',docnumber='$docnumber',urgent='$u1',comments='$comments',urgentstatus='0' where patientvisitcode='$visitcode' and radiologyitemname='$radiologyname' and refno='$refno' "; 

mysql_query($query123) or die(mysql_error());*/
  mysqli_query($GLOBALS["___mysqli_ston"], "update consultation_radiology set  prepstatus='$status',radiologyrefund='$status1',docnumber = '$billnumbercode',urgent='$u1',comments='$comments' where billnumber='$billnumber' and radiologyitemname='$radiologyname' and auto_number='$radno'");
...
<form name="frmsales" id="frmsales" method="post" action="externalradiologyprepentry.php" onKeyDown="return disableEnterKey(event)" enctype="multipart/form-data">
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$sno = '';
			$totalamount=0;			
			$query61 = "select * from consultation_radiology where billnumber='$billnumber' and resultentry='pending' and prepstatus='pending'";
...
?>
  <tr>
		...
		<td class="bodytext31" valign="center"  align="left"><div align="center">
        <input type="checkbox" name="ref[<?php echo $sno; ?>]" class="ref[]" id="ref<?php echo $sno; ?>"value="<?php echo $radautono; ?>" onClick="return checkboxcheck1('<?php echo $sno; ?>')"/></div></td>
          <td class="bodytext31" valign="center"  align="left"><div align="center" class="checkcomment">
			  <textarea name="comments[<?php echo $sno; ?>]" class="comments[]" id="comments<?php echo $sno; ?>" style="display:none"> </textarea></div></td>
           <td class="bodytext31" valign="center"  align="left"><div align="center">

...
header('Content-Disposition: attachment;filename="oprevenuereport_cash_pharmacy.xls"');
    ...
    <td width="99%" valign="top">
      ...
      <tr>
        ...
        <td>
          ...
          <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="" cellspacing="0" cellpadding="4" width="900" align="left" border="1">
          ...
          <tbody>
            ...
            <tr>
             ...
             <td colspan="12" bgcolor="#ecf0f5" class="bodytext3"><strong>OP Revenue &nbsp; From &nbsp;<?php echo $transactiondatefrom; ?> To <?php echo $transactiondateto; ?></strong></td>
              ...
              <tr>
              	  ...
              	  <td align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>S.No</strong></td>
				  
				    <td align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Bill Number</strong></td>

                  <td  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Date</strong></td>

                  <td align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Patient Code</strong></td>

                  <td  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Patient Visitcode</strong></td>

                  <td  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Patient Name</strong></td>

                  <td  align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Amount</strong></td>

                  <td  align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Location Name</strong></td>
			...
			$query1 = "select patientcode,patientname,fxamount,billdate,locationname,patientvisitcode,billnumber from billing_paynowpharmacy where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')

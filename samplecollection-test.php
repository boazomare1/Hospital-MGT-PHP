    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="drugs" action="samplecollection-test.php" method="post" onKeyDown="return disableEnterKey()" onSubmit="return validcheck()">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" 
            align="left" border="0">
      <tbody id="foo">
        <tr>
          <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>View Sample Collection</strong></td>
...
$entrywork = 'Pending';
			...
			<!--	<td align="left" valign="center"  
				...
				if($r == 0) { ?>
              	 <td align="left" valign="center"  
                class="bodytext31"><div align="left"><a href="labresultentry.php?patientcode=<?php echo $regno; ?>&&visitcode=<?php echo $visitno; ?>&&docnumber=<?php echo $docnumber; ?>&&sampleid=<?php echo $sampleid; ?>&&q_itemcode=<?php echo $itemcode; ?>"><strong>Enter</strong></a></div></td>
				<?php } else { ?>
				<td align="left" valign="center"  
...
{			$warddate1="select ward from master_ward where auto_number in(select ward from ip_bedtransfer where patientcode='$regno' and visitcode='$visitno' and recordstatus NOT IN ('discharged','transfered') )";
			...
			-->
				...
				if($r == 0) { ?>
              	 <td align="left" valign="center"  
                class="bodytext31"><div align="left"><a href="iplabresultentry.php?patientcode=<?php echo $regno; ?>&&visitcode=<?php echo $visitno; ?>&&docnumber=<?php echo $docnumber; ?>&&sampleid=<?php echo $sampleid; ?>&&q_itemcode=<?php echo $itemcode; ?>"><strong>Enter</strong></a></div></td>
				<?php } else { ?>
				<td align="left" valign="center"  
                class="bodytext31"><div align="left"><img src="images/plus.jpg" width="20" height="20" onClick="javascript: $('#SUB<?php echo $sno; ?>').toggle();"></div></td>
...
?>   
	  ...
	  <td width="241"  align="left" valign="center" class="bodytext31">
	   <input type="hidden" name="frmflag2" value="frmflag2" />
	    ...
	    <input type="submit" name="submit" value="Submit" onClick="return remark();"></td>
	  </tr>
	  </form>
      <tr>
        <td>&nbsp;</td>

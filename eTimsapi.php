...
//$etims_url='http://localhost:8088/trnsSales/saveSales';
//$etims_url='https://etims-api-sbx.kra.go.ke/etims-api/saveTrnsSalesOsdc';
//$etims_barcode_url='https://etims-sbx.kra.go.ke/common/link/etims/receipt/indexEtimsReceiptData?Data=P051521001';
//$etims_barcode_url='https://etims.kra.go.ke/common/link/etims/receipt/indexEtimsReceiptData?Data=';
$j=1;



if($res11billingdatetime>='2024-04-01')
{
...
if($receipt_no!='')
{
if($source_from=='paylater_detailed')
{
?>

<tr>

    <td  class="bodytext31"><?php echo $auto_number; ?> <br/> <?php echo $receipt_no; ?></td>
   <?php
include 'phpqrcode/qrlib.php';
		 $text = $etims_barcode_url.$etims_rcptSign;
		QRcode::png($text, 'qrcodes/image.png');
		?> 
    <td align="left" colspan="5" width="200"  class="bodytext30" > <img src="qrcodes/image.png" alt="" style="height:65px"></td>
...
else if($source_from=='ipfinal')
{
    ...
    <tr> 
            ...
            <td  width="450" class="bodytext31" align="left"></td> 
...
<tr>
			<td  width="200" class="bodytext31" align="right" ><?php echo $auto_number; ?> <br/> <?php echo $receipt_no; ?></td>
...
include 'phpqrcode/qrlib.php';
		...
		?> 
			...
			<td width="190" align="left" class="bodytext30"><img src="qrcodes/image.png" alt="" style="height:65px"></td>
</tr>
	
   
<?php
}
else if($source_from=='debitnote')
{
...
else
{
    ...
    <td  class="bodytext31" align="center"><?php echo $auto_number; ?> <br/> <?php echo $receipt_no; ?></td>
   <?php
include 'phpqrcode/qrlib.php';
		$text = $etims_barcode_url.$etims_rcptSign;
		QRcode::png($text, 'qrcodes/image.png');
		?> 
    <td align="left" width="200"  class="bodytext30" > <img src="qrcodes/image.png" alt="" style="height:65px"></td>

...
header('Content-Disposition: attachment;filename="oprevenuereport_cash_consultation.xls"');
   ...
   <td width="99%" valign="top">
      ...
      <tr>
        ...
        <td>
          ...
          <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" cellspacing="0" cellpadding="4" width="1100" align="left" border="1">

          <tbody>
            <tr>

             <td colspan="11"   class="bodytext3"><strong>OP Revenue &nbsp; From &nbsp;<?php echo $transactiondatefrom; ?> To <?php echo $transactiondateto; ?></strong></td>
              ...
              <tr>
              	  ...
              	  <td width="3%" align="left" valign="center"   class="bodytext31"><strong>S.No</strong></td>

                  <td width="8%" align="left" valign="center"   class="bodytext31"><strong>Date</strong></td>
				  
				    <td width="8%" align="left" valign="center" class="bodytext31"><strong>Bill Number</strong></td>

                  <td width="8%" align="left" valign="center"   class="bodytext31"><strong>Reg.No</strong></td>

                  <td width="8%" align="left" valign="center"   class="bodytext31"><strong>Visit No</strong></td>

                  <td width="16%" align="left" valign="center"   class="bodytext31"><strong>Patient Name</strong></td>
                  <td width="16%" align="left" valign="center"   class="bodytext31"><strong>Doctor</strong></td>
                  <td width="9%" align="right" valign="center"   class="bodytext31"><strong>Bill Amt</strong></td>
                  <td width="4%" align="right" valign="center"   class="bodytext31"><strong>Dr.Share%</strong></td>
                  <td width="8%" align="right" valign="center"   class="bodytext31"><strong>Dr.Share</strong></td>

                   <td width="8%" align="right" valign="center"   class="bodytext31"><strong>Hosp.Share</strong></td>
                  <td width="12%" align="right" valign="center"   class="bodytext31"><strong>Location Name</strong></td>
			...
			$query1 = "select patientcode,patientname,consultation,billdate,locationname,patientvisitcode,doctorname,consultation_percentage,sharingamount,billnumber as billnumber from billing_consultation where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')

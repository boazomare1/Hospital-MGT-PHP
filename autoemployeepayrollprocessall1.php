...
$searchyear = $searchyear1[1];
	...
	$totalamount = '0.00';
	$query2 = "select b.bankname, b.accountnumber, a.employeecode as employeecode, a.employeename as employeename, a.departmentname as departmentname, a.payrollstatus as payrollstatus, a.dateofjoining as doj, b.dateofbirth as dob from master_employee AS a JOIN master_employeeinfo AS b ON (a.employeecode = b.employeecode) where a.employeecode <> '' group by a.employeecode order by cast(b.payrollno as unsigned) asc";
	...
	{	
		...
		$payrollstatus1 = strtoupper($payrollstatus);
		
		if($res777employeecode != '' && $assignmonth != '' && $payrollstatus1 != 'INACTIVE')
		{
		$res2employeename = $res2['employeename'];

		
				$query_in = "INSERT INTO `details_employeepayroll`(`employeecode`, `employeename`, `paymonth`, `bankname`, `accountnumber`, `locationname`, `locationcode`, `ipaddress`, `username`, `updatedatetime`) VALUES('$employeecode','$employeename','$assignmonth','$bankname','$accountnumber','$locationname','$locationcode','$ipaddress','$username','$updatedatetime')";

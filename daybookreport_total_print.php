...
<tr>
        ...
        <td><table id="AutoNumber3" >
          ...
          <tbody>
            ...
            <tr>
            	<td colspan="10" align="center">Day Book Report From <?=$_GET['ADate1']; ?> To <?=$_GET['ADate2']; ?></td>

              <!-- <td width="" bgcolor="#cccccc" class="bodytext31">&nbsp;</td> -->

              <!-- <td colspan="10" bgcolor="#cccccc" class="bodytext31"> -->

                <?php

				if (isset($_GET["cbfrmflag1"])) { $cbfrmflag1 = $_GET["cbfrmflag1"]; } else { $cbfrmflag1 = ""; }
...

				{
					...
					$cbcustomername = $_GET['cbcustomername'];

					//$patientfirstname =  $cbcustomername;

					

					$customername = $_GET['cbcustomername'];

					if (isset($_GET["cbbillnumber"])) { $cbbillnumber = $_GET["cbbillnumber"]; } else { $cbbillnumber = ""; }

					//$cbbillnumber = $_GET['cbbillnumber'];

					if (isset($_GET["cbbillstatus"])) { $cbbillstatus = $_GET["cbbillstatus"]; } else { $cbbillstatus = ""; }

					//$cbbillstatus = $_GET['cbbillstatus'];

					

					$transactiondatefrom = $_GET['ADate1'];

					$transactiondateto = $_GET['ADate2'];
            ...
            <tr bgcolor="#9999FF">
              ...
              <td colspan="10"  align="left" valign="center" bgcolor="#cccccc" class="bodytext31"><strong><?php echo strtoupper ($res21username);?></strong></td>
...

		{
            ...
            <tr >
              ...
              <td class="bodytext31" valign="center"  align="right">
				...
				<td class="bodytext31" valign="center"  align="center"><?php echo $res37['chequenumber']; ?></td>

...
// Get pending IP radiology consultations count
$querynw1 = "select * from ipconsultation_radiology where resultentry='pending' and locationcode='$locationcode' and paymentstatus = 'pending' group by patientvisitcode order by consultationdate DESC";
...
<head>
    ...
    <title>IP Amend Radiology Pending - MedStar</title>
...
body {
        ...
        .action-btn.radiology { 
            background: #9b59b6; 
            color: white; 
        }
        
        .action-btn.radiology:hover { 
            background: #8e44ad; 
            transform: scale(1.1); 
        }
...
<body>
    ...
    <nav class="nav-breadcrumb">
        ...
        <span>→</span>
        <span>IP Amend Radiology Pending</span>
    </nav>
    ...
    <div class="main-container-with-sidebar">
        ...
        <main class="main-content">
            ...
            <div class="success-alert">
                ...
                <span><strong>Success!</strong> Bill Saved Successfully.</span>
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2><i class="fas fa-x-ray"></i> IP Amend Radiology Pending</h2>
                    <p>Manage and update pending IP radiology consultations and results</p>
                </div>
            ...
            <div class="search-form-section">
                <div class="search-form-header">
                    ...
                    <h3 class="search-form-title">Search IP Radiology Consultations</h3>
                </div>
                
                <form id="searchForm" name="cbform1" method="post" action="ipamendrad_pending.php">
                    <div class="form-row">
            ...
            <div class="data-table-section">
                <div class="data-table-header">
                    ...
                    <h3 class="data-table-title">Pending IP Radiology Consultations</h3>
	 ...
	 $filter_qry = "";
	 	...
	 	$filter_qry .= " and patientvisitcode ='$visitcodeget' ";
			...
			$query1 = "select * from ipconsultation_radiology where resultentry='pending' and locationcode='$searchlocationcode' and consultationdate between '$searchadate1'and '$searchadate2' $filter_qry group by patientvisitcode order by consultationdate DESC";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
                            ...
                            <tr class="<?php echo $rowClass; ?>">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="ipamendradiology.php?patientcode=<?php echo htmlspecialchars($patientcode); ?>&visitcode=<?php echo htmlspecialchars($visitcode); ?>&locationcode=<?php echo htmlspecialchars($locationcode); ?>&menuid=<?php echo $menu_id; ?>" 
			...
			<?php
                ...
                <div class="no-data-message">
                    ...
                    <p>No pending IP radiology consultations found for the selected criteria.</p>
    ...
    <!-- Modern JavaScript -->
    <script src="js/ipamendradpending-modern.js?v=<?php echo time(); ?>"></script>

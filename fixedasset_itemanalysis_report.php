    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="fixedasset_itemanalysis_report.php">
		...
		<table width="500" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td  colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>Fixed Asset - Anaylsis ItemWise</strong></td>
...
?>
          ...
          <tr <?php echo $colorcode; ?>>
             ...
             <td class="bodytext31" valign="center"  align="left"><div align="center"></div></td> 
			  ...
			  <td class="bodytext31" valign="center"  align="left">
               ...
               <td class="bodytext31" valign="center"  align="left"><div align="left"><strong></strong></div></td> 
		...
		<?php 
          ...
          <tr >
            ...
            <td colspan="4" class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left"><a href="fixedasset_itemanalysis_report_xl.php?categoryid=<?php echo $categoryid_selected ?>"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;"></a></td>

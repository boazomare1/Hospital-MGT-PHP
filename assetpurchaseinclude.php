...
$totalquantity = $totalquantity + $quantity;
	...
	if($itemname !='')
	{
			...
			discountamount, username, ipaddress, entrydate, itemtaxpercentage, itemtaxamount, itemfreequantity, itemtotalquantity,  typeofpurchase,suppliername,suppliercode,supplierbillnumber,location,locationname,coa,locationcode, asset, assetcode,itemdescription) 
			...
			'$itemtaxpercent', '$itemtaxamount', '$free', '$quantity', 'Asset','$suppliername','$suppliercode','$supplierbillno','$location','$location','$coa','$locationcode','$coaname','$coa','$itemdescription')";
		...
		username,credit,cash,subtotaldiscountamountonlyapply1,subtotaldiscountamountonlyapply2,locationcode, locationname)values('$companyanum','$billnumber','$billdate','$suppliercode', '$suppliername','$amount','$totalquantity','$ipaddress','$supplierbillno','Asset',

...

{
	...
	var url="automedicinecodesearch2_consultform.php?RandomKey="+Math.random()+"&&medicinesearch="+medicinesearch+"&&accountname="+accountname+"&&subtypeano="+subtypeano+"&&store="+store;

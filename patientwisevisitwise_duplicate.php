    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="1134">
              ...
              <form name="cbform1" method="post" action="patientwisevisitwise_duplicate.php">
            ...
            <tr>
              ...
              <td colspan="12" bgcolor="#ecf0f5" class="bodytext31">
...

				{
					...
					$urlpath = "cbcustomername=$cbcustomername&&cbbillnumber=$cbbillnumber&&locationcode1=$locationcode1&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&username=$username&&companyanum=$companyanum";//&&companyname=$companyname";
...
&nbsp;				<input type="hidden" value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" id="resetbutton22"  style="border: 1px solid #001E6A" />
			...
			$query2 = "select * from master_visitentry where locationcode='$locationcode1' and patientfullname like '%$patientfirstname%' and visitcode like '%$visitcode%' and consultationdate between '$transactiondatefrom' and '$transactiondateto' order by patientcode";
			...
			$query4 = "select * from master_accountname where locationcode='$locationcode1' and auto_number = '$res2accountname'";

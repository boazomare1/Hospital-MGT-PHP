            ...
            <tbody>
              <tr bgcolor="#011E6A">
				...
				<input type="hidden" name="mcc" id="mcc" value="<?php echo $mcc;?>">
				 <td colspan="4" align="center" valign="middle"  bgcolor="#cccccc" class="bodytext3"><strong><a target="_blank" href="emrresultsviewlist.php?patientcode=<?php echo $patientcode; ?>">EMR</a></strong></td>
...
-->
			...
			<input type='hidden' name='pkg2[]' id='pkg2'>
				 ...
				 <!--<tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext3"   onDblClick="return  funcRefferalHideView()" onClick="return funcRefferalShowView()"><span class="bodytext32"><span class="style2">Referral <img src="images/plus1.gif" width="13" height="13"  onDblClick="return  funcRefferalHideView()" onClick="return funcRefferalShowView()"> </span></span></td>
		        </tr>-->
				 <tr id="reffid">
				    <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				    <table id="presid" width="621" border="0" cellspacing="1" cellpadding="1">
				  ...
				  <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#CCCCCC" class="bodytext3"  onDblClick="return  funcExRefferalHideView()" onClick="return funcExRefferalShowView()" style="display: none"><span class="bodytext32"><span class="style2">External Referral <img src="images/plus1.gif" width="13" height="13"  onDblClick="return  funcExRefferalHideView()" onClick="return funcExRefferalShowView()"> </span></span></td>
		        </tr>
				<tr id="exreffid">

...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <table width="97%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="80%">
        <table width="600" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td width="859">
              <form name="form1" id="form1" method="post" action="requesupervisorlist.php" onSubmit="return additem1process1()">
                  <table width="860" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                       ...
                       <tr>
              <td width="127" align="left" valign="middle" bgcolor="#FFFFFF"  class="bodytext31">Request Number</td>
              <td colspan="5" bgcolor="#FFFFFF"  align="left" valign="top"  ><span class="bodytext3">
                <input name="request" type="text" id="request" value="" size="50" autocomplete="off">
              </span></td>
              </tr>
			    <tr>
               <td align="left" bgcolor="#FFFFFF" valign="middle"  class="bodytext31">User</td>
              <td colspan="5" bgcolor="#FFFFFF" align="left" valign="top"  ><span class="bodytext3">
            ...
            <td width="90" align="left" valign="middle"  class="bodytext31">Date To</td>
                       <td width="134" align="left" valign="center"  class="bodytext311"><input name="ADate2" id="ADate2" value="<?php echo date('Y-m-d'); ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
...
-->                    <input type="hidden" name="frmflag" value="addnew" />
						...
						<input  align="right" type="submit" name="Submit" value="Search" style="border: 1px solid #001E6A" /></td>
...
<tbody>
        <tr bgcolor="#011E6A">
                        <td colspan="6" bgcolor="#ecf0f5" class="bodytext31"><strong>Petty Supervisor Approval List </strong></td>
         </tr>
          <tr>
            <td  align="left" colspan="6" valign="top"  bgcolor="#ecf0f5">&nbsp;</td>
            </tr>
		<tr>
        <td width="7%" height="21" bgcolor="#ecf0f5" class="bodytext31"><strong>S.No.</strong></td>
        ...
        <td width="8%" bgcolor="#ecf0f5" class="bodytext31"><strong>Amount</strong></td>
        <td width="11%" bgcolor="#ecf0f5" class="bodytext31"><strong>Request by</strong></td>
        <td width="54%" bgcolor="#ecf0f5" class="bodytext31"><strong>Action</strong></td>
        </tr>
        <?php  
		$colorloopcount=0;
       ...
       <tr <?php echo $colorcode; ?>>
          ...
          <td align="left" valign="top"  class="bodytext31"><a href="viewpcrequest_new.php?docno=<?php echo $doc_no; ?>">View</a> </td>
        ...
        <tr bgcolor="#011E6A">
                        <td colspan="6" bgcolor="#ecf0f5" class="bodytext31"><strong>Petty Supervisor Discard List </strong></td>
         </tr>
          <tr>
            <td  align="left" colspan="6" valign="top"  bgcolor="#ecf0f5">&nbsp;</td>
            </tr>

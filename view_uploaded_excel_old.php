...
foreach($_POST['billnum2'] as $key => $value)
    ...
    {
         $query991="UPDATE excel_insurance_upload set allocate='0' where bill_no='$billnum2' and docno='$docnum'";
...
header("location:view_uploaded_excel.php?docno=$docnum&&searchaccount=$searchaccount_get&&searchdocno=$searchdocno&&fromdate=$fromdate&&todate=$todate");
...
foreach($_POST['billnum'] as $key => $value)
    ...
    {
         $query991="UPDATE excel_insurance_upload set allocate='1' where bill_no='$billnum' and docno='$docnum1'";
         $exec991=mysqli_query($GLOBALS["___mysqli_ston"], $query991);
    ...
    transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,docno,billbalanceamount,recordstatus,receivableamount,paymenttype,subtype,username,accountnameano,accountnameid,locationcode,locationname,subtypeano,accountcode,currency,fxrate,fxamount) 
    ...
    '$transactionmodule','$name','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$docnum1','$balamount','allocated','$receivableamount','$patienttype11','$patientsubtype11','$username','$accountnameano','$accountnameid','$res12locationcode','$res12location','$subtypeano','$accountnameid','$currency','1','$adjamount')";
    ...
    '$remarks', '$transactionmodule','$name','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$docnum1','$balamount','allocated','$receivableamount','$patienttype11','$patientsubtype11','$username','$accountnameano','$accountnameid','$res12locationcode','$res12location','$subtypeano','$accountnameid','$currency','1','$adjamount')";
    ...
    $query45 = "UPDATE master_transactionpaylater set recordstatus='allocated',transactionamount='$restotalaadjamount',fxamount = '$restotalaadjamount',cashamount='$restotalaadjamount',billbalanceamount='$balamount',transactiondate='$updatedatetime',username='$username' where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1'";
    ...
    $query45 = "update master_transactionpaylater set recordstatus='allocated',transactionamount='$restotalaadjamount',fxamount = '$restotalaadjamount',onlineamount='$restotalaadjamount',billbalanceamount='$balamount',transactiondate='$updatedatetime',username='$username' where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1'";
    ...
    $query45 = "update master_transactionpaylater set recordstatus='allocated',transactionamount='$restotalaadjamount',fxamount = '$restotalaadjamount',chequeamount='$restotalaadjamount',billbalanceamount='$balamount',transactiondate='$updatedatetime',username='$username' where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1'";
    ...
    $query45 = "update master_transactionpaylater set recordstatus='allocated',transactionamount='$restotalaadjamount',fxamount = '$restotalaadjamount',writeoffamount='$restotalaadjamount',billbalanceamount='$balamount',transactiondate='$updatedatetime',username='$username' where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1'";
  ...
  header("location:view_uploaded_excel.php?docno=$docnum1&&searchaccount=$searchaccount_get&&searchdocno=$searchdocno&&fromdate=$fromdate&&todate=$todate");
...
$query11 = "select sum(fxamount) as total11 from master_transactionpaylater where docno='$docno' and recordstatus='allocated'";
    ...
    <table style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="21" bgcolor="#ecf0f5" class="bodytext311"><strong>Pending Invoices</strong></td>
        ...
        <input type="hidden" name="receivableamount1" id="receivableamount" value="<?php echo $receivableamount; ?>" size="6" class="bal">
            ...
            <tr bgcolor="#011E6A">
              ...
              <td width="" align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Upload ID</strong></div></td>
...
// pending
         ...
         $not_find="";
            $docno_get=$_GET['docno'];
             $query = "SELECT * FROM `excel_insurance_upload` WHERE docno='$docno_get' and status='1' and location='$locationcode' and allocate='0'";
            $exec = mysqli_query($GLOBALS["___mysqli_ston"], $query) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
      ...
      $query1 = "SELECT patientcode, patientname, visitcode, totalamount, accountname, subtype, accountnameid  FROM `billing_paylater` where billno='$bill_no' ";
      ...
      $res1 = mysqli_fetch_array($exec1);
       $patientcode=$res1['patientcode'];
        ...
        // }
           ...
           $query2_ipfinal = " SELECT patientcode, patientname, visitcode, totalamountuhx, accountname, subtype, accountnameid FROM `master_transactionip` where `billnumber`='$bill_no'";
         ...
         if(($x=="0" and $y=="0")){
            $query1 = "SELECT patientcode, patientname, visitcode, transactionamount, accountname, subtype, accountcode  FROM `master_transactionpaylater` where billnumber='$bill_no' and subtypeano='$subtypeano_docno' ";
                    $exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
                    $x=mysqli_num_rows($exec1);
                    // if($x>0){
                    $res1 = mysqli_fetch_array($exec1);
    ...
    $doctorname='';
        ?>
        <tr  <?php  if(($x=="0" and $y=="0") or (round($allocation_amount, 2) > round($pending_allocated, 2)) or ($not_match!=0) or  ($subtypeid_docno!=$subtype_id_main)) { echo $not_find; }else{ echo $colorcode; } ?>>
            ...
            <input type="hidden" name="patientcode[]" id="patientcode<?php echo $sno; ?>" value="<?php echo $patientcode; ?>">
              ...
              <input type="hidden" class="dis" name="discount[]"  value="<?=$discount_only;?>" size="7" >
                          ...
                          <!-- <td class="bodytext31" valign="center"  align="left">
                             ...
                             <input type="checkbox" <?php if(($x=="0" and $y=="0") or $not_match!=0 or  ($subtypeid_docno!=$subtype_id_main)) { echo "disabled=''"; }else{ echo 'checked=""';  } ?> name="ack[]" class="chkalloc" id="acknowpending<?php echo $sno; ?>" value="<?php echo $bill_no; ?>" ></td>
               ...
               <td class="bodytext31" valign="center"  align="left"><div class="bodytext31"><?php echo $username; ?></div></td>
                ...
                <td class="bodytext31" valign="left"  align="left"><div class="bodytext31"><?php
                     ...
                     // }
                     // elseif($subtypeid_docno!=$subtype_id_main){ echo " The SubType Miss Matched"; }
                     // elseif($not_match!=0){ echo " The Invoice amount Not Matched"; }
                     //  elseif(round($allocation_amount, 2) > round($pending_allocated, 2)){ echo " The Amount Exceed "; }
...
<tr style="background-color: #FF9900;" >
                <td colspan="10" class="bodytext31" valign="center"  align="center"></td>
    ...
    <table style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="20" bgcolor="#ecf0f5" class="bodytext311"><strong>Allocated Invoices</strong></td>
        ...
        <input type="hidden" name="receivableamount1" id="receivableamount" value="<?php echo $receivableamount; ?>" size="6" class="bal">
            ...
            <tr bgcolor="#011E6A">
              ...
              <td width="" align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Doc No</strong></div></td>
              <!-- <td width="" align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Upload ID</strong></div></td> -->
              <td width="" align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><div align="left"><strong></strong></div></td>
         ...
         $not_find="";
            $docno_get=$_GET['docno'];
             $query = "SELECT * FROM `excel_insurance_upload` WHERE docno='$docno_get' and status='1' and location='$locationcode' and allocate='1' group by bill_no";
            $exec = mysqli_query($GLOBALS["___mysqli_ston"], $query) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
            $num2 = mysqli_num_rows($exec);
            while($res = mysqli_fetch_array($exec)){
        ...
        $allocation_amount1 += $allocation_amount;
                $username = ucwords($res['username']);
                 ...
                 $query2 = "SELECT sum(denied) as denied1, sum(discount) as discount1, sum(amount) as amount12 FROM `excel_insurance_upload` WHERE docno='$docno' and  bill_no='$bill_no' and status='1' and location='$locationcode' and allocate='1'";
            $exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
            $res2 = mysqli_fetch_array($exec2);
            $total_denied = $res2['denied1'];
            $total_discount = $res2['discount1'];
            $total_amount12 = $res2['amount12'];

            $total_denied1 += $total_denied;
            $total_discount1 += $total_discount;
            $total_amount121 += $total_amount12;
      ...
      $res1 = mysqli_fetch_array($exec1);
       $patientcode=$res1['patientcode'];
        ...
        // }
          ...
          $query_allocated_amount = "SELECT sum(fxamount) as amount, sum(discount) as discount from master_transactionpaylater where docno='$docno' and recordstatus='allocated' and billnumber='$bill_no'";
         // $query_allocated_amount = "SELECT * FROM `excel_insurance_upload` WHERE bill_no='$bill_no' and status='1' and location='$locationcode'";
      $exec_allocated_amount = mysqli_query($GLOBALS["___mysqli_ston"], $query_allocated_amount) or die ("Error in Query_allocated_amount".mysqli_error($GLOBALS["___mysqli_ston"]));
      while($res_allocated_amount = mysqli_fetch_array($exec_allocated_amount)){
        $allocated_amount=$res_allocated_amount['amount']+$res_allocated_amount['discount'];
        $allocate_discount = $res_allocated_amount['discount'];
        $allocate_discount1 += $res_allocated_amount['discount'];

      }

      $query_allocated_amount_old = "SELECT sum(fxamount) as amount, sum(discount) as discount from master_transactionpaylater where recordstatus='allocated' and docno!='$docno' and billnumber='$bill_no'";
        ...
        <tr  <?php if(($x=="0" and $y=="0") or $not_match!=0) { echo $not_find; }else{ echo $colorcode; } ?>>
          ...
          <!--   <input type="hidden" name="patientcode[]" id="patientcode<?php echo $sno; ?>" value="<?php echo $patientcode; ?>">
              ...
              <input type="hidden" name="billnum2[]" value="<?php echo $bill_no; ?>">
                         ...
                         <!--  <td><div align="center"><input type="checkbox" name="acknow1[]" id="acknow1<?php echo $sno1; ?>" value="<?php echo $bill_no; ?>" onClick="updatebox1('<?php echo $sno1; ?>','<?php echo $allocation_amount; ?>','<?php echo $num2; ?>')"></div></td>
                            -->
               ...
               <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php echo $total_discount; ?></div></td>
               <!-- $allocate_discount.'-'. -->

               <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php echo $total_denied; ?></div></td>

               <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php echo $total_amount12; ?></div></td>
...
<tr style="background-color: #FF9900;" >
                ...
                <td class="bodytext31" valign="center"  align="left" ><strong><?="Total";?></strong></td>
                <td class="bodytext31" valign="center"  align="right" ><strong><?=number_format($invoice_amount1,2,'.',',');?></strong></td>
                <!-- <td class="bodytext31" valign="center"  align="right" ><strong><?php //number_format($allocate_discount1,2,'.',','); ?></strong></td> -->
                <td class="bodytext31" valign="center"  align="right" ><strong><?=number_format($total_discount1,2,'.',',');?></strong></td>
                <td class="bodytext31" valign="center"  align="right" ><strong><?=number_format($total_denied1,2,'.',',');?></strong></td>
                <td class="bodytext31" valign="center"  align="right" ><strong><?=number_format($total_amount121,2,'.',',');?></strong></td>
                <td class="bodytext31" valign="center"  align="right" ></td>
        <td class="bodytext31" valign="center"  align="right" ><strong><?=number_format($total_amount_f_total,2,'.',',');?></strong></td>
   ...
   <tr>
             ...
             <!--  <?php 
              ...
              $query27 = "select sum(transactionamount) as amount from master_transactionpaylater where docno='$docno' and recordstatus='allocated'";
            ...
            <td class="bodytext311" valign="right" bordercolor="#f3f3f3" align="right"><input type="text" name="totaladjamt1" id="totaladjamt1" size="7" readonly="" style="text-align: right;"></td> -->

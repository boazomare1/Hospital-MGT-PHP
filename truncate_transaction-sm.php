...
/* 
	...
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1);		$query1 = "truncate table hdtriage_observations";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1);	$query1 = "truncate table hd_dialysis_prescription";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1);		$query1 = "truncate table hd_labrequests";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1);		$query1 = "truncate table master_hdtriage";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1);	
	$query1 = "truncate table posthd_medications";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1);

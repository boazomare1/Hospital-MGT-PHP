...
<table border=""  align="center" cellpadding="5" cellspacing="">
	...
	<tr>
		...
		<td  align="center"   class="bodytext4 border">Tax %</td>
...
//			$res11quantityperpackage= $res11['quantityperpackage'];
    ...
    <?php 
		...
		$grandtotalamount = $taxamount + $grandtotalamount - $totaldiscount;
    ...
    <tr>
    	<td width="1000" class="bodytext3" colspan="11"><strong>Amount In Words: </strong><?php echo str_replace('Kenya Shillings','',$totalamountinwords); ?></td>
    </tr>
    <tr>
    	<td width="1000" class="bodytext3" colspan="11"><strong>Prepared By&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong>&nbsp;<?php echo $username; ?></td>
    </tr>
</table>
</page>
<!----------------------------------------------unwanted------------------------------------>

...
$st = 0;
	...
	if(count($suppliercode)>0){
		...
		foreach($suppliercode as $k=>$v){
			 ...
			 $chkSql = "select * from lab_supplierlink where suppliercode='$suppliercodes' and itemcode='$itemcode' and supplier_autoid='$supautocodes' and status!='deleted'";
			 ...
			 if($numSup==0){ 
				...
				mysqli_query($GLOBALS["___mysqli_ston"], "insert into lab_supplierlink(itemcode,suppliercode,rate,updateddate,username,supplier_autoid,tat)values('$itemcode','$suppliercodes','$rates','$updatedatetime','$username','$supautocodes','$tat')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
        ...
        header("location:popup_labmapmultiple.php?item=$itemcode&st=1");
...
$st = 0;
	...
	if(count($suppliercode)>0){
		...
		foreach($suppliercode as $k=>$v){
			 ...
			 $chkSql = "select * from lab_supplierlink where auto_number='$suppliercodes'";
			 ...
			 if($numSup>0){ 
				 ...
				 if($fav==$suppliercodes)
				    ...
				    mysqli_query($GLOBALS["___mysqli_ston"], "update lab_supplierlink set rate='$rates',fav_supplier='1',tat='$tat' where auto_number='$suppliercodes'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));

				 else

					 mysqli_query($GLOBALS["___mysqli_ston"], "update lab_supplierlink set rate='$rates',fav_supplier='0',tat='$tat' where auto_number='$suppliercodes'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
        ...
        header("location:popup_labmapmultiple.php?item=$itemcode&st=2");
...
$st = 0;
			 ...
			 $chkSql = "select * from lab_supplierlink where auto_number='$id'";
			 ...
			 if($numSup>0){ 
				...
				mysqli_query($GLOBALS["___mysqli_ston"], "delete from lab_supplierlink where auto_number='$id'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));

				header("location:popup_labmapmultiple.php?item=$itemcode&st=3");
...
function addSupplier(){
   ...
   var itemname = $("#supname").val();
	...
	td1.style.backgroundColor = "#ecf0f5";
	...
	text11.style.backgroundColor = "#ecf0f5";
	...
	text111.style.backgroundColor = "#ecf0f5";
	...
	td8.style.backgroundColor = "#ecf0f5";
	...
	text8.style.backgroundColor = "#ecf0f5";
	...
	td9.style.backgroundColor = "#ecf0f5";
	...
	text9.style.backgroundColor = "#ecf0f5";
	...
	td10.style.backgroundColor = "#ecf0f5";
...
function del(id,item){
	...
	if (r == true) {
	  ...
	  window.location='popup_labmapmultiple.php?cnfform2=cnfform2&item='+item+'&id='+id;
...
<form name='form1' id='form1' action='popup_labmapmultiple.php?item=<?php echo $itemcode;?>' method='post' onSubmit="return valid();">
...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
	...
	$query1 = "select itemcode,itemname,rateperunit from master_lab where itemcode ='".$itemcode."' and status <> 'deleted' ";
	...
	?>
      ...
      <tr bgcolor="#011E6A">
        ...
        <td width="20%" bgcolor="#ecf0f5" class="bodytext3"><strong>Add Suppliers for "<?php echo $res1['itemname'];?>(<?php echo $res1['itemcode'];?>)"</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Rate "<?php echo number_format($res1['rateperunit'],2);?>"</strong></td>
	  ...
	  <tr >
        ...
        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3" style='red' align='center'><strong>Invalid item code.</strong></td>
...
<form name='form2' id='form2' action='popup_labmapmultiple.php?item=<?php echo $itemcode;?>' method='post' onSubmit="return valid2();">

<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">

    <tr bgcolor="#011E6A">

		<td bgcolor="#ecf0f5" class="bodytext3" colspan='7'>
	...
	<tr bgcolor="#011E6A">
		...
		<td width="15%" bgcolor="#ecf0f5" class="bodytext3"><strong>Supplier Code</strong></td>

		<td width="14%" bgcolor="#ecf0f5" class="bodytext3"><strong>Supplier Name</strong></td>

		<td width="24%" bgcolor="#ecf0f5" class="bodytext3"><strong>Rate</strong></td>
		
		<td width="14%" bgcolor="#ecf0f5" class="bodytext3"><strong>TAT</strong></td>

		<td width="4%" bgcolor="#ecf0f5" class="bodytext3"><strong>Fav.</strong></td>
	...
	<tr <?php echo $colorcode; ?> id='trEx<?php echo $res2['supplier_autoid']; ?>'>
	 ...
	 <tr bgcolor="#011E6A">
		...
		<td width="7%" bgcolor="#ecf0f5" class="bodytext3"></td>

		<td width="14%" bgcolor="#ecf0f5" class="bodytext3"></td>

		<td width="24%" bgcolor="#ecf0f5" class="bodytext3"></td>

...
$stringbuild1 = "";
 ...
 $query1 = "select * from master_ippackage where status <> 'Deleted' and locationcode='$res1locationanum' order by packagename";
$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
while ($res1 = mysqli_fetch_array($exec1))
{
	//$res1autonumber = $res1['auto_number'];
	$res1itemcode=$res1['auto_number'];
	$res1itemname = $res1['packagename'];
...
$filefolder = 'js';
$filename = 'autocomplete_packages1.'.'js';

      ...
      <tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$services_condition = "";
			$servicescode_arr = array();
			$queryservice = "select servicescode from master_ippackage";
			$execservice = mysqli_query($GLOBALS["___mysqli_ston"], $queryservice) or die ("Error in Query_pw".mysqli_error($GLOBALS["___mysqli_ston"]));
			$numrows_serv = mysqli_num_rows($execservice);
			if($numrows_serv)
			{
				while($servicesres = mysqli_fetch_array($execservice))
				{
					$servicecode = trim($servicesres['servicescode']);
					if($servicecode !="")
					{
						$servicescode_arr[] = $servicecode;
					}
				}
			}
			if(count($servicescode_arr) > 0)
			{
				$servceidsstr = implode(",",$servicescode_arr);
				$servceidsstr = "'" . implode ( "', '", $servicescode_arr ) . "'";
				
				if($servceidsstr !="")
				{
					$services_condition = " and servicesitemcode NOT IN(".$servceidsstr.") ";
				}	
			}
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			  ...
			  $query1 = "select * from consultation_services where locationcode = '".$locationcode."' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and (paymentstatus='completed' OR paymentstatus='paid') and billtype='PAY NOW' and process='pending' and servicerefund <> 'completed' and wellnessitem <> '1' and consultationdate between '$fromdate' and '$todate' $services_condition $services_linked_condition group by patientvisitcode order by consultationdate,auto_number";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
		  ...
		  // if($num822 == 0)
           ...
           <table width='80%' align='left'>
			...
			$totalamount=0;
			 ...
			 $query61 = "select * from consultation_services where paymentstatus='completed' and patientcode = '$res1patientcode' and patientvisitcode = '$res1visitcode' and process='pending' and servicerefund <> 'completed' and wellnessitem <> '1' and (billtype='PAY NOW' or (billtype='PAY LATER' )) $services_condition $services_linked_condition order by consultationdate,auto_number";
  ...
  <tr>
        ...
        <td class="bodytext31" valign="center"  align="left" 
               ...
               <td class="bodytext31" valign="center" align="left" > 
                ...
                <div align="left"><?php if($res1patientcode!='walkin'){?><a href="processservice.php?patientcode=<?php echo $res1patientcode; ?>&&visitcode=<?php echo $res1visitcode; ?>&&refnumber=<?php  echo $refno; ?>&&servicesitemcode=<?php  echo $service_item_code; ?>"><strong>PROCESS</strong></a><?php }else{?><a href="externalprocessservice.php?billnumber=<?php echo $billnumber; ?>"><strong>PROCESS</strong></a><?php }?></div></td>
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			  ...
			  $query2 = "select * from consultation_services where locationcode = '".$locationcode."' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and paymentstatus='completed' and billtype='PAY LATER' and process='pending' and servicerefund <> 'completed' and consultationdate between '$fromdate' and '$todate' and wellnessitem <> '1' $services_condition $services_linked_condition  group by patientvisitcode order by consultationdate ,auto_number";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
		  ...
		  // if($num822 == 0)
           ...
           <table width='80%' align='left'>
			...
			$totalamount=0;
			  ...
			  $query61 = "select * from consultation_services where paymentstatus='completed' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode' and process='pending' and servicerefund <> 'completed' and wellnessitem <> '1' and (billtype='PAY NOW' or (billtype='PAY LATER' )) $services_condition $services_linked_condition order by consultationdate ,auto_number";
  ...
  <tr>
        ...
        <td class="bodytext31" valign="center"  align="left" 
               ...
               <td class="bodytext31" valign="center" align="left" > 
                ...
                <div align="left"><?php if($res2patientcode!='walkin'){?><a href="processservice.php?patientcode=<?php echo $res2patientcode; ?>&&visitcode=<?php echo $res2visitcode; ?>&&refnumber=<?php  echo $refno; ?>&&servicesitemcode=<?php  echo $service_item_code; ?>"><strong>PROCESS</strong></a><?php }else{?><a href="externalprocessservice.php?billnumber=<?php echo $billnumber; ?>"><strong>PROCESS</strong></a><?php }?></div></td>
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			 ...
			 $query2 = "select * from consultation_services where locationcode = '".$locationcode."' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and paymentstatus='pending' and servicerefund <> 'completed' and billtype='PAY LATER' and approvalstatus!='0' and process='pending' and consultationdate between '$fromdate' and '$todate' and wellnessitem <> '1' group by billnumber order by consultationdate,auto_number";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
		  ...
		  // if($num822 == 0)

		   {
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			 ...
			 $query2 = "select * from consultation_services where locationcode = '".$locationcode."' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and paymentstatus='completed' and servicerefund <> 'completed' and billtype='PAY LATER' and process='pending' and consultationdate between '$fromdate' and '$todate' and wellnessitem <> '1' group by patientvisitcode order by consultationdate ,auto_number ";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
		  ...
		  // if($num822 == 0)
           ...
           <table width='100%'>
			...
			$totalamount=0;
			   ...
			   $query61 = "select * from consultation_services where paymentstatus='completed' and patientcode = '$res1patientcode' and patientvisitcode = '$res1visitcode' and process='pending' and servicerefund <> 'completed' and wellnessitem <> '1' and (billtype='PAY NOW' or (billtype='PAY LATER' )) order by consultationdate ,auto_number";
  ...
  <tr>
        ...
        <td class="bodytext31" valign="center"  align="left" 
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			 ...
			 $query2 = "select * from consultation_services where locationcode = '".$locationcode."' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and paymentstatus='completed' and billtype='PAY LATER' and process='pending' and servicerefund <> 'completed' and consultationdate between '$fromdate' and '$todate'  and wellnessitem <> '1' group by patientvisitcode order by consultationdate ,auto_number";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//

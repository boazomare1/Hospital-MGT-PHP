  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <td>&nbsp;
			...
			<tr>
              <td bgcolor="#ecf0f5" class="bodytext3" colspan="8"><strong>NM Goods Received Note</strong></td>
...
?>
  <tr>
	  ...
	  <table width="716">
     <tr>
	 <td width="20" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Total Purchase Cost</td><input type="hidden" name="totalpurchaseamount1" id="totalpurchaseamount" size="10" readonly="readonly" value="<?php echo $grandtotalamount; ?>">
	   <td width="111" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><input type="text" name="totalpurchaseamount" id="totalpurchaseamount" size="10" readonly="readonly" value="<?php echo number_format($grandtotalamount,2,'.',','); ?>"></td>

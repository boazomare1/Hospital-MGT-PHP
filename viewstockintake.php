  ...
  <tr>
   ...
   <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
        <td width="860">
              <form name="cbform1" method="post" action="viewstockintake.php">
          ...
          <tbody>
            <tr>
              ...
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext31">
                ...
                <div align="left"><strong>View Stock Intake</strong></div></td>
              </tr>
            <tr>
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			 $query1 = "select * from bloodstock where  locationcode='".$locationcode."' AND  transactiondate between '$fromdate' and '$todate' group by docno  order by transactiondate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res1 = mysqli_fetch_array($exec1))
			{
			$docno = $res1['docno'];
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><?php echo $account; ?></td>
			   <td class="bodytext31" valign="center"  align="left"><?php echo $subtypename; ?></td><?php */?>
             
                <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a target="_blank" href="viewstockintake1.php?docno=<?php echo $docno; ?>"><strong>View</strong></a>
				</div></td>
              </tr>
			<?php
			}    

...
<head>
    ...
    <title>Asset Entry List - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/assetentrylist-modern.css?v=<?php echo time(); ?>">
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2>Asset Entry List</h2>
                    <p>View and manage all registered assets in the system.</p>
                </div>
                <div class="page-header-actions">
                    ...
                    <a href="asset_newentry.php" class="btn btn-primary">
            ...
            <div class="search-filter-section">
                ...
                <form method="get" action="assetentrylist.php" class="search-filter-form">
                    <div class="form-row">
            ...
            <div class="assets-table-section">
                <div class="assets-table-header">
                    <i class="fas fa-table assets-table-icon"></i>
                    <h3 class="assets-table-title">Asset List</h3>
                        ...
                        <tbody id="assetsTableBody">
                            ...
                            while($res34 = mysqli_fetch_array($exec34)) {
                                ...
                                <tr>
                                    ...
                                    <td class="total-cost">
                                        <span class="currency-amount"><?php echo number_format($totalamount, 2); ?></span>
                                    </td>
                                    <td class="actions">
    ...
    <!-- Modern JavaScript -->
    <script src="js/assetentrylist-modern.js?v=<?php echo time(); ?>"></script>

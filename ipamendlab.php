...
if ($frm1submit1 == 'frm1submit1')
{
	...
	$alabfree = $_POST['alabfree'][$key];
	 $query1="update ipconsultation_lab set freestatus='$alabfree' where patientcode='$patientcode' and patientvisitcode='$visitcode' and labitemcode='$aitemcode' and locationcode = '$locationcode' ";
...
foreach($_POST['categorylab'] as $key=>$value)
	...
	$categorylabquery1=mysqli_query($GLOBALS["___mysqli_ston"], $sqlde) or die ("Error in sqlde".mysqli_error($GLOBALS["___mysqli_ston"])); 
	}	
	}
		...
		$labquery=mysqli_query($GLOBALS["___mysqli_ston"], "select * from master_lab where itemname='$labname'") or die ("Error in sqlde".mysqli_error($GLOBALS["___mysqli_ston"])); 
...
$data=mysqli_query($GLOBALS["___mysqli_ston"], "select auto_number,patientcode,patientvisitcode,patientname,refno,labitemcode,labitemname,labitemrate from ipconsultation_lab where auto_number='$labname'") or die ("Error in sqlde".mysqli_error($GLOBALS["___mysqli_ston"])); 
...

{
 ...
 $query="insert into amendment_details (patientcode,visitcode,patientname,refno,itemcode,itemname,rate,amenddate,amendtime,amendfrom,amendby,ipaddress,type,remarks) values ('$patientcode','$visitcode','$patientname','$refno','$medicinecode','$medicinename','$rate','$date','$time','lab','$username','$ipaddress','IP','$remarks')";

mysqli_query($GLOBALS["___mysqli_ston"], $query) or die ("Error in query".mysqli_error($GLOBALS["___mysqli_ston"])); 

}

	mysqli_query($GLOBALS["___mysqli_ston"], "delete from ipconsultation_lab where auto_number='$labname' and patientvisitcode='$viscode'") or die ("Error in query".mysqli_error($GLOBALS["___mysqli_ston"])); 
}
...
?>
<?php
$querylab1= mysqli_query($GLOBALS["___mysqli_ston"], "select * from ipconsultation_lab where patientcode='$patientcode'") or die ("Error in query131".mysqli_error($GLOBALS["___mysqli_ston"])); 
...
$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in query3".mysqli_error($GLOBALS["___mysqli_ston"]));
$res2 = mysqli_fetch_array($exec2);
...
<td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $iptestdocno; ?>
     ...
     <tr id="labid">
				 ...
				 <tr>
				   <td colspan="6" align="center" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">Total Amount</span>

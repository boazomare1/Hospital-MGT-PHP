...
function getGroupBalance($group_id, $from_date, $to_date, $sno, $locationwise, $includezeroballeg) {
    $data = "";
...
<head>
    ...
    <title>Balance Sheet - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/balancesheet-modern.css?v=<?php echo time(); ?>">
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2>Balance Sheet</h2>
                    <p>Generate and view comprehensive balance sheet reports for financial analysis.</p>
                </div>
            ...
            <div class="search-filter-section">
                ...
                <form method="post" name="form1" action="balancesheet.php" class="search-filter-form">
                    <div class="form-row">
                        <div class="form-group">
                            <label for="ADate2" class="form-label">Date</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-group">
                                <label class="checkbox-label">
                                    <input type="checkbox" name="includeopenbal" value="1" <?php echo $includeopenbal ? 'checked' : ''; ?>>
                                    <span>Include Opening Balance</span>
                                </label>
                                <label class="checkbox-label">
                                    <input type="checkbox" name="includezeroballeg" value="1" <?php echo $includezeroballeg ? 'checked' : ''; ?>>
                                    <span>Include Zero Balance Ledgers</span>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="balance-sheet-section">
                <div class="balance-sheet-header">
                    <i class="fas fa-file-invoice-dollar balance-sheet-icon"></i>
                    <h3 class="balance-sheet-title">Balance Sheet Report</h3>
                    <div class="report-summary">
                        <span class="summary-item">
                            <i class="fas fa-calendar"></i>
                            Date: <?php echo date('d/m/Y', strtotime($ADate2)); ?>
                        </span>
                        <?php if($location) { ?>
                        <span class="summary-item">
                ...
                <div class="table-container">
                    <table class="balance-sheet-table" id="tblData">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php
                            // Your existing PHP logic for displaying balance sheet data goes here
    ...
    <!-- Modern JavaScript -->
    <script src="js/balancesheet-modern.js?v=<?php echo time(); ?>"></script>

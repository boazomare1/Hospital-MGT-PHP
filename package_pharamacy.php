...
?>
		...
		$sno = 0;	
		$colorloopcount=0;
		$query2 = "select visitcode,entrydate,itemname,ipdocno,quantity,rate,username from pharmacysales_details where locationcode='$locationcode1' and entrydate between '$fromdate' and '$todate' and  freestatus='$status1' and visitcode in (select visitcode from master_ipvisitentry where locationcode='$locationcode1' and consultationdate between '$fromdate' and '$todate' and  package='$packagecode' and finalbillno <> '') order by entrydate ASC";

...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="599" 
            align="left" border="0">
          <tbody>
            <tr>
              <td width="10%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>External Radio</strong></td>
			...
			$query1 = "select * from billing_externalradiology where billdate between '$ADate1' and '$ADate2'";
...
-->		
          <tr>
			...
			<a href="viewoprevenuereportdetailsexternalradioxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>
			</tr>
        </table>
	   </tr>

...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Referral Return</strong></td>
			...
			$query1 = "SELECT billdate, billnumber, patientvisitcode, patientname, referalrate from refund_paylaterreferal where billdate between '$ADate1' and '$ADate2'
			union all SELECT billdate, billnumber, patientvisitcode, patientname, referalrate from refund_paynowreferal where billdate between '$ADate1' and '$ADate2'
			";
			...
			$res1consultationamount = $res1['referalrate'];
...
-->		
          ...
          <tr>
			...
			<a href="viewoprevenuereportdetailsreferralreturnxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>

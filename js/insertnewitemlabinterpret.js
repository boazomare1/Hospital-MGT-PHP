...
/*
	...
	*/
	...
	var text11int = document.createElement ('input');
	text11int.id = "interpret"+i+"";
	text11int.name = "interpret"+i+"";
	text11int.type = "button";
	text11int.setAttribute("data-toggle","modal");
	text11int.setAttribute("data-target","#myModal");
	text11int.value = "Interpretation";
	text11int.style.border = "1px solid #001E6A";
	text11int.onclick = function() { return CallFrom(i); }
	//td10.appendChild (text10);
	td101.appendChild (text11int);
	...
	tbody10.id = "add_interpret"+tid+"";
	tbody10.align = "left";
	tbody10.valign = "top";
	tbody10.style.backgroundColor = "#FFFFFF";
	tbody10.style.border = "0px solid #001E6A";
	document.getElementById ('presid').appendChild (tbody10);

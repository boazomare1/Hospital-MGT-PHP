...
$res = mysqli_fetch_array($exec);
  ...
  $locationcode=isset($_REQUEST['location'])?$_REQUEST['location']:$locationcode;
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
		<form name="stockinward" action="stockreportbystore-test.php" method="post" onKeyDown="return disableEnterKey()" onSubmit="return Locationcheck()">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" 
            align="left" border="0">
      <tbody id="foo">
        <tr>
          <td colspan="5" bgcolor="#ecf0f5" class="bodytext31"><strong>Stock - Report By Store</strong></td>
          </tr>
        <tr>
...
<?php }}?>
        ...
        <tr>
		  ...
		  <input type="hidden" name="searchitemcode" id="searchitemcode">
            <input name="searchbutton12" type="hidden" id="searchbutton12" style="border: 1px solid #001E6A" value="Search Item Name" /></td>
        </tr>
        <tr>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              <td colspan="40" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
            </tr>
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="left"><div class="bodytext31">
                  <div align="left"><?php echo number_format( $totqty); ?></div>
              </td>
			   ...
			   if($store != ''){
				...
				if($currentstock > 0)
				{
					$tddate = number_format($currentstock).' ('.$batchnumber.')';
				}
				else
				{
					$tddate = '';
            ...
            <tr>
       		<td align="right"> <a target="_blank" href="print_stockreportbystore.php?categoryname=<?= $categoryname; ?>&&store=<?= $store;?>&&location=<?= $location;?>&&searchcode=<?= $searchcode;?>"> <img src="images/excel-xls-icon.png" width="30" height="30"></a> </td>
            </tr>
			<?php
			}
			?>

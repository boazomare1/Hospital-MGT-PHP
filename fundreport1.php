...
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   <td width="1%" align="left" valign="top">&nbsp;</td>
    <td  valign="top">
	<form name="form1" id="form1" method="post" action="fundreport1.php" onSubmit="return from1submit1()">
   ...
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tbody>
	<tr bgcolor="#FFFFFF">
	<td colspan="30" align="center" class="bodytext3"><strong>PROVIDENT CONTRIBUTION</strong></td>
	</tr>
	<tr bgcolor="#ecf0f5">
	<td colspan="30" align="left" class="bodytext3"><strong>Provident Report</strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr>
	<td width="38" align="center" bgcolor="#ecf0f5" class="bodytext3"><strong>S.No</strong></td>
	<td width="82" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>PAYROLL NO</strong></td>
	<td width="237" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>EMPLOYEE'S NAME</strong></td>
	<td width="75" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>NSSF NO</strong></td>
	<td width="75" align="right" bgcolor="#ecf0f5" class="bodytext3"><strong>Total Gross</strong></td>
	<td width="82" align="right" bgcolor="#ecf0f5" class="bodytext3"><strong>Employee Amount</strong></td>
	<td width="87" align="right" bgcolor="#ecf0f5" class="bodytext3"><strong>Employer Amount</strong></td>
	<td width="106" align="right" bgcolor="#ecf0f5" class="bodytext3"><strong>Total Standard Amount</strong></td>
	<td width="7" align="left" bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
	<td width="96" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>ID NO</strong></td>
	<td width="12" align="left" bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
	</tr>
	<?php 
	$totalnssf = '0.00';
	$totalamount = '0.00';
	...
	$query6 = "select passportnumber,nssf,payrollno from master_employeeinfo where employeecode = '$res2employeecode' ORDER BY employeecode";
	...
	<?php 
	$totalgrossper = 0;
	$query1 = "select auto_number from master_payrollcomponent where recordstatus <> 'deleted' and auto_number = '24' order by typecode, auto_number";
	...
	<td align="right" class="bodytext3"><?php echo number_format($volamount,3,'.',','); ?></td>
	<td align="right" class="bodytext3"><?php echo number_format($totamount,3,'.',','); ?></td>
	<td align="right" class="bodytext3" width="7">&nbsp;</td>
	...
	<td colspan="3" align="left" bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
	</tr>
	<tr>
	<td colspan="10" align="left" class="bodytext3"><a href="print_fundreport1.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/pdfdownload.jpg" height="40" width="40"></a>
	&nbsp;&nbsp;&nbsp;<a href="print_fundreportxl.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/excel-xls-icon.png" height="40" width="40"></a></td>
	</tr>
	</tbody>
	</table> 
	<?php 

...
AutoSuggestControl.prototype.autosuggest = function (aSuggestions /*:Array*/,
 ...
 //alert('hi');
...

	{
  	...
  	var searchsuppliername1 = document.getElementById("accountsearch").value;
...
AutoSuggestControl.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			var varSupplierName = document.getElementById("accountsearch").value;
			...
			document.getElementById("accountsearch").value = varSupplierName;
...

{
	...
	var varEmployeeName = document.getElementById("accountsearch").value;

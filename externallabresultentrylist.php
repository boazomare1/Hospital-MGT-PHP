      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query1 = "select * from consultation_lab where labsamplecoll='completed' and resultentry='pending' and patientcode='walkin' group by billnumber order by consultationdate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="externallabresultentry.php?billnumber=<?php echo $billnumber; ?>"><strong>Enter</strong></a></div></td>
              </tr>
			<?php
			}    
			?>

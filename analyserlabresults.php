    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="drugs" action="analyserlabresults.php" method="post" onKeyDown="return disableEnterKey()" onSubmit="return validcheck()">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" 
            align="left" border="0">
      <tbody id="foo">
        <tr>
          <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Analyser Sample Collection</strong></td>
...
function AnaProcess(sno,pcode,vcode,dno,sid)
{
	...
	else
	{
	  ...
	  <form name="form1" id="form1" method="post" action="analyserlabresults.php">	
      <tr>
        <td>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
...
?>
			<tr>
			  ...
			  <td width="92" align="left" valign="center"  
			    ...
			    <td colspan="2" width="69" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Action</strong></div></td>
			    
             </tr>
			<?php
			$query7 = "select * from samplecollection_laban where locationcode = '".$locationcode."' and acknowledge = 'completed' and resultentry <> 'completed' and status = 'completed' and refund = 'norefund'  and recorddate between '$ADate1' and '$ADate2' order by recorddate desc";
			...
			$entrywork = 'Pending';
              ...
              <td align="left" valign="center"  
                ...
                class="bodytext31"><div align="left"><?php echo $sample; ?></div></td>
              	 <td align="left" valign="center"  
                class="bodytext31"><div align="left"><a href="analyserlabresultentry.php?patientcode=<?php echo $regno; ?>&&visitcode=<?php echo $visitno; ?>&&docnumber=<?php echo $docnumber; ?>&&sampleid=<?php echo $sampleid; ?>"><strong>View</strong></a></div></td>
				<td align="left" valign="center"  
                class="bodytext31">&nbsp;</td>

...
if ($frm1submit1 == 'frm1submit1')
{
	...
	$query4 = "update leave_request set from_date = '$fromdate', to_date = '$todate', total_days = '$totaldays', approvalstatus = '$approvalstatus',
			   hrusername = '$username', hrupdatedatetime = '$updatedatetime' where docno = '$docno'";
	$exec4 = mysqli_query($GLOBALS["___mysqli_ston"], $query4) or die ("Error in Query4".mysqli_error($GLOBALS["___mysqli_ston"]));
	
	header("location:leavehrapprovallist.php");
	exit;
}
      ...
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="5" cellspacing="5" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            ...
            <td colspan="8">&nbsp;</td>
              ...
              <tr>
              <td bgcolor="#ecf0f5" colspan="8" class="bodytext3" align="left"><strong>Leave Request HR Approval</strong></td>
              </tr>
               <tr>
			...
			$query88 = "select sum(total_days) as total_days from leave_request where employeecode = '$employeecode' and approvalstatus = 'approved' and docno <> '$docno' and leavestype = '$leavestypearr1' and status <> 'deleted'";
			$exec88 = mysqli_query($GLOBALS["___mysqli_ston"], $query88) or die ("Error in Query88".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res88 = mysqli_fetch_array($exec88);

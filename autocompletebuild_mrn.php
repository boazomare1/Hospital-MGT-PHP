...
$stringbuild1 = "";
 $todate=date('Y-m-d', mktime(0, 0, 0, date('m'), date('d') -360, date('Y')));
 $query1 = "select billnumber from materialreceiptnote_details where entrydate <= '".date('Y-m-d')."' AND entrydate >= '".$todate."' and grnstatus='' group by billnumber";

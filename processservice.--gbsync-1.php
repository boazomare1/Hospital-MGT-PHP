...
if($servicename != "")
 ...
 $query26="insert into process_service(patientname,patientcode,patientvisitcode,recorddate,recordtime,itemcode,itemname,acknowledge,refund,docnumber,locationname,locationcode)values('$patientname','$patientcode',
   ...
   mysqli_query($GLOBALS["___mysqli_ston"], "update consultation_services set process='$status',servicerefund='$status1',docnumber='$docnumber' where patientvisitcode='$visitcode' and servicesitemname='$servicename' and auto_number='$refno'");

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="radtimereport.php">
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Rad Results Time Report</strong></td>
...

{
	...
	$docnumber=$_POST['docnumber'];
		...
		$queryn21 = "select * from consultation_radiology where  patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and docnumber like '%$docnumber%' and consultationdate between '$fromdate' and '$todate' and $pass_location and radiologyitemcode like '%$labcode%' and resultentry='completed'";
...
?>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td width="8%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Patient Prepare</strong></div></td>

                <td width="19%"  align="left" valign="center" 

                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Image  Aquisition</strong></div></td>
		  ...
		  $query23 = "select * from consultation_radiology where and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and docnumber like '%$docnumber%' and consultationdate between '$fromdate' and '$todate' and $pass_location and radiologyitemcode = '$labcode' and resultentry='completed'";

		   } else {

			 $query23 = "select * from consultation_radiology where  patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and docnumber like '%$docnumber%' and consultationdate between '$fromdate' and '$todate' and $pass_location and resultentry='completed'";  
			...
			$itemname = $res23['radiologyitemname'];
			...
			$preparation_datetime = $res23['preparation_datetime'];

			$preptime = date('H:i:s',strtotime($preparation_datetime));
			
			$aquisition_datetime = $res23['aquisition_datetime'];
			
			$aqtime = date('H:i:s',strtotime($aquisition_datetime));
			
			$reporting_datetime = $res23['reporting_datetime'];
          ...
          <tr <?php echo $colorcode; ?>>
             ...
             <td class="bodytext31" valign="center"  align="left">
			   ...
			   <?php echo $preparation_datetime; ?>

			    </td>

               <td class="bodytext31" valign="center"  align="center">

			   <?php echo $aquisition_datetime; ?>

			    </td>

                   <td class="bodytext31" valign="center"  align="center">

			    <div align="center"><?php echo $reporting_datetime; ?></div></td>
      ...
      <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
		...
		<td colspan="3"><a href="print_radtimereportpdf.php?<?php echo $url; ?>"><img src="images/pdfdownload.jpg" width="30" height="30"></a></td>

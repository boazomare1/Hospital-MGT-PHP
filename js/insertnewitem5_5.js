...
function insertitem5()
{
	...
	var2=varrefRate;
	varref3=var2.replace(",","");
	varref4=parseInt(varref3);
	...
	text8.type = "text";
	text8.size = "8";
	text8.value = formatMoney(varref4);
	...
	text11.onclick = function() { return btnDeleteClick4(n,varref4); }
	...
	//alert(vRate);
	totalamount4=parseInt(totalamount4) + parseInt(varref4);
	
	document.getElementById("total5").value=formatMoney(totalamount4);
	document.getElementById("t6").value=totalamount4;

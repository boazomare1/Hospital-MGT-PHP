...
$query01="";
				...
				if($retqty !="0" && $retqty !="")
				{
 				 ...
 				 header("location:cashservicesrefund.php");
 				exit;
				}
...
if($num01!=$serialnum)
{
	...
	header('location:cashservicesrefund.php?st=matchfailed');
	exit;
}
...
if(retqty=='' || retqty==0){
	...
	alert("Please enter refund qty.");
	document.getElementById("rfqty1").focus();
	return false;
}
if(retqty >0 && remarks =="")
{
...
<form name="frmsales" id="frmsales" method="post" action="" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$totalamount=0;
			 ...
			 $query61 = "SELECT serviceqty,refundquantity,servicesitemname,billtype,auto_number,refno from consultation_services where paymentstatus='completed' and patientcode = '$patientcode' and patientvisitcode = '$visitcode' and (process='pending' or process='completed') and auto_number='$refnumber'  and servicesitemcode='$service_item_code' and (billtype='PAY NOW' or (billtype='PAY LATER' ))";

...
else
{
	...
	$paymentmode = $_REQUEST['billtype'];
		...
		header("location:amend_pending_misc.php");
		exit;
...
$data=mysqli_query($GLOBALS["___mysqli_ston"], "select auto_number,patientcode,patientvisitcode,patientname,billingaccountcode,billingaccountname,rate,docno,units,amount from ipmisc_billing where auto_number='$labname'");
$data1=mysqli_fetch_array($data);
$patientname=$data1['patientname'];
$patientcode=$data1['patientcode'];
$visitcode=$data1['patientvisitcode'];
$medicinecode=$data1['billingaccountcode'];
$medicinename=$data1['billingaccountname'];
$rate=$data1['rate'];
$amount=$data1['amount'];
$refno=$data1['docno'];
...
if($medicinecode<>'')
{
 $query="insert into amendment_details (patientcode,visitcode,patientname,refno,itemcode,itemname,rate,amenddate,amendtime,amendfrom,amendby,ipaddress,qty,amount,type,remarks) values ('$patientcode','$visitcode','$patientname','$refno','$medicinecode','$medicinename','$rate','$date','$time','Misc','$username','$ipaddress','$qty','$amount','IP','$remarks')";
mysqli_query($GLOBALS["___mysqli_ston"], $query)or die("Error in query".mysqli_error($GLOBALS["___mysqli_ston"]));
}


mysqli_query($GLOBALS["___mysqli_ston"], "delete from ipmisc_billing where auto_number='$labname' and patientvisitcode='$viscode'");

header('location:amendmisc.php?patientcode='.$patientcode.'&visitcode='.$visitcode);
...
<script type="text/javascript" src="js/insertnewitemipmiscbilling_misc.js"></script>
<script type="text/javascript" src="js/autosuggesaccountsearch1_new1.js"></script>
...
if(confirm("Do You Want To Save The Record?")==false){return false;document.getElementById("submit").disabled =false;}	else{
...
{
	var oTextbox = new AutoSuggestControl(document.getElementById("accountsearch"), new StateSuggestions());
...
del=confirm("Do You want to delete this test ?");
...
window.location='amendmisc.php?delete='+id+'&patientcode='+patient+'&&visitcode='+visit+'&remarks-'+id+'='+msg;
}
...
<body>
<form name="form1" id="frmsales" method="post" action="amendmisc.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
          ...
          <tbody id="foo">
            <tr>
              <td width="16%" class="bodytext31" valign="center"  align="left" 
				...
				<td width="16%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Unit </strong></div></td>
			...
			$query17 = "select * from ipmisc_billing where patientvisitcode='$visitcode' and patientcode='$patientcode'  ";
			...
			while ($res17 = mysqli_fetch_array($exec17))
			{
				...
				$description=$res17['description'];
				$unit=$res17['units'];
				$miscrate=$res17['rate'];
				$miscamount=$res17['amount'];
				$misc_auto_number=$res17['auto_number'];
				$billingaccountname=$res17['billingaccountname'];
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $billingaccountname; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $description; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $unit; ?></div></td>
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $miscrate; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $miscamount; ?></div></td>
				<td class="bodytext31" valign="center"  align="left"><div align="center"><input type = "text" name ="remarks-<?php echo $misc_auto_number; ?>" id ="remarks-<?php echo $misc_auto_number; ?>"></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><a onClick="return deletevalid('<?php echo $misc_auto_number; ?>','<?php echo $patientcode; ?>','<?php echo $visitcode; ?>')" href='javascript:return false;' >Delete</a></div></td>
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
				        ...
				        <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>IP Misc Billing </strong> </span></td>
		        </tr>
				<tr id="reffid">
					 ...
					 <div id="insertrow4">					 </div></tr>
					  ...
					  <input type="hidden" name="referalcode" id="referalcode" value="">
                       <td width="30">
					    ...
					    <input name="accountsearch" class="bodytext3" type="text" id="accountsearch" size="30">
				   ...
				   <td width="30"><input name="referal[]" type="text" id="referal" size="30"></td>
				    ...
				    <td width="30"><input name="rate4[]" type="text" id="rate4" size="8" onKeyUp="return funcamountcalc()" onkeypress="return isNumberKey(event,this)"></td>
	  ...
	  <td colspan="7" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
	   <input name="frm1submit1" id="frm1submit1" type="hidden" value="frm1submit1">
	    <input name="Submit2223" type="submit" id="submit" value="Save" accesskey="b" class="button"/>		</td>
	  </tr>

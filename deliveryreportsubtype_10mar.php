...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php echo $colorcode; ?>>
			  ...
			  <?php  //echo $accno.'=='.$res2accountnameano.'ano and is ='.$legid.'=='.$res2accountnameid; ?> 
		   ...
		   if($legid==$accountcode1){
			 ...
			 $query3 = "select * from billing_ipnhif where locationcode='$locationcode1' and  completed <> 'completed' and recorddate between '$ADate1' and '$ADate2'  and  docno NOT IN (SELECT  billno FROM print_deliverysubtype where status != 'deleted' and accountname='$accountname1' and isnhif='1') order by recorddate desc"; 
		  ...
		  //// ip
		  $query3 = "select * from billing_ip where locationcode='$locationcode1' and  accountnameano = '$accno' and completed <> 'completed' and billdate between '$ADate1' and '$ADate2'  and  billno NOT IN (SELECT  billno FROM print_deliverysubtype where status != 'deleted' and isnhif='0') group by billno order by accountname, billdate desc"; 
		  $exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
		  while ($res3 = mysqli_fetch_array($exec3))
		  {

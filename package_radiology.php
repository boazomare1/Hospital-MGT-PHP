...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            align="left" border="0">
          <tbody>
             <tr><td colspan="7" bgcolor="#ecf0f5" class="bodytext3"><strong> <?=$status2.' Lab Items - '.$packagename?> </strong></td></tr>
				<tr>
		...
		$sno = 0;	
		$colorloopcount=0;
		$query2 = "select patientvisitcode,consultationdate,radiologyitemname,iptestdocno,radiologyitemrate,username from ipconsultation_radiology where locationcode='$locationcode1' and consultationdate between '$fromdate' and '$todate' and  freestatus='$status1' and patientvisitcode in (select visitcode from master_ipvisitentry where locationcode='$locationcode1' and consultationdate between '$fromdate' and '$todate' and  package='$packagecode' and finalbillno <> '') order by consultationdate ASC";
		...
		$itemname= $res2['radiologyitemname'];
		$docno= $res2['iptestdocno'];
		$rate= $res2['radiologyitemrate'];
		...
		$colorloopcount = $colorloopcount + 1;
		   ...
		   ?>
		   <tr>
		   <td colspan="5" bgcolor="#ecf0f5" class="bodytext31" valign="center"  align="right"><strong>Total Amount</strong></td>

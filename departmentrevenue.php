    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="departmentrevenue.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                    <tr bgcolor="#011E6A">
                      <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Department Revenue</strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  include("pharmacyrevenuecalculation.php");
		  include("homerevenuecalculation.php");
		  include("ambulancerevenuecalculation.php");
		  ...
		  $netpharmacy = $totalpharmacy - $totalphamacycogs;
		  $nethomecare = $totalbillhomecare - $totalhomecarecogs;
		  $netambulance = $totalambulanceamount - $totalambulancecogs;
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="right">
                ...
                <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><?php echo number_format( $totalpharmacy,2,'.',','); ?></div></td>
                <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><?php echo number_format( $totalbillhomecare,2,'.',','); ?></div></td>
               <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><?php echo number_format(  $totalambulanceamount,2,'.',','); ?></div></td>
            ...
            <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><?php echo number_format($totalphamacycogs,2,'.',','); ?></div></td>
              <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><?php echo number_format($totalhomecarecogs,2,'.',','); ?></div></td>
				  <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><?php echo number_format($totalambulancecogs,2,'.',','); ?></div></td>
		   ...
		   <?php
			...
			<tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="right">
                ...
                <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><strong><?php echo number_format($netpharmacy,2,'.',','); ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><strong><?php echo number_format($nethomecare,2,'.',','); ?></strong></div></td>
				  <td class="bodytext31" valign="center"  align="right">
                <div class="bodytext31"><strong><?php echo number_format($netambulance,2,'.',','); ?></strong></div></td>

...
<tr>
  ...
  <tr>
    ...
    <td colspan="6" width="500" align="center"><strong><?php echo 'CAPITATION INVOICE'; ?></strong></td>
...
$grandtotal = $subtotal + $res19amount1 + $res20amount1 + $res21amount1 + $res22amount1 + $res23servicesitemratetotal+$res222amount1+$res2222amount1 - ($pw_lab+$pw_radiology+$pw_services) + $totalcopaytot - $totalcash_copay - $totalraddisc_amount;

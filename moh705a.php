...
<table width="1901" border="0" cellspacing="0" cellpadding="2">
  ...
  <td width="1%">&nbsp;</td>
    <td colspan="8">
     <form name="cbform1" method="post" id="form1" action="moh705a.php">
    <table width="604" border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>MOH 705a (below <= 5) </strong></td>
		   ...
		   <?php 
	   	  $query = "select locationname,locationcode,auto_number from master_location order by locationname"; 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="1200" align="left" border="1">
          <tbody>		 
                <tr>
                	<td colspan="35" valign="center"  align="center" bgcolor="#ffffff"><strong>UNDER 5 YEARS DAILY OUTPATIENT MORBIDITY SUMMARY SHEET</strong></td>
				</tr>
                 <tr>
                ...
                <tr bgcolor="#ffffff">
                    ...
                    <td colspan="5" valign="center"  align="left"  class="bodytext31"><strong>M.O.H.705A</strong></td>
                </tr>
                 <tr bgcolor="#ecf0f5">
         ...
         <td align="left" valign="top"><a target="_blank" href="print_moh705a.php?cbfrmflag1=cbfrmflag1&&locationcode=<?php echo $location; ?>&&month=<?php echo $selectedmonth; ?>&&year=<?php echo $selectedyear; ?>"><img src="images/pdfdownload.jpg" width="30" height="30"></a>
            <a href="moh705a_xl.php?cbfrmflag1=cbfrmflag1&&locationcode=<?php echo $location; ?>&&month=<?php echo $selectedmonth; ?>&&year=<?php echo $selectedyear; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>
      </tr>
    <?php 

   ...
   <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="servicelist-test.php">
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			  ...
			  echo $query1 = "select * from consultation_services where locationcode = '".$locationcode."' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and (paymentstatus='completed' OR paymentstatus='paid') and billtype='PAY NOW' and process='pending' and servicerefund <> 'completed' and wellnessitem <> '1' and consultationdate between '$fromdate' and '$todate' $services_condition $services_linked_condition group by patientvisitcode order by consultationdate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
		  ...
		  // if($num822 == 0)
           ...
           <table width='80%' align='left'>
			...
			$totalamount=0;
			 ...
			 $query61 = "select * from consultation_services where paymentstatus='completed' and patientcode = '$res1patientcode' and patientvisitcode = '$res1visitcode' and process='pending' and servicerefund <> 'completed' and wellnessitem <> '1' and (billtype='PAY NOW' or (billtype='PAY LATER' )) $services_condition $services_linked_condition ";
		  ...
		  // if($num822 == 0)
           ...
           <table width='80%' align='left'>
			...
			$totalamount=0;
			  ...
			  $query61 = "select * from consultation_services where paymentstatus='completed' and patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode' and process='pending' and servicerefund <> 'completed' and wellnessitem <> '1' and (billtype='PAY NOW' or (billtype='PAY LATER' )) $services_condition $services_linked_condition ";
		  ...
		  // if($num822 == 0)
           ...
           <table width='100%'>
			...
			$totalamount=0;
			   ...
			   $query61 = "select * from consultation_services where paymentstatus='completed' and patientcode = '$res1patientcode' and patientvisitcode = '$res1visitcode' and process='pending' and servicerefund <> 'completed' and wellnessitem <> '1' and (billtype='PAY NOW' or (billtype='PAY LATER' ))";

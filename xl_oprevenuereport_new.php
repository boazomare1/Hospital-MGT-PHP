...
header('Content-Disposition: attachment;filename="op-revenuereport-'.$datetime.'.xls"');
...
if (isset($_REQUEST["accountname"])) { $accountname = $_REQUEST["accountname"]; } else { $accountname = ""; }
 ...
 {
 $qrydpt = "select department from master_department where auto_number='$department'";
 $execdpt = mysqli_query($GLOBALS["___mysqli_ston"], $qrydpt);
 $resdpt = mysqli_fetch_array($execdpt);
 $departmentname=$resdpt['department'];
 }
...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="1100" align="left" border="0">
          <tbody>
       	 <tr><td colspan="12" align="center"><strong><h3>OP REVENUE REPORT</h3></strong></td></tr>
		
		  <tr><td colspan="12" align="center"><strong>Date From:    <?php echo  date("d-m-Y", strtotime($ADate1)); ?>   To:  <?php echo date("d-m-Y", strtotime($ADate2)); ?></strong></td></tr>
          
          <tr><td width="102"></td></tr>        
            <tr>
              ...
              <?php
				...
				if ($cbfrmflag1 == 'cbfrmflag1')
				{
					...
					//VENU-- 08-02-2016 -- Get Details Based on Location
					$qrydetails = "SELECT locationname FROM master_employeelocation WHERE locationcode ='$locationcode'" ;
					$exedetails = mysqli_query($GLOBALS["___mysqli_ston"], $qrydetails) or die ("Error in qrydetails".mysqli_error($GLOBALS["___mysqli_ston"]));
					$resdetails = mysqli_fetch_assoc($exedetails);
					$locationname = $resdetails['locationname'];
           ...
           <!-- <tr >
              <td align="left" valign="center" bgcolor="" class="style3">Head</td>
              <td width="8%" align="right" valign="center" bgcolor="" class="style3">Value</td>
              <td width="8%" align="right" valign="center" bgcolor="" class="style3">&nbsp;</td>
            </tr>-->
           <?php 
			   if($locationcode!='All')
			   {
			  ?> 
              <!--VENU -- 08-02-2016 -- DISPLAY LOCATION NAME-->
              <tr><td colspan="12" align="center"><strong>Location:    <?php echo $locationname; ?></strong></td></tr>
			  <tr><td colspan="12" align="center"><strong>Department:    <?php echo $departmentname; ?></strong></td></tr>
              <tr>
              	  <td width="102" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
                  <td width="102" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Consultation</strong></td>
                  <td width="102" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Pharmacy</strong></td>
                  <td width="102" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Laboratory</strong></td>
                  <td width="102" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Radiology</strong></td>
                  <td width="102" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Service</strong></td>
                  <td width="124" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Referral</strong></td>
                  <td width="97" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Rescue</strong></td>
                  <td width="103" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Home Care </strong></td>
                  <td width="84" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Total</strong></td>
              </tr>
            <?php
			   }
			?>
		...
		$query28 = "select sum(amount) as amount1 from billing_homecare where locationcode='$location' and recorddate between '$transactiondatefrom' and '$transactiondateto' and visitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			?>
                ...
                <tr >
				  ...
				  <?php echo number_format($res1consultationamount,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">
				  <?php echo  number_format($res9pharmacyitemrate,2,'.',','); ?></div></td>
           ...
           <!--     <tr >
              ...
              <!--ENDS-->
               ...
               <tr >
                 ...
                 <td class="bodytext31" width="102" valign="center"  align="right"><div class="bodytext31"><?php echo '-'.number_format($res12refundconsultation,2,'.',','); ?></div></td>
		   ...
		   ?>
			    ...
			    <?php
				} //ENDS IF LOCATION CODE IS NOT ALL
		  ?>
            
		   
		     
            <?php
			 //IF GET DISPLAY IF LOCATION CODE IS ALL
			  if($locationcode=='All')
			  {
		...
		?>
           <tr>
            <!--  <td colspan="3" class="bodytext31" valign="center" bgcolor="#FFFFFF" align="left"><strong><?php //echo $locationname; ?></strong></td>-->
               <td  colspan="10" align="left" valign="center" bgcolor="#ffffff" align="center" class="bodytext31"><strong><?php echo $locationname; ?></strong></td>
		   </tr>
        <tr><td colspan="10" align="center"><strong>Department:    <?php echo $departmentname; ?></strong></td></tr>
			...
			// this query for pharmacy
		    $query8 = "select sum(amount) as amount1 from billing_paylaterpharmacy where locationcode='$locationcode' and billdate between '$transactiondatefrom' and '$transactiondateto' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
		 	$exec8 = mysqli_query($GLOBALS["___mysqli_ston"], $query8) or die ("Error in query8".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res8 = mysqli_fetch_array($exec8);
			$res8pharmacyitemrate = $res8['amount1'];
			
			$query9 = "select sum(amount) as amount1 from billing_paynowpharmacy where locationcode='$locationcode' and billdate between '$transactiondatefrom' and '$transactiondateto' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
		    $exec9 = mysqli_query($GLOBALS["___mysqli_ston"], $query9) or die ("Error in Query9".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res9 = mysqli_fetch_array($exec9);
			$res9pharmacyitemrate = $res9['amount1'];
			...
			else
			{
			  ...
			  }//ENDS LOCATION CODE FOR ALL
			?>
            
		   <?php 
		   } //ENDS FOR ISSET CHECK
		   ?>
          </tbody>
        </table>
	  ...
	  <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="900" align="left" border="0">
         ...
         <tr><td colspan="12" align="center"><strong><h3>OP UNFINALIZED REVENUE REPORT</h3></strong></td></tr>
		  ...
		  <tr><td colspan="12" align="center"><strong>Date From:    <?php echo  date("d-m-Y", strtotime($ADate1)); ?>   To:  <?php echo date("d-m-Y", strtotime($ADate2)); ?></strong></td></tr>
			...
			//	$loccode=array();
				while ($res01 = mysqli_fetch_array($exec01))
				{
						...
						$locationcode = $res01["locationcode"];
		?>
		<tr><td colspan="12" align="center">&nbsp </td></tr>
           <tr><td colspan="12" align="center"><strong>Location:    <?php echo $locationname; ?></strong></td></tr>
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr >
				  ...
				  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php echo number_format($totalamount7,2,'.',','); ?></strong></div></td>
                                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php echo number_format($totalamount8,2,'.',','); ?></strong></div></td>
				  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php echo number_format($totalamount9,2,'.',','); ?></strong></div></td>

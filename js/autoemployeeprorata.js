...
function EmployeePayroll()   
{
	...
	//alert(Empcode);
	var Workdays = document.getElementById("searchworkdays").value;
	//alert(Workdays);
...
function ajaxprocessACCS21(Empcode)
{
	...
	return false; }
	var url = "";
	var url="autoemployeeprorata1.php?RandomKey="+Math.random()+"&&employeesearch="+varEmpcode+"&&assignmonth="+Assignmonth+"&&workdays="+Workdays+"";
   	//alert(url);

      ...
      <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
                <tr>
                  <td><form name="form1" id="form1" method="post" action="submenu.php" onSubmit="return process1()">
                    ...
                    //Then display it only if it's one of my blog page ?>
						...
						bgcolor="<?php if ($bgcolorcode == '') { echo '#FFFFFF'; } else if ($bgcolorcode == 'success') { echo '#FFBF00'; } else if ($bgcolorcode == 'failed') { echo '#AAFF00'; } ?>" class="bodytext31"><div align="left"><?php echo $errmsg; ?></div></td>
                          ...
                          <tr>
                            <td align="middle" colspan="2" ><strong>Note:  System automatically allocates rights for this Submodule to Administrator.</strong></td>
                          </tr>
                        </tbody>
                      </table>
                      <table width="1000" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                        <tbody>
                          <tr bgcolor="#011E6A">
                           ...
                           <tr bgcolor="#011E6A"> <th  width="21%" align="left" height="48" >Main Menu</th> <th  align="left" width="24%">Sub Menu</th> <th width="22%">Sub Order No</th>
		...
		while ($res1 = mysqli_fetch_array($exec1))
		{
			...
						$query5 = "select * from master_menumain where mainmenuid='$mainmenuid' and status <> 'deleted' ";			$exec5 = mysqli_query($GLOBALS["___mysqli_ston"], $query5) or die ("Error in Query5".mysqli_error($GLOBALS["___mysqli_ston"]));			$res5 = mysqli_fetch_array($exec5);			$res5accountsmain = $res5["mainmenutext"];			
		...
		?>
                          <tr <?php echo $colorcode; ?>>
                             ...
                             <td  align="left" valign="top"  class="bodytext31"><?php echo $res5accountsmain; ?></td>
                            ...
                            <td width="9%" align="left" valign="top"  class="bodytext31"><a href="edit_master_submenu.php?st=edit&&anum=<?php echo $auto_number; ?>" style="text-decoration:none">Edit</a>&nbsp;&nbsp; <a href="submenu.php?st=del&&anum=<?php echo $auto_number; ?>" onClick="return funcDeletesurgery1('<?php echo $name;?>')"> <img src="images/b_drop.png" width="16" height="16" border="0" /></a></td>
                          </tr>
                          <?php } ?>
                          <tr>
                        ...
                        <tbody>
                          <tr bgcolor="#011E6A">
                            <td colspan="6" bgcolor="#ecf0f5" class="bodytext11"><strong>Master Sub-Menu- Deleted </strong></td>
                             ...
                             <tr align="left" bgcolor="#011E6A"> <th  width="21%"  height="48" >Main Menu </th> <th align="left" width="22%">Sub Menu </th> <th width="22%">Sub Order No</th>
		...
		while ($res1 = mysqli_fetch_array($exec1))
		{
			...
			$submenuorder=$res1['submenuorder'];
			$submenulink=$res1['submenulink'];
			$auto_number = $res1['auto_number'];									$query5 = "select * from master_menumain where mainmenuid='$mainmenuid'  ";			$exec5 = mysqli_query($GLOBALS["___mysqli_ston"], $query5) or die ("Error in Query5".mysqli_error($GLOBALS["___mysqli_ston"]));			$res5 = mysqli_fetch_array($exec5);			$res5accountsmain = $res5["mainmenutext"];									
			$colorloopcount = $colorloopcount + 1;
		$showcolor = ($colorloopcount & 1); 
		if ($showcolor == 0)
		{
		...
		?>
                          <tr <?php echo $colorcode; ?>>
                            ...
                            <td align="left" valign="top"  class="bodytext31"><?php echo $submenulink; ?></td>
                               <td width="22%" height="28" align="left" valign="top"  class="bodytext31"><a href="submenu.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext31">

...
$stringbuild1 = "";
$query1 = "select * from master_employee where (employeename like '%$searchsuppliername1%' or jobdescription like '%$searchsuppliername1%') group by jobdescription order by jobdescription limit 0,10 ";

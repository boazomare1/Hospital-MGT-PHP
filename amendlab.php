...

{
 ...
 $query="insert into amendment_details (patientcode,visitcode,patientname,refno,itemcode,itemname,rate,amenddate,amendtime,amendfrom,remarks,amendby,ipaddress) values ('$patientcode','$visitcode','$patientname','$refno','$medicinecode','$medicinename','$rate','$date','$time','lab','$remarks','$username','$ipaddress')";
...
window.location='amendlab.php?delete='+id+'&patientcode='+patient+'&&visitcode='+visit+'&remarks-'+id+'='+msg;
}
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
...

			{
				...
				$query17 = "select * from consultation_lab where patientvisitcode='$visitcode' and patientcode='$patientcode'  and labsamplecoll='pending' ";

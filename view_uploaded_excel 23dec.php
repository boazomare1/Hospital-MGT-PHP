...
foreach($_POST['billnum2'] as $key => $value)
    ...
    $query8="UPDATE master_transactionpaylater set recordstatus = 'deallocated', acc_flag = '1' where docno='$docnum' and upload_id='$uploadid' and billnumber='$billnum2' and recordstatus = 'allocated'";
...
foreach($_POST['billnum'] as $key => $value)
    ...
    $query9912="update master_transactionpaylater set acc_flag='1' where billnumber='$billnum' and transactiontype='finalize' ";
    $exec9912=mysqli_query($GLOBALS["___mysqli_ston"], $query9912);

    

    $query87 ="SELECT * from master_transactionpaylater where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1' and recordstatus = 'allocated' and upload_id='$uploadid'";
    ...
    $query67 = "select * from master_transactionpaylater where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1' and upload_id='$uploadid'";
    ...
    $query45 = "UPDATE master_transactionpaylater set recordstatus='allocated',transactionamount='$restotalaadjamount',fxamount = '$restotalaadjamount',cashamount='$restotalaadjamount',billbalanceamount='$balamount',transactiondate='$updatedatetime',username='$username' where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1' and upload_id='$uploadid'";
    ...
    $query45 = "update master_transactionpaylater set recordstatus='allocated',transactionamount='$restotalaadjamount',fxamount = '$restotalaadjamount',onlineamount='$restotalaadjamount',billbalanceamount='$balamount',transactiondate='$updatedatetime',username='$username' where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1' and upload_id='$uploadid'";
    ...
    $query45 = "update master_transactionpaylater set recordstatus='allocated',transactionamount='$restotalaadjamount',fxamount = '$restotalaadjamount',chequeamount='$restotalaadjamount',billbalanceamount='$balamount',transactiondate='$updatedatetime',username='$username' where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1'  and upload_id='$uploadid'";
    ...
    $query45 = "update master_transactionpaylater set recordstatus='allocated',transactionamount='$restotalaadjamount',fxamount = '$restotalaadjamount',writeoffamount='$restotalaadjamount',billbalanceamount='$balamount',transactiondate='$updatedatetime',username='$username' where billnumber='$billnum' and transactiontype='PAYMENT' and docno='$docnum1' and upload_id='$uploadid'";
...
$query11 = "select sum(transactionamount) as total11 from master_transactionpaylater where docno='$docno' and upload_id='$uploadid' and recordstatus='allocated'";
...
// pending
      ...
      $res1 = mysqli_fetch_array($exec1);
       $patientcode=$res1['patientcode'];
        ...
        // }
           ...
           $query2_ipfinal = " SELECT patientcode, patientname, visitcode, transactionamount, accountname, subtype, accountnameid FROM `master_transactionip` where `billnumber`='$bill_no'";
          ...
          while($res2_ipfinal = mysqli_fetch_array($exec2_ipfinal)){
           $patientcode=$res2_ipfinal['patientcode'];
            ...
            $total_amount_f=$res2_ipfinal['transactionamount'];
            $suppliername=$res2_ipfinal['accountname'];
            $accountid_match=$res2_ipfinal['accountnameid'];
            $subtype_billno=$res2_ipfinal['subtype'];
         }

          $query_allocated_amount = "SELECT sum(transactionamount) as amount, sum(discount) as discount from master_transactionpaylater where  recordstatus='allocated' and billnumber='$bill_no'";
          // docno='$docno' and
    ...
    $doctorname='';
        ...
        if(($x=="0" and $y=="0")  or($array_found=='1') or ($not_match!=0) or ($allocation_amount>$pending_allocated)  or  ($subtypeid_docno!=$subtype_id_main)  ) { 
            $error += 1; 
            }else{ $error += 0;  } 
        ?>
        
        <tr  <?php  if(($x=="0" and $y=="0")  or($array_found=='1')  or ($not_match!=0) or ($allocation_amount>$pending_allocated)  or  ($subtypeid_docno!=$subtype_id_main)) { echo $not_find; }else{ echo $colorcode; } ?>>
              ...
              <input type="hidden" class="dis" name="discount[]"  value="<?=$discount_only;?>" size="7" >
                          ...
                          <td class="bodytext31" valign="center"  align="left">
                            ...
                            <!-- or ($pending_allocated<0)  -->
                             <input type="checkbox" <?php if(($x=="0" and $y=="0")  or($array_found=='1')  or ($allocation_amount>$pending_allocated) or  $not_match!=0 or  ($subtypeid_docno!=$subtype_id_main)) { echo "disabled=''"; }else{ echo 'checked=""';  } ?> name="ack[]" class="chkalloc" id="acknowpending<?php echo $sno; ?>" value="<?php echo $bill_no; ?>" ></td>
...
@keyframes blinkingText{
    ...
    <td colspan="1" align="right" valign="top"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                      <input type="hidden" name="frmflag23" value="frmflag23">
                       <input name="Submit" type="submit"  value="Allocate" class="button" id="submit1" onClick="return totalamountchec('<?php echo $num2; ?>','<?php echo $final_additionvalue; ?>'); "style="border: 1px solid #001E6A"    <?php if($error!=0) { echo "disabled=''"; } ?> />
    ...
    <table style="BORDER-COLLAPSE: collapse" 
        ...
        <input type="hidden" name="receivableamount1" id="receivableamount" value="<?php echo $receivableamount; ?>" size="6" class="bal">
            ...
            <tr bgcolor="#011E6A">
              ...
              <!-- <td width="%" align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Sub Type</strong></div></td> -->
      ...
      $res1 = mysqli_fetch_array($exec1);
       $patientcode=$res1['patientcode'];
        ...
        // }
           ...
           $query2_ipfinal = " SELECT patientcode, patientname, visitcode, transactionamount, accountname, subtype FROM `master_transactionip` where `billnumber`='$bill_no'";
          $exec2_ipfinal = mysqli_query($GLOBALS["___mysqli_ston"], $query2_ipfinal) or die ("Error in Query2_ipfinal".mysqli_error($GLOBALS["___mysqli_ston"]));
           $y=mysqli_num_rows($exec2_ipfinal);
          while($res2_ipfinal = mysqli_fetch_array($exec2_ipfinal)){
           $patientcode=$res2_ipfinal['patientcode'];
          ...
          $query_allocated_amount = "SELECT sum(transactionamount) as amount, sum(discount) as discount from master_transactionpaylater where docno='$docno' and upload_id='$uploadid'  and recordstatus='allocated' and billnumber='$bill_no'";
         // $query_allocated_amount = "SELECT * FROM `excel_insurance_upload` WHERE bill_no='$bill_no' and status='1' and location='$locationcode'";
      $exec_allocated_amount = mysqli_query($GLOBALS["___mysqli_ston"], $query_allocated_amount) or die ("Error in Query_allocated_amount".mysqli_error($GLOBALS["___mysqli_ston"]));
      while($res_allocated_amount = mysqli_fetch_array($exec_allocated_amount)){
        $allocated_amount=$res_allocated_amount['amount']+$res_allocated_amount['discount'];
      ...
      $query_allocated_amount_old = "SELECT sum(transactionamount) as amount, sum(discount) as discount from master_transactionpaylater where recordstatus='allocated'   and upload_id!='$uploadid' and billnumber='$bill_no'";
      // and docno!='$docno'

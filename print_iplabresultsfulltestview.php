...
$query2 = "select companyname,address1,address2,area,city,pincode,emailid1,phonenumber1,phonenumber2,cstnumber,emailid2 from master_company where auto_number = '$companyanum'";
...
$query = "select locationname,locationcode from login_locationdetails where username='$username' and docno='$docno' group by locationname order by locationname ";
...
$query1 = "select patientfullname,consultationdate,consultationtime,accountfullname,departmentname,'' as consultingdoctorName from master_visitentry where visitcode = '$visitcode'";
$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
$type = 'OP';
if(mysqli_num_rows($exec1) == 0)
{
$query1 = "select patientfullname,consultationdate,consultationtime,accountfullname,'' as departmentname,consultingdoctorName from master_ipvisitentry where visitcode = '$visitcode'";
$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
$type = 'IP';
...
$query5 = "select area,mrdno,age,gender,dateofbirth,mobilenumber from master_customer where customercode = '$patientcode'";
...
if($frompage=='lab'){
	...
	$ack= array();
	$page= array();
	$query115 = "select itemcode,sampleid from ipresultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' group by itemcode,sampleid";
...
$query211 = "select employeename from master_employee where username  = '$res11username'";
...
function roundTo($number, $to){ 
    return round($number/$to, 0)* $to; 
		...
		$query2 = "select address1,address2,phone,locationcode,prefix,suffix from master_location where locationcode = '$locationcode'";
		$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
		$res2 = mysqli_fetch_array($exec2);
		$address1 = $res2["address1"];
		$address2 = $res2["address2"];
 ...
 <table align="center" width="520" cellspacing="0" cellpadding="1" border="0">
	     <tr>
		    <td valign="top" width="83" rowspan="0">
			  ...
			  <?php
			$query3showlogo = "select showlogo from settings_billhospital where companyanum = '$companyanum'";
			...
			<img src="logofiles/<?php echo $companyanum;?>.jpg" width="245" height="85" />
			...
			?>
			<span class="style1"><?php echo $companyname.'<BR>ISO 15189 ACCREDITED'; ?></span>
			<span class="style1"><?php echo '<br>'. $labemobile.'<br>'.$labemail; ?></span>
			</td>
			</tr>
	 ...
	 <td width="70%"><?php echo strtoupper('Technologist'); ?>: <strong><?php echo strtoupper($publishedname); ?></strong></td>
	  ...
	  <td width="70%">Printed On: <?php echo date('d-M-Y g:i:A'); ?></td>
	     ...
	     <tr>
			...
			<img src="logofiles/<?php echo $companyanum;?>.jpg" width="95" height="65" />
...
<?php
	...
	$refcomments = str_replace('border="1"','border="0"',$refcomments);		
	 ...
	 <td align="left" valign="top" class="bodytext27"><?php echo $referencerange; ?></td>
      ...
      <?php }  ?>
	  <?php
	 $query34i = "select interpret_desc,interpret_range from master_labinterpretation where itemcode = '$res616itemcode' and status <> 'deleted'";

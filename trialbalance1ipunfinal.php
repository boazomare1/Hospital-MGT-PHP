        ...
        <td valign="top"><table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			{	
				...
				$colorloopcount = $colorloopcount + 1;
					...
					$unrealized =0;
					include 'accountip/tb_unrealized.php';
...
function ledgervalue($parentid,$ADate1,$ADate2,$tbinclude,$tbclosing)
{
	...
	{
		if($tbinclude == 'tb_accountincomephar.php' || $tbinclude == 'tb_accountincomelab.php' || $tbinclude == 'tb_accountincomerad.php' || $tbinclude == 'tb_accountincomeser.php' || $tbinclude == 'tb_accountincomeother.php')
		{
		include('accountip/'.$tbinclude);
		return $sumbalance;
		}	
	}
	else

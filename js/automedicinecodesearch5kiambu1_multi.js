...
function funcmedicinesearch4multi(serialno)
{

	//alert("Meow..."+serialno);
	console.log('in multi fn')
	var serialno = serialno;

	if(document.getElementById("medicinecode"+serialno).value!="")

	{

		var varmedicinesearch = document.getElementById("medicinecode"+serialno).value;
...

		{
			...
			ajaxprocessACCS24multi(serialno);		
...
function ajaxprocessACCS24multi(serialno)

{
...

	{
  	...
  	var medicinesearch = document.getElementById("medicinecode"+serialno).value;
	...
	var url="automedicinecodesearch5kiambu1.php?RandomKey="+Math.random()+"&&medicinesearch="+medicinesearch;

    //alert(url);

serno = serialno;
    console.log('before ')
	//xmlHttp.onreadystatechange=stateChangedACCS24multi(serialno) 

	xmlHttp.onreadystatechange=stateChangedACCS24multi
	console.log('after ')
...
function stateChangedACCS24multi(serialno) 

{ 
	console.log('in last fn ');
	...
	{
	var serialno = serno; 
	console.log('in last fn serialno'+serialno)
	...
	//{
		...
		document.getElementById("medicinecode"+serialno).value = varMedicineCode;
		...
		document.getElementById("medicinename"+serialno).value = varMedicineName;
		...
		document.getElementById("fxrate"+serialno).value = formatMoney(varMedicineRate);

		var fxamount = parseFloat(document.getElementById("fxamount").value);

		

		document.getElementById("rate"+serialno).value = formatMoney(varMedicineRate/fxamount);
		console.log('@@'+document.getElementById("rate"+serialno).value)
		...
		document.getElementById("avlqty"+serialno).value = varMedicineStock;
		...
		document.getElementById("packsize"+serialno).value = varMedicinePack;

		document.getElementById("reqqty"+serialno).value = '';
		document.getElementById("amount"+serialno).value = '';
		...
		//document.getElementById("medicinename"+serialno).value = Varmedicinename1;

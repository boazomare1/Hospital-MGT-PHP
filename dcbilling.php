...
$query91 = "select * from master_triagebilling order by auto_number desc limit 0, 1";
	 $exec91 = mysqli_query($GLOBALS["___mysqli_ston"], $query91) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
	 $rowcount91 = mysqli_num_rows($exec91);
	if ($rowcount91 == 0)
	{

		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Medicine Issue List </strong></td>
...

{
    ...
    $query9 = "select storecode from master_employeelocation where username = '$username' and locationcode = '$locationcode' and defaultstore='default'";
...
?>
		...
		$query1 = "select * from pharmacysales_details where locationcode = '".$locationcode."' AND patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and issuedfrom <> 'ip' and patientcode<>'walkin' and entrydate between '$fromdate' and '$todate' and store='$store' group by docnumber order by auto_number desc";
	    ...
	    $docnumber=$res1['docnumber'];
          ...
          <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="print_medicineissuenew.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $docnumber; ?>"><strong>Medicine Issued</strong></a></td>

    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
             ...
             <form name="cbform1" method="post" action="labtestbydatereport_duplicate.php">
                  ...
                  <tbody>
                    ...
                    <tr bgcolor="#011E6A">
					 ...
					 <tr bgcolor="#011E6A">
                      ...
                      <td  bgcolor="#fff" class="bodytext3"><strong>Test Name</strong></td>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="600" align="left" border="0">
          ...
          <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ffffff"><strong>OP Tests</strong></td>
            ...
            <tr>
			 ...
			 <tr bgcolor="#9999FF">
			  ...
			  <?php
$totalcount1=0;
		  $query1 = "select labitemname,labitemcode,labsamplecoll,consultationdate,patientcode,patientvisitcode  from consultation_lab where  labsamplecoll = 'completed' and labitemcode like '%$itemcode%' and consultationdate between '$transactiondatefrom' and '$transactiondateto' group by labitemcode";
		  ...
		  while($res1 = mysqli_fetch_array($exec1))
		   {
			...
			$countitem=0;
			$query2 = "select  labitemname,labitemcode,labsamplecoll,consultationdate,patientcode,patientvisitcode,sampleid from consultation_lab where labsamplecoll = 'completed' and consultationdate between '$transactiondatefrom' and '$transactiondateto' and labitemcode = '$res1itemcode' and labitemrate<>'0.00' ";
           ...
           <tr <?php echo $colorcode; ?>>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ecf0f5"><strong>Total Count</strong></td>

              <td class="bodytext31" valign="center"  align="center" 

                bgcolor="#ecf0f5"><strong><?php echo $totalcount1; 
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ffffff"><strong>IP Tests</strong></td>
...
$colorloopcount=0;
		  ...
		  $query1 = " select labitemname,labitemcode,labsamplecoll,consultationdate from ipconsultation_lab where  labsamplecoll = 'completed' and labitemcode like '%$itemcode%' and consultationdate between '$transactiondatefrom' and '$transactiondateto' group by labitemcode ";
		  ...
		  while($res1 = mysqli_fetch_array($exec1))

		   {
			 ...
			 $query2 = " select labitemname as item, count(labitemcode) as countitem from ipconsultation_lab where labsamplecoll = 'completed' and consultationdate between '$transactiondatefrom' and '$transactiondateto' and labitemname = '$res1itemname' group by labitemname";
           ...
           <tr <?php echo $colorcode; ?>>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="center" 
                ...
                bgcolor="#ecf0f5"><strong><?php echo $totalcount; $grandtotal= $grandtotal+$totalcount;?></strong></td>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ecf0f5"><strong>Grand Total Count</strong></td>

              <td class="bodytext31" valign="center"  align="center" 

                bgcolor="#ecf0f5"><strong><?php echo  $grandtotal;?></strong></td>
			  ...
			  ?>
              	...
              	<a href="xl_labstasticst.php?itemname=<?= $itemname ?>&&itemcode=<?= $itemcode ?>&&cbfrmflag1=cbfrmflag1&&ADate1=<?= $transactiondatefrom ?>&&ADate2=<?= $transactiondateto ?>" target="_blank"> <img src="images/excel-xls-icon.png" width="30" height="30" /> </a>

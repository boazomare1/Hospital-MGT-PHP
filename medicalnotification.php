...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="medicalnotification.php">
	...
	<form name="form1" id="form1" method="post" action="medicalnotification.php">	
	  <tr>
        <td>
              ...
              <tr <?php echo $colorcode; ?>>
				...
				<img src="images/female.png" width="16" height="16" border="0" />
				 ...
				 ?>
					...
					<td class="bodytext31" valign="center"  align="left">
				<div align="center">
				<select name="patientaction" id="patientaction" onChange="window.open(this.options[this.selectedIndex].value,'_blank')">
				<option value="#">Select</option>
				<option value="editpatient.php?patientcode=<?php echo $res2customercode; ?>&&menuid=<?php echo $menu_id; ?>">Edit Registration</option>
				<option value="medical_report.php?patientcode=<?php echo $res2customercode; ?>&&menuid=<?php echo $menu_id; ?>">Medical Report</option>
				<option value="birth_notification.php?patientcode=<?php echo $res2customercode; ?>&&menuid=<?php echo $menu_id; ?>">Birth Notification</option>
				<option value="death_notification.php?patientcode=<?php echo $res2customercode; ?>&&menuid=<?php echo $menu_id; ?>">Death Notification</option>
				</select>
				</div>	</td>
                  </tr>
			  <?php

...
<?php 
$query8 = "SELECT visitcode,docno,fxamount,transactiondate,accountname FROM `master_transactionpaylater` WHERE `docno` LIKE '%Cr.N%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'paylatercredit' order by auto_number";
...
$i = 0;
$drresult = array();
$querydr1bnk = "SELECT SUM(`fxamount`) as income FROM `refund_paylaterconsultation` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `refund_paylaterlab` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`amount`) as income FROM `refund_paylaterpharmacy` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `refund_paylaterradiology` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `refund_paylaterservices` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`referalrate`) as income FROM `refund_paylaterreferal` WHERE billnumber = '$docno'";

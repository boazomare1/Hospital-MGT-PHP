...
?>
    ...
    <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		...
		<tr>
			...
			<td colspan="8"  align="center" valign="middle" bgcolor="#ffffff" class="bodytext31"> <strong>Supplier Outstanding</strong></td> 
...
$query69 = "select * from supplier_debit_transactions where approve_id='$res45billnumber'";
		...
		<tr>
			...
			<td colspan="7" class="bodytext31" valign="center"  align="left" >&nbsp;</td>
               ...
               <td width="160" class="bodytext31" valign="center"  align="right" 
              ...
              <td width="160" class="bodytext31" valign="center"  align="right" 
           	 ...
           	 <td width="220" class="bodytext31" valign="center"  align="right" 
            ...
            <td class="bodytext31" valign="center"  align="right" 
                ...
                ><?php echo number_format($totalsum,2,'.',','); ?> &nbsp; &nbsp;</td>

...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$searchsuppliername='';
			 ...
			 $totalamount1 = 0;
				...
				?>
			<?php
			$query22 = "select accountname,id,auto_number from master_accountname where auto_number = '$acc_id' and recordstatus <>'DELETED' ";
			...
			?>
			<tr bgcolor="#ecf0f5">
            <td colspan="16"  align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo $res22accountname;?></strong></td>
            </tr>
		  ...
		  $query4 = "select servicesitemcode,serviceqty,refundquantity from consultation_services where patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode' and consultationdate between '$ADate1' and '$ADate2'  and wellnessitem <> '1'";
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr <?php echo $colorcode; ?>>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo number_format($totalservices,2); ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo number_format($totalpharmacy,2); ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo number_format($totalradiology,2); ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo number_format($totalconsultation,2); ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo number_format($totalreferrel,2);?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
			...
			<a href="viewopcreditxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>
			</tr>-->
          </tbody>
        </table></td>
      </tr>

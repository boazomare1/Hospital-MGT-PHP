    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="791" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong> Shiftwise Report</strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query31 = "select * from shift_tracking as st LEFT JOIN master_employeelocation as mel ON st.username = mel.username where mel.locationcode='$locationcode1' and st.username = '$searchemployeename' and st.lastupdate between '$ADate1' and '$ADate2' GROUP BY st.auto_number order by st.auto_number desc";

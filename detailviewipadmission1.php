  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <?php
		$totaladmncharges = 0;
		$query66 = "SELECT * FROM `billing_ipadmissioncharge` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' and visitcode in(select visitcode from master_ipvisitentry where accountname ='$acc_id')";

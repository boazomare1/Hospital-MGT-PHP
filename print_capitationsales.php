...
//header location
	...
	$query55 = "select * from debtors_invoice where billnumber='$billnumber'";
	$exec55=mysqli_query($GLOBALS["___mysqli_ston"], $query55) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	$num55=mysqli_num_rows($exec55);
	$res55=mysqli_fetch_array($exec55);
	$billdate = $res55['entrydate'];
	$accountname = $res55['accountname'];
	$accountcode = $res55['accountcode'];
	
	$query14 = "select * from master_accountname where locationcode='$locationcode' and id='$accountcode'";
...
<table align="center">
  <tr>
    <td colspan="6" style="text-transform:uppercase" class="bodyhead">Debtors Invoice</td></tr>
	<tr>
   	  <td class="bodytextbold">Account:</td>
      <td width="300px"><?php echo $accountname;?></td>
        <td colspan="2">&nbsp;</td>
    ...
    <tr>
        ...
        <td colspan="2"><?php //echo $accountname;?></td>
        <td>&nbsp;</td>
...
<table align="center" border="1px #000000" class="adjust">
	<tr>
		<td class="bodytextbold" align="center">Sno</td>
...
<?php
	$sno = 1;
	$totalqty = 0;
	$query34="select * from debtors_invoice where billnumber='$billnumber'";
...
?>
	<tr>
		...
		<td class="bodytext" align="right"><?php echo number_format($rate,2,'.',',');?></td>
...
?>
	<tr>
		<td class="bodytextbold" align="right" colspan="4" > Grand Total </td>
		<td class="bodytextbold" align="right"><?php echo number_format($netamount,2,'.',',');?></td>
	</tr>
	<tr>
		<td colspan="5" class="bodytext35" width="300" ><strong><?php if($currency=='USD'){  echo $currency." "; ?></strong><?php echo str_replace('Kenya Shillings','',$convertedwords); }else{?> Kenya Shillings </strong><?php echo str_replace('Kenya Shillings','',$convertedwords); }?></td>
...
$dompdf->stream("Direct Invoice.pdf", array("Attachment" => 0)); 
?>
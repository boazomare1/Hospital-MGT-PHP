function insertitem10()
{
	...
	{
		alert("Please select bloodgroup name");
		document.cbform1.bloodgroup.focus();
		return false;
	}
	if(document.cbform1.quantity.value=="")
	{
		alert("Please enter quantity name");
		document.cbform1.quantity.focus();
		return false;
	}
	if(document.cbform1.batchnumber.value=="")
	{
		alert("Please enter batchnumber name");
		document.cbform1.batchnumber.focus();
		return false;
	}
...
var varItemExpiryDateLength = varItemExpiryDate.length;
	...
	{
		alert ("Expiry Year Should Be Between 2015 And 2025.");
		document.getElementById("expirydate").focus();
		return false;
	}
	...
	var varMedicineName = document.getElementById("bloodgroup").value;
	
	
	var varBatch = document.getElementById("batchnumber").value;
	var varQuantity = document.getElementById("quantity").value;
	var varexpirydate=document.getElementById("expirydate").value;
	...
	text11.id = "bloodgroup"+i+"";
	text11.name = "bloodgroup"+i+"";
	text11.type = "text";
	text11.align = "left";
	text11.size = "25";
	...
	//var text5 = document.createElement ('<input name="rateperunit'+i+'" value="'+varItemMRP+'" id="rateperunit'+i+'" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="6" />');
	var text5 = document.createElement ('input');
	text5.id = "expirydate"+i+"";
	text5.name = "expirydate"+i+"";
	text5.type = "text";
	text5.size = "8";
	text5.value = varexpirydate;
	text5.readOnly = "readonly";
	text5.style.backgroundColor = "#FFFFFF";
	text5.style.border = "0px solid #001E6A";
	text5.style.textAlign = "left";

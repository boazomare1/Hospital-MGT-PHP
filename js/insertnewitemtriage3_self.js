...
function insertitem4()
{
	...
	{
		alert("Please select services name");
	...
	text111.id = "servicescode5"+m+"";
	text111.name = "servicescode5[]"+m+"";
	text111.type = "hidden";
	text111.align = "left";
	text111.size = "25";
	text111.value = varServicescode;
	...
	totalamount3=parseInt(totalamount3) + parseInt(varserviceamount.replace(/[^0-9\.]+/g,""));
	//alert(totalamount3);
	...
	var varLab = document.getElementById("servicescode").value = "";

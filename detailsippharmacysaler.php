  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <?php
		$totalpharmacysale = 0;
		$query66 = "SELECT patientcode,billdate,patientvisitcode, sum(amountuhx) as rateuhx FROM `billing_ippharmacy` WHERE billdate BETWEEN '$ADate1' AND '$ADate2' group by patientvisitcode";

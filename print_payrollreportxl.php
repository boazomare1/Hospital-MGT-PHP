...
<table border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
	...
	<tr bgcolor="#FFFFFF">
	<td align="left" class="bodytext3">&nbsp;</td>	
	<td colspan="30" align="left" class="bodytext3"><strong>MONTH OF PAY : <?php echo $searchmonthyear; ?></strong></td>
	</tr>
	<tr>
	<td width="35" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>S.No</strong></td>
	<td width="101" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>EMPLOYEE CODE</strong></td>
	<td width="250" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>EMPLOYEE NAME</strong></td>
	<?php
	$totalamount = '0.00';
	...
	?>
	<td align="center" bgcolor="#FFFFFF" class="bodytext3" width="64"><strong><?php echo $componentname; ?></strong></td>
	<?php
	}
	?>
	<td align="center" bgcolor="#FFFFFF" class="bodytext3" width="64"><strong>GROSS PAY</strong></td>
	<td align="center" bgcolor="#FFFFFF" class="bodytext3" width="64"><strong>DEDUCTIONS</strong></td>
	<!--<td align="center" bgcolor="#FFFFFF" class="bodytext3" width="84"><strong>NOTIONAL BENEFIT</strong></td>-->
	<td align="center" bgcolor="#FFFFFF" class="bodytext3" width="64"><strong>NETT PAY</strong></td>
	</tr>
	<?php
	$totalamount = '0.00';
	...
	{	
		...
		$query31 = "select * from details_employeepayroll where employeename like '%$searchemployeename%' and paymonth = '$searchmonthyear' and status <> 'deleted'";
	...
	<tr bgcolor="#FFFFFF">
	<td colspan="3" align="right" class="bodytext3"><strong>Total :</strong></td>
	<?php
	$totalamount = '0.00';
	$query1 = "select * from master_payrollcomponent where recordstatus <> 'deleted' order by typecode, auto_number";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	$totalamount = '0.00';
		...
		$query3 = "select * from details_employeepayroll where employeename like '%$searchemployee%' and paymonth = '$searchmonthyear' and componentanum = '$componentanum' and status <> 'deleted'";
		$exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	?>
	<?php
	$query60 = "select sum(componentamount) as totalgross from details_employeepayroll where employeename like '%$searchemployee%' and paymonth = '$searchmonthyear' and componentname = 'GROSSPAY' and status <> 'deleted'";
	...
	<?php
	$query61 = "select sum(componentamount) as totaldeduct from details_employeepayroll where employeename like '%$searchemployee%' and paymonth = '$searchmonthyear' and componentname = 'TOTALDEDUCTIONS' and status <> 'deleted'";
	...
	<?php
	$query62 = "select sum(componentamount) as totalnett from details_employeepayroll where employeename like '%$searchemployee%' and paymonth = '$searchmonthyear' and componentname = 'NETTPAY' and status <> 'deleted'";
	...
	<tr>
	<td colspan="30" align="left" class="bodytext3">&nbsp;</td>
	</tr>
	<tr>
	<td colspan="30" align="left" class="bodytext3">&nbsp;</td>
	</tr>
	...
	<td align="left" class="bodytext3">&nbsp;</td>
	<td align="left" class="bodytext3">&nbsp;</td>
	<td colspan="6" align="left" class="bodytext3"><strong>Prepared By :___________________________________</strong></td>
	<td colspan="6" align="left" class="bodytext3"><strong>Checked By :___________________________________</strong></td>
	<td colspan="10" align="left" class="bodytext3"><strong>Authorized By :___________________________________</strong></td>
	</tr>
	<tr>
	<td colspan="30" align="left" class="bodytext3">&nbsp;</td>
	</tr>
	...
	<td align="left" class="bodytext3">&nbsp;</td>
	<td align="left" class="bodytext3">&nbsp;</td>
	<td colspan="6" align="left" class="bodytext3"><strong>Signature :___________________________________</strong></td>
	<td colspan="6" align="left" class="bodytext3"><strong>Signature :___________________________________</strong></td>
	<td colspan="10" align="left" class="bodytext3"><strong>Signature :___________________________________</strong></td>
	</tr>
	<tr>
	<td colspan="30" align="left" class="bodytext3">&nbsp;</td>
	</tr>
	...
	<td align="left" class="bodytext3">&nbsp;</td>
	<td align="left" class="bodytext3">&nbsp;</td>
	<td colspan="6" align="left" class="bodytext3"><strong>Date :___________________________________</strong></td>
	<td colspan="6" align="left" class="bodytext3"><strong>Date :___________________________________</strong></td>
	<td colspan="10" align="left" class="bodytext3"><strong>Date :___________________________________</strong></td>
	</tr>
	</tbody>
	</table> 
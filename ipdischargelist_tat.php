    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="ipdischargelist_tat.php">
		...
		<table width="510" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Inpatient Discharge TAT</strong></td>
...
?>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			<td align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31"><a target="_blank" href="ipdischargelist_tatxl.php?cbfrmflag1=cbfrmflag1&location=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom;?>&ADate2=<?php echo $transactiondateto; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>
			...
			<tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
                ...
                ><?php echo $res50['visitcode'];?></td>

            

              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 

                ><?php echo $res50['recorddate'].' '.$res50['recordtime'];?></td>
...
//echo "the totalhours--->".$total_hours;
//echo "the totalminutes--->".$total_minutes;
...
$total_time=$days." Days ".$hours.":".$minutes;
            ...
            <tr>
              ...
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
                ...
                bgcolor="#ecf0f5"><strong><?php echo $total_time;?></strong></td>

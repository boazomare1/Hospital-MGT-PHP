	...
	<div class="row">
		<div class="col-6">
			...
			<table>
				...
				<tr>
					<td align="center" colspan="7" ><b>Income Statement</b></td>
				</tr>
				<tr>
			...
			<?php
				...
				{       
					...
					echo "<tr style='font-weight:bold;'> <td colspan='5' align='right'>P & L : </td> <td  colspan='2' align='right'>".showAmount($balance_sheet,'1')." </td> </tr>";

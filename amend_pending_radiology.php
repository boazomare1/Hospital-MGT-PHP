...
// Get pending radiology consultations count
$querynw1 = "select * from consultation_radiology where resultentry='pending' and paymentstatus = 'pending' group by patientvisitcode order by consultationdate desc";
...
<head>
    ...
    <title>Amend Pending Radiology - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/amendpendingradiology-modern.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <nav class="nav-breadcrumb">
        ...
        <span>→</span>
        <span>Amend Pending Radiology</span>
    </nav>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2><i class="fas fa-x-ray"></i> Amend Pending Radiology</h2>
                    <p>Manage and update pending radiology consultations and results</p>
                </div>
            ...
            <div class="search-form-section">
                <div class="search-form-header">
                    ...
                    <h3 class="search-form-title">Search Radiology Consultations</h3>
                </div>
                
                <form id="searchForm" name="cbform1" method="post" action="amend_pending_radiology.php">
                    <div class="form-row">
            ...
            <div class="data-table-section">
                <div class="data-table-header">
                    <i class="data-table-icon fas fa-x-ray"></i>
                    <h3 class="data-table-title">Pending Radiology Consultations</h3>
                    <div class="table-summary">
                        ...
                        <div class="summary-item">
                            ...
                            <span>Pending Radiology: <strong><?php echo $resnw1; ?></strong></span>
                        </div>
                    </div>
                </div>
                
                <div class="table-container">
                    <table class="data-table" id="radiologyTable">
                        <thead>
                            <tr>
                                <th>No.</th>
                        ...
                        <tbody id="radiologyTableBody">
                            <?php
                            $colorloopcount = '';
                            $sno = '';
                            
                            // Query for pending radiology consultations
                            $query1 = "select * from consultation_radiology where resultentry='pending' and patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and consultationdate between '$ADate1' and '$ADate2' and paymentstatus = 'pending' and billtype = 'PAY NOW' group by patientvisitcode order by consultationdate DESC";
                            ...
                            <tr class="<?php echo $rowClass; ?>">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="amendradiology.php?patientcode=<?php echo htmlspecialchars($patientcode); ?>&visitcode=<?php echo htmlspecialchars($visitcode); ?>&menuid=<?php echo $menu_id; ?>" 
                                           class="action-btn amend" title="Amend Radiology Consultation">
                                        ...
                                        <button class="action-btn radiology" 
                                                onclick="viewRadiologyDetails('<?php echo htmlspecialchars($patientcode); ?>', '<?php echo htmlspecialchars($visitcode); ?>')"
                                                title="View Radiology Details">
                            ...
                            // Query for additional pending consultations
                            $query11 = "select * from consultation_radiology where resultentry='pending' and patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and consultationdate between '$ADate1' and '$ADate2' and paymentstatus = 'pending' and billtype != 'PAY NOW' group by patientvisitcode order by consultationdate DESC";
                            ...
                            <tr class="<?php echo $rowClass; ?>">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button class="action-btn view" 
                                                onclick="viewPatientDetails('<?php echo htmlspecialchars($patientcode); ?>', '<?php echo htmlspecialchars($patientcode); ?>')"
                                                title="View Patient Details">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="action-btn print" 
                ...
                <div class="no-data-message">
                    ...
                    <p>No pending radiology consultations found for the selected criteria.</p>
    ...
    <!-- Modern JavaScript -->
    <script src="js/amendpendingradiology-modern.js?v=<?php echo time(); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (totalRecords) {
                const rows = document.querySelectorAll('#radiologyTableBody tr');

...
$requestuser = $_REQUEST['requestuser'];
...
foreach($_POST['rownumber'] as $key => $value)
	 ...
	 $medicinequery2="insert into master_stock_transfer(fifo_code,docno,fromstore,tostore,itemcode,itemname,transferquantity,batch,fromstorequantitybeforetransfer,fromstorequantityaftertransfer,tostorequantitybeforetransfer,tostorequantityaftertransfer,rate,amount,username,ipaddress,companyanum,locationcode,recordstatus,entrydate,categoryname,typetransfer,locationname,requestdocno,requestuser)values('$fifo_code','$billnumbercode1','$fromstore','$tostore','$medicinecode','$medicinename','$transferquantity','$batchnumber','$fromstorequantitybeforetransfer','$fromstorequantityaftertransfer','$tostorequantitybeforetransfer','$tostorequantityaftertransfer','$rate','$amount','$username','$ipaddress','$companyanum','$locationcode','completed','$updatedatetime','$categoryname','$typetransfer','$locationname','$requestdocno','$requestuser')";
	...
	$execquery2=mysqli_query($GLOBALS["___mysqli_ston"], $medicinequery2) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		echo "<script>window.open('print_stockrequest_new.php?docno=$requestdocno&&transdoc=$billnumbercode1', '_blank');</script>";
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" id="cbform1" method="post" action="stocktransfer_new.php">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="217" align="left" valign="middle"><span class="bodytext32">
                        ...
                        <input type="hidden" name="requestuser" value="<?php echo $requestuser; ?>">

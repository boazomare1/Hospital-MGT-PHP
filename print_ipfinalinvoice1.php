...
//			  }
			...
			$fxrate = $original_fxrate;
			  ...
			  $query19 = "select * from ipconsultation_lab where patientvisitcode='$visitcode' and patientcode='$patientcode' and labitemname <> ''  and freestatus='No' and labrefund='norefund' order by consultationdate";
			...
			<!-- <input name="medicinename[]" type="hidden" id="medicinename" size="25" value="<?php echo $phaname; ?>">
			 ...
			 <td class="bodytext31" valign="center"  align="right" width="75"><?php echo number_format($resamount,2,'.',',');; ?></td>
			  ...
			  <?php 
				  ...
				  $query19 = "select * from ipconsultation_lab where locationcode='$locationcode' and patientvisitcode='$visitcode' and patientcode='$patientcode' and labitemname <> ''  and freestatus='No' and labrefund='norefund' order by consultationdate";
		...
		<tr>
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left"width="225"> <?php echo 'NHIF- Gain / Loss'; ?></td>
			...
			<tr>
			 ...
			 if(number_format($overalltotal,2,'.','')==""){ $overalltotal=0; } else{ $overalltotal=$overalltotal; }
			  ...
			  $consultationtotal=$totalop;
			   ...
			   $gross_amount=$payoveralltotal-$gross_discount;
...
$res11subtotalamount=$gross_amount;

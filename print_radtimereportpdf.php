		...
		<table id="AutoNumber3"
            ...
            align="left" border="1" style="border-collapse:collapse;">
              ...
              <td  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><strong>Patient Prepare</strong></td>

                <td  align="left" valign="center" 

                bgcolor="#ffffff" class="bodytext31"><strong>Image  Aquisition</strong></td>
          ...
          <tr>
			  ...
			  <?php echo $patientname; ?></td>
			   ...
			   <?php echo $aquisition_datetime; ?>
			    ...
			    <?php echo $reporting_datetime; ?></td>

      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$colorloopcount = '';
			$sno = '';
			$query34="select * from purchase_indent where docno='$pono' and approvalstatus like '%reject%'";
			$exec34=mysqli_query($GLOBALS["___mysqli_ston"], $query34) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ecf0f5"><a href="viewpurchaseindentstatus.php"><strong>Back</strong></a></td>
              </tr>
          </tbody>
        </table></td>
      </tr>

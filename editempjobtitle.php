...
if ($frmflag1 == 'frmflag1')
{
	...
	//echo $length;
	$query1 = "update master_jobtitle set jobtitle='$jobtitle', ipaddress='$ipaddress', recorddate='$updatedatetime', username='$username' where auto_number = '$anum'";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
...
if ($st == 'edit')
{
	...
	$query1 = "select * from master_jobtitle where auto_number = '$editanum'";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
	$res1 = mysqli_fetch_array($exec1);
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="editempjobtitle.php" onSubmit="return addward1process1()">
              ...
              <td colspan="4" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
               <input type="text" name="jobtitle" id="jobtitle" size="30" value="<?= $jobtitle; ?>" style="border: 1px solid #001E6A; text-transform:uppercase;">
              </span></td>
              </tr>
                      ...
                      <tr>
						...
						<input type="hidden" name="anum" id="anum" value="<?= $auto_number; ?>">

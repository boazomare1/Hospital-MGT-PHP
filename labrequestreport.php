    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Lab Request Report</strong></td>
	  ...
	  <tr>
        <td>
	<form name="form1" id="form1" method="post" action="labrequestreport.php">	
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="2" cellpadding="0" width="90%" 
            align="left" border="0">
          <tbody>
             <tr>
            ...
            <tr>
             ...
             <td width=""  align="left" valign="center" 
				...
				<td width=""  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>External Lab</strong></div></td>
				...
				<td width=""  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>ResultEntry</strong></div></td>
		 ...
		 $colorloopcount = $colorloopcount + 1;
           ...
           <tr>
             <td height="45"  align="left" valign="center" class="bodytext31" colspan="6"><div align="right"><strong>Grand Total</strong></div></td>
			   <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31" align="right"><strong><?= number_format($grandtotal,2) ?></strong></div></td>
             </tr>
			 
			 
			 <tr>
			
             <td height="45"  align="left" valign="center" class="bodytext31" colspan="2"><div align="right"><strong>Lab Count</strong></div></td>
			  ...
			  <td height="45"  align="left" valign="center" class="bodytext31" colspan="2"><div align="right"><strong>Lab Pending Count</strong></div></td>
			   <td class="bodytext31" valign="center"  align="left">

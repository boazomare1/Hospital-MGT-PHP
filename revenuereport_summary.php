...
<head>
    ...
    <title>Revenue Report Summary - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/revenuereport_summary-modern.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <header class="hospital-header">
        ...
        <p class="hospital-subtitle">Revenue Report Summary</p>
    </header>
...
?>
    ...
    <!-- Modern JavaScript -->
    <script src="js/revenuereport_summary-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

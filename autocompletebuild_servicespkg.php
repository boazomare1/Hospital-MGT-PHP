...
$query1 = "select * from $tablenames where status <> 'Deleted' AND rateperunit <> 0 and itemcode not in (select itemcode from package_processing where visitcode='$visitcode' and add_pkg_trackid='' and package_item_type='SI') order by itemname";

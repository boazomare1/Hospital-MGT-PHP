...
<tr>
<td colspan="12" align="center" valign="middle"><strong>OP Deposit</strong></td>
</tr>
...
<td align="right"><strong>Deposit (Cr)</strong></td>
<td align="right"><strong>Cashcode</strong></td>
<td align="right"><strong>Bankcode</strong></td>
<td align="right"><strong>Mpesacode</strong></td>
<td align="right"><strong>Total</strong></td>
<td align="right"><strong>Diff</strong></td>
<td align="center"><strong>Status</strong></td>
</tr>
<?php 
$query8 = "SELECT transactiondate, docno, patientname, transactionamount, visitcode, cashcode, bankcode, mpesacode FROM `master_transactionadvancedeposit` WHERE `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
		   UNION ALL SELECT transactiondate, docno, patientname, transactionamount, visitcode, cashcode, bankcode, mpesacode FROM `master_transactionipdeposit` WHERE `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactionmodule` = 'PAYMENT'";
	...
	if($parentid != '' && $tbinclude != '')
	{
		if($parentid == '16' || $parentid == '17' || $parentid == '18')
		{
			...
			{  
				...
				$j = 0;
				$crresult = array();
				$querycr1 = "SELECT SUM(`cashamount`) as bankamount FROM `master_transactionadvancedeposit` WHERE `cashcode` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
		...
		else if($parentid == '21')
		{
			...
			{  
				...
				$i = 0;
				$result = array();
					$querydr1 = "SELECT SUM(`transactionamount`) as deposit FROM `master_transactionadvancedeposit` WHERE `transactiondate` BETWEEN '$ADate1' AND '$ADate2'

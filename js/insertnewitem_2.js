...
//alert(document.getElementById("serial1").value);
	...
	var varlabr=Number(varlabRate.replace(/[^0-9\.]+/g,""));
	...
	text8.type = "text";
	text8.size = "8";
	text8.value = formatMoney(varlabr);
	...
	text11.onclick = function() { return btnDeleteClick1(j,varlabr); }
	...
	totalamount1=parseFloat(totalamount1) + parseFloat(varlabr);

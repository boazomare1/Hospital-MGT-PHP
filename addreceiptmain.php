      ...
      <tr>
            ...
            <tr>
              <td><form name="form1" id="form1" method="post" action="addreceiptmain.php" onSubmit="return addreceiptmain1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Receipt Main  - Add New </strong></td>
                      </tr>
					  <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>Receipt Main - Existing List </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">
		...
		?>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Receipt Main - Deleted </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">

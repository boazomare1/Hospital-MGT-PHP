...
$res6itemname=$res6['itemname'];
 ...
 $query8 = "select formula from master_medicine where itemcode='$res2medicinecode'";
...
echo "TAKE"."&nbsp;".$res2dose."&nbsp;".$dosemeasure."&nbsp;".$timely."&nbsp;"."FOR"."&nbsp;".$res2days."&nbsp;"."DAYS"."&nbsp;"."&nbsp;"."BY"."&nbsp;".$res2route."&nbsp;";				
				}
				?>
  ...
  <tr>
    <td  align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong><?php echo $res7patientfullname; ?></strong></td>
    </tr>
	<tr>
  ...
  <tr>
    <td  class="bodytext31"  valign="center"  align="left" 
                bgcolor="#ffffff"><strong>Date:<?php echo date('d/m/Y ',$phpdate); ?></strong>&nbsp;&nbsp;<strong><?php echo $companyname; ?></strong></td>
  </tr>
...
try
{
$html2pdf = new HTML2PDF('L', array(35,80),'en', true, 'UTF-8', array(0, 0, 0, 0));

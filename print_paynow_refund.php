...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="bodytext39" valign="center"  align="right"><?php echo number_format($labrate,2,'.',','); ?></td>
    <td class="bodytext39" valign="center"  align="right"><?php echo number_format($labrate,2,'.',','); ?></td>
  </tr>
  <?php
			}
...
$forall = $resplan['forall'];
  ...
  <tr>
    ...
    <td  align="right" valign="center" class="bodytext40">Total:</td>
    <td class="bodytext40" valign="center"  align="right"><?php echo number_format($overalltotal,2,'.',','); ?></td>
  </tr>
...
-->
  ...
  <tr>
    ...
    <td class="bodytext31" align="left"><?php echo $res27transactiontime; ?></td>

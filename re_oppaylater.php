...
<?php 
$query8 = "SELECT visitcode,billnumber,transactionamount,transactiondate,accountname,fxamount FROM `master_transactionpaylater` WHERE `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'finalize' AND `billnumber` LIKE 'CB%' order by auto_number";
...
$i = 0;
$drresult = array();
$querydr1bnk = "SELECT SUM(`fxamount`) as income FROM `billing_paylaterconsultation` WHERE billno = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_paylaterlab` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_paylaterpharmacy` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_paylaterradiology` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_paylaterservices` WHERE billnumber = '$docno' and  wellnessitem <> '1'
UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_paylaterreferal` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_referal` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_opambulancepaylater` WHERE billnumber = '$docno'
UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_homecarepaylater` WHERE billnumber = '$docno'";
	...
	if($parentid != '' && $tbinclude != '')
	{
		if($parentid == '15' || $parentid == '41' || $parentid == '16' || $parentid == '17' || $parentid == '18')
		{
			...
			{  
				...
				$j = 0;
				$crresult = array();
				$querycr1 = "SELECT SUM(`fxamount`) as paylater FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'finalize' AND `billnumber` LIKE 'CB%'";
				$execcr1 = mysqli_query($GLOBALS["___mysqli_ston"], $querycr1) or die ("Error in Querycr1".mysqli_error($GLOBALS["___mysqli_ston"]));
				while($rescr1 = mysqli_fetch_array($execcr1))
				{
				$j = $j+1;
				$crresult[$j] = $rescr1['paylater'];
				}
		...
		else
		{
			...
			{  
				...
				if($id == '01-10041-NHL')
				{
				$querydr1 = "SELECT SUM(`fxamount`) as income FROM `billing_paylaterradiology` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'";
				}
				else if($id == '01-10031-NHL')
				{
				$querydr1 = "SELECT SUM(`fxamount`) as income FROM `billing_paylaterlab` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'";
				}
				else if($id == '01-1000-1')
				{
				$querydr1 = "SELECT SUM(`fxamount`) as income FROM `billing_paylaterpharmacy` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'";
				}
				else if($id == '03-3002-NHL')
				{
				$querydr1 = "SELECT SUM(`fxamount`) as income FROM `billing_paylaterconsultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
...
UNION ALL SELECT SUM(`fxamount`) as income FROM `billing_homecarepaylater` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2'";
				...
				{
				$querydr1 = "SELECT SUM(`fxamount`) as income FROM `billing_paylaterservices` WHERE billdate BETWEEN '$ADate1' AND '$ADate2' AND `servicesitemcode` in (SELECT `itemcode` FROM `master_services` where ledgerid='$id')";
				}

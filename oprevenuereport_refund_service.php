        ...
        <td>
          ...
          <tbody>
			...
			<td colspan="11" align = "right" >
				<a href="excel_oprevenuereport_refund_service.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&locationcode=<?php echo $locationcode; ?>"><img  width="30" height="30" src="images/excel-xls-icon.png" style="cursor:pointer;"></a>
			</td>
			</tr>
            <tr>
			...
			?>
                ...
                <tr <?php echo $colorcode; ?>>
                  ...
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php 
                  $amount=(-1)*$amount;
                  echo number_format($amount,2,'.',','); ?></div></td>
			...
			?>
				...
				<tr bgcolor="#ecf0f5">
                  ...
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php  ?></strong></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php  ?></strong></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php 
                  // $tot_amount=(-1)*$tot_amount;
                  echo number_format((-1)*$tot_amount,2,'.',',');  ?></strong></div></td>

	   ...
	   <table width="105%" border="0" cellspacing="0" cellpadding="0"><!--2ndtablestarthere  -->
		  ...
		  <tr><!--2ndtable-1strow start here  -->
				<td width="860"><!--2ndtable-1sttd start here  -->
					<form name="cbform1" method="post" action="patientweiverslist.php">
<!--3rd table start here --><table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
	...
	<!--4rth table   start here  -->	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
											...
											?>
											 ...
											 <td class="bodytext31" valign="center"  align="left"><a href="patientweivers_paylater.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $patientvisitcode; ?>&&menuid=<?php echo $menu_id; ?>"><strong>Waivers</strong></a>			  </td>
											  </tr>
											  <?php
											//}
											}
										...
										//location code get
										$locationcode= isset($_REQUEST['location'])?$_REQUEST['location']:'';	  
										$query34 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and locationcode='$locationcode' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and  paymentstatus = 'completed' and billtype = 'PAY NOW' and consultationdate between '$fromdate' and '$todate'  order by auto_number desc";

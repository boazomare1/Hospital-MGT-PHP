...
<?php if($type=='oprefunds'){ ?>
 <tr <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5" align="left"><?php echo '1'; ?></td>
               ...
               <td align="right" valign="center" bgcolor="#ecf0f5" class="bodytext31"><div class="bodytext31"><?php echo number_format((-1)*$totalrefundamount,2,'.',','); ?></div></td>
...
<tr <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" bgcolor="#CBDBFA" align="left"><?php echo '2'; ?></td>
               ...
               <td align="right" valign="center" bgcolor="#CBDBFA" class="bodytext31"><div class="bodytext31"><?php echo number_format((-1)*$totallabrefundamount,2,'.',','); ?></div></td>
...
<tr <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5" align="left"><?php echo '3'; ?></td>
               ...
               <td align="right" valign="center" bgcolor="#ecf0f5" class="bodytext31"><div class="bodytext31"><?php echo number_format((-1)*$totalradiologyrefundamount,2,'.',','); ?></div></td>
...
<tr <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" bgcolor="#CBDBFA" align="left"><?php echo '4'; ?></td>
               ...
               <td align="right" valign="center" bgcolor="#CBDBFA" class="bodytext31"><div class="bodytext31"><?php echo number_format((-1)*$totalservicesrefundamount,2,'.',','); ?></div></td>
...
<tr <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5" align="left"><?php echo '5'; ?></td>
               ...
               <td align="right" valign="center" bgcolor="#ecf0f5" class="bodytext31"><div class="bodytext31"><?php echo number_format((-1)*$totalpharmacyrefundamount,2,'.',','); ?></div></td>
...
<tr <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" bgcolor="#CBDBFA" align="left"><?php echo '6'; ?></td>
               ...
               <td align="right" valign="center" bgcolor="#CBDBFA" class="bodytext31"><div class="bodytext31"><?php echo number_format((-1)*$totalreferalrefundamount,2,'.',','); ?></div></td>
      	 ...
      	 <tr>
              ...
              <td colspan="2"  class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong>Net Revenue:</strong></td>
              <td align="right" valign="center" 
                bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo number_format((-1)*$oprefunds,2,'.',','); ?></strong></td>
       </tr>
<?php } ?>
           <!-- op refunds -->

...
//	if($refund == $itemcode)
	...
	{ //echo 'in';
		...
		$stockquery2="insert into transaction_stock (fifo_code,tablename,itemcode, itemname, transaction_date,transactionfunction,description,
			...
			'$cum_quantity', '$billnumber', '','1','1', '$getlocationcode','','$getstorecode', '', '$username', '$ipaddress','$dateonly','$timeonly','$datetimeonly','$patientcode','$visitcode','$patientname','$rate','$amount','$ledgercode','$ledgername','$incomeledger','$incomeledgercode')";
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$totalavaquantity1=0;
			$returnqty='';
		   $queryrefund = "select sum(return_quantity) as return_total,docno,refno,issue_quantity,rateperunit,freestatus,fifo_code from medicine_return_request where patientcode = '$patientcode' and visitcode = '$visitcode' and refundstatus <> 'refund'  and completestatus <> 'complete' and docno='$returndocno' GROUP BY refno,itemcode,fifo_code";
...
?>
  ...
  <td class="bodytext31" valign="center"  align="left"><div align="center">
        ...
        <input type="hidden" name="fifo_code[<?= $sno; ?>]" value="<?php echo $fifo_code; ?>">
			...
			<td class="bodytext31" valign="center"  align="left"><div align="center"><input type="text" name="returnquantity[<?= $sno; ?>]" id="returnquantity<?php echo $sno; ?>" onKeyUp="balancecalc('<?php echo $sno; ?>','<?php echo $resquantity;?>','<?php echo $nno; ?>',event)"size="7" value="<?php echo $returnqty;?>"></div></td>

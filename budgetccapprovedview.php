  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="1214" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
       ...
       <td width="96%"><table width="100%" border="0" align="left" cellpadding="4" cellspacing="4" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">

          <tbody>

		  <tr bgcolor="">

		  <td bgcolor="" class="bodytext3" colspan="5" align="left"><strong>Cost Center Budget Entries - Approved</strong></td>

		  <td bgcolor="" class="bodytext3" colspan="5" align="right"><strong><?php echo $reslocationname; ?></strong></td>
		  ...
		  <td width="9%" align="left" class="bodytext3"><strong>Budget Year </strong></td>

		  <td width="8%" align="left" class="bodytext3"><?php echo $budgetyear; ?>

		  <input type="hidden" name="byear" id="byear" value="<?php echo $budgetyear; ?>" /></td>

		  <td width="9%" align="left" class="bodytext3"><strong>Uploaded By </strong></td>
		  <td width="20%" align="left" class="bodytext3"><?php echo $uploaded_by; ?> 

		   <td width="13%" align="left" class="bodytext3"><strong>Approved By </strong></td>
		  <td width="20%" align="left" class="bodytext3"><?php echo $approved_by; ?>
		  </tr>
        ...
        <td width="1%">&nbsp;</td><td width="100%"><table width="100%" border="1" align="left" cellpadding="4" cellspacing="4" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
		  ...
		  <?php
			...
			$query1 = "select * from budgetentry where budgetno = '$docno' and recordstatus='' group by accountcode,cost_center order by auto_number";
			...
			$ledger_inc = $ledger_inc + 1;
			  ...
			  $cost_center_id = $res1['cost_center'];
		   ...
		   $query_allmonths = "select * from budgetentry where budgetno = '$docno' and accountcode='$accountcode' and cost_center='$cost_center_id'  and recordstatus='' order by budgetmonth ";
		   ...
		   while($res_allmonths=mysqli_fetch_array($exec_allmonths))
		  {
		  	...
		  	if($res_allmonths['budgetmonth'] >0)
		  	{
		  		$budgetvalue_allmonths[$res_allmonths['budgetmonth']] = $res_allmonths['ledgervalue'];

		  		$totals_allmonths[$ledger_inc][$res_allmonths['budgetmonth']] = $totals_allmonths[$ledger_inc][$res_allmonths['budgetmonth']] + $res_allmonths['ledgervalue'];
		  	}
		   ...
		   /*if($ledger_sequence_no > 1)
		   {
			...
			<td align="left" class="bodytext3"><strong><?php echo $cost_center_id; ?></strong></td>

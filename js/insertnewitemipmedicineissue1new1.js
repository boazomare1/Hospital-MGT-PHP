...
/*
	...
	*/
	...
	{
	totalamount2=Number(document.getElementById("total").value.replace(/[^0-9\.]+/g,""));
	}
...
var result = medcode.indexOf(varMedicinecode);
	console.log(result);
...
console.log(medcode);
	...
	var textw1 = document.createElement ('input');
	textw1.id = "medicinecode"+i+"";
	textw1.name = "medicinecode"+i+"";
	textw1.type = "hidden";
	textw1.size = "25";
	textw1.value = varMedicinecode;
	textw1.readOnly = "readonly";
	textw1.style.backgroundColor = "#FFFFFF";
	textw1.style.border = "0px solid #001E6A";
	textw1.style.textAlign = "left";

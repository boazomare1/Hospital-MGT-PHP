...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Lab return</strong></td>
			...
			$query1 = "SELECT billdate, billnumber, patientvisitcode, patientname, labitemrate from refund_paynowlab where billdate between '$ADate1' and '$ADate2'
			UNION ALL SELECT billdate, billnumber, patientvisitcode, patientname, labitemrate from refund_paylaterlab where billdate between '$ADate1' and '$ADate2'
			UNION ALL  select entrydate as billdate, billno as billnumber, visitcode as patientvisitcode, patientname, labfxamount as labitemrate from billing_patientweivers where entrydate between '$ADate1' and '$ADate2'
			";
			...
			$res1consultationamount = $res1['labitemrate'];
...
-->		
           ...
           <tr>
			...
			<a href="viewoprevenuereportdetailslabreturnxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="pharmatimereport.php">
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Pharma Results Time Report</strong></td>
...

{
	...
	//$docnumber=$_POST['docnumber'];
		...
		$queryn21 = "select * from master_consultationpharm where  patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%'  and recorddate between '$fromdate' and '$todate' and $pass_location and medicineissue='completed'";
            ...
            <tr>
              ...
              <td width="8%"  align="left" valign="center" 
               ...
               <!-- <td width="19%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Approved By</strong></div></td>-->
          ...
          <tr <?php echo $colorcode; ?>>
            ...
            <!--   <td class="bodytext31" valign="center"  align="center">
			   ...
			   <?php echo $preparation_datetime; ?>
			    ...
			    <div align="center"><?php echo $entrydate;?><?php echo $entrytime;?></div></td>
...
?>
             ...
             <tr>
              ...
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
                ...
                bgcolor="#ecf0f5">AWT</td>

                <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 

                bgcolor="#ecf0f5"><?php echo $averageTimeFormatted;?></td>
            ...
            <?php 
				...
				$url = "cbfrmflag1=cbfrmflag1&&patient=$searchpatient&&patientcode=$searchpatientcode&&visitcode=$searchvisitcode&&ADate1=$fromdate&&ADate2=$todate&&location=$location&&labcode=$labcode";

				?>

            <tr>

		<td colspan="3"><a href="print_pharmatimereportpdf.php?<?php echo $url; ?>"><img src="images/pdfdownload.jpg" width="30" height="30"></a></td>

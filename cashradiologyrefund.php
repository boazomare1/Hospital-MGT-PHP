...
<title>Cash Radiology Refund</title>
<!-- Modern CSS -->
<link href="css/cashradiologyrefund-modern.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
<link href="css/three.css" rel="stylesheet" type="text/css">
<!-- Modern JavaScript -->
<script type="text/javascript" src="js/cashradiologyrefund-modern.js?v=<?php echo time(); ?>"></script>
</head>
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
        <td width="860">
              <form name="cbform1" method="post" action="cashradiologyrefund.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                  <tr bgcolor="#011E6A">
              <td colspan="2"  class="bodytext3"><strong>  Radiology Cash Refund </strong></td>
              ...
              <!-- <tr>
          <td class="bodytext31" valign="center"  align="left" >Patient Type</td>
 ...
 class="bodytext31"><strong> Date From </strong></td>
          <td width="137" align="left" valign="center"   class="bodytext31"><input name="ADate1" id="ADate1" value="<?php echo $fromdate; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="9"  class="bodytext31">
                ...
                <div align="left"><strong>Radiology Cash Refund Action</strong><label class="number"></label></div></td>
				<td width="9%" colspan="4"  class="bodytext31">&nbsp;</td>
              </tr>
            <tr>
              <td class="bodytext31" valign="center"  align="left" 
><div align="left"><strong>No.</strong></div></td>
              <td width="5%"  align="left" valign="center" 
 class="bodytext31"><div align="left"><strong> OP Date</strong></div></td>
              <td width="3%"  align="left" valign="center" 
 class="bodytext31"><div align="left"><strong> OP Time</strong></div></td>
              <td width="6%"  align="left" valign="center" 
 class="bodytext31"><div align="left"><strong>Patientcode </strong></div></td>
              <td width="6%"  align="left" valign="center" 
 class="bodytext31"><div align="left"><strong>Visitcode</strong></div></td>
              <td width="9%"  align="left" valign="center" 
 class="bodytext31"><div align="left"><strong>Patient</strong></div></td>
              <td width="5%"  align="left" valign="center" 
 class="bodytext31"><strong>Age</strong></td>
              <td width="6%"  align="left" valign="center" 
 class="style1">Gender</td>
              <td width="11%"  align="left" valign="center" 
 class="bodytext31"><strong>Test</strong></td>
              <td width="9%"  align="left" valign="center" 
 class="bodytext31"><strong>Account</strong></td>
				 <td width="9%"  align="left" valign="center" 
 class="bodytext31"><div align="left"><strong>Requested by</strong></div></td>
				 <td width="12%"  align="left" valign="center" 
 class="bodytext31"><div align="left"><strong>Ward/Department</strong></div></td>
              <td width="14%"  align="left" valign="center" 
 class="bodytext31"><div align="left"><strong>Action</strong></div></td>
              <td width="3%"  align="left" valign="center" 
 class="bodytext31"><div align="left"><strong>Time</strong></div></td>
              </tr>
...
?>
	<tr>
			...
			$query1 = "SELECT a.* from consultation_radiology as a JOIN master_radiology as b ON a.radiologyitemcode=b.itemcode and b.categoryname='$categoryname' where a.patientname like '%$searchpatient%' and a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and a.prepstatus='completed' and a.billtype='PAY NOW' and resultentry!='refund' and (a.paymentstatus='completed' OR a.paymentstatus='paid') and  a.consultationdate between '$fromdate' and '$todate'  and a.locationcode='".$locationcode."'  group by a.patientvisitcode,a.radiologyitemcode,a.refno
 order by a.consultationdate ";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//

 // $query1 = "SELECT a.* from consultation_radiology as a JOIN master_radiology as b ON a.radiologyitemcode=b.itemcode and b.categoryname='$categoryname' where a.patientname like '%$searchpatient%' and a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and a.prepstatus='$searchstatus' and a.billtype='PAY NOW' and a.resultentry='pending' and (a.paymentstatus='completed' OR a.paymentstatus='paid') and  a.consultationdate between '$fromdate' and '$todate'  and a.locationcode='".$locationcode."'  group by a.patientvisitcode,a.radiologyitemcode,a.refno
 // order by a.consultationdate ";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...
$data_count++;
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="cashradiologyrefund_view.php?patientcode=<?php echo $res1patientcode; ?>&&visitcode=<?php echo $res1visitcode; ?>&&q_itemcode=<?= $radiologyitemcode ?>&&q_refno=<?= $refno ?>&&menuid=<?php echo $menu_id; ?>"><strong>View</strong></a></div></td>
				<td align="left" valign="center"  
                class="bodytext31" <?php if($waitingtime1 > 15 || $days > 1){ ?> bgcolor=" #FF0040" <?php } ?>><div align="center"><strong>
				<?php $datetime1=$res1consultationdate.' '.$consultationtime; get_time($datetime1); ?></strong></div></td>
              </tr>
			<?php
			} 

...

{
	...
	var url="automedicinecodesearchipmedicineissue.php?RandomKey="+Math.random()+"&&medicinesearch="+medicinesearch+"&&locationcode="+location+"&&storecode="+store+"&accountname="+accountname;

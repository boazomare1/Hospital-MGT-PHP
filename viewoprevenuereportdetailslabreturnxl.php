...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  <?php
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ffffff" class="bodytext31"><strong>Lab return from <?php echo $ADate1; ?> to <?php echo $ADate2; ?></strong></td>
			...
			// $query1 = "select * from refund_paynowlab where billdate between '$ADate1' and '$ADate2'";
...
*/	
         ...
         <tr>
              ...
              <td align="right" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><strong><?php echo number_format((-1)*$total6,2,'.',','); ?></strong></td></tr>

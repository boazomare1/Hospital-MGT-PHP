  ...
  <tr>
    ...
    <table width="97%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <!-- <table width="671" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1"> -->
        ...
        <form method="post" action="appprovedlist.php">
         <tr bgcolor="#011E6A">
                        <td height="27" colspan="6" bgcolor="#ecf0f5" class="bodytext31"><strong>Petty Cash Management-Approved-List </strong></td>
                </tr>
				<!-- <tr>
...
if (isset($_REQUEST["request"])) { $request= $_REQUEST["request"]; } else { $request = ""; }
	    ...
	    $sno=0;
	    $querry=" select  * from pcrequest where doc_no like '%$request%' and username like '%$user%' and currentdate between '$startdate' and '$enddate' and delete_status <>'deleted' and approved_status =1 and 	approved_status <>3 and approved_status<>2 and approved_status<>4";
	$exe=mysqli_query($GLOBALS["___mysqli_ston"], $querry);
           ...
           <tr>
            ...
            <td width="152" bgcolor="#ecf0f5" class="bodytext31"><strong>Request.No.</strong></td>
            <td width="27" bgcolor="#ecf0f5" class="bodytext31"><strong>Date</strong></td>
            <td width="144" bgcolor="#ecf0f5" class="bodytext31"><strong>Request Amount</strong></td>
            ...
            <td width="128" bgcolor="#ecf0f5" class="bodytext31"><strong>Requested By</strong></td>
            <td width="178" bgcolor="#ecf0f5" class="bodytext31"><strong>Approve By</strong></td>
		...
		while($result=mysqli_fetch_array($exe)){
			...
			$first_approvel_user=$result['first_approvel_user'];
           ...
           <td align="left" valign="top"  class="bodytext31"><?php echo $sno; ?> </td>
             <td align="left" valign="top"  class="bodytext31"><input type="hidden" name="doc" id="doc"value="<?php echo $doc_no; ?>"><?php echo $doc_no; ?> </td>
              <td align="left" valign="top"  class="bodytext31"><?php echo $date; ?> </td>
               <td align="left" valign="top"  class="bodytext31"><input type="test" name="amount" id="amount" value="<?php echo number_format($amount); ?>"> </td>
                <td align="left" valign="top"  class="bodytext31"><input type="test" name="aamount" id="aamount" value="<?php echo number_format($approved_amt); ?>"> </td>
                <td align="left" valign="top"  class="bodytext31"><?php echo $remarks; ?> </td>
                 <td align="left" valign="top"  class="bodytext31"><?php echo $username; ?> </td>
                 <td align="left" valign="top"  class="bodytext31"><?php echo $first_approvel_user; ?> </td>
                  <td align="left" valign="top"  class="bodytext31"><a href="viewapproval.php?doc=<?php echo $doc_no; ?>">View</a> </td> 

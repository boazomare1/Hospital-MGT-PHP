...
Phone No: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo $res14phone;?>
    		...
    		LPO Date : <?php echo date("d/M/Y", strtotime($billdate)); ?><br/>
    	LPO Validity : <?php echo date("d/M/Y", strtotime($lpodate)); echo '  ('.$validity_days.') days'; ?><br/>
LPO Type:<?php echo $lpo_type; ?>

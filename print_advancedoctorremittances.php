...
//echo "hii".$billnumber;
	...
	$query12 = "select * from advance_payment_entry where docno = '$docno' order by auto_number desc limit 0, 1 ";
	...
	$res12taxamount = $res12['wht_amount'];
	...
	$res12doctorname = $res12['ledger_name'];
	$res12wht = $res12['wht_perc'];
	$res12netpayable = $res12['bank_amount'];
...
<table width="530" border="0" cellpadding="0" cellspacing="0" align="center"> 
	<?php
		$query12 = "select *, (transactionamount) as totalamount, (wht_amount) as totaltax, (bank_amount) as totalpayable from advance_payment_entry where docno = '$docno' order by auto_number desc limit 0, 1 ";
		$exec12 = mysqli_query($GLOBALS["___mysqli_ston"], $query12) or die ("Error in Query12".mysqli_error($GLOBALS["___mysqli_ston"]));
		mysqli_num_rows($exec12);
		$res12 = mysqli_fetch_array($exec12);
		$res12billnumber = $res12['docno'];
	...
	?> 	
	<tr>
		<td colspan="5" style="border-bottom:solid 2px #000000;">&nbsp;</td>
	</tr>
	<tr>
<td colspan="5" style="">&nbsp;</td>
	...
	<tr>
		<td colspan ="5" class="bodytext32">Doctor : <?php echo strtoupper($res12doctorname); ?></td>
	</tr>
	<tr>
		<td colspan="5">&nbsp;</td> 
	</tr>
...
<table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
 	 ...
 	 <tr>
		...
		<td width="45" align="center" class="bodytext32" style="border:solid 1px #000000; background:#FFFFFF;border-left:none;border-right:none;"><strong>Bill No</strong></td>
		...
		<td width="25" align="right" class="bodytext32" style="border:solid 1px #000000; background:#FFFFFF;border-left:none;border-right:none;"><strong>Withholding</strong></td>
  	...
  	$query11 = "select * from advance_payment_allocation where docno = '$docno' and recordstatus='allocated' order by auto_number";
	...
	while($res11 = mysqli_fetch_array($exec11))
	{
		...
		$res11taxamount = ($res11transactionamount*$whtcentage)/100;
		$res11netpayable = $res11transactionamount - $res11taxamount;
...
$dompdf->stream("AdvancePaymentReport.pdf", array("Attachment" => 0)); 
?>
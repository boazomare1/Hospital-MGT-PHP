    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="stockinward" action="cospricethistory.php" method="post" onKeyDown="return disableEnterKey()" onSubmit="return Locationcheck()">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" 
            align="left" border="0">
      <tbody id="foo">
        <tr>
          <td colspan="6" bgcolor="#ecf0f5" class="bodytext31"><strong>Pharmacy Rate Update Report</strong></td>
          </tr>
        <tr>
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Margin</strong></div></td>
                <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Sale Price</strong></div></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Username</strong></div></td>
                 <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Date Updated</strong></div></td>
...
$sno=0;
			    $queryitem = " SELECT * from pharma_template_map WHERE dateadded BETWEEN '$ADate1' and '$ADate2'";

			    //$queryitem .= " and itemname like '%".$searchmedicinename."%'";searchitemcode

			    $queryitem .= " and productcode like '%".$medicinecode."%'";

			    $queryitem .= " order by auto_number DESC";
				...
				{   //print_r($resitems);
					$res1itemcode = $resitems['productcode'];
	
					//$res1itemname = $resitems['itemname'];
					$res1itemname = $searchmedicinename;
					...
					$query1 = "select purchaseprice from master_medicine where  itemcode='$res1itemcode' ";
					$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
					$res1 = mysqli_fetch_array($exec1);
					$cost = $res1['purchaseprice'];

					$item_rate = $resitems['rate'];
					$margin = $resitems['margin'];
					//$sell_price = ((float)$margin / 100 * (float)$item_rate) + (float)$item_rate;
					$item_entrydate = $resitems['dateadded'];
					$username = $resitems['username'];
             ...
             <td align="left" valign="center"  
              ...
              <td align="left" valign="center"  
                 class="bodytext31"><div class="bodytext31"><?php echo $res1itemcode;?></div></td>
			 ...
			 <td align="left" valign="center"  
              ...
              <td align="left" valign="center"  
                ...
                <div class="bodytext31">
                  <div align="right"><?php echo number_format($cost,'2','.',','); ?>&nbsp;</div>
                </div>
              </div></td>
              ...
              <td align="left" valign="center"  
                 class="bodytext31"><div align="right">
                <div class="bodytext31">
                  <div align="right"><?php echo $margin; ?>&nbsp;</div>
                </div>
              </div></td>
              
              <td align="right" valign="center"  
                 class="bodytext31"><div class="bodytext31"><?php echo number_format($item_rate,'2','.',','); ?>&nbsp;</div></td>
              <td align="left" valign="center"  
                 class="bodytext31"><div class="bodytext31">
                <div align="right"><?php echo $username; ?>&nbsp;</div>
              </div></td>
               <td align="left" valign="center"  
                 class="bodytext31"><div class="bodytext31">
                <div align="right"><?php echo $item_entrydate; ?>&nbsp;</div>
              </div></td>

...

{
	...
	window.open("popup_radmapmultiple.php?callfrom="+varCallFrom+'&item='+item,"Window2",'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=750,height=350,left=100,top=100');
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="850" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td colspan="15" bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>Radiology Item Map Master </strong></span></td>
                      ...
                      <tr bgcolor="#011E6A">
						...
						<form name="form1" id="form1" action="radmapmultiple.php" method="post" onSubmit="return form1valid();">
...

	  {
		...
		$search1 = $_REQUEST["search1"];
		 ...
		 $query1 = "select itemcode,categoryname,itemname,rateperunit from master_radiology  where itemname like '%$search1%' and status <> 'deleted' and exclude = 'yes'  order by itemname";
		...
		$supplierq = "select suppliercode from rad_supplierlink where itemcode = '$itemcode' and fav_supplier='1'";
...
var search1=document.getElementById('search1').value;
  ...
  source:"ajax_radmapmultiple_search.php?pid="+search1,
  minLength:1,
  html: true,

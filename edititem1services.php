...
$exec90 = mysqli_query($GLOBALS["___mysqli_ston"], $query90) or die ("Error in Query90".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);
...

{
	 ...
	 $locationname=isset($_REQUEST['locname'])?$_REQUEST['locname']:'';
	 
	$loccodeget=isset($_REQUEST['loccode'])?$_REQUEST['loccode']:'';
	...
	//get base values
	 ...
	 $groupid1 = isset($_REQUEST["groupid"])?$_REQUEST["groupid"]:'0';
...

	{
		...
		$query24 = "select * from $sertemplate where itemcode = '$itemcode' and locationcode = '$loccodeget'";// or itemname = '$itemname'";
		$exec24 = mysqli_query($GLOBALS["___mysqli_ston"], $query24) or die ("Error in Query24".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);
		$res24 = mysqli_num_rows($exec24);
		if($res24 == 0)
		{		
		$query1 = "insert into $sertemplate set itemname='$itemname', categoryname='$categoryname', rateperunit='".$locrateget."', expiryperiod='$expiryperiod', ipaddress='$ipaddress', updatetime='$updatedatetime', description='', ipmarkup='$ipmarkup',itemcode = '$itemcode',locationcode='".$loccodeget."',baseunit='".$baseunit."',incrementalquantity='".$incrementalqty."',incrementalrate='".$incrementalrate."',slab='".$slab."', pkg='$pkg',wellnesspkg='$wellnesspkg', ledgername='$saccountname',ledgerid='$saccountid',groupid='$groupid1',username='$username'";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);
		}else{
		$query1 = "update $sertemplate set itemname='$itemname', categoryname='$categoryname', rateperunit='".$locrateget."', expiryperiod='$expiryperiod', ipaddress='$ipaddress', updatetime='$updatedatetime', description='', ipmarkup='$ipmarkup',itemcode = '$itemcode',locationcode='".$loccodeget."',baseunit='".$baseunit."',incrementalquantity='".$incrementalqty."',incrementalrate='".$incrementalrate."',slab='".$slab."', pkg='$pkg',wellnesspkg='$wellnesspkg', ledgername='$saccountname',ledgerid='$saccountid',groupid='$groupid1' where itemcode = '$itemcode' and locationcode = '$loccodeget'";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);
		}
			...
			$query241 = "select * from $templatename where itemcode = '$itemcode' ";// or itemname = '$itemname'";
			$exec241 = mysqli_query($GLOBALS["___mysqli_ston"], $query241) or die ("Error in Query241".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);
			$res241 = mysqli_num_rows($exec241);
			if($res241 == 0)
			{
			$query1 = "insert into $templatename set itemname='$itemname', categoryname='$categoryname', rateperunit='".$locrateget."', expiryperiod='$expiryperiod', ipaddress='$ipaddress', updatetime='$updatedatetime', description='', ipmarkup='$ipmarkup',itemcode = '$itemcode',locationcode='".$loccodeget."',baseunit='".$baseunit."',incrementalquantity='".$incrementalqty."',incrementalrate='".$incrementalrate."',slab='".$slab."', pkg='$pkg',wellnesspkg='$wellnesspkg', ledgername='$saccountname',ledgerid='$saccountid',groupid='$groupid1',username='$username'";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);	
			}	else{
			$query1 = "update $templatename set itemname='$itemname', categoryname='$categoryname', expiryperiod='$expiryperiod', ipaddress='$ipaddress', updatetime='$updatedatetime', description='', ipmarkup='$ipmarkup',itemcode = '$itemcode',locationcode='".$loccodeget."',baseunit='".$baseunit."',incrementalquantity='".$incrementalqty."',incrementalrate='".$incrementalrate."',slab='".$slab."', pkg='$pkg',wellnesspkg='$wellnesspkg', ledgername='$saccountname',ledgerid='$saccountid',groupid='$groupid1' where itemcode = '$itemcode' and locationcode = '$loccodeget'";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);	
			}
			}
...

{
	...
	$locationname = $res67['locationname'];
	$locationcode = $res67['locationcode'];
	...
	$saccountname=$res67['ledgername'];

	$saccountid=$res67['ledgerid'];
	...
	$wellnesspkg=$res67['wellnesspkg'];

	$groupid=$res67['groupid'];
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td><form name="form1" id="form1" method="post" action="edititem1services.php" onSubmit="return additem1process1()">
                     ...
                     <td align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3">IP Mark up</td>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#ecf0f5"><input name="itemname" type="text" id="itemname" style="border: 1px solid #001E6A" onChange="return spl()" value="<?php echo $itemname; ?>" size="60"></td>
                         ...
                         <?php /*?><!--<td align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3">Location</td>

                        <td align="left" valign="top"  bgcolor="#ecf0f5"><input type="text" name="location" style="border: 1px solid #001E6A" value="<?php echo $location; ?>"></td>--><?php */?>

                 </tr>

				 <?php if($sertemplate =='master_services') {?>
				 ...
				 <td width="13%" align="left" valign="top"  bgcolor="#ecf0f5"  class="bodytext3">Income Ledger</td>
                        ...
                        <input type="text" name="saccountname" id="saccountname" size="30" value="<?php echo $saccountname;?>" />

                        <input type="hidden" name="saccountauto" id="saccountauto" />

                        <input type="hidden" name="saccountid" id="saccountid" value="<?php echo $saccountid;?>"/>
				 ...
				 <?php }?>
					  ...
					  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><div align="left">Slab</div></td>
					   ...
					   <td align="left" valign="top"  bgcolor="#ecf0f5"><input type="checkbox" name="slab" value="1" <?php if($slab=='1'){echo "checked";}?>></td>
					  ...
					  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><div align="left">Base Unit</div></td>
					   ...
					   <td align="left" valign="top"  bgcolor="#ecf0f5"><input type="text" name="baseunit" value="<?php echo $baseunit;?>" style="border: 1px solid #001E6A"></td>
					  ...
					  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><div align="left">Incremental Quantity</div></td>
					   ...
					   <td align="left" valign="top"  bgcolor="#ecf0f5"><input type="text" name="incrementalqty"  value="<?php echo $incrementalquantity;?>" style="border: 1px solid #001E6A"></td>
					  ...
					  <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><div align="left">Incremental Rate</div></td>
					   ...
					   <td align="left" valign="top"  bgcolor="#ecf0f5"><input type="text" name="incrementalrate"  value="<?php echo $incrementalrate;?>" style="border: 1px solid #001E6A"></td>
                       ...
                       <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><div align="left">Package</div></td>

					   <td align="left" valign="top"  bgcolor="#ecf0f5"><input type="checkbox" name="pkg"  value="yes" <?php if($pkg1=='yes'){ echo "checked='checked'"; } ?>></td>
					  ...
					  <tr>
					    ...
					    <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><div align="left">Wellness pkg</div></td>

					   <td align="left" valign="top"  bgcolor="#ecf0f5"><input type="checkbox" name="wellnesspkg"  value="1" <?php if($wellnesspkg=='1'){ echo "checked='checked'"; } ?>></td>
					  ...
					  <tr>  <td align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3">MIS Group</td>
                        ...
                        <td align="left" valign="top"  bgcolor="#ecf0f5"><select name="groupid">
                        	...
                        	<?php
                        		...
                        		$qmis = "select * from mis_accountname where auto_number = '$groupid'";
                        		...
                        		while($resmis = mysqli_fetch_array($execmis)){
                        			...
                        			<option value="<?php echo $id; ?>" selected><?php echo $accountname; ?></option>
                      ...
                      <?php /*?><!--<tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#ecf0f5"><input name="rateperunit" id="rateperunit" style="border: 1px solid #001E6A" value="<?php echo $rate1; ?>" size="20" />
                    ...
                    <?php
						...
						$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error().__LINE__);
                    ...
                    <?php
					   ...
					   <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#ecf0f5"><input name="rate2" id="rate2" style="border: 1px solid #001E6A" value="<?php echo $rate2; ?>" size="20" />                          </td>
				   ...
				   <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#ecf0f5"><input name="rate3" id="rate3" style="border: 1px solid #001E6A" value="<?php echo $rate3; ?>" size="20" />                          </td>
      ...
      <?php /* $query1 = "select locationcode,locationname,prefix,suffix from master_location where status <> 'deleted' order by locationname";
					...
					$exec13 = mysqli_query($GLOBALS["___mysqli_ston"], $query13) or die(mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);
      ...
      <tr>
	   ...
	   <td width="9%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
		...
		<!--<input type="checkbox" name="lcheck<?php //echo $incr;?>" id="lcheck<?php //echo $incr;?>" style="float:left" value="<?php //echo $locationcode;?>" <?php //if($rate13 != '') { ?> checked="checked" <?php //} ?>><input type="hidden" name="checklocval" value=<?php //echo $locationcode;?>"">-->

         &nbsp;<span style="width:100px;float:left;line-height:20px">Rate</span>&nbsp;<input type="text" name="locrate" style="width:90px;" value="<?php echo $rate1;?>"><input type="hidden" name="locname" style="width:90px;" value="<?php echo $locationname;?>"><input type="hidden" name="loccode" style="width:90px;" value="<?php echo $locationcode;?>"></td>

...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
      ...
      <tr>
        ...
        <tr>
        	<td colspan="2">
                ...
                <table width="436" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                   <tr bgcolor="#011E6A">
              <td width="183" colspan="1" bgcolor="#ecf0f5" class="bodytext3"><strong> Search Lab Item By Location</strong></td>
        ...
        <tr><td>&nbsp;&nbsp;</td></tr>
            ...
            <?php if($total_pages > 0)
			 { 
			  ?>	 
				 <td align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31"><a target="_blank" href="print_labitemsbylocation.php?cbfrmflag1=cbfrmflag1&&locationcode=<?php echo $locationcode; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>
              <?php
		      }
		   ?>
                      </tr>
	...
	$query1 = "select * from master_lab where  location = '".$locationcode."' and status <> 'deleted' group by itemcode order by auto_number desc LIMIT $start , $limit";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
		$labcount = mysqli_num_rows($exec1);
		while ($res1 = mysqli_fetch_array($exec1))
		{
		$itemcode = $res1["itemcode"];
		$itemname = $res1["itemname"];

...
$locrateget = isset($_REQUEST['locrate'])?$_REQUEST['locrate']:'0';
...

	{
...

		{
			...
			$query1 = "insert into master_radiology (itemcode, itemname, categoryname,  rateperunit, expiryperiod, ipaddress, pkg, updatetime, description,  referencevalue,ipmarkup,locationcode,externalshare, ledger_name,ledger_code, groupid, discount,username,exclude,locationname) 

			values ('$itemcode', '$itemname', '$categoryname',  '".$locrateget."', '$expiryperiod',  '$ipaddress', '".$pkg."', '$updatedatetime','manual',  '$referencevalue','$ipmarkup','".$loccodeget."','$externalrate' , '$saccountname','$saccountid', '$groupid1', '$discount','$username','$exclude','$loccodename')";
...

			{
				...
				$querytemp1 = "insert into `$templatename` (itemcode, itemname, categoryname,  rateperunit, expiryperiod, ipaddress, pkg, updatetime, description,  referencevalue,ipmarkup,locationcode,externalshare, ledger_name,ledger_code,locationname,username) 

			values ('$itemcode', '$itemname', '$categoryname',  '".$locrateget."', '$expiryperiod',  '$ipaddress', '".$pkg."', '$updatedatetime','manual',  '$referencevalue','$ipmarkup','".$loccodeget."','$externalrate', '$saccountname','$saccountid','$loccodename','$username')";
		 ...
		 /*<?php?>$query1 = "insert into master_renewal (itemcode, itemname, renewalmonths, ipaddress, updatetime) 
			...
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error().__LINE__);<?php ?>*/
...

{
	...
	$query3 = "update master_radiology set status = 'deleted',username = '$username',ipaddress = '$ipaddress',updatetime = '$updatedatetime' where auto_number = '$delanum'";
...

{
	...
	$query3 = "update master_radiology set status = '',username = '$username',ipaddress = '$ipaddress',updatetime = '$updatedatetime' where auto_number = '$delanum'";
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <td><form name="form1" id="form1" method="post" action="radiologyitem1.php" onSubmit="return additem1process1()">
                  ...
                  <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#ECF0F5" class="bodytext3"><input type="checkbox" name="exclude" value="yes"></td>

                        </tr>

                      <tr>

                        <td align="left" valign="middle"  bgcolor="#ECF0F5" class="bodytext3"> <div align="left">New Radiology Item Code </div></td>

                        <td align="left" valign="top"  bgcolor="#ECF0F5"><input name="itemcode" value="<?php echo $itemcode; ?>" id="itemcode" readonly onKeyDown="return process1backkeypress1()" style="border: 1px solid #001E6A; background-color:#CCCCCC" size="20" maxlength="100" />
				 ...
				 <td width="13%" align="left" valign="top"  bgcolor="#ECF0F5"  class="bodytext3">Income Ledger</td>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="middle"  bgcolor="#ECF0F5" class="bodytext3"><div align="left">Add New Radiology Item Name </div></td>
                        ...
                        <td align="left" valign="top"  bgcolor="#ECF0F5" class="bodytext3">EXT share %</td>

                        <td align="left" valign="top"  bgcolor="#ECF0F5"><input type="text" name="externalrate" style="border: 1px solid #001E6A"></td>
                      ...
                      <tr>
                       ...
                       <tr>  <td align="left" valign="top"  bgcolor="#ECF0F5" class="bodytext3">Package</td>
                        ...
                        <tr>  <td align="left" valign="top"  bgcolor="#ECF0F5" class="bodytext3">Is Discount</td>

                        <td align="left" valign="top"  bgcolor="#ECF0F5"><input type="checkbox" name="discount" value="yes"></td>
      ...
      <?php //}?><input type="hidden" name="locationcount" value="<?php echo  $incr;?>">
                      ...
                      <tr>
                        ...
                        <td width="18%" align="left" valign="top"  bgcolor="#ECF0F5" class="bodytext3">&nbsp;</td>

                        <td width="46%" align="left" valign="top"  bgcolor="#ECF0F5">&nbsp;</td>

                        <td width="16%" align="left" valign="top"  bgcolor="#ECF0F5">&nbsp;</td>

                        <td width="20%" align="left" valign="top"  bgcolor="#ECF0F5"><input type="hidden" name="frmflag" value="addnew" />
	 ...
	 /*?>	
		...
		$exec6 = mysql_query($query6) or die ("Error in Query6".mysql_error().__LINE__);

...

{
	...
	{	
...

		{
			...
			echo $serialnumber = $_REQUEST['serialnumber'.$j];
		...
		echo $medicinename=$_REQUEST['medicinename'.$j];
		...
		echo $querygetrows = "SELECT * from transaction_stock where itemcode = '$itemcode' and batch_stockstatus = '1' and storecode = '$store' and locationcode = '$fromlocationcode' ORDER BY fifo_code ASC";
...

{
	...
	header("location:storestockconsumption-test.php");
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="storestockconsumption-test.php">
			 ...
			 <td align="left" class="bodytext3"><strong></strong></td>
                ...
                <table width="1197" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="left" class="bodytext32" id="ledgernameth" bgcolor="#ecf0f5" style="display: none"><strong>Expense Ledger</strong></td>
                      <td align="left" valign="left" class="bodytext32" id="expenseledgerhiddencolon" bgcolor="#ecf0f5" style="display: none"><strong>&nbsp;</strong></td>

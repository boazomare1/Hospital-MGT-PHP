...
{  
	...
	if ($res2 != 0)
	{
	    $query1 = "update master_accountssub set accountsmain = '$accountsmain',accountssub = '$accountssub',id='$id',shortname='$shortname' where auto_number = '$accountssubanum'";
...
function addward1process1()
{
	...
	if (document.form1.shortname.value == "")
	{
            ...
            <tr>
              <td><form name="form1" id="form1" method="post" action="editaccountssub.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Accounts Sub Master - Edit</strong></td>
                      </tr>
					  <tr>
                      ...
                      <tr>
						...
						$query5 = "select * from master_accountsmain where recordstatus = '' order by auto_number asc";
						$exec5 = mysqli_query($GLOBALS["___mysqli_ston"], $query5) or die ("Error in Query5".mysqli_error($GLOBALS["___mysqli_ston"]));
					  ...
					  <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Account Short Name</div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="shortname" id="shortname"  value="<?php echo $shortname;?>"style="border: 1px solid #001E6A; text-transform:uppercase" size="40" /></td>
                      </tr>
                      <tr>

...
<table width="100%" border="0" cellspacing="0" cellpadding="1">
       ...
       <td width="10%" align="left" valign="center"  
                ...
                bgcolor="#ffffff" class="bodytext31"><strong>Cheque Date</strong></td>
              ...
              <td width="24%" align="left" valign="center"  
                 ...
                 class="bodytext31"><strong>Corresponding Ledger</strong></td>

              <td width="24%" align="left" valign="right"  

                 class="bodytext31"><strong>Amount</strong></td>
  ...
  <td class="bodytext31" valign="center"  align="left" 
		 ...
		 <td  colspan="7" align="left" valign="center"  
				...
				<td   align="right" valign="center"  
                 ...
                 class="bodytext31"><strong><?php echo number_format($statementamount,2,'.',','); ?></strong></td>
		...
		////////////////////////
			...
			?>
				  <tr >
				  	...
				  	<td class="bodytext31" valign="center"  align="left"><?php echo $unpresented_incr; ?></td>
               <td class="bodytext31" valign="center"  align="left">

               <?php echo $aptransactiondate; ?></td>   

            <td class="bodytext31" valign="center"  align="left">

                <?php echo $apchequedate; ?></td>
		...
		//	$credit_amount = $amount['credit_amount'];
			...
			?>
               ...
               <td class="bodytext31" valign="center"  align="left">
                ...
                <?php echo $artransactiondate; ?></td>
               <td class="bodytext31" valign="center"  align="left">

                <?php echo $archequedate; ?></td>
 ...
 -->
		   ...
		   <?php
			...
			?>
              ...
              <td class="bodytext31" valign="center"  align="right">
			    ...
			    <?php echo number_format($credit_amount,2,'.',',');?></td>
		   ...
		   <?php
            ...
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
             <td align="right" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
             <td   align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
            ...
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
             <td align="right" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>Calculated Balance</strong></td>
             <td align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong><?php echo number_format($calculated_balance,2,'.',',');?></strong></td>
            ...
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
             <td align="right" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>Cash Book Balance</strong></td>
             <td align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong><?php echo number_format($closing_balance_ledger,2,'.',',');?></strong></td>
            ...
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
            <td  align="left" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>&nbsp;</strong></td>
             <td align="right" valign="left" bgcolor="#ffffff" class="bodytext31"><strong>Difference</strong></td>
             <td align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong><?php echo number_format($difference,2,'.',',');?></strong></td>

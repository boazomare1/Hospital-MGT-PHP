...

{
	...
	$objPHPExcel->getProperties()->setCreator("Med360")
							 ...
							 ->setTitle("Lab Template")

							 ->setSubject("Lab Template")

							 ->setDescription("Lab Template")

							 ->setKeywords("Lab Template")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$rowCount, "Charges");

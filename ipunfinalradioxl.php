...
header('Content-Disposition: attachment;filename="IPUnfinal_radiology.xls"');
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="8" bgcolor="#FFFFFF" class="bodytext31" align="center"><strong>Radiology Charge Details</strong></td>
...
?>		
         ...
         <tr>
              ...
              <td colspan="7"  class="bodytext31" valign="center"  align="right" 
                ...
                bgcolor="#fff"><strong>Total Radiology Charges:</strong></td>

              <td align="right" valign="center" 

                bgcolor="#fff" class="bodytext31"><strong><?php echo number_format($totalradiologyitemrate,2,'.',','); ?></strong></td>

        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>		 
                ...
                <td colspan="4" valign="center"  align="center" bgcolor="#ffffff"><strong><?= strtoupper($res1location); ?></strong></td>
                 ...
                 <tr>
                <td colspan="2" valign="center"  align="left" bgcolor="#fff" class="bodytext31">Diagnosis [Morbidity]:IP</td>
				...
				<td align="center" valign="center" bgcolor="#ffffff" class="bodytext31" width="50%"><strong>DISEASE</strong></td>
...
$dompdf->stream("print_ipmorbiditymortalitysummary.pdf", array("Attachment" => 0)); 
?>

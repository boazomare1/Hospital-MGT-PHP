		...
		<table width="658" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Sample Collection By User</strong></td>
          ...
          <?php
           ...
           if($location=='All')
			...
			//echo 'Received';
			 ...
			 $query1 = "select username from samplecollection_lab where recorddate between '$ADate1' and '$ADate2' and $pass_location group by username order by username";
			 ...
			 $query7 = "select username from samplecollection_lab where username like '$cbcustomername' and recorddate between '$ADate1' and '$ADate2' and $pass_location"; 

		  $exec7 = mysqli_query($GLOBALS["___mysqli_ston"], $query7) or die ("Error in Query7".mysqli_error($GLOBALS["___mysqli_ston"]));

		  $numcount=mysqli_num_rows($exec7);

 $query71 = "select username from ipsamplecollection_lab where username like '$cbcustomername' and recorddate between '$ADate1' and '$ADate2' and $pass_location"; 

		  $exec71 = mysqli_query($GLOBALS["___mysqli_ston"], $query71) or die ("Error in Query71".mysqli_error($GLOBALS["___mysqli_ston"]));

		  $numcount2=mysqli_num_rows($exec71);
          ...
          <tbody>
		     ...
		     <tr>
              ...
              <td colspan='12' bgcolor="#ecf0f5" class="bodytext31"><?php echo 'Total No of Sample collected by  '.$cbcustomername?>(<?php echo $numcount;?>)</td>
			...
			<?php
		  		  ...
		  		  $query4 = "select * from samplecollection_lab where username like '$cbcustomername' and recorddate between '$ADate1' and '$ADate2' and $pass_location"; 
		 ...
		 $query41 = "select * from ipsamplecollection_lab where username like '$cbcustomername' and recorddate between '$ADate1' and '$ADate2' and $pass_location"; 

		  $exec41 = mysqli_query($GLOBALS["___mysqli_ston"], $query41) or die ("Error in Query4".mysqli_error($GLOBALS["___mysqli_ston"]));

		  $numcount=mysqli_num_rows($exec41);

...
<table width="90%" border="0" cellspacing="0" cellpadding="2" style="padding-left:9px">
 ...
 <tr>
    ...
    <td colspan="10">&nbsp;</td>
              ...
              <tr>
                ...
                <td colspan="6" align="center" valign="middle"  bgcolor="#ecf0f5" class="bodytext365"><strong>CASE SHEET </strong></td>

                <td align="center" valign="middle"  bgcolor="#ecf0f5" class="bodytext365"><span class="style1"><a target="_blank" href="sick_referral1.php?visitcode=<?php echo $visitcode; ?>">Refer</a></span></td>
             ...
             <tr>
                ...
                <td align="left" colspan="5" valign="middle"  bgcolor="#ecf0f5" class="bodytext313"> <strong>Patient Bio Data</strong> </td>
			  ...
			  ?>
                ...
                <td width="150" align="left" valign="middle"   bgcolor="#ffffff" class="bodytext31"><strong>Patient :</strong>&nbsp;&nbsp;<?php echo $patientfullname; ?>, <?php echo $age; ?>, <?php echo $gender; ?></td>

                <td width="90" align="left" valign="middle"   bgcolor="#ffffff" class="bodytext31"><strong>Reg.No :</strong> <?php echo $patientcode; ?></td>

                <td width="95" align="left" valign="middle"   bgcolor="#ffffff" class="bodytext31"> <strong> Visit :</strong>  <?php echo $visitcode; ?></td>

                <td width="95" align="left" valign="middle"   bgcolor="#ffffff" class="bodytext31"><strong>Date : </strong> <?php echo $consultationdate; ?></td>

                <td width="100" align="left" valign="middle"   bgcolor="#ffffff" class="bodytext31"><strong>Nurse : </strong><?php echo strtoupper($user); ?></td>
                <td width="30" align="right" valign="center"  > <a target="_blank" href="print_emrcasesheet.php?visitcode=<?php echo $visitcode; ?>" > <img src="images/pdfdownload.jpg" width="30" height="30"></a> </td>
		  ...
		  ?>
            ...
            <td width="254" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext32"><strong>Chief Complaint </strong></td>

            <td colspan="5" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext32"><?php echo $complaints; ?></td>

            <td width="108" align="left" valign="top"  bgcolor="#ecf0f5" class="style1">Medical History </td>
          ...
          <tr>
            ...
            <td width="254" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext32"><strong>Obsterical History </strong></td>
            ...
            <td width="108" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext32"><strong>Surgical History</strong></td>
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext32">&nbsp;</td>
          ...
          <tr>
            ...
            <td width="254" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext32"><strong>Family History </strong></td>

            <td colspan="5" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext32">
            ...
            <td width="108" align="left" valign="top"  bgcolor="#ecf0f5" class="style1">Intoxications</td>

            <td width="128" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext32">
          ...
          <tr>
            ...
            <td width="254" align="left" valign="top"  bgcolor="#ecf0f5" class="style1">Transfusions</td>
            ...
            <td width="108" align="left" valign="middle"  bgcolor="#ecf0f5" class="style1">Subsequent Visit</td>

            <td width="128" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext32"><?php if($gestationage !=''){ ?>
		  ...
		  <tr>
            ...
            <td width="254" align="left" valign="top"  bgcolor="#ecf0f5" class="style1">ANC Profile</td>
            ...
            <td width="108" align="left" valign="middle"  bgcolor="#ecf0f5" class="style1">&nbsp;</td>

            <td width="128" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext32">&nbsp;</td>
          ...
          <?php
				...
				$exec100=mysqli_query($GLOBALS["___mysqli_ston"], $query100);
           ...
           <tr>
            ...
            <td align="left" valign="middle"  bgcolor="#ecf0f5" class="style1">Murphing</td>

            

            <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext32"><?php echo $murphing; ?></td>
            ...
            <tr style="margin-bottom: 20px;">
                ...
                <td align="left" colspan="4" valign="middle"  class="bodytext32" ><strong>Op Cardex</strong></td>

			</tr>
            <tr>
            <?php 
           
			$querynw1 = "select * from dc_progressnotes where patientcode='$patientcode' and visitcode='$visitcode' and recordstatus = '' order by auto_number desc";
...

		{
            ...
            while($resnw1 = mysqli_fetch_array($execnw1)){
            	...
            	/*var_dump($resnw1);*/
            		$previousnotes = $resnw1["notes"];
            		$recordDate=$resnw1['recorddate'];
            		$recordTime=$resnw1['recordtime'];
            		$username=$resnw1['username'];

            		/*$daterec=$resnw1['recorddate'];*/
            			echo '<tr><td width="11%" align="left" valign="middle"  class="bodytext3">'.'<b>'.$recordDate.'</b>'.'<br></td>
            			<td width="11%" align="center" valign="middle"  class="bodytext3">'.'<b>'.$recordTime.'</b>'.'<br></td>
            			<td width="30%"  valign="middle"  class="bodytext3">'.'<b>'.$previousnotes.'</b>'.'<br></td>
            			<td width="11%" align="center" valign="middle"  class="bodytext3">'.'<b>'.$username.'</b>'.'<br></td>
		...
		/*$res14recordtime = $resnw1["recorddate"];*/
            }
            ...
            <td align="left" valign="middle"  bgcolor="" class="bodytext32"><?php echo $murphing; ?></td>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
             ...
             <tr>
                ...
                <td align="left" colspan="8" valign="middle"  class="bodytext32" ><strong> Doctor Notes </strong></td>
		   ...
		   <tr>
            ...
            <td colspan="5" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3">

			<?php

		    $query10="select * from dc_progressnotes where patientname=";
			...
			<tr bgcolor="#ffffff">
			  ...
			  <td colspan="5" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>

			  <tr>  

				<td align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3">Doctor : <?php echo strtoupper($res10username); ?></td>

				 <td colspan="3" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>

				<td colspan="2" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3">Date : <?php echo $res10date; ?></td>

			</tr>

			  <tr>

			    <td align="left" valign="top"  bgcolor="#ecf0f5" class="style1">&nbsp;</td>
			...
			<tr >
			  ...
			  <td colspan="6" align="left" valign="top"  class="bodytext3">
			...
			<td width="254" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
		...
		<tr bgcolor="#ffffff">
			...
			<td colspan="8" align="left" valign="middle"  class="bodytext3">
            ...
            <tr>
                ...
                <td colspan="2" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>

                </tr>

            <tr>

            <td width="254" align="left" valign="top"  bgcolor="#ecf0f5" class="style1">ICD Codes</td>

            <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext31">
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext31"><strong>Primary Diagnosis: </strong></td>
			...
			?>	
              ...
              <tr bgcolor="#ffffff">
                ...
                <td width="254" align="left" valign="middle"   class="bodytext31"><?php echo $res4disease; ?></td>

                <td width="161" align="left" valign="middle"   class="bodytext31"><?php echo $res4icdcode; ?></td>
			...
			<?php } ?> 
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext31"><strong>Secondary Diagnosis: </strong></td>
			...
			?>	
              ...
              <tr >
                ...
                <td width="254" align="left" valign="middle"  class="bodytext31"><?php echo $res5disease; ?></td>

                <td width="161" align="left" valign="middle"   class="bodytext31"><?php echo $res5icdcode; ?></td>
			...
			<?php } ?>  
             ...
             <tr>
                ...
                <td align="left" colspan="4" valign="middle"  bgcolor="#ecf0f5" class="bodytext32" > <strong>Lab Tests </strong></td>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
		       ...
		       <tr>
                ...
                <td align="left" colspan="4" valign="middle"  bgcolor="#ecf0f5" class="bodytext32" ><strong> Lab Amends </strong></td>
        ...
        <tr>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
             ...
             <tr>
                ...
                <td align="left" colspan="4" valign="middle"  bgcolor="#ecf0f5" class="bodytext32" > <strong>Radiology Tests</strong> </td>
          ...
          <tr>
            ...
            <td colspan="5" align="left" valign="top"  bgcolor="#ecf0f5" class="bodytext3"><?php
		   ...
		   <tr>
            ...
            <td>&nbsp;</td>
		      ...
		      <tr>
                ...
                <td align="left" colspan="4" valign="middle"  bgcolor="#ecf0f5" class="bodytext32" > <strong>Radiology Amends</strong> </td>
        ...
        <tr>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left" colspan="4" valign="middle"  bgcolor="#ecf0f5" class="bodytext32" > <strong>Procedures </strong></td>
          ...
          <tr>
		    ...
		    ?>
                ...
                <?php } ?></td>            <td width="128" align="left" valign="top"  bgcolor="#ecf0f5" class="style1">&nbsp;</td>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
		      ...
		      <tr>
                ...
                <td align="left" colspan="4" valign="middle"  bgcolor="#ecf0f5" class="bodytext32" > <strong>Procedures Amends</strong></td>
          ...
          <tr>
			...
			<?php } ?>
              ...
              <tr>
                ...
                <td align="left" colspan="4" valign="middle"  bgcolor="#ecf0f5" class="bodytext32" ><span class="bodytext32" ><strong>Prescribed Drugs <strong></span></td>
              ...
              <tr bgcolor="#FFFFFFF">
                ...
                <td align="left" colspan="2" valign="middle"   class="bodytext3"><strong>Medicine</strong></td>

                <td align="left" valign="middle"   class="bodytext3">Units</td>

                <td align="left" valign="middle"   class="bodytext3">Dose.Measure</td>

                <td align="left" valign="middle"   class="bodytext3">Freq</td>

                <td align="left" valign="middle"   class="bodytext3">Days</td>

                <td align="left" valign="middle"   class="bodytext3">Quantity</td>

                <td align="left" valign="middle"   class="bodytext3">Route</td>

                <td align="left" valign="middle"   class="bodytext3">Instructions</td>
	...
	$sno=0;
			...
			<tr <?php echo $colorcode;?>>
                ...
                <td align="left" colspan="2" valign="middle"   class="bodytext3"><?php echo $medicinename.'<br>Prescribed By - <strong>'.strtoupper($res6consultingdoctor).'</strong>'.'<br>Approved By - <strong>'.strtoupper($res6approver).'</strong>'; ?></td>

                <td align="left" valign="middle"   class="bodytext3"><?php echo $dose; ?></td>

                <td align="left" valign="middle"   class="bodytext3"><?php echo $dosemeasure; ?></td>
           ...
           <tr>
                ...
                <td align="left" colspan="4" valign="middle"  bgcolor="#ecf0f5" class="bodytext32" style="color:blue;font-weight:bold;font-size:medium"> &nbsp; </td>

			</tr> 

              <tr>

                <td align="left" colspan="4" valign="middle"   class="bodytext32" ><strong>Issued Drugs</strong> </td>
         ...
         <tr bgcolor="#FFFFFFF">
			...
			<tr <?php echo $colorcode;?>>
                ...
                <td align="left" colspan="2" valign="middle"   class="bodytext3"><?php echo $medicinename.' - <strong>'.strtoupper($res44username).'</strong>'; ?></td>
            ...
            <?php }
			  ...
			  <tr>
			   ...
			   <tr>
                ...
                <td align="left" colspan="4" valign="middle"  bgcolor="#ecf0f5" class="bodytext32"><strong>Drugs Amends</strong></td>

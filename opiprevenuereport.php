		...
		<form name="cbform1" method="post" action="opiprevenuereport.php">
          <!--TABLE FOR OP/IP REVENUE REPORT -->
           <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
             <tbody>
             <tr bgcolor="#011E6A">
                 <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>OP/IP Revenue Report </strong></td>
            ...
            <td colspan="13" bgcolor="#ecf0f5" class="bodytext3"><strong>OP Revenue  &nbsp; From &nbsp;<?php echo date('d-M-Y',strtotime($ADate1)); ?> To <?php echo date('d-M-Y',strtotime($ADate2)); ?></strong></td>
             <!-- <td width="10%" bgcolor="#ecf0f5" class="bodytext31">Op Renenue</td>-->
              ...
              <tr>
                  ...
                  <td width="10%" align="right" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Other Sales</strong></td>
...
$res8pharmacyitemrate = 0;
			...
			$query1 = "select sum(billamount1) as billamount1 from (
				select sum(consultation) as billamount1 from billing_consultation where  locationcode='$location' and  billdate between '$transactiondatefrom' and '$transactiondateto' 
				UNION ALL
				select sum(totalamount) as billamount1 from billing_paylaterconsultation where locationcode='$location' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname = 'CASH - HOSPITAL'
				) as billamount";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res1 = mysqli_fetch_array($exec1);
...
*/
			 $query1 = "select SUM(totalamount) AS billamount1 from billing_paylaterconsultation where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL' and visitcode in (select visitcode from master_visitentry )";
			 $query1 = "select SUM(totalamount) AS billamount1 from billing_paylaterconsultation where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL' and visitcode in (select visitcode from master_visitentry )";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			while($res1 = mysqli_fetch_array($exec1)){;
			...
			$query12c = "select sum(fxamount) as consultation1 from refund_paylaterconsultation where locationname='$location' and billdate between '$transactiondatefrom' and '$transactiondateto'  ";
			...
			$query121 = "select sum(consultationfxamount) as consultation1 from billing_patientweivers where locationcode='$location' and entrydate between '$transactiondatefrom' and '$transactiondateto' ";
			...
			$tot_consult = $res1consultationamount + $res2consultationamount ;
			//- $res12refundconsultation;
			//**ENDS**//
			?>
		   <?php
		  //**PHARMACY**//
		  //CASH
		  	...
		  	select sum(fxamount) as amount1 from billing_paynowpharmacy where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto'  
		  	UNION ALL
		  	select sum(fxamount) as amount1 from billing_paylaterpharmacy where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto' and accountname = 'CASH - HOSPITAL'
		  	) as amount1";
			...
			//CREDIT
/*
			$query8 = "select sum(amount1) as amount1 from (select sum(amount) as amount1 from billing_paylaterpharmacy where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL') as amount";
				*/
			$query8 = "select SUM(fxamount) AS  amount1 from billing_paylaterpharmacy where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL' and patientvisitcode in (select visitcode from master_visitentry)
";
			...
			$query221 = "select sum(pharmacyfxamount) as amount1 from billing_patientweivers where locationcode='$location' and entrydate between '$transactiondatefrom' and '$transactiondateto'";
			...
			$query21p = "SELECT SUM(`amount`) as amount1 FROM `paylaterpharmareturns` WHERE locationcode='$location' and billdate between  '$transactiondatefrom' and '$transactiondateto' AND ledgercode <> '' AND `billnumber` IN (SELECT b.`docno` FROM `master_transactionpaylater` as a JOIN `master_transactionpaylater` as b ON (a.`visitcode` = b.`visitcode`) WHERE a.`transactiontype` = 'finalize' and b.`transactiontype` = 'pharmacycredit' and b.`auto_number` > a.`auto_number`)";
			...
			$tot_pharmacy = $res9pharmacyitemrate + $res8pharmacyitemrate + $res17pharmacyitemrate;
			// - $totalrefundpharmacy;
			//**ENDS**//
		?>
        <?php	
			...
			$query3 = "select sum(labitemrate1) as labitemrate1 from (
				select sum(fxamount) as labitemrate1 from billing_paynowlab where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto'
				UNION ALL
				select sum(labitemrate) as labitemrate1 from billing_paylaterlab where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto' and accountname = 'CASH - HOSPITAL'
				) as labitemrate";
			...
			//CREDIT
			$query2 = "select sum(labitemrate1) as labitemrate1 from (select sum(labitemrate) as labitemrate1 from billing_paylaterlab where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL') as amount1";
			...
			$query222 = "select sum(labfxamount) as amount1 from billing_patientweivers where locationcode='$location' and entrydate between '$transactiondatefrom' and '$transactiondateto'";
			...
			$tot_lab = $res3labitemrate + $res2labitemrate + $res14labitemrate ;
			//- $totalrefundlab;
		   ...
		   <?php
			...
			$query5 = "select sum(radiologyitemrate1) as radiologyitemrate1 from (
				select sum(fxamount) as radiologyitemrate1 from billing_paynowradiology where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto'
				UNION ALL
				select sum(radiologyitemrate) as radiologyitemrate1 from billing_paylaterradiology where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto' and accountname = 'CASH - HOSPITAL'
			...
			//CREDIT
			$query4 = "select sum(radiologyitemrate) as radiologyitemrate1 from billing_paylaterradiology where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL'";
			...
			//REFUND
			$query22 = "select sum(fxamount)as radiologyitemrate1 from refund_paylaterradiology where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto'";
			$exec22 = mysqli_query($GLOBALS["___mysqli_ston"], $query22) or die ("Error in Query22".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res22 = mysqli_fetch_array($exec22) ;
			...
			$query223 = "select sum(radiologyfxamount) as amount1 from billing_patientweivers where locationcode='$location' and entrydate between '$transactiondatefrom' and '$transactiondateto'";
			...
			$tot_radiol = $res5radiologyitemrate + $res4radiologyitemrate + $res15radiologyitemrate;
			// - $totalrefundradio;
			//**ENDS**//
			?>
		   ...
		   <?php
			...
			//REFUND
			$query24 = "select sum(fxamount)as servicesitemrate1 from refund_paylaterservices where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto'";
			...
			$query225 = "select sum(servicesfxamount) as amount1 from billing_patientweivers where locationcode='$location' and entrydate between '$transactiondatefrom' and '$transactiondateto'";
			...
			$tot_serv = $res7servicesitemrate + $res6servicesitemrate + $res16servicesitemrate;
			// - $totalrefundservice;
			...
			$tot_reffer = $res11referalitemrate + $res10referalitemrate + $total ;
			//- $totalrefundreferal;
			//**ENDS**//
			?>
             <?php
			...
			$toto_othersamt =0;
			//other sales
			$query3_ex = "select sum(amount) as otheramt from other_sales_billing where locationcode='$location' and billdate between '$transactiondatefrom' and '$transactiondateto'";
			$exec3_ex = mysqli_query($GLOBALS["___mysqli_ston"], $query3_ex) or die ("Error in query3_ex".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res3_ex = mysqli_fetch_array($exec3_ex);
			$res3otheramt = $res3_ex['otheramt'];
			$toto_othersamt+=$res3otheramt;
			...
			//for cash total
			$cashtotal = $res1consultationamount + $res9pharmacyitemrate + $res3labitemrate + $res5radiologyitemrate + $res7servicesitemrate + $res11referalitemrate + $res30rescue + $res28homecare+$res3otheramt;
			...
			$holetotal1 = $cashtotal + $credittotal + $externaltotal ;
			//- $refundtotal;
			?>
              <tr <?php echo $colorcode= 'bgcolor="#ecf0f5"'; ?>>
				  ...
				  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php echo number_format($res3otheramt,2,'.',','); ?></div></td>
                 <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">
				
				<a target="_blank" href="oprevenuereport_cashamend.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><strong><?php echo number_format($cashtotal,2,'.',','); ?></strong></a> 
              ...
              <tr <?php echo $colorcode = 'bgcolor="#CBDBFA"'; ?>>
                   ...
                   <td class="bodytext31" valign="center"  align="right"><a target="_blank" href="oprevenuereport_credit_laboratory.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><div class="bodytext31"><?php echo number_format($res2labitemrate,2,'.',','); ?></a></div></td>
                   ...
                   <td class="bodytext31" valign="center"  align="right"><a target="_blank" href="oprevenuereport_credit_referral.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><div class="bodytext31"><?php echo number_format($res10referalitemrate,2,'.',','); ?></a></div></td>
                   <td class="bodytext31" valign="center"  align="right"><a target="_blank" href="oprevenuereport_credit_rescue.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><div class="bodytext31"><?php echo number_format($res31rescue,2,'.',','); ?></a></div></td>
				   ...
				   <a target="_blank" href="oprevenuereport_creditamend.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><strong><?php echo number_format($credittotal,2,'.',','); ?></strong></a> 
              ...
              <tr <?php echo $colorcode= 'bgcolor="#ecf0f5"';?>>
                   ...
                   <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><a target="_blank" href="oprevenuereport_external_referral.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><?php echo number_format($refexternal,2,'.',','); ?></a></div></td>
             ...
             <td class="bodytext31" width="30" valign="center"  align="right"><div class="bodytext31"><a target="_blank" href="oprevenuereport_refund_consultation.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><?php echo number_format((-1)*$res12refundconsultation,2,'.',','); ?></a></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><a target="_blank" href="oprevenuereport_refund_pharmacy.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><?php echo number_format((-1)*$totalrefundpharmacy,2,'.',','); ?></a></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><a target="_blank" href="oprevenuereport_refund_laboratory.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><?php echo number_format((-1)*$totalrefundlab,2,'.',','); ?></a></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><a target="_blank" href="oprevenuereport_refund_radiology.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><?php echo number_format((-1)*$totalrefundradio,2,'.',','); ?></a></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><a target="_blank" href="oprevenuereport_refund_service.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><?php echo number_format((-1)*$totalrefundservice,2,'.',','); ?></a></div></td>
				  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><a target="_blank" href="oprevenuereport_refund_referral.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><?php echo number_format((-1)*$totalrefundreferal,2,'.',','); ?></a></div></td>
                   <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php  ?></div></td>
                   <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php  ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php  ?></div></td>
				  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php echo number_format((-1)*$refundtotal,2,'.',','); ?></strong></div></td>
                ...
                <tr <?php echo $colorcode = 'bgcolor="#ecf0f5"'; ?>>
                  ...
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php echo number_format($toto_othersamt,2,'.',','); ?></strong></div></td>
   ...
   <tr>
      <td>
        ...
        <table width="auto" id="AutoNumber3" style="BORDER-COLLAPSE: collapse"  bordercolor="#666666" cellspacing="0" cellpadding="4"  align="left" border="0">
          <tbody>
            <tr>
             <td colspan="15" bgcolor="#ecf0f5" class="bodytext3"><strong>Ip Revenue  &nbsp; From &nbsp;<?php echo date('d-M-Y',strtotime($ADate1)); ?> To <?php echo date('d-M-Y',strtotime($ADate2)); ?> </strong></td>
...
$totrebate                = 0;
	...
	//QUERY TO GET PATIENT DETAILS TO PASS
	$query1 = "select  auto_number,patientname,patientcode,visitcode,'billing' as type  from billing_ip where locationcode='$locationcode1' and  accountnameano = '603' and billdate between '$fromdate' and '$todate'
		UNION ALL 
	 SELECT auto_number,patientname,patientcode,visitcode,'creditapproved' as type from billing_ipcreditapproved where locationcode='$locationcode1' and  accountnameano = '603' and billdate between '$fromdate' and '$todate' group by visitcode  order by auto_number DESC ";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		//TO GET TOTAL IP PACKAGE CHARGES AMOUNT  
		 //$query112 = "select sum(amountuhx) from billing_ipbedcharges where locationcode='$locationcode1' and  description NOT IN ('Bed Charges','Nursing Charges','RMO Charges','Daily Review charge','Consultant Fee')and patientcode = '$patientcode' and visitcode='$visitcode'  and recorddate between '$fromdate' and '$todate' ";
				...
				// if($res1['type']=='billing') {
				     $query112 = "select sum(amountuhx) as amountuhx from billing_ipbedcharges where locationcode='$locationcode1' and  description NOT IN ('Bed Charges','Nursing Charges','RMO Charges','Daily Review charge','Consultant Fee') and  visitcode='$visitcode'  and recorddate between '$fromdate' and '$todate' 
    ...
    //                $query112 = "select sum(amountuhx) as amountuhx from billing_ipbedcharges where locationcode='$locationcode1' and  description NOT IN  ('Bed Charges','Nursing Charges','Resident Doctor Charges') and  visitcode='$visitcode'  and recorddate between '$fromdate' and '$todate'
		...
		$radiologyamount=$res4['sum(radiologyitemrateuhx)'];
		 ...
		 $query5 = "select sum(rate*quantity) from billing_ippharmacy where locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'  ";
		$exec5 = mysqli_query($GLOBALS["___mysqli_ston"], $query5) or die ("Error in Query5".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num5=mysqli_num_rows($exec5);
		$res5 = mysqli_fetch_array($exec5);
		$pharmacyamount=$res5['sum(rate*quantity)'];
		$totalpharmacyamount=$totalpharmacyamount + $pharmacyamount;
	
		//TO GET TOTAL SERVICE CHARGES AMOUNT
	    $query6 = "select sum(servicesitemrateuhx),sum(sharingamount) from billing_ipservices where locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode'   and billdate between '$fromdate' and '$todate'";
		$exec6 = mysqli_query($GLOBALS["___mysqli_ston"], $query6) or die ("Error in Query6".mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		// $query8 = "select sum(transactionamount) from billing_ipprivatedoctor where locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and billtype <>'' and recorddate between '$fromdate' and '$todate'  ";
		...
		$query8              = "select sharingamount,original_amt,visittype,coa from billing_ipprivatedoctor where  patientcode = '$patientcode' and visitcode='$visitcode'   and billtype <>'' and recorddate between '$fromdate' and '$todate' and coa ='' ";
                $exec8 = mysqli_query($GLOBALS["___mysqli_ston"], $query8) or die("Error in Query8" . mysqli_error($GLOBALS["___mysqli_ston"]));
                $num8                     = mysqli_num_rows($exec8);
                while($res8 = mysqli_fetch_array($exec8))
				{
					$privatedoctoramount=0;
							...
							{
								if($res8['coa'] !=""){
								 $privatedoctoramount = $res8['sharingamount'];
								}else{
		...
		if($res1['type']=='billing') {
		   $query10 = "select sum(amountuhx) as amount  from billing_ipbedcharges where locationcode='$locationcode1' and  description='Nursing Charges' and  visitcode='$visitcode'  and recorddate between '$fromdate' and '$todate' 
		...
		$query111 = "select sum(amount) from billing_ipbedcharges where locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and description = 'Consultant Fee' and recorddate between '$fromdate' and '$todate' ";
		...
		while($res12 = mysqli_fetch_array($exec12))
		{
		   ...
		   <?php 
			...
			$rowtot1 = $totaladmissionamount+0+$totalipbedcharges+$totalipnursingcharges+$totaliprmocharges+ $totaliprmocharges1+$totallabamount+$totalradiologyamount+$totalpharmacyamount+$totalservicesamount+$totalambulanceamount+$totalhomecareamount+$totalprivatedoctoramount+$totalipmiscamount;
			//+$totalipdiscamount;
			 ?>
			 <tr bgcolor="#ecf0f5">
              <td class="bodytext31" valign="center"  align="left"><div align="center"><strong>Cash</strong></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=admission"><?php echo number_format($totaladmissionamount,2,'.',','); ?></a></div></td>
                 <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=package"><?php echo number_format($totalpackagecharge,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=bed"><?php echo number_format($totalipbedcharges,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=nursing"><?php echo number_format($totalipnursingcharges,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=mo"><?php echo number_format($totaliprmocharges,2,'.',','); ?></a></div></td>
				<td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=consultant"><?php echo number_format($totaliprmocharges1,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left">
			      <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=lab"><?php echo number_format($totallabamount,2,'.',','); ?></a></div></td>
				<td class="bodytext31" valign="center"  align="left">
			      <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=rad"><?php echo number_format($totalradiologyamount,2,'.',','); ?></a></div></td>
				<td class="bodytext31" valign="center"  align="left">
			      <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=pharma"><?php echo number_format($totalpharmacyamount,2,'.',','); ?></a></div></td>
				  <td class="bodytext31" valign="center"  align="left">
			        <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=services"><?php echo number_format($totalservicesamount,2,'.',','); ?></a></div></td>
				  <td class="bodytext31" valign="center"  align="left">
			        <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=ambulance"><?php echo number_format($totalambulanceamount,2,'.',','); ?></a></div></td>
                    <td class="bodytext31" valign="center"  align="left">
			        <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=homecare"><?php echo number_format($totalhomecareamount,2,'.',','); ?></a></div></td>
				   <td class="bodytext31" valign="center"  align="left">
			         <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=pvtdr"><?php echo number_format($totalprivatedoctoramount,2,'.',','); ?></a></div></td>
				   <td  align="left" valign="center" class="bodytext31"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=misc"><?php echo number_format($totalipmiscamount,2,'.',','); ?></a></div></td>
				   <td  align="left" valign="center" class="bodytext31"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=discount"><?php echo number_format($totalipdiscamount,2,'.',','); ?></a></div></td>
				   <td  align="left" valign="center" class="bodytext31"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=cash&name=rebate"><?php echo number_format($rebate,2,'.',','); ?></a></div></td>
                   ...
                   <td  align="right" valign="center" class="bodytext31">
				     ...
				     <a target="_blank" href="iprevenuereport_cashamend.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><strong><?php echo number_format($rowtot1,2,'.',','); ?></strong></a> 
		...
		//QUERY TO GET PATIENT DETAILS TO PASS
	 //   $query105 = "select  patientname,patientcode,visitcode from billing_ip where locationcode='$locationcode1' and accountnameano <> '603' and billdate between '$fromdate' and '$todate'  group by visitcode  order by auto_number DESC ";
		...
		// //TO GET TOTAL IP PACKAGE CHARGES AMOUNT  
		// $query112 = "select sum(amountuhx) from billing_ipbedcharges where locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and description NOT IN ('Bed Charges','Nursing Charges','RMO Charges','Daily Review charge','Consultant Fee') and recorddate between '$fromdate' and '$todate' ";
  ...
  //          $totalservicesamount=$totalservicesamount + $servicesamount;
	 ...
	 //     $query8 = "select sum(amountuhx) from billing_ipambulance where locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and recorddate between '$fromdate' and '$todate'  ";
		...
		// //TO GET TOTAL PRIVATE DOCTER CHARGES AMOUNT
		// // $query8 = "select sum(transactionamount) from billing_ipprivatedoctor where locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and recorddate between '$fromdate' and '$todate'  ";
		// // $exec8 = mysql_query($query8) or die ("Error in Query8".mysql_error());
		// // $num8=mysql_num_rows($exec8);
		// // $res8 = mysql_fetch_array($exec8);
		// // $privatedoctoramount=$res8['sum(transactionamount)'];
		...
		// //TO GET TOTAL RMO CHARGES AMOUNT
		// $query11 = "select sum(amountuhx) from billing_ipbedcharges where locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and (description = 'Daily Review charge' or description = 'RMO Charges') and recorddate between '$fromdate' and '$todate' ";
		// $exec11 = mysql_query($query11) or die ("Error in Query11".mysql_error());
		// $num11=mysql_num_rows($exec11);
		// $res11 = mysql_fetch_array($exec11);
		// $iprmocharges=$res11['sum(amountuhx)'];
		// $totaliprmocharges=$totaliprmocharges + $iprmocharges;
		// $query111 = "select sum(amountuhx) from billing_ipbedcharges where locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and description = 'Consultant Fee' and recorddate between '$fromdate' and '$todate' ";
		// $exec111 = mysql_query($query111) or die ("Error in Query11".mysql_error());
...
$totalipmiscamount = 0;
$totalipdiscamount = 0;
	 $query186 = "select  auto_number,patientname,patientcode,visitcode,'billing' as type from billing_ip where locationcode='$locationcode1' and billdate between '$fromdate' and '$todate'  and accountnameano != '603' 
	 UNION ALL SELECT auto_number,patientname,patientcode,visitcode,'creditapproved' as type from billing_ipcreditapproved where billdate between '$fromdate' and '$todate' and  locationcode='$locationcode1'  and accountnameano != '603'  group by visitcode  order by auto_number DESC ";
		...
		//TO GET TOTAL LAB AMOUNT
		 // $query3 = "select sum(labitemrate) as labitemrate1 from billing_iplab where locationcode='$locationcode1' and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'";
		  ...
		  $query3 = "SELECT SUM(rateuhx) as amountuhx FROM `billing_iplab` WHERE billdate BETWEEN '$fromdate' AND '$todate' and locationcode='$locationcode1'   and  patientvisitcode ='$visitcode'
		UNION ALL SELECT SUM(fxamount) as amountuhx FROM `ip_debitnotebrief` WHERE consultationdate BETWEEN '$fromdate' AND '$todate' and billtype = 'PAY LATER' and description = 'Lab' and locationcode='$locationcode1' and patientvisitcode='$visitcode'";
		$exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num3=mysqli_num_rows($exec3);
	    $res3 = mysqli_fetch_array($exec3);
	   ...
	   $totalradiologyamount=$totalradiologyamount + $radiologyamount;
		...
		$query6 = "SELECT SUM(servicesitemrateuhx) as amountuhx,sum(sharingamount) as sharingamount  FROM `billing_ipservices` WHERE locationcode='$locationcode1' AND billdate BETWEEN '$fromdate' AND '$todate'   and patientvisitcode ='$visitcode'
		...
		//TO GET TOTAL PRIVATE DOCTER CHARGES AMOUNT
		$query8 = "select sharingamount,original_amt,visittype,coa from billing_ipprivatedoctor where locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and recorddate between '$fromdate' and '$todate'  and coa =''";
		$exec8 = mysqli_query($GLOBALS["___mysqli_ston"], $query8) or die ("Error in Query8".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num8=mysqli_num_rows($exec8);
		// $res8 = mysql_fetch_array($exec8);
		while($res8 = mysqli_fetch_array($exec8)){
		...
		//TO GET TOTAL IP MISC BILL AMOUNT
		$query14 = "select sum(amountuhx) from billing_ipmiscbilling where locationcode='$locationcode1' and patientcode = '$patientcode' and visitcode='$visitcode' and recorddate between '$fromdate' and '$todate' ";
		$exec14 = mysqli_query($GLOBALS["___mysqli_ston"], $query14) or die ("Error in Query14".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num14=mysqli_num_rows($exec14);
		$res14 = mysqli_fetch_array($exec14);
...
$chk = "accountnameano != '603'";
 ...
 UNION ALL SELECT sum(-1*rate) as amount FROM `ip_discount` WHERE patientvisitcode IN (select visitcode FROM `billing_ipcreditapprovedtransaction` WHERE $chk and billdate BETWEEN '$fromdate' AND '$todate' group by billno) and patientvisitcode ='$visitcode'";
		...
		// DISCOUNTT
		$querysearchnew = "select visitcode from billing_ip where billdate between '$fromdate' and '$todate' and accountnameano <> '603'  and  locationcode='$locationcode1'  UNION ALL SELECT visitcode from billing_ipcreditapproved where billdate between '$fromdate'  and '$todate' and accountnameano <> '603' and  locationcode='$locationcode1'";
		$query12 = "SELECT sum(-1*rate) as discount FROM `ip_discount` WHERE patientvisitcode IN (select visitcode FROM `master_transactionip` WHERE accountnameano != '603' and transactiondate BETWEEN '$fromdate' AND '$todate' group by billnumber) and patientvisitcode IN ($querysearchnew)
			UNION ALL SELECT sum(-1*rate) as discount FROM `ip_discount` WHERE patientvisitcode IN (select visitcode FROM `billing_ipcreditapprovedtransaction` WHERE accountnameano != '603' and billdate BETWEEN '$fromdate' AND '$todate' group by billno) and patientvisitcode IN ($querysearchnew)";
		...
		$rebate += $rebateamount;
			...
			$rowtot2 = $totaladmissionamount+0+$totalipbedcharges+$totalipnursingcharges+$totaliprmocharges+ $totaliprmocharges1+$totallabamount+$totalradiologyamount+
		...
		?>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center"><strong>Credit</strong></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=admission"><?php echo number_format($totaladmissionamount,2,'.',','); ?></a></div></td>
                 <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=package"><?php echo number_format($totalpackagecharge,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=bed"><?php echo number_format($totalipbedcharges,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=nursing"><?php echo number_format($totalipnursingcharges,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=mo"><?php echo number_format($totaliprmocharges,2,'.',','); ?></a></div></td>
				<td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=consultant"><?php echo number_format($totaliprmocharges1,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left">
			      <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=lab"><?php echo number_format($totallabamount,2,'.',','); ?></a></div></td>
				<td class="bodytext31" valign="center"  align="left">
			      <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=rad"><?php echo number_format($totalradiologyamount,2,'.',','); ?></a></div></td>
				<td class="bodytext31" valign="center"  align="left">
			      <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=pharma"><?php echo number_format($totalpharmacyamount,2,'.',','); ?></a></div></td>
				  <td class="bodytext31" valign="center"  align="left">
			        <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=services"><?php echo number_format($totalservicesamount,2,'.',','); ?></a></div></td>
				  <td class="bodytext31" valign="center"  align="left">
			        <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=ambulance"><?php echo number_format($totalambulanceamount,2,'.',','); ?></a></div></td>
                    <td class="bodytext31" valign="center"  align="left">
			        <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=homecare"><?php echo number_format($totalhomecareamount,2,'.',','); ?></a></div></td>
				   <td class="bodytext31" valign="center"  align="left">
			         <div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=pvtdr"><?php echo number_format($totalprivatedoctoramount,2,'.',','); ?></a></div></td>
				  <td  align="left" valign="center" class="bodytext31"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=misc"><?php echo number_format($totalipmiscamount,2,'.',','); ?></a></div></td>
				  <td  align="left" valign="center" class="bodytext31"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=discount"><?php echo number_format($totalipdiscamount,2,'.',','); ?></a></div></td>
				  <td  align="left" valign="center" class="bodytext31"><div align="right"><a target="_blank" href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=credit&name=rebate"><?php echo number_format($rebate,2,'.',','); ?></a></div></td>
                  <td  align="left" valign="center" class="bodytext31"><div align="right"><?php echo number_format(0,2,'.',','); ?></div></td>
                  <td  align="left" valign="center" class="bodytext31">
				  
				  
				   <a target="_blank" href="iprevenuereport_creditamend.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><strong><?php echo number_format($rowtot2,2,'.',','); ?></strong></a> 
		...
		$totbrfrmodisc = 0;
         ...
         $qrycreditbrf = "select patientcode, patientvisitcode,patientname from ip_creditnotebrief where locationcode = '$locationcode1' and consultationdate between '$fromdate' and '$todate' and patientvisitcode like '%IPV%' group by patientcode ";
		...
		while($rescreditbrf = mysqli_fetch_array($execcredibrf))
		{
         ...
         <!--DISPLAY ENDS-->
			  ...
			  <td class="bodytext31" valign="center"  align="left"><div align="right"><?php //echo number_format($admissionamount,2,'.',','); ?>0.00</div></td>
                ...
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target='_blank' href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=note&name=bed"><?php echo "-".number_format($totbrfbeddisc,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target='_blank' href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=note&name=nursing"><?php echo "-".number_format($totbrfnursedisc,2,'.',','); ?></a></div></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target='_blank' href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=note&name=mo"><?php echo "-".number_format($totbrfrmodisc,2,'.',','); ?></a></div></td>
				<td class="bodytext31" valign="center"  align="left"><div align="right"><a target='_blank' href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=note&name=consultant">-0.00</div></a></td>
                <td class="bodytext31" valign="center"  align="left"><div align="right"><a target='_blank' href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=note&name=lab"><?php echo "-".number_format($totbrflabdisc,2,'.',','); ?></a></div></td>
				<td class="bodytext31" valign="center"  align="left"><div align="right"><a target='_blank' href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=note&name=rad"><?php echo "-".number_format($totbrfraddisc,2,'.',','); ?></a></div></td>
				<td class="bodytext31" valign="center"  align="left"><div align="right"><a target='_blank' href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=note&name=pharma"><?php echo "-".number_format($totbrfpharmadisc,2,'.',','); ?></a></div></td>
				  <td class="bodytext31" valign="center"  align="left"><div align="right"><a target='_blank' href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=note&name=services"><?php echo "-".number_format($totbrfservdisc,2,'.',','); ?></a></div></td>
				  ...
				  <td  align="left" valign="center" class="bodytext31"><div align="right"><?php echo number_format(0,2,'.',','); //echo number_format($ipmiscamount,2,'.',','); ?></div></td>
                   <td  align="left" valign="center" class="bodytext31"><div align="right"><a target='_blank' href="iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $locationcode1; ?>&ADate1=<?php echo $fromdate; ?>&ADate2=<?php echo $todate; ?>&type=note&name=others"><?php echo number_format($totalbrfotherdisc,2,'.',',');  ?></a></div></td>
                   <td  align="left" valign="center" class="bodytext31"><div align="right"><?php echo number_format(0,2,'.',','); //echo number_format($ipmiscamount,2,'.',','); ?></div></td>
			  ...
			  <td class="bodytext31" valign="center"  align="left"><div align="right"><strong><?php echo number_format($totadmn,2,'.',','); ?></strong></div></td>
				...
				<td class="bodytext31" valign="center"  align="left"><div align="right"><strong><?php echo number_format($totpha,2,'.',','); ?></strong></div></td>
				  ...
				  <td  align="left" valign="center" class="bodytext31"><div align="right"><strong><?php echo number_format($totmisc,2,'.',','); ?></strong></div></td>
				   <td  align="left" valign="center" class="bodytext31"><div align="right"><strong><?php echo number_format($totdisc,2,'.',','); ?></strong></div></td>
				  ...
				  <tr bgcolor="#ecf0f5">
                 <td class="bodytext31" valign="center"  align="left"><div align="center"><strong>Total OP</strong></div></td>
			     <td class="bodytext31" valign="center"  align="left"><div align="right">
				 
				 <a target="_blank" href="oprevenuereport_totalamend.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><strong><?php echo number_format($holetotal1,2,'.',','); ?></strong></a>
				 
				 
				 </div></td>
                </tr>
				<tr bgcolor="#CBDBFA">
                 <td class="bodytext31" valign="center"  align="left"><div align="center"><strong>Total IP</strong></div></td>
			     <td class="bodytext31" valign="center"  align="left"><div align="right"><a target="_blank" href="iprevenuereport_totalamend.php?cbfrmflag1=cbfrmflag1&locationcode=<?php echo $location; ?>&ADate1=<?php echo $transactiondatefrom; ?>&ADate2=<?php echo $transactiondateto; ?>"><strong><?php echo number_format($rowtot4,2,'.',','); ?></strong></a></div></td>
                </tr>
				<tr bgcolor="#CCC">
                 <td class="bodytext31" valign="center"  align="left"><div align="center"><strong>Total OP/IP</strong></div></td>
			     <td class="bodytext31" valign="center"  align="left"><div align="right"><strong><?php echo number_format($holetotal1+$rowtot4,2,'.',','); ?></strong></div></td>
                </tr>
				<tr><td>&nbsp;</td>
				  </tr>
				<tr bgcolor="#ecf0f5">
                 <td class="bodytext31" valign="center"  align="left"><div align="center"><strong> OP %</strong></div></td>
			     <td class="bodytext31" valign="center"  align="left"><div align="right"><strong><?php echo number_format((($holetotal1/($holetotal1+$rowtot4))*100),2,'.',','); ?></strong></div></td>
                </tr>
				<tr bgcolor="#CBDBFA">
                 <td class="bodytext31" valign="center"  align="left"><div align="center"><strong> IP %</strong></div></td>
			     <td class="bodytext31" valign="center"  align="left"><div align="right"><strong><?php echo number_format((($rowtot4/($holetotal1+$rowtot4))*100),2,'.',','); ?></strong></div></td>
                </tr>
				<?php } ?>
          </tbody>
        </table>

...

{
	...
	$query2 = "select * from master_costcenter where auto_number = '$departmentanum'";
...

	{
		...
		$query1 = "update master_costcenter set name = '$department',ipaddress = '$ipaddress',recorddate = '$updatedatetime' where auto_number = '$departmentanum'";
		...
		header ("location:costcenter.php");
...

	{
		...
		header ("location:editcostcenter1.php?bgcolorcode=failed&&st=edit&&anum=$departmentanum");
...

{
    ...
    $query1 = "select * from master_costcenter where auto_number = '$anum'";
      ...
      <tr>
        ...
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            ...
            <tr>
              ...
              <td><form name="form1" id="form1" method="post" action="editcostcenter1.php" onSubmit="return addward1process1()">
                  ...
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tbody>
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Cost Center Master - Add New </strong></td>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">Add New Cost Center </div></td>

                        <td align="left" valign="top"  bgcolor="#FFFFFF">

						<input name="department" id="department" value="<?php echo $res1department; ?>" style="border: 1px solid #001E6A; text-transform:uppercase;" size="40" /></td>

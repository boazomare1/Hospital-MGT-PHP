...
$new_datetime=date('Y-m-d H:i:s');		 
		 $query123="update ipconsultation_radiology set imgaquistatus='completed',imagefilename='$filename',imagefilename2='$filename2',imagefilename3='$filename3',aquisition_datetime='$new_datetime' where patientvisitcode='$visitcode' and radiologyitemcode='$itemcode' and auto_number='$auto_number' "; 
...
<form name="frmsales" id="frmsales" method="post" action="ipradiologyimgentry.php" onKeyDown="return disableEnterKey(event)"  enctype="multipart/form-data">
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$sno = '';
			$totalamount=0;			
$query61 = "select * from ipconsultation_radiology where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and resultentry='pending' and prepstatus='completed'  and imgaquistatus='pending' and radiologyitemcode='$q_itemcode' and auto_number='$q_refno' group by radiologyitemname";

...
$primary = $resicd['primarydiag'];
  ...
  <td colspan="10">&nbsp;</td></tr>
		   ...
		   <tr>
             ...
             <td width="" align="left" valign="center" class="bodytext31"><strong>Name:</strong></td> 

		     <td width="" align="left" valign="center" class="bodytext31"><?php echo $patientname; ?></td>

		     <td width="" align="left" valign="center" class="bodytext31"><strong>Invoice No:</strong></td> 

		     <td width="" align="left" valign="center" class="bodytext31"><?php echo $billno; ?></td>

          </tr>

	       <tr>

             <td width="" align="left" valign="center" class="bodytext31"><strong>Reg. No.:</strong></td>

	         <td width="" align="left" valign="center" class="bodytext31"><?php echo $patientcode; ?></td>

	         <td width="" align="left" valign="center" class="bodytext31"><strong>Bill Date:</strong></td> 

		     <td width="" align="left" valign="center" class="bodytext31"><?php echo date("d/m/Y", strtotime($billdate1)); ?></td>

         </tr>

          <tr>

             <td width="" align="left" valign="center" class="bodytext31"><strong>Bill Type:</strong></td>

	         <td width="" align="left" valign="center" class="bodytext31"><?php echo $billtype; ?></td>

	         <td width="" align="left" valign="center" class="bodytext31"><strong>IP Visit No.:</strong></td>

			 <td width="" align="left" valign="left" class="bodytext31"><?php echo $visitcode; ?></td>

         </tr>

        <tr>

			<td width="" align="left" valign="center" class="bodytext31"><strong>Account:</strong></td>

			<td width="" align="left" valign="center" class="bodytext31"><?php echo $accname; ?></td>

			<td width="" align="left" valign="center" class="bodytext31"><strong>Admission Date:</strong></td> 

	        <td width="" align="left" valign="center" class="bodytext31"><?php echo  date("d/m/Y", strtotime($admissiondate))." ".$admissiontime; ?></td>

</tr>		<tr>

            <td width="" align="left" valign="center" class="bodytext31"><strong>Covered By: </strong></td>

            <td width="" align="left" valign="center" class="bodytext31"><?php echo $subtype; ?></td>

            <td width="" align="left" valign="center" class="bodytext31"><strong>Discharge Date:</strong></td>

			<td width="" align="left" valign="center" class="bodytext31"><?php echo date("d/m/Y", strtotime($updatedate))." ".$updatedatetime; ?></td>
		 ...
		 <tr>
			...
			<td width="" align="left" valign="center" class="bodytext31"><strong>&nbsp;</strong></td>

             <td width="" align="left" valign="center" class="bodytext31">&nbsp;</td>

            <td width="" align="left" valign="center" class="bodytext31"><strong>No of Days:</strong></td>

			<td width="" align="left" valign="left" class="bodytext31"><?php echo $nbOfDays; ?></td>
         ...
         <tr>
			...
			<td width="" align="left" valign="center" class="bodytext31"><strong>Type:</strong></td>

			<td width="" align="left" valign="left" class="bodytext31"><?php echo $type; ?></td>
          ...
          <tr>
			...
			<td width="" align="left" valign="center" class="bodytext31"><strong>Bed No:</strong></td>

			<td width="" align="left" valign="center" class="bodytext31"><?php echo $bed;?></td>
  ...
  <td colspan="10">&nbsp;</td></tr> 
			...
			?>
			 ...
			 <td class="bodytext31"  valign="center"  align="left"><strong>Admission Fees:</strong></td>
                ...
                <td class="bodytext31" valign="center"  align="center"><?php echo number_format($consultationfee,2,'.',','); ?></td>
...

	{
	 ...
	 $reqdate = date('Y-m-d',strtotime($packagedate1) + (24*3600*$reqquantity));
          ...
          <tr>
                        ...
                        <td class="bodytext31" valign="center"  align="center"><?php  echo number_format($packageamount,2,'.',',');  ?></td>                   
...
$totalbedtransferamount=0;		
			...
			if($charge=="RMO Charges"){
					...
					<tr>
                        ...
                        <td class="bodytext31" valign="center"  align="center"><?php  echo number_format($amount,2,'.',',');  ?></td>                   
...
<td width="169" align="left"  valign="center" class="bodytext31">&nbsp;</td>
		...
		<tr>
			...
			<td class="bodytext31"  valign="center"  align="left"><strong>Pharmacy:</strong></td>
			 ...
			 <td class="bodytext31" valign="center"  align="center"><?php  echo number_format(($phaamount3/$fxrate),2,'.',',');  ?></td>
        ...
        <tr>
			...
			<td class="bodytext31"  valign="center"  align="left"><strong>Pharmacy Returns:</strong></td>
			 ...
			 <td class="bodytext31" valign="center"  align="center">-<?php  echo number_format(($phaamount31/$fxrate),2,'.',',');  ?></td>
...
//			  }
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="center"><?php echo number_format($totallab,2,'.',','); ?></td>
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="center"><?php echo number_format($totalrad,2,'.',','); ?></td>
...
<td width="169" align="left"  valign="center" class="bodytext31">&nbsp;</td>
        ...
        <?php	
           ...
           /*
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="center"><?php echo number_format($totalser,2,'.',','); ?></td>
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="center"><?php echo number_format($totalotbillingamount,2,'.',','); ?></td>
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="center"><?php echo number_format($totalprivatedoctoramount,2,'.',','); ?></td>
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="center"><?php echo number_format($totalambulanceamount,2,'.',','); ?></td>
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="center"><?php echo number_format($totalmiscbillingamount,2,'.',','); ?></td>
			...
			<td align="center" class="bodytext31" valign="middle" style=""><?php echo number_format($payoveralltotal,2,'.',','); ?></td>
		   ...
		   $totalcreditamt = $totalcreditamt + $totaldiscountamount; 
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="center"><?php echo number_format($totalcreditamt,2,'.',','); ?></td>
			...
			<tr>
				...
				<td class="bodytext31" colspan="1" valign="center"  align="center"><?php echo number_format($totaldeposit/$fxrate,2,'.',','); ?></td>
			...
			<tr>
				...
				<td class="bodytext31" colspan="1" valign="center"  align="center"><?php echo number_format($net_amount_summary,2,'.',','); ?></td>

			</tr>
			<tr>
				<td class="bodytext31" colspan="1" valign="center"  align="left">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="1" align="right"><strong><?php echo 'Diagnosis'; ?></strong></td>
...
<br />
		...
		<table width="" border="0"  align="center" cellpadding="2" cellspacing="0">
		...
		<thead>
			...
			<tr>
				...
				<td  align="left" valign="center" width="85" bgcolor="#ffffff" class="bodytext31"><strong>BILL DATE</strong></td>

				<td  align="left" valign="center" width="85" bgcolor="#ffffff" class="bodytext31"><strong>Ref.No</strong></td>

				<td  align="left" valign="center" style="white-space:normal" width="275" bgcolor="#ffffff" class="bodytext31"><strong>Description</strong></td>

				<td  align="right" valign="center" width="45" bgcolor="#ffffff" class="bodytext31"><strong>Qty</strong></td>

				<td  align="right" valign="center" width="110" bgcolor="#ffffff" class="bodytext31"><strong>Rate</strong></td>

				<td  align="right" valign="center" width="110" bgcolor="#ffffff" class="bodytext31"><strong>Amount</strong></td>
	...
	?>
			...
			<!-- <td class="bodytext31" valign="center"  align="left"><?php //echo $sno = $sno + 1; ?></td> -->
				...
				<td class="bodytext31" valign="center"  align="left" width="85"><?php echo $visitcode; ?></td>

			 <td class="bodytext31" valign="center"  align="left" width="275"><?php echo 'Admission Charge'; ?></td>

			     <td class="bodytext31" valign="center"  align="right" width="45"><?php echo '1'; ?></td>

                <td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($consultationfee,2,'.',','); ?></td>

				 <td class="bodytext31" valign="center"  align="right" width="110	"><?php echo $consultationfee; ?></td>
			...
			$description = $res741['description'];
...

	{
	 ...
	 $reqdate = date('Y-m-d',strtotime($packagedate1) + (24*3600*$reqquantity));
		...
		<!--	<td class="bodytext31" valign="center"  align="left"><?php //echo $sno = $sno + 1; ?></td> -->
			...
			<td class="bodytext31" valign="center"  align="left" width="275"><?php echo $packagename; ?></td>

			<td class="bodytext31" valign="center"  align="right" width="45"><?php echo '1'; ?></td>

			<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($packageamount,2,'.',','); ?></td>
...
$totalbedtransferamount=0;
			...
			$querya01 = "select * from billing_ipbedcharges where locationcode='$locationcode' and visitcode='$visitcode' and patientcode='$patientcode' and docno='$billno' and bed <> '0'";
			...
			while($resca01=mysqli_fetch_array($execa01)){
                ...
                <tr>
                    ...
                    <td class="bodytext31" valign="center"  align="left" width="85"><div align="left"><?php echo date("d-m-Y", strtotime($date)); ?></div></td>

                    <td class="bodytext31" valign="center"  align="left" width="85"><div align="left"><?php echo $wardname; ?></div></td>

                    <td class="bodytext31" valign="center"  align="left" width="275"><div align="left" ><?php echo $charge1.' ('.$bedname.')'; ?></div></td>

                    <td class="bodytext31" valign="center"  align="left" width="45"><div align="right"><?php echo $quantity; ?></div></td>

                    

                    <td class="bodytext31" valign="center"  align="left" width="110"><div align="right"><?php echo number_format($rate,2,'.',','); ?></div></td>

                    <td class="bodytext31" valign="center"  align="left" width="110"><div align="right"><?php echo number_format($amount,2,'.',','); ?></div></td>
...
//while (strtotime($from_limit_date) <= strtotime($to_limit_date)) {
			...
			$queryn19 = "select * from ipconsultation_lab where locationcode='$locationcode' and patientvisitcode='$visitcode' and patientcode='$patientcode' and labitemname <> '' and labrefund <> 'refund' and freestatus='No' ";
		...
		<!--	<td class="bodytext31" valign="center"  align="left"><?php //echo $sno = $sno + 1; ?></td> -->
			 ...
			 <td class="bodytext31" valign="center"  align="left"  width="275"nowrap="nowrap"><?php echo $phaname; ?></td>
			...
			<!-- <input name="medicinename[]" type="hidden" id="medicinename" size="25" value="<?php echo $phaname; ?>">
             ...
             <td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format(($pharate/$fxrate),2,'.',','); ?></td>

			 <td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($resamount,2,'.',',');; ?></td>
		...
		<!--	<input name="lab[]" id="lab" size="69" type="hidden" value="<?php echo $labname; ?>">
			...
			<td class="bodytext31" valign="center"  align="left" width="275"><?php echo $labname; ?></td>

			<td class="bodytext31" valign="center"  align="right" width="45"><?php echo '1'; ?></td>

			<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($labrate,2,'.',','); ?></td>
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="left" width="275"><?php echo $radname; ?></td>
		...
		<!--	<input name="radiology[]" id="radiology" type="hidden" size="69" autocomplete="off" value="<?php echo $radname; ?>">
			...
			<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($radrate,2,'.',','); ?></td>
		    ...
		    $query21 = "select * from ipconsultation_services where locationcode='$locationcode' and patientvisitcode='$visitcode' and patientcode='$patientcode' and servicesitemname <> '' and servicerefund <> 'refund' and wellnessitem <> '1' and freestatus = 'No'  group by servicesitemname,iptestdocno";
...
/*			$querys51 = "select sum(servicesitemrate) as rateperunit from `billing_ipservices` where patientvisitcode='$visitcode' and patientcode='$patientcode' and servicesitemcode='$sercode' and wellnessitem <> '1'";
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left"width="275"><?php echo $sername." - ".$servicesdoctorname; ?></td>
			...
			<!--	<input name="services[]" type="hidden" id="services" size="69" value="<?php echo $sername; ?>">
				...
				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($serrate,2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($totserrate,2,'.',','); ?></td>
		...
		<tr>
			...
			<td class="bodytext31" valign="center"  align="left"width="275"><?php echo $otbillingname; ?></td>
		...
		<!--	<input name="surgeryname[]" type="hidden" id="surgeryname" size="69" value="<?php echo $otbillingname; ?>">
			...
			<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($otbillingrate,2,'.',','); ?></td>
...

		   {
			...
			<!--	<td class="bodytext31" valign="center"  align="left"><?php //echo $sno = $sno + 1; ?></td> -->
				...
				<td class="bodytext31" valign="center"  align="left"width="275"><?php echo $privatedoctor.' '.$description; ?></td>
			...
			<!--	<input name="doctorname[]" type="hidden" id="doctorname" size="69" value="<?php echo $privatedoctor; ?>">
				...
				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($privatedoctorrate/$fxrate,2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($privatedoctoramount,2,'.',','); ?></td>
...

		   {
			...
			<!--	<td class="bodytext31" valign="center"  align="left"><?php //echo $sno = $sno + 1; ?></td> -->
				...
				<td class="bodytext31" valign="center"  align="left"width="275"><?php echo $ambulance; ?></td>
			...
			<!--	<input name="doctorname[]" type="hidden" id="doctorname" size="69" value="<?php echo $ambulance; ?>">
				...
				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($ambulancerate/$fxrate,2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($ambulanceamount,2,'.',','); ?></td>
...

		   {
			...
			<!--	<td class="bodytext31" valign="center"  align="left"><?php //echo $sno = $sno + 1; ?></td> -->
				...
				<td class="bodytext31" valign="center"  align="left"width="275"><?php echo $miscbilling; ?></td>
			...
			<!--	<input name="doctorname[]" type="hidden" id="doctorname" size="69" value="<?php echo $miscbilling; ?>">
				...
				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($miscbillingrate/$fxrate,2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($miscbillingamount,2,'.',','); ?></td>
			...
			$query112 = "select * from master_transactionipdeposit where locationcode='$locationcode' and patientcode='$patientcode' and visitcode='$visitcode' and transactionamount>0";
			...
			<!--	<td class="bodytext31" valign="center"  align="left"><?php //echo $sno = $sno + 1; ?></td> -->
				...
				<td class="bodytext31" valign="center"  align="left" width="275"><?php echo 'Deposit'; ?>&nbsp;&nbsp;<?php echo $transactionmode; ?>
				...
				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($depositamount,2,'.',','); ?></td>
			  ...
			  $query112 = "select * from master_transactionadvancedeposit where locationcode='$locationcode' and patientcode='$patientcode' and visitcode='$visitcode'";
			...
			?>
			  ...
			  <tr>
				...
				<!-- <td class="bodytext31" valign="center"  align="left"><?php //echo $sno = $sno + 1; ?></td> -->
				 ...
				 <td class="bodytext31" valign="center"  align="left"width="275"><?php echo 'Deposit Refund'; ?></td>

				 <td class="bodytext31" valign="center"  align="right" width="45"><?php echo '1'; ?></td>

				 <td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($depositrefundamount,2,'.',','); ?></td>
...

		   {
			...
			<tr>
				...
				<td class="bodytext31" valign="center"  align="left"width="275"> <?php echo 'NHIF'; ?></td>

				<td class="bodytext31" valign="center"  align="right" width="45"><?php echo $nhifqty; ?></td>

				<td class="bodytext31" valign="center"  align="right" width="110">-<?php echo number_format($nhifrate,2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right" width="110">-<?php echo number_format($nhifclaim,2,'.',','); ?></td>
...

		   {
			...
			<!--	<td class="bodytext31" valign="center"  align="left"><?php //echo $sno = $sno + 1; ?></td> -->
				...
				<td class="bodytext31" valign="center"  align="left"width="275">Discount On <?php echo $discount; ?> by <?php echo $authorizedby; ?></td>
			...
			<!--	<input name="doctorname[]" type="hidden" id="doctorname" size="69" value="<?php echo $discount; ?>">
				...
				<td class="bodytext31" valign="center"  align="right" width="110"><?php echo number_format($discountrate,2,'.',','); ?></td>
			...
			$query64 = "select * from master_transactionip where locationcode='$locationcode' and patientcode='$patientcode' and visitcode='$visitcode'";
          ...
          <table align="center" cellpadding="0" cellspacing="2" width="" border="0">

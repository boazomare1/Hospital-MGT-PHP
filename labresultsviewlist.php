...
$query24 = "select * from master_employee where username = '$orderedby'";
   ...
   $query44 = "update consultation_lab set publishstatus='completed',publishdatetime='".date('Y-m-d h:i:s')."' where resultdoc='$docno'";
		...
		$query43 = "update resultentry_lab set publishstatus='completed',publishdatetime='".date('Y-m-d h:i:s')."',published_by='$username' where docnumber='$docno'";
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="11" bgcolor="#ecf0f5" class="bodytext31" nowrap="nowrap"><div align="left"><strong>Lab Results View</strong><label class="number"><<<?php echo $resnw1;?>>></label></div></td>
			 </tr>
            <tr>
		...
		$query1 = "select * from resultentry_lab where locationcode = '".$locationcode."' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and patientcode <> 'walkin' and recorddate between '$fromdate' and '$todate' and docnumber like '%$docnumber%' and resultstatus='completed' and publishstatus = '' group by docnumber order by patientvisitcode";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));

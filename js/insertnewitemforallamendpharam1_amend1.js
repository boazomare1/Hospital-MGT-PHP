function insertitem10()
{
	...
	if(Number.isInteger(parseInt(document.form1.quantity.value))==false || parseInt(document.form1.quantity.value)==0)
	{
...
/*  
	...
	*/
	...
	td1.id = "serialnumber"+varpharamsno+"";
	//td1.align = "left";
	td1.valign = "top";
	...
	text1.id = "serialnumber"+varpharamsno+"";
	text1.name = "serialnumber"+varpharamsno+"";
	text1.type = "hidden";
	text1.size = "25";
	text1.value = i;
	...
	td101.id = "serialnumber"+varpharamsno+"";
	//td1.align = "left";
	td101.valign = "top";
	...
	text2.id = "adose"+varpharamsno+"";
	text2.name = "adose["+varpharamsno+"]";
	text2.type = "text";
	text2.size = "8";
	text2.value = varDose;
	...
	td21.id = "adosemeasure"+varpharamsno+"";
	td21.align = "left";
	td21.valign = "top";
	...
	text21.id = "adosemeasure"+varpharamsno+"";
	text21.name = "adosemeasure["+varpharamsno+"]";
	text21.type = "text";
	text21.size = "8";
	...
	td3.id = "afrequency"+varpharamsno+"";
	td3.align = "left";
	td3.valign = "top";
	...
	text3.id = "afrequency"+varpharamsno+"";
	text3.name = "afrequency["+varpharamsno+"]";
	text3.type = "hidden";
	text3.size = "12";
	text3.value = varFrequency;
	...
	text5.id = "adays"+varpharamsno+"";
	text5.name = "adays["+varpharamsno+"]";
	text5.type = "text";
	text5.size = "6";
	text5.value = varDays;
	...
	text6.id = "aquantity"+varpharamsno+"";
	text6.name = "aquantity["+varpharamsno+"]";
	text6.type = "text";
	text6.size = "4";
	...
	text12.id = "aroute"+varpharamsno+"";
	text12.name = "aroute["+varpharamsno+"]";
	text12.type = "text";
	text12.size = "10";
	...
	td7.id = "ainstructions"+varpharamsno+"";
	td7.align = "left";
	td7.valign = "top";
	...
	text7.id = "ainstructions"+varpharamsno+"";
	text7.name = "ainstructions["+varpharamsno+"]";
	text7.type = "text";
	text7.size = "14";
	...
	td81.id = "aamounttd"+varpharamsno+"";
	td81.align = "left";
	td81.valign = "top";
	...
	td102.id = "aitemcode"+varpharamsno+"";
	//td1.align = "left";
	td102.valign = "top";
	...
	text102.id = "aitemcode"+varpharamsno+"";
	text102.name = "aitemcode["+varpharamsno+"]";
	text102.type = "hidden";
	text102.align = "left";
	text102.size = "10";
	text102.value = varmedicinecode;

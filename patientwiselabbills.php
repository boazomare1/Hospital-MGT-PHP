    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Patient Wise Lab Bills</strong></td>
              </tr>
            <tr>
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
		  ...
		  $exec1age = mysqli_query($GLOBALS["___mysqli_ston"], $query1age) or die ("Error in Query1age".mysqli_error($GLOBALS["___mysqli_ston"]));
		  $res1age = mysqli_fetch_array($exec1age);
		  ...
		  { 
		  $query31 = "select * from billing_paylaterlab where patientname = '$res21patientfullname' and patientvisitcode = '$res21visitcode' and patientcode = '$res21patientcode' and billdate between '$ADate1' and '$ADate2'";
		  }
		  else if($res21billtype == 'PAY NOW')
		  {
		  $query31 = "select * from billing_paynowlab where patientname = '$res21patientfullname' and patientvisitcode = '$res21visitcode' and patientcode = '$res21patientcode' and billdate between '$ADate1' and '$ADate2'";
		  }
		  $exec31 = mysqli_query($GLOBALS["___mysqli_ston"], $query31) or die ("Error in Query31". mysqli_error($GLOBALS["___mysqli_ston"]));
		  
		  if($res21billtype == 'PAY LATER')
		  {
		  $query44 = "select * from billing_paylaterlab where patientname = '$res21patientfullname' and patientvisitcode = '$res21visitcode' and billdate between '$ADate1' and '$ADate2'";
		  }
		  else if($res21billtype == 'PAY NOW')
		  {
		   $query44 = "select * from billing_paynowlab where patientname = '$res21patientfullname' and patientvisitcode = '$res21visitcode' and billdate between '$ADate1' and '$ADate2'";
		  }
		  ...
		  <tr bgcolor="#9999FF">
              <td colspan="8"  align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo strtoupper($res21patientfullname); ?> (<?php echo $res21patientcode;?>, <?php echo $res21visitcode; ?>,<?php echo $res21gender; ?>,<?php echo $age; ?>)</strong></td>
              </tr>
		  ...
		  $exec144 =mysqli_query($GLOBALS["___mysqli_ston"], $query144) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		  $res144= mysqli_fetch_array($exec144);

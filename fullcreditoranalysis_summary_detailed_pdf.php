        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse; width: 90%" 
         ...
         <!-- <tr><td colspan="13">&nbsp;</td></tr> -->
            ...
            <tr>
              ...
              <!-- <td style="width: 10%;" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31"><strong>Supplier Name</strong></td> -->
           ...
           <tr  bgcolor="#ff944d">
            		<td colspan="3" class="bodytext31" valign="center"  align="left"><strong><?php echo strtoupper($res22accountname);?></strong></td>
            		 <td colspan="1" class="bodytext31" valign="center"  align="left">Open Bal : </td>
		  ...
		  $snocount = $snocount + 1;
           ...
           <tr   >
              ...
              <td class="bodytext31" valign="center"  align="left"><?php echo $snocount; ?></td>
               ...
               <!-- <td class="bodytext31" valign="center"  align="left"> <?php // echo $res21suppliername; ?></td> -->
...
//      $html2pdf->setModeDebug();
        ...
        $html2pdf->Output('print_fullcreditor_detailed.pdf');

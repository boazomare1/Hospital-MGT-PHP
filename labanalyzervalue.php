            ...
            <tr>
              <td><form name="form1" id="form1" method="post" action="labanalyzervalue.php">
                <table width="1300" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>Lab Item Master - Existing List - Latest 50 Lab Items </strong></span></td>
                      ...
                      <tr bgcolor="#011E6A">
                        <td width="5%" bgcolor="#ecf0f5" class="bodytext3"><div align="center"><strong>S.No</strong></div></td>

...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="9" bgcolor="#ecf0f5" class="bodytext31" nowrap="nowrap"><div align="left"><strong>Lab Results View</strong><label class="number"><<<?php echo $resnw1; ?>>></label></div></td>
			 </tr>
            <tr>

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="optracking.php" >
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>OP Tracking</strong></td>
...
?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td width="155"  align="left" valign="center" 
				...
				<td width="185"  align="left" valign="center" 
		...
		$query1 = "select * from master_visitentry where  patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientfullname like '%$searchpatient%'  order by auto_number desc";
	    ...
	    $colorloopcount = $colorloopcount + 1;
          ...
          <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="fetch_pages_track.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&location=<?php echo $locationcode;?>" target='_blank'><strong>Track</strong></a> </td>

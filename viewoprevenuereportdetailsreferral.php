...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Referral</strong></td>
			...
			$query1 = "select * from billing_paynowreferal where billdate between '$ADate1' and '$ADate2'";
...
-->		
           <tr>
			...
			<a href="viewoprevenuereportdetailsreferralxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>
			</tr>
        </table>
	   </tr>

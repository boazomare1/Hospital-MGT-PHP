          ...
          <tbody>
            <tr>
			  ...
			  <form method="post" name="form2" id="form2" action="automaticpo.php" onSubmit="return Valid1();">
			   <tr>
              <td class="bodytext31" valign="center"  align="left" bgcolor="#ecf0f5"><strong>Location</strong></td>
              <td align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31">
           ...
           <td colspan="9" bgcolor="#ecf0f5" align="left" class="bodytext3"><input type="hidden" name="frmflag45" id="frmflag45" value="frmflag45">
		   ...
		   <input type="text" name="ADate1" id="ADate1" readonly value="<?php echo date('Y-m-d'); ?>" size="10"></td>
			...
			$reorderquery1 = "select cum_quantity from transaction_stock where itemcode = '$itemcode' and cum_stockstatus='1' and locationcode = '$location'";

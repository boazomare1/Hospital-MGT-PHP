...
include ("db/db_connect.php");
 ...
 if($accountssub ==""){
	...
	$accountssubsql = "accountssub like '%%'";

 }else{

	$accountssubsql = "accountssub = '$accountssub'";
...
// $query1 = "select id,accountname,accountssub from master_accountname where accountsmain = '7' and $accountssubsql and accountname like '%$process%' and recordstatus <> 'Deleted' order by accountname limit 15";
$query1 = "select id,accountname,accountssub from master_accountname where accountssub = '12' and accountname like '%$process%' and recordstatus <> 'Deleted' order by accountname limit 15";

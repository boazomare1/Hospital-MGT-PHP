...
$(function() {
	...
	source:'ajaxipadmdoctorsearch1.php', 
	//alert(source);
	minLength:3,
	delay: 0,
	html: true, 
...
<table width="129%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1447"><form name="cbform1" method="post" action="doctorrevenuereportdetailed.php">
          <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Doctor Detail Revenue </strong></td>
			  ...
			  <tr>
			   <td align="left" valign="middle"  bgcolor="#ffffff"><span class="bodytext31">Admission Doctor </span></td>
				  <td align="left" valign="middle"  bgcolor="#ffffff" class="bodytext31"><strong>
            ...
            <tr>
              ...
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="right" 
                ...
                <td width="35" rowspan="2" align="right" valign="center" 
                  bgcolor="#ecf0f5" class="bodytext31"><div align="left"><a target="_blank" href="print_doctorrevenuereportdetailed.php?cbfrmflag1=cbfrmflag1&&locationcode=<?php echo $location; ?>&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&consultingdoctorsearch=<?php echo $consultingdoctorsearch; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></div></td>
               </tr>

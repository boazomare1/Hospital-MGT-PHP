		...
		<div class="row">
			<div class="col-8">
				<table width="100%" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse;">
				    ...
				    <tr bgcolor="#011E6A">
				     ...
				     <tr>
						<td width="22%"  align="right" valign="center" bgcolor="#FFFFFF" class="bodytext31"> Start Date </td>
						<td width="25%" align="left" valign="center"  bgcolor="#FFFFFF"><span class="bodytext31">
						...
						<td width="15%"  align="right" valign="center" bgcolor="#FFFFFF" class="bodytext31"> End Date </td>
					...
					<tr>
						<td width="15%"  align="right" valign="center" bgcolor="#FFFFFF" class="bodytext31"> Include Opening Bal </td>
						<td colspan="1" align="left" valign="center"  bgcolor="#FFFFFF"><span class="bodytext31"> <input type="checkbox" name="includeopenbal"  id="includeopenbal"value='1' <?php if($includeopenbal=='1') {echo 'checked';} ?>/></span> </td>
						<td width="25%"  align="right" valign="center" bgcolor="#FFFFFF" class="bodytext31"> Include Zero Balance Ledgers </td>
						<td colspan="1" align="left" valign="center"  bgcolor="#FFFFFF"><span class="bodytext31"> <input type="checkbox" name="includezeroballeg"  id="includezeroballeg"value='1' <?php if($includezeroballeg=='1') {echo 'checked';} ?>/></span> </td>
					</tr>
					<tr>
			...
			<div class="col-4">
				...
				<div style="text-align:left;">
					<a href="print_treetrial.php?ADate1=<?php echo $ADate1;?>&&ADate2=<?php echo $ADate2; ?>&&includeopenbal=<?php echo $includeopenbal; ?>&&location=<?php echo $location; ?>&&includezeroballeg=<?php echo $includezeroballeg; ?>" id="downloadLink" target="_blank" ><img src="images25/excel-xls-icon.png" alt="excel export" width="50px" height="50px"/></a>
				</div>
			<?php } ?>
			</div>
	     </div>
				...
				{       
						...
						$section = $res['section'];
							...
							//$openingenddate = date('Y-m-d',strtotime('-1 day', strtotime($from_date)));
								...
								echo getSubgroups($res['uid'],$from_date,$to_date,$sno,$includeopenbal,$locationwise,$includezeroballeg);
								echo "</tbody>";
				}
...
<?php
function getSubgroups($account_id,$from_date,$to_date,$sno,$includeopenbal,$locationwise,$includezeroballeg){
	...
	{   
		$sno2 = $sno2 + 1;
		getGroupBalance($res['uid'],$from_date,$to_date,$sno,$sno2,$includeopenbal,$locationwise,$includezeroballeg);		
	}

	return $data;
}

function getLedger($group_id,$from_date,$to_date,$sno,$sno2,$includeopenbal,$locationwise,$includezeroballeg){
...
function getGroupBalance($group_id,$from_date,$to_date,$sno,$sno2,$includeopenbal,$locationwise,$includezeroballeg){
	$data = "";
	...
	$section = $res1['section'];			
	 ...
	 if($res['show_ledger']=="1"){
		 	 $data .=getLedger($res['uid'],$from_date,$to_date,$sno,$sno2,$includeopenbal,$locationwise,$includezeroballeg);
		 }

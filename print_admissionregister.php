...
<table cellspacing="3" cellpadding="0" align="left" border="0" style="border-collapse:collapse;" width="100%">
	...
	<tr>
		<td class="bodytext31" valign="middle"  align="left" ><strong>Admission Register From <?php echo date("d/m/Y", strtotime($ADate1)); ?> to <?php echo date("d/m/Y", strtotime($ADate2)); ?> printed on <?php echo $currentdate; ?></strong></td>  
	</tr>
	<tr>
		<td colspan="10"><br></td>
	</tr>
        ...
        <?php
          ...
          while ($res1 = mysqli_fetch_array($exec1)){
	          ...
	          <tr <?php echo $colorcode; ?>>
	           	<td width="8%" class="bodytext31" valign="middle" align="left"><?php echo $admissiondate; ?></td>
	          	<td width="6%" align="left" valign="middle" class="bodytext31"><?php echo wordwrap(strtoupper($ipnumber),10,"<br>\n"); ?></td>
	            <td width="15%" class="bodytext31" valign="middle" align="left"><?php echo strtoupper($patientname); ?></td>
	            <td width="6%" class="bodytext31" valign="middle"  align="left"><?php echo strtoupper($gender); ?></td>
	            <td width="6%" class="bodytext31" valign="middle"  align="left"><?php echo $age ." YEARS";?></td>
	            <td width="15%" class="bodytext31" valign="middle"  align="left"><?php $doc = explode(".", $admissiondoc); foreach($doc as $item){ echo ( wordwrap(strtoupper($item)." ", 12, "<br>\n")); } ?></td>
	            <td width="15%" class="bodytext31" valign="middle"  align="left"><?php echo wordwrap(strtoupper($consultingdoc),15,"<br>\n"); ?></td>
	            <td width="15%"class="bodytext31" valign="middle"  align="left"><?php echo wordwrap(strtoupper($companyname),25,"<br>\n"); ?></td>
	            <td width="6%" class="bodytext31" valign="middle"  align="left"><?php echo wordwrap(strtoupper($bedno),10,"<br>\n");?></td>
	            <td width="6%" class="bodytext31" valign="middle"  align="left"><?php echo $dischargedate; ?></td>
	          </tr>
		<?php
				}
			}
            ...
            ?>
            <tr>
				<td colspan="10" bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo $res23['ward']; ?></strong></td>
			</tr>
			<tr>
	          	<col width="80"><td align="center" valign="center"  
	            	bgcolor="#ffffff" class="bodytext31"><strong>Admission Date</strong></td>
...
//      $html2pdf->setModeDebug();
        ...
        $html2pdf->Output('print_admissionregister.pdf');
    }

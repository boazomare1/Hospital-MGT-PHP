...
header('Content-Disposition: attachment;filename="FullDebtorAnalysisDetailedOutstanding.xls"');
...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="center" colspan="17" bgcolor="#ffffff" class="bodytext31"><strong>Full Debtor Analysis Detailed</strong></td>  

            </tr>

			<tr>

              <td align="center" colspan="17" bgcolor="#ffffff" class="bodytext31"><strong>Report From <?php echo $ADate1; ?> To <?php echo $ADate2; ?></strong></td>  
...
*/
		...
		$openingtransactiondate = $opres['transactiondate'];
            ...
            <td colspan="6"  align="left" valign="center" bgcolor="#FFF" class="bodytext31" ><strong><?php echo $subtype; ?> </strong></td>
               <td colspan="4"  align="right" valign="center" bgcolor="#FFF" class="bodytext31" ><strong>Opening Balance Total:</td>
...
//ACCOUNT WISE OPENING BALANCE END					
		   ...
		   <td class="bodytext31" valign="center"  align="left"><?=$sno++;?></td>
                ...
                <td class="bodytext31" valign="center" colspan="4" align="right">Opening Balance</td>

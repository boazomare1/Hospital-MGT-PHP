...
// Check if table exists and get radiology results data
$tableExists = false;
$exec2 = null;
$sno = 0;

// Check if table exists
$checkTable = "SHOW TABLES LIKE 'resultentry_radiology'";
$checkResult = mysqli_query($GLOBALS["___mysqli_ston"], $checkTable);
if(mysqli_num_rows($checkResult) > 0) {
    $tableExists = true;
    $query2 = "select * from resultentry_radiology where date(updatedatetime) between '$transactiondatefrom' and '$transactiondateto' order by updatedatetime desc";
...
<head>
    ...
    <title>Radiology Results - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/ipradiologyresults-modern.css?v=<?php echo time(); ?>">
...
<body>
        ...
        <aside id="leftSidebar" class="left-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="ipservicelist.php" class="nav-link">
                            <i class="fas fa-stethoscope"></i>
                            <span>Service List</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="ipradiologyresults.php" class="nav-link active">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2><i class="fas fa-x-ray"></i> Radiology Results</h2>
                    <p>View and manage radiology examination results</p>
                </div>
                ...
                <form method="post" class="search-form">
                    <div class="search-row">
                        <div class="search-group">
                            ...
                            <input type="text" id="searchInput" class="search-input" placeholder="Search by patient name, examination, or ID...">
                        </div>
                        
                        <div class="search-group">
                            <label for="fromDate">From Date</label>
                            <input type="text" id="fromDate" name="ADate1" class="search-input" value="<?php echo $transactiondatefrom; ?>" readonly>
                        </div>
                        
                        <div class="search-group">
                            <label for="toDate">To Date</label>
                            <input type="text" id="toDate" name="ADate2" class="search-input" value="<?php echo $transactiondateto; ?>" readonly>
                        </div>
                        
                        <div class="search-group">
                            <label for="examinationType">Examination Type</label>
                            <select id="examinationType" class="search-input">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="8" style="text-align: center; padding: 3rem;">
                                <div style="color: #64748b; font-size: 1.1rem;">
                                    ...
                                    <p>The 'resultentry_radiology' table does not exist in the database.</p>
                        ...
                        <tr>
                            <td colspan="8" style="text-align: center; padding: 3rem;">
                                <div style="color: #64748b; font-size: 1.1rem;">
                                    ...
                                    <p>No radiology results found for the selected date range.</p>
                                </div>
                            </td>
                        </tr>
                        <?php } else if ($exec2) { 
                            ...
                            while ($res2 = mysqli_fetch_array($exec2)) {
                                ...
                                $examination = $res2["examination"];
                                $examinationtype = $res2["examinationtype"];
                                $result = $res2["result"];
                                $examinationdate = $res2["updatedatetime"];
                                $status = $res2["status"];
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($examination); ?></td>
                            <td><?php echo htmlspecialchars($examinationtype); ?></td>
                            <td><?php echo htmlspecialchars(substr($result, 0, 50)) . (strlen($result) > 50 ? '...' : ''); ?></td>
                            <td><?php echo date('d-m-Y H:i', strtotime($examinationdate)); ?></td>
                            <td>
    ...
    <!-- Modern JavaScript -->
    <script src="js/ipradiologyresults-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

			...
			if($num69 > 0)
		{
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="left">
                ...
                <option value="ipmedicineissue.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode;?>&&searchlocation=<?php echo $searchlocation;?>&&menuid=<?php echo $menu_id; ?>">Medicine Request</option>
		</select></td>
              </tr>
		   <?php 
		   }

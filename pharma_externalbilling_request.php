...
if(isset($_POST['dis']) && count($_POST['dis'])>1){
	...
	*/
	...
	/*		 $query1222 = "select bankrefno from bank_refrencenumber  where visitcode='$visitcode' and patientcode='$patientcode' and patientname='$patientfullname' and billnumber='' ";
		...
		header("location:pharma_externalbilling_request.php");
...
<form name="form1" id="frmsales" method="post" action="pharma_externalbilling_request.php" onSubmit="return validcheck()"   >
			   ...
			   <tr>
				...
				<td><input type="text" name="billno" id="billno" value="<?php echo $billnumbercode; ?>" size="18" rsize="20" readonly/></td>
				  ...
				  <tr>
							 ...
							 <td align="left" valign="middle" class="bodytext3"><strong>Consulting Doctor</strong></td>

				<td><input type="text" name="consultingdoctor" id="consultingdoctor" value="" size="28" rsize="20" />				</td>	

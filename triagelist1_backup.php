   ...
   <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860">
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong> Search Patient to Triage </strong></td>
          ...
          <td width="263" align="left" valign="center"  bgcolor="#ffffff"><span class="bodytext31">
			...
			<tr>
                ...
                <table >
                	<tr >
                		<td>&nbsp;&nbsp;&nbsp;</td> 
                		<td ><iframe id="publishedlistiframe" src="publishedlistiframe_intriagelist.php" width="670" height="250" frameborder="1">                  </iframe>                  
              </td>
                	</tr>
                </table>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="10" bgcolor="#ecf0f5" class="bodytext31"><script language="javascript">
           ...
           $query123 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and locationcode='$locationcode' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and locationcode='$locationcode' and  paymentstatus = '' and consultationdate between '$fromdate' and '$todate'  order by auto_number desc";
			...
			$exec123 = mysqli_query($GLOBALS["___mysqli_ston"], $query123) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			<td class="bodytext31" valign="center"  align="left">
             ...
             <td class="bodytext31" valign="center"  align="left">
			  ...
			  {?>
				...
				<a href="mchtriagebilling.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"></a></div>

				<?php } else{?>

				<div align="left"><a href="addtriage2.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"><strong>Triage</strong></a>&nbsp;&nbsp;

				<a href="triagebilling.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>"></a></div>

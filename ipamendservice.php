...

{
...

	{
		...
		$servicequery= mysqli_query($GLOBALS["___mysqli_ston"], "select * from master_services where itemname='$servicesname'") or die ("Error in query1".mysqli_error($GLOBALS["___mysqli_ston"])); 
		...
		{	
...

			{
				...
				$servicesquery1=mysqli_query($GLOBALS["___mysqli_ston"],"insert into ipconsultation_services(consultationid,patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,billtype,accountname,consultationdate,paymentstatus,refno,process,freestatus,locationcode)values('$consultationid','$patientcode','$patientname','$visitcode','$servicescode','$servicesname','$servicesrate','$patientpaymentmode','$accountname','$consultationdate','$status','$serrefnonumber','pending','$servicesfree','$locationcode')") or die ("Error in query1".mysqli_error($GLOBALS["___mysqli_ston"])); 

				$servicesquery2=mysqli_query($GLOBALS["___mysqli_ston"], "update master_visitentry set servicebill='pending' where visitcode='$visitcode' and locationcode='$locationcode'") or die ("Error in query1".mysqli_error($GLOBALS["___mysqli_ston"])); 
...
$data=mysqli_query($GLOBALS["___mysqli_ston"], "select auto_number,patientcode,patientvisitcode,patientname,refno,servicesitemcode,servicesitemname,servicesitemrate,serviceqty,amount from ipconsultation_services where auto_number='$servicename'") or die ("Error in query1".mysqli_error($GLOBALS["___mysqli_ston"])); 
...
$time=date('H:i:s');
$remarks=stripslashes(urldecode($_REQUEST['remarks-'.$servicename]));
...

{
 ...
 $query="insert into amendment_details (patientcode,visitcode,patientname,refno,itemcode,itemname,rate,qty,amount,amenddate,amendtime,amendfrom,amendby,ipaddress,type,remarks) values ('$patientcode','$visitcode','$patientname','$refno','$medicinecode','$medicinename','$rate','$serviceqty','$amount','$date','$time','services','$username','$ipaddress','IP','$remarks')";
...
mysqli_query($GLOBALS["___mysqli_ston"], $query) or die ("Error in query".mysqli_error($GLOBALS["___mysqli_ston"]));
 ...
 $delete="delete from ipconsultation_services where auto_number='$servicename' and patientvisitcode='$visit' and locationcode='$locationcode'";

$exedelete=mysqli_query($GLOBALS["___mysqli_ston"], $delete) or die ("Error in delete".mysqli_error($GLOBALS["___mysqli_ston"]));
...
$querylab1=mysqli_query($GLOBALS["___mysqli_ston"], "select * from master_customer where customercode='$patientcode'") or die ("Error in query121".mysqli_error($GLOBALS["___mysqli_ston"])); 
...
$querylab2=mysqli_query($GLOBALS["___mysqli_ston"], "select * from master_accountname where auto_number='$patientaccount'") or die ("Error in query121".mysqli_error($GLOBALS["___mysqli_ston"])); 
...
function deletevalid(id,patient,visit,locationcode)
{
...
window.location='ipamendservice.php?delete='+id+'&patientcode='+patient+'&&visitcode='+visit+'&locationcode='+locationcode+'&remarks-'+id+'='+msg;
}
  ...
  <tr>
			  ...
			  <tr>
			   ...
			   <tr>
                ...
                <td colspan="3" align="left" valign="top" class="bodytext3">
				  ...
				  <input type="hidden" name="locationcode" id="locationcode" value="<?php echo $patientlocationcode; ?>" /></td>
          ...
          <tbody id="foo">
            ...
            <tr>
              ...
              <td width="16%" class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Ref.Code </strong></div></td>
	...
	$status='completed';
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $iptestdocno; ?>
			    ...
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 ...
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				  ...
				  <td class="bodytext31" valign="center"  align="left"><div align="center"><select name="afree[]" id="afree">
					  ...
					  <td class="bodytext31" valign="center"  align="left"><div align="center"><input type = "text" name ="remarks-<?php echo $autonumber; ?>" id ="remarks-<?php echo $autonumber; ?>"></div></td>

				  <td class="bodytext31" valign="center"  align="left"><div align="center"><a onClick="return deletevalid('<?php echo $autonumber; ?>','<?php echo $patientcode; ?>','<?php echo $visitcode; ?>','<?php echo $locationcode; ?>')" href='javascript:return false;' >Delete</a></div></td>
	   ...
	   <td width="9%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Add Service</strong></td>
     	...
     	<tr id="serid">
				 ...
				 <tr>
				   ...
				   <td colspan="6" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">Total Amount</span>

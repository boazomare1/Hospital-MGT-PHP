...
$billnumber = $billnumbercode;
	...
	$transactiontype = 'PAYMENT';
		...
		transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,financialyear,username,transactiontime,cashgivenbycustomer,cashgiventocustomer,source,locationname,locationcode,mpesanumber,bankcode) 
		...
		'$transactionmodule','$patientname','$patientcode','$visitcode','$accountname','$doctorname','paid','$financialyear','$username','$timeonly','$cashgivenbycustomer','$cashgiventocustomer','paynowrefund','".$locationnameget."','".$locationcodeget."','$paymentmode')";

		$exec9 = mysqli_query($GLOBALS["___mysqli_ston"], $query9) or die ("Error in Query9".mysqli_error($GLOBALS["___mysqli_ston"]));

		

		$query37 = "insert into paymentmodecredit(patientname,patientcode,patientvisitcode,accountname,billnumber,billdate,ipaddress,username,mpesa,mpesacoa,source,locationname,locationcode)values('$patientname','$patientcode','$visitcode','$accountname','$billnumber','$billdate','$ipaddress','$username','$totalamount','$paymentmode','paynowrefund','".$locationnameget."','".$locationcodeget."')";
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "update consultation_lab set labrefund='completed' where patientvisitcode='$visitcode' and labitemname='$labname'");
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "update consultation_radiology set radiologyrefund='completed' where patientvisitcode='$visitcode' and radiologyitemname='$radname'");
	...
	mysqli_query($GLOBALS["___mysqli_ston"], "update consultation_services set servicerefund='completed' where patientvisitcode='$visitcode' and servicesitemname='$sername' and auto_number='".$serautonumber."'");
...
$query475 = "insert into refund_paylaterservices(patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,accountname,billdate,billnumber,username,servicecoa,locationname,locationcode,servicesitemqty,amount)values
	...
	function openPrint(){
		...
		window.top.location = "patientbillingstatus_bills.php?mainmenuid=MM005";
		...
		//window.location = "location:patientbillingstatus_bills.php?mainmenuid=MM005";
      ...
      <tr>
          ...
          <tbody id="foo">
           ...
           <tr bgcolor="#011E6A">
            ...
            <tr>
			  ...
			  $query19 = "select * from consultation_lab where patientvisitcode='$visitcode1' and patientcode='$patientcode1' and labrefund='refund' and refundapproval = 'approved'";
			...
			?>
             ...
             <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo  number_format($copaylab, 2, '.', ','); ?></div></td>
			...
			<td width="4%"  align="left" valign="center" 
			  ...
			  $query23 = "select * from pharmacysalesreturn_details where visitcode='$visitcode' and patientcode='$patientcode' and billstatus='pending' and refundapproval = 'approved'";
			...
			<td width="4%"  align="left" valign="center" 
			  ...
			  $query20 = "select * from consultation_radiology where patientvisitcode='$visitcode' and patientcode='$patientcode' and radiologyrefund='refund' and refundapproval = 'approved'";
		...
		//	$totalrad=$totalrad+$radrate;
			...
			?>
             ...
             <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo  number_format($copayrad, 2, '.', ','); ?></div></td>
			...
			$query21 = "select * from consultation_services where patientvisitcode='$visitcode' and patientcode='$patientcode' and servicerefund='refund' and refundapproval = 'approved'";

			$exec21 = mysqli_query($GLOBALS["___mysqli_ston"], $query21) or die ("Error in exec21".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			?>
             ...
             <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo  number_format($copayser, 2, '.', ','); ?></div></td>

			 <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo  number_format($copaysertotal, 2, '.', ','); ?></div></td>

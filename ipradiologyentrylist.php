        ...
        <td width="860">
              <form name="cbform1" method="post" action="ipradiologyentrylist.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                  <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong> Search Radiology result</strong></td>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
					$query1 = "select * from ipconsultation_radiology where patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and prepstatus='completed' and imgaquistatus='completed' and billtype='PAY NOW' and resultentry='pending'  and  consultationdate between '$fromdate' and '$todate'  and locationcode='".$locationcode."' group by patientvisitcode order by consultationdate ";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
 ...
 list($year, $month, $day) = explode("-", $patientdob);
    ...
    $day_diff   = date("d") - $day;
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><?php  if($year_diff>0){echo $year_diff." year";} else {if($month_diff>0){echo $month_diff." month";} else{echo $day_diff." days";}}?></td>
              ...
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="ipradiologyentry.php?patientcode=<?php echo $res1patientcode; ?>&&visitcode=<?php echo $res1visitcode; ?>"><strong>Process</strong></a></div></td>
              </tr>
			<?php
			}    
			?>
			...
			$query2 = "select * from ipconsultation_radiology where patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and prepstatus='completed' and imgaquistatus='completed' and billtype='PAY LATER' and resultentry='pending' and  consultationdate between '$fromdate' and '$todate'  and locationcode='".$locationcode."' group by patientvisitcode order by consultationdate ";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
    ...
    $day_diff   = date("d") - $day;
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><?php echo $res2account; ?></td>
			   ...
			   <td class="bodytext31" valign="center"  align="left"><?php echo $res1112department; ?></td>
              <td class="bodytext31" valign="center" align="left">
			    <div align="left"><a href="ipradiologyentry.php?patientcode=<?php echo $res2patientcode; ?>&&visitcode=<?php echo $res2visitcode; ?>"><strong>Process</strong></a></div></td>
              </tr>
			<?php
			}    

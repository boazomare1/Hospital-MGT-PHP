...

{
 ...
 $query="insert into amendment_details (patientcode,visitcode,patientname,refno,itemcode,itemname,rate,qty,amount,amenddate,amendtime,amendfrom,amendby,ipaddress) values ('$patientcode','$visitcode','$patientname','$refno','$medicinecode','$medicinename','$rate','$serviceqty','$amount','$date','$time','services','$username','$ipaddress')";
		  ...
		  <?php if($num17lab > 0) {?>
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
				...
				<input type="checkbox" name="lablatertonow[<?php echo $sno; ?>]" id="lablatertonow<?php echo $sno; ?>"  onClick="approvalfunction2(this.id,<?php echo $pharmitemrate; ?>),selectcash('lab','<?php echo $sno; ?>')" <?php if($approvalstatus=='1'){ echo "disabled=disabled";}if($approvalstatus=='2'){ echo "checked=checked disabled=disabled";}?>>
					  	...
					  	<td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3" colspan="8">
			       			<table border="0" width="1050">
			       				<tr>
			       					...
			       					<td align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">Total Amount</span><input type="text" id="total1" readonly size="7" value="<?php echo number_format($totalamount,2); $totalamount=0;?>"></td>
			       				</tr>
			       			</table>
		       			</td>
          ...
          <tbody id="foo">
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
				...
				<input type="checkbox" name="radlatertonow[<?php echo $sno; ?>]" id="radlatertonow<?php echo $sno; ?>" onClick="approvalfunction2(this.id,<?php echo $pharmitemrate; ?>),selectcash('rad','<?php echo $sno; ?>')" <?php if($approvalstatus=='1'){ echo "disabled=disabled";}if($approvalstatus=='2'){ echo "checked=checked disabled=disabled";}?>>
				   ...
				   <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
		       			<table border="0" width="1050">
		       				<tr>
		       					...
		       					<td align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">Total Amount</span><input type="text" id="total2" readonly size="7" value="<?php echo number_format($totalamount,2); $totalamount=0;?>"></td>
		       				</tr>
		       			</table>
		       		</td>
				   </tr>
	  ...
	  ?>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$query17 = "select * from consultation_services where patientvisitcode='$visitcode' and patientcode='$patientcode'  and process='pending' and wellnessitem <> '1' and ((paymentstatus = 'pending' and approvalstatus <> '1') OR (approvalstatus <> '2'))";
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
				...
				<input type="checkbox" name="serlatertonow[<?php echo $sno; ?>]" id="serlatertonow<?php echo $sno; ?>"  onClick="approvalfunction2(this.id,<?php echo $amount11; ?>),selectcash('ser','<?php echo $sno; ?>')" <?php if($approvalstatus=='1'){ echo "disabled=disabled";}if($approvalstatus=='2'){ echo "checked=checked disabled=disabled";}?>>
			...
			<?php } ?> 
			 ...
			 <!-- <?php
			  ...
			  $query17 = "select * from consultation_services where patientvisitcode='$visitcode' and patientcode='$patientcode' and paymentstatus='pending' and wellnessitem <> '1' and process='pending' and approvalstatus='2'";
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
			    ...
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate1; ?></div></td>
				 ...
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><!--<a onClick="return deletevalid()" href="opamend.php?delete=<?php echo $deprefanum; ?>&&patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&remove=depreferal">Delete</a>--></div></td>

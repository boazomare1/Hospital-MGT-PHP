...
$qryreset = "update healthcarepackagelinking set recordstatus = 'deleted' where servicecode = '$servicescode'";
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		$qryservice = "select * from master_services where itemcode = '$servicecode' and status <> 'deleted' and wellnesspkg = '1'";
		$execservice = mysqli_query($GLOBALS["___mysqli_ston"], $qryservice);
		$resservice = mysqli_fetch_array($execservice);
		$servicename = $resservice['itemname'];
		?>
		
              <form name="cbform1" method="post" action="edithealthcarelinking.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		   <tr>
            ...
            <tr>
              <td colspan="8" class="bodytext3"><strong> Service </strong>
                <input name="services" type="text" id="services" size="69" readonly value="<?= $servicename?>">
			    <input type="hidden" name="servicescode" id="servicescode" value="<?= $servicecode?>">
...
<!--Service-->   <tr id="pressid3">
				   ...
				   <table id="presid3" width="500" border="0" cellspacing="1" cellpadding="1">
					 ...
					 <?php
					 $i=1;
					 $qrylab = "select * from healthcarepackagelinking where servicecode = '$servicecode' and department = 4 and recordstatus <> 'deleted'";
					...
					<!-- </td>
					 ...
					 <input id="sername<?=$i?>" name="sername<?=$i?>" type="text" align="left" value="<?=$itemname?>" size="25" readonly="" style="background-color: rgb(255, 255, 255); border: 0px solid rgb(0, 30, 106); text-align: left;">
					 </td>
					 <td id="serrate<?=$i?>" align="left" style="background-color: rgb(255, 255, 255); border: 0px solid rgb(0, 30, 106);">
					 <input id="serrate<?=$i?>" name="serrate<?=$i?>" type="text" size="16" readonly="" value="<?=$itemrate?>" style="background-color: rgb(255, 255, 255); border: 0px solid rgb(0, 30, 106); text-align: right;">
					 </td>
					 <td id="btndeleteser<?=$i?>" align="right" style="background-color: rgb(255, 255, 255); border: 0px solid rgb(0, 30, 106);">
					 <input id="btndeleteser<?=$i?>" name="btndeleteser<?=$i?>" onclick = "return btnDeleteClick14('<?=$i?>');" type="button" value="Del" style="border: 1px solid rgb(0, 30, 106);"></td></tr>
					 <?php
					 $i++;
					 }
					 ?>

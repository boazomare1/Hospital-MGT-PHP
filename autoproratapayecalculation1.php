...
while ($res31 = mysqli_fetch_array($exec31))
{
	...
	{
		$componentamount = $res31['prorataamount'];
		//$componentamount = '0.00';
	}
...
while ($res67 = mysqli_fetch_array($exec67))
{
	...
	if($res67monthly == 'Yes')
	{
		...
		$exec68 = mysqli_query($GLOBALS["___mysqli_ston"], $query68) or die ("Error in Query68".mysqli_error($GLOBALS["___mysqli_ston"]));
		$res68 = mysqli_fetch_array($exec68);
		$rows68 = mysqli_num_rows($exec68);
	...
	{
		$componentamount1 = $res67['prorataamount'];
		//$componentamount = '0.00';
	}
	//echo '<br>'.$componentamount;	
...
while ($res39 = mysqli_fetch_array($exec39))
{
	...
	$res39componentamount = $res39['prorataamount'];
...
while ($res66 = mysqli_fetch_array($exec66))
{
	...
	{
		$deductionamount = $res66['prorataamount'];
		//$componentamount = '0.00';
	}
...
if($res74componentanum == '')
{
	...
	if($res88excludenhif == 'Yes')
	{
		...
		$exec75 = mysqli_query($GLOBALS["___mysqli_ston"], $query75) or die ("Error in Query75".mysqli_error($GLOBALS["___mysqli_ston"]));
	}
	else
	{
		$query75 = "insert into nhif_monthwise(componentanum, componentname, employeecode, employeename, assignmonth, componentamount, ipaddress, username, updatedatetime)

...
/*
	...
	*/
	...
	var text113= document.createElement ('input');

	text113.id = "dosemeasure"+i+"";

	text113.name = "dosemeasure"+i+"";
	...
	text113.value = vardosemeasure;

	text113.readOnly = "readonly";

	text113.style.backgroundColor = "#FFFFFF";

	text113.style.border = "0px solid #001E6A";

	text113.style.textAlign = "left";

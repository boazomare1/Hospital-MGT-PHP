...
if ($frm1submit1 == 'frm1submit1')
{
	...
	foreach($_POST['services'] as $key => $value)
		...
		{
		$servicesquery1=mysqli_query($GLOBALS["___mysqli_ston"], "insert into consultation_services(consultationid,patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,billtype,accountname,consultationdate,paymentstatus,refno,process,locationcode)values('$consultationid','$patientcode','$patientname','$visitcode','$servicescode','$servicesname','$servicesrate','$patientpaymentmode','$accountname','$consultationdate','$status','$serrefnonumber','$process','$locationcode')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
mysqli_query($GLOBALS["___mysqli_ston"], "delete from consultation_services where auto_number='$servicename' and patientvisitcode='$visit'");
}
...
<form name="form1" id="frmsales" method="post" action="amendservice.php" onSubmit="return validcheck()">
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$query17 = "select * from consultation_services where patientvisitcode='$visitcode' and patientcode='$patientcode' and paymentstatus='$status' and process='$process'";
			...
			?>
			 ...
			 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $paharmitemname; ?></div></td>
			    <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $pharmitemrate; ?></div></td>
				 <td class="bodytext31" valign="center"  align="left"><div align="center"><a onClick="return deletevalid()" href="amendservice.php?delete=<?php echo $seranum; ?>&&patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>">Delete</a></div></td>

...
<body>
<?php $querynw1 = "select * from ipconsultation_lab where labsamplecoll='completed' and resultentry='pending' and labrefund <> 'refund' and patientcode <> 'walkin' group by docnumber order by consultationdate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query1 = "select * from ipconsultation_lab where labsamplecoll='completed' and resultentry='pending' and labrefund <> 'refund' and patientcode <> 'walkin' group by docnumber order by consultationdate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//

...
//
				...
				{  
					...
					*/
					$j = 0;
					$crresult = array();
					$querycr1 = "SELECT SUM(`transactionamount`) as paylatercredit FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `docno` LIKE 'AR-%' AND `transactionstatus` = 'onaccount' AND `transactionmodule` = 'PAYMENT'";

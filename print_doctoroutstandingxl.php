...
header('Content-Disposition: attachment;filename="DoctorOutstanding.xls"');
...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
			...
			<td width="10%" align="left" valign="center"  
              ...
              <td width="10%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Credit</strong></div></td>
...
/* 				$query81 = "select patientvisitcode,billnumber,referalrate from billing_paynowreferal  where referalname='$searchsuppliername' and  billdate < '$ADate1'";
		  ...
		  ?>
			...
			// sum(amount) as transactionamount, billtype, locationcode, 0 as transactionamount1, billingaccountcode as doccoa, '' as visittype from adhoc_creditnote where billingaccountcode = '$searchsuppliercode' and consultationdate between '$ADate1' and '$ADate2'  group by visitcode

			// UNION ALL SELECT '' AS doctorname,patientname,patientcode,patientvisitcode as visitcode, accountname,docno as billnumber, consultationdate as recorddate, 0 as original_amt,amount,
			// sum(amount) as transactionamount, billtype, locationcode, 0 as transactionamount1, billingaccountcode as doccoa, '' as visittype from adhoc_debitnote where billingaccountcode = '$searchsuppliercode' and consultationdate between '$ADate1' and '$ADate2'  group by visitcode
           ...
           <td class="bodytext31" valign="center"  align="right" 
			...
			<tr>
               ...
               <td class="bodytext31" valign="center"  align="right" 
                ...
                ><?php echo number_format(($totalamount30+$totalamount30_n),2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right" 

                ><?php echo number_format(($totalamount60+$totalamount60_n),2,'.',','); ?></td>

              <td class="bodytext31" valign="center"  align="right" 

                ><?php echo number_format(($totalamount90+$totalamount90_n),2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right" 

                ><?php echo number_format(($totalamount120+$totalamount120_n),2,'.',','); ?></td>

				<td class="bodytext31" valign="center"  align="right" 

                ><?php echo number_format(($totalamount180+$totalamount180_n),2,'.',','); ?></td>

            <td class="bodytext31" valign="center"  align="right" 

                ><?php echo number_format(($totalamountgreater+$totalamountgreater_n),2,'.',','); ?></td>

             	 <td class="bodytext31" valign="center"  align="right" 

                ><?php echo number_format(($totalat+$grandtotal_n),2,'.',','); ?></td>

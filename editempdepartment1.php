...
if ($frmflag1 == 'frmflag1')
{
	...
	$query34 = "update master_payrolldepartment set department = '$department', unit = '$unit',recorddate = '$updatedatetime', 
...
if($st == 'edit' && $anum != '')
{
$query1 = "select * from master_payrolldepartment where auto_number = '$anum'";
$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
$res1 = mysqli_fetch_array($exec1);
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="editempdepartment1.php" onSubmit="return addward1process1()">

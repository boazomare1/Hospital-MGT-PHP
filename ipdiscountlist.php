...
<head>
    ...
    <title>IP Discount List - MedStar</title>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <link rel="stylesheet" href="css/ipdiscountlist-modern.css?v=<?php echo time(); ?>">
...
<body onLoad="return funcOnLoadBodyFunctionCall()">
        ...
        <aside id="leftSidebar" class="left-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="ipdiscountlist.php" class="nav-link active">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h2><i class="fas fa-percentage"></i> IP Discount List</h2>
                    <p>Manage Inpatient Discounts and Billing</p>
                </div>
            ...
            <div class="search-form-container">
                <form name="cbform1" method="post" action="ipdiscountlist.php" class="search-form">
                    <div class="form-row">
                                ...
                                if($searchpatient != '') { 
                                        ...
                                        if($paymentstatus == '') {
                                            if($creditapprovalstatus == '') {
                                                ...
                                                <tr <?php echo $colorcode; ?>>
                                                    ...
                                                    <td>
                                                        <select name="invoice" id="invoice" onChange="window.open(this.options[this.selectedIndex].value,'_blank')" class="action-select">
                                                            <option value="">Select Action</option>
                                                            <option value="ipdiscount.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&menuid=<?php echo $menu_id; ?>">Apply Discount</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <?php
                                    ...
                                    while($res34 = mysqli_fetch_array($exec34)) {
                                        ...
                                        <tr <?php echo $colorcode; ?>>
                                            ...
                                            <td><span class="status-badge status-<?php echo strtolower($status); ?>"><?php echo $status; ?></span></td>
                                            <td>
                                                <select name="invoice" id="invoice" onChange="if (this.value) window.open(this.value, '_blank')" class="action-select">
                                                    <option value="">Select Action</option>
                                                    <option value="ipdiscount.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&menuid=<?php echo $menu_id; ?>">Apply Discount</option>
                                                </select>
                                            </td>
    ...
    <script src="js/ipdiscountlist-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

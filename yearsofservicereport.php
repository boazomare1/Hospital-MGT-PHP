...
<?php
function calculate_age($dol,$doj)
{
 ...
 if($dol=="0000-00-00")
 {
  return "0 Days";
    ...
    $today =($dol);
    $diff = $dol->diff(new DateTime($doj));
...
<body>
<table width="119%" align="left" border="0" cellspacing="0" cellpadding="2">
  <tr>
  ...
  <tr>
   <td width="1%" align="left" valign="top">&nbsp;</td>
    <td  valign="top">
	<form name="form1" id="form1" method="post" action="yearsofservicereport.php">
	...
	<tbody>
	<tr bgcolor="#999999">
	<td colspan="30" align="left" class="bodytext3"><strong>Search  Employees Years of Service Report</strong></td>
	</tr>
<tr>
	...
	if ($frmflag1 == 'frmflag1')
{
	...
	<td width="104" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Payroll No</strong></td>
	<td width="194" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>EMPLOYEE NAME</strong></td>
	
	<td width="136" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Department</strong></td>
	
		<td width="136" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Designation</strong></td>
	<td width="136" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Age</strong></td>

	<td width="113" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Date of Hire</strong></td>
	<td width="120" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Date of Termination</strong></td>
	
	<td width="96" align="left" bgcolor="#ecf0f5" class="bodytext3"><strong>Year of Service</strong></td>
...
$dol='';
	...
	?>
		...
		<tr>
				...
				<a target="_blank" href="print_yearsofservicereport.php?searchemployee=<?=$searchemployee;?>&&searchjob=<?= $searchjob;?>&&department=<?= $department;?>&&employeetype=<?= $employeetype;?>&&frmflag1=<?= $frmflag1;?>"> <img src="images/excel-xls-icon.png" width="30" height="30"></a>
				</td>
				</tr>

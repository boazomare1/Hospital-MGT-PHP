...
{  
	...
	if($id != '')
	{
		...
		UNION ALL SELECT SUM(`openbalanceamount`) as stockpurchase FROM `openingbalanceaccount` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'";
		...
		UNION ALL SELECT SUM(`openbalanceamount`) as stockreturn FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and payablestatus ='1'";

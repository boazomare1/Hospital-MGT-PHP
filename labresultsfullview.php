...
function loadprintpagepdf1(patientcodes,visitcodes,date1,date2,docno,itemcode)
{
	...
	window.open("print_master.php?patientcode="+varpatientcodes+"&&visitcode="+varvisitcodes+'&&docnumber='+docno+'&&fromdate='+vardate1+'&&todate='+vardate2+'&&itemcode='+itemcode1,"Window");
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
    	 ...
    	 $query1 = "select * from resultentry_lab where patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and patientcode <> 'walkin' and recorddate between '$fromdate' and '$todate' and docnumber like '%$docnum%' and  resultstatus='completed' group by docnumber,itemcode order by auto_number desc";
		$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num1=mysqli_num_rows($exec1);
		if($num1>0)
		{
			?>
            <tr><td colspan="9" class="bodytext31" bgcolor="#ecf0f5"><strong>OP</strong></td></tr>
		<?php
	  ...
	  $query11="select * from resultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and recorddate between '$fromdate' and '$todate' and  resultstatus='completed' and publishstatus = 'completed' group by itemcode ";
		...
		if($res23num !=0)
          ...
          <tr <?php echo $colorcode; ?>>
		   ...
		   <?php
		$query21 = "select * from consultation_lab where patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and patientcode like '%walkin%' and patientvisitcode like '%walkinvis%' and resultentry='completed' and docnumber like '%$docnum%' and consultationdate between '$fromdate' and '$todate'  group by billnumber,labitemcode order by auto_number desc ";
		$exec21 = mysqli_query($GLOBALS["___mysqli_ston"], $query21) or die ("Error in Query21".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num21=mysqli_num_rows($exec21);
		if($numn21>0)
		{?>
        <tr><td colspan="9" class="bodytext31" bgcolor="#ecf0f5"><strong>External</strong></td></tr>
        <?php
		...
		$query39="select * from resultentry_lab where patientcode like 'walkin' and patientvisitcode like 'walkinvis' and docnumber='$res121resultdoc' and resultstatus='completed' and recorddate between '$fromdate' and '$todate' and itemcode='$res21labitemcode' group by itemcode order by auto_number desc ";
...
if($num39 !=0)
		   ...
		   ?>
		    ...
		    <?php
		$query22 = "select * from ipresultentry_lab where patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and patientvisitcode like '%$searchvisitcode%' and recorddate between '$fromdate' and '$todate' and docnumber like '%$docnum%' group by docnumber,itemcode order by auto_number desc ";
		$exec22 = mysqli_query($GLOBALS["___mysqli_ston"], $query22) or die ("Error in Query22".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num22=mysqli_num_rows($exec22);
		if($num22>0)
		{?>
        
		<tr><td colspan="9" class="bodytext31" bgcolor="#ecf0f5"><strong>IP</strong></td></tr>
        <?php
		...
		$num45=mysqli_num_rows($exec45);
           ...
           <tr <?php echo $colorcode; ?>>
              <td height="45"  align="left" valign="center" class="bodytext31"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="center"><a target="_blank" href="print_master.php?patientcode=<?php echo $res22patientcode; ?>&&visitcode=<?php  echo $res22patientvisitcodee; ?>&&docnumber=<?php echo $res22docnumber; ?>&&fromdate=<?php echo $fromdate; ?>&&todate=<?php echo $todate; ?>&&docnumber=<?= $res22docnumber?>&&itemcode=<?= $res22itemcode ?>"><strong>Print</strong></a></td>

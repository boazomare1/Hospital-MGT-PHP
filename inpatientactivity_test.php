...
?>
		...
		echo $query50 = "select * from master_bed where ward='$wardnum' and locationcode='$location'";
	    ...
	    echo $query59 = "select * from ip_bedallocation where ward='$wardnum' and bed='$bedanum' and locationcode='$location' and patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and recordstatus NOT IN ('discharged','transfered') order by auto_number desc limit 0, 1";
		...
		$subtypename = $res493['subtype'];
		   ...
		   $bedname = $res51['bed'];
			...
			echo $query7811 = "select * from master_ward where auto_number='$ward' and recordstatus='' and locationcode='$location' ";
			...
			if($num69 > 0)
		{
		   ...
		   echo $query82 = "select * from master_ipvisitentry where patientcode='$patientcode'  and locationcode='$location' and visitcode='$visitcode' and discharge not in ('discharged','completed')";
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="left">
			    ...
			    <div align="center"><?php echo $bedname; ?></div></td>
				  <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $subtypename; ?></div></td>
				<td class="bodytext31" valign="center"  align="left">

...
<page pagegroup="new" backtop="12mm" backbottom="14mm" backleft="2mm" backright="3mm" >
...
<td width="169" align="left"  valign="center" class="bodytext31">&nbsp;</td>
		   ...
		   $thresholdvalue = $threshold/100;
			   ...
			   $discount_bed = 0;
				...
				//////////////////////// BED CHARGES /////////////
				if($totalbedallocationamount!=0){
					?>
			  

				<tr>
				<td width="169" align="left"  valign="center" class="bodytext31">&nbsp;</td>
				<td class="bodytext31"  valign="center"  align="left"><strong>Bed And Nursing Charges:</strong></td>
				<td class="bodytext31" valign="center"  align="right"><?php echo number_format($totalbedallocationamount,2,'.',','); ?></td>
				</tr>	
			<?php }else{ ?>
				<tr>
				<td width="169" align="left"  valign="center" class="bodytext31">&nbsp;</td>
				<td class="bodytext31"  valign="center"  align="left"><strong>Bed And Nursing Charges:</strong></td>
				<td class="bodytext31" valign="center"  align="right"><?php echo number_format($totalbedtransferamount,2,'.',','); ?></td>
				</tr>	
...

						{
						  ...
						  ?>
									...
									<td class="bodytext31" valign="center"  align="left"><div align="left"><?php //echo $sno = $sno + 1; ?></div></td>
										...
										<td class="bodytext31" valign="center"  align="left"><div align="left" width="250"><?php echo $charge1; ?>(<?php echo $bedname; ?>)ass</div></td>
...
//      $html2pdf->setModeDebug();
        ...
        $html2pdf->Output('Creditapproval.pdf');

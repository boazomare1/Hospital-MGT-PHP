...
<body>
	...
	<table width="800" border="0" cellspacing="0" cellpadding="2" style="border-top:solid 1px #000000;border-bottom:solid 1px #000000;">
		<tbody>
		<tr>
			<td width="60" align="left" valign="middle" nowrap="nowrap" class="bodytext27">
				<strong>Patient</strong>
				<input name="billnumberprefix" id="billnumberprefix" value="<?php echo $billnumberprefix; ?>" type="hidden" style="border: 1px solid #001E6A"  size="5" /> 
				<input type="hidden" name="patientcode" value="<?php echo $patientcode; ?>">
			</td>
			<td width="220" align="left" valign="middle" nowrap="nowrap" class="bodytext27">
				<?php echo $Patientname; ?>&nbsp; <?php if($patientcode !='') { echo '('.$patientcode.')' ; } ?>
			...
			<td width="150" align="left" valign="middle" nowrap="nowrap" class="bodytext27"><?php echo date('Y-M-d g:i:A',strtotime($samplecollectedon)); ?></td>
		</tr>
			
		<tr>
			<td width="60" align="left" valign="middle" nowrap="nowrap" class="bodytext27"><strong>Patient Code</strong></td>
			<td width="220" align="left" valign="middle" nowrap="nowrap" class="bodytext27"><?php echo $patientcode; ?>
			...
			<td width="60" align="left" valign="middle" nowrap="nowrap" class="bodytext27"><strong>Account </strong></td>
			<td width="100" align="left" valign="middle" nowrap="nowrap" class="bodytext27"><?php if($accountname != ''){ echo $accountname; }else{ echo 'SELF'; } ?></td>
		</tr>
		
		<tr>
			<td colspan="4" align="left" valign="middle" nowrap="nowrap" class="bodytext27"> &nbsp; </td>
		</tr>
		
		<tr>
			<td colspan="4" align="center" valign="middle" style="font-size:16px; text-decoration:underline;"><strong>Radiology Report</strong> </td>
		</tr>
		<tr>
		...
		?>
		<tr>
			<td width="540" align="left" valign="middle" class="bodytext31"><strong>	<?php echo trim($labname1); ?></strong><br>
				<?php echo trim($templatedata); ?></td>
		</tr>
		...
		?>
		<tr>
			<td width="540" align="left" valign="middle" class="bodytext31"><strong> Addendum: </strong> <br />	 <?php echo $addendum; ?></td>
		</tr>
		<?php
		}
		?>
...
//      $html2pdf->setModeDebug();
        ...
        $html2pdf->Output('RadiologyResultsFull.pdf');
    }

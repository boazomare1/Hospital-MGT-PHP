...
<table width="1900" border="0" cellspacing="0" cellpadding="2">
    ...
    <td width="99%" valign="top">
      ...
      <tr>
        <td>
          ...
          <tbody>
            <td colspan="12" bgcolor="#ecf0f5" class="bodytext3"><strong>OP Revenue Credit &nbsp; From &nbsp;<?php echo $transactiondatefrom; ?> To <?php echo $transactiondateto; ?></strong></td>
			...
			$query1 = "select patientcode,patientname,fxamount,billdate,locationname,visitcode,doctorname,consultation_percentage,sharingamount,billno as billnumber from billing_paylaterconsultation where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL' and visitcode in (select visitcode from master_visitentry where department like '$department')

				UNION ALL

				select patientcode,patientname,consultation as fxamount,billdate,locationname,patientvisitcode as visitcode,doctorname,consultation_percentage,sharingamount,billnumber as billnumber from billing_consultation where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')
				order by billdate";
			...
			$query1 = "select patientcode,patientname,fxamount,billdate,locationname,patientvisitcode,billnumber from billing_paylaterpharmacy where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')

				UNION ALL

				select patientcode,patientname,fxamount,billdate,locationname,patientvisitcode,billnumber from billing_paynowpharmacy where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and accountname != 'CASH - HOSPITAL' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			$query1 = "select patientcode,patientname,fxamount,billdate,locationname,patientvisitcode,billnumber from billing_paylaterlab where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and  accountname != 'CASH - HOSPITAL' AND patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
 ...
 <td class="bodytext31" valign="center"    colspan="3" align="left"><div class="bodytext31"></div></td>
			...
			$query1 = "select patientcode,patientname,referalrate,billdate,locationname,patientvisitcode,billnumber from billing_paylaterreferal where  locationcode='$locationcode' and  billdate between '$transactiondatefrom' and '$transactiondateto' and patientvisitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			$query1 = "select patientcode,patientname,amount,recorddate,locationname,visitcode,docno from billing_opambulancepaylater where  locationcode='$locationcode' and  recorddate between '$transactiondatefrom' and '$transactiondateto' and visitcode in (select visitcode from master_visitentry where department like '$department')";
			...
			$query1 = "select patientcode,patientname,amount,recorddate,locationname,visitcode,docno from billing_homecarepaylater where  locationcode='$locationcode' and  recorddate between '$transactiondatefrom' and '$transactiondateto' and visitcode in (select visitcode from master_visitentry where department like '$department')";

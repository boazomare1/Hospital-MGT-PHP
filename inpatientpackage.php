    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="inpatientpackage.php">
          ...
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Package Inpatient </strong></td>
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="6" bgcolor="#ecf0f5" class="bodytext31"><div align="left"><strong>Package Inpatient </strong><label class="number"></label></div></td>
			 </tr>
            <tr>

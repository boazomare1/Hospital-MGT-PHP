...
function Process23()
{
	if (document.getElementById("visitcode").value == "")
	{
		alert("Please search with Visitcode");
...
function update_values(id,sno)
{
	var avail_limit=$("#avail_limit"+sno).val();
	var visit_limit=$("#visit_limit"+sno).val();
	avail_limit=avail_limit.replace(/,/g,'');
	visit_limit=visit_limit.replace(/,/g,'');
	$.ajax({
		type: "POST",
		url: "ajax_updateopvisitlimit.php",
		datatype: "json",
		async: false,
		data:{'auto_number' : id,'avail_limit' : avail_limit,'visit_limit' : visit_limit},
		catch : false,
		success:function(data){
		$("#avail_limit"+sno).css('background-color','#00FF00');
		$("#visit_limit"+sno).css('background-color','#00FF00');
		}
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="opvisitupdate.php" onSubmit="return Process23()">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Edit Visit Details </strong></td>
          ...
          <tr>
              ...
              <td  bgcolor="#FFFFFF"><select name="location" id="location" onChange="ajaxlocationfunction(this.value);"  style="border: 1px solid #001E6A;">
                  <?php
            ...
            <tr style="display:none">
              ...
              <td width="82%" colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
                <input name="patient" type="text" id="patient" value="<?php echo $patient; ?>" size="50" autocomplete="off">
              </span></td>
              </tr>
			    <tr style="display:none">
              <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Registration No</td>
              <td width="82%" colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
                <input name="patientcode" type="text" id="patientcode" value="<?php echo $patientcode; ?>" size="50" autocomplete="off">
              </span></td>
              </tr>
			   <tr>
              <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Visitcode</td>
              <td width="82%" colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
                <input name="visitcode" type="text" id="visitcode" value="<?php echo $visitcode; ?>" size="50" autocomplete="off">
              </span></td>
              </tr>
			  <tr style="display:none">
...
if ($cbfrmflag1 == 'cbfrmflag1' || isset($_REQUEST['page']))
{
	...
	$searchvisitcode = trim($_SESSION['servisvisitcode']);
          ...
          <tbody>
           ...
           <tr>
               ...
               <td width="51" align="left" valign="center"  
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Avail Limit</strong></div></td>
                <td width="36" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Visit Limit</strong></div></td>
              ...
              $cno=0;
			  $reslocationanumm= $_REQUEST['location'];
              $query2 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and locationcode like '%$reslocationanumm%'  order by auto_number desc"; //LIMIT $start , $limit";
			  ...
			  $availablelimit = $res2['availablelimit'];
			  ...
			  {
			  //$query891 = "select billno from billing_paynow where visitcode='$res2visitcode' and patientcode = '$res2customercode'";	
			  //$exec891 = mysqli_query($GLOBALS["___mysqli_ston"], $query891) or die ("Error in Query891".mysqli_error($GLOBALS["___mysqli_ston"]));
			  //$row8910 = mysqli_num_rows($exec891);
			  $row8910=0;
				 ...
				 ?>
                    ...
                    <td class="bodytext31" valign="center"  align="left"><?php echo $res2nationalidnumber; ?></td>
					 <td class="bodytext31" valign="center"  align="left"><?php echo $user; ?></td>
                       ...
                       <td  align="left" valign="center" class="bodytext31"><input style="text-align:right" type="text" id="avail_limit<?php echo $cno;?>" name="avail_limit<?php echo $cno;?>" value="<?php echo number_format($availablelimit,2,'.',',');?>" size="12"/></td>
                     <td class="bodytext31" valign="center"  align="left"><input style="text-align:right" type="text" id="visit_limit<?php echo $cno;?>" name="visit_limit<?php echo $cno;?>" value="<?php echo number_format($visitlimit,2,'.',',');?>" size="8" align="right"/></td>
                <td class="bodytext31" valign="center"  align="left"><input type="button" id="update_it" name="update_it" value="Update" onClick="update_values('<?php echo $res2customeranum;?>','<?php echo $cno;?>')"/></td>
                  </tr>
			  <?php
			  }
			  }

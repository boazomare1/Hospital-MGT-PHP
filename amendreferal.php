...
$visit = $_REQUEST['visitcode'];
 ...
 $data=mysqli_query($GLOBALS["___mysqli_ston"], "select auto_number,patientcode,patientvisitcode,patientname,refno,referalcode,referalname,referalrate from consultation_referal where referalname='$referalname'");
...
mysqli_query($GLOBALS["___mysqli_ston"], "delete from consultation_referal where referalname='$referalname' and patientvisitcode='$visit'");
}
...
-->
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
	   <td width="9%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Add Referal</strong></td>

...
global $a_json;
	$query2 = "select * from master_accountname where recordstatus <> 'deleted' and id <> '' and accountssub='9' and accountname like '%$term%'order by auto_number desc limit 0, 10";

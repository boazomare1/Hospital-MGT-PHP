...
text-align:right;
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#FFFFFF" class="bodytext31"><strong>Discount Details</strong></td>
        ...
        <?php
		 ...
		 // $query9 = "SELECT * FROM ip_discount WHERE patientvisitcode IN (SELECT `visitcode` FROM `billing_ip` where billdate BETWEEN '$ADate1' and '$ADate2')";
...
?>		
         ...
         <tr>
              ...
              <td colspan="4"  class="bodytext31" valign="center"  align="right" 
                ...
                bgcolor="#FFFFFF"><strong>Total Discount Amount</strong></td>

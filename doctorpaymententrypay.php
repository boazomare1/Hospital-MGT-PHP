...
if($username_auto_number!=""){
	...
	$billnumbercode.="-".$username_auto_number;
			...
			$query1 = "select * from master_tax where status <> 'deleted' and auto_number='$taxanum' order by taxname";
...

			{
				...
				{	$querychk1 = "select visitcode from master_transactiondoctor where visitcode = '$visitcode' and transactionamount = '$adjamount' and billnumber = '$billnum' and billautonumber = '$billautonumber' and transactiondate = '$transactiondate'";
					...
					transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,docno,doctorcode,username,locationcode,bankname, bankcode) 
					...
					'$transactionmodule','','','','','$searchsuppliername1','','$billnumbercode','$searchsuppliercode1','$username','$locationcode','$bankname','$bankcode')";
...

					{
...

						{
...

							{
								...
								transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,docno,doctorcode,billautonumber,username,bankcode,bankname) 
								...
								'$transactionmodule','$name','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$billnumbercode','$doctorcode','$billautonumber','$username','$bankcode','$bankname')";
...

			{
...

				{
					...
					transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,docno,doctorcode,username,bankcode,bankname) 
					...
					'$transactionmodule','','','','','$searchsuppliername1','','$billnumbercode','$searchsuppliercode1','$username','$bankcode','$bankname')";
...

				{
...

					{
...

						{
							...
							$querychk1 = "select visitcode from master_transactiondoctor where visitcode = '$visitcode' and transactionamount = '$adjamount' and billnumber = '$billnum3' and billautonumber = '$billautonumber' and transactiondate = '$transactiondate'";
...

							{
								...
								'$transactionmodule','$name1','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$billnumbercode','$doctorcode','$billautonumber','$username','$bankcode','$bankname')";
...

			{
...

				{
					...
					bankname, chequenumber, chequedate,username,bankcode) 
				...
				{	
...

					{
...

						{
							...
							$querychk1 = "select visitcode from master_transactiondoctor where visitcode = '$visitcode' and transactionamount = '$adjamount' and billnumber = '$billnum1' and billautonumber = '$billautonumber' and transactiondate = '$transactiondate'";
							...
							transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,docno,doctorcode,billautonumber,username,bankcode) 
							...
							'$remarks', '$transactionmodule','$name2','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$billnumbercode','$doctorcode','$billautonumber','$username','$bankcode')";
...

			{
...

				{
					...
					transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,docno,doctorcode,billautonumber,username) 
					...
					'$transactionmodule','','','','','$searchsuppliername1','','$billnumbercode','$searchsuppliercode1','$billautonumber','$username')";
				...
				{	
...

					{
...

						{
							...
							$querychk1 = "select visitcode from master_transactiondoctor where visitcode = '$visitcode' and billnumber = '$billnum2' and billautonumber = '$billautonumber' and transactionamount = '$adjamount' and transactiondate = '$transactiondate'";
...

							{
								...
								transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,doctorcode,billautonumber,username,locationcode) 
								...
								'$transactionmodule','$name3','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$doctorcode','$billautonumber','$username','$locationcode')";
		...
		header("location:doctorpaymententrypay.php?docno=$billnumbercode");
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="doctorpaymententrypay.php">
...

	{
		...
		$suppliername = $_REQUEST['cbsuppliername'];
		 ...
		 ?>
				...
				<form name="form1" id="form1" method="post" action="doctorpaymententrypay.php?cbfrmflag1=<?php echo $cbfrmflag1; ?>" onSubmit="return paymententry1process1()">

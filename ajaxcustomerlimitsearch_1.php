...
$a_json = array();
$a_json_row = array();
$query1 = "select * from master_customer where (customercode LIKE '%$customer%' OR customerfullname LIKE '%$customer%') and status <> 'Deleted' and membertype = '1' and billtype = 'PAY LATER' order by auto_number limit 20";
...
while ($res1 = mysqli_fetch_array($exec1))
{
	...
	$query12 = "select planname from master_planname where auto_number = '$res1planname'";

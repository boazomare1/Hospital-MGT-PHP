...

{
	...
	var url="automedicinecodesearch_medicineitempck.php?RandomKey="+Math.random()+"&&medicinesearch="+medicinesearch+"&&accountname="+accountname+"&&subtypeano="+subtypeano+"&&store="+store;

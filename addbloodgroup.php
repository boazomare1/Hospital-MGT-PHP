...
if ($frmflag1 == 'frmflag1') {
    ...
    if ($length <= 100) {
        ...
        if ($res2 == 0) {
            ...
            $errmsg = "Success. New blood group added.";
            $bgcolorcode = 'success';
        } else {
            $errmsg = "Failed. Blood group already exists.";
            $bgcolorcode = 'failed';
        }
    } else {
...
if ($st == 'del') {
    ...
    header("Location: addbloodgroup.php?msg=deleted");
    exit;
}
...
if ($st == 'activate') {
    ...
    $exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
    header("Location: addbloodgroup.php?msg=activated");
    exit;
}
...
if ($svccount == 'firstentry') {
    $errmsg = "Please add blood group to proceed for billing.";
    $bgcolorcode = 'failed';
}
...
if (isset($_GET['msg'])) {
    if ($_GET['msg'] == 'deleted') {
        $errmsg = "Blood group deleted successfully.";
        $bgcolorcode = 'success';
    } elseif ($_GET['msg'] == 'activated') {
        $errmsg = "Blood group activated successfully.";
        $bgcolorcode = 'success';
    }
}
?>
...
<head>
    ...
    <title>Blood Group Master - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/addbloodgroup-modern.css?v=<?php echo time(); ?>">
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    ...
                    <p>Manage blood groups for patient records and medical procedures.</p>
                </div>
            ...
            <div class="add-form-section">
                <div class="add-form-header">
                    ...
                    <h3 class="add-form-title">Add New Blood Group</h3>
                </div>
                
                <form id="bloodGroupForm" name="form1" method="post" action="addbloodgroup.php" class="add-form">
                    <div class="form-group">
                        <label for="bloodgroup" class="form-label">Blood Group Name</label>
                        <input type="text" name="bloodgroup" id="bloodgroup" class="form-input" 
                               placeholder="Enter blood group (e.g., A+, B-, O+, AB+)" maxlength="100">
                    </div>
            ...
            <div class="data-table-section">
                <div class="data-table-header">
                    ...
                    <h3 class="data-table-title">Existing Blood Groups</h3>
                </div>
                ...
                <div style="margin-bottom: 1rem;">
                    <div style="display: flex; gap: 1rem; align-items: center;">
                        <input type="text" id="searchInput" class="form-input" 
                               ...
                               oninput="searchBloodGroups(this.value)">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="action-btn delete" 
                                                onclick="confirmDelete('<?php echo htmlspecialchars($bloodgroup); ?>', '<?php echo $auto_number; ?>')"
                                                title="Delete">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                        <a href="editbloodgroup.php?st=edit&anum=<?php echo $auto_number; ?>" 
            ...
            <div class="deleted-items-section">
                <div class="deleted-items-header">
                    ...
                    <h3 class="deleted-items-title">Deleted Blood Groups</h3>
                </div>
                ...
                <table class="data-table">
                    ...
                    <tbody id="deletedBloodGroupTableBody">
                        <?php
                        $query1 = "select * from master_bloodgroup where recordstatus = 'deleted' order by bloodgroup";
                        $exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
                            ...
                            <tr>
                                <td>
                                    <button class="action-btn activate" 
                                            onclick="confirmActivate('<?php echo htmlspecialchars($bloodgroup); ?>', '<?php echo $auto_number; ?>')"
                                            title="Activate">
    ...
    <!-- Modern JavaScript -->
    <script src="js/addbloodgroup-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

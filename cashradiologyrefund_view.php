...
$query24 = "select * from master_employee where username = '$orderedby'";
 ...
 $new_datetime=date('Y-m-d H:i:s');  
  ...
  $query123="update consultation_radiology set clinical_diagnosis='$clinical',prepstatus='$status1', resultentry='$status1',radiologyrefund='$status1',docnumber='$docnumber',urgent='$u1',resulttime='".date('Y-m-d h:i:s')."' , comments='$comments',urgentstatus='0',preparation_datetime='$new_datetime' where patientvisitcode='$visitcode' and radiologyitemcode='$itemcode' and refno='$refno' "; 
...
$new_datetime=date('Y-m-d H:i:s');
   ...
   //echo "update consultation_radiology set resultentry='$status',radiologyrefund='$status1',docnumber='$docnumber',urgent='$u1',resulttime='".date('Y-m-d h:i:s')."' , comments='$comments',urgentstatus='0' where patientvisitcode='$visitcode' and radiologyitemname='$radiologyname' and refno='$refno";
  $query123="update consultation_radiology set clinical_diagnosis='$clinical',prepstatus='$status', radiologyrefund='$status1',docnumber='$docnumber',urgent='$u1',comments='$comments',urgentstatus='0',preparation_datetime='$new_datetime' where patientvisitcode='$visitcode' and radiologyitemcode='$itemcode' and refno='$refno' "; 
...
//exit;
	header("location:cashradiologyrefund.php");
    exit();
}
...
<form name="frmsales" id="frmsales" method="post" action="" onKeyDown="return disableEnterKey(event)" enctype="multipart/form-data" onSubmit="return validcheck()">
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$sno = '';
			$totalamount=0;			
$query61 = "SELECT * from consultation_radiology where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and prepstatus='completed'  and paymentstatus='completed'  and radiologyitemcode='$q_itemcode' and refno='$q_refno' and (billtype='PAY NOW' or (billtype='PAY LATER' ))";

...
<div class="row">
	...
	<div class="col-4">
		<div style="text-align:left;">
			<a href="print_trialincomestatement.php?ADate1=<?php echo $ADate1;?>&&ADate2=<?php echo $ADate2; ?>" id="downloadLink" target="_blank"><img src="images25/excel-xls-icon.png" alt="excel export" width="50px" height="50px"/></a>
		</div>
	</div>
</div>

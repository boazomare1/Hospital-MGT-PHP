...
function ledgervalue($parentid,$ADate1,$ADate2,$tbinclude,$tbclosing)
{
	...
	{
		if($tbinclude == 'tb_accountbank.php' || $tbinclude == 'tb_accountar.php' || $tbinclude == 'tb_accountincomephar.php' || $tbinclude == 'tb_accountincomelab.php' || $tbinclude == 'tb_accountincomerad.php' || $tbinclude == 'tb_accountincomeser.php' || $tbinclude == 'tb_accountincomeother.php')
		{
		include('accounts1/'.$tbinclude);
		return $sumbalance;
		}	
	}
	else

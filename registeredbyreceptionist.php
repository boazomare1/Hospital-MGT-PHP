      ...
      <tr>
	   ...
	   <?php if($cbfrmflag2 == 'cbfrmflag1'){?>
          ...
          <?php
			...
			{	
			//echo 'Received';
			 $query1 = "select username from master_customer where registrationdate between '$ADate1' and '$ADate2' group by username order by username";
          ...
          <tbody>
			...
			<?php
		  		  ...
		  		  $query4 = "select a.customerfullname as customerfullname,a.customercode as customercode,a.username as username,a.registrationdate as registrationdate,b.accountname as accountname from master_customer as a JOIN master_accountname AS b ON (a.accountname = b.auto_number) where a.username like '$cbcustomername' and a.registrationdate between '$ADate1' and '$ADate2'"; 
...
*/			
        ...
        <td>&nbsp;</td>
          ...
          <tbody>
            <tr>
              <td colspan='6' bgcolor="#ecf0f5" class="bodytext31"><?php echo 'Total No of Registered by '.$cbcustomername?>(<?php echo $numcount;?>)</td>
            </tr>
            <tr>
              <td width="3%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><strong>No.</strong></td>

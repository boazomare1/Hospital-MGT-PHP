...
if ($frmflag1 == 'frmflag1')
{
	...
	$query34 = "update master_assetdepartment set department = '$department', unit = '$unit',recorddate = '$updatedatetime', 
	ipaddress = '$ipaddress', locationcode = '$locationcode', locationname = '$locationname'  where auto_number = '$auto_number'";
	$exec34 = mysqli_query($GLOBALS["___mysqli_ston"], $query34) or die ("Error in Query34".mysqli_error($GLOBALS["___mysqli_ston"]));
	
	header('location:addassetdepartmentunit.php?st=success');
}
...
if($st == 'edit' && $anum != '')
{
$query1 = "select * from master_assetdepartment where auto_number = '$anum'";
$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
$res1 = mysqli_fetch_array($exec1);
...
function addward1process1()
{
	...
	{
		alert ("Pleae Enter Department Unit.");
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="editassetdepartmentunit.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="" bgcolor="#ecf0f5" class="bodytext3"><strong>Asset Department Master  </strong></td>
               ...
               <select name="location" id="location"   style="border: 1px solid #001E6A;">
                  <?php
                      ...
                      <tr>
						...
						<input name="department" id="department" value="<?php echo $department; ?>" style="border: 1px solid #001E6A; text-transform:uppercase;" size="40" /></td>
                      </tr>
					  <tbody id="unitadd">
					  </tbody>
					  <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="unit" id="unit" value="<?php echo $unit; ?>" style="border: 1px solid #001E6A; text-transform:uppercase;" size="40" />&nbsp;
						<input type="hidden" name="addunit" id="addunit" value="Add" style="border: 1px solid #001E6A;"></td>
                      </tr>
                      <tr>
						...
						<input type="hidden" name="auto_number" value="<?php echo $anum; ?>" />

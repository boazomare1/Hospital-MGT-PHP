    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Ambulance Details</strong></td>
              <td width="10%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
              </tr>            
        ...
        <?php
		 ...
		 $query7 = "SELECT * FROM ip_ambulance WHERE patientvisitcode IN (SELECT `visitcode` FROM `billing_ip`) AND consultationdate BETWEEN '$ADate1' and '$ADate2' and patientvisitcode in(select visitcode from master_ipvisitentry where accountname ='$acc_id')";
		$exec7 = mysqli_query($GLOBALS["___mysqli_ston"], $query7) or die ("Error in Query7".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num7=mysqli_num_rows($exec7);
		$totalambulance='0.00';
		while($res7 = mysqli_fetch_array($exec7))
		{
		$totalambulanceamount=$res7['amount'];
		
		$transfferdate=$res7['consultationdate'];
		//$dischargeddate=$res13['dischargeddate'];
		$docno=$res7['docno'];
		$visitcode=$res7['patientvisitcode'];
		  // $bedtransferanum = $res13['bed'];
		   
		   $sno=$sno+1;
		   
		   
		   $totalambulance=$totalambulance+$totalambulanceamount;
           ...
           <tr <?php echo $colorcode; ?>>
            ...
            <td align="right" valign="center"  class="bodytext31"><div class="bodytext31"><?php echo number_format($totalambulanceamount,2,'.',','); ?></div></td>
           </tr>
	<?php
		}
?>		
         <tr>
              <td colspan="4"  class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong>Total Ambulance Amount</strong></td>
              <td align="right" valign="center" 
                bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo number_format($totalambulance,2,'.',','); ?></strong></td>
...
<!--<tr>
			...
			<a href="detailsipambulancexl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>
			</tr>-->
          </tbody>
        </table>

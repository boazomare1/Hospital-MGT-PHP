/**
 * MedStar Creditor Analysis Modern JavaScript
...
function toggleChartView() {
    ...
    if (chartSection.style.display === 'none' || !chartSection.style.display) {
        ...
        if (chartToggleBtn) {
            chartToggleBtn.innerHTML = '<i class="fas fa-chart-pie"></i> Chart View';
        }
    }
}
...
function exportToExcel() {
    ...
    // Build export URL
    let exportUrl = 'print_fullcreditoranalysisdetailed.php?';
    ...
    exportUrl += '&searchsuppliername=' + encodeURIComponent(formData.get('searchsuppliername') || '');

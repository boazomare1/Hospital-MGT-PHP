...
$ledgername = $_POST['ledgername'][$key];
...

			{
				...
				manufactureranum, manufacturername,typeofpurchase,suppliername,suppliercode,supplieranum ,ponumber,supplierbillnumber,costprice,locationcode,store,coa,categoryname,fifo_code,totalfxamount,deliverybillno,mrnno,assetledger,assetledgercode,assetledgeranum,job_title) 
				...
				'$manufactureranum', '$manufacturername','Process','$suppliername','$suppliercode','$supplieranum','$ponumber','$supplierbillno','$costprice','$locationcode','$store1','$coa','$categoryname','$fifo_code','$totalfxpuramount','$deliverybillno','$mrnno','$expense','$expensecode','$expenseanum','$job_title')";
		...
		<table width="1000" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3">
            ...
            <tbody>
			  ...
			  <tr>
                ...
                <td width="15%" align="left" valign="middle" class="bodytext3"><?php echo $billnumbercode.'-'.$locationprefix; ?>

...
$exec165=mysqli_query($GLOBALS["___mysqli_ston"], $query165) or die("error in query165".mysqli_error($GLOBALS["___mysqli_ston"]));
$res165=mysqli_fetch_array($exec165);
     ...
     <tr>
	  <td colspan="5" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext365">
				 <strong>LAB RESULTS</strong>
				   ...
				   <tr>
		    <td width="11%" class="bodytext366" valign="center"  align="left" 
			...
			<td width="24%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext366"><div align="center"><strong>Comments</strong></div></td>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            align="left" border="0">
              <tbody>
			   ...
			   <?php 
			   $subTRsno = 0;
			  $query52="select * from master_labreference where itemname='$labname1' and itemcode='$itemcode2' and (gender = '$patientgender' or gender='') and '$patientage' >= agefrom and '$patientage' < ageto and status <> 'deleted'"; 
			  ...
			  $num=mysqli_num_rows($exec52);
			   ...
			   $labname2=$res52['itemname'];
				...
				$labitemanum = $res52['auto_number'];
				 ...
				 if($labreferencename != '')
				 {
				  ...
				  $refcomments = $res87['referencecomments'];
				 $color1 = $res87['color'];
				  }
				  else
				  {
				...
				//echo $labreferencerange1[0];
				 ...
				 $pastresult = $res49['resultvalue'];
                  ...
                  <td width="237" align="center" valign="center" bordercolor="#f3f3f3" class="bodytext311"><div align="center"> 
				  <input type="text" readonly name="result[]" id="result<?php echo $sn; ?>" value="<?php echo $resultvalue;?>" /></div></td>
                  <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" width="98"><div align="left"> <?php if($labreferenceunit == '')
				  {
				  echo $labunit1;
				  }
				  else
			   ...
			   <td width="158" align="center"><textarea rows="3" cols="20" readonly="readonly"><?php echo $refcomments; ?></textarea></td>
              </tr>
			  <?php 
		 }
		 }

	...
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
      ...
      <tbody id="foo">
        ...
        <tr>
          ...
          <td colspan="2" bgcolor="#ecf0f5" class="bodytext31"><strong>Adjustment Report - By Item</strong></td>
      ...
      <tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            // check if ajustadd or adjustminus is 0
            
            if($adjustmentaddquantity == '0' && $adjustmentminusquantity == '0' || $adjustmentaddquantity == '' && $adjustmentminusquantity == ''){
            	$adj_check = 1;
            } else{
            	$adj_check = 0;
            }
            ...
            <tr <?php echo $colorcode; ?> <?php //if($adj_check == 1 ){ echo "style='display:none;'";} ?> >
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ecf0f5"><div align="right"><strong>Total Quantity</strong></div></td>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                <td class="bodytext31" valign="top"   align="left"> 
                 ...
                 <a target="_blank" href="print_reportadjustment.php?transactiondatefrom=<?php echo $transactiondatefrom; ?>&&transactiondateto=<?php echo $transactiondateto; ?>&&locationcode=<?= $locationcodeget; ?>&&itemcode=<?= $searchitemcode;?>&&storecode=<?=$searchstorecode;?>"> <img src="images/pdfdownload.jpg" width="50" height="50"></a> 

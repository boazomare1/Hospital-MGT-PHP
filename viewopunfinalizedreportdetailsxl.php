...
header('Content-Disposition: attachment;filename="opunfinalreport.xls"');
...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query21 = "select * from master_visitentry where billtype='PAY LATER' and overallpayment='' and accountfullname like '%$searchsuppliername%' and consultationdate between '$ADate1' and '$ADate2' AND visitcode NOT IN (SELECT visitcode FROM billing_paylater) group by accountfullname order by accountfullname desc";
            ...
            <td colspan="15"  align="left" valign="center" bgcolor="#fff" class="bodytext31"><strong><?php echo $res22accountname;?></strong></td>
...
$query2 = "select * from master_visitentry where billtype='PAY LATER' and accountname = '$res21accountnameano' and consultationdate between '$ADate1' and '$ADate2' AND visitcode NOT IN (SELECT visitcode FROM billing_paylater)   order by accountfullname desc ";
		  ...
		  $query3 = "select labitemcode from consultation_lab where patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode' ";
		  ...
		  $query4 = "select servicesitemcode,serviceqty,refundquantity from consultation_services where patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode' ";
		  ...
		  $query5 = "select radiologyitemcode from consultation_radiology where patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode'";
		  ...
		  // }
			...
			$query321 = "select sum(totalamount) as totalamount2 from pharmacysalesreturn_details where visitcode='$res2visitcode' ";// and ipdocno = '$refno'";//group by itemcode";
           ...
           <tr>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="right" 
                ...
                bgcolor="#fff"><strong><?php //echo number_format($totalamount2,2,'.',','); ?></strong></td>

				 <td class="bodytext31" valign="center"  align="right" 

                bgcolor="#fff"><strong><?php //echo number_format($totalamount3,2,'.',','); ?></strong></td>

				 <td class="bodytext31" valign="center"  align="right" 

                bgcolor="#fff"><strong><?php //echo number_format($totalamount4,2,'.',','); ?></strong></td>

				 <td class="bodytext31" valign="center"  align="right" 

                bgcolor="#fff"><strong><?php //echo number_format($totalamount5,2,'.',','); ?></strong></td>

              <td class="bodytext31" valign="center"  align="right" 

                bgcolor="#fff"><strong><?php //echo number_format($totalamount6,2,'.',','); ?></strong></td>

				<td class="bodytext31" valign="center"  align="right" 

                bgcolor="#fff"><strong><?php //echo number_format($totalamount7,2,'.',','); ?></strong></td>

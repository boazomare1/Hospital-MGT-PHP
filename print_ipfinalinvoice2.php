...
<td width="169" align="left"  valign="center" class="bodytext31">&nbsp;</td>
			...
			while($res64 = mysqli_fetch_array($exec64))
		   {
			...
			?>
				...
				$totaldeposit =$totaldeposit-$paid_amount;
			?>
			<tr>
<td width="169" align="left"  valign="center" class="bodytext31">&nbsp;</td>
...
<tr><td colspan='2'>&nbsp;</td></tr>
<tr>
			<td colspan='2' class="bodytext31" align="left">I Understand that my Liability to this bill is not waived.</td>
		 </tr>
<tr><td colspan='2'>&nbsp;</td></tr>
<tr>
...
//      $html2pdf->setModeDebug();
        ...
        $html2pdf->Output('print_ip_final2.pdf');
    }

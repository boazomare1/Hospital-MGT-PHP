...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td colspan="10" bgcolor="#0077ff"><?php // include ("includes/alertmessages1.php"); ?></td>
  </tr>
  <tr>
    <td colspan="10" bgcolor="#0077ff"><?php // include ("includes/title1.php"); ?></td>
  </tr>
  <tr>
    <td colspan="10" bgcolor="#0077ff"><?php // include ("includes/menu1.php"); ?></td>
  </tr>
  <tr>
    <td colspan="10">&nbsp;</td>
  </tr>
				...
				<table width="100%" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse;">
				    ...
				    <tr>
					  ...
					  <input type="hidden" name="cbfrmflag1" value="cbfrmflag1">
				          ...
				          <input name="resetbutton" type="reset" id="resetbutton"  style="border: 1px solid #001E6A" value="Reset" class="resetbutton"/></td>
				    </tr>
				  </tbody>
				</table>
			</div>
...
<div id="tblData" class="container-full">
		...
		<div class="col-12">
			<?php
				...
				' cellpadding='1' cellspacing='2'>";
	              ...
	              <td colspan="7" bgcolor="#CCCCCC" class="bodytext3"><strong>&nbsp;</strong></td>
	              </tr>';
				...
				{       
						...
						$section = $res['section'];
							...
							$openingenddate = date('Y-m-d',strtotime('-1 day', strtotime($from_date)));
								...
								echo "<tbody>";
						 		echo "<tr style='background-color: #CBDBFA;' data-node-id='".$sno."'><td></td><td width='17%' align='right'>".showAmount($opening_dr_cr,'1')."</td> <td>".$res['code']."</td> <td>".ucwords(strtolower($res['name']))."</td> <td  align='right'>".showAmount($transaction_dr,'0')."</td>  <td  align='right'>".showAmount($transaction_cr,'0')."</td> <td  align='right'>".showAmount($closing_dr_cr,'1')."</td> </tr> </li>";
					...
					echo "<tr style='font-weight:bold;'> <td colspan='6' align='right'>Total : </td> <td  colspan='2' align='right'>".showAmount($balance_sheet,'1')." </td> </tr>";
	              ...
	              <td colspan="7" bgcolor="#CCCCCC" class="bodytext3"><strong>&nbsp;</strong></td>
					...
					while($res = mysqli_fetch_array($exec))
					{
						...
						/*	else{
							 ...
							 //echo $res['uid'];
							 echo "<tr  style='background-color: #CBDBFA;' data-node-id='".$sno."'> <td></td> <td width='17%' align='right'>".showAmount($opening_dr_cr,'1')."</td> <td>".$res['code']."</td> <td>".ucwords(strtolower($res['name']))."</td> <td  align='right'>".showAmount($transaction_dr,'0')."</td>  <td  align='right'>".showAmount($transaction_cr,'0')."</td> <td  align='right'>".showAmount($closing_dr_cr,'1')."</td> </tr>";
							 //echo $res['uid'];
						echo getSubgroups($res['uid'],$from_date,$to_date,$sno);
						...
						echo "<tr style='font-weight:bold'> <td colspan='6' align='right'>Total </td> <td  colspan='2' align='right'>".showAmount($income_statement ,1)." </td> </tr>";
				echo "</table>";
			?>
		</div>
		<div class="col-12">
  ...
  <?php
	...
	$sql="SELECT doc_number,remarks, ledger_id, transaction_date,transaction_amount FROM `tb` where (ledger_id is null or ledger_id='') and transaction_amount!=0";
    ...
    <?php
	$sql="SELECT doc_number,sum(IF(transaction_type='C',-1*transaction_amount,transaction_amount)) as amount, ledger_id, transaction_date FROM `tb` WHERE transaction_date >= '2021-01-01' group by doc_number HAVING amount!=0 and (amount>1 or amount<-1)";
	$exec_error = mysqli_query($GLOBALS["___mysqli_ston"], $sql) or die ("Error in sql".mysqli_error($GLOBALS["___mysqli_ston"]));

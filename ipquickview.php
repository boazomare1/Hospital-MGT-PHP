	...
	<tr>
      ...
      $query22=mysqli_query($GLOBALS["___mysqli_ston"], "select * from master_iptriage where patientcode='$patientcode' and visitcode='$visitcode' ");
	    ...
	    $ipconsultationdate = $exec22['consultationdate'];
					  ...
					  <tr bgcolor="#CBDBFA"> 
							<td width="20%" align="left" valign="middle"  class="bodytext3"><span class="bodytext32">  Drug Allergy   </span></td>

							<td width="25%"   align="left" valign="middle"  class="bodytext3"><?php echo $drugallergy; ?></td>

							<td width="20%"  colspan="1" align="left" valign="middle"  class="bodytext313">Height</td>

							<td width="25%"   colspan="1" align="left" valign="middle"  class="bodytext3"><?php echo $height; ?></td>
				  ...
				  <?php  //discharge_icd
						...
						<tr bgcolor="#CBDBFA"> 
						 ...
						 <tr bgcolor="#ecf0f5"> 
						  ...
						  <tr bgcolor="#ecf0f5"> 
						 	<td colspan="1" align="left" valign="middle"  class="bodytext313">&nbsp;</td>
							<td align="left" valign="middle"  class="bodytext3"><span class="bodytext32"><b >Post OPD Doctor Notes</b>   </span></td>

							<td  align="left" valign="middle"  class="bodytext3"><b  id="postdocotorbtn" style="color: blue;text-decoration: underline; cursor: pointer;">View</b>  </td>

						 </tr>

						  <tr bgcolor="#ecf0f5"> 
						 	<td colspan="1" align="left" valign="middle"  class="bodytext313">&nbsp;</td>
							<td align="left" valign="middle"  class="bodytext3"><span class="bodytext32"><b >Post OPD Anaesthetisit Notes</b>   </span></td>

							<td  align="left" valign="middle"  class="bodytext3"><b  id="postanaebtn" style="color: blue;text-decoration: underline; cursor: pointer;">View</b>  </td>
...
<table  class="modal-content" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody  >
            ...
            <tr>
              ...
              <td   class="bodytext31" valign="left"  align="left" 
                ...
                bgcolor="#ccccc"><div align="left"><strong>Req Date</strong></div></td>
				...
				<td    align="left" valign="left" bgcolor="#ccccc" class="bodytext31"><div align="left"><strong>View </strong></div></td>
                 <td  width="5%" colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong> &nbsp;</strong></td>
	...
	$status='completed';
			...
			$query17 = "select * from ipconsultation_lab where patientvisitcode='$visitcode' and patientcode='$patientcode' ";
			// and resultentry!='completed'
			$exec17 = mysqli_query($GLOBALS["___mysqli_ston"], $query17) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res17 = mysqli_fetch_array($exec17))
			{
...

			{
				...
				$query33="select * from  ipresultentry_lab where patientvisitcode = '$visitcode' AND sampleid='$sampleid' and itemcode='$pharmitemcode' group by itemname  " ;
				$exec33=mysqli_query($GLOBALS["___mysqli_ston"], $query33);
				$num32=mysqli_num_rows($exec33);
			 ...
			 <td class="bodytext31" valign="left"  align="left"><div align="left"><?php echo $paharmitemname; ?></div></td>
			   ...
			   <!--  <td class="bodytext31" valign="left"  align="left"><div align="left"><?php echo $pharmitemrate; ?></div></td>
				...
				<!-- <td class="bodytext31" valign="left"  align="left"><div align="left"><?php echo strtoupper($username_processed) ; ?></div></td> -->
				 ...
				 <td   class="bodytext3" valign="left"  align="left" >
               <?php   if($num32>0){ 
               	?>
               <a href="iplabresultsview.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $labdocnumber; ?>" target="_blank"><strong>View</strong></a> | <a href="emr_lab_print.php?patientcode=<?=$patientcode;?>&&visitcode=<?=$visitcode;?>&&docnumber=<?=$labdocnumber;?>&&labcode=<?=$labitemcode;?>&&sampleid=<?=$sampleid;?>" target="_blank">Print</a>
               <?php  }else{ 
               		echo 'Pending';
          			  } ?>
...
<table  class="modal-content" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody >
           	...
           	<tr>
           		 <td colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong> &nbsp;</strong></td>
			   <td colspan="4" align="left" bgcolor="#ffffff" class="bodytext31"><strong><h2 style="text-align: center;">Radiology Tests</h2></strong></td>
	...
	$status='completed';
			...
			?>
			 ...
			 <td class="bodytext31" valign="left"  align="left"><div align="left"><?php echo $paharmitemname; ?></div></td>
			   ...
			   <!--  <td class="bodytext31" valign="left"  align="left"><div align="left"><?php echo $pharmitemrate; ?></div></td>
				 ...
				 <td class="bodytext31" valign="left"  align="left"><div align="left">

				 	 <?php   if($num3233>0){ 
               	?>
               <a href="printradiologyresultsip.php?patientcode=<?=$patientcode;?>&&visitcode=<?=$visitcode;?>&&docnumber=<?=$labdocnumber;?>&&labcode=<?=$labitemcode;?>&&sampleid=<?=$sampleid;?>" target="_blank">Print</a>
               <?php  }else{ 
               		echo 'Pending';
          			  } ?>
			...
			<?php } ?>
              ...
              <td colspan="5" class="bodytext31" valign="left"  align="left" bgcolor="#ecf0f5">&nbsp;</td>
...
<div id="postdocModal" class="modal" bgcolor="#ffffff">
<table  class="modal-content" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody style="width: 80%; margin: auto; padding-left: 300px;" >
           	<tr >
           		 <td width="5%" colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong> &nbsp;</strong></td>
			   <td colspan="3" align="center" bgcolor="#ffffff" class="bodytext31"><strong><h2 style="text-align: center;">Post Doctor Notes</h2></strong></td>
			      <td width="5%" colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong><span class="close" id='close_doc1'>&times;</span></strong></td>

			  </tr>


				  <?php
      $query14 = "select post_doctor_notes from master_theatre_booking where patientcode='$patientcode' and patientvisitcode='$visitcode' and approvalstatus != 'Pending' and post_doctor_notes!='' order by auto_number desc ";
		$exec14 = mysqli_query($GLOBALS["___mysqli_ston"], $query14) or die ("Error in Query14".mysqli_error($GLOBALS["___mysqli_ston"]));
		$numdsdn=mysqli_num_rows($exec14);
		while ($res14 = mysqli_fetch_array($exec14))
		{
        ...
        <tr <?php echo $colorcode; ?>>
        	<td colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong> &nbsp;</strong></td>
                        <td width="11%" align="left" valign="bottom"  class="bodytext3">
                          <div align="center" class="bodytext3"></div>
                        </td>
						 <td width="14%" align="left" valign="bottom"  class="bodytext3"></td>
	...
	<?php }else{  ?>
			<tr>
			 <td colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong> &nbsp;</strong></td>
			  <td colspan="3" align="center" bgcolor="#ffffff" class="bodytext31"><strong>There is No Post Doctor Notes!</strong></td>
			   <td colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong> &nbsp;</strong></td>
		</tr>
	<?php } ?>
...
<div id="postaneaModal" class="modal" bgcolor="#ffffff">
<table  class="modal-content" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody style="width: 80%; margin: auto; padding-left: 300px;" >
           	<tr >
           		 <td width="5%" colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong> &nbsp;</strong></td>
			   <td colspan="3" align="center" bgcolor="#ffffff" class="bodytext31"><strong><h2 style="text-align: center;">Post Anaesthetist Notes</h2></strong></td>
			      <td width="5%" colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong><span class="close" id='close_doc2'>&times;</span></strong></td>

			  </tr>


				  <?php
      $query14 = "select post_anaesthetist_notes from master_theatre_booking where patientcode='$patientcode' and patientvisitcode='$visitcode' and approvalstatus != 'Pending' and post_anaesthetist_notes!='' order by auto_number desc ";
		$exec14 = mysqli_query($GLOBALS["___mysqli_ston"], $query14) or die ("Error in Query14".mysqli_error($GLOBALS["___mysqli_ston"]));
		$numdsdn=mysqli_num_rows($exec14);
		while ($res14 = mysqli_fetch_array($exec14))
		{
		$post_doctor_notes = $res14["post_anaesthetist_notes"];
		$colorloopcount = $colorloopcount + 1;
		$showcolor = ($colorloopcount & 1); 
		if ($showcolor == 0)
		{
	...
	<?php }else{  ?>
			<tr>
			 <td colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong> &nbsp;</strong></td>
			  <td colspan="3" align="center" bgcolor="#ffffff" class="bodytext31"><strong>There is No Post Anaesthetist Notes!</strong></td>
			   <td colspan="1" align="left" bgcolor="#ffffff" class="bodytext31"><strong> &nbsp;</strong></td>
		</tr>
	<?php } ?>
...
/// post doc notes
var doc1 = document.getElementById("postdocModal");
var docBtn1 = document.getElementById("postdocotorbtn");
var close_doc1 = document.getElementById("close_doc1");
// var span = document.getElementsByClassName("close")[0];
docBtn1.onclick = function() {
  doc1.style.display = "block";
}

close_doc1.onclick = function() {
  doc1.style.display = "none";
}

window.onclick = function(event) {
  if (event.target == doc1) {
    doc1.style.display = "none";
  }
}
...
/// post anea notes
var doc2 = document.getElementById("postaneaModal");
var docBtn2 = document.getElementById("postanaebtn");
var close_doc2 = document.getElementById("close_doc2");
// var span = document.getElementsByClassName("close")[0];
docBtn2.onclick = function() {
  doc2.style.display = "block";
}

close_doc2.onclick = function() {
  doc2.style.display = "none";
}

window.onclick = function(event) {
  if (event.target == doc2) {
    doc2.style.display = "none";
  }
}

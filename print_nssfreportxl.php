...
<?php //include("a4pdfheader1.php"); ?>	
	...
	<td colspan="7" align="left" class="bodytext3"><strong>NSSF CONTRIBUTION</strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td width="50" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>&nbsp;</strong></td>
	...
	<tr bgcolor="#FFFFFF">
	<td width="50" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>&nbsp;</strong></td>
		<td colspan="7" align="left" class="bodytext3"><strong>EMPLOYER'S NSSF NUMBER : <?php echo $nssfnumber; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td width="50" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>&nbsp;</strong></td>
	...
	<tr bgcolor="#FFFFFF">
	<td width="50" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>&nbsp;</strong></td>
	<td colspan="7" align="left" class="bodytext3"><strong>MONTH OF CONTRIBUTION : <?php echo $searchyear.'-'.date('m',strtotime($searchmonth)); ?></strong></td>
	</tr>
		<tr>

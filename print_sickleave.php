...
{
$age = calculate_age($res2fromdate,$res2todate);


	
?>
<tr><td colspan="5"class="bodytext365">Kindly allow sick leave from <?=$res2fromdate;?> to <?= $res2todate; ?> (<?php echo $age;?>).</td></tr>
<tr><td>&nbsp;</td></tr><tr><td colspan="5">&nbsp;</td></tr>
<?php } ?>
<?php if($res2fromduty <> '' && $res2fromduty <> '0000-00-00')
{
$age2 = calculate_age($res2fromduty,$res2toduty);
	
?>
<tr><td colspan="5"class="bodytext365"><strong>Light duty is recommended from</strong>
<?=$res2fromduty;?> <strong>to</strong>
<?= $res2toduty; ?> (<?php echo $age2;?>).</td></tr>
<tr><td>&nbsp;</td></tr><tr><td colspan="5">&nbsp;</td></tr>
<?php } ?>
...
<tr><td colspan="5">&nbsp;</td></tr>
<tr><td colspan="5">&nbsp;</td></tr>
<tr><td colspan="5" align="left" class="bodytext365">Signed: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Authorized By</td></tr>
<tr><td colspan="5">&nbsp;</td></tr>
...
function calculate_age($frm,$todate)
{
    $today = new DateTime($todate);
    $diff = $today->diff(new DateTime($frm));

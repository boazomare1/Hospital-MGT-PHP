...
for($i=1;$i<=50;$i++)
{
	...
	header("location:pettycashentries.php");
}
//////////////////
//exit;
?>
<script>
		...
		window.open("pettycashentries.php?st=success","_self")
	</script>
<?php
}
?>
...
{	
	...
	source:"ajaxentriesvoucherledger_pettycash.php?type="+type+"&&location="+location,
	//alert(source);
	minLength:0,
	html: true, 
...
<tr>
  ...
  <tr>
    ...
    <td width="90%" valign="top">
			  ...
			  <form name="form1" id="form1" method="post" action="pettycashentries.php" enctype="multipart/form-data" >
                  ...
                  <table width="918" border="0" align="left" cellpadding="3" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                      ...
                      <tr bgcolor="#011E6A">
                        <td colspan="7" bgcolor="#999999" class="bodytext11"><strong> Petty Cash Entries - Add New </strong></td>
					  ...
					  <?php } 
					   if (isset($_SESSION['items'])) { ?>
					  <tr>
                        <td colspan="8" bgcolor="#FFFF00" align="left" valign="middle" class="bodytext3"><div align="left" style="font-size:12px"><strong><?php echo "Your previous Journal Entry post was not successful, please check the entries and repost"; ?></strong></div></td>
                      </tr>
					  <?php } ?>
				  ...
				  <select name="location" id="location"  onChange=" ajaxlocationfunction(this.value);" >
                      	...
                      	<?php
						 $query01="
						 select * from master_location as ml LEFT JOIN login_locationdetails as ll ON ml.locationcode=ll.locationcode where ll.docno = '".$sessiondocno."' order by ml.locationname"
				   ...
				   <tr>
					...
					<input id="vamount" name="vamount" type="hidden" align="left" size="12" onBlur="addcommas(this.id)"  onKeyDown="return numbervaild(event)" style="text-align:right; font-weight:bold;">
						...
						<td id="idTDJ1" align="left"><input id="ledger1" class="clientglaccountsc" name="ledger1" type="text" align="left" size="50" style="text-align:left; font-weight:bold;" onClick="clicklocation();">
						...
						<td id="costcenter_tdcontent1" align="left" >
							
						</td>
						<!-- <input id="costcenterid1" class="" name="costcenterid1" type="hidden"> -->
						...
						<td align="left">&nbsp;</td>
						<td id="idTDK11" align="left"><textarea class="clientglaccountremarks" id="remark1" name="remark1" type="text" align="left" rows="2" cols="15" style="font-weight:bold;"></textarea></td>
						...
						<td align="right"><input id="cramount1" name="cramount1" type="text" align="right" readonly="readonly" size="12" onBlur="addcommas(this.id)"  onKeyDown="return numbervaild(event)" style="text-align:right; font-weight:bold;  border:none; background-color:transparent;"></td>
						<td align="right"><input id="dramount1" name="dramount1" type="text" align="right" readonly="readonly" size="12" onBlur="addcommas(this.id)"  onKeyDown="return numbervaild(event)" style="text-align:right; font-weight:bold; border:none; background-color:transparent;"></td>
						</tr>
						<?php } ?>
						    		...
						    		function processReplacement($one, $two)
{
  return $one . strtoupper($two);
									  ...
									  foreach ($_SESSION['items'] as $key => $value) {
									  	...
									  	$costcenteridd = $value['costcenter']; 
									  	
									  	$cc_style = "'display:none'";
									  	$html="";
									  	if(trim($value['costcenter']) !="" )
									  	{
									  		$html="";
									  		$cc_style = "'display:block'";
									  		$ledg_id=$value['ledgerno'];
									  		$query11 = "select accountsmain from master_accountname where id = '$ledg_id'";
		...
		if($hasdata)
		{
		 	$html .= "</select>";
						...
						<option value="Dr" <?php if($value['entrytype'] == 'Dr') echo "selected";?>>Dr</option>
						</select></td>
						<td id="idTDJ1" align="left"><input id="ledger1" class="clientglaccountsc" name="ledger1" type="text" align="left" size="50" style="text-align:left; font-weight:bold;" value="<?php echo $value['ledger']?>">
						<input id="ledgerno1" class="clientglaccountsc" name="ledgerno1" type="hidden" align="left" size="50" value="<?php echo $value['ledgerno']?>">
						<input id="billwise1" class="clientglaccountsc" name="billwise1" type="hidden" align="left" size="50">
						</td>
						<td id="costcenter_tdcontent1" align="left" style="display:none">
							<?= $html;?>
						</td>
						<!-- <input id="costcenterid1" class="" name="costcenterid1" type="hidden"> -->
						<td id="idTDK1" align="left"><input class="clientglaccountamt" id="amount1" name="amount1" type="text" value="<?php echo $value['amount']?>" align="left" size="12" onBlur="addcommas(this.id)"  onKeyDown="return numbervaild(event)" onKeyUp="return FillAmt('1')" onFocus="return Dis('1')" style="text-align:right; font-weight:bold;"></td>
						<td align="left">&nbsp;</td>
						<td id="idTDK11" align="left"><textarea class="clientglaccountremarks" id="remark1" name="remark1" type="text" align="left" rows="2" cols="15" style="font-weight:bold;"><?php echo $value['remark']?></textarea></td>
						<td id="btnact1" align="right">
						<select id="selectact1" name="selectact1" class="mainrefaction" multiple="multiple" size="3" style="text-align:left; font-weight:bold; display:none;">
						<option value="1">New Ref</option>
						<option value="2">Agst Ref</option>
						...
						<td align="right"><input id="cramount1" name="cramount1" type="text" align="right" value="<?php echo $credit_amt?>" readonly="readonly" size="12" onBlur="addcommas(this.id)"  onKeyDown="return numbervaild(event)" style="text-align:right; font-weight:bold;  border:none; background-color:transparent;"></td>
						<td align="right"><input id="dramount1" name="dramount1" type="text" align="right" value="<?php echo $debit_amt?>" readonly="readonly" size="12" onBlur="addcommas(this.id)"  onKeyDown="return numbervaild(event)" style="text-align:right; font-weight:bold; border:none; background-color:transparent;"></td>
						</tr>
									  <?php	}
									  if($key !=1){
									  	$costcenteridd = $value['costcenter']; 
		...
		if($hasdata)
		{
		 	$html .= "</select>";
									  ...
									  <tbody id="insertrow<?php echo $key?>">
									  	<tr id="idTRI<?php echo $key?>">
									  		<td id="idTDI<?php echo $key?>" align="left"><input id="serialnumberentries<?php echo $key?>" name="serialnumberentries<?php echo $key?>" type="hidden" align="left" size="2" value="<?php echo $key?>" readonly="">
									  			<select name="entrytype<?php echo $key?>" id="entrytype<?php echo $key?>" onChange="return FillAmt(<?php echo $key?>)" style="text-align:left; font-weight:bold;">
									  				
									  				
									  				<option value="Dr" <?php if($value['entrytype'] == 'Dr') echo "selected";?>>Dr</option>
									  			</select>
									  		</td>
									  		<td id="idTDJ<?php echo $key?>" align="left"><input id="ledger<?php echo $key?>" class="clientglaccountsc" name="ledger<?php echo $key?>" type="text" align="left" size="50" style="text-align:left; font-weight:bold;" value="<?php echo $value['ledger']?>">
									  			<input id="ledgerno<?php echo $key?>" class="clientglaccountsc" name="ledgerno<?php echo $key?>" type="hidden" value="<?php echo $value['ledgerno']?>" align="left" size="50">
									  			<input id="billwise<?php echo $key?>" class="clientglaccountsc" name="billwise<?php echo $key?>" type="hidden" align="left" size="50">
									  			</td>
									  			<td id="costcenter_tdcontent<?php echo $key?>" align="left" ><?= $html;?></td>
									  			<td id="idTDK<?php echo $key?>" align="left"><input class="clientglaccountamt" id="amount<?php echo $key?>" name="amount<?php echo $key?>" type="text" align="left" size="12" value="<?php echo $value['amount']?>" onBlur="addcommas(this.id)"  onKeyDown="return numbervaild(event)" onFocus="return Dis(<?php echo $key?>)" onKeyUp="return FillAmt(<?php echo $key?>)" style="text-align:right; font-weight:bold;"></td>
									  			<td>&nbsp;</td>
									  			<td id="idTDK<?php echo $key?>" align="left"><textarea class="clientglaccountremarks" id="remark<?php echo $key?>" name="remark<?php echo $key?>"  align="left" rows="2" cols="15"  style="font-weight:bold;"><?php echo $value['remark']?></textarea></td>
									  			<td id="btnact<?php echo $key?>" align="right"><select id="selectact<?php echo $key?>" name="selectact<?php echo $key?>" class="mainrefaction" multiple="multiple" size="3" style="text-align:left; font-weight:bold;display:none">';
														<option value="">Select</option>
														<option value="1">New Ref</option>
														<option value="2">Agst Ref</option>
													<option value="3">On Account</option>
														</select></td>
									  			<td align="right"><input id="cramount<?php echo $key?>" name="cramount<?php echo $key?>" type="text" readonly="readonly" value="<?php echo $credit_amt?>" align="right" size="12" onBlur="addcommas(<?php echo $key?>)"  onKeyDown="return numbervaild(event)" style="text-align:right; font-weight:bold; border:none; background-color:transparent;"></td>
									  			<td align="right"><input id="dramount<?php echo $key?>" name="dramount'+sno+'" type="text" readonly="readonly" value="<?php echo $debit_amt?>" align="right" size="12" onBlur="addcommas(<?php echo $key?>)"  onKeyDown="return numbervaild(event)" style="text-align:right; font-weight:bold; border:none; background-color:transparent;"></td>
									  			<td align="right"><input type="button" value="Del" onClick="return btnDeleteClickindustry(<?php echo $key?>)"></td>
									  	</tr>
									  </tbody>
						...
						<td width="140" align="center" class="bodytext13"><strong>
						...
						<td width="92" align="center" class="bodytext13"><strong>
						  ...
						  <td width="40" align="right" class="bodytext13">&nbsp;</td>
						</tr>
                        ...
                        <?php if (isset($_SESSION['items'])) { ?>
                        	<input type="hidden" name="serialnumber" id="serialnumber" value="<?php echo $serialnumber_cnt+1;?>" size="1" />
                        <?php } else
                        {
                        	?>

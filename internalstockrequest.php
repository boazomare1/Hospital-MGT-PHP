...
for ($p=1;$p<=$number;$p++)
		...
		$medicinename=addslashes(trim($medicinename));
...
$numcount = mysqli_num_rows($exec23);
...

		{
...

			{
				...
				$totalquantity=$reqquantity+$alreadyreqquantity;
				  ...
				  $excupdatequery=mysqli_query($GLOBALS["___mysqli_ston"], $updatequery) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
{	
	...
	$('#medicinename').autocomplete({
		...
		source:'ajaxrequestmedicinebuildnew_1.php?typetransfer='+$('#typetransfer').val()+'&&storecode='+$('#fromstore').val()+'&&action=medicinesearch', 
		...
		html: true, 
			...
			select: function(event,ui){
				...
				$('#medicinecode').val(itemcode);
					...
					url:"ajaxrequestmedicinebuildnew_1.php",
			        ...
			        dataString = 'itemcode='+itemcode+'&&storecode='+$('#tostore').val()+'&&location='+$('#location').val()+'&&action=medicineqty';
					$.ajax({
					type:"POST",
					url:"ajaxrequestmedicinebuildnew_1.php",
					data:dataString,
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext3"><strong> Internal Stock Request </strong></td>
          ...
          <tr bgcolor="#011E6A">
                      ...
                      <td colspan="12" bgcolor="#ecf0f5" class="bodytext32"><select name="typetransfer" id="typetransfer" onChange="return medicinesearch(this.value);">
                      ...
                      <option value="2">Clinical Consumable</option> -->
...
?>
		...
		$nondrug_store = $res55['nondrug_store'];
		$drugs_store = $res55['drugs_store'];
		$asset_store = $res55['asset_store'];
			 if($storecode=='')

			   $query2 = "select * from master_store where locationcode = '$res7locationanum' and storecode In('$drugs_store','$nondrug_store','$asset_store') and recordstatus <> 'Deleted' order by store limit 0, 200";

			else

			  //$query2 = "select * from master_store where locationcode = '$res7locationanum' and recordstatus <> 'Deleted' and storecode!='".$storecode."' order by store limit 0, 200";
$query2 = "select * from master_store where locationcode = '$res7locationanum' and recordstatus <> 'Deleted' and storecode!='".$storecode."' and storecode In('$drugs_store','$nondrug_store','$asset_store')order by store limit 0, 200";
	  ...
	  <tr id="pressid">
				   ...
				   <table id="presid" width="500" border="0" cellspacing="1" cellpadding="1">
                     ...
                     <tr>
                       ...
                       <td width="84" class="bodytext3">Frm Store Avl.Qty</td>
                     ...
                     <tr>
					  ...
					  <input type="hidden" name="medicinecode" id="medicinecode" value="">
						...
						<td><input name="avlquantity" type="text" id="avlquantity" size="8" readonly></td>

						<td><input name="toavlquantity" type="text" id="toavlquantity" size="8" readonly></td>

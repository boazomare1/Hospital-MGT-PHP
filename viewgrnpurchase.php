     ...
     <td>
          ...
          <tbody>
             ...
             <tr bgcolor="#011E6A">
                ...
                <td colspan="8" bgcolor="#ecf0f5" class="bodytext31" align="left" valign="middle"><strong>GRN Detatiled Report</strong></td>
             ...
             <tr bgcolor="#999999">
                ...
                <td width=""  align="left" valign="middle"  class="bodytext31"><strong>GRN No</strong></td>
                ...
                <td width=""  align="left" valign="middle" class="bodytext31"><strong>Tax %</strong></td>
                <td width=""  align="right" valign="middle" class="bodytext31"><strong>Tax Amt</strong></td>
...
<?php
	...
	$qrypodetailed = "SELECT entrydate,itemcode,itemname,rate,quantity,username,totalfxamount,billnumber,itemtaxamount,itemtaxpercentage FROM materialreceiptnote_details WHERE ponumber = '$searchponumber' AND recordstatus<>'deleted'";
...

	{
		...
		$billnumber = $respodetailed["billnumber"];

		$fxamount = $respodetailed["totalfxamount"];

...
$query2 = "select * from master_icd where (description like '%$searchdisease1%' OR icdcode like '%$searchdisease1%') and recordstatus = 'active' order by auto_number LIMIT 1000";// order by subtype limit 0, 15";

...

{
...

	{
  	...
  	var searchsuppliercode = document.getElementById("searchsuppliercode").value;
	...
	var url="automedicinecodesearch5kiambu1_emerindent.php?RandomKey="+Math.random()+"&&medicinesearch="+medicinesearch+"&&searchsuppliercode="+searchsuppliercode;

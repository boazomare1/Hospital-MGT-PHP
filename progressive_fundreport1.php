...
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   <td width="1%" align="left" valign="top">&nbsp;</td>
    <td  valign="top">
	<form name="form1" id="form1" method="post" action="progressive_fundreport1.php" onSubmit="return from1submit1()">
   ...
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tbody>
	<tr bgcolor="#FFFFFF">
	<td colspan="8" align="center" class="bodytext3"><strong>HISTORICAL PROVIDENT CONTRIBUTION</strong></td>
	</tr>
	<tr bgcolor="#ecf0f5">
	<td colspan="8" align="left" class="bodytext3"><strong>Historical Provident Report</strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
	<td colspan="8" align="left" class="bodytext3"><strong>PROVIDENT NUMBER : <?php echo $nssf; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<?php 
	$totalgrossper = 0;
	$query1 = "select `1`,`23` from details_employeepayroll where employeecode='$res2employeecode' AND paymonth ='$paymonth'";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($res1 = mysqli_fetch_array($exec1))
	{
		$basicpay = $res1['1'];
		$voluntary = $res1['23'];
		$stdamount = $basicpay*0.05;
		$empamount = $basicpay*0.15;
		$totamount = $stdamount+$empamount;

	}
	 ?>
	<td align="right" class="bodytext3"><?php echo number_format($basicpay,3,'.',','); ?></td>
	...
	<tr>
	<td colspan="10" align="left" class="bodytext3"><a href="print_progressive_fundreport1.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/pdfdownload.jpg" height="40" width="40"></a>
	&nbsp;&nbsp;&nbsp;<a href="print_progressive_fundreportxl.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/excel-xls-icon.png" height="40" width="40"></a></td>
	</tr>
	</tbody>
	</table> 
	<?php 

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="consultationrevenuedayreport.php">
          ...
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext3"><strong>Consultation Revenue - Day Wise </strong></td>
              </tr>
		    ...
		    if($charttype== 'Bar') { ?>
		 	<tr>
				<td width="94" align="left" valign="center">
					...
					open_flash_chart_object( 440, 250, 'http://'. $_SERVER['SERVER_NAME'] .'/medbot/consultationrevenueday-bar.php', true );

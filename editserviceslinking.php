...
foreach($_POST['itemcode'] as $key => $value)
		...
		$query77="select itemcode from master_medicine where itemname='$itemname'";
		...
		$itemcode=$_REQUEST['itemcode'][$key];
	...
	$execquery2=mysqli_query($GLOBALS["___mysqli_ston"], $medicinequery2) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		header("location:serviceslinking.php");
...
$query1 = "select itemname,itemcode from master_services where status <> 'Deleted' and itemcode = '$code' limit 0,1";
...

{
	...
	deleted_itemcode = deleted_itemcode.trim();
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
		   ...
		   <tr>
              ...
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext3"><strong>Edit Services Linking </strong></td>
...
$itemcode = trim($res23['itemcode']);

$itemname = $res23['itemname'];

$quantity = $res23['quantity'];

$item_codes_arr[] = $itemcode;
...
<script type="text/javascript">
	...
	var itemcodearr = <?php echo json_encode($item_codes_arr); ?>;

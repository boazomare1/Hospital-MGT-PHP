...
if (isset($_REQUEST["docno"])) {  $docno = $_REQUEST["docno"]; } else { $docno = ""; }
  $querry=" SELECT  * from pcrequest where doc_no='$docno'  and delete_status <>'deleted' and (approved_status<>1 and approved_status<>2 and approved_status<>3 and approved_status<>6 and approved_status<>4 or approved_status=4  ) order by doc_no desc";
...
function adddata(a){
	...
	$.ajax({
		type : "POST",
		url : "pettyupdate_new.php",
		data : data,
		cache:false,
		success: function(data){
			//alert(data); 
			 window.open("requestlist.php","_self");
		}
    ...
    <table width="97%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="901" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            ...
            <td width="3%" height="31" bgcolor="#ecf0f5" class="bodytext31"><strong>S.No.</strong></td>
            ...
            <td width="11%" bgcolor="#ecf0f5" class="bodytext31"><strong>Requested Amount</strong></td>
             <td width="16%" bgcolor="#ecf0f5" class="bodytext31"><strong>Approve Amount</strong></td>
            <td width="18%" bgcolor="#ecf0f5" class="bodytext31"><strong>Remarks</strong></td>
            <td width="11%" bgcolor="#ecf0f5" class="bodytext31"><strong>Requested By</strong></td>
            <td width="19%" bgcolor="#ecf0f5" class="bodytext31"><strong>Approve/Discard</strong></td>
             <td width="9%" bgcolor="#ecf0f5" class="bodytext31"><strong>&nbsp;</strong></td>
            <td width="0%" height="37" align="left" valign="top"  bgcolor="#ecf0f5"  class="bodytext31">&nbsp;</td>
              ...
              <td align="left" valign="top" bgcolor="#FFFFFF"  class="bodytext31"><input type="hidden" name="currentd" id="currentd" value="<?php echo $currentdate; ?> "><?php echo date('d/m/Y',strtotime($currentdate)); ?></td>
               <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext31"><input type="hidden" name="ramount" id="ramount" value="<?php echo number_format($amount); ?>"> <?php echo $amount; ?></td>
                ...
                <td align="center" valign="top" bgcolor="#FFFFFF"  class="bodytext31"><?php echo $remarks; ?> </td>
                 ...
                 id="action" name="action" value="5" checked >Approve
                 <input type="radio"  
                 id="action" name="action" value="6" >Discard
                  </td>

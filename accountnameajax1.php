...
$query2 = "select auto_number,id,accountname,accountssub from master_accountname where accountname like '%$term%' and accountsmain = '5' and recordstatus <> 'deleted' limit 0,10";

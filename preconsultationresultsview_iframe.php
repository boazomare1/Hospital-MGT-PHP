...
.bodytext3 {FONT-WEIGHT: normal; FONT-SIZE: 12px; COLOR: #3b3b3c; FONT-FAMILY: Tahoma; text-decoration:none
...

			{
				...
				$colorcode = 'bgcolor="#FFFFFF"';
				  ...
				  <tr <?php echo $colorcode; ?>>
				   ...
				   <td class="bodytext3 size_change" valign="center"  align="left"><div align="center"><?php echo $consultationdate; ?></div> </td>

			   

			 <td class="bodytext3 size_change" valign="center"  align="left"><div align="center"><?php echo $labitemname; ?></div></td>
...

			{
				...
				$colorcode = 'bgcolor="#FFFFFF"';
				  ...
				  <tr <?php echo $colorcode; ?>>
				   ...
				   <td class="bodytext3 size_change" valign="center"  align="left"><div align="center"><?php echo $date6; ?></div> </td>

			   

			 <td class="bodytext3 size_change" valign="center"  align="left"><div align="center"><?php echo $itemname; ?></div></td>

			 <td class="bodytext3" valign="center"  align="left"><div align="center"><a target="_blank" href="printradiologyresults.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&&docnumber=<?php echo $resraddocnumber; ?>">View<br>

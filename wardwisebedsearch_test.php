    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" id="form1" action="wardwisebedsearch_test.php" onSubmit="return wardwisesearch1()">
		<table width="604" border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Ward Wise Bed Search</strong></td>
	  ...
	  <form name="form1" id="form1" method="post" action="wardwisebedsearch_test.php">	
	  <tr>
        <td>
...
?>
		...
		if($searchtype == 'all')
		{
echo		$query50 = "select * from master_bed where ward='$wardnum' and locationcode='$searchlocationcode' and recordstatus <> 'deleted'";
		...
		{
echo		$query41 = "select * from ip_bedallocation where ward='$wardnum' and bed='$bedanum' and locationcode='$searchlocationcode' and (recordstatus='' or recordstatus='request')";
		...
		{
echo		$query411 = "select * from ip_bedtransfer where ward='$wardnum' and locationcode='$searchlocationcode' and bed='$bedanum' and (recordstatus='' or recordstatus='request') order by auto_number desc limit 0,1";
		$exec411 = mysqli_query($GLOBALS["___mysqli_ston"], $query411) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		$res411 = mysqli_fetch_array($exec411);

                      ...
                      <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><strong>
                        <select name="billtype" id="billtype" >
                         ...
                         <!-- <option value="20" <?php if($billtype==20) echo 'selected'; ?>>Account Receivable</option>-->
                          ...
                          <option value="24" <?php if($billtype==24) echo 'selected'; ?>>Other Sales</option>
                        </select>
                      </strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
		   ...
		   <?php
			$query7 = "select * from master_transactionipdeposit where patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and docno like '%$billnumber%' and locationcode='$locationcode1' and transactiondate between '$transactiondatefrom' and '$transactiondateto' and transactionmodule = 'PAYMENT' order by auto_number desc ";
			$exec7 = mysqli_query($GLOBALS["___mysqli_ston"], $query7) or die ("Error in query7".mysqli_error($GLOBALS["___mysqli_ston"]));
		   ...
		   <?php } }  ?>
			...
			<?php if ($cbfrmflag1 == 'cbfrmflag1' && ($billtype== 8 || $billtype== '8a')) 
				...
				$query77 = "select * from master_transactionipcreditapproved where patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and billnumber like '%$billnumber%' and locationcode='$locationcode1' and transactiontype='finalize' and transactiondate between '$transactiondatefrom' and '$transactiondateto' group by billnumber order by auto_number desc ";
		   ...
		   <?php
		    $query7 = "select patientcode,visitcode,transactiondate,patientname,billnumber,username,accountname,'ipfinal' as types from master_transactionip where patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and billnumber like '%$billnumber%' and locationcode='$locationcode1' and transactiontype = 'finalize' and transactiondate between '$transactiondatefrom' and '$transactiondateto'  
		    union all
            select patientcode,visitcode,transactiondate,patientname,billnumber,username,accountname,'creadit' as types from master_transactionipcreditapproved where patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and billnumber like '%$billnumber%' and locationcode='$locationcode1' and transactiontype='finalize' and transactiondate between '$transactiondatefrom' and '$transactiondateto' group by billnumber 
		   ";
			$exec7 = mysqli_query($GLOBALS["___mysqli_ston"], $query7) or die ("Error in query7".mysqli_error($GLOBALS["___mysqli_ston"]));
			while($res7 = mysqli_fetch_array($exec7))
			 {
		   ...
		   <?php if ($cbfrmflag1 == 'cbfrmflag1' && $billtype== 9)
			...
			<tr>
             ...
             <tr <?php //echo $colorcode; ?>>
              ...
              <td width="9%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">User</td>
              <td width="9%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Action</td>
              <td width="7%" align="left" valign="center" bgcolor="#FFFFF6F" class="style3">No ICD</td>
              <td width="7%" align="left" valign="center" bgcolor="#FFFFF6F" class="style3">&nbsp;</td>
            </tr>
		   ...
		   // $query7 = "select * from billing_paylater where patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and billno like '%$billnumber%' and locationcode='$locationcode1' and patientcode <> '' and billdate between '$transactiondatefrom' and '$transactiondateto' order by auto_number desc "; 
            ...
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center" align="left"><?php echo $snocount; ?></td>
               ...
               <td class="bodytext31" valign="center"  align="left"><?php echo $res7patientvisitcode; ?></td>
               <td class="bodytext31" valign="center"  align="left"><?php echo strtoupper($res7username); ?></td>
               <td class="bodytext31" valign="center"  align="left"><input type="button" id="print_it<?php echo $snocount;?>" name="print_it<?php echo $snocount;?>" value="Print" onClick="print_it_val('<?php echo $snocount;?>','<?php echo $locationcode1;?>','<?php echo $res7billnumber;?>')"/></td>
                <td class="bodytext31" valign="center"  align="left"><input type="checkbox" id="no_icd<?php echo $snocount;?>" name="noicd<?php echo $snocount;?>" value=""/></td>
           ...
           <?php if ($cbfrmflag1 == 'cbfrmflag1' && $billtype== 161)
				{
				$query7 = "SELECT auto_number as auto_number, patientcode as patientcode, billno as billno, visitcode as visitcode, billdate as billdate, patientname as patientname from refund_paylater where locationcode='$locationcode1' and billno like '%$billnumber%' and billdate between '$transactiondatefrom' and '$transactiondateto' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' group by billno  
				UNION ALL select auto_number as auto_number, patientcode as patientcode, billno as billno, visitcode as visitcode, billdate as billdate, patientname as patientname from ip_creditnote where locationcode='$locationcode1' and billno like '%$billnumber%' and billdate between '$transactiondatefrom' and '$transactiondateto' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' group by billno 
				UNION ALL select auto_number as auto_number, patientcode as patientcode, billno as billno, visitcode as visitcode, billdate as billdate, patientname as patientname from ip_debitnote where locationcode='$locationcode1' and billno like '%$billnumber%' and billdate between '$transactiondatefrom' and '$transactiondateto' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' group by billno
		...
		//	$res7username= $res7['username'];
           ...
           <?php if ($cbfrmflag1 == 'cbfrmflag1' && $billtype== 19)
				{
				$queryn = "select * from  expensesub_details where locationcode='$locationcode1' and chequenumber like '%$billnumber%' and chequedate between '$transactiondatefrom' and '$transactiondateto'  group by chequenumber order by auto_number desc ";
		   ...
		   <?php
		    $querynn = "select * from expensesub_details where locationcode='$locationcode1' and docnumber like '%$billnumber%' and transactiondate between '$transactiondatefrom' and '$transactiondateto' group by chequenumber order by auto_number desc ";
            ...
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center" align="left"><?php echo $snocount; ?></td>
               <td class="bodytext31" valign="center"  align="left"><?php echo $cdate; ?></td>
           ...
           <?php if ($cbfrmflag1 == 'cbfrmflag1' && $billtype== 24)
				{
				$queryn = "select * from  other_sales where docno like '%$billnumber%' and name like '%$searchpatient%'  and consultationdate between '$transactiondatefrom' and '$transactiondateto'  and  locationcode='$locationcode1' group by docno order by auto_number desc ";
				$execn = mysqli_query($GLOBALS["___mysqli_ston"], $queryn) or die ("Error in queryn".mysqli_error($GLOBALS["___mysqli_ston"]));
				$numn = mysqli_num_rows($execn);
			 ?> 	
			<tr>
				<td colspan="5" bgcolor="#ecf0f5" class="style3">Other Sales<?php echo '('.$numn.')'; ?></td>
			</tr>
             <tr <?php //echo $colorcode; ?>>
              <td width="5%" align="left" valign="center" bgcolor="#FFFFFF" class="bodytext31"><strong>S.No.</strong></td>
              <td width="10%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Bill Date</td>
              ...
              <td width="10%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Bill No</td>
              <td width="29%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Name</td>
              <td width="10%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Reg No</td>
		   ...
		   <?php
		    $querynn = "select * from other_sales_billing where billno like '%$billnumber%' and name like '%$searchpatient%'  and billdate between '$transactiondatefrom' and '$transactiondateto'  and  locationcode='$locationcode1' group by osno order by auto_number desc ";
			$execnn = mysqli_query($GLOBALS["___mysqli_ston"], $querynn) or die ("Error in querynn".mysqli_error($GLOBALS["___mysqli_ston"]));
			while($resnn = mysqli_fetch_array($execnn))
			 {
				 $billno = $resnn['billno'];
				 $osno = $resnn['osno'];
				 $cdate=$resnn['billdate'];
				 /*$cdate=$resnn['consultationdate'];
				 $cnumber=$resnn['docno'];
				 $cname=$resnn['name'];
				 $ccode='';
				 $canumber=$resnn['auto_number'];*/
				 
				$query2 = "select * from other_sales where docno = '$osno'";
				$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
            ...
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center" align="left"><?php echo $snocount; ?></td>
			   ...
			   <td class="bodytext31" valign="center"  align="left"><?php echo $ccode; ?></td>
               <td class="bodytext31" valign="center"  align="left">
               <a target="_blank" href="print_othersales.php?billno=<?php echo $billno; ?>&docno=<?php echo $cnumber; ?>&locationcode=<?php echo $locationcode; ?>"><strong>Print</strong></a></td>
               </tr>
		   <?php } }  ?>

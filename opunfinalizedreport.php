<?php
	...
	$totalpharmacysalesreturn=0;
		 ...
		 $query2 = "select planname,patientcode,visitcode,subtype,planpercentage from master_visitentry where billtype='PAY LATER' and consultationdate between '$ADate1' and '$ADate2' AND visitcode NOT IN (SELECT visitcode FROM billing_paylater) order by accountfullname desc ";
		  ...
		  $query4 = "select servicesitemcode,serviceqty,refundquantity from consultation_services where patientcode = '$res2patientcode' and patientvisitcode = '$res2visitcode' and wellnessitem <> '1'";
		  ...
		  echo '<br>'.$overaltotalrefund;

		  echo '<br>'.$res2visitcode;

		  echo '<br>'.$res3labitemrate;

		  echo '<br>'.$res4servicesitemrate;

		  echo '<br>'.$res9pharmacyrate;

		  echo '<br>'.$res5radiologyitemrate;

		  echo '<br>'.$consultation;

		  echo '<br>'.$res6referalrate;
		  ...
		  $snocount = $snocount + 1;
			...
			//echo  $overaltotalrefund;

//			echo '<br>'.$totalamount1;

//			echo '<br>'.$totalamount2;

//			echo '<br>'.$totalamount3;

//			echo '<br>'.$totalamount4;

//			echo '<br>'.$totalamount5;

//			echo '<br>'.$totalamount6;

//			echo '<br>'.$totalamount7;

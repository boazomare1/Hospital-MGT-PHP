...
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   <td width="1%" align="left" valign="top">&nbsp;</td>
    <td  valign="top">
	<form name="form1" id="form1" method="post" action="payereport2.php" onSubmit="return from1submit1()">
	...
	<tbody>
	<tr bgcolor="#999999">
	<td colspan="36" align="left" class="bodytext3"><strong>Search Report</strong></td>
	</tr>
	<tr>
   ...
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tbody>
	<tr bgcolor="#FFFFFF">
	<td colspan="36" align="center" class="bodytext3"><strong>PAYE CONTRIBUTION</strong></td>
	</tr>
	<tr bgcolor="#ecf0f5">
	<td colspan="36" align="left" class="bodytext3"><strong>PAYE Report</strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="36" align="left" class="bodytext3"><strong>EMPLOYER'S PIN NUMBER : <?php echo $pinnumber; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="36" align="left" class="bodytext3"><strong>EMPLOYER'S NAME : <?php eval(base64_decode('IGVjaG8gJGNvbXBhbnluYW1lOyA=')); ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="36" align="left" class="bodytext3"><strong>MONTH OF CONTRIBUTION : <?php eval(base64_decode('IGVjaG8gJHNlYXJjaG1vbnRoeWVhcjsg')); ?></strong></td>
	</tr>
	<tr>
	...
	<tr>
	<td colspan="36" align="left" class="bodytext3"><a href="print_payereport2csv.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><b>Download CSV for KRA Upload</b></a>
	&nbsp;&nbsp;&nbsp;<a href="print_payereportxl2.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/excel-xls-icon.png" height="40" width="40"></a></td>
	</tr>
	</tbody>
	</table> 
	<?php 

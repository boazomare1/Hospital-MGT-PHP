...
if(isset($_REQUEST['key_provider'])) { $key_provider = $_REQUEST['key_provider']; } else { $key_provider = ''; }
...
$query8 = "select sum(fxamount) as tot from billing_ipcreditapprovedtransaction where visitcode = '$visitcode'";
...
$query81 = "select sum(fxamount) as tot from billing_ipcreditapprovedtransaction where visitcode = '$visitcode' and accountnameano!='$accountname' ";

$exec81 = mysqli_query($GLOBALS["___mysqli_ston"], $query81) or die ("Error in query81".mysqli_error($GLOBALS["___mysqli_ston"]));

$res81 = mysqli_fetch_array($exec81);

$nhif_amount = $res81['tot'];
...
$fileData1 = $fileData1.addslashes("
	...
	<Total_Amount>".(-1)*$nhif_amount."</Total_Amount>
...
$InOut_Type = '2';
 ...
 $query8 = "update billing_ipcreditapprovedtransaction set orginalsmartxml='".addslashes($importData)."' where visitcode = '$visitcode' and accountnameano='$accountname' and billno='$billautonumber'";

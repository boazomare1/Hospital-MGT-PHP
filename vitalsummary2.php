...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
	...
	<tr>
		...
		<td colspan="2" width="99%" valign="top">
			...
			<form name="form1" id="form1" method="post" action="vitalsummary2.php" onKeyDown="return disableEnterKey(event)" onSubmit="return process1()">
			<tr>
				<td width="1000">
			...
			<table width="800" border="0" cellpadding="4" cellspacing="0" bordercolor="#666666" style="border-collapse: collapse">
				...
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td><a href="vitalsummarygraph2.php?patientcode=<?=$searchpatientcode?>&&fromdate=<?=$fromdate?>&&todate=<?=$todate?>" target="_blank">View Graphs</td>
				</tr>
			</table>
			<?php
					}

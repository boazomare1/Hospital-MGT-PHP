...
header('Content-Disposition: attachment;filename="storeReorderLevel.xls"');
...
<table border="1" width="100%" style="border-collapse:collapse;">
      <tr>
	    ...
	    <td width="223"  align="left" valign="center" 
			...
			$incr = 0;
			//$query11 = "select itemcode,itemname,rol,minimumstock,maximumstock,packagename,categoryname from master_medicine where status <> 'deleted'    group by itemcode order by itemname";

    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <?php
		 ...
		 $query9 = "SELECT * FROM ip_discount WHERE patientvisitcode IN (SELECT `visitcode` FROM `billing_ip` where billdate BETWEEN '$ADate1' and '$ADate2') and patientvisitcode in(select visitcode from master_ipvisitentry where accountname ='$acc_id')";

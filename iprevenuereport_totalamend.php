    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="1100" align="left" border="0">
		  ...
		  $main_array_1 =array('cash','credit','note');
           ...
           $query1 = "select patientcode, patientvisitcode as visitcode,patientname,'' as type from ip_creditnotebrief where locationcode = '$locationcode1' and consultationdate between '$ADate1' and '$ADate2' and patientvisitcode like '%IPV%' group by patientcode ";

...
?>
  ...
  <td class="bodytext31" valign="center"  align="left" style="font-size:20px;"><div align="center"><?php echo $sampleid; ?>
		...
		?>
			...
			{
		var popWin; 
		popWin = window.open("print_labsample_label.php?patientcode="+patientcode+'&visitno=<?php echo $visitcode;?>',"OriginalWindowA4",'width=800,height=800,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25'); 
			}
			}
           </script>
          </tbody>

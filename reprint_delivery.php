...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td  valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="">
        <form name="cbform1" method="post" action="reprint_delivery.php" >
	  ...
	  <tr><td  align="left" colspan="4" valign="middle"  >&nbsp;</td></tr>
			<?php
				...
				$query24 = "select * from print_deliverysubtype where date(updatedatetime) between '$ADate1' and '$ADate2' and status <> 'deleted' group by printno order by updatedatetime desc";
			?>
               ...
               <td colspan="4" >
			     <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
						 ...
						 <tr>
						  ...
						  <td align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><strong>Sub Type</strong></td>
						...
						<td class="bodytext31" valign="center"  align="left"><a href='print_deliverysubpdf2.php?printno=<?php echo $res24['printno']; ?>' target='_blank'>Print</a> &nbsp;&nbsp;<a href='print_deliverysubpdf2xl.php?printno=<?php echo $res24['printno']; ?>' target='_blank'>Download</a></td>
						</tr>
						<?php

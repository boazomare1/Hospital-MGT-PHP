...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td colspan="6" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		<td>
<?php 	$query1 = "select locationcode,visitlimit from master_ipvisitentry where patientcode='$patientcode' and visitcode='$visitcode'";
...
<td width=""  align="left" valign="center" 
 ...
 $query_1 = "select ward from master_ward where auto_number='$wardno'";
	...
	$accname = $res_sc['scheme_name'];
		...
		$query32 = "select currency,fxrate,subtype,bedtemplate,labtemplate,radtemplate,sertemplate,ippactemplate from master_subtype where auto_number = '".$menusub."'";
	...
	//	$res2 = mysql_num_rows($exec2);
		...
		$ippactemplate=$mastervalue['ippactemplate'];
		...
		$colorloopcount = $colorloopcount + 1;
          ...
          <tr <?php echo $colorcode; ?>>
			  ...
			  <td align="left" valign="center" class="bodytext31">
				...
				<td  align="center" valign="center" class="bodytext31"><?php echo date("d/m/Y", strtotime($consultationdate)); ?></td>
	...
	<tr>
		...
		<?php if($num32 != '0') {?>
        <td  bgcolor="#ffffff"  class="bodytext311" align="left" colspan="2">
            ...
            There are Pending IP Medicine Requests for this Patient. Pl Advise Pharmacy to Clear them to reflect in Bill</strong>
            </a>
            </td>
		<?php }else {?>
		<td>&nbsp;</td>
	...
	<td width="5%" >&nbsp;</td>
	<td colspan="2">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="2" width="40%" align="center" border="0">
    <tbody id="foo">
	<tr >
	<td  bgcolor="#ffffff" style="FONT-SIZE:16px;" class="bodytext31" align="right" >	Visit Limit</td>
	<td  bgcolor="#ffffff" style="FONT-SIZE:16px;" class="bodytext31" align="right" >	Interm Amount</td>
	<td  bgcolor="#ffffff" style="FONT-SIZE:16px;" class="bodytext31" align="right" >	Available Amount</td>
	</tr>
	<tr>
	<td  bgcolor="" style="FONT-SIZE:16px;" class="bodytext3" align="right" >	<strong><?php echo number_format($visitlimit,2,'.',',');?></strong></td>
	<td  bgcolor="" style="FONT-SIZE:16px;" class="bodytext3" align="right" >	<strong><?php echo number_format($overalltotal,2,'.',','); ?></strong></td>
	<td  bgcolor="" style="FONT-SIZE:16px;" class="bodytext3" align="right" >	<strong><?php echo number_format($visitlimit-$overalltotal,2,'.',',');?></strong></td>
	</tr>
	</tbody>
	</table>
	</td>

...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="594" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Radiology Return</strong></td>
			...
			$query1 = "SELECT billdate, billnumber, patientvisitcode, patientname, radiologyitemrate from refund_paynowradiology where billdate between '$ADate1' and '$ADate2'
			union all SELECT billdate, billnumber, patientvisitcode, patientname, radiologyitemrate from refund_paylaterradiology where billdate between '$ADate1' and '$ADate2'
			union all select entrydate as billdate, billno as billnumber, visitcode as patientvisitcode, patientname, radiologyfxamount as radiologyitemrate from billing_patientweivers where entrydate between '$ADate1' and '$ADate2'
			";
			...
			$res1consultationamount = $res1['radiologyitemrate'];
...
-->		
           ...
           <tr>
			...
			<a href="viewoprevenuereportdetailsradiologyreturnxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>

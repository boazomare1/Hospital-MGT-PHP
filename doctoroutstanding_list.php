...
<head>
    ...
    <title>Doctor Outstanding List Report - MedStar Hospital Management</title>
...
<body>
    ...
    <nav class="nav-breadcrumb">
        ...
        <span>Reports</span>
        <span>→</span>
        <span>Doctor Outstanding List</span>
    </nav>
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item active">
                        <a href="doctoroutstanding_list.php" class="nav-link">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2>Doctor Outstanding List Report</h2>
                    <p>Generate comprehensive reports on doctor outstanding amounts with detailed transaction tracking and aging analysis.</p>
                </div>
            ...
            <!-- Search Form -->
            <form name="cbform1" method="post" action="doctoroutstanding_list.php" class="form-section">
                <div class="form-section-header">
                    <i class="fas fa-search form-section-icon"></i>
                    <h3 class="form-section-title">Search Criteria</h3>
                    <span class="form-section-subtitle">Enter search parameters to generate the doctor outstanding list report</span>
                </div>
            ...
            <div class="data-table-section">
                <div class="data-table-header">
                    <h3 class="data-table-title">Doctor Outstanding List Report Results</h3>
                </div>
                    ...
                    <table class="data-table">
                        <thead class="table-header">
                            <tr>
                                ...
                                <th class="table-header-cell text-right">Invoice Share Amt</th>
                                <th class="table-header-cell text-right">Balance Amt</th>
                            </tr>
                        </thead>
                        <tbody>

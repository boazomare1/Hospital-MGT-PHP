        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext31"><script language="javascript">
			...
			$colorloopcount = '';
			$sno = '';
			$query31=mysqli_query($GLOBALS["___mysqli_ston"], "select * from master_visitentry where doctorconsultation='completed' and billtype='PAY NOW' and overallpayment='' order by consultationdate desc") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			$query33=mysqli_query($GLOBALS["___mysqli_ston"], "select * from master_doctor where auto_number='$consultingdoctor'") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			$query32=mysqli_query($GLOBALS["___mysqli_ston"], "select * from master_consultation where patientvisitcode='$patientvisitcode'");

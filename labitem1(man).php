...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
                  ...
                  <table width="900" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#ecf0f5"><input name="itemname" type="text" id="itemname" style="border: 1px solid #001E6A" onChange="return spl()" value="<?php echo $itemname; ?>" size="45"></td>
				    ...
				    <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#ecf0f5"><textarea name="referencevalue" cols="35" id="referencevalue" style="border: 1px solid #001E6A"><?php echo $referencevalue; ?></textarea>
 ...
 <tr>
      ...
      <tr>
	   <td width="9%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">&nbsp;</td>
        <td width="10px" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3" ><input type="checkbox" name="lcheck<?php echo $incr;?>" id="lcheck<?php echo $incr;?>" style="float:left" value="<?php echo $incr;?>"><input type="hidden" name="checklocval" value=<?php echo $locationcode;?>"">
                ...
                <table width="1300" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
						...
						<td colspan="6" bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32">

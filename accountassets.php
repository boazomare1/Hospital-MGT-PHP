        ...
        <td valign="top"><table width="701" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <?php
				...
				{  
					...
					$i=0;
					$querydr1 = "SELECT SUM(`totalfxamount`) as assetvalue FROM `assets_register` WHERE `assetledgercode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'
					...
					<td align="right" class="bodytext3"><strong><?php echo number_format($accountasset,2,'.',','); ?></strong></td>
					</tr>

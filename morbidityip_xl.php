...
header('Content-Disposition: attachment;filename="morbidityip_xl.xls"');
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
                ...
                <td colspan="4" valign="center"  align="center" bgcolor="#ffffff"><strong><?= strtoupper($res1location); ?></strong></td>
                 ...
                 <tr>
                <td colspan="2" valign="center"  align="left" bgcolor="#ffffff" class="bodytext31">Diagnosis [Morbidity]:IP</td>

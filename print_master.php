...
<a href="emr2.php?patientcode=<?php echo $patientcode?>&&visitcode=<?php echo $visitcode?>"><?php echo $patientcode; ?></a>
     ...
     <tr>
      ...
      <td colspan="6" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext365"><strong>Location : <?php echo $locationname; ?></strong></td>
      <input type="hidden" name="locationcodeget" value="<?php echo $locationcode;?>">
       <input type="hidden" name="locationnameget" value="<?php echo $locationname;?>">
                ...
                bgcolor="#ffffff"><div align="left"><strong>Date</strong></div></td>
				   		    <td width="10%" class="bodytext366" valign="center"  align="left" 
	  ...
	  { 
	   ...
	   $equipmentname=$res31['equipmentname'];
	   ...
	   $labitemcode = $res31['itemcode'];
		...
		if($type == 'IP')
		 $query79="SELECT recorddate from ipsamplecollection_lab where patientcode='$patientcode' and patientvisitcode='$visitcode' and sampleid='$sampleid'";
		else
	   ...
	   $colorloopcount = $colorloopcount + 1;
		...
		?>		  
			  ...
			  <td class="bodytext31" valign="center"  align="center"><div align="center"><?php echo $equipmentname; ?></div></td>	
			...
			<td colspan="9"  align="left" valign="center" class="bodytext31">
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            align="left" border="0">
              <tbody>
			   ...
			   $query52="select * from master_labreference where itemcode='$labitemcode' and (gender = '$patientgender' or gender='' or gender='ALL') and '$birth_days' >= agefrom and '$birth_days' < ageto and status <> 'deleted' group by referencename"; 

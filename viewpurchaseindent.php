...
if(isset($_POST['docno'])){$docno = $_POST['docno'];}else{$docno='';}
	...
	$query1 = "select * from purchase_indent where approvalstatus='' and initial_approval='1' and is_edited<>'1' and (date between '$fromdate' and '$todate') and docno like '%$docno%' group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
	...
	$query2 = "select * from purchase_indent where approvalstatus='rejected1' and initial_approval='1' and (date between '$fromdate' and '$todate') and docno like '%$docno%' group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860">
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>Branch Indent Approval</strong></td>
  ...
  <tr>    
    ...
    <td valign="top" width="99%"><table width="61%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
          ...
          <tr>
            ...
            <tr>
              ...
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext31">
                ...
                <div align="left" style="width:70%; float:left"><strong>Branch Indent Approval</strong></div><div align="right" style="width:20%; float:left;"><strong><<<?php echo $resnw3;?>>></strong>
		...
		$dptqry = "select distinct departmentname from master_employee where username in (select username from purchase_indent where approvalstatus = '' and initial_approval='1') and departmentname like '$searchdpt'";
...

	{
		...
		$dptqry1 = "select distinct departmentunit from master_employee as a join master_employeeinfo as b on (a.employeecode = b.employeecode) where a.username in (select username from purchase_indent where approvalstatus = '' and initial_approval='1') and a.departmentname = '$dpt'";
	...
	$query1 = "select * from purchase_indent where approvalstatus='' and initial_approval='1'  and (date between '$fromdate' and '$todate') and docno like '%$docno%' and username in (select a.username from master_employee as a join master_employeeinfo as b on (a.employeecode = b.employeecode) where a.departmentname like '$dpt' and b.departmentunit like '$dpt1') group by docno";
		...
		// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    ...
			    <div align="left"><a href="purchaseindentapproval.php?docno=<?php echo $docno1; ?>&&menuid=<?php echo $menu_id; ?>"><strong> <?php if($approvalstatus=='')
	...
	$query1 = "select * from purchase_indent where approvalstatus='' and initial_approval='1'  and (date between '$fromdate' and '$todate') and docno like '%$docno%' and username in (select username from master_employee where departmentname like '$dpt') and is_deleted!='1' and is_edited<>'1' group by docno";
		...
		$dptqry = "select distinct departmentname from master_employee where username in (select fausername from purchase_indent where approvalstatus = 'rejected1' and initial_approval!='') and departmentname like '$searchdpt'";
...

	{
		...
		$dptqry1 = "select distinct departmentunit from master_employee as a join master_employeeinfo as b on (a.employeecode = b.employeecode) where a.username in (select fausername from purchase_indent where approvalstatus = 'rejected1' and initial_approval!='') and a.departmentname = '$dpt'";
	...
	$dpt1 = $resdpt1['departmentunit'];
			...
			$query1 = "select * from purchase_indent where approvalstatus='rejected1' and initial_approval!='' and (date between '$fromdate' and '$todate') and docno like '%$docno%' and fausername in (select a.username from master_employee as a join master_employeeinfo as b on (a.employeecode = b.employeecode) where a.departmentname like '$dpt' and b.departmentunit like '$dpt1') group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...

	{
			...
			$query1 = "select * from purchase_indent where approvalstatus='rejected1' and initial_approval!='' and (date between '$fromdate' and '$todate') and docno like '%$docno%' and fausername in (select username from master_employee where departmentname like '$dpt') group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//

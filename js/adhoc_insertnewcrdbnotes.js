...

{
	...
	text11.onclick = function() { return btnDeleteClick4(n,varamount.replace(/[^0-9\.]+/g,"")); }
	// text11.onclick = function() { return btnDeleteClick4(n,varamount.replace(/[^0-9\.]+/g,"")); }
	...
	totalamount=parseFloat(totalamount.replace(/[^0-9\.]+/g,"")) + parseFloat(varamount.replace(/[^0-9\.]+/g,""));
	...
	var varamount12 = document.getElementById("amount").value = '';

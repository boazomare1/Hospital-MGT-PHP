...
header('Content-Disposition: attachment;filename="IP Unrealized Report.xls"');
header('Cache-Control: max-age=80');  
//$frmflag2 = $_POST['frmflag2'];
if($locationcode1==''){
$locationwise="and locationcode like '%%'";
} else{
$locationwise="and locationcode = '$locationcode1'";
}
?>
<style type="text/css">
<!--
...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse; margin-top:50px;"   cellspacing="0" cellpadding="4" width="800" align="left" border="1">
          <tbody>		 
                <tr>
                	<td colspan="20" valign="center"  align="center" bgcolor="#ffffff"><strong>IP Unrealized Report</strong></td>
				</tr>
                 <tr>
                	<td colspan="20" valign="center"  align="center" bgcolor="#ffffff">&nbsp;</td>
				</tr>
                <tr bgcolor="#ffffff">
				<td width="36" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><div align="center"><strong>S.No. </strong></div></td>
				<td width="134" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><div align="center"><strong>Patient</strong></div></td>
				<td width="69" class="bodytext31" valign="center"  align="left" bgcolor="#ffffff"><div align="center"><strong>Reg No. </strong></div></td>
				<td width="73"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="center">IP&nbsp;No</div></td>
				<td width="200"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="center">Account Name</div></td>
				<td width="65"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">Adm Fee </div></td>
				<td width="76"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">IP&nbsp;Package</div></td>
				<td width="65"  align="left" valign="center"  bgcolor="#ffffff" class="style2"><div align="right">Bed</div></td>
				<td width="65"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">Nursing</div></td>
				<td width="65"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">RMO</div></td>
				<td width="65"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">Lab</div></td>
				<td width="65"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">Rad</div></td>
				<td width="65"  align="left" valign="center"  bgcolor="#ffffff" class="style2"><div align="right">Pharma</div></td>
				<td width="69"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">Services</div></td>
				<td width="82"  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Ambulance</strong></div></td>
				<td width="72"  align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Homecare</strong></div></td>
				<td width="80"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">Pvt Dr.</div></td>
				<td width="94"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">Misc&nbsp;Billing</div></td>
				<td width="64"  align="left" valign="center" bgcolor="#ffffff" class="style2"><div align="right">IP Discount</div></td>
...
$depbalance = "0.00";
		...
		if($type=='all'){
		$query41 = "select * from master_ipvisitentry where visitcode NOT IN (select visitcode from billing_ip UNION ALL select visitcode from billing_ipcreditapproved)  and $pass_location  and consultationdate between '$ADate1' and '$ADate2' and bedallocation='completed'";
		} else {
		$query41 = "select * from master_ipvisitentry where visitcode NOT IN (select visitcode from billing_ip UNION ALL select visitcode from billing_ipcreditapproved)  and $pass_location  and consultationdate between '$ADate1' and '$ADate2' and bedallocation='completed' and visitcode in (select visitcode from ip_discharge where req_status='discharge')";	
		}
		...
		while($res66 = mysqli_fetch_array($exec66))
		{
		   ...
		   $totaldiscountamountuhx = $totaldiscountamountuhx + $discountrateuhx;
	        ...
	        // $query4 = "SELECT * FROM ipprivate_doctor WHERE `patientvisitcode` NOT IN (SELECT `visitcode` FROM `billing_ip`) AND `consultationdate` BETWEEN '$ADate1' and '$ADate2' and pvt_flg = '1' ";
		...
		// }
			...
			<tr>
			  ...
			  <td class="bodytext31" valign="center"  align="left">
                ...
                <td class="bodytext31" valign="center"  align="left"><div align="right"><?php echo number_format(($totalbedallocationamountuhx+$totalbedtransferamount),2,'.',','); ?></div></td>
				...
				<td class="bodytext31" valign="center"  align="left"> <div align="right"><?php echo number_format(($totalpharm-$totalpharmreturn),2,'.',','); ?></div></td>
				<!-- <td class="bodytext31" valign="center"  align="left"> <div align="right">-<?php echo number_format($totalpharmreturn,2,'.',','); ?></div></td> -->
				  ...
				  <td class="bodytext31" valign="center"  align="left">
				   ...
				   <td class="bodytext31" valign="center"  align="left">
			         <div align="right"><?php echo number_format($totalprivatedoctorcharges,2,'.',','); ?></div></td>
          ...
          <!--ENDS-->
            ...
            <tr>
             ...
             <!-- <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
              ...
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="right"  bgcolor="#ecf0f5"><strong><?php echo number_format(($totalbedcharges+$totalbedtransfercharges),2,'.',','); ?></strong></td>
              ...
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left"  bgcolor="#ecf0f5"><div align="right"><strong><?php echo number_format(($totalpharmacysaleamount-$totalpharmacysalereturnamount),2,'.',','); ?></strong></div></td>

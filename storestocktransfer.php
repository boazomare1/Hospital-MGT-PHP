...

{
	...
	{	
		...
		/////////////////////////////////////////////// CONSUMABLE ////////////////////////////////////////////
						...
						// 			transaction_stock
						// master_stock_transfer
						// consumedstock


		$querygetrows = "SELECT * from transaction_stock where itemcode = '$itemcode' and batch_stockstatus = '1' and storecode = '$store' and locationcode = '$fromlocationcode' ORDER BY fifo_code ASC";
	...
	$('#tostorename').autocomplete({
			...
			html: true, 
				select: function(event,ui){
					...
					$.ajax({
					type : "get",
					url : "store_stocktaking_chk.php?storecode="+code+"&locationcode="+document.getElementById("location").value,
					catch : false,
					success : function(data){
						if(data==1){
							alert("Stock Take in process. Transactions are Frozen.");	
...
<script type="text/javascript" src="js/autosuggestrequestmedicine_1transfer.js"></script> <!-- For searching customer -->
...
<script type="text/javascript" src="js/insertnewitemrequestmedicine_2.js"></script>
			 ...
			 <td align="left" class="bodytext3"><strong></strong></td>
                ...
                <table width="1197" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    ...
                    <tr>
                      ...
                      <td align="left" valign="left" class="bodytext32" id="ledgernameth" bgcolor="#ecf0f5" style="display: none"><strong>Expense Ledger</strong><span id="expenseledgerhiddencolon" bgcolor="#ecf0f5" style="display: none"></span></td>
                      ...
                      <td width="52" align="left" valign="left" bgcolor="#ecf0f5" class="bodytext32"><strong>Avl.Qty</strong></td>

                      <td width="44" align="left" valign="left" bgcolor="#ecf0f5" class="bodytext32"><strong>Trn.Qty</strong></td>

                      <td align="center" valign="left" class="bodytext32" bgcolor="#ecf0f5"><strong>Cost</strong></td>

                      <td width="50" align="left" valign="left" bgcolor="#ecf0f5" class="bodytext32"><strong>Amount</strong></td>

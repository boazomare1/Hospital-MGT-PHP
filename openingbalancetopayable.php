...
$query1 = "select locationname,locationcode from login_locationdetails where username='$username' and docno='$docno5' group by locationname order by locationname";
...
else
{
	...
	values ('$docnumber', '$accountname', '$amount', '$entrydate','Opening Balance','unpaid','$subtypename','$locationcode','$locationname','$accountcode')";
	...
	transactionamount, transactiondate, transactiontime, remarks, username, ipaddress, companyname, companyanum,patientname,paymenttype,subtype,transactiontype,locationcode,locationname,accountcode) 
	values ('$docnumber', '$accountname', '$amount', '$entrydate',  
	'$entrytime', '$remarks', '$username', '$ipaddress', '$companyname', '$companyanum','Opening Balance','$paymenttypename','$subtypename','finalize','$locationcode','$locationname','$accountcode')";
      ...
      <tr>
        <td >
			  ...
			  <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                <tbody>
                  <tr bgcolor="#011E6A">
                    <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Opening Balance Account Entry - Details </strong></td>

function insertitem14()
{
	...
	{
		alert("Please Select service name From the list");
		document.getElementById("sername").focus();
		return false;
	}

	if(document.getElementById("serqty").value=="")
	{
		alert("Please enter the Quantity");
		document.getElementById("serqty").focus();
		return false;
	}
	...
	var varserqty = document.getElementById("serqty").value;
	var varseramt = document.getElementById("seramt").value;
...
//	tr.appendChild (td3);
	...
	var varserName = document.getElementById("serqty").value = "";
	...
	document.getElementById("seramt").value = "";
	document.getElementById("sername").focus();

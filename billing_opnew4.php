...
{   
	...
	$query21=mysqli_query($GLOBALS["___mysqli_ston"], "update master_visitentry set referalbill='completed' where visitcode='$visitcode'");
        ...
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
               ...
               <td bgcolor="#ecf0f5" class="bodytext3"><strong>Referal Bill No. </strong></td>
	 <td bgcolor="#ecf0f5" class="bodytext3"> <input name="billnumber" id="billnumber" value="<?php echo $billnumbercode; ?>" <?php echo $billnumbertextboxvalidation; ?> style="border: 1px solid #001E6A; text-align:right" size="9" readonly="readonly"/> </td>

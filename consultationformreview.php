...
if ($frmflag1 == 'frmflag1')
{
	...
	if(isset($_REQUEST['mcc']) && $_REQUEST['mcc']!='' && $_REQUEST['subtyp_mcc']==1)
	 ...
	 $grandtotal10=$_REQUEST["grandtotal1"];
	  $grandtotal1=(int)preg_replace('[,]','',$grandtotal10);
...
$wellnesspkg=$rescheckhc['wellnesspkg'];
	...
	//}
		...
		{
		$newquery2=mysqli_query($GLOBALS["___mysqli_ston"], "update master_visitentry set referalconsultation='completed' where visitcode='$visitcode' and 
		albill='completed'");
		}
...
'$patientcode','$billnumbercode1','$visitcode','$dateonly2','$fromdate1','$todate1','$fromreview','$toreview','$fromduty','$toduty','$work','$nodays1','$nodays2','$sicktype','$remarks','$username','completed','$timeonly','$locationnameget','$locationcodeget')";
	...
	header ("location:reviewlist.php?patientcode=$patientcode&&visitcode=$visitcode&&st=success&&sickleave=1");
	exit;
    }
...
$exec591 = mysqli_query($GLOBALS["___mysqli_ston"], $query591) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
$num591 = mysqli_num_rows($exec591);
if($num591 > 0)
{
$res591 = mysqli_fetch_array($exec591);
...
// 	var amount = document.getElementById('serviceamount').value;
// 	if(amount == 0){
...
var VarR = document.getElementById("rates").value;
var VarRate =parseFloat(VarR.replace(/[^0-9\.]+/g,""));
...
var VarR = document.getElementById("rates").value;
var VarRate =Number(VarR.replace(/[^0-9\.]+/g,""));
var ResultAmount = parseFloat(VarRate * ResultFrequency);
  document.getElementById("amount").value = formatMoney(ResultAmount);
}
}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="103%"><table   border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#ecf0f5" class="style2">Consultation</td>
				 <td bgcolor="#ecf0f5" class="style2">&nbsp;</td>
				 <td bgcolor="#ecf0f5" class="style2">&nbsp;</td>
			  <td bgcolor="#ecf0f5" class="style2">&nbsp;</td>
			 <td bgcolor="#ecf0f5" class="style2" colspan="2">Location:&nbsp;<?php echo $locationname?>
				...
				<input type="hidden" name="mcc" id="mcc" value="<?php echo $mcc;?>">
				  ...
				  &nbsp;&nbsp;<?php if($visitlimit != 0){ echo "Visit Limit"; } ?>
				<?php if($visitlimit != 0){ echo number_format($visitlimit1,2,'.',','); } ?><input type="hidden" name="visitbalance" id="visitbalance" value="<?php echo $visitlimit1; ?>">
				 </td>
				 <td colspan="2" align="center" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong><a target="_blank" href="emrresultsviewlist.php?patientcode=<?php echo $patientcode; ?>">EMR</a></strong></td>
...
-->
				...
				<td align="left" valign="middle"  bgcolor="" class="bodytext3"><span class="bodytext32 style5"><?php echo $route;?></span></td>
				 ...
				 <!--  <td align="left" valign="top"  bgcolor=""><span class="bodytext32"><strong>Murphing</strong></span></td>
				   ...
				   <td align="left" valign="top"   bgcolor=""><label class="bodytext32">
				    ...
				    <td align="left" valign="top"  bgcolor=""><span class="bodytext32"></td>
				   <td align="left" valign="top"  bgcolor="">
                       <input type='hidden' name="murphing" id="murphing" class="bodytext32">
                        </td>
                   <?php 
				   $availablelimit1=0;
				   $consultationfees=0;
	...
	while ($res3 = mysql_fetch_array($exec3))
				...
				?>
				 ...
				 <tr id="labid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
                     ...
                     <tr>
                       ...
                       <td class="bodytext3">Rate</td>
                       <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext32"><!--<button type="button" id="addlabtesta" onClick="labFunction()" title="Lab Request Form"><img src="images/addbutton.png" /></button> --> </td>
                     </tr>
					  <tr>
				 ...
				 <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ccccc" class="bodytext3"  onDblClick="return funcSerHideView()" onClick="return funcSerShowView()"><span class="bodytext32"><span class="style2">Service, Procedures and Package Billing <img src="images/plus1.gif" width="13" height="13" onDblClick="return funcSerHideView()" onClick="return funcSerShowView()"> </span></span></td>
		        </tr>
				 <tr id="serid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				    <table id="presid" width="621" border="0" cellspacing="1" cellpadding="1">
				 ...
				 <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"  onDblClick="return  funcRefferalHideView()" onClick="return funcRefferalShowView()" style="display: none;"><span class="bodytext32"><span class="style2">Referral <img src="images/plus1.gif" width="13" height="13"  onDblClick="return  funcRefferalHideView()" onClick="return funcRefferalShowView()"> </span></span></td>
		        </tr>
				 <tr id="reffid">
				    <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				    <table id="presid" width="621" border="0" cellspacing="1" cellpadding="1">
					...
					<tr style="display:none;">
					 <td align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">Department</td>
					  ...
					  ?>
						 ...
						 <tr style="display:none;">
				   <td colspan="8" align="right" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">Total</span><input type="text" id="totalr" readonly size="7"></td></tr>

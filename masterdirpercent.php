...
if ($frmflag1 == 'frmflag1')
{
	...
	$query1 = "select * from master_dirpercent where status <> 'deleted'";
	$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
	$res1 = mysqli_fetch_array($exec1);
	$res1anum = $res1['auto_number'];	
	if($res1anum == '')
	{
		$query2 = "insert into master_dirpercent(amount, type, finalamount, ipaddress, username, updatedatetime) values('$amount', '$type', '$finalamount', '$ipaddress', '$username', '$updatedatetime')";
		$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
	}
	else
	{
		$query3 = "update master_dirpercent set amount = '$amount', finalamount = '$finalamount', type = '$type' where auto_number = '$res1anum'";
...
if ($st == 'edit')
{
	$query5 = "select * from master_dirpercent where auto_number = '$anum'";
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="masterdirpercent.php" onSubmit="return addward1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Director Max Percent</strong></td>
                      </tr>
					  <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Director Max Percent - Existing List </strong></td>
                      ...
                      <?php
						...
						<a href="masterdirpercent.php?st=edit&&anum=<?php echo $auto_number; ?>" style="text-decoration:none">Edit</a>						</td>
                      </tr>
                      <?php
						}
						?>

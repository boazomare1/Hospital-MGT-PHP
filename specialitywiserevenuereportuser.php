...
if (isset($_REQUEST["location"])) { $locationcode1 = $_REQUEST["location"]; } else { $locationcode1 = ""; }
//echo $searchsuppliername;
if (isset($_REQUEST["department"])) { $departmentcode = $_REQUEST["department"]; } else { $departmentcode = ""; }
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
    <form name="cbform1" method="post" action="specialitywiserevenuereportuser.php">
    <table width="634" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Speciality wise Revenue</strong></td>
             </tr>
             <tr>
               <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Search Location</td>
                  <td colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><strong>
                    <select name="location" id="location">
                      <?php
                       $query52 = "select * from master_location";
                       ...
                       {
                         $locationcode = $res52["locationcode"];
                         $locationname = $res52["locationname"];
                       ?>
               ...
               <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Search Department</td>
                  <td colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><strong>
                    <select name="department" id="department">
                      ...
                      <?php
                       $query51 = "select * from mis_specialities where recordstatus <> 'deleted' ";
                       ...
                       while ($res51 = mysqli_fetch_array($exec51))
                         ...
                         $res51department = $res51["speciality"];
                       ?>
      ...
      <?php if (isset($_POST['Submit'])){ ?>
       <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="500" 
            align="left" border="0">
      <tbody>
        <tr>
          <td class="bodytext31" valign="center"  align="left"> 
           <!-- <a target="_blank" href="print_specialitywiserevenue.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>&&departmentcode=<?php echo $departmentcode; ?>"><img src="images/pdfdownload.jpg" width="30" height="30"></a> -->
           <a href="print_specialitywiserevenuexls.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>&&departmentcode=<?php echo $departmentcode; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a>
          </td>
        </tr>
            <tr>
            <td colspan="5" bgcolor="#ecf0f5" class="bodytext31"><span class="bodytext311"><strong>
            <?php 
          ...
          <td width="10" align="left" valign="center"  
            bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>SNo.</strong></div></td>
        ...
        while($res3 = mysqli_fetch_array($exec3)){
          ...
          $query4 = "select doctorname, employeename, doctorcode from doctor_mapping where employeecode = '$employeecode' and status <> 'deleted'";
          ...
          //OPD VOLUME
          $query21 = "SELECT count(patientvisitcode) as count FROM master_consultation WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' AND username = '$employeename'";
          ...
          array_push($speciality_array,array("speciality" => $speciality, "opdamount" => $opdamount, "ipdamount" => $ipdamount, "rowtot" => $rowtot));

        }
        }       


        $query31 = "select department from master_department where recordstatus <> 'deleted'";
        $exec31 = mysqli_query($GLOBALS["___mysqli_ston"], $query31) or die("Error in Query31".mysqli_error($GLOBALS["___mysqli_ston"]));
        while ($res31 = mysqli_fetch_array($exec31)) {
          $speciality_print = $res31['department'];
          $opdamount_print = 0;
          $ipdamount_print = 0;
          $rowtotal_print = 0;
          foreach ($speciality_array as $data) {
            if($data['speciality']==$speciality_print){
              $opdamount_print += $data['opdamount'];
              $ipdamount_print += $data['ipdamount'];
              $rowtotal_print += $data['rowtot'];             
            }
          } 
          ...
          <tr <?php echo $colorcode; ?>>
            ...
            <td class="bodytext31" valign="center" align="left"><?php echo $speciality_print; ?></td>
            <td class="bodytext31" valign="center" align="right"><?php echo number_format($opdamount_print,2); ?></td>
            <td class="bodytext31" valign="center" align="right"><?php echo number_format($ipdamount_print,2); ?></td>
            <td class="bodytext31" valign="center" align="right"><?php echo number_format($rowtotal_print,2); ?></td>
          </tr>
        ...
        <?php
         ...
         $query2 = "SELECT sum(consultation) as consultation from (SELECT sum(totalamount) as consultation FROM `billing_paylaterconsultation` WHERE `billdate` BETWEEN '$ADate1' and '$ADate2' and visitcode in (select patientvisitcode from master_consultation where recorddate BETWEEN '$ADate1' and '$ADate2' and username not in ('$used_usernames')) 
          ...
          //COUNT OPD VOLUME
          $query21 = "SELECT sum(count) as count from (SELECT count(patientvisitcode) as count FROM master_consultation WHERE recorddate BETWEEN '$ADate1' and '$ADate2' and username not in ('$used_usernames') UNION ALL SELECT count(patientvisitcode) as count FROM master_consultation WHERE recorddate BETWEEN '$ADate1' and '$ADate2' and username <> '' ) as count1";
          $exec21 = mysqli_query($GLOBALS["___mysqli_ston"], $query21) or die("Error in query21".mysqli_error($GLOBALS["___mysqli_ston"]));
          while($res21 = mysqli_fetch_array($exec21)){
              $opdvolume = $res21['count'];
              $sumopdvolume += $opdvolume;
          ...
          //COUNT ADMISSIONS
          $query23 = "SELECT sum(admission) as admission from (SELECT count(visitcode) as admission FROM `ip_bedallocation` where recorddate between '$ADate1' and '$ADate2' and visitcode in (select visitcode from master_ipvisitentry where opdoctorcode <> '') UNION ALL SELECT count(visitcode) as admission FROM `ip_bedallocation` where recorddate between '$ADate1' and '$ADate2' and visitcode in (select visitcode from master_ipvisitentry where opdoctorcode NOT IN ('$used_employeecodes')))as admission1";
          $exec23 = mysqli_query($GLOBALS["___mysqli_ston"], $query23) or die("Error in query23".mysqli_error($GLOBALS["___mysqli_ston"]));
          while($res23 = mysqli_fetch_array($exec23)){
              $admission = $res23['admission'];
              $sumadmission += $admission;
        ...
        if($sumadmission != 0 and $sumopdvolume != 0){
          $sumopipconversion = $sumadmission / $sumopdvolume;
        } else {
          $sumopipconversion = 0;
        }

			...
			default :
				...
				break;	
					...
					*/
					...
					UNION ALL SELECT SUM(`openbalanceamount`) as bankcredit FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and payablestatus ='1'

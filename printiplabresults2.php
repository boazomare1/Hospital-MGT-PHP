...
<?php 
$query341 = "select * from ipconsultation_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and resultentry = 'completed' order by auto_number";
...
$query612 = "select * from ipconsultation_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and labitemcode = '$labitemcode34' order by auto_number desc";
...
$query123 = "select * from ipsamplecollection_lab where patientcode = '$patientcode' and patientname = '$patientname' order by auto_number desc";
...
?>
	...
	<table cellspacing="0" cellpadding="1" border="0">
	 <tr>
	  ...
	  ?></td> 
	  <td width="430" align="center" class="bodytext21" style="font-size:16px">
	  <?php
	...
	<tr>
	 <td width="430" align="center" class="printbodytext22" style="font-size:15px"><strong>ISO 15189 ACCREDITED</strong></td>
	</tr>
	<tr>
	 <td width="430" align="center" class="bodytext23" style="font-size:13px">
	 <?php
   ...
   <tr>
	 <td width="430" align="center" class="bodytext24" style="font-size:13px">
	 <?php
   ...
   <tr>
	<td width="430" align="center" style="font-size:12px;"><strong><?php echo $location; ?>&nbsp;</strong></td>
   </tr>
   <tr>
  ...
  <table cellspacing="4" cellpadding="2" style="border-top:solid 1px #000000;border-bottom:solid 1px #000000;">
   ...
   <tr>
	...
	<td width="130" align="left" valign="top" class="bodytext27"><?php echo date('Y-M-d g:i:A',strtotime($billdatetime)); ?></td>
	</tr>
	<tr>
...
<table border="0" cellspacing="0" cellpadding="2">
	...
	$query616 = "select * from ipconsultation_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and labitemcode = '$labitemcode34' and consultationdate between '$fromdate' and '$todate' order by auto_number desc";

...
function suppliernamelostfocus3()
{
	...
	var varSupplierCode3 = arrSupplierName2[1];
	var varSupplierAnum3 = arrSupplierName2[2];
	if (varSupplierCode3 != undefined)
	{
		document.getElementById("accountname3").value = varSupplierName32;
		document.getElementById("accountnameid3").value = varSupplierCode3;
		document.getElementById("accountnameano3").value = varSupplierAnum3;				document.getElementById('amount3').readOnly = false;
		return false;
	}
	else
	{
		document.getElementById("accountname3").value = "";				document.getElementById('amount3').readOnly = true;
	}

...
$a_json = array();
$a_json_row = array();
 $query1 = "select id,accountname,accountssub from master_accountname where accountsmain IN ('4','5','2') and accountname like '%$process%' and recordstatus <> 'Deleted' order by accountname";

...
if(isset($_REQUEST['radtemplate'])) { $radtemplate = $_REQUEST['radtemplate']; } else { $radtemplate = "master_radiology"; }
...

{
	...
	$externalrate = $_REQUEST["externalrate"];
	...
	{  
		...
		header("location:radiologyitem1temp.php?st=1");
	...
	$discount = isset($_REQUEST['discount'])?$_REQUEST['discount']:'no';
...

	{
		...
		if($radtemplate =='NHIF_ADUAFYA'){
			...
			$qlocationcodes = "location = '$loccodeget'";

			$qlocationcodegets = "location='$loccodeget'";
			...
			$qlocationcodes = "locationcode = '$loccodeget'";

			$qlocationcodegets = "locationcode='$loccodeget'";

			$qexternalshares = "externalshare='$externalrate' , ";

			$qledger_codes = "ledger_code='$saccountid' , ";

			$qledger_names = "ledger_name='$saccountname' , ";
		...
		$query24 = "select * from $radtemplate where itemcode = '$itemcode' ";// or itemname = '$itemname'";
...

		{
			...
			$query1 = "insert into $radtemplate set exclude='$exclude',itemname='$itemname', categoryname='$categoryname', rateperunit='".$locrateget."', expiryperiod='$expiryperiod', ipaddress='$ipaddress', updatetime='$updatedatetime', description='$description', ipmarkup='$ipmarkup', pkg='$pkg', discount='$discount', locationname = '$locationname', groupid='$groupid1', itemcode='$itemcode',username='$username',referencevalue='$referencevalue' ,$qexternalshares $qledger_codes $qledger_names $qlocationcodegets";
			...
			if($res241 > 0)
			{
			$querytemp1 = "update `$templatename` set exclude='$exclude',itemname='$itemname', categoryname='$categoryname', expiryperiod='$expiryperiod', ipaddress='$ipaddress', updatetime='$updatedatetime', description='$description', ipmarkup='$ipmarkup', pkg='$pkg', discount='$discount', locationname = '$locationname', groupid='$groupid1', itemcode='$itemcode',username='$username',referencevalue='$referencevalue' ,$qexternalshares $qledger_codes $qledger_names $qlocationcodegets where itemcode = '$itemcode'";
...

{
	...
	$exec67 = mysqli_query($GLOBALS["___mysqli_ston"], $query67) or die("error in query67 ".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);
	...
	if($radtemplate =='NHIF_ADUAFYA'){
		...
		$externalshare = $res67['externalshare'];

		$saccountname=$res67['ledger_name'];

		$saccountid=$res67['ledger_code'];
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            ...
            <tr>
              ...
              <td><form name="form1" id="form1" method="post" action="edititem1radiology.php" onSubmit="return additem1process1()">
                ...
                $query18 = "select exclude from master_radiology where itemcode='$itemcode'";
                
                $exec18 = mysqli_query($GLOBALS["___mysqli_ston"], $query18) or die ("Error in Query18".mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);
                
                $res18 = mysqli_fetch_array($exec18);
                
                $excludeval = $res18["exclude"];
                ...
                ?>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#E0E0E0" class="bodytext3"><input type="checkbox" name="exclude" value="yes" <?php if($excludeval == 'yes'){ ?> checked="checked"<?php } ?>></td>
				 ...
				 <td width="13%" align="left" valign="top"  bgcolor="#E0E0E0"  class="bodytext3">Income Ledger</td>

                        <td width="33%" align="left" valign="top"  bgcolor="#E0E0E0"> 
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#E0E0E0" class="bodytext3">EXT share %</td>

                        <td align="left" valign="top"  bgcolor="#E0E0E0"><input type="text" name="externalrate" style="border: 1px solid #001E6A" value="<?php echo $externalshare; ?>"></td>
				  ...
				  <tr>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><div align="left">Is Discount </div></td>

                        <td align="left" valign="top"  bgcolor="#E0E0E0"><input type="checkbox" name="discount" id="discount" value="yes" <?php if($discount=='yes'){ echo "checked='checked'"; } ?> /></td>
                      ...
                      <tr>  <td align="left" valign="top"  bgcolor="#E0E0E0" class="bodytext3">MIS Group</td>

                        <td align="left" valign="top"  bgcolor="#E0E0E0"><select name="groupid">
	  ...
	  /* $query1 = "select locationcode,locationname,prefix,suffix from master_location where status <> 'deleted' order by locationname";
						...
						if($radtemplate =='NHIF_ADUAFYA'){
							...
							$qlocationcode = "location = '$locationcode'";

						}else{

							$qlocationcode = "locationcode = '$locationcode'";

						}

						 $incr=$incr+1;

						$query13 = "select * from $radtemplate where itemcode='$itemcode' and $qlocationcode";
      ...
      <tr>
	   ...
	   <td width="9%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">&nbsp;</td>
        ...
        <td width="10px" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3" >

 ...
 <?php $query1 = "select locationcode,locationname,prefix,suffix from master_location where status <> 'deleted' order by auto_number asc";
  ...
  <input type="text"  name="consname<?php echo $dcr;?>" id="consname<?php echo $dcr;?>" style="float:right"  style="width:120px;" placeholder="Consultation Type" value="<?php echo $cons_type; ?>"></td>
	  ...
	  <input type="hidden" name="depart_count" id="depart_count" value="<?php echo  $dcr;?>">			  
				  ...
				  <form name="form12" id="form12" method="post" action="addconsultationtype1loc.php" >
              ...
              <td width="40%" colspan="4" align="left" valign="top"  bgcolor="#FFFFFF" style="display:none"><span class="bodytext3">
			   ...
			   <td width="54%" align="left" valign="top"  bgcolor="#FFFFFF">
                ...
                <tr bgcolor="#011E6A">
                <td width="10%" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">From Location
			    ...
			    <select name="from_location" id="from_location">
                    ...
                    <?php
						...
						$query1="select locationcode,locationname from master_location where status='' ";
						...
						?>
						 ...
						 <option value="<?php echo $locationcode; ?>" <?php if($from_location!='')if($from_location==$locationcode){echo "selected";}?>><?php echo $locationname; ?></option>
               ...
               <td width="10%" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">To Location
			    ...
			    <select name="to_location" id="to_location">
                    ...
                    <?php
						...
						?>
						 ...
						 <option value="<?php echo $locationcode; ?>" <?php if($to_location!='')if($to_location==$locationcode){echo "selected";}?>><?php echo $locationname; ?></option>
                ...
                <td width="10%" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><input type="button" name="transfer_data" id="transfer_data" value="Copy" onClick="transferdata()"/></td>
                <td width="10%" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"></td>
                </tr>
...
{
alert("From and To Locations are Same");
return false;	
}
else
{
	document.getElementById("transfer_data").disabled=true;
        $.ajax({
		type: "POST",
		url: "ajax_updateconsult_location.php",
		datatype: "json",
		async: false,

...
$query34 = "update purchaseorder_details set packagequantity='$packagequantity', quantity = '$reqquantity', remarks='$remarks' where billnumber='$pono' and itemname='$itemname'";
...
var packsize=document.getElementById("packsizeapo"+i).value;
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			?>
			  <tr>
			    <td width="10%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>PO No</strong></td>
				...
				<input type="hidden" name="suppliername" id="suppliername" value="<?php echo $suppliername; ?>" style="border: 1px solid #001E6A;" size="20" autocomplete="off" readonly="readonly"/>                  </td>
                 <td width="10%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Telephone</strong></td>
			   ...
			   <td width="10%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Address</strong></td>
				...
				<input type="hidden" name="address" value="<?php echo $address; ?>"></td>
				   <td width="10%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Email</strong></td>
				...
				<tr>
			   <td width="10%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Location Code</strong></td>
            ...
            <tr>
              <td class="bodytext31" valign="center"  align="left" 
				...
				<td width="13%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Req Qty</strong></div></td>
				<td width="13%"  align="left" valign="center" 
			...
			?>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   <td class="bodytext31" valign="center"  align="left">
				...
				<td class="bodytext31" valign="center"  align="left">
			    <div align="center"><input type="text" readonly="readonly" name="packagequantity[]" id="packagequantity<?php echo $sno ;?>" size="6" value="<?php echo $totalquantity; ?>" onKeyUp="return amountcalc('<?php echo $sno ;?>');"></div></td>
				<td class="bodytext31" valign="center"  align="left"> <div align="center">
				<input type="text" name="reqquantity[]" id="reqquantity<?php echo $sno ;?>" value="<?php echo number_format($quantity,0,'',''); ?>" size="6" onKeyUp="return Apocalc('<?php echo $sno; ?>');" style="border:solid 1px #0000CC;" readonly="readonly">
				<input type="hidden" size="6" name="amount" id="amount<?php echo $sno ;?>" value="<?php echo $amount?>" class="bal" readonly="readonly"></div></td>
				<td class="bodytext31" valign="center"  align="center">
				<input type="text" name="packsizeapo[]" id="packsizeapo<?php echo $sno ;?>" size="6" value="<?php echo $packagename; ?>" readonly="readonly">
...
<!--	  
	  ...
	  <tr id="pressid">
				   ...
				   <table id="presid" width="621" border="0" cellspacing="1" cellpadding="1">
				    ...
				    <tr>
				   <td colspan="8" align="center" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">Total</span><input type="hidden" id="total" readonly size="7"></td>
			      </tr>
-->

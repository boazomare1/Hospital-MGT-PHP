...
$query1 = "select * from purchase_indent where approvalstatus='reject' and (date between '$fromdate' and '$todate') and docno like '%$docno%' and is_edited <> '1' group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860">
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>Discarded Purchase Indents Approval</strong></td>
      ...
      <tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext31">
                ...
                <!--<input onClick="javascript:printbillreport1()" name="resetbutton2" type="submit" id="resetbutton2"  style="border: 1px solid #001E6A" value="Print Report" />-->
                 ...
                 <div align="left" style="width:70%; float:left"><strong>Rejected Purchase Indents</strong></div><div align="right" style="width:20%; float:left;"><strong><<<?php echo $resnw3;?>>></strong>
			...
			$query1 = "select * from purchase_indent where approvalstatus LIKE 'reject' and (date between '$fromdate' and '$todate') and docno like '%$docno%' and is_edited <> '1'  group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
          ...
          <div align="left"><a href="purchaseindentedit.php?docno=<?php echo $docno; ?>"><strong> <?php if($approvalstatus=='')

...
$searchsuppliername='';
		  ...
		  $Querylab=mysqli_query($GLOBALS["___mysqli_ston"], "select * from master_customer where customercode='$res2patientcode'");
			...
			$querysubtype="select * from master_subtype where auto_number='$patientsubtype'";
			$querysubtype1 = mysqli_query($GLOBALS["___mysqli_ston"], $querysubtype);
			$execsubtype=mysqli_fetch_array($querysubtype1);

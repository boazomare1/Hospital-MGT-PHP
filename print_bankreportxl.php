...
-->
	...
	?>
	<table width="530" border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
	<tbody>
	<tr bgcolor="#FFFFFF">
	<td colspan="8" align="left" class="bodytext3"><strong>BANK Report</strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="8" align="left" class="bodytext3"><strong>EMPLOYER'S PIN : <?php echo $companycode; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="8" align="left" class="bodytext3"><strong>EMPLOYER'S NAME : <?php echo $companyname; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="8" align="left" class="bodytext3"><strong>MONTH OF PAY : <?php echo $searchmonthyear; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="8" align="left" class="bodytext3"><strong>&nbsp;</strong></td>
	</tr>
	<tr>
	<td width="54" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>S.No</strong></td>
    <td width="54" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>PAYROLL NO</strong></td>
	<td width="295" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>EMPLOYEE NAME</strong></td>
	...
	<td width="101" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>BRANCH NAME</strong></td>
	<td align="right" bgcolor="#FFFFFF" class="bodytext3" width="90"><strong>AMOUNT</strong></td>
	...
	?>
	<tr>
	<td colspan="6" align = "left" class="bodytext3" bgcolor="#FFFFFF"><strong><?php echo $res9bankname; ?></strong></td>
	</tr>
	<?php
	...
	?>
	<td align="left" class="bodytext3" width="70"><?php echo number_format($nettpay,0,'.',''); ?></td>
	...
	<tr>
	<td colspan="6" bgcolor="#FFFFFF" align="right" class="bodytext3"><strong>Total :</strong></td>

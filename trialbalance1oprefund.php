    ...
    <td colspan="2" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="1202" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong> Trial Balance CGS</strong></td>
              </tr>
             <tr>
		...
		{  
			...
			if($id == '01-1006-NHL-1')
			{
				...
				$querydr1in = "SELECT SUM(`amount`) as incomedr FROM `refund_paynowpharmacy` WHERE `billdate` BETWEEN '$ADate1' AND '$ADate2'
							   ...
							   UNION ALL SELECT SUM(`fxamount`) as incomedr FROM `refund_paylaterconsultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
							   UNION ALL SELECT SUM(`labitemrate`) as incomedr FROM `refund_paynowlab` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
							   UNION ALL SELECT SUM(`fxamount`) as incomedr FROM `refund_paylaterlab` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
							   UNION ALL SELECT SUM(`radiologyitemrate`) as incomedr FROM `refund_paynowradiology` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
							   UNION ALL SELECT SUM(`fxamount`) as incomedr FROM `refund_paylaterradiology` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
							   UNION ALL SELECT SUM(`referalrate`) as incomedr FROM `refund_paynowreferal` WHERE `billdate` BETWEEN '$ADate1' AND '$ADate2'
							   UNION ALL SELECT SUM(`fxamount`) as incomedr FROM `refund_paylaterreferal` WHERE `billdate` BETWEEN '$ADate1' AND '$ADate2'
							   UNION ALL SELECT SUM(`fxamount`) as incomedr FROM `refund_paylaterservices` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
							   UNION ALL SELECT SUM(`servicetotal`) as incomedr FROM `refund_paynowservices` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
							   UNION ALL SELECT SUM(`fxamount`) as incomedr FROM `ip_creditnotebrief` WHERE consultationdate BETWEEN '$ADate1' AND '$ADate2' 
							   UNION ALL SELECT SUM(-1*`fxamount`) as incomedr FROM `ip_debitnotebrief` WHERE consultationdate BETWEEN '$ADate1' AND '$ADate2'";
			...
			else if ($id == '01-01-ACR')
			{
			$i = 0;
				$drresult = array();
				$querydr1in = "SELECT SUM(-1*fxamount) as incomedr FROM `master_transactionpaylater` WHERE `billnumber` LIKE '%IPCr%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'paylatercredit' and billnumber = patientcode
								UNION ALL SELECT SUM(fxamount) as incomedr FROM `master_transactionpaylater` WHERE `billnumber` LIKE '%IPDr%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' and billnumber = patientcode";
				$execdr1 = mysqli_query($GLOBALS["___mysqli_ston"], $querydr1in) or die ("Error in querydr1in".mysqli_error($GLOBALS["___mysqli_ston"]));
				while($resdr1 = mysqli_fetch_array($execdr1))
				{
				$i = $i+1;
			...
			else
			{
				$i = 0;
				$drresult = array();
				$querydr1bnk = "SELECT SUM(fxamount) as bankcredit FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `billnumber` LIKE '%IPCr%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'paylatercredit'
								UNION ALL SELECT SUM(-1*fxamount) as bankcredit FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `billnumber` LIKE '%IPDr%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
								UNION ALL SELECT SUM(fxamount) as bankcredit FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `billnumber` LIKE 'Cr.N%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'paylatercredit'

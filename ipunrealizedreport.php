    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1447"><form name="cbform1" method="post" action="ipunrealizedreport.php">
		  ...
		  <option value="discharged" <?php if($type=='discharged'){ echo 'selected'; } ?>>Discharged</option></td>
		  </tr>
            <tr>
	  ...
	  <tr>
        <td>
	<form name="form1" id="form1" method="post" action="ipunrealizedreport.php">	
...
?>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
             <tr>
			 <td colspan="20" bgcolor="#ecf0f5" class="bodytext31" align="left" valign="middle"><strong>IP Unfinalized Bills</strong></td>
			 </tr>
			 <tr>
			 <td colspan="20" align="left"><a href="ipunrealizedreport_xl.php?ADate1=<?php echo $ADate1;?>&&ADate2=<?php echo $ADate2; ?>&&locationcode1=<?php echo $locationcode1; ?>&&type=<?php echo $type; ?>" id="downloadLink" target="_blank" ><img src="images25/excel-xls-icon.png" alt="excel export" width="50px" height="50px"/></a></td>
			 </tr>
			  <tr>

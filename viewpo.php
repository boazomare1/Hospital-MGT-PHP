...

{
...

			{
		       ...
		       $query43="insert into purchaseorder_details(billdate,billnumber,itemname,itemcode,quantity,packagequantity,rate,totalamount,username,recordstatus,companyanum,suppliername,suppliercode)values
		                 ...
		                 ('$currentdate','$pono','$medicinename','$medicinecode','$reqqty','$pkgqty','$rate','$amount','$username','generated','$companyanum','$suppliername','$suppliercode')";
...
header("location:approvedpurchaseorderlist.php");
...
/*$qry_dis = "select baserate,discount_by_percent,discountpercentage,rate from purchaseorder_details where billnumber='$pono' and recordstatus='generated' and itemstatus <> 'deleted'";
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
          ...
          <tbody>
			...
			?>
			  ...
			  <tr>
				...
				<input type="hidden" name="suppliername" id="suppliername" value="<?php echo $suppliername; ?>" style="border: 1px solid #001E6A;" size="20" autocomplete="off" readonly/>                  </td>
                 ...
                 <td width="11%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Telephone</strong></td>
			   ...
			   <td width="7%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Address</strong></td>
				...
				<input type="hidden" name="address" value="<?php echo $address; ?>"></td>
				   ...
				   <td width="11%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Email</strong></td>
				...
				<input type="hidden" name="email" id="email" value="<?php echo $email; ?>" style="border: 1px solid #001E6A;" size="20" autocomplete="off" readonly/>                  </td>
				 ...
				 <td width="11%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Valid Till</strong></td>

				  <td width="16%" align="left" valign="middle" class="bodytext3"><input type="text" name="lpodate" id="lpodate"   size="10"   value="<?php echo $lpodate; ?>" class="bal bodytext3" readonly /></td>

			

			    </tr>

			    <tr><td width="47" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><strong>Validity</strong></td>

			<td width="11%" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"> <input type="hidden" name="todaydate" id="todaydate" value="<?php echo date('Y-m-d'); ?>"><input type="text" name="validityperiod" id="validityperiod" class="bal bodytext3"  style="width:40px;">&nbsp; Days</td></tr>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Free.Qty</strong></div></td>
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Discount Amt</strong></div></td>
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Tax.Amt</strong></div></td>
		...
		$query34="select * from purchaseorder_details where billnumber='$pono' and recordstatus='generated' and itemstatus <> 'deleted' ";
		...
		$amount=number_format($amount,2,'.','');
			...
			?>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
			   ...
			   <td class="bodytext31" valign="center"  align="left">
				...
				<select name="packagename[]"  id="packagename<?php echo $sno ;?>" onChange="return calculate('<?php echo $sno ;?>');">
			    ...
			    <div align="center"><input type="text" readonly name="freeqty[]" id="freeqty<?php echo $sno ;?>" size="6" value="<?php echo $freeqty; ?>" class="bal"></div></td>



			     <td class="bodytext31" valign="center"  align="left">

			    <div align="center"><?php echo $baserate; ?></div></td>

			    <!--  <?php if($discount_by_percent){ ?>

			     <td class="bodytext31" valign="center"  align="left">

			    <div align="center"><?php $discount_percentage = preg_replace('~\.0+$~','',$discount_percentage);echo $discount_percentage; ?></div></td>

			    <?php } ?> -->



			    <td class="bodytext31" valign="center"  align="left"> <div align="center"><input type="text" size="6" name="discount[]" id="discount<?php echo $sno ;?>" value="<?php echo $discount; ?>" class="bal" readonly></div></td>
			    ...
			    <div align="center"><?php echo $tax_percentage; ?></div></td>
			       <td class="bodytext31" valign="center"  align="left">

			    <div align="center"><?php echo number_format($tax_amount,'2','.',','); ?></div></td>


				<td class="bodytext31" valign="center"  align="left"> <div align="center"><input type="text" size="6" name="totalquantity[]" id="totalquantity<?php echo $sno ;?>" value="<?php echo $totalpieces; ?>" class="bal" readonly></div></td>

				

				<td class="bodytext31" valign="center"  align="left"> <div align="center"><input type="text" size="6" name="existamount[]" id="existamount<?php echo $sno ;?>" value="<?php echo $amount; ?>" class="bal" readonly></div></td>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ecf0f5"><a href="approvedpurchaseorderlist.php"><strong>Back</strong></a></td>
...
<!--	  <tr>
	  ...
	  <tr id="pressid">
				   ...
				   <td colspan="8" align="center" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="style2">Total</span><input type="text" id="total" readonly size="7"></td>

			 ...
			 $querycumstock2 = "select cum_quantity from transaction_stock where cum_stockstatus='1' and itemcode='$itemcode' and locationcode='$locationcodeget'";
				...
				if($pharmacyquantityenter>0)
				{
					...
					if($bat_quantity>='0')
					{
					 ...
					 $queryupdate=mysqli_query($GLOBALS["___mysqli_ston"], "update ipconsultation_radiology set pkg_process='completed',remarks='$remarks' where radiologyitemname='$servicename' and patientvisitcode='$visitcode' and patientcode='$patientcode' and radiologyitemcode = '$q_itemcode' and auto_number='$refno'")or die("Error in queryupdate".mysqli_error($GLOBALS["___mysqli_ston"]));
					}
					else
					{
...
<form name="frmsales" id="frmsales" method="post" action="processipradiology.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$totalamount=0;
			 ...
			 $query61 = "select radiologyitemname,billtype,auto_number,refno from ipconsultation_radiology where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and pkg_process='pending' and auto_number='$refnumber'  and radiologyitemcode='$q_itemcode' and (billtype='PAY NOW' or (billtype='PAY LATER' ))";

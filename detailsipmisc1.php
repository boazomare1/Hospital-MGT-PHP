  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>IPMISC Details</strong></td>
              <td width="10%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
              </tr>            
        ...
        <?php
		$totalpharmacysale=0;
		$query66 = "SELECT * FROM `billing_ipmiscbilling` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2' and visitcode in(select visitcode from master_ipvisitentry where accountname ='$acc_id')";
		...
		while($res66 = mysqli_fetch_array($exec66))
		{
			...
			$totalmiscbillingamountuhx = $res66['amountuhx'];
			$totalpharmacysale+=$totalmiscbillingamountuhx;
			 $sno=$sno+1;
           ...
           <tr <?php echo $colorcode; ?>>
            ...
            <td align="right" valign="center"  class="bodytext31"><div class="bodytext31"><?php echo number_format($totalmiscbillingamountuhx,2,'.',','); ?></div></td>
           </tr>
	<?php
		}
?>		
         <tr>
              <td colspan="4"  class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong>Total IPMISC Amount</strong></td>
...
-->		<!--<tr>
			...
			<a href="detailsipmiscxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>
			</tr>-->
          </tbody>
        </table>

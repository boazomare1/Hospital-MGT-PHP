...
<head>
    ...
    <title>Active Inpatient List Medicine - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/activeinpatientlistmedicine-modern.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <nav class="nav-breadcrumb">
        ...
        <span>→</span>
        <span>Active Inpatient List Medicine</span>
    </nav>
        ...
        <aside id="leftSidebar" class="left-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="activeinpatientlistmedicine.php" class="nav-link active">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2><i class="fas fa-bed"></i> Active Inpatient List Medicine</h2>
                    <p>View and manage active inpatients and their medication needs</p>
                </div>
                <div class="page-header-actions">
                    <button class="btn btn-primary" onclick="generatePatientReport()">
            ...
            <div class="search-form-container">
                <form name="cbform1" method="post" action="activeinpatientlistmedicine.php" class="search-form">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="searchpatient" id="searchpatient" value="<?php echo $searchpatient; ?>" class="form-control" placeholder="Search by patient name">
                        </div>
            ...
            <div class="patient-cards">
                <div class="patient-card">
                    <h4><i class="fas fa-bed"></i> Active Patients</h4>
                    <p>Currently admitted patients requiring medical care</p>
                </div>
                
                <div class="patient-card">
                    <h4><i class="fas fa-pills"></i> Medication Required</h4>
                    <p>Patients requiring medication administration</p>
                </div>
                
                <div class="patient-card">
                    <h4><i class="fas fa-clock"></i> Pending Discharge</h4>
                    <p>Patients ready for discharge planning</p>
                </div>
                
                <div class="patient-card">
                    <h4><i class="fas fa-exclamation-triangle"></i> Critical Care</h4>
                    <p>Patients requiring intensive medical attention</p>
                </div>
            </div>
            ...
            <div class="data-table-section">
                <div class="data-table-header">
                    <h3><i class="fas fa-table"></i> Active Inpatients</h3>
                </div>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="6" style="text-align: center; padding: 2rem;">
                                    ...
                                    <p>Search for active inpatients using the form above</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <!-- Modern JavaScript -->
    <script src="js/activeinpatientlistmedicine-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

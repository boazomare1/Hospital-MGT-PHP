							...
							//if($startyear == $endyear ){
									if($section == 'I'){
										...
										while($res_opening = mysqli_fetch_array($exec_opening)){
											...
											$query03 = "SELECT id,accountsmain FROM master_accountssub WHERE auto_number = '$accountssub' ";
											...
											$groupcode = $res03['id'];	
											$accountsmain = $res03['accountsmain'];
											
                                                 echo '<br>';   
												if($accountsmainauto == $accountsmain){
													echo 'EAL'.$GLOBALS['eal'];
													echo '<br>';
													echo 'REVENUE'.$GLOBALS['revenue'];
													echo '<br>';
													echo $opening_dr_cr = $opening_dr_cr + $GLOBALS['eal']+$GLOBALS['revenue'];
                                                      echo '<br>';
												}
                                                else{
                                                     $opening_dr_cr = $opening_dr_cr ;

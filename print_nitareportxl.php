...
header('Content-Disposition: attachment;filename="Nitareport.xls"');
...
<?php //include("a4pdfheader1.php"); ?>	
	...
	<tbody>
	<tr bgcolor="#FFFFFF">
	<td colspan="6" align="left" class="bodytext3"><strong>MONTHLY PAYROLL RETURN TO NITA</strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="7" align="left" class="bodytext3"><strong>EMPLOYER'S PIN CODE : <?php echo $helbnumber; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="6" align="left" class="bodytext3"><strong>EMPLOYER'S NAME : <?php echo $employername; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">

...
header('Content-Disposition: attachment;filename="report_specialitywiserevenue.xls"');
...
<table cellspacing="3" cellpadding="0" align="left" border="0" style="border-collapse:collapse;" width="100%">
	...
	<tr>
		<td class="bodytext31"  valign="middle" colspan="5" align="left" ><strong><?php echo strtoupper($res1locationname); ?></strong></td>
	</tr>
	<tr>
		<td class="bodytext31"  valign="middle" colspan="5"  align="left" ><strong>Specialitywise Revenue Report From <?php echo date("d/m/Y", strtotime($ADate1)); ?> to <?php echo date("d/m/Y", strtotime($ADate2)); ?> printed on <?php echo $currentdate; ?></strong></td>  
	</tr>
	<tr>
		<td colspan="5"><br></td>
	</tr>
    ...
    <tbody>
        <tr>
          <td width="10" align="left" valign="center"  
            bgcolor="#ecf0f5" class="bodytext31"><div align="center"><strong>SNo.</strong></div></td>
          <td width="100" align="left" valign="center"  
            bgcolor="#ecf0f5" class="bodytext31"><div align="left"><strong>SPECIALITY</strong></div></td>
          <td width="100" align="right" valign="center"  
            bgcolor="#ecf0f5" class="bodytext31"><div align="right"><strong>OPD</strong></div></td>
          <td width="100" align="right" valign="center"  
            bgcolor="#ecf0f5" class="bodytext31"><div align="right"><strong>IPD</strong></div></td>
          <td width="100" align="right" valign="center"  

...
{ 
	...
	for (m=0;m<=varNewLineLength;m++)
	{
		...
		//hide service search
		//document.getElementById("presid").style.display = "";
		//document.getElementById("services").disabled = false;
		//document.getElementById("serviceqty").disabled = false;
		...
		document.getElementById("subtypeano").value = varCustomerSubType;

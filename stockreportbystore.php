...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
		<form name="stockinward" action="stockreportbystore.php" method="post" onKeyDown="return disableEnterKey()" onSubmit="return Locationcheck()">
            ...
            <tr <?php echo $colorcode; ?>>
			  ...
			  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">
			   ...
			   if($store != ''){
				...
				if($currentstock > 0)
				{
					$tddate = number_format($currentstock);
				}
				else
				{
					$tddate = '';

...
<?php include("a4pdfpayrollheader1.php"); ?>	
	...
	?>	
	<table width="518" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
	<tbody>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
		<td colspan="6" align="left" class="bodytext3"><strong>EMPLOYER'S PIN NUMBER : <?php echo $pinnumber; ?></strong></td>
	</tr>
	<tr>
	<td width="37" align="center" bgcolor="#FFFFFF" class="bodytext3"><strong>S.No</strong></td>
	<td width="80" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>PAYROLL NO</strong></td>
    <td width="167" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>EMPLOYEE NAME</strong></td>
	<td width="46" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>ID NO</strong></td>
	<td width="56" align="left" bgcolor="#FFFFFF" class="bodytext3"><strong>PIN NO</strong></td>
	<td align="right" bgcolor="#FFFFFF" class="bodytext3" width="70"><strong>AMOUNT</strong></td>
	</tr>
	<?php 
	$totalamount = '0.00';
	...
	<?php 
	$query1 = "select * from master_payrollcomponent where recordstatus <> 'deleted' and auto_number = '4' order by typecode, auto_number";
	...
	$totalamount = $totalamount + $componentamount;
	 ?>
	<td align="right" class="bodytext3" width="70"><?php echo number_format($componentamount,3,'.',','); ?></td>
	<?php 
	} echo '</tr>';
	}
	}
	...
	<td bgcolor="#FFFFFF" align="right" class="bodytext3"><strong><?php echo number_format($totalamount,3,'.',','); ?></strong></td>
	<td align="left" bgcolor="#FFFFFF" class="bodytext3" width="70">&nbsp;</td>
	</tr>
	</tbody>
	</table> 
	<?php
...
require_once('html2pdf/html2pdf.class.php');
...

    {
        ...
        $html2pdf->Output('PayeReport.pdf');

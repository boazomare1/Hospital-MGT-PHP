...
AutoSuggestControlmed.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	var url="ajaxmedicine1build_addpkgmedicine.php?searchmedicinename1="+searchmedicinename1+"&&visitcode="+visitcode+"&&packageid="+packageid+"&&RandomKey="+Math.random()+"";
...
AutoSuggestControlmed.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			document.getElementById("hiddenmedicinename").value = varSupplierName1;
...

{
...

	{
		...
		document.getElementById("hiddenmedicinename").value = varmedicineName;
...

	{
		...
		document.getElementById("hiddenmedicinename").value = "";

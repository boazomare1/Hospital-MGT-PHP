      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
			...
			$sno = '';
			$totalamount=0;			
$query61 = "select * from consultation_radiology where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and resultentry='pending' and prepstatus='completed' and paymentstatus='completed' and imgaquistatus='Pending' and radiologyitemcode='$q_itemcode' and refno='$q_refno' and (billtype='PAY NOW' or (billtype='PAY LATER' ))";
...
if($billtype=='PAY LATER'  and ($approvalstatus=='0')){
	continue;
}

  ...
  <tr>
    ...
    <table width="97%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <!-- <table width="761" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1"> -->
        ...
        <form method="post" >
         <tr bgcolor="#011E6A">
                        <td height="27" colspan="6" bgcolor="#ecf0f5" class="bodytext31"><strong>Petty Cash Management-Final Approve-List </strong></td>
                </tr>
             			<!-- <tr>
                 <td width="94" height="25" bgcolor="" class="bodytext31">&nbsp;</td>
                </tr> -->
                	      <tr bgcolor="#FFFFFF">
       ...
       <tr bgcolor="#FFFFFF">
                  <td width="108" align="left" valign="middle"   class="bodytext31">Start Date</td>
                       <td width="152" align="left" valign="center"  class="bodytext311"><input name="ADate1" id="ADate1" value="<?php echo date('Y-m-d'); ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
			<img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate1')" style="cursor:pointer"/>			</td>
            <td width="132" align="left" valign="middle"  class="bodytext31">End Date</td>
                       <td width="213" align="left" valign="center"  class="bodytext311"><input name="ADate2" id="ADate2" value="<?php echo date('Y-m-d'); ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
			<img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate2')" style="cursor:pointer"/>			</td>
            
                       
                        
                         <td width="66" align="left" valign="top"  ><input type="hidden" name="frmflag" value="addnew" />
...
if (isset($_REQUEST["request"])) { $request= $_REQUEST["request"]; } else { $request = ""; }
	    ...
	    $sno=0;
	    $querry=" select  * from pcrequest where doc_no like '%$request%' and username like '%$user%' and currentdate between '$startdate' and '$enddate' and delete_status <>'deleted'  and approved_status ='3' and final_status='pending' ORDER BY `pcrequest`.`doc_no` ASC ";
	$exe=mysqli_query($GLOBALS["___mysqli_ston"], $querry);
		...
		<table border="0" >
			<tr>
				...
				<td width="70" bgcolor="#ecf0f5" class="bodytext31"><strong>Request.No.</strong></td>
				<td width="80" bgcolor="#ecf0f5" class="bodytext31"><strong>Date</strong></td>
				<td width="144" bgcolor="#ecf0f5" class="bodytext31"><strong>Reqested Amount</strong></td>
				<td width="144" bgcolor="#ecf0f5" class="bodytext31"><strong>Approve Amount</strong></td>
				<td width="128" bgcolor="#ecf0f5" class="bodytext31"><strong>Remarks</strong></td>
				<td width="144" bgcolor="#ecf0f5" class="bodytext31"><strong>Requested By</strong></td>
				<td width="144" bgcolor="#ecf0f5" class="bodytext31"><strong>Approve By</strong></td>
       ...
       <tr <?php echo $colorcode; ?>>
           ...
           <td align="left" valign="top" class="bodytext31"><?php echo $sno; ?> </td>
             <td align="left" valign="top" class="bodytext31"><input type="hidden" name="doc" id="doc"value="<?php echo $doc_no; ?>"><?php echo $doc_no; ?> </td>
              <td align="left" valign="top" class="bodytext31"><?php echo $date; ?> </td>
               <td align="left" valign="top" class="bodytext31"><input type="hidden" name="amount" id="amount" value="<?php echo number_format($amount); ?>"><?php echo number_format($amount); ?> </td>
                <td align="left" valign="top" class="bodytext31"><input type="hidden" name="aamount" id="aamount" value="<?php echo number_format($approved_amt); ?>"><?php echo number_format($approved_amt); ?> </td>
                <td align="left" valign="top" class="bodytext31"><?php echo $remarks; ?> </td>
                 <td align="left" valign="top" class="bodytext31"><?php echo ucwords($requestedby_user); ?> </td>
				 <td align="left" valign="top" class="bodytext31"><?php echo ucwords($second_approvel_user); ?> </td>
                  <td align="left" valign="top" class="bodytext31"><a href="pettycashallocation.php?docno=<?php echo $doc_no; ?>">DISBURSE</a> </td> 

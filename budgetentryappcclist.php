...
<form name="budget" id="budget" method="post" action="budgetentryapplist.php">
    ...
    <td width="99%" valign="top"><table width="1214" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
       ...
       <td width="6%">&nbsp;</td><td width="94%"><table width="70%" border="0" align="left" cellpadding="4" cellspacing="4" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
		  ...
		  <td width="8%" align="left" class="bodytext3"><strong>Doc No</strong></td>

		  <td width="23%" align="left" class="bodytext3"><strong>Budget Name</strong></td>

		  <td width="11%" align="left" class="bodytext3"><strong>Budget Year</strong></td>

		<!--   <td width="12%" align="left" class="bodytext3"><strong>Budget Type</strong></td> -->

		  <td width="12%" align="left" class="bodytext3"><strong>Initiated Date</strong></td>

		  <td width="11%" align="left" class="bodytext3"><strong>Initiated By</strong></td>

		   <td width="12%" align="left" class="bodytext3"><strong>Approved By</strong></td>

		  <td width="6%" align="left" class="bodytext3"><strong>View</strong></td>
		 ...
		 <!--  <td align="left" class="bodytext3"><?php echo $budgettype; ?></td> -->
		  ...
		  <td align="left" class="bodytext3"><?php echo strtoupper($approvedby); ?></td>

		  <td align="left" class="bodytext3"><a href="budgetccapprovedview.php?st=view&&docno=<?php echo $budgetno; ?>"><strong><?php echo 'View'; ?></strong></a></td>

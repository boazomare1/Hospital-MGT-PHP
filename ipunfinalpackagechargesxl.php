...
header('Content-Disposition: attachment;filename="package.xls"');
...
text-align:right;
        ...
        <?php
			...
			$query14 = "select * from master_ipvisitentry where visitcode not in (select visitcode from `billing_ip`) and consultationdate between '$ADate1' and '$ADate2' and package <> 0"; 

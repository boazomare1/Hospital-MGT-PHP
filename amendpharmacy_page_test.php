        ...
        if ($pharmtotalno != 0) {
            ...
            if ($billingtype != 'PAY NOW') {
                ...
                if ($pharamapprovalstatus == '') {
                    ...
                    $query34 = "update master_consultationpharm set days='$adays',dose='$adose',dosemeasure='$adosemeasure',quantity='$aquantity',route='$aroute',amount='$aamount',frequencyauto_number='$frequencyautonumber',frequencycode='$frequencycode',frequencynumber='$afrequency',instructions='$ainstructions',amendstatus='" . $amendstatus . "',approver_username='$username',approvalstatus='$pharamapprovalstatus', paymentstatus='pending',pharmacybill='pending' where patientcode='$patientcode' and patientvisitcode='$visitcode' and medicinecode='$aitemcode' and consultation_id='$consid1' and auto_number='$autonum'"; //and amendstatus <> '2'
                    ...
                    $query34 = "update master_consultationpharm set days='$adays',dose='$adose',dosemeasure='$adosemeasure',quantity='$aquantity',route='$aroute',amount='$aamount',frequencyauto_number='$frequencyautonumber',frequencycode='$frequencycode',frequencynumber='$afrequency',instructions='$ainstructions',amendstatus='" . $amendstatus . "',paymentstatus='$status',pharmacybill='$status',approver_username='$username' where patientcode='$patientcode' and patientvisitcode='$visitcode' and medicinecode='$aitemcode' and consultation_id='$consid1' and auto_number='$autonum'"; //and amendstatus <> '2'
                    $exec34 = mysqli_query($GLOBALS["___mysqli_ston"], $query34) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
//echo "<br>";
                    $query35 = "update master_consultationpharmissue set days='$adays',dose='$adose',dosemeasure='$adosemeasure',prescribed_quantity='$aquantity',quantity='$aquantity',route='$aroute',amount='$aamount',frequencyauto_number='$frequencyautonumber',frequencycode='$frequencycode',frequencynumber='$afrequency',instructions='$ainstructions',amendstatus='" . $amendstatus . "',paymentstatus='$status' where patientcode='$patientcode' and patientvisitcode='$visitcode' and medicinecode='$aitemcode' and consultation_id='$consid1' and auto_number='$autonum'"; //and amendstatus <> '2'
                    $exec35 = mysqli_query($GLOBALS["___mysqli_ston"], $query35) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
if (isset($_REQUEST['delete'])) {
    ...
    $data = mysqli_query($GLOBALS["___mysqli_ston"], "select auto_number,patientcode,patientvisitcode,patientname,refno,medicinecode,medicinename,quantity,rate,amount from master_consultationpharm where auto_number='$medicinename' and patientvisitcode='$viscode'");
...
if ($billtype == 'PAY LATER') {
    ...
    $query67 = "select sum(amount) as serviceamt from consultation_services where patientcode='$patientcode' and patientvisitcode='$visitcode' ";
    ...
    $query67 = "select sum(labitemrate) as labamt from consultation_lab where patientcode='$patientcode' and patientvisitcode='$visitcode'  and labrefund<>'refund'";
    $exec67 = mysqli_query($GLOBALS["___mysqli_ston"], $query67) or die(mysqli_error($GLOBALS["___mysqli_ston"]) . __LINE__);
    $num67 = mysqli_fetch_array($exec67);
    $labamt = $num67['labamt'];

    $query67 = "select sum(radiologyitemrate) as radamt from consultation_radiology where patientcode='$patientcode' and patientvisitcode='$visitcode' ";
    $exec67 = mysqli_query($GLOBALS["___mysqli_ston"], $query67) or die(mysqli_error($GLOBALS["___mysqli_ston"]) . __LINE__);
    $num67 = mysqli_fetch_array($exec67);
    $radamt = $num67['radamt'];
    $totalserivces = $consultationfees + $serviceamt + $labamt + $radamt;
                    ...
                    <tr>
                        <td>
                            <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse"
                                ...
                                if ($billtype == 'PAY NOW') {
                                    $status = 'pending';
                                    $query17 = "select * from master_consultationpharm where patientvisitcode='$visitcode' and patientcode='$patientcode' and pharmacybill='$status' and medicineissue='pending' and amendstatus='$selectpending'";
                                } else {
                                    $status = 'completed';
                                    $query17 = "select * from master_consultationpharm where patientvisitcode='$visitcode' and patientcode='$patientcode' and medicineissue='pending' and amendstatus='$selectpending'";
                                }
                                    ...
                                    <tr <?php echo $colorcode; ?>>
                                        ...
                                        <td class="bodytext31" valign="center" align="left">
                                            <div align="center"><?php $sno = $sno + 1; ?>
                                                <input id="pharamcheck<?php echo $sno; ?>"
                                                       name="pharamcheck[<?php echo $sno; ?>]" type="checkbox"
                                                       align="left" size="10" value="<?php echo $sno; ?>" readonly
                                        ...
                                        <td class="bodytext31" valign="center" align="left">
                                            <div align="center">
                                                <input type="text" name="adose[<?php echo $sno; ?>]"
                                                       id="adose<?php echo $sno; ?>"
                                                       onKeyUp="return Functionfrequency('<?php echo $sno; ?>')"
                                                       value="<?php echo $pharmdose; ?>" size="8"
                    ...
                    <?php
					  ...
					  <option value="suppositories">suppositories</option>
					   ...
					   <option value="pcs">pcs</option>
                                        ...
                                        <td class="bodytext31" valign="center" align="left">
                                            <div align="center"><input type="text" name="adays[<?php echo $sno; ?>]"
                                                                       id="adays<?php echo $sno; ?>"
                                                                       onKeyUp="return Functionfrequency('<?php echo $sno; ?>')"
                                                                       value="<?php echo $pharmdays; ?>" size="8"
                                                                       style="text-align:center;"></div>
                                        </td>
                                        <td class="bodytext31" valign="center" align="left">
                                        ...
                                        <td class="bodytext31" valign="center" align="left">
                                            <div align="center">
                                                ...
                                                <input type="checkbox" name="pharamlatertonow[<?php echo $sno; ?>]"
                                                       id="pharamlatertonow<?php echo $sno; ?>"
                                                       value="<?php echo $sno; ?>" disabled>

...
if(isset($_REQUEST['month'])){ $from_month = $_REQUEST['month']; } else { $from_month = date('n'); }
...
function _getAdmissions($ADate1, $ADate2){
  // $count=0;
...
function _getRebate($ADate1, $ADate2){
...
function _getOPDiscount($ADate1, $ADate2){
  ...
  <tbody>
    ...
    <?php
      ...
      for($i = 0; $i < $from_month; $i++){
        ...
        $start_month = date('Y-m-d', strtotime('first day of'.$from_year.'-'.$month));
        $end_month = date('Y-m-d', strtotime('last day of'.$from_year.'-'.$month));
        $admissioncount = _getAdmissions($start_month, $end_month);
    ...
    <?php
      ...
      for($i = 0; $i < $from_month; $i++){
        ...
        $end_month = date('Y-m-d', strtotime('last day of'.$from_year.'-'.$month));
        $inpatientincome = getTotalInpatientIncome($start_month, $end_month);
        $admission = _getAdmissions($start_month, $end_month);
...
$filename ='monthlycumulative-'.$dtime.'.xls';
$path=$mis_path;
if ( !file_exists($path) ) {
	 mkdir ($path, 0755);
 }

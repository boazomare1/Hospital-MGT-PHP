...
if ($cbfrmflag1 == 'cbfrmflag1')
{
	...
	$qryreset = "delete from package_items  where package_id = '$packageid'";
    mysqli_query($GLOBALS["___mysqli_ston"], $qryreset);
		...
		$consultation_amt = trim($_POST['consultationamt']);
...
function isNumber(evt, element) {
	...
	function calAmount()
{
var qty=document.getElementById("pharmaqty").value;	
var pharmarate=document.getElementById("pharmarate").value;
var amnt=parseFloat(qty)*parseFloat(pharmarate);
document.getElementById("pharmaamt").value=amnt;
}
</script>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
		   <tr>
              <td colspan="5" bgcolor="#CCCCCC" class="bodytext3"><strong> Package Items Linking </strong></td>
                 ...
                 <tr>
                  <td colspan="8" id="pharmacyArea" >
							   ...
							   <table id="presid3" width="500" border="0" cellspacing="1" cellpadding="1">
								 ...
								 <tr>
								  ...
								  <input type="hidden" name="medicinecode" id="medicinecode" value="">
									...
									<td style="display:none"><select name="dosemeasure" id="dosemeasure">
									...
									<input type="text" name="days" id="days" size="3" onkeyup="return Functionfrequency()" onfocus="return frequencyitem()"/></td>
									 ...
									 <td>
									<input type="text" name="pharmaqty" id="pharmaqty" size="3" onkeyup="return calAmount();" /></td>
						...
						<strong>Amount</strong>
								...
								<td style="display:none" id="tddose<?=$p?>" align="left" style="background-color: rgb(255, 255, 255); border: 0px solid rgb(0, 30, 106);">
										 ...
										 <td style="display:none"  id="tddosemeasure<?=$p?>" align="left" style="background-color: rgb(255, 255, 255); border: 0px solid rgb(0, 30, 106);">
										 ...
										 <td style="display:none"  id="tdfrequency<?=$p?>" align="middle" style="background-color: rgb(255, 255, 255); border: 0px solid rgb(0, 30, 106);">
										 ...
										 <td style="display:none"  id="tddays<?=$p?>" align="left" style="background-color: rgb(255, 255, 255); border: 0px solid rgb(0, 30, 106);">

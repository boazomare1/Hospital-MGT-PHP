...
<head>
    ...
    <title>Customer Statement - MedStar</title>
...

{
...

	{
		...
		alert("Please Select PatientName");
...
<body>
    ...
    <div class="main-container-with-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li class="nav-item active">
                        <a href="customerstatement.php" class="nav-link">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    ...
                    <p>Generate detailed customer account statements with transaction history and outstanding balances.</p>
                </div>
            ...
            <div class="search-form-section">
                <div class="search-form-header">
                    ...
                    <h3 class="search-form-title">Customer Statement Search</h3>
                </div>
                
                <form id="customerStatementForm" name="form1" method="post" action="customerstatement.php" class="search-form">

                    <div class="form-group">
                        <label for="customername" class="form-label">Patient Name</label>
                        <input name="customername" type="text" id="customername" class="form-input" 
                               placeholder="Enter patient name to search..." autocomplete="off">
                        <input type="hidden" name="searchcustomercode" id="searchcustomercode" value=""/>
                        <small class="form-help">Search Sequence: First Name | Middle Name | Last Name | Date of Birth | Location | Mobile Number | National ID | Registration No (*Use "|" symbol to skip sequence)</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" onClick="return funcAccount();" class="submit-btn">
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <td colspan="2" align="right" class="bodytext31" bgcolor="#ecf0f5"><strong></strong></td>

            <td colspan="1" align="right" class="bodytext31" bgcolor="#ecf0f5"><strong>Opening Balance</strong></td>

            <td colspan="4" align="right" class="bodytext31" bgcolor="#ecf0f5"><?= number_format($balanceamt,2,'.',',');?></td>
            ...
            <td colspan="7" align="left" class="bodytext31" bgcolor="#ecf0f5"><strong><?= $customername.'('.$customercode.')';?></strong></td>
...

			{
              ...
              <td width="8%" align="left" valign="center"  
                ...
                <td class="bodytext31" valign="center"  align="left"><a target="_blank" href="print_consultationbill_dmp4inch1.php?locationcode=<?php echo $locationcode1; ?>&&billautonumber=<?php echo $billnumber; ?>"><strong><?php echo $billnumber; ?></strong></a></td> 
              ...
              <td width="18%" align="right" valign="center"  
				...
				$paynow=mysqli_query($GLOBALS["___mysqli_ston"], "select sum(totalamount) as totamount,billno,accountname,billdate from billing_paynow where visitcode='$visitcode' group by visitcode,billno")or die("Error in paynow".mysqli_error($GLOBALS["___mysqli_ston"]));
...

				{
				 ...
				 //$debit =$respaynow['totamount'];
				  ...
				  $paylab="select sum(labitemrate) as labitemrate from billing_paynowlab where patientcode='$customercode' and billnumber='$billnumber' and patientvisitcode='$visitcode' group by billnumber";
...

			{
              ...
              <td width="8%" align="left" valign="center"  
               ...
               <a target="_blank" href="print_billpaynowbill_dmp4inch1.php?locationcode=<?php echo $locationcode1; ?>&&billautonumber=<?php echo $billnumber; ?>&&patientcode=<?php echo $searchcustomercode; ?>"><strong><?php echo $billnumber; ?></strong></a></td>
              ...
              <td width="18%" align="right" valign="center"  
                ...
                class="bodytext31"><?= number_format($balanceamt,2,'.',',');?></td>
				  ...
				  <?php
				      ...
				      $paypharmacy="select sum(amount) as amount from billing_paynowpharmacy where patientcode='$customercode' and patientvisitcode='$visitcode' and billnumber='$billnumber' group by billnumber";
              ...
              <td width="18%" align="right" valign="center"  
                ...
                class="bodytext31"><?= number_format($balanceamt,2,'.',',');?></td>
				  ...
				  <?php
				   ...
				   $payradiology="select sum(radiologyitemrate) as radiologyitemrate from billing_paynowradiology where patientcode='$customercode' and patientvisitcode='$visitcode' and billnumber='$billnumber' group by billnumber";
              ...
              <td width="18%" align="right" valign="center"  
                ...
                class="bodytext31"><?= number_format($balanceamt,2,'.',',');?></td>
				  ...
				  <?php
				   ...
				   $payreferal="select sum(referalrate) as referalrate from billing_paynowreferal where patientcode='$customercode' and patientvisitcode='$visitcode' and billnumber='$billnumber' group by billnumber";
...

			{
              ...
              <td width="18%" align="right" valign="center"  
                ...
                class="bodytext31"><?= number_format($balanceamt,2,'.',',');?></td>
				  ...
				  $payservices="select sum(amount) as amount from billing_paynowservices where patientcode='$customercode' and patientvisitcode='$visitcode' and billnumber='$billnumber' group by billnumber";
     ...
     <a target="_blank" href="print_paynow_refund.php?locationcode=<?php echo $locationcode1; ?>&&billnumber=<?php echo $billnumber; ?>&&patientcode=<?php echo $searchcustomercode; ?>"><strong><?php echo $billnumber; ?></strong></a></td>
			 ...
			 <tr  <?php echo $colorcode; ?>>
              ...
              <td width="8%" align="left" valign="center"  
                ...
                class="bodytext31"><?php echo $consdate;?></td>
                 ...
                 <td class="bodytext31" valign="center"  align="left"><a target="_blank" href="print_paylater_detailed.php?locationcode=<?php echo $locationcode1; ?>&&billautonumber=<?php echo $billnumber; ?>"><strong><?php echo $billnumber; ?></strong></a></td>
              ...
              <td width="8%" align="left" valign="center"  
                ...
                class="bodytext31"><?php echo $consdate;?></td>
                 ...
                 class="bodytext31"><div align="left"><?php echo "Towards Credit Lab(".$billnumber.','.$visitcode.','.$accountname.")";?></div></td>
                  ...
                  <td class="bodytext31" valign="center"  align="left"><a target="_blank" href="print_paylaterrefund.php?locationcode=<?php echo $locationcode1; ?>&&patientcode=<?php echo $customercode; ?>&&visitcode=<?php echo $visitcode; ?>&&billno=<?php echo $billnumber; ?>"><strong><?php echo $billnumber; ?></strong></a></td>
			 ...
			 <tr  <?php echo $colorcode; ?>>
              ...
              <td width="8%" align="left" valign="center"  
                ...
                class="bodytext31"><?php echo $consdate;?></td>
                 ...
                 <td class="bodytext31" valign="center"  align="left"><a target="_blank" href="print_ipfinalinvoice1.php?locationcode=<?php echo $locationcode1; ?>&&patientcode=<?php echo $customercode; ?>&&visitcode=<?php echo $visitcode; ?>&&billnumber=<?php echo $billnumber; ?>"><strong><?php echo $billnumber; ?></strong></a></td> 
			...
			<tr  <?php echo $colorcode; ?>>
              ...
              <td width="8%" align="left" valign="center"  
                ...
                class="bodytext31"><?php echo $consdate;?></td>
                 ...
                 <td class="bodytext31" valign="center"  align="left"><a target="_blank" href="print_creditnote.php?locationcode=<?php echo $locationcode1; ?>&&patientcode=<?php echo $customercode; ?>&&visitcode=<?php echo $visitcode; ?>&&billno=<?php echo $billnumber; ?>"><strong><?php echo $billnumber; ?></strong></a></td>
        ...
        <td colspan="6" class="bodytext31" align="right" bgcolor="#ecf0f5"><strong>Total:</strong></td><td  bgcolor="#ecf0f5" colspan="1" align="right" class="bodytext31"><?= number_format($balanceamt,2,'.',',');?></td>

        </tr>

        <tr>

        <td colspan="7"  align="right" class="bodytext31"><a href="customerstatementt_xl.php?searchcustomercode=<?php echo $searchcustomercode; ?>&&ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></td>

		 <td   align="right" class="bodytext31"><a href="customerstatement_print.php?searchcustomercode=<?php echo $searchcustomercode; ?>&&ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/pdfdownload.jpg" width="30" height="30"></a></td>
    ...
    <!-- Modern JavaScript -->
    <script src="js/customerstatement-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

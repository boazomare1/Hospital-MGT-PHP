...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="597" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Pharmacy return</strong></td>
			...
			if (isset($_REQUEST["ADate2"])) { $ADate2 = $_REQUEST["ADate2"]; } else { $ADate2 = ""; }
              ...
              <td width="16%" align="left" valign="center" bgcolor="#FFFFFF" class="style3">Patient code</td>
			...
			// $query1 = "select * from pharmacysalesreturn_details where `visitcode` NOT LIKE 'IP%' and entrydate between '$ADate1' and '$ADate2'";

			$query1 = "SELECT billdate, billnumber, patientvisitcode, patientname, amount as amount from refund_paylaterpharmacy where billdate between '$ADate1' and '$ADate2'
			union all select billdate, billnumber, patientvisitcode, patientname, amount as amount from refund_paynowpharmacy where billdate between '$ADate1' and '$ADate2'
			union all select entrydate as billdate, billno as billnumber, visitcode as patientvisitcode, patientname, pharmacyfxamount as amount from billing_patientweivers where entrydate between '$ADate1' and '$ADate2'
			UNION ALL SELECT billdate, billnumber, patientvisitcode, patientname, amount as amount FROM `paylaterpharmareturns` WHERE billdate between  '$ADate1' and '$ADate2' AND ledgercode <> '' AND `billnumber` IN (SELECT b.`docno` FROM `master_transactionpaylater` as a JOIN `master_transactionpaylater` as b ON (a.`visitcode` = b.`visitcode`) WHERE a.`transactiontype` = 'finalize' and b.`transactiontype` = 'pharmacycredit' and b.`auto_number` > a.`auto_number`)
			";
			...
			$res1consultationamount = $res1['amount'];
...
*/	
		   ...
		   ?>
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="right"><?php echo number_format((-1)*$res1consultationamount,2,'.',','); ?></td>
         ...
         <tr>
              ...
              <td align="right" valign="center" 
                ...
                bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo number_format((-1)*$total6,2,'.',','); ?></strong></td>
...
-->		
           ...
           <tr>
			...
			<a href="viewoprevenuereportdetailspharmacyreturnxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>

...

{
	...
	$query222 = "select itemcode,itemname from master_medicine where itemname like '%$searchmedicinename1%' and status <> 'Deleted' and transfertype='$typetransfer' limit 0,10";
			...
			$exec_ph_cat = mysqli_query($GLOBALS["___mysqli_ston"], $query_ph_cat) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res_ph_cat = mysqli_fetch_array($exec_ph_cat);

...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
        ...
        <td width="860">
              <form name="cbform1" method="post" action="viewpurchaseindent.php">
                <table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                  <tbody>
                   <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>Budget Purchase Indents Approval</strong></td>
  ...
  <tr>    
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tr>
            ...
            <tr>
			  ...
			  <?php
		$dptqry = "select distinct departmentname from master_employee where username in (select username from purchase_indent where approvalstatus = '') and departmentname like '$searchdpt'";
	...
	{
		$dptqry1 = "select distinct departmentunit from master_employee as a join master_employeeinfo as b on (a.employeecode = b.employeecode) where a.username in (select username from purchase_indent where approvalstatus = '') and a.departmentname = '$dpt'";
	...
	$query1 = "select * from purchase_indent where approvalstatus=''  and (date between '$fromdate' and '$todate') and docno like '%$docno%' and username in (select a.username from master_employee as a join master_employeeinfo as b on (a.employeecode = b.employeecode) where a.departmentname like '$dpt' and b.departmentunit like '$dpt1') group by docno";
	...
	$query1 = "select * from purchase_indent where approvalstatus=''  and (date between '$fromdate' and '$todate') and docno like '%$docno%' and username in (select username from master_employee where departmentname like '$dpt') and is_deleted!='1' group by docno";
		...
		$query1 = "select * from purchase_indent where approvalstatus=''  and (date between '$fromdate' and '$todate') and docno like '%$docno%' and username in (select username from master_employee where departmentname like '') and is_deleted!='1' group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
            ...
            <tr>
			  ...
			  <?php
		$dptqry = "select distinct departmentname from master_employee where username in (select fausername from purchase_indent where approvalstatus = 'rejected1') and departmentname like '$searchdpt'";
	$dptexec = mysqli_query($GLOBALS["___mysqli_ston"], $dptqry);
	while ($resdpt = mysqli_fetch_assoc($dptexec))
	{
	$dpt = $resdpt['departmentname'];
	if(strtoupper($dpt) == 'OPERATIONS' )
	{
		$dptqry1 = "select distinct departmentunit from master_employee as a join master_employeeinfo as b on (a.employeecode = b.employeecode) where a.username in (select fausername from purchase_indent where approvalstatus = 'rejected1') and a.departmentname = '$dpt'";
	$dptexec1 = mysqli_query($GLOBALS["___mysqli_ston"], $dptqry1);
	while ($resdpt1 = mysqli_fetch_assoc($dptexec1))
	{
	$dpt1 = $resdpt1['departmentunit'];
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			$query1 = "select * from purchase_indent where approvalstatus='rejected1' and (date between '$fromdate' and '$todate') and docno like '%$docno%' and fausername in (select a.username from master_employee as a join master_employeeinfo as b on (a.employeecode = b.employeecode) where a.departmentname like '$dpt' and b.departmentunit like '$dpt1') group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res1 = mysqli_fetch_array($exec1))
			{
			$date = $res1['date'];
	...
	else
	{
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			$query1 = "select * from purchase_indent where approvalstatus='rejected1' and (date between '$fromdate' and '$todate') and docno like '%$docno%' and fausername in (select username from master_employee where departmentname like '$dpt') group by docno";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			while ($res1 = mysqli_fetch_array($exec1))
			{
			$date = $res1['date'];

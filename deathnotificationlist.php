...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="deathnotificationlist.php">
	...
	<form name="form1" id="form1" method="post" action="deathnotificationlist.php">	
	  <tr>
        <td>
            ...
            $query2 = "select * from master_customer where customercode like '$patientcode'";
			 ...
			 // echo $num2;
              ...
              <tr <?php echo $colorcode; ?>>
				...
				?>
					<a target="_blank" href="edit_death_notification.php?patientcode=<?=  $res2customercode ?>"> Edit </a>
				<?php
				}
				?>
					</td>

...
else
{
	...
	$paymentmode = $_REQUEST['billtype'];
		...
		if(($pairvar!="")&&($pairvar1!=""))
		{
		$radiologyquery1=mysqli_query($GLOBALS["___mysqli_ston"], "insert into ipconsultation_radiology(patientcode,patientname,patientvisitcode,radiologyitemcode,radiologyitemname,radiologyitemrate,consultationdate,resultentry,iptestdocno,accountname,billtype,consultationtime,freestatus,locationname,locationcode)values('$patientcode','$patientfullname','$visitcode','$radiologycode','$pairvar','$pairvar1','$currentdate','pending','$billnumbercode','$account','$billtype','$timeonly','$radiologyfree','$locationname','$locationcode')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		if(($labname!="")&&($labrate!=''))
		{
		$labquery1=mysqli_query($GLOBALS["___mysqli_ston"], "insert into ipconsultation_lab(patientcode,patientname,patientvisitcode,labitemcode,labitemname,labitemrate,consultationdate,paymentstatus,labsamplecoll,resultentry,labrefund,iptestdocno,accountname,billtype,consultationtime,freestatus,locationname,locationcode)values('$patientcode','$patientfullname','$visitcode','$labcode','$labname','$labrate','$currentdate','paid','pending','pending','norefund','$billnumbercode','$account','$billtype','$timeonly','$labfree','$locationname','$locationcode')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
				}
		}
		...
		{
		$servicesquery1=mysqli_query($GLOBALS["___mysqli_ston"], "insert into ipconsultation_services(patientcode,patientname,patientvisitcode,servicesitemcode,servicesitemname,servicesitemrate,consultationdate,paymentstatus,process,iptestdocno,accountname,billtype,consultationtime,freestatus,locationname,locationcode)values('$patientcode','$patientfullname','$visitcode','$servicescode','$servicesname','$servicesrate','$currentdate','paid','pending','$billnumbercode','$account','$billtype','$timeonly','$servicesfree','$locationname','$locationcode')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		}
		}
		
		mysqli_query($GLOBALS["___mysqli_ston"], "insert into iptest_procedures(docno,patientname,patientcode,visitcode,account,recorddate,ipaddress,recordtime,username,billtype,locationname,locationcode)values('$billnumbercode','$patientfullname','$patientcode','$visitcode','$account','$currentdate','$ipaddress','$timeonly','$username','$billtype','$locationname','$locationcode')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
...
<form name="form1" id="frmsales" method="post" action="newborniptests.php" onKeyDown="return disableEnterKey(event)">
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
		         ...
		         <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>Radiology <img src="images/plus1.gif" width="13" height="13" onDblClick="return funcRadHideView()"  onClick="return funcRadShowView()"> </strong></span></td>
		        </tr>
				<tr id="radid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
		        ...
		        <tr>
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong>Services <img src="images/plus1.gif" width="13" height="13" onDblClick="return funcSerHideView()" onClick="return funcSerShowView()"> </strong></span></td>
		        </tr>
				<tr id="serid">
				   <td colspan="11" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3">
				    <table id="presid" width="621" border="0" cellspacing="1" cellpadding="1">

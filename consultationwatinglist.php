...
if($patienttype == 'allpatients' || $patienttype=='')
    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
        ...
        <td><table width="100%" height="80" border="0" 
          ...
          <tbody>
			...
			<tr>
				...
				<td colspan="6" class="bodytext31" align="Left"><label><strong>Consultation Waiting</strong></label></td>
			...
			$query212 = "select * from billing_paylater where visitcode='$visitcode' and patientcode = '$patientcode' order by auto_number";
			...
			$query22 = "select age,gender,consultingdoctor from master_visitentry where visitcode='$visitcode' and locationcode='$locationcode'";
			...
			$consultingdoctorname = $res22['consultingdoctor'];
...

			{
				...
				<tr <?php echo $colorcode; ?>>
				  ...
				  <td class="bodytext31" valign="center"  align="left"><?php echo strtoupper($consultingdoctorname); ?></td>
			...
			<?php
				...
				$query111 = "select * from master_visitentry where patientfullname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and referalconsultation <> 'completed' and paymentstatus = 'completed' and consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode' ".$docname." order by auto_number desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//

			$exec111 = mysqli_query($GLOBALS["___mysqli_ston"], $query111) or die ("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			$query12 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode1' and consultation = '' and paymentstatus = 'completed' and locationcode='$locationcode' order by auto_number desc";
...

		{
			...
			$query12 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode1' and consultation = '' and locationcode='$locationcode' and (consultant in (select doctorname from master_doctor where docusername like '$username') or consultant = '')";

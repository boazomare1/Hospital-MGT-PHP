...

{
	...
	$paymentmode = $_REQUEST['billtype'];
		...
		$storecode=$storecodeget=isset($_REQUEST['storecode'])?$_REQUEST['storecode']:'';
...

			{
...

				{
...

					{
						...
						$query86 ="insert into ipmedicine_prescription(itemname,itemcode,quantity,prescribed_quantity,rateperunit,totalrate,batchnumber,companyanum,patientcode,visitcode,patientname,username,ipaddress,date,account,docno,billtype,expirydate,starttime,session,frequency,dose,days,freestatus,route,dischargemedicine,medicineissue,instructions,locationcode,locationname,dosemeasure,store)values('$medicinename','$medicinecode','$quantity','$quantity','$rates','$amounts','$medicinebatch','$companyanum','$patientcode','$visitcode','$patientname','$username','$ipaddress','$dateonly','$accountname','$billnumbercode','$billtype','$expirydate','$starttime','$sess','$frequency','$dose','$days','$pharmfree','$route','$dischargemedicine','completed','$instructions','".$locationcodeget."','".$locationnameget."','$dosemeasure','$storecodeget')"; 
						...
						$query66 ="insert into pharmacysales_details(fifo_code,itemname,itemcode,quantity,rate,totalamount,batchnumber,companyanum,patientcode,visitcode,patientname,financialyear,username,ipaddress,entrydate,accountname,ipdocno,entrytime,location,store,issuedfrom,freestatus,categoryname,route,locationcode,locationname,ledgeranum,ledgercode,ledgername,incomeledger,incomeledgercode,costprice,totalcp)values('$fifo_code','$medicinename','$medicinecode','$quantity','$rates','$amounts','$medicinebatch','$companyanum','$patientcode','$visitcode','$patientname','$financialyear','$username','$ipaddress','$dateonly','$accountname','$billnumbercode','$timeonly','$location1','$storecodeget','ip','$pharmfree','$categoryname','$route','".$locationcodeget."','".$locationnameget."','$ledgeranum','$ledgercode','$ledgername','$incomeledger','$incomeledgercode','$rate','$amount')";
							...
							$query86 ="insert into ipmedicine_issue(itemname,itemcode,quantity,rateperunit,totalrate,batchnumber,companyanum,patientcode,visitcode,patientname,username,ipaddress,date,account,docno,billtype,expirydate,starttime,session,frequency,dose,days,freestatus,route,dischargemedicine,instructions,locationcode,locationname,dosemeasure)values('$medicinename','$medicinecode','$quantity','$rates','$amounts', '$medicinebatch','$companyanum','$patientcode','$visitcode','$patientname','$username','$ipaddress','$dateonly','$accountname','$billnumbercode','$billtype','$expirydate','$starttime','$sess','$frequency','$dose','$days','$pharmfree','$route','$dischargemedicine','$instructions','".$locationcodeget."','".$locationnameget."','$dosemeasure')";
...

{
	...
	document.getElementById('availableamount_org').value=formatMoney(parseFloat(availableamount_org)+parseFloat(varamount12));
	
	
	document.getElementById('grand_total').value=formatMoney(vartotal12);

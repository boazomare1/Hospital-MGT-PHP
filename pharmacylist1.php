   ...
   <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860">
              ...
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong> Medicine Issue </strong></td>
      ...
      <tr>
		 ...
		 $subtypename = $res24['subtype'];
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="left">
			    ...
			    <div align="left"><?php if($patientcode!='walkin'){?><a href="pharmacy1.php?patientcode=<?php echo $patientcode; ?>&&visitcode=<?php echo $visitcode; ?>&loccode=<?php echo $locationcode;?>&&menuid=<?php echo $menu_id; ?>"><strong>Issue</strong></a><?php }else{?><a href="externalpharmacy1.php?billnumber=<?php echo $billnumber; ?>&loccode=<?php echo $locationcode;?>&&menuid=<?php echo $menu_id; ?>"><strong>Issue</strong></a>
...

		{
		 ...
		 $subtypename = $res24['subtype'];
			...
			$query1 = "select * from master_consultationpharm where locationcode='".$locationcode."' AND patientname like '%$searchpatient%' and patientcode like '%$searchpatientcode%' AND store='$store' and patientvisitcode like '%$searchvisitcode%' and medicineissue='pending' and billtype='PAY LATER' and pharmacybill='completed' and amendstatus='2'  and recorddate between '$fromdate' and '$todate' and refund='' group by patientvisitcode  order by recorddate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//

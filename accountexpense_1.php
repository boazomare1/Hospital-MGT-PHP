            ...
            <?php
				...
				{  
					...
					if($id != '')
					{
						...
						$i = 0;
						$result = array();
						echo "<br>".$querydr1 = "SELECT SUM(`debitamount`) as expenses FROM `master_journalentries` WHERE `ledgerid` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'
						...
						$j = 0;
						$crresult = array();
						echo "<br>".$querycr1inv = "SELECT SUM(`creditamount`) as stockcredit FROM `master_journalentries` WHERE `ledgerid` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'

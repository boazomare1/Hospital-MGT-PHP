...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  <?php
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#FFFFFF" class="bodytext31"><strong>Service Return <?php echo $ADate1; ?> to <?php echo $ADate2; ?></strong></td>
			...
			// $query1 = "select * from refund_paynowservices where billdate between '$ADate1' and '$ADate2'";

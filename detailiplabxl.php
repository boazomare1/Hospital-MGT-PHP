...
header('Content-Disposition: attachment;filename="IPlab.xls"');
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#FFFFFF" class="bodytext31"><strong>Lab Charge Details from <?php echo $ADate1; ?> to <?php echo $ADate2; ?></strong></td>
              <td width="10%" bgcolor="#FFFFFF" class="bodytext31">&nbsp;</td>
              </tr>            

...
else
{
	...
	$paymentmode = $_REQUEST['billtype'];
		...
		$patienttype1 = $_REQUEST['patienttype'];
      ...
      <tr>
		...
		<tr>
			...
			<?php echo $patientaccount1; ?>	</td>	
				...
				<td class="bodytext3"><input name="billdate" id="billdate" value="<?php echo $dateonly; ?>" style="border: 1px solid #001E6A" size="18" rsize="12" readonly/><img src="images2/cal.gif" onClick="javascript:NewCssCal('billdate')" style="cursor:pointer"/> 				</td>	
      ...
      <tr>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
				        ...
				        <tr>
				   <td colspan="13" align="left" valign="middle"  bgcolor="#ecf0f5" class="bodytext3"><span class="bodytext32"><strong> Debit Note </strong> </span></td>
		        </tr>
				<tr>
				 <td width="24%" align="center" valign="middle" class="bodytext3">Bed</td>
				  <td width="24%" align="left" valign="middle" class="bodytext3"><input type="text" name="bed" id="bed" autocomplete='off' size="8" onKeyUp="return totalcalc()"></td>
				...
				<tr>
				 <td align="center" valign="middle" class="bodytext3">Others</td>
				  <td colspan="3" align="left" valign="middle" class="bodytext3"><input type="text" name="others" id="others" autocomplete='off' size="8" onKeyUp="return totalcalc()">

    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3">
			...
			$res444 = mysqli_fetch_array($exec444);
  ...
  <tr>
		...
		?>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ecf0f5">&nbsp;</td>
				 <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5" class="bodytext31" valign="left" width="80" align="left"><strong>Total Amount</strong></td>
				<td class="bodytext31" valign="center"  align="center" 
                bgcolor="#ecf0f5"><strong><?php echo number_format($amt,2, '.', ',');?></strong></td>
                <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ecf0f5">&nbsp;</td>

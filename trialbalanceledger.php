...
//echo $ADate1;
if (isset($_REQUEST["ADate2"])) { $ADate2 = $_REQUEST["ADate2"]; } else { $ADate2 = "2016-10-31"; }
//echo $ADate2;
    ...
    <td colspan="2" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="2" width="46%">
              ...
              <form name="cbform1" method="post" action="trialbalanceledger.php">
       ...
       <tr>
        <td valign="top"><table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			{	
				...
				$queryledger22 = "select accountssub from master_accountname where accountssub = '$parentid2'";
				...
				if($numledger22>0){ subledger($parentid2,$orderid1,$tbinclude); }
			...
			function subledger($parentid,$orderid,$tbinclude)
			{	
				$colorloopcount = '';
				$ledgeramount = "0.00";
				$sid=0;
				...
				if (isset($_REQUEST["ADate2"])) { $ADate2 = $_REQUEST["ADate2"]; } else { $ADate2 = ""; }
				if (isset($_REQUEST["location"])) { $location = $_REQUEST["location"]; } else { $location = ""; }
				$query2 = "select auto_number,id,accountname from master_accountname where accountssub = '$parentid' order by accountname";
				$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
				while($res2 = mysqli_fetch_array($exec2))
				{  
					...
					$ledgeramount = ledgervalue($parentid,$ADate1,$ADate2,$tbinclude,$id);
					$ledgeramountsum = $ledgeramountsum + $ledgeramount;
					?>
					<tr style="display" id="<?php echo $sid; ?>" <?php echo $colorcode; ?>> 
					<td width="695" align="left" class="bodytext3" style="text-decoration:none">
					...
					echo '&nbsp;&nbsp;&nbsp;'; ?>
					<?= $id; ?>&nbsp;
					<strong><?php echo $accountname; ?></strong></td>
					<td width="100" align="right" class="bodytext3"><strong><?php echo number_format($ledgeramount,2,'.',','); ?></strong>&nbsp;&nbsp;</td>
					</tr>
					<?php
				}
 ...
 <td width="54%" valign="top"><table width="600" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
			...
			{	
				...
				{  
					...
					$execledger22 = mysqli_query($GLOBALS["___mysqli_ston"], $queryledger22) or die ("Error in queryledger22".mysqli_error($GLOBALS["___mysqli_ston"]));
					$numledger22= mysqli_num_rows($execledger22);
					if($numledger22>0){ subledger1($parentid2,$orderid1,$tbinclude); }
			...
			function subledger1($parentid,$orderid1,$tbinclude)
			{
...
<?php
function ledgervalue($parentid,$ADate1,$ADate2,$tbinclude,$id)
{
	$orderid1 = 0;
	$lid = 0;
	$sumbalance = 0;

    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
        	...
        	<?php if($name=='pvtdr'){ $width="1000";} else{$width="900";} ?>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			<td colspan="11" align = "right" >
				<a href="excel_iprevenuereport_details.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2; ?>&&locationcode=<?php echo $locationcode1; ?>&&type=<?php echo $type; ?>&&name=<?php echo $name; ?>"><img  width="30" height="30" src="images/excel-xls-icon.png" style="cursor:pointer;"></a>
			</td>
			</tr>
            ...
            <tr>
              ...
              <td   colspan="11" width="10%" bgcolor="#ecf0f5" class="bodytext31" colspan='9'><strong>IP <?php echo $title;?> Details From  <?php echo $ADate1;?> To <?php echo $ADate2;?></strong></td>
        ...
        <?php }
        	...
        	{ ?>
              ...
              <td width="10%" bgcolor="#ecf0f5" class="bodytext31" colspan='10'><strong>IP <?php echo $title;?> Details From  <?php echo $ADate1;?> To <?php echo $ADate2;?></strong></td>
              </tr>  
        		      <tr <?php //echo $colorcode; ?>>
			  ...
			  <td width="16%" align="left" valign="center" bgcolor="#FFFFFF" class="bodytext31">Patient Name</td>

			  
              <td width="10%" align="right" valign="center" bgcolor="#FFFFFF" class="bodytext31"> Date</td>


              <td width="10%"  align="right" valign="center" bgcolor="#FFFFFF" class="bodytext31">Visitcode</td>
               <!-- <td width="10%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31">Bill Number</td> -->
                  <td width="20%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31">Service</td>
		...
		<tr>
              ...
              <td width="10%" bgcolor="#ecf0f5" class="bodytext31" colspan='8'><strong>IP <?php echo $title;?> Details From  <?php echo $ADate1;?> To <?php echo $ADate2;?></strong></td>
             ...
             <tr <?php //echo $colorcode; ?>>
			  ...
			  <td width="24%" align="left" valign="center" bgcolor="#FFFFFF" class="bodytext31">Remarks</td>
              ...
              <td width="2%" align="right" valign="center" bgcolor="#FFFFFF" class="bodytext31">Amount</td>
		   ...
		   $chk = "accountnameano = '603'";
               ...
               if($ward=='')

				{
				    ...
				    $query1 = "select visitcode,'billing' as type from billing_ip where billdate between '$ADate1' and '$ADate2' and  locationcode='$locationcode1' and accountnameano = '603' group by visitcode
				      UNION ALL SELECT visitcode,'creditapproved' as type from billing_ipcreditapproved where billdate between '$ADate1' and '$ADate2' and  locationcode='$locationcode1' and accountnameano = '603' group by visitcode";
                  ...
                  $query1 = "select visitcode,'billing' as type from ip_bedallocation where ward = '$ward'  and locationcode='$locationcode1' and recordstatus !='transfered' and visitcode in (select visitcode from billing_ip where billdate between '$ADate1' and '$ADate2' and accountnameano = '603'  and  locationcode='$locationcode1')



				   UNION  select visitcode,'creditapproved' as type from ip_bedallocation where ward = '$ward'  and locationcode='$locationcode1' and recordstatus !='transfered' and visitcode in (SELECT visitcode from billing_ipcreditapproved where billdate between '$ADate1' and '$ADate2' and accountnameano = '603'  and  locationcode='$locationcode1')



				   UNION  select visitcode,'billing' as type from ip_bedtransfer where ward = '$ward'  and locationcode='$locationcode1' and recordstatus !='transfered' and visitcode in (select visitcode from billing_ip where billdate between '$ADate1' and '$ADate2' and accountnameano = '603'  and  locationcode='$locationcode1')	

				   

				   UNION  select visitcode,'creditapproved' as type from ip_bedtransfer where ward = '$ward'  and locationcode='$locationcode1' and recordstatus !='transfered' and visitcode in (SELECT visitcode from billing_ipcreditapproved where billdate between '$ADate1' and '$ADate2' and accountnameano = '603'  and  locationcode='$locationcode1')	
			...
			if($ward=='')
			{
					  $query1 = "select visitcode,'billing' as type from billing_ip where billdate between '$ADate1' and '$ADate2' and  locationcode='$locationcode1' and accountnameano != '603' group by visitcode  UNION ALL SELECT visitcode,'creditapproved' as type from billing_ipcreditapproved where billdate between '$ADate1' and '$ADate2' and  locationcode='$locationcode1' and accountnameano != '603' group by visitcode";

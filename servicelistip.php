   ...
   <tr>
    ...
    <td width="99%" valign="top"><table width="105%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="servicelistip.php">
...
?>
          ...
          <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>IP Service List</strong></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="10" bgcolor="#ecf0f5" class="bodytext31">
                ...
                <div align="left"><strong> IP Process Service</strong>
			...
			//$query1 = "select * from master_billing where paymentstatus = 'completed' and consultationdate >= NOW() - INTERVAL 6 DAY order by consultationdate";
			 ...
			 $query1 = "select a.auto_number,a.patientcode,a.patientvisitcode,a.patientname,a.accountname,a.consultationdate,a.billnumber,a.serviceqty,a.refno,b.pkg from ipconsultation_services a JOIN master_services b ON (a.servicesitemcode=b.itemcode) where a.locationcode = '".$locationcode."'  and a.patientname like '%$searchpatient%' and a.patientcode like '%$searchpatientcode%' and a.patientvisitcode like '%$searchvisitcode%' and  a.process='pending' and a.consultationdate between '$fromdate' and '$todate' and a.wellnessitem <> '1' and b.pkg='yes'  and b.wellnesspkg='1' $services_linked_condition group by patientvisitcode order by consultationdate desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
...

		   {
            ...
            <tr <?php echo $colorcode; ?>  class="showdocument"  id="<?php echo $sno = $sno + 1; ?>">
           ...
           <table >
			...
			$totalamount=0;
			  ...
			  $query61 = "select a.auto_number,a.servicesitemcode,a.servicesitemname,a.billtype,a.patientcode,a.patientvisitcode,a.process,a.wellnessitem,a.serviceqty,a.refno,b.pkg from ipconsultation_services a JOIN master_services b ON (a.servicesitemcode=b.itemcode) where  a.patientcode = '$res1patientcode' and a.patientvisitcode = '$res1visitcode' and a.process='pending' and a.wellnessitem <> '1' and b.pkg='yes' and b.wellnesspkg='1' $services_linked_condition ";

$exec61 = mysqli_query($GLOBALS["___mysqli_ston"], $query61) or die ("Error in Query16".mysqli_error($GLOBALS["___mysqli_ston"]));
  ...
  <tr>
        ...
        <td class="bodytext31" valign="center"  align="left" 
               ...
               <td class="bodytext31" valign="center" align="left" > 
                ...
                <div align="left"><?php ?><a href="processserviceip.php?patientcode=<?php echo $res1patientcode; ?>&&visitcode=<?php echo $res1visitcode; ?>&&refnumber=<?php  echo $refno; ?>&&servicesitemcode=<?php  echo $service_item_code; ?>"><strong>PROCESS</strong></a><?php ?></div></td>

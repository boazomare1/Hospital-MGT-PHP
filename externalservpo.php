    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td>
			...
			<form name="drugs" action="externalservpo.php" method="post" onKeyDown="return disableEnterKey()" onSubmit="">
	...
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
      ...
      <tbody id="foo">
        ...
        <tr>
          ...
          <td colspan="6" bgcolor="#cccccc" class="bodytext31"><strong>External Services PO</strong></td>
...

	{
     ...
     <td colspan="1" align="left" valign="top"   bgcolor="#ffffff"class="bodytext3"> <input name="lpodate" id="lpodate" size="10"   value="<?php echo $default_lpo_date; ?>" readonly onChange="return getValidityDays();"/>
      ...
      <tr>
		...
		<form name="form1" id="form1" method="post" action="externalservpo.php" onSubmit="return validcheck()">	
...
$sno1=0;
   ...
   $query7 = "(select billtype,paymentstatus,auto_number as auto_number,docnumber as docnumber,patientname as patientname,patientcode as patientcode,patientvisitcode as patientvisitcode,consultationdate as recorddate,servicesitemname as itemname,servicesitemcode as itemcode,'' as sampleid,'' as billnumber,'consultation_services' as tablename from consultation_services where exclude = 'yes' and  externalack='0' and  consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode') 
 union all
( select billtype,paymentstatus,auto_number as auto_number,docnumber as docnumber,patientname as patientname,patientcode as patientcode,patientvisitcode as patientvisitcode,consultationdate as recorddate,servicesitemname as itemname,servicesitemcode as itemcode,'' as sampleid,'' as billnumber,'ipconsultation_services' as tablename from ipconsultation_services where exclude = 'yes'  and externalack='0' and  consultationdate between '$fromdate' and '$todate' and locationcode='$locationcode') order by recorddate desc";
...
$billtype = $res7['billtype'];

$paymentstatus = $res7['paymentstatus'];
...
if($res7tablename=='consultation_services' && $billtype=='PAY NOW')
{
$query71 = "select * from consultation_services where auto_number='$res7auto_number' and billtype='PAY NOW' and paymentstatus='completed' ";
...
$colorloopcount = $colorloopcount + 1;
	...
	<input name="samplecollid<?=$sno;?>" type="hidden" id="samplecollid<?=$sno;?>"  value="<?php echo $res7docnumber; ?>"  size="8">
            ...
            <option value="">Select</option>
              <?php				
              $sql= "select * from serv_supplierlink where itemcode='$itemcode' ";
            ...
            <input name="tax_percent<?=$sno;?>" type="hidden" id="tax_percent<?=$sno;?>"  value=""  size="8">

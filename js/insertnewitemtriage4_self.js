...
function insertitem3()
{
	...
	text111.id = "radiologycode5"+k+"";
	text111.name = "radiologycode5[]"+k+"";
	text111.type = "hidden";
	text111.align = "left";
	text111.size = "25";
	text111.value = varRadiologycode;
	...
	totalamount2=parseInt(totalamount2) + parseInt(varradRate.replace(/[^0-9\.]+/g,""));
	document.getElementById("total2").value=totalamount2.toFixed(2);
	
	
	var varLab = document.getElementById("radiology").value = "";
	
	var varLab = document.getElementById("radiologycode").value = "";

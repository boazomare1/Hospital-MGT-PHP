...
$query12 = "select recorddate, recordtime,username from resultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and itemcode like '$labcode' and sampleid ='$sampleid' and  docnumber='$docnumberip'";
$exec12 = mysqli_query($GLOBALS["___mysqli_ston"], $query12) or die ("Error in Query12".mysqli_error($GLOBALS["___mysqli_ston"]));
if($type == 'IP')
{
	$query12 = "select recorddate, recordtime,username from ipresultentry_lab where patientcode = '$patientcode' and patientvisitcode = '$visitcode' and itemcode like '$labcode' and sampleid ='$sampleid' and  docnumber='$docnumberip'";
$exec12 = mysqli_query($GLOBALS["___mysqli_ston"], $query12) or die ("Error in Query12".mysqli_error($GLOBALS["___mysqli_ston"]));
}
...
<?php
	...
	$query616 = "select rslt.*,count(rslt.referencename) as nors  from resultentry_lab as rslt join master_labreference as ref on ref.referencename=rslt.referencename and rslt.itemcode = ref.itemcode where rslt.patientcode = '$patientcode' and rslt.patientvisitcode = '$visitcode' and rslt.itemcode = '$labcode' and rslt.sampleid = '$sampleid' and rslt.resultvalue <> '' and  rslt.docnumber='$docnumberip' group by rslt.itemcode,rslt.sampleid,rslt.referencename ORDER BY reforder ";
		...
		if($type == 'IP')
		{
			...
			$query616 = "select rslt.*,count(rslt.referencename) as nors  from ipresultentry_lab as rslt join master_labreference as ref on ref.referencename=rslt.referencename and rslt.itemcode = ref.itemcode where rslt.patientcode = '$patientcode' and rslt.patientvisitcode = '$visitcode' and rslt.itemcode = '$labcode'  and rslt.resultvalue <> '' and rslt.sampleid = '$sampleid' and  rslt.docnumber='$docnumberip' group by rslt.itemcode,rslt.docnumber ORDER BY reforder";
	...
	echo $query32="select rslt.* from resultentry_lab as rslt join master_labreference as ref on ref.referencename=rslt.referencename and rslt.itemcode = ref.itemcode where rslt.patientcode = '$patientcode' and rslt.patientvisitcode = '$visitcode' and rslt.itemcode = '$res616itemcode' and rslt.sampleid = '$docnumber'  and rslt.resultvalue <> '' and  rslt.docnumber='$docnumberip' group by rslt.referencename order by reforder ";
	...
	if($type == 'IP')
	{
		...
		$query32="select rslt.* from ipresultentry_lab as rslt join master_labreference as ref on ref.referencename=rslt.referencename and rslt.itemcode = ref.itemcode where rslt.patientcode = '$patientcode' and rslt.patientvisitcode = '$visitcode' and rslt.itemcode = '$res616itemcode'   and rslt.resultvalue <> '' and  rslt.docnumber='$docnumberip' group by rslt.referencename order by reforder";

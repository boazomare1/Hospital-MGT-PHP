...
window.resizeTo(screen.availWidth, screen.availHeight);	
	$("#addlabitems").click(function (){
		...
		type: "POST",
		url: "ajaxlab1.php",
		data:{'labcode':this.value,'tb':'<?php echo $tb; ?>','pkg':'<?php echo $pkg; ?>'},
...
<div class="row" >
   <div class="pull-right">
   	 <button align="right" class="btn-success btn verticaltext" type="button" name="addlabitems" id="addlabitems" style="position:fixed; bottom:10px;right:25px;">Add Tests </button> 
   </div>
</div>
  </form>
  </div>

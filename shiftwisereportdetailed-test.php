...
//$frmflag2 = $_POST['frmflag2'];
 ...
 $query31 = "select st.shiftstarttime,st.shiftouttime,st.username,st.physical_cash from shift_tracking as st LEFT JOIN master_employeelocation as mel ON st.username = mel.username where mel.locationcode='$locationcode' and st.auto_number='$anum'";
       ...
       <tr>
        <td colspan="3"><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		 ...
		 <td width="47" align="right" valign="center"  
			...
			$totalmpesaamount = 0; 
			$totalonlineamount = 0; 
		   $query281 = "select billnumber,patientcode,patientvisitcode,source from paymentmodecredit where billdatetime between '$starttime' and '$outtime' and username = '$user' group by billnumber order by auto_number desc";
...
-->			    <td class="bodytext31" valign="center"  align="right">&nbsp;</td>
		 ...
		 echo $query2 = "select * from paymentmodedebit where billdatetime between '$starttime' and '$outtime' and username = '$user' order by auto_number desc";

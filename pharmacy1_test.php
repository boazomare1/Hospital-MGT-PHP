...
$totalpending = 0;
 ...
 print_r($_POST);
...

		{
			...
			echo $medicinename=$_POST['medicine'][$key];
...

		   {
				...
				//	echo $bat_quantity.','.$itemcode.'<br>';
...

					{
						...
						echo "update master_consultationpharmissue set quantity='$pending',docnumber='$docnumber' where medicinecode='$itemcode' and patientvisitcode='$visitcode' and consultation_id='$consid1' and auto_number='$pharmano'";
						echo "update master_consultationpharm set medicineissue='$issuestatus',docnumber='$docnumber' where medicinecode='$itemcode' and patientvisitcode='$visitcode' and consultation_id='$consid1' and auto_number='$pharmano'";

						//mysql_query("update master_consultationpharmissue set quantity='$pending',docnumber='$docnumber' where medicinecode='$itemcode' and patientvisitcode='$visitcode' and consultation_id='$consid1' and auto_number='$pharmano'") or die(mysql_error());

						//mysql_query("update master_consultationpharm set medicineissue='$issuestatus',docnumber='$docnumber' where medicinecode='$itemcode' and patientvisitcode='$visitcode' and consultation_id='$consid1' and auto_number='$pharmano'");
...

	{
...

		{
			...
			//mysql_query("update master_consultationpharm set medicineissue='completed',docnumber='$docnumber' where medicinename='$medicinename2' and patientvisitcode='$visitcode' and auto_number='$pharmano'");
...
<form name="frmsales" id="frmsales" method="post" action="pharmacy1_test.php" onKeyDown="return disableEnterKey(event)" onSubmit="document.getElementById('subbutton').disabled=true">

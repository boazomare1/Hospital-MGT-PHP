...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
 ...
 <form name="cbform1" method="post" action="tbroundoffinsert.php">
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
           ...
           <?php
                $colorloopcount ='';
                $snocount = 0;
                $roundoff_ledgerid = "06-5000-2"; // PREMIER Build
                ...
                $credit_amt = 0;
				    ...
				    $query3 = "SELECT doc_number,transaction_type,transaction_date,sum(transaction_amount) as amount FROM `tb` WHERE doc_number= '$doc_number' group by transaction_type";
		   ...
		   $diff = abs($diff);
		   $query_inner = "INSERT INTO `tb` (`auto_number`, `doc_number`, `ledger_id`, `transaction_date`, `transaction_amount`, `transaction_type`,`remarks`) VALUES (NULL, '$doc_number', '$roundoff_ledgerid', '$trans_date', '$diff', '$transaction_type','roundoff')";
		   //echo $query_inner.'<br>';
			$exec_inner = mysqli_query($GLOBALS["___mysqli_ston"], $query_inner) or die ("Error in INSERT Query".mysqli_error($GLOBALS["___mysqli_ston"]));
		}
		   } 

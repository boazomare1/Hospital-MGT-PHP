...
global $a_json;
	...
	//$query2 = "select * from master_accountname where accountname like '%$term%' and (accountsmain in('6') or accountssub in('9','16')) and recordstatus <> 'deleted' and id <> '' order by auto_number desc limit 0, 10";
$query2 = "select * from master_accountname where accountname like '%$term%' and (accountsmain in('6')) and recordstatus <> 'deleted' and id <> '' order by auto_number desc limit 0, 10";

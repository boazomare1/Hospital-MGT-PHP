  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="1447"><form name="cbform1" method="post" action="hospitalrevenuereportdetailed.php">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Hospital Detail Revenue </strong></td>
       ...
       <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" bordercolor="#666666" cellspacing="0" cellpadding="4" width="1100" align="left" border="0">
          <tbody>
		   <?php
				...
				?>
            <tr>
            <td colspan="13" bgcolor="#ecf0f5" class="bodytext3"><strong>Hospital Detail : OP Revenue  &nbsp; From &nbsp;<?php echo date('d-M-Y',strtotime($_POST['ADate1'])); ?> To <?php echo date('d-M-Y',strtotime($_POST['ADate2'])); ?></strong></td>
...
$serial=0;
		...
		if ($cbfrmflag1 == 'cbfrmflag1')
			...
			//**CONSULTATION**//
			//CASH
			$query_op = "SELECT patientcode, patientvisitcode as  visitcode, patientname, billnumber as billno, billdate as billdate  from billing_consultation where  $pass_location and billdate between '$transactiondatefrom' and '$transactiondateto' group by billno
			union all SELECT patientcode,visitcode, patientname, billno as billno, billdate as billdate   from billing_paynow where  $pass_location and  billdate between '$transactiondatefrom' and '$transactiondateto' group by billno
			UNION ALL select patientcode,visitcode, patientname, billno as billno, billdate as billdate    from billing_paylater where $pass_location and  billdate between '$transactiondatefrom' and '$transactiondateto'
			union all SELECT patientcode,visitcode, patientname, docno as billno, recorddate as billdate   from billing_opambulance where  $pass_location and  recorddate between '$transactiondatefrom' and '$transactiondateto' group by billno
			union all SELECT patientcode,visitcode, patientname, docno as billno, recorddate as billdate  from billing_homecare where  $pass_location and  recorddate between '$transactiondatefrom' and '$transactiondateto' group by billno
			";
			// UNION ALL select patientcode,visitcode, patientname  from billing_paynow where $pass_location and  billdate between '$transactiondatefrom' and '$transactiondateto' 
			...
			//CREDIT
			$query1 = "SELECT sum(totalamount) as billamount1 from billing_paylaterconsultation where billno='$billno_op' ";
			$exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die ("Error in query1".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res1 = mysqli_fetch_array($exec1);
			...
			//REFUND
			// $query12 = "select sum(consultation) as consultation1 from refund_consultation where $pass_location and  patientcode='$patientcode_op' and patientvisitcode='$visitcode_op' ";
		  ...
		  //**PHARMACY**//
		  //CASH
		  $query9 = "select sum(fxamount) as amount1 from billing_paynowpharmacy where $pass_location and   billnumber='$billno_op'  "; 
			$exec9 = mysqli_query($GLOBALS["___mysqli_ston"], $query9) or die ("Error in Query9".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res9 = mysqli_fetch_array($exec9);
			$res9pharmacyitemrate = $res9['amount1'];
		
			//CREDIT
			$query8 = "select sum(fxamount) as amount1 from billing_paylaterpharmacy where $pass_location and   billnumber='$billno_op' ";
			$exec8 = mysqli_query($GLOBALS["___mysqli_ston"], $query8) or die ("Error in query8".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res8 = mysqli_fetch_array($exec8);
			$res8pharmacyitemrate = $res8['amount1'];
			
			//EXTERNAL
			$query17 = "select sum(amount) as amount1 from billing_externalpharmacy where $pass_location and   billnumber='$billno_op' "; 
        ...
        <?php	
			...
			//CREDIT
			$query2 = "select sum(fxamount) as labitemrate1 from billing_paylaterlab where $pass_location and billnumber='$billno_op' "; 
			$exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in query2".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res2 = mysqli_fetch_array($exec2);
			$res2labitemrate = $res2['labitemrate1'];
			
			//EXTERNAL
			$query14 = "select sum(labitemrate) as labitemrate1 from billing_externallab where $pass_location and billnumber='$billno_op' "; 
		   ...
		   <?php
			...
			//CASH
			$query5 = "select sum(fxamount) as radiologyitemrate1 from billing_paynowradiology where $pass_location and billnumber='$billno_op' "; 
			$exec5 = mysqli_query($GLOBALS["___mysqli_ston"], $query5) or die ("Error in Query5".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res5 = mysqli_fetch_array($exec5);
			$res5radiologyitemrate = $res5['radiologyitemrate1'];
			
			//CREDIT
			$query4 = "select sum(fxamount) as radiologyitemrate1 from billing_paylaterradiology where $pass_location  and billnumber='$billno_op' "; 
			$exec4 = mysqli_query($GLOBALS["___mysqli_ston"], $query4) or die ("Error in query4".mysqli_error($GLOBALS["___mysqli_ston"]));
			$res4 = mysqli_fetch_array($exec4);
			$res4radiologyitemrate = $res4['radiologyitemrate1'];
			
			//EXTERNAL
			$query15 = "select sum(radiologyitemrate) as radiologyitemrate1 from billing_externalradiology where $pass_location  and billnumber='$billno_op' "; 
...
$query_refund="SELECT patientcode,visitcode, patientname, billnumber as billno, transactiondate as billdate from refund_paynow where  $pass_location and  transactiondate between '$transactiondatefrom' and '$transactiondateto'  
			UNION ALL SELECT patientcode,visitcode, patientname, billno as billno, billdate as billdate from refund_paylater where  $pass_location and  billdate between '$transactiondatefrom' and '$transactiondateto'  
			UNION ALL SELECT patientcode,visitcode, patientname, billno as billno, entrydate as billdate from billing_patientweivers where  $pass_location and entrydate between '$transactiondatefrom' and '$transactiondateto'
			";
...
$subtotal_2-=$subtotal_ref;
			...
			?>
			 ...
			 <tr <?php echo $colorcode1; ?>>
                  ...
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php echo number_format((-1)*$subtotal_ref,2,'.',','); ?></strong></div></td>
           ...
           $subtotal_refp=0;
           $pharmacy_refp=0;
           $query1 = "SELECT billnumber, `amount` as amount, patientcode, patientname, patientvisitcode, locationname, billdate FROM `paylaterpharmareturns` WHERE $pass_location and billdate between  '$transactiondatefrom' and '$transactiondateto' AND ledgercode <> '' AND `billnumber` IN (SELECT b.`docno` FROM `master_transactionpaylater` as a JOIN `master_transactionpaylater` as b ON (a.`visitcode` = b.`visitcode`) WHERE a.`transactiontype` = 'finalize' and b.`transactiontype` = 'pharmacycredit' and b.`auto_number` > a.`auto_number`)";
           ...
           ?>
            <tr <?php echo $colorcode1; ?>>
                  ...
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><?php echo  number_format((-1)*$pharmacy_refp,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">-<?php echo number_format(0,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">-<?php echo number_format(0,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">-<?php echo number_format(0,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">-<?php echo number_format(0,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">-<?php echo number_format(0,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31">-<?php echo number_format(0,2,'.',','); ?></div></td>
                  <td class="bodytext31" valign="center"  align="right"><div class="bodytext31"><strong><?php echo number_format((-1)*$pharmacy_refp,2,'.',','); ?></strong></div></td>
...
<!-- ///////////////////////////////////////////////////// REFUNDS CLOSE /////////////////////////////////////////			 -->
 ...
 <tr>
	   ...
	   $query1 = "select  patientname,patientcode,visitcode, billdate from billing_ip where patientbilltype <> '' and $pass_location  and billdate between '$fromdate' and '$todate' group by visitcode  order by auto_number DESC ";
		...
		//TO GET TOTAL IP PACKAGE CHARGES AMOUNT  
		 ...
		 // $query112 = "select sum(amountuhx) as bedamount from billing_ipbedcharges where $pass_location  and patientcode = '$patientcode' and visitcode='$visitcode' and description!='Resident Doctor Charges' and description!='Ward Dispensing Charges' and description!='bed charges' and recorddate between '$fromdate' and '$todate' ";
		 // $query112 = "select sum(amountuhx) as bedamount from billing_ipbedcharges where $pass_location  and patientcode = '$patientcode' and visitcode='$visitcode' and description NOT IN ('Bed Charges','Nursing Charges','RMO Charges','Daily Review charge','Consultant Fee') and recorddate between '$fromdate' and '$todate' ";
		...
		//TO GET TOTAL LAB AMOUNT
		  ...
		  $query3 = "select sum(rateuhx) as labitemrate from billing_iplab where $pass_location  and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'  ";
	   ...
	   $totalradiologyamount=$totalradiologyamount + $radiologyamount;
	    ...
	    $query6 = "select sum(servicesitemrateuhx) as servicesitemrate, sum(sharingamount) as sharingamount from billing_ipservices where $pass_location  and patientcode = '$patientcode' and patientvisitcode='$visitcode' and billdate between '$fromdate' and '$todate'  ";
		...
		$colorloopcount = $colorloopcount + 1;
          ...
          <tr <?php echo $colorcode; ?>>
		   ...
		   <?php 
			...
			$query186 = "select  patientname,patientcode,visitcode, billdate from billing_ipcreditapproved where $pass_location  and billdate between '$fromdate' and '$todate' group by visitcode  order by auto_number DESC ";
		...
		//TO GET TOTAL IP PACKAGE CHARGES AMOUNT  
		 ...
		 // $query112 = "select sum(amountuhx) as amount from billing_ipbedcharges where $pass_location  and patientcode = '$patientcode' and visitcode='$visitcode' and description NOT IN  ('Bed Charges','Nursing Charges','Resident Doctor Charges') and recorddate between '$fromdate' and '$todate' ";
	   ...
	   $totalradiologyamount=$totalradiologyamount + $radiologyamount;
...

		{
			...
			$billdate_ipcreditnote = $rescreditbrf["consultationdate"];
		  ...
		  $qrybrfbedchgsdisc = "select sum(fxamount) as brfbedchgsdisc from ip_creditnotebrief where description='Bed Charges'  AND patientcode = '$pcode' AND patientvisitcode = '$vcode'  and locationcode = '$locationcode1' and consultationdate between '$fromdate' and '$todate'";
		   ...
		   $totbrfbeddisc = $totbrfbeddisc + $brfbedchgsdiscount;
			...
			$qrybrflabchgsdisc = "SELECT sum(fxamount) AS brflabchgsdisc FROM ip_creditnotebrief WHERE description='Lab'  AND patientcode = '$pcode' AND patientvisitcode='$vcode' AND $pass_location  AND consultationdate BETWEEN '$fromdate' and '$todate'";
			...
			$qrybrfnursechgsdisc = "SELECT sum(fxamount) AS brfnursechgsdisc FROM ip_creditnotebrief WHERE description='Nursing Charges'  AND patientcode = '$pcode' AND patientvisitcode='$vcode' AND $pass_location  AND consultationdate BETWEEN '$fromdate' and '$todate'";
			...
			$qrybrfpharmachgsdisc = "SELECT sum(fxamount) AS brfpharmachgsdisc FROM ip_creditnotebrief WHERE description='Pharmacy'  AND patientcode = '$pcode' AND patientvisitcode='$vcode' AND $pass_location  AND consultationdate BETWEEN '$fromdate' and '$todate'";
			...
			$qrybrfradchgsdisc = "SELECT sum(fxamount) AS brfradchgsdisc FROM ip_creditnotebrief WHERE description='Radiology'  AND patientcode = '$pcode' AND patientvisitcode='$vcode' AND $pass_location  AND consultationdate BETWEEN '$fromdate' and '$todate'";
			...
			$qrybrfrmochgsdisc = "SELECT sum(fxamount) AS brfrmochgsdisc FROM ip_creditnotebrief WHERE description='RMO Charges'  AND patientcode = '$pcode' AND patientvisitcode='$vcode' AND $pass_location  AND consultationdate BETWEEN '$fromdate' and '$todate'";
			...
			$qrybrfservchgsdisc = "SELECT sum(fxamount) AS brfservchgsdisc FROM ip_creditnotebrief WHERE description='Service'  AND patientcode = '$pcode' AND patientvisitcode='$vcode' AND $pass_location  AND consultationdate BETWEEN '$fromdate' and '$todate'";
			...
			$qrybrfotherdisc = "SELECT sum(fxamount) AS brfotherdisc FROM ip_creditnotebrief WHERE description='Others'  AND patientcode = '$pcode' AND patientvisitcode='$vcode' AND $pass_location  AND consultationdate BETWEEN '$fromdate' and '$todate'";
         ...
         <!--DISPLAY CREDITNOTE DETAILS-->
          ...
          <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $sno = $sno + 1; ?></div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="center"><?php echo $billdate_ipcreditnote; ?></div></td>
            ...
            <tr>
              ...
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="right" 
                ...
                <td width="35" rowspan="2" align="right" valign="center" 
                  ...
                  bgcolor="#ecf0f5" class="bodytext31"><div align="left"><a target="_blank" href="print_hospitalrevenuereportdetailed.php?cbfrmflag1=cbfrmflag1&&location=<?php echo $location; ?>&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></div></td>

...
if(isset($_REQUEST['ledgercode'])) { $ledgercode = $_REQUEST['ledgercode']; } else { $ledgercode = ''; }
if(isset($_REQUEST['frmflag1'])) { $frmflag1 = $_REQUEST['frmflag1']; } else { $frmflag1 = ''; }
if($frmflag1 == 'frmflag1')
{
visitcreate:
$paynowbillprefix = 'PCR-';
$paynowbillprefix1=strlen($paynowbillprefix);
 $query2 = "select * from master_journalentries where docno like 'PCR-%' order by auto_number desc limit 0, 1";
...
for($i=1;$i<=50;$i++)
{
	if(isset($_REQUEST['serialnumberentries'.$i]))
	{
		...
		if($serialnumberentries != '')
		{
			...
			values('$docno1','$entrydate','','JOURNAL','$entrytype','$ledgerno','$ledger', '$amount', '$creditamount', '$debitamount','','$ipaddress','$username','$updatedatetime','$locationcode','$locationname','$narration')";
			$exec7 = mysqli_query($GLOBALS["___mysqli_ston"], $query7) or die ("Error in Query7".mysqli_error($GLOBALS["___mysqli_ston"]));
			
			if($exec7)
			{
			 $quer="update master_journalentries set disbursstatus='1' where docno='$ddoc'";
			$ex=mysqli_query($GLOBALS["___mysqli_ston"], $quer);
...
header("location:disbursedpettycash.php?st=success");
...
{	
	...
	source:"ajaxentriesvoucherledger_exp.php",
	//alert(source);
	minLength:0,
	html: true, 
...
<?php 
  ...
  $querry=" select ledgerid,ledgername,transactionamount,selecttype,docno from  master_journalentries where ledgerid='$ledgercode' and docno='$doc'";
...
<tr>
  ...
  <tr>
    ...
    <td width="90%" valign="top">
			  ...
			  <form name="form1" id="form1" method="post" action="pettycashreconcile.php" enctype="multipart/form-data" >
                  ...
                  <table width="918" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
				   ...
				   <tr>
					...
					<input id="vamount" name="vamount" type="hidden" align="left" size="12" onBlur="addcommas(this.id)"  onKeyDown="return numbervaild(event)" style="text-align:right; font-weight:bold;">
						...
						<td id="idTDJ1" align="left"><input id="ledger1" class="clientglaccountsc" name="ledger1" type="text" align="left" size="50" style="text-align:left; font-weight:bold;" value="<?php echo $ledgername; ?>" readonly>
						<input id="ledgerno1" class="clientglaccountsc" name="ledgerno1" type="hidden" align="left" size="50" value="<?php echo $ledgerid; ?>">
						<input id="billwise1" class="clientglaccountsc" name="billwise1" type="hidden" align="left" size="50">
						</td>
						<td id="idTDK1" align="left"><input class="clientglaccountamt" value="<?php echo $transactionamount; ?>" id="amount1" name="amount1" type="text" align="left" size="12" onKeyUp="addcommas(this.id)"  onKeyDown="return numbervaild(event)" onBlur="return FillAmt('1')" onFocus="return Dis('1')" style="text-align:right; font-weight:bold;" readonly ></td>
                        ...
                        <input type="hidden" name="ddoc"  id="ddoc"value="<?php echo $docno;  ?>" />

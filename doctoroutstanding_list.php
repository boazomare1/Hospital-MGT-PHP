    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="860">
              ...
              <form name="cbform1" method="post" action="doctoroutstanding_list.php">
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          ...
          <tbody>
            ...
            <tr bgcolor="#011E6A">
              ...
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Doctor Outstanding List</strong></td>
...
// 					sum(amount) as transactionamount, billtype, locationcode, 0 as transactionamount1, billingaccountcode as doccoa, '' as visittype from adhoc_debitnote where billingaccountcode = '$searchsuppliercode2' and consultationdate between '$ADate1' and '$ADate2'  group by visitcode
					...
					// -- sum(transactionamount) as transactionamount, billtype, locationcode, 0 as transactionamount1, doccoa as doccoa, visittype as visittype from billing_ipprivatedoctor_refund where doccoa = '$searchsuppliercode2' and recorddate between '$ADate1' and '$ADate2' group by visitcode  
			 ...
			 $res45transactionamount_old=0;
					...
					$num_crnno=mysqli_num_rows($exec_crnno);
					 ...
					 $crnnumber=$res_crnno['docno'];
					  ...
					  $query_crn2 = "SELECT  docno FROM `adhoc_creditnote` WHERE billingaccountcode='$searchsuppliercode2'  AND `patientvisitcode` =  '$visitcode'  ";
				    ...
				    ///////////// for crn billls
					 ...
					 $query_adpallocaion = "SELECT  sum(transactionamount) as transactionamount,docno  from advance_payment_allocation where  doctorcode='$searchsuppliercode2' and `visitcode` =  '$visitcode' and transactiondate <='$ADate2' and billnumber='$billnumber' and recordstatus='allocated'";
...
*/
			...
			$query3 = "select * from master_transactiondoctor where billnumber = '$billnumber' and companyanum='$companyanum' and recordstatus = ''  and acc_status <> 'deallocated' and doctorcode = '$searchsuppliercode2' order by auto_number desc";
			...
			else
			{
				...
				else
				{
					...
					<div class="bodytext31">
						...
						<?php if($num234>0){ ?>
							&nbsp;&nbsp;<a href="#"><?php echo $ref_doc; ?></a>	
						<?php }if($num_crnno>0){ ?>
							&nbsp;&nbsp;<a href="#"><?php echo $crnnumber; ?></a>	
						<?php } if($num_crn2>0){ ?>
...
?>
 ...
 <tr>
	  <td class="bodytext31" valign="center"  align="right" colspan='8'><a href="doctoroutstanding_list_xl.php?<?php echo $urlpath; ?>" target="_blank"><img  width="40" height="40" src="images/excel-xls-icon.png" style="cursor:pointer;" ></a></td>
	  </tr>

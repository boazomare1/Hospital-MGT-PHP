...
$stringbuild1 = "";
  ...
  $query1 = "select * from master_customer where locationcode='$locationcode' and (customerfullname like '%$customer%' or customercode like '%$customer%' or nationalidnumber like '%$customer%') and status <> 'Deleted'  order by customerfullname LIMIT 10";

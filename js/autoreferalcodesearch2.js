...
{ 
	...
	//{
		...
		var weekdays_ids_str = varNewLineValue[3];

		if(weekdays_ids_str != "")

		{

			document.getElementById("doctor_weekdaysid_str").value = varNewLineValue[3];

			//doctor_weekdays

			var weekdays_ids_str = document.getElementById("doctor_weekdaysid_str").value;
...

			{
				...
				var weekdays_ids_arr = weekdays_ids_str.split("_");

				var array3 = weekdays.filter(function(obj) { return weekdays_ids_arr.indexOf(obj) == -1; });

			doctor_weekdays = weekdays_ids_arr;

			disable_weekdays = array3;

			console.log('@'+disable_weekdays)

			}
			else
			{
				//disable_weekdays = 7;
				disable_weekdays = ['1','2','3','4','5','6','7'];
...

		{
			...
			document.getElementById("doctor_weekdaysid_str").value = "";
			disable_weekdays = ['1','2','3','4','5','6','7'];

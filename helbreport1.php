...
<table width="101%" align="left" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
   <td width="1%" align="left" valign="top">&nbsp;</td>
    <td  valign="top">
	<form name="form1" id="form1" method="post" action="helbreport1.php" onSubmit="return from1submit1()">
   ...
   <td width="1%" align="left" valign="top">&nbsp;</td>
	...
	<tbody>
	<tr bgcolor="#FFFFFF">
	<td colspan="7" align="center" class="bodytext3"><strong>MONTHLY PAYROLL RETURN TO HELB</strong></td>
	</tr>
	<tr bgcolor="#ecf0f5">
	<td colspan="7" align="left" class="bodytext3"><strong>HELB Report</strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	<td colspan="7" align="left" class="bodytext3"><strong>EMPLOYER'S HELB CODE : <?php echo $helbnumber; ?></strong></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr>
	<td colspan="5" align="left" class="bodytext3"><a href="print_helbreport1.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/pdfdownload.jpg" height="40" width="40"></a>
	&nbsp;&nbsp;&nbsp;<a href="print_helbreportxl.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>"><img src="images/excel-xls-icon.png" height="40" width="40"></a>&nbsp;&nbsp;&nbsp;<a href="print_helbreportcsv1.php?<?php eval(base64_decode('IGVjaG8gJHVybDsg')); ?>">CSV File</a></td>
	</tr>
	</tbody>
	</table> 
	<?php 

...
function suppliernamelostfocus()
{
	...
	var varSubtypeCode = arrSupplierName[3];
	
	if (varSubtypeCode != undefined)
	{
		...
		document.getElementById("searchsuppliercode").value = varSubtypeCode;
		return false;
	}
	else
	{
		document.getElementById("searchsuppliername").value = "";
		document.getElementById("searchaccountnameanum1").value = "";
	}

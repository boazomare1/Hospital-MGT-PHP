...
if($oporip=='P')
	...
	<tr>
		...
		else
		{
			?>
        <tr>
    	<td class="bodyhead" colspan="5">OP DEBIT NOTE</td>
    </tr>
...
<?php
	...
	{
	$query5 = "SELECT * FROM ip_debitnote WHERE patientcode = '$patientcode' AND visitcode = '$visitcode' AND billno = '$billnumber'";
	$exec5 = mysqli_query($GLOBALS["___mysqli_ston"], $query5) or die ("Error in query5".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($res5 = mysqli_fetch_array($exec5)){
	$item = $res5['remarks'];
	$amount = $res5['totalamount'];
	$tot = $tot + $amount;
	$sno = $sno + 1;
?>
   	<tr>
    	<td class="bodytext" align="center"><?php echo $sno;?></td>
        <td width="260" class="bodytext"><?php echo $item;?></td>
...
?>
	<tr>
        ...
        <td class="bodytext" align="right"><?php echo number_format($tot,2);?></td>
    </tr>
</table>
...
<table align="center">
	<tr>
        <td width="700" class="bodytextbold" align="left">Authorized By:</td>
    </tr>
</table>
<?php

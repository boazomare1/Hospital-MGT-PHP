...
// Get pending service consultations count
$querynw1 = "select * from consultation_services where paymentstatus = 'pending' group by patientvisitcode order by consultationdate desc";
...
<head>
    ...
    <title>Amend Pending Service - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/amendpendingservice-modern.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <nav class="nav-breadcrumb">
        ...
        <span>→</span>
        <span>Amend Pending Service</span>
    </nav>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2><i class="fas fa-cogs"></i> Amend Pending Service</h2>
                    <p>Manage and update pending service consultations and results</p>
                </div>
            ...
            <div class="search-form-section">
                <div class="search-form-header">
                    ...
                    <h3 class="search-form-title">Search Service Consultations</h3>
                </div>
                
                <form id="searchForm" name="cbform1" method="post" action="amend_pending_service.php">
                    <div class="form-row">
            ...
            <div class="data-table-section">
                <div class="data-table-header">
                    ...
                    <h3 class="data-table-title">Pending Service Consultations</h3>
                    <div class="table-summary">
                        ...
                        <div class="summary-item">
                            ...
                            <span>Pending Services: <strong><?php echo $resnw1; ?></strong></span>
                        </div>
                    </div>
                </div>
			...
			$sno = '';
                            ...
                            // Query for pending service consultations - PAY NOW
			$query1 = "select * from consultation_services where patientcode like '%$patientcode1' and patientvisitcode like '%$visitcode1%' and patientname like '%$patientname1%' and consultationdate between '$ADate1' and '$ADate2' and paymentstatus = 'pending' and billtype = 'PAY NOW' group by patientvisitcode order by consultationdate DESC";
			...
			$showcolor = ($colorloopcount & 1); 
                            ...
                            <tr class="<?php echo $rowClass; ?>">
                                ...
                                <td>
                                    <span class="status-badge status-<?php echo strtolower($paymentstatus); ?>">
                                        <?php echo htmlspecialchars($paymentstatus); ?>
                                    </span>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        <a href="amendservice.php?patientcode=<?php echo htmlspecialchars($patientcode); ?>&visitcode=<?php echo htmlspecialchars($visitcode); ?>&menuid=<?php echo $menu_id; ?>" 
                                           class="action-btn amend" title="Amend Service Consultation">
			...
			<?php
                            ...
                            // Query for additional pending consultations - PAY LATER with 0% plan
                            $query11 = "select a.patientcode as patientcode, a.patientvisitcode as patientvisitcode, a.patientname as patientname, a.accountname as accountname, a.consultationdate as consultationdate, a.paymentstatus as paymentstatus, b.planpercentage as planpercentage from consultation_services AS a JOIN master_visitentry AS b ON (a.patientvisitcode = b.visitcode) where a.patientcode like '%$patientcode1' and a.patientvisitcode like '%$visitcode1%' and a.patientname like '%$patientname1%' and a.consultationdate between '$ADate1' and '$ADate2' and (a.paymentstatus = 'completed' or a.paymentstatus = 'pending') and a.process = 'pending' and b.planpercentage = '0.00' and a.billtype = 'PAY LATER' group by a.patientvisitcode order by a.consultationdate DESC";
			...
			<?php 
                            ...
                            // Query for additional pending consultations - PAY LATER with >0% plan
			 $query12 = "select a.patientcode as patientcode, a.patientvisitcode as patientvisitcode, a.patientname as patientname, a.accountname as accountname, a.consultationdate as consultationdate, a.paymentstatus as paymentstatus, b.planpercentage as planpercentage from consultation_services AS a JOIN master_visitentry AS b ON (a.patientvisitcode = b.visitcode) where a.patientcode like '%$patientcode1' and a.patientvisitcode like '%$visitcode1%' and a.patientname like '%$patientname1%' and a.consultationdate between '$ADate1' and '$ADate2' and a.paymentstatus = 'pending' and a.process = 'pending' and b.planpercentage > '0.00' and a.approvalstatus = '' and a.billtype = 'PAY LATER' group by a.patientvisitcode order by a.consultationdate DESC";
			...
			$paymentstatus = $res12['paymentstatus'];
			$planpercentage = $res12['planpercentage'];
			...
			$showcolor = ($colorloopcount & 1); 
                ...
                <div class="no-data-message">
                    ...
                    <p>No pending service consultations found for the selected criteria.</p>
    ...
    <!-- Modern JavaScript -->
    <script src="js/amendpendingservice-modern.js?v=<?php echo time(); ?>"></script>

    ...
    <td width="99%" valign="top"><table width="1425" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="867" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#ecf0f5" class="bodytext3"><strong>Purchase Bill Report     - Select Supplier </strong></td>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  ?>
            ...
            <tr>
              ...
              <td width="23%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
              <td width="4%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
              <td width="4%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
...
-->
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ecf0f5">&nbsp;</td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo $totalnetamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo $totalcashamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo $totalchequeamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo $totalonlineamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo $totalcardamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ecf0f5"><div align="right"><strong><?php echo $totalcreditamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ecf0f5">&nbsp;</td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#ecf0f5">&nbsp;</td>

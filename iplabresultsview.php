...
$exec319=mysqli_query($GLOBALS["___mysqli_ston"], $query319) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
$res319=mysqli_fetch_array($exec319);
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            align="left" border="0">
              <tbody>
			   ...
			   <?php 
			   $subTRsno = 0;
			  $query52="select * from master_labreference where itemname='$labname1' and itemcode='$itemcode2' and location='$locationcode'";
			   ...
			   $labname2=$res52['itemname'];
				...
				$labitemanum = $res52['auto_number'];
				 ...
				 $color1 = $res87['color'];
				  ...
				  $query64 = "select * from master_labreference where itemcode='$itemcode2' and referencename = '$labreferencename' and auto_number = '$labitemanum' and status <> 'deleted'  and location='$locationcode' group by referencename";

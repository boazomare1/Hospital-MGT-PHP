    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><form name="cbform1" method="post" action="consultationrevenue.php">
          ...
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="6" bgcolor="#ecf0f5" class="bodytext3"><strong>Consultation Revenue </strong></td>
              </tr>
...
<!--			 <tr>
			<td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left" 
                bgcolor="#ecf0f5"><strong>Total</strong></div></td>
			<td align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ecf0f5" class="bodytext31"><div align="right"><strong><?php echo number_format($totalhospitalrevenue,2,'.',',');  ?></strong></div></td>
		    <td align="left" valign="center" bordercolor="#f3f3f3" 

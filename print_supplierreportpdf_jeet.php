...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              <td colspan="10" class="bodytext31">

            </td>  
            </tr>
            <tr>
              <td width="40" class="bodytext31" valign="center"  align="left" 
...
$res85supplierbillnumber='';
		   ...
		   $query45 = "select transactiondate as groupdate,suppliername,suppliercode,sum(totalfxamount) as totalfxamount,billnumber, auto_number from master_transactionpharmacy where suppliercode = '$arraysuppliercode' and transactiondate between '$ADate1' and '$ADate2' and transactiontype = 'PURCHASE' group by billnumber ";
		$query45 .= " union all select a.billdate as groupdate,a.patientname,a.patientcode,a.transactionamount as totalfxamount,a.billnumber,a.auto_number from paymentmodecredit as a join master_transactionpharmacy as b on (a.billnumber = b.docno) where a.source = 'supplierpaymententry' and b.suppliercode = '$arraysuppliercode' and a.billdate between '$ADate1' and '$ADate2'  group by a.billnumber";
		  $query45 .= " union all select entrydate as groupdate,suppliername,suppliercode,sum(subtotal) as totamount,billnumber,grnbillnumber from purchasereturn_details where suppliercode = '$arraysuppliercode' and entrydate between '$ADate1' and '$ADate2' and billnumber not like 'SPCA%' group by billnumber,grnbillnumber";
		  ...
		  $query45 .= " union all select entrydate as groupdate,username,locationcode,sum(creditamount-debitamount) as amount,docno,auto_number from master_journalentries where ledgerid = '$arraysuppliercode' and entrydate between '$ADate1' and '$ADate2' group by docno order by groupdate asc";
...
$totalamount420 =$res451transactionamount-($totalpayment + $returnamount);
	...
	$totalat = $totalat + $res45transactionamount;
           ...
           <tr >
              <td  width="40" class="bodytext31" valign="center"  align="left"><?php echo $snocount; ?></td>
               <td  width="70" class="bodytext31" valign="center"  align="left">
                 <?php echo $res45transactiondate; ?> </td>
              <td  width="70" class="bodytext31" valign="center"  align="left">
                 <?php echo 'Towards Purchase'; ?>  </td>
				<td  width="70" class="bodytext31" valign="center"  align="left"><?php echo ''; ?></td>
              <td  width="70" class="bodytext31" valign="center"  align="left"><?php echo $res85supplierbillnumber; ?></td>
              <td  width="70" class="bodytext31" valign="center"  align="left"><?php echo $res45billnumber; ?></td>
              <td  width="70" class="bodytext31" valign="center"  align="right">
			  <?php  ?></td>
              <td  width="70" class="bodytext31" valign="center"  align="right">
	...
	else
	{
	 $totalat = $totalat - $total;
           ...
           <tr >
              ...
              <td  width="70" class="bodytext31" valign="center"  align="left"><?php echo $res5chequenumber; ?></td>
			  <td  width="70" class="bodytext31" valign="center"  align="left">&nbsp;</td>
              <td  width="70" class="bodytext31" valign="center"  align="left"><?php echo $res5docnumber;?></td>
              <td  width="70" class="bodytext31" valign="center"  align="right">
		 ...
		 //echo $totalamount30;
		  ...
		  $totalamountgreater = $totalamountgreater - $res65subtotal;
           ...
           <tr>
              ...
              <td  width="70" class="bodytext31" valign="center"  align="left"><?php echo $res65billnumber;?></td>
			  <td  width="70" class="bodytext31" valign="center"  align="left">&nbsp;</td>
              <td  width="70" class="bodytext31" valign="center"  align="left"><?php echo $res65grnnumber;?></td>
              <td  width="70" class="bodytext31" valign="center"  align="right">
		...
		if($num69>0)
		  ...
		  $totalamountgreater2 = $totalamountgreater2 + $resjournalcreditpayment;
           ...
           <tr >
              ...
              <td  width="70" class="bodytext31" valign="center"  align="left">&nbsp;</td>
			  <td  width="70" class="bodytext31" valign="center"  align="left">&nbsp;</td>
              <td  width="70" class="bodytext31" valign="center"  align="left"><?php echo $jdocno;?></td>
              <td  width="70" class="bodytext31" valign="center"  align="right">
...
<td   colspan="10">
           ...
           <td  width="70" class="bodytext31" valign="center"  align="right" 
			...
			<tr>
               <td  width="70" class="bodytext31" valign="center"  align="right" 
                ><?php echo number_format($totalamount302,2,'.',','); ?></td>
              <td  width="70" class="bodytext31" valign="center"  align="right" 
                ><?php echo number_format($totalamount602,2,'.',','); ?></td>
              <td  width="70" class="bodytext31" valign="center"  align="right" 
                ><?php echo number_format($totalamount902,2,'.',','); ?></td>
				<td  width="70" class="bodytext31" valign="center"  align="right" 
                ><?php echo number_format($totalamount1202,2,'.',','); ?></td>
				<td  width="70" class="bodytext31" valign="center"  align="right" 
                ><?php echo number_format($totalamount1802,2,'.',','); ?></td>
            <td  width="70" class="bodytext31" valign="center"  align="right" 
                ><?php echo number_format($totalamountgreater2,2,'.',','); ?></td>
             	 <td  width="70" class="bodytext31" valign="center"  align="right" 
                ><?php echo number_format($totalat,2,'.',','); ?></td>
				<td  width="70" class="bodytext31" valign="center"  align="right">&nbsp;</td>
				<td  width="70" class="bodytext31" valign="center"  align="right">&nbsp;</td>

...
&nbsp;				<input  value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
		 ...
		 $totoptotalamount30 = 0;
		  ...
		  $subtypeopbal = 0;
			...
			{	
				...
				$query2211 = "select accountname,auto_number,id from master_accountname where subtype='$subtypeanum' and id='02-1500-1519'";
			}
						//echo $query221;
			...
			$res21accountid = $res2211['id'];
		 	...
		 	$querydebit12 = "select * from master_transactionpaylater where accountnameano='$res21accountnameano' ";
		...
		$openingtransactiondate = $opres['transactiondate'];
			...
			if( $subtypeanum!='')
			{
				 $query221 = "select accountname,auto_number,id from master_accountname where subtype='$subtypeanum' and id='02-1500-1519'";
			}
			//echo $query221;
...
//ACCOUNT WISE OPENING BALANCE END		
		  ...
		  while($res42 = mysqli_fetch_array($exec42))
		  {
				...
				$query98 = "select sum(fxamount) as transactionamount1,docno from master_transactionpaylater where visitcode='$res2visitcode' and transactiontype = 'PAYMENT' and billnumber='$res2billnumber' and recordstatus = 'allocated' ";

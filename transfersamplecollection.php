...
foreach($_POST['itemcode'] as $key => $value)
	...
	$status1='norefund';
	   ...
	   $query29=mysqli_query($GLOBALS["___mysqli_ston"], "update consultation_lab set labrefund='$status1' where labitemcode='$itemcode' and patientvisitcode='$visitcode' and sampleid='$sampleid'");
    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="drugs" action="transfersamplecollection.php" method="post" onKeyDown="return disableEnterKey()" onSubmit="return validcheck()">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" 
            align="left" border="0">
      <tbody id="foo">
        <tr>
          <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>View Transfer Sample Collection</strong></td>
...
//}
        ...
        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Transfer Location</td>
        ...
        <tr>
          ...
          <td width="55" align="left" valign="center"  bgcolor="#FFFFFF" class="style1"><span class="bodytext31"> Date To </span></td>
          <td width="122" align="left" valign="center"  bgcolor="#ffffff"><span class="bodytext31">
            <input name="ADate2" id="ADate2" value="<?php echo $transactiondateto; ?>"  size="10"  readonly="readonly" onKeyDown="return disableEnterKey()" />
			<img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate2')" style="cursor:pointer"/>
		  </span></td>
          <td width="152" align="center" valign="center"  bgcolor="#ffffff" class="bodytext31"><strong></strong> </td>
          <td width="187" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31">		  </td>
        </tr>
	  ...
	  <form name="form1" id="form1" method="post" action="transfersamplecollection.php">	
      <tr>
        <td>
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
...
<?php
$query7 = "select * from samplecollection_lab where transferlabcode = '".$locationcode."' and acknowledge = 'completed' and status = 'transfer' and resultentry = '' and refund = 'norefund'  and recorddate between '$ADate1' and '$ADate2' order by recorddate desc";
...
$entrywork = 'Pending';
				...
				if($regno == 'walkin')
				{
				$query43 = "select * from consultation_lab where patientvisitcode='$visitno' and patientname='$patientname6' and labsamplecoll = 'transfer' and labitemcode = '$itemcode' and (labrefund = 'norefund' or labrefund = '') and (sampleid ='$sampleid' or sampleid = '')";
				}
				else
				{
				$query43 = "select * from consultation_lab where patientvisitcode='$visitno' and labsamplecoll = 'transfer' and labitemcode = '$itemcode' and (labrefund = 'norefund' or labrefund = '') and (sampleid ='$sampleid' or sampleid = '')";
				}
              ...
              <td align="left" valign="center"  
                ...
                class="bodytext31"><div align="left"><?php echo $entrywork; ?></div></td>
              	 ...
              	 <td align="left" valign="center"  
                class="bodytext31"><div align="left"><a href="labresultentry.php?patientcode=<?php echo $regno; ?>&&visitcode=<?php echo $visitno; ?>&&docnumber=<?php echo $docnumber; ?>&&sampleid=<?php echo $sampleid; ?>"><strong>Enter</strong></a></div></td>
				<td align="left" valign="center"  

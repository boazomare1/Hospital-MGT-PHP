...

{
	...
	$test_backdate = isset($_POST["test_backdate"])? 1 : 0;
 ...
 $query8771 = "update master_role set exp_drug='$exp_drug',tat_details='$tat_details',test_backdate='$test_backdate' where role_id='$roleid'";
$exec8771 = mysqli_query($GLOBALS["___mysqli_ston"], $query8771) or die(mysqli_error($GLOBALS["___mysqli_ston"]).__LINE__);

$query877 = "update master_employee set exp_drug='$exp_drug',tat_details='$tat_details' where role_id='$roleid'";
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" action="role_mapping.php" onKeyDown="return disableEnterKey()" onSubmit="return from1submit1()">
          ...
          <td width="860"><table width="900" height="250" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            ...
            <tbody>
              ...
              <?php
				 ...
				 $query31 = "select exp_drug,tat_details,test_backdate from master_role where role_id = '$roleid' ";
				 ...
				 $checkedvalue2='';
				 $checkedvalue3 ='';
				 $exp_drug = $res31['exp_drug'];
				 $tat_details = $res31['tat_details'];
				 $test_backdate = $res31['test_backdate'];
              ...
              <tr>
                ...
                <td align="left" valign="middle"   bgcolor="#FFFFFF" class="bodytext3"><strong>Test's Back Date <input id="test_backdate" class="mainmenucheck1" type="checkbox" name="test_backdate" <?php echo $checkedvalue3; ?> ></strong></td>
			  ...
			  <tr>
                ...
                <td align="left" valign="middle"   bgcolor="#FFFFFF" class="bodytext3"><strong>Expiry Drug <input id="exp_drug" class="mainmenucheck1" type="checkbox" name="exp_drug" <?php echo $checkedvalue1;?>></strong></td>
              ...
              <tr>
                ...
                <td align="left" valign="middle"   bgcolor="#FFFFFF" class="bodytext3"><strong>TAT Details<input id="tat_details" class="mainmenucheck1" type="checkbox" name="tat_details" <?php echo $checkedvalue2;?>></strong></td>
			  ...
			  $checkedvalue2 = '';
               ...
               $query2 = "select * from master_menumain where status = '' order by mainmenuorder";
				...
				//$query2 = "select * from master_menumain where mainmenuid NOT IN ('MM001','MM026') and status = '' order by mainmenuorder";
				 ...
				 if($res2menuid=='MM001' || $res2menuid=='MM026')
				 {

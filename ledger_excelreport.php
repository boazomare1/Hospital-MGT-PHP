...
$query2 = "select accountssub from master_accountssub where auto_number = '$group' and recordstatus <> 'deleted'";
...
<body>
     <table width="80%" id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
				...
				<?php
					...
					$querycr1op = "SELECT sum(openbalanceamount) as expenses,accountcode as code,'Opening Balances Entry',docno,entrydate as date FROM `openingbalanceaccount` WHERE `accountcode` = '$id' AND `entrydate` < '$ADate1'
						UNION ALL SELECT `totalamount` as expenses,locationcode as code, itemname as name, billnumber as docno, entrydate as date FROM `expensepurchase_details` WHERE `expensecode` = '$id' AND `entrydate` < '$ADate1' and recordstatus <> 'deleted'
									 ...
									 UNION ALL SELECT SUM(-1*`openbalanceamount`)as expenses,accountcode as code,'Opening Balances Entry',docno,entrydate as date FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` < '$ADate1' and payablestatus ='0'
					...
					{ 
						...
						UNION ALL SELECT `totalamount` as expenses,locationcode as code, itemname as name, billnumber as docno, entrydate as date FROM `expensepurchase_details` WHERE `expensecode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and recordstatus <> 'deleted'
									 ...
									 UNION ALL SELECT SUM(-1*`openbalanceamount`)as expenses,accountcode as code,'Opening Balances Entry' as name,docno,entrydate as date FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and payablestatus ='0'
			...
			<?php
				...
				{  
					...
					{	
						$j = 0;
						$crresult = array();
						$querycr1in = "SELECT income,code,name,docno,date FROM (SELECT `fxamount` as income, patientcode as code, patientname as name, docno as docno, recorddate as date FROM `billing_opambulancepaylater` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2'
						 UNION ALL SELECT (-1*`openbalanceamount`) as income, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date FROM `openingbalanceaccount` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'
									   UNION ALL SELECT (`openbalanceamount`) as income, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and payablestatus ='0') as cc";
						$execcr1 = mysqli_query($GLOBALS["___mysqli_ston"], $querycr1in) or die ("Error in querycr1in".mysqli_error($GLOBALS["___mysqli_ston"]));
						while($rescr1 = mysqli_fetch_array($execcr1))
						{
						$i = $i+1;
					...
					else if($id == '03-3002-NHL')
					{
						...
						$querycr1in = "SELECT income,code,name,docno,date FROM (SELECT `fxamount` as income, patientcode as code, patientname as name, billnumber as docno, billdate as date FROM `billing_paynowreferal` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
									   ...
									   UNION ALL SELECT (`fxamount`) as income, patientcode as code, patientname as name, billno as docno, billdate as date FROM `billing_paylaterconsultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
									   UNION ALL SELECT (`fxamount`) as income, patientcode as code, patientname as name, docno as docno, recorddate as date FROM `billing_opambulancepaylater` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2'
									   UNION ALL SELECT (`fxamount`) as income, patientcode as code, patientname as name, docno as docno, recorddate as date FROM `billing_homecarepaylater` WHERE recorddate BETWEEN '$ADate1' AND '$ADate2'
									   ...
									   UNION ALL SELECT (`openbalanceamount`) as income, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and payablestatus ='0'
										...
										UNION ALL SELECT (`consultation`) as income, patientcode as code, patientname as name, billnumber as docno, billdate as date FROM `refund_consultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
										UNION ALL SELECT (`fxamount`) as income, patientcode as code, patientname as name, billnumber as docno, billdate as date FROM `refund_paylaterconsultation` WHERE billdate BETWEEN '$ADate1' AND '$ADate2'
					  ...
					  $ledgertotal = $ledgertotal + $consultation;
					  $aa = $aa + $consultation;
					  ...
					  $ledgertotal = $ledgertotal + $res6referalrate;
					  $aa = $aa + $res6referalrate;
					...
					$colorloopcount = $colorloopcount + 1;
                        ...
                        <td align="left" class="bodytext3"><?php echo $colorloopcount; ?></td>
                        <td align="left" class="bodytext3"><?php echo $res2registrationdate; ?></td>
                        <td align="left" class="bodytext3"><?php echo $res2visitcode; ?></td>
                        <td align="left" class="bodytext3"><?php echo $res2patientcode; ?></td>
                        <td align="left" class="bodytext3"><?php echo $res2patientfullname; ?></td>
						<?php if($aa >= 0) { ?>
                        <td align="right" class="bodytext3">&nbsp;</td>
                        <td align="right" class="bodytext3"><?php echo number_format($aa,2); ?></td>
						<?php } else { ?>
						<td align="right" class="bodytext3"><?php echo number_format(abs($aa),2); ?></td>
						<td align="right" class="bodytext3">&nbsp;</td>
						<?php } ?>
                        <td align="right" class="bodytext3"><?= number_format($ledgertotal,2);?></td>
                        </tr>
...
$sssno = 0;
		...
		while($res66 = mysqli_fetch_array($exec66))
		{
			$patientcode = $res66['patientcode'];
			$visitcode = $res66['visitcode'];
			$date = $res66['consultationdate'];
			$res2patientfullname = $res66['patientfullname'];
			$aa=0;
			$colorloopcount=0;
		...
		/*echo '<br><br><br><br>'.$totaladmncharges;
		echo '<br>'.$labtotal;
		echo '<br>'.$totalradiologyitemrate;
		echo '<br>'.$totalservicesitemrate;
		echo '<br>'.$totalprivatedoctoramount;
		echo '<br>'.$totalpharmacysaleamount;
		echo '<br>'.$totalpharmacysalereturnamount;
		echo '<br>'.$totalambulanceamount;
		echo '<br>'.$totalipmis;
		echo '<br>'.$totaldiscountrate;
		echo '<br>'.$totalbedcharges;
		echo '<br>'.$totalbedtransfercharges;
		echo '<br>'.$totalpackage;
		*/
		$ledgertotal = $balance;
				...
				?>
				<tr >
				<td align="left" class="bodytext3"><?php echo $sssno; ?></td>
				<td align="left" class="bodytext3"><?php echo $date; ?></td>
				...
				//here2
				else if($group == '4' || $group == '5' || $group == '6' || $group == '7' || $group == '8' || $group == '9' || $group == '10' || $group == '11' || $group == '12' || $group == '13' || $group == '55' || $group == '56' || $group == '59' || $group == '60'	|| $group == '27' || $group == '31' || $group == '37' || $group == '38' || $group == '39' || $group == '42' || $group == '43' || $group == '44')
				{
				?>
				<tr bgcolor="#CCC">
				<td width="92" align="left" class="bodytext3"><strong><?php echo 'S.No'; ?></strong></td>
				...
				$expenses=0;
				$id =$ledgerid;
				$querycr1op = "SELECT `totalamount` as expenses,locationcode as code, itemname as name, billnumber as docno, entrydate as date FROM `expensepurchase_details` WHERE `expensecode` = '$id' AND `entrydate` < '$ADate1' and recordstatus <> 'deleted'
									 UNION ALL SELECT `totalamount` as expenses,locationcode as code, itemname as name, billnumber as docno, entrydate as date FROM `assetpurchase_details` WHERE `assetcode` = '$id' AND `entrydate` < '$ADate1' and recordstatus <> 'deleted'
									 UNION ALL SELECT `totalamount` as expenses,locationcode as code, itemname as name, billnumber as docno, entrydate as date FROM `otherpurchase_details` WHERE `expensecode` = '$id' AND `entrydate` < '$ADate1' and recordstatus <> 'deleted'
									 UNION ALL SELECT `totalamount` as expenses,itemcode as code, itemname as name, billnumber as docno, entrydate as date FROM `purchase_details` WHERE `expensecode` = '$id' AND billnumber NOT LIKE 'SUPO%' AND suppliername <> 'OPENINGSTOCK' AND `entrydate` < '$ADate1' and recordstatus <> 'deleted'
								     UNION ALL SELECT a.`totalamount` as expenses,a.itemcode as code, a.itemname as name, a.billnumber as docno, a.entrydate as date FROM `purchase_details` AS a JOIN master_medicine AS b ON (a.itemcode = b.itemcode) WHERE b.inventoryledgercode = '$id' AND a.billnumber NOT LIKE 'SUPO%' AND a.suppliername <> 'OPENINGSTOCK' AND a.entrydate < '$ADate1' and a.recordstatus <> 'deleted'
								     UNION ALL SELECT `transactionamount` as expenses,expensecoa as code, expenseaccount as name, docnumber as docno, transactiondate as date FROM `expensesub_details` WHERE `expensecoa` = '$id' AND `transactiondate` < '$ADate1'
									 UNION ALL SELECT a.`amount` as expenses,a.itemcode as code, a.itemname as name, a.docno as docno, a.entrydate as date FROM `master_stock_transfer` AS a WHERE a.tostore = '$id' AND a.entrydate < '$ADate1' and a.recordstatus <> 'deleted'
									 UNION ALL SELECT `openbalanceamount` as expenses, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date FROM `openingbalanceaccount` WHERE `accountcode` = '$id' AND `entrydate` < '$ADate1' 
									 UNION ALL SELECT (-1*`openbalanceamount`) as expenses, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` < '$ADate1' and payablestatus ='0'
									 UNION ALL SELECT (-1*a.`totalcp`) as expenses,a.itemcode as code, a.itemname as name, a.billnumber as docno, a.entrydate as date FROM `pharmacysales_details` AS a JOIN master_medicine AS b ON (a.itemcode = b.itemcode) WHERE b.inventoryledgercode = '$id' AND a.`entrydate` < '$ADate1'
									 UNION ALL SELECT (-1*a.`totalamount`) as expenses,a.itemcode as code, a.itemname as name, a.billnumber as docno, a.entrydate as date FROM `purchasereturn_details` AS a JOIN master_medicine AS b ON (a.itemcode = b.itemcode) WHERE b.inventoryledgercode = '$id' AND a.entrydate < '$ADate1' and a.recordstatus <> 'deleted'
									 UNION ALL SELECT (-1*a.`amount`) as expenses,a.itemcode as code, a.itemname as name, a.docno as docno, a.entrydate as date FROM `master_stock_transfer` AS a JOIN master_medicine AS b ON (a.itemcode = b.itemcode) WHERE b.inventoryledgercode = '$id' AND a.entrydate < '$ADate1' and a.tostore not like 'STO%'
									 UNION ALL SELECT (-1*`totalamount`) as expenses,itemcode as code, itemname as name, billnumber as docno, entrydate as date FROM `purchasereturn_details` WHERE expensecode = '$id' AND entrydate < '$ADate1' and recordstatus <> 'deleted'
				...
				{  
					...
					if($id != '')
					{
						...
						$querydr1 = "SELECT `totalamount` as expenses,locationcode as code, itemname as name, billnumber as docno, entrydate as date FROM `expensepurchase_details` WHERE `expensecode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and recordstatus <> 'deleted'
								     ...
								     UNION ALL SELECT `transactionamount` as expenses,expensecoa as code, expenseaccount as name, docnumber as docno, transactiondate as date FROM `expensesub_details` WHERE `expensecoa` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2'
									 UNION ALL SELECT a.`amount` as expenses,a.itemcode as code, a.itemname as name, a.docno as docno, a.entrydate as date FROM `master_stock_transfer` AS a WHERE a.tostore = '$id' AND a.entrydate BETWEEN '$ADate1' AND '$ADate2' and a.recordstatus <> 'deleted'
									 UNION ALL SELECT `openbalanceamount` as expenses, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date FROM `openingbalanceaccount` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' 
									 UNION ALL SELECT (-1*`openbalanceamount`) as expenses, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and payablestatus ='0'
									 UNION ALL SELECT (-1*a.`totalcp`) as expenses,a.itemcode as code, a.itemname as name, a.billnumber as docno, a.entrydate as date FROM `pharmacysales_details` AS a JOIN master_medicine AS b ON (a.itemcode = b.itemcode) WHERE b.inventoryledgercode = '$id' AND a.`entrydate` BETWEEN '$ADate1' AND '$ADate2'
									 UNION ALL SELECT (-1*a.`totalamount`) as expenses,a.itemcode as code, a.itemname as name, a.billnumber as docno, a.entrydate as date FROM `purchasereturn_details` AS a JOIN master_medicine AS b ON (a.itemcode = b.itemcode) WHERE b.inventoryledgercode = '$id' AND a.entrydate BETWEEN '$ADate1' AND '$ADate2' and a.recordstatus <> 'deleted'
									 UNION ALL SELECT (-1*a.`amount`) as expenses,a.itemcode as code, a.itemname as name, a.docno as docno, a.entrydate as date FROM `master_stock_transfer` AS a JOIN master_medicine AS b ON (a.itemcode = b.itemcode) WHERE b.inventoryledgercode = '$id' AND a.entrydate BETWEEN '$ADate1' AND '$ADate2' and a.tostore not like 'STO%'
									 UNION ALL SELECT (-1*`totalamount`) as expenses,itemcode as code, itemname as name, billnumber as docno, entrydate as date FROM `purchasereturn_details` WHERE expensecode = '$id' AND entrydate BETWEEN '$ADate1' AND '$ADate2' and recordstatus <> 'deleted'
				...
				{  
					...
					$result = array();
					 $querydr1 = "SELECT (`fxamount`) as paylater, patientcode as code, CONCAT('Paylater Bill - ',patientname) as name, billnumber as docno, transactiondate as date,chequenumber as chequenum FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'finalize' AND `billnumber` LIKE 'CB%'
								 UNION ALL SELECT (`fxamount`) as paylater,patientcode as code, CONCAT('IP Debit - ',patientname) as name, docno as docno, transactiondate as date,chequenumber as chequenum FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'finalize' AND `billnumber` LIKE '%IPDr%'
								 UNION ALL SELECT (`transactionamount`) as paylater,patientcode as code, CONCAT('Opening Balance - ',patientname) as name, docno as docno, transactiondate as date,chequenumber as chequenum FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'finalize' AND `billnumber` LIKE '%AOP%'
								 UNION ALL SELECT (a.`totalamountuhx`) as paylater,a.patientcode as code, CONCAT('IP Bill - ',a.patientname) as name, a.billnumber as docno, a.transactiondate as date,a.chequenumber as chequenum FROM `master_transactionip` AS a JOIN master_ipvisitentry AS b ON (a.visitcode = b.visitcode) WHERE a.`accountnameid` = '$id' AND b.billtype = 'PAY LATER' AND a.`transactiondate` BETWEEN '$ADate1' AND '$ADate2'
								 UNION ALL SELECT (`fxamount`) as paylater, patientcode as code, CONCAT('IP Credit Approve Bill - ',patientname) as name, billno as docno, billdate as date,auto_number as chequenum FROM `billing_ipcreditapprovedtransaction` WHERE `accountnameid` = '$id' AND `billdate` BETWEEN '$ADate1' AND '$ADate2'
								 UNION ALL SELECT (`debitamount`) as paylater, locationcode as code, CONCAT('Journal - ',ledgername) as name, docno as docno, entrydate as date,vouchertype as chequenum FROM `master_journalentries` WHERE `ledgerid` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'
								 UNION ALL SELECT (-1*fxamount) as paylater,patientcode as code, CONCAT('OP Credit - ',patientname) as name, docno as docno, transactiondate as date,chequenumber as chequenum FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `docno` LIKE '%Cr.N%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'paylatercredit'
								 UNION ALL SELECT (-1*fxamount) as paylater,patientcode as code, CONCAT('IP Credit - ',patientname) as name, docno as docno, transactiondate as date,chequenumber as chequenum FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `billnumber` LIKE '%IPCr%' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `transactiontype` = 'paylatercredit'
								 UNION ALL SELECT (-1*`amount`) as paylater,patientcode as code, CONCAT('Pharma Credit - ',patientname) as name, billnumber as docno, billdate as date,null as chequenum FROM `paylaterpharmareturns` WHERE billdate BETWEEN '$ADate1' AND '$ADate2' AND `billnumber` IN (SELECT b.`docno` FROM `master_transactionpaylater` as a JOIN `master_transactionpaylater` as b ON (a.`visitcode` = b.`visitcode`) WHERE b.`accountnameid` = '$id' and a.`transactiontype` = 'finalize' and b.`transactiontype` = 'pharmacycredit' and b.`auto_number` > a.`auto_number`)
								 UNION ALL SELECT (-1*`openbalanceamount`) as paylater,accountcode as code, CONCAT('OP Bal - ',accountname) as name, docno as docno, entrydate as date,null as chequenum FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'
								 UNION ALL SELECT (-1*`transactionamount`) as paylater, accountcode as code, CONCAT(remarks,' - ',accountname,' By ',transactionmode) as name, docno as docno, transactiondate as date,chequenumber as chequenum FROM `master_transactionpaylater` WHERE `accountnameid` = '$id' AND `transactiondate` BETWEEN '$ADate1' AND '$ADate2' AND `docno` LIKE 'AR-%' AND `transactionstatus` = 'onaccount' AND `transactionmodule` = 'PAYMENT'
								 UNION ALL SELECT (-1*`creditamount`) as paylater, locationcode as code, CONCAT('Journal - ',ledgername) as name, docno as docno, entrydate as date,vouchertype as chequenum FROM `master_journalentries` WHERE `ledgerid` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2'";
	...
	$i = $i+1;
				...
				$payablesdr=0;
				$id = $ledgerid;
				$querycr1op = "SELECT payables,code,name,docno,date,chequenum FROM (SELECT (-1*`transactionamount`) as payables, suppliercode as code, CONCAT('Payment - ',remarks) as name, docno as docno, transactiondate as date,chequenumber as chequenum FROM `master_transactionpharmacy` WHERE `suppliercode` = '$id' AND `transactionmodule` = 'PAYMENT' AND (`docno` LIKE 'SP%' or `docno` LIKE 'SPE%') AND `transactiondate` < '$ADate1'
						 
						 UNION ALL SELECT (-1*`totalamount`) as payables,suppliercode as code, CONCAT('Return - ',suppliername) as name, billnumber as docno, entrydate as date,typeofreturn as chequenum FROM `purchasereturn_details` WHERE `suppliercode` = '$id' AND billnumber NOT LIKE 'SPCA%' AND `entrydate` < '$ADate1'
						 
						 UNION ALL SELECT (-1*`debitamount`) as payables, locationcode as code, CONCAT('Journal - ',ledgername) as name, docno as docno, entrydate as date,vouchertype as chequenum FROM `master_journalentries` WHERE `ledgerid` = '$id' AND selecttype = 'Dr' AND `entrydate` < '$ADate1'
						 
						 UNION ALL SELECT (-1*`transactionamount`) as payables,expensecoa as code, remarks as name, docnumber as docno, transactiondate as date, chequenumber as chequenum FROM `expensesub_details` WHERE `expensecoa` = '$id' AND transactionmode <> 'ADJUSTMENT' AND transactiondate < '$ADate1'
						
						 UNION ALL SELECT (-1*`openbalanceamount`) as payables, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date, 'Opening Balance' as chequenum FROM `openingbalanceaccount` WHERE `accountcode` = '$id' AND `entrydate` < '$ADate1'
						
						UNION ALL SELECT (`openbalanceamount`) as payables, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date, 'Opening Balance' as chequenum FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` < '$ADate1' and payablestatus ='1'
						 ...
						 UNION ALL SELECT `creditamount` as payables, locationcode as code, CONCAT('Journal - ',ledgername) as name, docno as docno, entrydate as date,vouchertype as chequenum FROM `master_journalentries` WHERE `ledgerid` = '$id' AND selecttype = 'Cr' AND `entrydate` < '$ADate1'
						 UNION ALL SELECT `totalamount` as payables,suppliercode as code, CONCAT('Payable Credit - ',suppliername) as name, billnumber as docno, entrydate as date,typeofreturn as chequenum FROM `purchasereturn_details` WHERE `suppliercode` = '$id' AND billnumber LIKE 'SPCA%' AND `entrydate` < '$ADate1') as ap order by ap.date";
						$execcr1 = mysqli_query($GLOBALS["___mysqli_ston"], $querycr1op) or die ("Error in querycr1op".mysqli_error($GLOBALS["___mysqli_ston"]));
						while($rescr1 = mysqli_fetch_array($execcr1))
						{
				...
				$accountsmain2 = $res267['accountname'];
					...
					if($id != '')
					{
						...
						UNION ALL SELECT (`openbalanceamount`) as payables, docno as code, CONCAT('Opening Balance as of may 1st - ',accountname) as name, docno as docno, entrydate as date, 'Opening Balance' as chequenum FROM `openingbalancesupplier` WHERE `accountcode` = '$id' AND `entrydate` BETWEEN '$ADate1' AND '$ADate2' and payablestatus ='1'

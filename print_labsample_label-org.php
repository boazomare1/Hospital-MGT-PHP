...
if (isset($_REQUEST["visitno"])) {$visitno = $_REQUEST["visitno"]; } else { $visitno = ""; }

?> 

<style type="text/css">
.bodytext31 {FONT-WEIGHT: normal; FONT-SIZE: 10px; COLOR: #000000;  text-decoration:none
}
...
$query61 = "select patientname,sampleid, itemname,patientcode,patientvisitcode,recorddate,recordtime from opipsampleid_lab where docnumber = '$patientcode' and patientvisitcode = '$visitno' order by auto_number ASC ";
...
//$testcode1 = substr($sampleid,-4,10);
//$testcode = $lanum;
?>
  ...
  <td   align="center" valign="center" 
				...
				<strong><?= $patientname.' &nbsp;'.$visitcode ?> </strong> </td>
...
//			}
//			?>
<img src="<?php echo $applocation1; ?>/barcode/test.php?text=<?php echo $sampleanum; ?>" width="150" height="50" />
<!--<img src="<?php echo $applocation1; ?>/barcode/test.php?text=<?php echo $sampleid; ?>" width="0" height="0" />-->
 </td>
...
?>
 ...
 <tr>
  <td  align="center" valign="center" bgcolor="#ffffff" class="bodytext31" ><strong><?= $patientname.' &nbsp;'.$visitcode ?> </strong> </td>
...
//			}
//			?>
<img src="<?php echo $applocation1; ?>/barcode/test.php?text=<?php echo $sampleanum; ?>" width="150" height="50" /> </td>

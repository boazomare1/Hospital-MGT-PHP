...
header('Content-Disposition: attachment;filename="report_mis['.$ADate1.' - '.$ADate2.'].xls"');
...
<table cellspacing="3" cellpadding="0" align="left" border="0" style="border-collapse:collapse;" width="100%">
  ...
  <tr>
    <td class="bodytext31"  valign="middle"  align="left" colspan="10"><strong>MIS Report From <?php echo date("d/m/Y", strtotime($ADate1)); ?> to <?php echo date("d/m/Y", strtotime($ADate2)); ?> printed on <?php echo $currentdate; ?></strong></td>  
  </tr>
  <tr>
    <td colspan="10"><br></td>
  </tr>
...
<table style="border-collapse:collapse;" cellspacing="3" cellpadding="0" width="1400" align="left" border="1">
  <tr>
      ...
      <col width="60"><td align="center" valign="center"  
        bgcolor="#ecf0f5" class="bodytext31"><strong>AR OPD</strong></td>
      <col width="60"><td align="center" valign="center"  
      ...
      <td class="borderhide" rowspan="9">
        ...
        <tr>
          ...
          <?php
                  $bedcapacity = $totalbedday = $totalpatientdays = $avgstay = $arpob = $occupancy = $fulltotaldischargecount1 = 0;
                    ...
                    $query7 = "select sum(count) as count from (
                        ...
                        while($res7 = mysqli_fetch_array($exec7)){
                          ...
                          if($dischargecount0 != ''){
                            ...
                            $fulltotaldischargecount1 += $dischargecount;
                          } else {
                            $dischargecount = 0;
                          }
                        }
                  ...
                  if($fulltotaldischargecount1 != '' && $totalpatientdays != ''){
                        $avgstay = $totalpatientdays / $fulltotaldischargecount1;
                  } else {
                        $avgstay = 0;
                  }
        ...
        <tr>
          ...
          <td class="bodytext31" valign="center" align="center"><?php echo $totalpatientdays; ?></td>
        </tr>
        <tr>
          <td class="border3hide"></td>
          <td class="bodytext31" valign="center" align="left">ALOS</td>
          <td class="bodytext31" valign="center" align="center"><?php echo number_format($avgstay,2); ?></td>
        </tr>
        <tr>
          <td class="border3hide"></td>
          <td class="bodytext31" valign="center" align="left">A.R.P.O.B</td>
          <td class="bodytext31" valign="center" align="center"><?php echo number_format($arpob, 2); ?></td>
        </tr>
        <tr>
          <td class="border3hide"></td>
          <td class="bodytext31" valign="center" align="left">OCCUPANCY</td>
          <td class="bodytext31" valign="center" align="center"><?php echo number_format($occupancy,2)."%"; ?></td>
        </tr>
        <tr><td><br></td></tr>
        <tr>
          <td class="border3hide"></td>
      ...
      <td class="borderhide" rowspan="9">
        ...
        <tr>
          <col width="50"><td class="border3hide"></td>
          <col width="100"><td align="center" valign="center"  
            bgcolor="#ecf0f5" class="bodytext31"><strong>MORTURY</strong></td>
          <col width="100"><td align="center" valign="center"  
            bgcolor="#ecf0f5" class="bodytext31"><strong>VALUE</strong></td>
        </tr>
        <tr>
...
<?php
        ...
        <tr>
          ...
          <td class="bodytext31" valign="center" align="center"><?php echo number_format($discharge, 2);  ?></td>
        </tr>
        <tr>
          <td class="border3hide"></td>
          <td class="bodytext31" valign="center" align="left">OCCUPANCY</td>
        ...
        <tr>
          ...
          <td class="bodytext31" valign="center" align="center"><?php echo number_format($mrevenue, 2);  ?></td>
        </tr>
        </table>
      </td>
  ...
  <?php
            $totalopd = $totalip = $fulltotalip = 0;
            $dischargecount = $fulltotaldischargecount = 0;
            $query1 = "select * from mis_types where recordstatus <> 'deleted'";
              $exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die(mysqli_error($GLOBALS["___mysqli_ston"]));
              while($res1 = mysqli_fetch_array($exec1)){
                $totalopd = $totalip = 0;
    ...
    <tr <?php echo $colorcode; ?>>
      ...
      <td class="bodytext31" valign="center"  align="right"><?php echo number_format($totalip, 2); ?></td> 
      <td class="bodytext31" valign="center"  align="right"><?php echo number_format($totalopd, 2); ?></td>
      <td class="bodytext31" valign="center"  align="right"><?php echo number_format($grandtotal, 2); ?></td>
      <td class="bodytext31" valign="center"  align="right"><?php echo number_format($opvisit); ?></td>
      <td class="bodytext31" valign="center"  align="right"><?php echo number_format($arpopd); ?></td>
      <td class="bodytext31" valign="center"  align="right"><?php echo number_format($dischargecount); ?></td>
      <td class="bodytext31" valign="center"  align="right"><?php echo number_format($arperip); ?></td>
      <td class="bodytext31" valign="center"  align="right"><?php echo number_format($admissioncount); ?></td>
    </tr>
  ...
  ?>  
  <tr>
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5" align="left"><strong><?php echo "GROSS TOTAL" ?></strong></td>
              <td  align="right" valign="center" bgcolor="#ecf0f5" class="bodytext31"><div align="right"><strong><?php echo number_format($fulltotalip, 2); ?></strong></div></td>
              ...
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5"  align="right">
                <div align="right"><strong><?php echo number_format($totalarpopd); ?></strong></div></td>
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5"  align="right">
            ...
            <?php
              ...
              <tr <?php echo $colorcode; ?>>
                ...
                <td  align="right" valign="center" class="bodytext31"><div align="right"><?php echo number_format(0, 2); ?></div></td> 
            ...
            <tr>
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5" align="left"><strong><?php echo "NET TOTAL" ?></strong></td>
              <td  align="right" valign="center" bgcolor="#ecf0f5" class="bodytext31"><div align="right"><strong><?php echo number_format($fulltotalip, 2); ?></strong></div></td>
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5"  align="right">
                <div class="bodytext31"><strong><?php echo number_format($fulltotalopd, 2); ?></strong></div></td>
              <td class="bodytext31" valign="center" bgcolor="#ecf0f5"  align="right">
               ...
               <?php
                ...
                //MORTURY INCOME
                  ...
                  $query50 = "select sum(amount) as count from (
                    ...
                    $query49 = "select sum(count) as count from (
                      select count(DISTINCT(billing_ipservices.patientvisitcode)) as count, A.misreport FROM `billing_ipservices` join (SELECT DISTINCT(master_accountname.accountname), master_accountname.misreport FROM master_accountname) AS A on A.accountname = billing_ipservices.accountname JOIN master_services ON billing_ipservices.servicesitemcode = master_services.itemcode where A.misreport = '$miscode' and master_services.groupid = '$misautono' and (billing_ipservices.billdate BETWEEN '$ADate1' and '$ADate2') group by billing_ipservices.patientvisitcode
                    ) as count1";

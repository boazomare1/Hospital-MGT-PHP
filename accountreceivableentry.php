...
foreach($_POST['billnum'] as $key => $value)
		...
		$decline=$_POST['decline'][$key];
		$remarks=$_POST['remarks'][$key];
		$bill_date=$_POST['bill_date_one'][$key];
		...
		transactionmodule,patientname,patientcode,visitcode,accountname,doctorname,billstatus,docno,billbalanceamount,recordstatus,receivableamount,paymenttype,subtype,username,accountnameano,accountnameid,locationcode,locationname,subtypeano,accountcode,currency,fxrate,fxamount,discount,decline,bill_date) 
		...
		'$transactionmodule','$name','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$docnum1','$balamount','allocated','$receivableamount','$patienttype11','$patientsubtype11','$username','$accountnameano','$accountnameid','$res12locationcode','$res12location','$subtypeano','$accountnameid','$currency','1','$adjamount','$discount','$decline','$bill_date')";
		...
		'$remarks', '$transactionmodule','$name','$patientcode','$visitcode','$accountname','$doctorname','$billstatus','$docnum1','$balamount','allocated','$receivableamount','$patienttype11','$patientsubtype11','$username','$accountnameano','$accountnameid','$res12locationcode','$res12location','$subtypeano','$accountnameid','$currency','1','$adjamount','$discount','$decline','$bill_date')";
		$exec9 = mysqli_query($GLOBALS["___mysqli_ston"], $query9) or die ("Error in Query9".mysqli_error($GLOBALS["___mysqli_ston"]));
...
<script>
function resaonsearch(id){
	var serno=id;
	
$('#remarks'+serno).autocomplete({
	source:'ajaxallocationdeclinereason.php', 
	minLength:1,
	delay: 0,
	html: true, 
	select: function(event,ui){
			var value = ui.item.value;
			$('#remarks'+serno).val(value);
			}
    });
}

function funcservice(){
$('#searchallaccountsearchid').val('');
$('#searchallaccountsearch').autocomplete({
		
	source:'getsubtypeallsearch.php?main_account_name='+$('#account_name').val(), 
	//alert(source);
	minLength:1,
	delay: 0,
	html: true, 
		select: function(event,ui){
			var code = ui.item.saccountauto;
			$('#searchallaccountsearchid').val(code);
			},
    });
}
...
var remainamount=amounttodisp1-cumtotal1;
var billamt = billamt;
  var textbox = document.getElementById("adjamount"+varSerialNumber+"");
    ...
    document.getElementById("balamount"+varSerialNumber+"").value = "";
	 document.getElementById("decline"+varSerialNumber+"").value = "";
if(document.getElementById("acknowpending"+varSerialNumber+"").checked == true)
{
	...
	document.getElementById("decline"+varSerialNumber+"").value=discount123.toFixed(2);
...
if((parseFloat(document.getElementById("receivableamount").value.replace(/,/g,''))) < (parseFloat(document.getElementById("totaladjamt").value.replace(/,/g,''))))
{
	...
	$('#cumtotal').css({"font-weight": "bold",'font-size':'20px'});
	}
	else
...
{
var new_total=parseFloat(checkamount).toFixed(2)-parseFloat(amounttodisp).toFixed(2);
if(new_total>0)
{
...
function balancecalc_other(varSerialNumber1,billamt1,totalcount)
{
		...
		var billamount=document.getElementById("billamount"+varSerialNumber1+"").value;
		...
		var decline=document.getElementById("decline"+varSerialNumber1+"").value;
		var decline3=parseFloat(decline);
		...
		if((adjamount3+discount3+decline3) > billamt1)
		{
...
//alert(discount3);
//alert(decline3);
		var balanceamount=parseFloat(billamount)-parseFloat(adjamount3)-(discount3+decline3);
...
function balancecalc_dis(varSerialNumber1,billamt1,totalcount)
{
      ...
      var remainamount=amounttodisp1-cumtotal1;
		...
		if(adjamount=="" ){
		 ...
		 var balamount=document.getElementById("balamount"+varSerialNumber1+"").value;
		   if(parseFloat(balamount)<=0){
			document.getElementById("balamount"+varSerialNumber1+"").value = '0.00';
			document.getElementById("adjamount"+varSerialNumber1+"").value = (billamt1-discount3-decline3).toFixed(2);
		   }
		...
		if((discount3+adjamount3+decline3) > billamt1)
		{
			alert("Please enter correct amount");
			...
			document.getElementById("discount"+varSerialNumber1+"").focus();
			balancecalc_other(varSerialNumber1,billamt1,totalcount);
			// return false;
		// }
			// }
...
function balancecalc_dec(varSerialNumber1,billamt1,totalcount)
{
		var varSerialNumber1 = varSerialNumber1;
		var billamt1 = billamt1;
		var totalcount=document.getElementById("totalrow").value;
		...
		if((discount3+decline3+adjamount3) > billamt1)
		{
			alert("Please enter correct amount");
			document.getElementById("totaldecline").value = '0.00';
			document.getElementById("decline"+varSerialNumber1+"").value = '0.00';
			
			//document.getElementById("balamount"+varSerialNumber1+"").value = '0.00';
			//document.getElementById("adjamount"+varSerialNumber1+"").value = billamt1;
			document.getElementById("decline"+varSerialNumber1+"").focus();
			//return false;
		}
		...
		for(i=1;i<=totalcount;i++)
		{
			var totaldiscount=document.getElementById("decline"+i+"").value;
			if(totaldiscount == "")
			{
				totaldiscount=0;
			}
		...
		grandtotaldiscount=grandtotaldiscount.toFixed(2);
		grandtotaldiscount = grandtotaldiscount.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
		document.getElementById("totaldecline").value=grandtotaldiscount;
		for(i=1;i<=totalcount;i++)
		{
			var totaladjamount=document.getElementById("adjamount"+i+"").value;
			if(totaladjamount == "")
...
function balancecalc(varSerialNumber1,billamt1,totalcount)
{
		...
		if((adjamount3+discount3+decline3) > billamt1)
		{
			...
			document.getElementById("totaladjamt").value = '0.00';
			document.getElementById("adjamount"+varSerialNumber1+"").value = '0.00';
			document.getElementById("balamount"+varSerialNumber1+"").value = (billamt1-discount3-decline3).toFixed(2);
			document.getElementById("adjamount"+varSerialNumber1+"").focus();
			return false;
		}
		var balanceamount=parseFloat(billamt1)-(discount3+adjamount3+decline3);
		balanceamount=balanceamount.toFixed(2);
		balanceamount = balanceamount.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
		document.getElementById("balamount"+varSerialNumber1+"").value=balanceamount;
		for(i=1;i<=totalcount;i++)
		...
		if((parseFloat(document.getElementById("amounttodisp").value.replace(/,/g,''))) < (parseFloat(document.getElementById("totaladjamt").value.replace(/,/g,''))))
		{
			 alert('Amount Exceed!');
			 document.getElementById("adjamount"+varSerialNumber1+"").value = '0.00';
			 balancecalc(varSerialNumber1,billamt1,totalcount);
			//document.getElementById("cumtotal").style.color="red";
			//$('#cumtotal').css({"font-weight": "bold",'font-size':'20px'});
			}
			else
...
$(document).ready(function(e) {
	...
	// }
		...
		var searchallinvoiceno = $('#searchallinvoiceno').val();
		var searchallaccountsearchid = $('#searchallaccountsearchid').val();
		var Databuild = "accountnameano="+accountnameano+"&&billno="+sbillno+"&&docno="+docno+"&&totalrow="+totalrow+"&&ADate1="+ADate1+"&&ADate2="+ADate2+"&&searchallinvoiceno="+searchallinvoiceno+"&&searchallaccountsearchid="+searchallaccountsearchid;
		$.ajax({
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
	...
	<td class="bodytext31" valign="center"  align="left" colspan="4"><?php echo $suppliername; ?><input type="hidden" name="account_name" id="account_name" value="<?php echo $suppliername; ?>" size="6" ></td>
<td colspan="2"></td>
	</tr>
	<tr>
    ...
    <tr>
  <td colspan="8" align="left" valign="top" class="tab">
  ...
  <td colspan="4" align="left" valign="top">&nbsp;</td>
        	...
        	<table width="671" border="0" cellspacing="5" cellpadding="5" style="border-collapse:collapse;">
			 <tr>
           ...
           <tr>
                ...
                bgcolor="#ffffff"><strong>Member No</strong></td>
				<td width="15%" class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><strong>Pre Auth Code</strong></td>
                ...
                <td width="14%"align="center" valign="center"   bgcolor="#ffffff" class="bodytext31"><strong>Decline</strong></td>
                ...
                <td width="40%"align="center" valign="center"   bgcolor="#ffffff" class="bodytext31"><strong>Remarks</strong></td>
	  ...
	  <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="1092" 
            align="left" border="0">
          <tbody>
          <tr>
              <td colspan="14" bgcolor="#ecf0f5" class="bodytext311"><strong>From <input type="text" name="ADate1" id="ADate1" size="10" value="<?php echo $ADate1; ?>" readonly onChange="" /> <img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate1')" style="cursor:pointer"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To <input type="text" name="ADate2" id="ADate2" size="10" value="<?php echo $ADate2; ?>" readonly onChange="" /> <img src="images2/cal.gif" onClick="javascript:NewCssCal('ADate2')" style="cursor:pointer"/> &nbsp;&nbsp; Invoice Number <input type="text" name="searchallinvoiceno" id="searchallinvoiceno" size="8"> &nbsp;&nbsp; Provider <input type="text" name="searchallaccountsearch" id="searchallaccountsearch" size="25" onkeyup="return funcservice();"><input type="hidden" name="searchallaccountsearchid" id="searchallaccountsearchid" size="8"></strong>
            ...
            <tr>
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext311"><strong>Pending Invoices</strong></td>
			 ...
			 <td width="20%" bgcolor="#ecf0f5" class="bodytext311">&nbsp;</td>
            ...
            <tr>
              ...
              <td width="17%" align="left" valign="center" bordercolor="#f3f3f3" 
                ...
                bgcolor="#ffffff" class="bodytext311"><strong>Account</strong></td>
				 ...
				 <td width="5%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext311"><strong>Member No</strong></td>
				<td width="5%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext311"><strong>Pre Auth Code</strong></td>
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" 
                bgcolor="#ffffff"><div align="left"><strong>Bill No </strong></div></td>
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" width="10%"  bgcolor="#ffffff"><div align="left"><strong>Bill Date </strong></div></td>
              <td width="9%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext311"><div align="right"><strong>Pending</strong></div></td>
				  ...
				  <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left"   bgcolor="#ffffff"><div align="right"><strong>Discount</strong></div></td>
                   <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left"   bgcolor="#ffffff"><div align="right"><strong>Decline</strong></div></td>
              ...
              <td width="8%" align="left" valign="center" bordercolor="#f3f3f3" 
                ...
                <td width="8%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong> Remarks</strong></div></td>
            </tr>
		...
		$totalrefundedamount=0;
            ...
            <tr>
             ...
             <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" bgcolor="#ecf0f5"><input type="text" name="totaldiscount" id="totaldiscount" size="7" class="bal" readonly></td>
              ...
              <td class="bodytext311" valign="center" bordercolor="#f3f3f3" align="left" bgcolor="#ecf0f5"><input type="text" name="totaldecline" id="totaldecline" size="7" class="bal" readonly></td>

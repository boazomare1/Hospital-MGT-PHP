...
echo '+++++'.$res23servicesitemrate = $res23['servicesitemrate'];
...
$resqty = mysqli_fetch_array($exec2111);
 ...
 $query233 = "select refno,sum(cash_copay) as cash_copay, sum(servicesitemrate) as servicesitemrate,sum(amount) as amount from consultation_services where patientvisitcode='$res2visitcode' and patientcode='$res2patientcode' and servicesitemcode = '".$res23servicesitemcode."' and paymentstatus='completed' group by servicesitemcode";
...
echo '======'.$sercash_copay=$res233['cash_copay'];
...
if($isnhif==1)
{
	$res233serviceitemrate=$res233serviceitemrate;

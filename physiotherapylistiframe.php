...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              <td colspan="8" bgcolor="#ecf0f5" class="bodytext31"><strong>Physio Therapy List</strong> </td>
			...
			$query1 = "select * from master_visitentry where department='2' and doctorconsultation <> 'completed' and paymentstatus = 'completed' order by auto_number desc";// and (billingdatetime between '$triagedatefrom' and '$triagedateto')";//
			...
			{
			$query12 = "select * from consultation_departmentreferal where patientvisitcode='$visitcode1' and referalcode = '2'";
		...
		if($num12 > 0)
		{
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left" colspan="3" colspan="3">

...
$stringbuild1 = "";
$query1 = "select * from $tablenames where status <> 'Deleted' AND locationcode = '".$locationcode."' AND rateperunit <> 0 order by itemname";
...
$filefolder = 'js';
$filename = 'autocomplete_services_theatre.'.'js';

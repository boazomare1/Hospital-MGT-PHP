...
<head>
    ...
    <title>Chart of Accounts Main Data Import - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/chartaccountsmain-import-modern.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <nav class="nav-breadcrumb">
        ...
        <span>→</span>
        <span>Chart of Accounts Main Data Import</span>
    </nav>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2>Chart of Accounts Main Data Import</h2>
                    <p>Import Chart of Accounts Main data from TAB delimited files to streamline account management.</p>
                </div>
            ...
            <div class="sample-file-section">
                ...
                <p class="sample-file-description">
                    Download the sample Excel file to understand the required format for importing Chart of Accounts Main data.
                </p>
                <a href="tab_file_dump/chartofaccountsmain.xlsx" class="sample-file-link" onclick="downloadSampleFile()">
            ...
            <div class="import-section">
                <div class="import-section-header">
                    ...
                    <h3 class="import-section-title">Import Chart of Accounts Main Data</h3>
                </div>
                
                <form id="importForm" action="chartaccountsmaindataimport.php" method="post" enctype="multipart/form-data" class="import-form">
    ...
    <!-- Modern JavaScript -->
    <script src="js/chartaccountsmain-import-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

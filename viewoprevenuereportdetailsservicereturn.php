...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Service Return</strong></td>
			...
			$query1 = "SELECT billdate, billnumber, patientvisitcode, patientname, servicesitemrate from refund_paynowservices where billdate between '$ADate1' and '$ADate2'
			union all SELECT billdate, billnumber, patientvisitcode, patientname, servicesitemrate from refund_paylaterservices where billdate between '$ADate1' and '$ADate2'
			union all select entrydate as billdate, billno as billnumber, visitcode as patientvisitcode, patientname, servicesfxamount as servicesitemrate from billing_patientweivers where entrydate between '$ADate1' and '$ADate2'
			";
			...
			$res1consultationamount = $res1['servicesitemrate'];
...
-->		
          ...
          <tr>
			...
			<a href="viewoprevenuereportdetailsservicereturnxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>

...
$(document).ready(function(e) {
	...
	source:"ajaxservices_search.php",
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tr>
            ...
            <tr>
              ...
              <a href="pdf_servicesrevenuereport.php?type=<?php echo $type; ?>&&slocation=<?= $slocation; ?>&&cbfrmflag1=cbfrmflag1&&ADate1=<?= $transactiondatefrom ?>&&ADate2=<?= $transactiondateto ?>&&services=<?php echo $services; ?>" target="_blank"><img src="images/pdfdownload.jpg" width="30" height="30"></a>

              </td> 

              <td width="75"  align="left" valign="center" bgcolor="" class="bodytext31">

              <a href="xl_servicesrevenuereport.php?type=<?php echo $type; ?>&&slocation=<?= $slocation; ?>&&cbfrmflag1=cbfrmflag1&&ADate1=<?= $transactiondatefrom ?>&&ADate2=<?= $transactiondateto ?>&&services=<?php echo $services; ?>" target="_blank"> <img src="images/excel-xls-icon.png" width="30" height="30" /> </a>

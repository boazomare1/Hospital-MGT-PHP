...
$queryd2 = "select * from master_transactionpaynow where username = '$res21username' order by username desc";
...
$queryd23 = "select * from master_billing where username = '$res21username'  order by username desc";
...
$queryd24 = "select * from master_transactionexternal where username = '$res21username'  order by username desc";
...
$queryd25 = "select * from refund_paynow where username = '$res21username'  order by username desc";
...
$queryd26 = "select * from master_transactionadvancedeposit where username = '$res21username'  order by username desc";
...
$queryd27 = "select * from master_transactionipdeposit where username = '$res21username'  order by username desc";
...
$queryd28 = "select * from master_transactionip where username = '$res21username'  order by username desc";
...
$queryd29 = "select * from master_transactionipcreditapproved where username = '$res21username'  order by username desc";
...
$queryd40 = "select * from receiptsub_details where username = '$res21username' ";
...
$queryd291 = "select * from deposit_refund where username = '$res21username'  order by username desc";
...
$queryd140 = "select * from master_transactionpaylater where locationcode='$locationcode1' and username = '$res21username'  and docno like 'AR-%' and transactionstatus='onaccount' ";

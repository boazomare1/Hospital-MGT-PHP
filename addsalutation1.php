...
if ($frmflag1 == 'frmflag1') {
    ...
    if ($length <= 100) {
        ...
        if ($res2 == 0) {
            ...
            $errmsg = "Success. New Salutation Added.";
            $bgcolorcode = 'success';
        } else {
...
if ($st == 'del') {
    ...
    header("Location: addsalutation1.php?msg=deleted");
    exit();
}
...
if ($st == 'activate') {
    ...
    $exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
    header("Location: addsalutation1.php?msg=activated");
    exit();
}
...
if (isset($_GET['msg'])) {
    if ($_GET['msg'] == 'deleted') {
        $errmsg = "Salutation deleted successfully.";
        $bgcolorcode = 'success';
    } elseif ($_GET['msg'] == 'activated') {
        $errmsg = "Salutation activated successfully.";
        $bgcolorcode = 'success';
    }
}
?>
...
<head>
    ...
    <title>Salutation Master - MedStar</title>
    
    <!-- jQuery -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    
    <!-- Modern CSS -->
    <link rel="stylesheet" href="css/addsalutation1-modern.css?v=<?php echo time(); ?>">
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <h2>Salutation Master</h2>
                    <p>Manage salutations and titles for patient and staff records.</p>
                </div>
            ...
            <div class="add-form-section">
                <div class="add-form-header">
                    ...
                    <h3 class="add-form-title">Add New Salutation</h3>
                </div>
                
                <form id="salutationForm" name="form1" method="post" action="addsalutation1.php" class="add-form">
                    <div class="form-group">
                        <label for="salutation" class="form-label">Salutation</label>
                        <input type="text" name="salutation" id="salutation" class="form-input" 
                               placeholder="Enter salutation (e.g., Dr., Mr., Mrs., Ms.)" maxlength="100">
                    </div>
            ...
            <div class="data-table-section">
                <div class="data-table-header">
                    ...
                    <h3 class="data-table-title">Existing Salutations</h3>
                </div>
                ...
                <div style="margin-bottom: 1rem;">
                    <div style="display: flex; gap: 1rem; align-items: center;">
                        <input type="text" id="searchInput" class="form-input" 
                               ...
                               oninput="searchSalutations(this.value)">
                ...
                <table class="data-table">
                    ...
                    <tbody id="salutationTableBody">
                        <?php
                        $query2 = "select * from master_salutation where recordstatus = '' order by salutation";
                        $exec2 = mysqli_query($GLOBALS["___mysqli_ston"], $query2) or die ("Error in Query2".mysqli_error($GLOBALS["___mysqli_ston"]));
                        $colorloopcount = 0;
                        
                        while ($res2 = mysqli_fetch_array($exec2)) {
                            $res2salutation = $res2['salutation'];
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($res2salutation); ?></td>
                                <td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="action-btn delete" 
                                                onclick="confirmDelete('<?php echo htmlspecialchars($res2salutation); ?>', '<?php echo $res2auto_number; ?>')"
                                                title="Delete">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                        <a href="editsalutation1.php?st=edit&anum=<?php echo $res2auto_number; ?>" 
            ...
            <div class="deleted-items-section">
                <div class="deleted-items-header">
                    ...
                    <h3 class="deleted-items-title">Deleted Salutations</h3>
                </div>
                ...
                <table class="data-table">
                    ...
                    <tbody id="deletedSalutationTableBody">
                        <?php
                        $query3 = "select * from master_salutation where recordstatus = 'deleted' order by salutation";
                        $exec3 = mysqli_query($GLOBALS["___mysqli_ston"], $query3) or die ("Error in Query3".mysqli_error($GLOBALS["___mysqli_ston"]));
                        
                        while ($res3 = mysqli_fetch_array($exec3)) {
                            $res3salutation = $res3['salutation'];
                            ...
                            <tr>
                                <td>
                                    <button class="action-btn activate" 
                                            onclick="confirmActivate('<?php echo htmlspecialchars($res3salutation); ?>', '<?php echo $res3auto_number; ?>')"
                                            title="Activate">
                                        <i class="fas fa-undo"></i> Activate
                                    </button>
                                </td>
                                <td><?php echo htmlspecialchars($res3salutation); ?></td>
                                <td>
                                    <span class="gender-badge gender-<?php echo strtolower($res3gender); ?>">
                                        <?php echo htmlspecialchars($res3gender); ?>
                                    </span>
                                </td>
                            </tr>
                            <?php
    ...
    <!-- Modern JavaScript -->
    <script src="js/addsalutation1-modern.js?v=<?php echo time(); ?>"></script>
</body>
</html>

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="ipdischargelist_test.php">
		<table width="510" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="1" bgcolor="#ecf0f5" class="bodytext3"><strong>Inpatient Discharge</strong></td>
...
?>
  ...
  <?php         }?>
	  ...
	  <form name="form1" id="form1" method="post" action="ipdischargelist_test.php">	
	  <tr>
        <td>
...
?>
		...
		{
		echo $query592 = "select * from ip_bedtransfer where ward='$wardnum' and bed='$bedanum' and recordstatus = 'request' and locationcode='$locationcode' order by auto_number desc limit 0, 1";
	...
	echo $visitcode = $res592['visitcode'];

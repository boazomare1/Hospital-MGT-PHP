        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#FFFFFF" class="bodytext31"><strong>Bed Transfer Charge Details</strong></td>
              <td width="10%" bgcolor="#FFFFFF" class="bodytext31">&nbsp;</td>
              </tr>            
...
?>		
         <tr>
              <td colspan="4"  class="bodytext31" valign="center"  align="right" 
                bgcolor="#fff"><strong>Total Bed Charges:</strong></td>
              <td align="right" valign="center" 
                bgcolor="#fff" class="bodytext31"><strong><?php echo number_format($totalbedtransfercharges,2,'.',','); ?></strong></td>
           </tr>     
          </tbody>
        </table>

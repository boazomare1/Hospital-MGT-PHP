...
else
{
	...
	//echo $companycode;
		...
		if($pairvar!="")
		{
	 	$creditquery="insert into ip_creditnote(billno,accountname,accountnameid,accountnameano,remarks,totalamount,billdate,locationname,locationcode,subtype,subtypeano,patientcode,visitcode,accountcode) values('$billnumbercode','$accountname1','$accountid0','$accountautonum','$pairvar','$amount','$billdate','$locationnameget','$locationcodeget','$subtype','$subtypeanum','$billnumbercode','$billnumbercode','$accountid0')";
		$execredit=mysqli_query($GLOBALS["___mysqli_ston"], $creditquery)or die("error in".mysql_error);
	
 		$paylaterquery="insert into master_transactionpaylater(docno,transactiondate,accountname,accountnameano,accountnameid,transactiontype,transactionamount,particulars,locationname,locationcode,acc_flag,updatedate,transactiontime,paymenttype,subtype,subtypeano,patientcode,visitcode,billnumber,username,receivableamount,accountcode,fxamount,fxrate,exchrate) 
values('$billnumbercode','$billdate','$accountname1','$accountautonum','$accountid0','paylatercredit','$amount','$pairvar','$locationnameget','$locationcodeget','0','$currentdate','$timeonly','$paymenttype','$subtype','$subtypeanum','$billnumbercode','$billnumbercode','$billnumbercode','$username','$amount','$accountid0','$fxamount','$fxrate','$fxrate')";
...
<form name="form1" id="frmsales" method="post" action="creditbill.php" onKeyDown="return disableEnterKey(event)" onSubmit="return validcheck()">

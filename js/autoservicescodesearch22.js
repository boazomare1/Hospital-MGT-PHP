...
function ajaxprocessACCS27()
{
	...
	var url = "";
	var url="autoservicescodesearch2.php?RandomKey="+Math.random()+"&&servicessearch="+servicessearch+"&&patienttypesearch="+varpatienttype2+"&&varpaymenttype="+varpaymenttype+"&&locationcode="+locationcode;
    //alert(url);

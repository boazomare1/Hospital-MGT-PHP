    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="634" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext3"><strong>External patients Report</strong></td>
			  			  <td bgcolor="#ecf0f5" class="bodytext3"><strong><a href="#" onClick="viewReport();">W</a></strong></td>
           ...
           <tr <?php echo $colorcode; ?>>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="right" 
				...
				<?php if($total6 != 0.00) { ?>
				 <td align="left" valign="center" bgcolor="#ecf0f5" class="bodytext31"><div align="right"><a target="_blank" href="print_externalpatientsreport.php?cbfrmflag1=cbfrmflag1&&ADate1=<?php echo $transactiondatefrom; ?>&&ADate2=<?php echo $transactiondateto; ?>&&user=<?php echo $res21username; ?>"><img src="images/excel-xls-icon.png" width="30" height="30"></a></div></td>
				<?php } ?>
				</tr>
          </tbody>
        </table></td>

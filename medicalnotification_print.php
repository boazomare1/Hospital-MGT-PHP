...
if ($getcanum != '')
{
	...
	$ADate1=isset($_POST['ADate1'])?$_POST['ADate1']:'';
	$ADate2=isset($_POST['ADate2'])?$_POST['ADate2']:'';
...
<table width="101%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="medicalnotification_print.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#ecf0f5" class="bodytext3"><strong>Print Patient Records </strong></td>
              </tr>
          
            <tr>
              <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Record Type</td>
              <td width="82%" colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext3">
			  <select id="search_type" name="search_type">
			  	<option value="">Select Type</option>
			  	<option value="medical">Medical Report</option>
			  	<option value="birth">Birth Notification</option>
			  	<option value="death">Death Notification</option>
	...
	<form name="form1" id="form1" method="post" action="medicalnotification_print.php">	
	  <tr>
        <td>
...
else if($search_type=='sick'){
$table_name='sickleave_entry';
$docno_col = 'visitcode';
$date_col = 'recorddate';
}
if($table_name==''){
				      ...
				      <?php //error_reporting(0);
							...
							*/
							...
							{	
								...
								//previous button
								if ($page > 1) 
									$pagination.= "<a href=\"$1?page=$prev\" style='color:#3b3b3c;'>previous</a>";
								else
              ...
              <tr <?php echo $colorcode; ?>>
				...
				<img src="images/female.png" width="16" height="16" border="0" />
				 ...
				 ?>
					...
					<td class="bodytext31" valign="center"  align="left"><?php echo date_format(date_create($date),'d-m-Y'); ?></td>
					<td class="bodytext31" valign="center"  align="left">
				<?php	
				if($search_type=='death'){
				?>
					<a target="_blank" href="print_death_notificationcopy.php?docno=<?=  $dnumber ?>"> Print </a>
				<?php
				}
				elseif($search_type=='birth'){
				?>
					<a target="_blank" href="print_birthnotificationcopy.php?docno=<?=  $dnumber ?>"> Print </a>
				<?php
				}
				elseif($search_type=='sick'){
				?>
					<a target="_blank" href="print_sickleave.php?patientcode=<?=  $res2customercode ?>&&visitcode=<?=  $dnumber ?>"> Sick Leave - <?= $dnumber?> </a>
				<?php
				}
				else
				{
				?>
				<a target="_blank" href="print_medical_reports.php?docnumber=<?=  $dnumber ?>&search_type=<?= $search_type ?>"> Print </a>
				<?php
				}

...
//  }
 ...
 $query1 = "select count(*) as count from ip_bedallocation where recorddate BETWEEN '$ADate1' AND '$ADate2' and ward NOT IN ('1','2','3','8','17') ";
...
function getAvailableBeds(){
  ...
  $query1 = "select count(*) as count from $bedtable where ward NOT IN ('1','2','3','8','17') and recordstatus <> 'deleted'";
  $exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
  $res1 = mysqli_fetch_array($exec1);
  $count = $res1['count'];
...
function getLabWalkin($ADate1, $ADate2){
  $query1 = "select count(count) as count from (
    select count(a.patientvisitcode) as count from consultation_lab as a JOIN master_visitentry as b ON a.patientvisitcode = b.visitcode where a.consultationdate between '$ADate1' and '$ADate2' and b.department = '24' group by a.patientvisitcode
    ) as amt1";
  $exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
  $res1 = mysqli_fetch_array($exec1);
  $count = $res1['count'];
...
function getPharmacyWalkin($ADate1, $ADate2){
  $query1 = "select count(count) as count from (
    select count(distinct billnumber) as count from billing_paynowpharmacy as a JOIN master_visitentry as b ON a.patientvisitcode = b.visitcode where a.billdate between '$ADate1' and '$ADate2' and b.department = '24' group by a.patientvisitcode
    UNION ALL
    select count(distinct billnumber) as count from billing_paylaterpharmacy as a JOIN master_visitentry as b ON a.patientvisitcode = b.visitcode where a.billdate between '$ADate1' and '$ADate2' and b.department = '24' group by a.patientvisitcode
    ) as amt1";
  $exec1 = mysqli_query($GLOBALS["___mysqli_ston"], $query1) or die("Error in Query1".mysqli_error($GLOBALS["___mysqli_ston"]));
  $res1 = mysqli_fetch_array($exec1);
  $count = $res1['count'];
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="daytodayflash_duplicate.php">

...
while ($res1 = mysqli_fetch_array($exec1))
{
	...
	$res1doctorfees=$res1['pridoc_charge'];
...
*/
	...
	*/
	...
	if ($stringbuild1 == '')
	{
		$stringbuild1 = '"'.$res1doctorcode.'||'.' '.$res1doctorname.'||'.' '.$res1doctorfees.'"';
	}
	else
	{
		$stringbuild1 = $stringbuild1.',"'.$res1doctorcode.'||'.' '.$res1doctorname.'||'.' '.$res1doctorfees.'"';
	}
}
//echo $stringbuild1;

    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="pending_claims.php">
...
if ($cbfrmflag1 == 'cbfrmflag1')
{
    ...
    $querynw1 = "select * from billing_paylater where patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and billdate between '$fromdate' and '$todate' and billno like '%$billnumber2%' and slade_status!='completed' and slade_claim_id!=''";
...
?>
            ...
            <tr>
              ...
              <td width="20%"  align="left" valign="center" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong> Bill Number</strong></div></td>
				 ...
				 <td width="20%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong> Claim</strong></div></td>
		...
		$query12 = "select * from billing_paylater where patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and billdate between '$fromdate' and '$todate' and billno like '%$billnumber2%' and slade_status!='completed' and slade_claim_id!=''";
		$exec12 = mysqli_query($GLOBALS["___mysqli_ston"], $query12) or die ("Error in Query12".mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		$slade_claim_id=$res12['slade_claim_id'];
          ...
          <tr <?php echo $colorcode; ?> id="row-<?php echo $sno ; ?>">
              ...
              <td class="bodytext31" valign="center"  align="left">
			    <div align="center"><?php echo $slade_claim_id; ?></div></td>
                <td class="bodytext31" valign="center"  align="left">
			    <div align="center">
			      <?php echo $accountname; ?>			      </div></td>
                  
              
              <td class="bodytext31" valign="center"  align="left"><a href="javascript:return false;" onclick="return repost_claim('<?php echo $sno ; ?>','<?php echo $visitcode; ?>','<?php echo $billnumber; ?>','<?php echo $slade_claim_id; ?>');";><strong>Re-Post to Slade</strong></a></td>
              </tr>
		   <?php 
		...
		$query12 = "select * from billing_ip where patientcode like '%$searchpatientcode%' and visitcode like '%$searchvisitcode%' and patientname like '%$searchpatient%' and billdate between '$fromdate' and '$todate' and billno like '%$billnumber2%' and slade_status!='completed' and slade_claim_id!=''";
		$exec12 = mysqli_query($GLOBALS["___mysqli_ston"], $query12) or die ("Error in Query12".mysqli_error($GLOBALS["___mysqli_ston"]));
		$num12=mysqli_num_rows($exec12);
		if($num12>0){
		?>
		...
		$slade_claim_id=$res12['slade_claim_id'];
          ...
          <tr <?php echo $colorcode; ?> id="row-<?php echo $sno ; ?>">
              ...
              <td class="bodytext31" valign="center"  align="left"><a href="javascript:return false;" onclick="return repost_claimip('<?php echo $sno ; ?>','<?php echo $visitcode; ?>','<?php echo $billnumber; ?>','<?php echo $slade_claim_id; ?>');";><strong>Re-Post to Slade</strong></a></td>
              </tr>
		   <?php 

  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td colspan="3" bgcolor="#ecf0f5" class="bodytext31"><strong>Pharmacy Return  Details</strong></td>
              <td width="10%" bgcolor="#ecf0f5" class="bodytext31">&nbsp;</td>
              </tr>            
        ...
        <?php
		$totalpharmacysale = 0;
		$query66 = "select * from master_ipvisitentry where visitcode IN (select visitcode from billing_ip where billdate between '$ADate1' and '$ADate2')";
		...
		while($res66 = mysqli_fetch_array($exec66))
		{
			...
			$querymenu = "select * from master_ipvisitentry where visitcode='$visitcode'";
		   ...
		   $query32 = "select currency,fxrate,subtype from master_subtype where auto_number = '".$menusub."'";
			...
			$totalpharmacysalereturnamount = 0;
			
			$query331 = "select (quantity) as quantity, rate, (totalamount) as totalamount from pharmacysalesreturn_details where visitcode='$visitcode' and patientcode='$patientcode'";
		   ...
		   $totalpharmacysale=$totalpharmacysale+$totalpharmacysalereturnamount;
           ...
           <tr <?php echo $colorcode; ?>>
            ...
            <td align="right" valign="center"  class="bodytext31"><div class="bodytext31"><?php echo number_format($totalpharmacysalereturnamount,2,'.',','); ?></div></td>
           </tr>
	<?php
		}
...
?>		
         <tr>
              <td colspan="4"  class="bodytext31" valign="center"  align="right" 
                bgcolor="#ecf0f5"><strong>Total Pharmacy Sales Return Amount</strong></td>
              <td align="right" valign="center" 
                bgcolor="#ecf0f5" class="bodytext31"><strong><?php echo number_format($totalpharmacysale,2,'.',','); ?></strong></td>
...
<tr>
			...
			<a href="detailsippharmacyreturnxl.php?ADate1=<?php echo $ADate1; ?>&&ADate2=<?php echo $ADate2;?>"><img src="images/excel-xls-icon.png" width="40" height="40"></a></td>
			</tr>
          </tbody>
        </table>
